...
public class SetsJVM {
    ...
    private static final <E> Set<E> buildSetInternal(int r1, Function1<? super Set<E>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
    ...
    public static final <E> Set<E> createSetBuilder(int r1) {
