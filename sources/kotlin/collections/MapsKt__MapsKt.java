...
public class MapsKt__MapsKt extends MapsJVM {
    ...
    private static final <K, V> Map<K, V> buildMap(int r1, Function1<? super Map<K, V>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        Map createMapBuilder = MapsKt.createMapBuilder(r1);
        builderAction.invoke(createMapBuilder);
        return MapsKt.build(createMapBuilder);
    }
