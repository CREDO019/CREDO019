...
@Metadata(m184d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00020\u00040\u0003H\u008a@"}, m183d2 = {"<anonymous>", "", "T", "Lkotlin/sequences/SequenceScope;", ""}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
@DebugMetadata(m175c = "kotlin.collections.SlidingWindowKt$windowedIterator$1", m174f = "SlidingWindow.kt", m173i = {0, 0, 0, 2, 2, 3, 3}, m172l = {34, 40, 49, 55, 58}, m171m = "invokeSuspend", m170n = {"$this$iterator", "buffer", "gap", "$this$iterator", "buffer", "$this$iterator", "buffer"}, m169s = {"L$0", "L$1", "I$0", "L$0", "L$1", "L$0", "L$1"})
...
public final class SlidingWindowKt$windowedIterator$1<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super List<? extends T>>, Continuation<? super Unit>, Object> {
    ...
    public SlidingWindowKt$windowedIterator$1(int r1, int r2, Iterator<? extends T> it, boolean z, boolean z2, Continuation<? super SlidingWindowKt$windowedIterator$1> continuation) {
