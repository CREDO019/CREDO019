...
public class _ArraysJvm extends Arrays {
    ...
    public static final List<Integer> asList(int[] r1) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        return new ArraysKt___ArraysJvmKt$asList$3(r1);
    }
    ...
    public static /* synthetic */ int binarySearch$default(Object[] objArr, Object obj, Comparator comparator, int r3, int r4, int r5, Object obj2) {
        if ((r5 & 4) != 0) {
            r3 = 0;
        }
        if ((r5 & 8) != 0) {
        ...
        return ArraysKt.binarySearch(objArr, obj, comparator, r3, r4);
    }

    public static final <T> int binarySearch(T[] tArr, T t, Comparator<? super T> comparator, int r4, int r5) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return Arrays.binarySearch(tArr, r4, r5, t, comparator);
    }

    public static /* synthetic */ int binarySearch$default(Object[] objArr, Object obj, int r2, int r3, int r4, Object obj2) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        return ArraysKt.binarySearch(objArr, obj, r2, r3);
    }

    public static final <T> int binarySearch(T[] tArr, T t, int r3, int r4) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        return Arrays.binarySearch(tArr, r3, r4, t);
    }

    public static /* synthetic */ int binarySearch$default(byte[] bArr, byte b, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        return ArraysKt.binarySearch(bArr, b, r2, r3);
    }

    public static final int binarySearch(byte[] bArr, byte b, int r3, int r4) {
        Intrinsics.checkNotNullParameter(bArr, "<this>");
        return Arrays.binarySearch(bArr, r3, r4, b);
    }

    public static /* synthetic */ int binarySearch$default(short[] sArr, short s, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        return ArraysKt.binarySearch(sArr, s, r2, r3);
    }

    public static final int binarySearch(short[] sArr, short s, int r3, int r4) {
        Intrinsics.checkNotNullParameter(sArr, "<this>");
        return Arrays.binarySearch(sArr, r3, r4, s);
    }

    public static /* synthetic */ int binarySearch$default(int[] r0, int r1, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        return ArraysKt.binarySearch(r0, r1, r2, r3);
    }

    public static final int binarySearch(int[] r1, int r2, int r3, int r4) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        return Arrays.binarySearch(r1, r3, r4, r2);
    }

    public static /* synthetic */ int binarySearch$default(long[] jArr, long j, int r3, int r4, int r5, Object obj) {
        if ((r5 & 2) != 0) {
            r3 = 0;
        }
        if ((r5 & 4) != 0) {
        ...
        return ArraysKt.binarySearch(jArr, j, r3, r4);
    }

    public static final int binarySearch(long[] jArr, long j, int r4, int r5) {
        Intrinsics.checkNotNullParameter(jArr, "<this>");
        return Arrays.binarySearch(jArr, r4, r5, j);
    }

    public static /* synthetic */ int binarySearch$default(float[] fArr, float f, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        return ArraysKt.binarySearch(fArr, f, r2, r3);
    }

    public static final int binarySearch(float[] fArr, float f, int r3, int r4) {
        Intrinsics.checkNotNullParameter(fArr, "<this>");
        return Arrays.binarySearch(fArr, r3, r4, f);
    }

    public static /* synthetic */ int binarySearch$default(double[] dArr, double d, int r3, int r4, int r5, Object obj) {
        if ((r5 & 2) != 0) {
            r3 = 0;
        }
        if ((r5 & 4) != 0) {
        ...
        return ArraysKt.binarySearch(dArr, d, r3, r4);
    }

    public static final int binarySearch(double[] dArr, double d, int r4, int r5) {
        Intrinsics.checkNotNullParameter(dArr, "<this>");
        return Arrays.binarySearch(dArr, r4, r5, d);
    }

    public static /* synthetic */ int binarySearch$default(char[] cArr, char c, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        return ArraysKt.binarySearch(cArr, c, r2, r3);
    }

    public static final int binarySearch(char[] cArr, char c, int r3, int r4) {
        Intrinsics.checkNotNullParameter(cArr, "<this>");
        return Arrays.binarySearch(cArr, r3, r4, c);
    }
    ...
    @Deprecated(message = "Use Kotlin compiler 1.4 to avoid deprecation warning.")
    @DeprecatedSinceKotlin(hiddenSince = "1.4")
    private static final /* synthetic */ boolean contentEquals(int[] r1, int[] other) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        return Arrays.equals(r1, other);
    }
    ...
    private static final boolean contentEqualsNullable(int[] r0, int[] r1) {
    ...
    @Deprecated(message = "Use Kotlin compiler 1.4 to avoid deprecation warning.")
    @DeprecatedSinceKotlin(hiddenSince = "1.4")
    private static final /* synthetic */ int contentHashCode(int[] r1) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
    ...
    private static final int contentHashCodeNullable(int[] r0) {
    ...
    @Deprecated(message = "Use Kotlin compiler 1.4 to avoid deprecation warning.")
    @DeprecatedSinceKotlin(hiddenSince = "1.4")
    private static final /* synthetic */ String contentToString(int[] r1) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
    ...
    private static final String contentToStringNullable(int[] r1) {
        String arrays = Arrays.toString(r1);
        Intrinsics.checkNotNullExpressionValue(arrays, "toString(this)");
        return arrays;
    }
    ...
    public static /* synthetic */ Object[] copyInto$default(Object[] objArr, Object[] objArr2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(objArr, objArr2, r3, r4, r5);
    }

    public static final <T> T[] copyInto(T[] tArr, T[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        System.arraycopy(tArr, r4, destination, r3, r5 - r4);
        return destination;
    }

    public static /* synthetic */ byte[] copyInto$default(byte[] bArr, byte[] bArr2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(bArr, bArr2, r3, r4, r5);
    }

    public static final byte[] copyInto(byte[] bArr, byte[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(bArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        System.arraycopy(bArr, r4, destination, r3, r5 - r4);
        return destination;
    }

    public static /* synthetic */ short[] copyInto$default(short[] sArr, short[] sArr2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(sArr, sArr2, r3, r4, r5);
    }

    public static final short[] copyInto(short[] sArr, short[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(sArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        System.arraycopy(sArr, r4, destination, r3, r5 - r4);
        return destination;
    }

    public static /* synthetic */ int[] copyInto$default(int[] r1, int[] r2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(r1, r2, r3, r4, r5);
    }

    public static final int[] copyInto(int[] r1, int[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        System.arraycopy(r1, r4, destination, r3, r5 - r4);
        return destination;
    }

    public static /* synthetic */ long[] copyInto$default(long[] jArr, long[] jArr2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(jArr, jArr2, r3, r4, r5);
    }

    public static final long[] copyInto(long[] jArr, long[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(jArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        System.arraycopy(jArr, r4, destination, r3, r5 - r4);
        return destination;
    }

    public static /* synthetic */ float[] copyInto$default(float[] fArr, float[] fArr2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(fArr, fArr2, r3, r4, r5);
    }

    public static final float[] copyInto(float[] fArr, float[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(fArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        System.arraycopy(fArr, r4, destination, r3, r5 - r4);
        return destination;
    }

    public static /* synthetic */ double[] copyInto$default(double[] dArr, double[] dArr2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(dArr, dArr2, r3, r4, r5);
    }

    public static final double[] copyInto(double[] dArr, double[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(dArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        System.arraycopy(dArr, r4, destination, r3, r5 - r4);
        return destination;
    }

    public static /* synthetic */ boolean[] copyInto$default(boolean[] zArr, boolean[] zArr2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(zArr, zArr2, r3, r4, r5);
    }

    public static final boolean[] copyInto(boolean[] zArr, boolean[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(zArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        System.arraycopy(zArr, r4, destination, r3, r5 - r4);
        return destination;
    }

    public static /* synthetic */ char[] copyInto$default(char[] cArr, char[] cArr2, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        return ArraysKt.copyInto(cArr, cArr2, r3, r4, r5);
    }

    public static final char[] copyInto(char[] cArr, char[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(cArr, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
    ...
    private static final int[] copyOf(int[] r1) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
    ...
    private static final byte[] copyOf(byte[] bArr, int r2) {
        Intrinsics.checkNotNullParameter(bArr, "<this>");
        byte[] copyOf = Arrays.copyOf(bArr, r2);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return copyOf;
    }

    private static final short[] copyOf(short[] sArr, int r2) {
        Intrinsics.checkNotNullParameter(sArr, "<this>");
        short[] copyOf = Arrays.copyOf(sArr, r2);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return copyOf;
    }

    private static final int[] copyOf(int[] r1, int r2) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        int[] copyOf = Arrays.copyOf(r1, r2);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return copyOf;
    }

    private static final long[] copyOf(long[] jArr, int r2) {
        Intrinsics.checkNotNullParameter(jArr, "<this>");
        long[] copyOf = Arrays.copyOf(jArr, r2);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return copyOf;
    }

    private static final float[] copyOf(float[] fArr, int r2) {
        Intrinsics.checkNotNullParameter(fArr, "<this>");
        float[] copyOf = Arrays.copyOf(fArr, r2);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return copyOf;
    }

    private static final double[] copyOf(double[] dArr, int r2) {
        Intrinsics.checkNotNullParameter(dArr, "<this>");
        double[] copyOf = Arrays.copyOf(dArr, r2);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return copyOf;
    }

    private static final boolean[] copyOf(boolean[] zArr, int r2) {
        Intrinsics.checkNotNullParameter(zArr, "<this>");
        boolean[] copyOf = Arrays.copyOf(zArr, r2);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return copyOf;
    }

    private static final char[] copyOf(char[] cArr, int r2) {
        Intrinsics.checkNotNullParameter(cArr, "<this>");
    ...
    private static final <T> T[] copyOf(T[] tArr, int r2) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
    ...
    private static final <T> T[] copyOfRangeInline(T[] tArr, int r4, int r5) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return (T[]) ArraysKt.copyOfRange(tArr, r4, r5);
        }
        if (r5 > tArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + tArr.length);
        }
        T[] tArr2 = (T[]) Arrays.copyOfRange(tArr, r4, r5);
        Intrinsics.checkNotNullExpressionValue(tArr2, "{\n        if (toIndex > …fromIndex, toIndex)\n    }");
        return tArr2;
    }

    private static final byte[] copyOfRangeInline(byte[] bArr, int r4, int r5) {
        Intrinsics.checkNotNullParameter(bArr, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return ArraysKt.copyOfRange(bArr, r4, r5);
        }
        if (r5 > bArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + bArr.length);
        }
    ...
    private static final short[] copyOfRangeInline(short[] sArr, int r4, int r5) {
        Intrinsics.checkNotNullParameter(sArr, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return ArraysKt.copyOfRange(sArr, r4, r5);
        }
        if (r5 > sArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + sArr.length);
        }
        short[] copyOfRange = Arrays.copyOfRange(sArr, r4, r5);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "{\n        if (toIndex > …fromIndex, toIndex)\n    }");
        return copyOfRange;
    }

    private static final int[] copyOfRangeInline(int[] r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(r3, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return ArraysKt.copyOfRange(r3, r4, r5);
        }
        if (r5 > r3.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + r3.length);
        }
        int[] copyOfRange = Arrays.copyOfRange(r3, r4, r5);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "{\n        if (toIndex > …fromIndex, toIndex)\n    }");
        return copyOfRange;
    }

    private static final long[] copyOfRangeInline(long[] jArr, int r4, int r5) {
        Intrinsics.checkNotNullParameter(jArr, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return ArraysKt.copyOfRange(jArr, r4, r5);
        }
        if (r5 > jArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + jArr.length);
        }
        long[] copyOfRange = Arrays.copyOfRange(jArr, r4, r5);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "{\n        if (toIndex > …fromIndex, toIndex)\n    }");
        return copyOfRange;
    }

    private static final float[] copyOfRangeInline(float[] fArr, int r4, int r5) {
        Intrinsics.checkNotNullParameter(fArr, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return ArraysKt.copyOfRange(fArr, r4, r5);
        }
        if (r5 > fArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + fArr.length);
        }
        float[] copyOfRange = Arrays.copyOfRange(fArr, r4, r5);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "{\n        if (toIndex > …fromIndex, toIndex)\n    }");
        return copyOfRange;
    }

    private static final double[] copyOfRangeInline(double[] dArr, int r4, int r5) {
        Intrinsics.checkNotNullParameter(dArr, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return ArraysKt.copyOfRange(dArr, r4, r5);
        }
        if (r5 > dArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + dArr.length);
        }
        double[] copyOfRange = Arrays.copyOfRange(dArr, r4, r5);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "{\n        if (toIndex > …fromIndex, toIndex)\n    }");
        return copyOfRange;
    }

    private static final boolean[] copyOfRangeInline(boolean[] zArr, int r4, int r5) {
        Intrinsics.checkNotNullParameter(zArr, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return ArraysKt.copyOfRange(zArr, r4, r5);
        }
        if (r5 > zArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + zArr.length);
        }
        boolean[] copyOfRange = Arrays.copyOfRange(zArr, r4, r5);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "{\n        if (toIndex > …fromIndex, toIndex)\n    }");
        return copyOfRange;
    }

    private static final char[] copyOfRangeInline(char[] cArr, int r4, int r5) {
        Intrinsics.checkNotNullParameter(cArr, "<this>");
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            return ArraysKt.copyOfRange(cArr, r4, r5);
        }
        if (r5 > cArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + r5 + ", size: " + cArr.length);
        }
        char[] copyOfRange = Arrays.copyOfRange(cArr, r4, r5);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "{\n        if (toIndex > …fromIndex, toIndex)\n    }");
        return copyOfRange;
    }

    public static final <T> T[] copyOfRange(T[] tArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, tArr.length);
        T[] tArr2 = (T[]) Arrays.copyOfRange(tArr, r2, r3);
    ...
    public static final byte[] copyOfRange(byte[] bArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(bArr, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, bArr.length);
    ...
    public static final short[] copyOfRange(short[] sArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(sArr, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, sArr.length);
        short[] copyOfRange = Arrays.copyOfRange(sArr, r2, r3);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "copyOfRange(this, fromIndex, toIndex)");
        return copyOfRange;
    }

    public static final int[] copyOfRange(int[] r1, int r2, int r3) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, r1.length);
        int[] copyOfRange = Arrays.copyOfRange(r1, r2, r3);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "copyOfRange(this, fromIndex, toIndex)");
        return copyOfRange;
    }

    public static final long[] copyOfRange(long[] jArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(jArr, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, jArr.length);
        long[] copyOfRange = Arrays.copyOfRange(jArr, r2, r3);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "copyOfRange(this, fromIndex, toIndex)");
        return copyOfRange;
    }

    public static final float[] copyOfRange(float[] fArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(fArr, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, fArr.length);
        float[] copyOfRange = Arrays.copyOfRange(fArr, r2, r3);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "copyOfRange(this, fromIndex, toIndex)");
        return copyOfRange;
    }

    public static final double[] copyOfRange(double[] dArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(dArr, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, dArr.length);
        double[] copyOfRange = Arrays.copyOfRange(dArr, r2, r3);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "copyOfRange(this, fromIndex, toIndex)");
        return copyOfRange;
    }

    public static final boolean[] copyOfRange(boolean[] zArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(zArr, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, zArr.length);
        boolean[] copyOfRange = Arrays.copyOfRange(zArr, r2, r3);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "copyOfRange(this, fromIndex, toIndex)");
        return copyOfRange;
    }

    public static final char[] copyOfRange(char[] cArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(cArr, "<this>");
        ArraysKt.copyOfRangeToIndexCheck(r3, cArr.length);
        char[] copyOfRange = Arrays.copyOfRange(cArr, r2, r3);
        Intrinsics.checkNotNullExpressionValue(copyOfRange, "copyOfRange(this, fromIndex, toIndex)");
        return copyOfRange;
    }

    public static /* synthetic */ void fill$default(Object[] objArr, Object obj, int r2, int r3, int r4, Object obj2) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        ArraysKt.fill(objArr, obj, r2, r3);
    }

    public static final <T> void fill(T[] tArr, T t, int r3, int r4) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        Arrays.fill(tArr, r3, r4, t);
    }

    public static /* synthetic */ void fill$default(byte[] bArr, byte b, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        ArraysKt.fill(bArr, b, r2, r3);
    }

    public static final void fill(byte[] bArr, byte b, int r3, int r4) {
        Intrinsics.checkNotNullParameter(bArr, "<this>");
        Arrays.fill(bArr, r3, r4, b);
    }

    public static /* synthetic */ void fill$default(short[] sArr, short s, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        ArraysKt.fill(sArr, s, r2, r3);
    }

    public static final void fill(short[] sArr, short s, int r3, int r4) {
        Intrinsics.checkNotNullParameter(sArr, "<this>");
        Arrays.fill(sArr, r3, r4, s);
    }

    public static /* synthetic */ void fill$default(int[] r0, int r1, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
    ...
    public static final void fill(int[] r1, int r2, int r3, int r4) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        Arrays.fill(r1, r3, r4, r2);
    }

    public static /* synthetic */ void fill$default(long[] jArr, long j, int r3, int r4, int r5, Object obj) {
        if ((r5 & 2) != 0) {
            r3 = 0;
        }
        if ((r5 & 4) != 0) {
        ...
        ArraysKt.fill(jArr, j, r3, r4);
    }

    public static final void fill(long[] jArr, long j, int r4, int r5) {
        Intrinsics.checkNotNullParameter(jArr, "<this>");
        Arrays.fill(jArr, r4, r5, j);
    }

    public static /* synthetic */ void fill$default(float[] fArr, float f, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        ArraysKt.fill(fArr, f, r2, r3);
    }

    public static final void fill(float[] fArr, float f, int r3, int r4) {
        Intrinsics.checkNotNullParameter(fArr, "<this>");
        Arrays.fill(fArr, r3, r4, f);
    }

    public static /* synthetic */ void fill$default(double[] dArr, double d, int r3, int r4, int r5, Object obj) {
        if ((r5 & 2) != 0) {
            r3 = 0;
        }
        if ((r5 & 4) != 0) {
        ...
        ArraysKt.fill(dArr, d, r3, r4);
    }

    public static final void fill(double[] dArr, double d, int r4, int r5) {
        Intrinsics.checkNotNullParameter(dArr, "<this>");
        Arrays.fill(dArr, r4, r5, d);
    }

    public static /* synthetic */ void fill$default(boolean[] zArr, boolean z, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        ArraysKt.fill(zArr, z, r2, r3);
    }

    public static final void fill(boolean[] zArr, boolean z, int r3, int r4) {
        Intrinsics.checkNotNullParameter(zArr, "<this>");
        Arrays.fill(zArr, r3, r4, z);
    }

    public static /* synthetic */ void fill$default(char[] cArr, char c, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        ArraysKt.fill(cArr, c, r2, r3);
    }

    public static final void fill(char[] cArr, char c, int r3, int r4) {
        Intrinsics.checkNotNullParameter(cArr, "<this>");
        Arrays.fill(cArr, r3, r4, c);
    }
    ...
    public static final int[] plus(int[] r2, int r3) {
        Intrinsics.checkNotNullParameter(r2, "<this>");
        int length = r2.length;
        int[] result = Arrays.copyOf(r2, length + 1);
        result[length] = r3;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final int[] plus(int[] r3, Collection<Integer> elements) {
        Intrinsics.checkNotNullParameter(r3, "<this>");
        Intrinsics.checkNotNullParameter(elements, "elements");
        int length = r3.length;
        int[] result = Arrays.copyOf(r3, elements.size() + length);
    ...
    public static final int[] plus(int[] r3, int[] elements) {
        Intrinsics.checkNotNullParameter(r3, "<this>");
        Intrinsics.checkNotNullParameter(elements, "elements");
        int length = r3.length;
        int length2 = elements.length;
        int[] result = Arrays.copyOf(r3, length + length2);
        System.arraycopy(elements, 0, result, length, length2);
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final void sort(int[] r2) {
        Intrinsics.checkNotNullParameter(r2, "<this>");
        if (r2.length > 1) {
            Arrays.sort(r2);
        }
    ...
    public static /* synthetic */ void sort$default(Comparable[] comparableArr, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
            r2 = comparableArr.length;
        }
        ArraysKt.sort(comparableArr, r1, r2);
    }

    public static final <T extends Comparable<? super T>> void sort(T[] tArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        Arrays.sort(tArr, r2, r3);
    }

    public static /* synthetic */ void sort$default(byte[] bArr, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        ArraysKt.sort(bArr, r1, r2);
    }

    public static final void sort(byte[] bArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(bArr, "<this>");
        Arrays.sort(bArr, r2, r3);
    }

    public static /* synthetic */ void sort$default(short[] sArr, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        ArraysKt.sort(sArr, r1, r2);
    }

    public static final void sort(short[] sArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(sArr, "<this>");
        Arrays.sort(sArr, r2, r3);
    }

    public static /* synthetic */ void sort$default(int[] r0, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        ArraysKt.sort(r0, r1, r2);
    }

    public static final void sort(int[] r1, int r2, int r3) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        Arrays.sort(r1, r2, r3);
    }

    public static /* synthetic */ void sort$default(long[] jArr, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        ArraysKt.sort(jArr, r1, r2);
    }

    public static final void sort(long[] jArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(jArr, "<this>");
        Arrays.sort(jArr, r2, r3);
    }

    public static /* synthetic */ void sort$default(float[] fArr, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        ArraysKt.sort(fArr, r1, r2);
    }

    public static final void sort(float[] fArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(fArr, "<this>");
        Arrays.sort(fArr, r2, r3);
    }

    public static /* synthetic */ void sort$default(double[] dArr, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        ArraysKt.sort(dArr, r1, r2);
    }

    public static final void sort(double[] dArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(dArr, "<this>");
        Arrays.sort(dArr, r2, r3);
    }

    public static /* synthetic */ void sort$default(char[] cArr, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        ArraysKt.sort(cArr, r1, r2);
    }

    public static final void sort(char[] cArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(cArr, "<this>");
        Arrays.sort(cArr, r2, r3);
    }

    public static /* synthetic */ void sort$default(Object[] objArr, int r1, int r2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r1 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        ArraysKt.sort(objArr, r1, r2);
    }

    public static final <T> void sort(T[] tArr, int r2, int r3) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        Arrays.sort(tArr, r2, r3);
    }
    ...
    public static /* synthetic */ void sortWith$default(Object[] objArr, Comparator comparator, int r2, int r3, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            r2 = 0;
        }
        if ((r4 & 4) != 0) {
        ...
        ArraysKt.sortWith(objArr, comparator, r2, r3);
    }

    public static final <T> void sortWith(T[] tArr, Comparator<? super T> comparator, int r3, int r4) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        Arrays.sort(tArr, r3, r4, comparator);
    }
    ...
    public static final Short[] toTypedArray(short[] sArr) {
        ...
        int length = sArr.length;
        for (int r2 = 0; r2 < length; r2++) {
            shArr[r2] = Short.valueOf(sArr[r2]);
        }
        return shArr;
    }

    public static final Integer[] toTypedArray(int[] r4) {
        Intrinsics.checkNotNullParameter(r4, "<this>");
        Integer[] numArr = new Integer[r4.length];
    ...
    public static final Float[] toTypedArray(float[] fArr) {
        ...
        int length = fArr.length;
        for (int r2 = 0; r2 < length; r2++) {
            fArr2[r2] = Float.valueOf(fArr[r2]);
        }
        return fArr2;
    }
    ...
    public static final Double[] toTypedArray(double[] dArr) {
        ...
        int length = dArr.length;
        for (int r2 = 0; r2 < length; r2++) {
            dArr2[r2] = Double.valueOf(dArr[r2]);
        }
        return dArr2;
    }
    ...
    public static final Boolean[] toTypedArray(boolean[] zArr) {
        ...
        int length = zArr.length;
        for (int r2 = 0; r2 < length; r2++) {
            boolArr[r2] = Boolean.valueOf(zArr[r2]);
        }
        return boolArr;
    }
    ...
    public static final Character[] toTypedArray(char[] cArr) {
        ...
        int length = cArr.length;
        for (int r2 = 0; r2 < length; r2++) {
            chArr[r2] = Character.valueOf(cArr[r2]);
        }
        return chArr;
    }
    ...
    public static final SortedSet<Integer> toSortedSet(int[] r1) {
        Intrinsics.checkNotNullParameter(r1, "<this>");
        return (SortedSet) ArraysKt.toCollection(r1, new TreeSet());
    }
    ...
    private static final BigDecimal sumOfBigDecimal(int[] r4, Function1<? super Integer, ? extends BigDecimal> selector) {
        Intrinsics.checkNotNullParameter(r4, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        for (int r3 : r4) {
            valueOf = valueOf.add(selector.invoke(Integer.valueOf(r3)));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(int[] r4, Function1<? super Integer, ? extends BigInteger> selector) {
        Intrinsics.checkNotNullParameter(r4, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        BigInteger valueOf = BigInteger.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
