...
public class TypeIntrinsics {
    ...
    public static boolean isFunctionOfArity(Object obj, int r2) {
        return (obj instanceof Function) && getFunctionArity(obj) == r2;
    }

    public static Object beforeCheckcastToFunctionOfArity(Object obj, int r3) {
        if (obj != null && !isFunctionOfArity(obj, r3)) {
            throwCce(obj, "kotlin.jvm.functions.Function" + r3);
        }
        return obj;
    }

    public static Object beforeCheckcastToFunctionOfArity(Object obj, int r1, String str) {
        if (obj != null && !isFunctionOfArity(obj, r1)) {
            throwCce(str);
        }
        return obj;
    }
