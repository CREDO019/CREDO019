...
public class Intrinsics {
    ...
    public static void reifiedOperationMarker(int r0, String str) {
        throwUndefinedForReified();
    }

    public static void reifiedOperationMarker(int r0, String str, String str2) {
    ...
    public static <T extends Throwable> T sanitizeStackTrace(T t, String str) {
        ...
        t.setStackTrace((StackTraceElement[]) Arrays.copyOfRange(stackTrace, r2 + 1, length));
        return t;
    }
