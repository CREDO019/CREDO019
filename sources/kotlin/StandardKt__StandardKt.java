...
class StandardKt__StandardKt {
    ...
    private static final void repeat(int r2, Function1<? super Integer, Unit> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        for (int r0 = 0; r0 < r2; r0++) {
            action.invoke(Integer.valueOf(r0));
        }
    }
}
