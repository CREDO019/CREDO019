...
class StringBuilderJVM extends RegexExtensions {
    ...
    private static final void set(StringBuilder sb, int r2, char c) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.setCharAt(r2, c);
    }

    private static final StringBuilder setRange(StringBuilder sb, int r2, int r3, String value) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        StringBuilder replace = sb.replace(r2, r3, value);
        Intrinsics.checkNotNullExpressionValue(replace, "this.replace(startIndex, endIndex, value)");
        return replace;
    }

    private static final StringBuilder deleteAt(StringBuilder sb, int r2) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        StringBuilder deleteCharAt = sb.deleteCharAt(r2);
        Intrinsics.checkNotNullExpressionValue(deleteCharAt, "this.deleteCharAt(index)");
        return deleteCharAt;
    }

    private static final StringBuilder deleteRange(StringBuilder sb, int r2, int r3) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        StringBuilder delete = sb.delete(r2, r3);
        Intrinsics.checkNotNullExpressionValue(delete, "this.delete(startIndex, endIndex)");
        return delete;
    }

    static /* synthetic */ void toCharArray$default(StringBuilder sb, char[] destination, int r3, int r4, int r5, int r6, Object obj) {
        if ((r6 & 2) != 0) {
            r3 = 0;
        }
        if ((r6 & 4) != 0) {
        ...
        sb.getChars(r4, r5, destination, r3);
    }

    private static final void toCharArray(StringBuilder sb, char[] destination, int r3, int r4, int r5) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        sb.getChars(r4, r5, destination, r3);
    }

    private static final StringBuilder appendRange(StringBuilder sb, char[] value, int r3, int r4) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        sb.append(value, r3, r4 - r3);
        Intrinsics.checkNotNullExpressionValue(sb, "this.append(value, start…x, endIndex - startIndex)");
        return sb;
    }

    private static final StringBuilder appendRange(StringBuilder sb, CharSequence value, int r3, int r4) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        sb.append(value, r3, r4);
        Intrinsics.checkNotNullExpressionValue(sb, "this.append(value, startIndex, endIndex)");
        return sb;
    }

    private static final StringBuilder insertRange(StringBuilder sb, int r2, char[] value, int r4, int r5) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        StringBuilder insert = sb.insert(r2, value, r4, r5 - r4);
        Intrinsics.checkNotNullExpressionValue(insert, "this.insert(index, value…x, endIndex - startIndex)");
        return insert;
    }

    private static final StringBuilder insertRange(StringBuilder sb, int r2, CharSequence value, int r4, int r5) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        StringBuilder insert = sb.insert(r2, value, r4, r5);
    ...
    private static final StringBuilder appendLine(StringBuilder sb, int r2) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.append(r2);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value)");
        sb.append('\n');
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    private static final StringBuilder appendln(StringBuilder sb, int r2) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.append(r2);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value)");
        return StringsKt.appendln(sb);
