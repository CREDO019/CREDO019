...
@Metadata(m184d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m183d2 = {"<anonymous>", "", "Lkotlin/sequences/SequenceScope;", ""}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
@DebugMetadata(m175c = "kotlin.text.Regex$splitToSequence$1", m174f = "Regex.kt", m173i = {1, 1, 1}, m172l = {276, 284, 288}, m171m = "invokeSuspend", m170n = {"$this$sequence", "matcher", "splitCount"}, m169s = {"L$0", "L$1", "I$0"})
...
public final class Regex$splitToSequence$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
    ...
    public Regex$splitToSequence$1(Regex regex, CharSequence charSequence, int r3, Continuation<? super Regex$splitToSequence$1> continuation) {
