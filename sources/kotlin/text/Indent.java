...
@Metadata(m184d1 = {"\u0000\u001e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\b\u000b\u001a!\u0010\u0000\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\u0006\u0010\u0003\u001a\u00020\u0002H\u0002¢\u0006\u0002\b\u0004\u001a\u0011\u0010\u0005\u001a\u00020\u0006*\u00020\u0002H\u0002¢\u0006\u0002\b\u0007\u001a\u0014\u0010\b\u001a\u00020\u0002*\u00020\u00022\b\b\u0002\u0010\u0003\u001a\u00020\u0002\u001aJ\u0010\t\u001a\u00020\u0002*\b\u0012\u0004\u0012\u00020\u00020\n2\u0006\u0010\u000b\u001a\u00020\u00062\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\u0014\u0010\r\u001a\u0010\u0012\u0004\u0012\u00020\u0002\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001H\u0082\b¢\u0006\u0002\b\u000e\u001a\u0014\u0010\u000f\u001a\u00020\u0002*\u00020\u00022\b\b\u0002\u0010\u0010\u001a\u00020\u0002\u001a\u001e\u0010\u0011\u001a\u00020\u0002*\u00020\u00022\b\b\u0002\u0010\u0010\u001a\u00020\u00022\b\b\u0002\u0010\u0012\u001a\u00020\u0002\u001a\n\u0010\u0013\u001a\u00020\u0002*\u00020\u0002\u001a\u0014\u0010\u0014\u001a\u00020\u0002*\u00020\u00022\b\b\u0002\u0010\u0012\u001a\u00020\u0002¨\u0006\u0015"}, m183d2 = {"getIndentFunction", "Lkotlin/Function1;", "", "indent", "getIndentFunction$StringsKt__IndentKt", "indentWidth", "", "indentWidth$StringsKt__IndentKt", "prependIndent", "reindent", "", "resultSizeEstimate", "indentAddFunction", "indentCutFunction", "reindent$StringsKt__IndentKt", "replaceIndent", "newIndent", "replaceIndentByMargin", "marginPrefix", "trimIndent", "trimMargin", "kotlin-stdlib"}, m182k = 5, m181mv = {1, 6, 0}, m179xi = 49, m178xs = "kotlin/text/StringsKt")
/* renamed from: kotlin.text.StringsKt__IndentKt */
/* loaded from: classes5.dex */
public class Indent extends Appendable {
    public static /* synthetic */ String trimMargin$default(String str, String str2, int r2, Object obj) {
        if ((r2 & 1) != 0) {
            str2 = "|";
        }
    ...
    public static /* synthetic */ String replaceIndentByMargin$default(String str, String str2, String str3, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            str2 = "";
        }
        if ((r3 & 2) != 0) {
    ...
    public static final String replaceIndentByMargin(String str, String newIndent, String marginPrefix) {
        ...
        for (Object obj : lines) {
            ...
            String str4 = null;
            if ((r0 == 0 || r0 == lastIndex) && StringsKt.isBlank(str3)) {
                str3 = null;
            } else {
                ...
                while (true) {
                    if (r2 >= length2) {
                        r5 = -1;
                        break;
                    } else if (!CharsKt.isWhitespace(str2.charAt(r2))) {
                        r5 = r2;
                        break;
                    } else {
                        r2++;
                ...
                if (r5 != -1) {
                    int r17 = r5;
                    if (StringsKt.startsWith$default(str3, marginPrefix, r5, false, 4, (Object) null)) {
                        str4 = str3.substring(r17 + marginPrefix.length());
    ...
    public static /* synthetic */ String replaceIndent$default(String str, String str2, int r2, Object obj) {
        if ((r2 & 1) != 0) {
            str2 = "";
        }
    ...
    public static final String replaceIndent(String str, String newIndent) {
        ...
        for (Object obj2 : list) {
            ...
            if ((r5 == 0 || r5 == lastIndex) && StringsKt.isBlank(str3)) {
                str3 = null;
            } else {
    ...
    public static /* synthetic */ String prependIndent$default(String str, String str2, int r2, Object obj) {
        if ((r2 & 1) != 0) {
            str2 = "    ";
        }
    ...
    private static final String reindent$StringsKt__IndentKt(List<String> list, int r13, Function1<? super String, String> function1, Function1<? super String, String> function12) {
        Appendable joinTo;
        String invoke;
        ...
        for (Object obj : list) {
            ...
            if ((r2 == 0 || r2 == lastIndex) && StringsKt.isBlank(str)) {
                str = null;
            } else {
        ...
        joinTo = CollectionsKt.joinTo(arrayList, new StringBuilder(r13), (r14 & 2) != 0 ? ", " : "\n", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : null);
        String sb = ((StringBuilder) joinTo).toString();
        Intrinsics.checkNotNullExpressionValue(sb, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return sb;
    }
