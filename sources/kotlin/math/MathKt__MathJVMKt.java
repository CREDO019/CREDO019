...
public class MathKt__MathJVMKt extends MathH {
    ...
    /* renamed from: ln */
    private static final double m164ln(double d) {
        return Math.log(d);
    }
    ...
    private static final double pow(double d, int r4) {
        return Math.pow(d, r4);
    }
    ...
    private static final double withSign(double d, int r4) {
        return Math.copySign(d, r4);
    }
    ...
    /* renamed from: ln */
    private static final float m163ln(float f) {
    ...
    private static final float pow(float f, int r3) {
        return (float) Math.pow(f, r3);
    }
    ...
    private static final float withSign(float f, int r1) {
        return Math.copySign(f, r1);
    }
