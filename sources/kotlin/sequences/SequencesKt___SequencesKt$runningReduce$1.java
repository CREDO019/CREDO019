...
@Metadata(m184d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\b\b\u0001\u0010\u0003*\u0002H\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@"}, m183d2 = {"<anonymous>", "", ExifInterface.LATITUDE_SOUTH, "T", "Lkotlin/sequences/SequenceScope;"}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
@DebugMetadata(m175c = "kotlin.sequences.SequencesKt___SequencesKt$runningReduce$1", m174f = "_Sequences.kt", m173i = {0, 0, 0, 1, 1, 1}, m172l = {2173, 2176}, m171m = "invokeSuspend", m170n = {"$this$sequence", "iterator", "accumulator", "$this$sequence", "iterator", "accumulator"}, m169s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2"})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 == 0) {
            ...
            if (it2.hasNext()) {
                ...
                this.L$2 = next;
                this.label = 1;
                if (sequenceScope.yield(next, this) == obj2) {
                    return obj2;
                }
                it = it2;
            }
