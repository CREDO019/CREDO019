...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    /* synthetic */ KFunctionImpl(KDeclarationContainerImpl kDeclarationContainerImpl, String str, String str2, FunctionDescriptor functionDescriptor, Object obj, int r12, DefaultConstructorMarker defaultConstructorMarker) {
        this(kDeclarationContainerImpl, str, str2, functionDescriptor, (r12 & 16) != 0 ? CallableReference.NO_RECEIVER : obj);
    }
    ...
    private KFunctionImpl(KDeclarationContainerImpl kDeclarationContainerImpl, final String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.descriptor$delegate = ReflectProperties.lazySoft(functionDescriptor, new Functions<FunctionDescriptor>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$descriptor$2
        ...
        this.caller$delegate = ReflectProperties.lazy(new Functions<Caller<? extends Member>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$caller$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final Caller<? extends Member> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!Modifier.isStatic(method3.getModifiers())) {
                        ...
                        createJvmStaticInObjectCaller = KFunctionImpl.this.getDescriptor().getAnnotations().mo3005findAnnotation(UtilKt.getJVM_STATIC()) != null ? KFunctionImpl.this.createJvmStaticInObjectCaller(method3) : KFunctionImpl.this.createStaticMethodCaller(method3);
                    }
        ...
        this.defaultCaller$delegate = ReflectProperties.lazy(new Functions<Caller<? extends Member>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final Caller<? extends Member> invoke() {
                ...
                if (mapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Intrinsics.checkNotNull(KFunctionImpl.this.getCaller().mo2998getMember());
                    constructor = container.findDefaultMethod(methodName, methodDesc, !Modifier.isStatic(mo2998getMember.getModifiers()));
                ...
                if (constructor instanceof Constructor) {
                    ...
                    method = (KFunctionImpl.this.getDescriptor().getAnnotations().mo3005findAnnotation(UtilKt.getJVM_STATIC()) == null || ((ClassDescriptor) KFunctionImpl.this.getDescriptor().getContainingDeclaration()).isCompanionObject()) ? KFunctionImpl.this.createStaticMethodCaller((Method) constructor) : KFunctionImpl.this.createJvmStaticInObjectCaller((Method) constructor);
                } else {
                    method = null;
                }
                if (method == null) {
