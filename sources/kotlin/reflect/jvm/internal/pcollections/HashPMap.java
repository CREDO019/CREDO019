...
public final class HashPMap<K, V> {
    ...
    private HashPMap(IntTreePMap<ConsPStack<MapEntry<K, V>>> intTreePMap, int r2) {
    ...
    private ConsPStack<MapEntry<K, V>> getEntries(int r2) {
        ConsPStack<MapEntry<K, V>> consPStack = this.intMap.get(r2);
