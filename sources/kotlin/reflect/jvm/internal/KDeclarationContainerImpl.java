...
public abstract class KDeclarationContainerImpl implements ClassBasedDeclarationContainer {
    ...
    public abstract class Data {
        ...
        public Data(final KDeclarationContainerImpl this$0) {
            ...
            this.this$0 = this$0;
            this.moduleData$delegate = ReflectProperties.lazySoft(new Functions<RuntimeModuleData>() { // from class: kotlin.reflect.jvm.internal.KDeclarationContainerImpl$Data$moduleData$2
    ...
    */
    ...
    /* compiled from: KDeclarationContainerImpl.kt */
    @Metadata(m184d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0084\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006j\u0002\b\u0007j\u0002\b\b¨\u0006\t"}, m183d2 = {"Lkotlin/reflect/jvm/internal/KDeclarationContainerImpl$MemberBelonginess;", "", "(Ljava/lang/String;I)V", "accept", "", "member", "Lkotlin/reflect/jvm/internal/impl/descriptors/CallableMemberDescriptor;", "DECLARED", "INHERITED", "kotlin-reflection"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes5.dex */
    ...
    private final Method lookupMethod(Class<?> cls, String str, Class<?>[] clsArr, Class<?> cls2, boolean z) {
        ...
        if (tryGetMethod == null && ((superclass = cls.getSuperclass()) == null || (tryGetMethod = lookupMethod(superclass, str, clsArr, cls2, z)) == null)) {
            ...
            int r2 = 0;
            while (r2 < length) {
                Class<?> superInterface = interfaces[r2];
                r2++;
                Intrinsics.checkNotNullExpressionValue(superInterface, "superInterface");
                Method lookupMethod = lookupMethod(superInterface, str, clsArr, cls2, z);
                if (lookupMethod == null) {
                    if (z && (tryLoadClass = ReflectJavaClassFinderKt.tryLoadClass(reflectClassUtil.getSafeClassLoader(superInterface), Intrinsics.stringPlus(superInterface.getName(), "$DefaultImpls"))) != null) {
    ...
    private final List<Class<?>> loadParameterTypes(String str) {
        ...
        while (str.charAt(r8) != ')') {
            ...
            if (StringsKt.contains$default((CharSequence) "VZCBSIFJD", charAt, false, 2, (Object) null)) {
                indexOf$default = r2 + 1;
            } else if (charAt == 'L') {
                indexOf$default = StringsKt.indexOf$default((CharSequence) str, ';', r8, false, 4, (Object) null) + 1;
            } else {
                throw new KotlinReflectionInternalError(Intrinsics.stringPlus("Unknown type prefix in the method signature: ", str));
            }
            arrayList.add(parseType(str, r8, indexOf$default));
            r8 = indexOf$default;
        }
        return arrayList;
    }

    private final Class<?> parseType(String str, int r9, int r10) {
        char charAt = str.charAt(r9);
        if (charAt == 'L') {
            ClassLoader safeClassLoader = reflectClassUtil.getSafeClassLoader(getJClass());
            String substring = str.substring(r9 + 1, r10 - 1);
            ...
            return UtilKt.createArrayType(parseType(str, r9 + 1, r10));
        } else {
            if (charAt == 'V') {
    ...
    /* compiled from: KDeclarationContainerImpl.kt */
    @Metadata(m184d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001e\u0010\u0003\u001a\u0012\u0012\u0002\b\u0003 \u0005*\b\u0012\u0002\b\u0003\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\u00020\u0007X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\t¨\u0006\n"}, m183d2 = {"Lkotlin/reflect/jvm/internal/KDeclarationContainerImpl$Companion;", "", "()V", "DEFAULT_CONSTRUCTOR_MARKER", "Ljava/lang/Class;", "kotlin.jvm.PlatformType", "LOCAL_PROPERTY_SIGNATURE", "Lkotlin/text/Regex;", "getLOCAL_PROPERTY_SIGNATURE$kotlin_reflection", "()Lkotlin/text/Regex;", "kotlin-reflection"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes5.dex */
