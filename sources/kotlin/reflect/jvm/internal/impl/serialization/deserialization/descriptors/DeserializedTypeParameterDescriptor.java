...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: c */
    private final DeserializationContext f1531c;
    ...
    */
    ...
    protected List<KotlinType> resolveUpperBounds() {
        List<ProtoBuf.Type> upperBounds = protoTypeTableUtil.upperBounds(this.proto, this.f1531c.getTypeTable());
        if (upperBounds.isEmpty()) {
            return CollectionsKt.listOf(DescriptorUtils.getBuiltIns(this).getDefaultBound());
        }
        List<ProtoBuf.Type> list = upperBounds;
        TypeDeserializer typeDeserializer = this.f1531c.getTypeDeserializer();
    ...
    public Void mo3014reportSupertypeLoopError(KotlinType type) {
