...
public final class AnnotationAndConstantLoaderImpl implements AnnotationAndConstantLoader<AnnotationDescriptor, ConstantValue<?>> {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            r0[AnnotatedCallableKind.PROPERTY.ordinal()] = 1;
            r0[AnnotatedCallableKind.PROPERTY_GETTER.ordinal()] = 2;
            r0[AnnotatedCallableKind.PROPERTY_SETTER.ordinal()] = 3;
    ...
    public List<AnnotationDescriptor> loadCallableAnnotations(ProtoContainer container, MessageLite proto, AnnotatedCallableKind kind) {
        ...
        if (proto instanceof ProtoBuf.Constructor) {
            ...
            int r6 = WhenMappings.$EnumSwitchMapping$0[kind.ordinal()];
            if (r6 == 1) {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.serialization.deserialization.AnnotationAndConstantLoader
    public List<AnnotationDescriptor> loadValueParameterAnnotations(ProtoContainer container, MessageLite callableProto, AnnotatedCallableKind kind, int r5, ProtoBuf.ValueParameter proto) {
        Intrinsics.checkNotNullParameter(container, "container");
