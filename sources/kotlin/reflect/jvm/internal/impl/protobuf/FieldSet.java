...
public final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    public FieldSet<FieldDescriptorType> clone() {
        ...
        for (int r1 = 0; r1 < this.fields.getNumArrayEntries(); r1++) {
            Map.Entry<FieldDescriptorType, Object> arrayEntryAt = this.fields.getArrayEntryAt(r1);
    ...
    public Object getRepeatedField(FieldDescriptorType fielddescriptortype, int r3) {
        if (!fielddescriptortype.isRepeated()) {
            throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
        }
        Object field = getField(fielddescriptortype);
    ...
    */
    private static void verifyType(kotlin.reflect.jvm.internal.impl.protobuf.WireFormat.FieldType r2, java.lang.Object r3) {
        /*
            ...
            int[] r0 = kotlin.reflect.jvm.internal.impl.protobuf.FieldSet.C48371.$SwitchMap$com$google$protobuf$WireFormat$JavaType
    ...
    public boolean isInitialized() {
        for (int r1 = 0; r1 < this.fields.getNumArrayEntries(); r1++) {
            if (!isInitialized(this.fields.getArrayEntryAt(r1))) {
                return false;
            }
        }
        for (Map.Entry<FieldDescriptorType, Object> entry : this.fields.getOverflowEntries()) {
    ...
    public void mergeFrom(FieldSet<FieldDescriptorType> fieldSet) {
        for (int r0 = 0; r0 < fieldSet.fields.getNumArrayEntries(); r0++) {
            mergeFromField(fieldSet.fields.getArrayEntryAt(r0));
        }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C48371 {
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z) throws IOException {
        switch (C48371.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    private static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int r3, Object obj) throws IOException {
        if (fieldType == WireFormat.FieldType.GROUP) {
            codedOutputStream.writeGroup(r3, (MessageLite) obj);
            return;
        }
        codedOutputStream.writeTag(r3, getWireFormatForFieldType(fieldType, false));
        ...
        if (fieldDescriptorLite.isRepeated()) {
            ...
            if (fieldDescriptorLite.isPacked()) {
                ...
                for (Object obj2 : list) {
                    r3 += computeElementSizeNoTag(liteType, obj2);
                }
                codedOutputStream.writeRawVarint32(r3);
    ...
    public int getSerializedSize() {
        int r1 = 0;
        for (int r0 = 0; r0 < this.fields.getNumArrayEntries(); r0++) {
            Map.Entry<FieldDescriptorType, Object> arrayEntryAt = this.fields.getArrayEntryAt(r0);
    ...
    private static int computeElementSize(WireFormat.FieldType fieldType, int r2, Object obj) {
        ...
        if (fieldDescriptorLite.isRepeated()) {
            ...
            if (fieldDescriptorLite.isPacked()) {
                for (Object obj2 : (List) obj) {
                    r2 += computeElementSizeNoTag(liteType, obj2);
                }
                return CodedOutputStream.computeTagSize(number) + r2 + CodedOutputStream.computeRawVarint32Size(r2);
            }
            for (Object obj3 : (List) obj) {
                r2 += computeElementSize(liteType, number, obj3);
            }
            return r2;
        }
