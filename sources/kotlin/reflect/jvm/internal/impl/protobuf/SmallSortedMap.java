...
public class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> SmallSortedMap<FieldDescriptorType, Object> newFieldMap(int r1) {
        return (SmallSortedMap<FieldDescriptorType, Object>) new SmallSortedMap<FieldDescriptorType, Object>(r1) { // from class: kotlin.reflect.jvm.internal.impl.protobuf.SmallSortedMap.1
            @Override // kotlin.reflect.jvm.internal.impl.protobuf.SmallSortedMap, java.util.AbstractMap, java.util.Map
            public /* bridge */ /* synthetic */ Object put(Object obj, Object obj2) {
                return super.put((C48421<FieldDescriptorType>) ((FieldSet.FieldDescriptorLite) obj), (FieldSet.FieldDescriptorLite) obj2);
            }
            ...
            public void makeImmutable() {
                if (!isImmutable()) {
                    for (int r0 = 0; r0 < getNumArrayEntries(); r0++) {
                        Map.Entry<FieldDescriptorType, Object> arrayEntryAt = getArrayEntryAt(r0);
    ...
    public Map.Entry<K, V> getArrayEntryAt(int r2) {
    ...
    public V removeArrayEntryAt(int r5) {
        checkMutable();
        V value = this.entryList.remove(r5).getValue();
        if (!this.overflowEntries.isEmpty()) {
    ...
    private int binarySearchInArray(K k) {
        ...
        while (r1 <= size) {
            int r2 = (r1 + size) / 2;
            int compareTo2 = k.compareTo(this.entryList.get(r2).getKey());
            if (compareTo2 < 0) {
                size = r2 - 1;
    ...
    private class EntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        public Map.Entry<K, V> next() {
            ...
            int r1 = this.pos + 1;
            this.pos = r1;
            if (r1 < SmallSortedMap.this.entryList.size()) {
