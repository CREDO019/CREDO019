...
public final class JavaTypeResolverKt {
    ...
    public static /* synthetic */ JavaTypeAttributes toAttributes$default(TypeUsage typeUsage, boolean z, TypeParameterDescriptor typeParameterDescriptor, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            z = false;
        }
        if ((r3 & 2) != 0) {
