...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    /* renamed from: c */
    private final LazyJavaResolverContext f1507c;
    ...
    public /* synthetic */ LazyJavaClassDescriptor(LazyJavaResolverContext lazyJavaResolverContext, DeclarationDescriptor declarationDescriptor, JavaClass javaClass, ClassDescriptor classDescriptor, int r5, DefaultConstructorMarker defaultConstructorMarker) {
        this(lazyJavaResolverContext, declarationDescriptor, javaClass, (r5 & 8) != 0 ? null : classDescriptor);
    }
    ...
    public LazyJavaClassDescriptor(LazyJavaResolverContext outerContext, DeclarationDescriptor containingDeclaration, JavaClass jClass, ClassDescriptor classDescriptor) {
        ...
        this.f1507c = childForClassOrPackage$default;
        ...
        this.moduleAnnotations$delegate = LazyKt.lazy(new Functions<List<? extends javaElements>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$moduleAnnotations$2
            ...
            public final List<? extends javaElements> invoke() {
                ClassId classId = DescriptorUtils.getClassId(LazyJavaClassDescriptor.this);
                if (classId == null) {
                    return null;
                }
        ...
        this.scopeHolder = ScopesHolderForClass.Companion.create(lazyJavaClassDescriptor, childForClassOrPackage$default.getStorageManager(), childForClassOrPackage$default.getComponents().getKotlinTypeChecker().getKotlinTypeRefiner(), new Function1<KotlinTypeRefiner, LazyJavaClassMemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$scopeHolder$1
            ...
            public final LazyJavaClassMemberScope invoke(KotlinTypeRefiner it) {
                ...
                LazyJavaResolverContext lazyJavaResolverContext = LazyJavaClassDescriptor.this.f1507c;
        ...
        this.declaredParameters = childForClassOrPackage$default.getStorageManager().createLazyValue(new Functions<List<? extends TypeParameterDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$declaredParameters$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final List<? extends TypeParameterDescriptor> invoke() {
                ...
                for (JavaTypeParameter javaTypeParameter : typeParameters) {
                    TypeParameterDescriptor resolveTypeParameter = lazyJavaClassDescriptor2.f1507c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter);
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            for (JavaClassifierType javaClassifierType : this.jClass.getPermittedTypes()) {
                ClassifierDescriptor mo3011getDeclarationDescriptor = this.f1507c.getTypeResolver().transformJavaType(javaClassifierType, attributes$default).getConstructor().mo3011getDeclarationDescriptor();
    ...
    public String toString() {
        return Intrinsics.stringPlus("Lazy Java class ", DescriptorUtils.getFqNameUnsafe(this));
    }
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public LazyJavaClassTypeConstructor(final LazyJavaClassDescriptor this$0) {
            super(this$0.f1507c.getStorageManager());
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            this.this$0 = this$0;
            this.parameters = this$0.f1507c.getStorageManager().createLazyValue(new Functions<List<? extends TypeParameterDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$LazyJavaClassTypeConstructor$parameters$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                KotlinType enhanceSuperType = this.this$0.f1507c.getComponents().getSignatureEnhancement().enhanceSuperType(this.this$0.f1507c.getTypeResolver().transformJavaType(next, JavaTypeResolverKt.toAttributes$default(TypeUsage.SUPERTYPE, false, null, 3, null)), this.this$0.f1507c);
                if (enhanceSuperType.getConstructor().mo3011getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            collections.addIfNotNull(arrayList3, classDescriptor != null ? mappingUtil.createMappedTypeParametersSubstitution(classDescriptor, this.this$0).buildSubstitutor().substitute(classDescriptor.getDefaultType(), Variance.INVARIANT) : null);
            collections.addIfNotNull(arrayList3, purelyImplementedSupertype);
            if (!arrayList2.isEmpty()) {
                ErrorReporter errorReporter = this.this$0.f1507c.getComponents().getErrorReporter();
                ClassDescriptor mo3011getDeclarationDescriptor = mo3011getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(mo3011getDeclarationDescriptor, arrayList5);
            }
            return arrayList3.isEmpty() ^ true ? CollectionsKt.toList(arrayList) : CollectionsKt.listOf(this.this$0.f1507c.getModule().getBuiltIns().getAnyType());
        }
        ...
        */
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo3005findAnnotation = annotations.mo3005findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (mo3005findAnnotation == null) {
                return null;
            }
            Object singleOrNull = CollectionsKt.singleOrNull(mo3005findAnnotation.getAllValueArguments().values());
            StringValue stringValue = singleOrNull instanceof StringValue ? (StringValue) singleOrNull : null;
            if (stringValue == null) {
                return null;
            }
            String value = stringValue.getValue();
            if (FqNamesUtil.isValidJavaFqName(value)) {
        ...
        public SupertypeLoopChecker getSupertypeLoopChecker() {
            return this.this$0.f1507c.getComponents().getSupertypeLoopChecker();
        }
    ...
    public final LazyJavaClassDescriptor copy$descriptors_jvm(JavaResolverCache javaResolverCache, ClassDescriptor classDescriptor) {
        ...
        LazyJavaResolverContext lazyJavaResolverContext = this.f1507c;
