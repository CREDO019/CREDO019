...
public final class JavaTargetAnnotationDescriptor extends JavaAnnotationDescriptor {
    ...
    public JavaTargetAnnotationDescriptor(javaElements annotation, LazyJavaResolverContext c) {
        ...
        this.allValueArguments$delegate = c.getStorageManager().createLazyValue(new Functions<Map<Name, ? extends ConstantValue<? extends Object>>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.components.JavaTargetAnnotationDescriptor$allValueArguments$2
            ...
            public final Map<Name, ? extends ConstantValue<? extends Object>> invoke() {
                ...
                annotationArguments firstArgument = JavaTargetAnnotationDescriptor.this.getFirstArgument();
                ...
                Map<Name, ? extends ConstantValue<? extends Object>> mapOf = mapJavaTargetArguments$descriptors_jvm != null ? MapsKt.mapOf(TuplesKt.m176to(JavaAnnotationMapper.INSTANCE.getTARGET_ANNOTATION_ALLOWED_TARGETS$descriptors_jvm(), mapJavaTargetArguments$descriptors_jvm)) : null;
