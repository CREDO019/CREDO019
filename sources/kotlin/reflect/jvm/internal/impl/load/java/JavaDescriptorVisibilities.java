...
public class JavaDescriptorVisibilities {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int r9) {
        String str = (r9 == 5 || r9 == 6) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
        Object[] objArr = new Object[(r9 == 5 || r9 == 6) ? 2 : 3];
        switch (r9) {
            case 1:
