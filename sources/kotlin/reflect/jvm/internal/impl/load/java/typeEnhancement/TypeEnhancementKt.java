...
public final class TypeEnhancementKt {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            int[] r0 = new int[NullabilityQualifier.values().length];
            r0[NullabilityQualifier.NULLABLE.ordinal()] = 1;
            r0[NullabilityQualifier.NOT_NULL.ordinal()] = 2;
    ...
    public static final Boolean getEnhancedNullability(typeQualifiers typequalifiers, TypeComponentPosition typeComponentPosition) {
        if (TypeComponentPositionKt.shouldEnhance(typeComponentPosition)) {
            ...
            int r1 = nullability == null ? -1 : WhenMappings.$EnumSwitchMapping$0[nullability.ordinal()];
            if (r1 != 1) {
                return r1 != 2 ? null : false;
            }
            return true;
        }
        return null;
