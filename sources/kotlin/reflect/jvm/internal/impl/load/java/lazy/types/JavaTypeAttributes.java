...
public final class JavaTypeAttributes {
    ...
    public static /* synthetic */ JavaTypeAttributes copy$default(JavaTypeAttributes javaTypeAttributes, TypeUsage typeUsage, JavaTypeFlexibility javaTypeFlexibility, boolean z, Set set, SimpleType simpleType, int r9, Object obj) {
        if ((r9 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (r0 + (set == null ? 0 : set.hashCode())) * 31;
    ...
    public /* synthetic */ JavaTypeAttributes(TypeUsage typeUsage, JavaTypeFlexibility javaTypeFlexibility, boolean z, Set set, SimpleType simpleType, int r12, DefaultConstructorMarker defaultConstructorMarker) {
        this(typeUsage, (r12 & 2) != 0 ? JavaTypeFlexibility.INFLEXIBLE : javaTypeFlexibility, (r12 & 4) != 0 ? false : z, (r12 & 8) != 0 ? null : set, (r12 & 16) != 0 ? null : simpleType);
    }
