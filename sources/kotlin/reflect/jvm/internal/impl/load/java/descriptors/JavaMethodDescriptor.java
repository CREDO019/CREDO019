...
public class JavaMethodDescriptor extends SimpleFunctionDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int r11) {
        String str = (r11 == 12 || r11 == 17 || r11 == 20) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
        Object[] objArr = new Object[(r11 == 12 || r11 == 17 || r11 == 20) ? 2 : 3];
        switch (r11) {
            case 1:
            case 6:
            case 15:
    ...
    public /* bridge */ /* synthetic */ JavaCallableMemberDescriptor enhance(KotlinType kotlinType, List list, KotlinType kotlinType2, Tuples tuples) {
        return enhance(kotlinType, (List<ValueParameterData>) list, kotlinType2, (Tuples<CallableDescriptor.UserDataKey<?>, ?>) tuples);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.java.descriptors.JavaCallableMemberDescriptor
    public JavaMethodDescriptor enhance(KotlinType kotlinType, List<ValueParameterData> list, KotlinType kotlinType2, Tuples<CallableDescriptor.UserDataKey<?>, ?> tuples) {
        if (list == null) {
            $$$reportNull$$$0(18);
        }
        if (kotlinType2 == null) {
