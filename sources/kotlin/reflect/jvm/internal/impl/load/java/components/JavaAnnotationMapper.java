...
public final class JavaAnnotationMapper {
    ...
    static {
        ...
        kotlinToJavaNameMap = MapsKt.mapOf(TuplesKt.m176to(StandardNames.FqNames.target, JvmAnnotationNames.TARGET_ANNOTATION), TuplesKt.m176to(StandardNames.FqNames.retention, JvmAnnotationNames.RETENTION_ANNOTATION), TuplesKt.m176to(StandardNames.FqNames.mustBeDocumented, JvmAnnotationNames.DOCUMENTED_ANNOTATION));
        javaToKotlinNameMap = MapsKt.mapOf(TuplesKt.m176to(JvmAnnotationNames.TARGET_ANNOTATION, StandardNames.FqNames.target), TuplesKt.m176to(JvmAnnotationNames.RETENTION_ANNOTATION, StandardNames.FqNames.retention), TuplesKt.m176to(JvmAnnotationNames.DEPRECATED_ANNOTATION, StandardNames.FqNames.deprecated), TuplesKt.m176to(JvmAnnotationNames.DOCUMENTED_ANNOTATION, StandardNames.FqNames.mustBeDocumented));
    }
    ...
    public static /* synthetic */ AnnotationDescriptor mapOrResolveJavaAnnotation$default(JavaAnnotationMapper javaAnnotationMapper, javaElements javaelements, LazyJavaResolverContext lazyJavaResolverContext, boolean z, int r4, Object obj) {
        if ((r4 & 4) != 0) {
            z = false;
        }
