...
public class typeSignatureMapping<T> {
    ...
    protected final void writeJvmTypeAsIs(T type) {
        ...
        if (this.jvmCurrentType == null) {
            int r0 = this.jvmCurrentTypeArrayLevel;
            if (r0 > 0) {
                type = this.jvmTypeFactory.createFromString(Intrinsics.stringPlus(StringsKt.repeat("[", r0), this.jvmTypeFactory.toString(type)));
            }
