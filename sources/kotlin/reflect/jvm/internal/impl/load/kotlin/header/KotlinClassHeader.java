...
public final class KotlinClassHeader {
    ...
    private final boolean has(int r1, int r2) {
        return (r1 & r2) != 0;
    }

    public KotlinClassHeader(Kind kind, JvmMetadataVersion metadataVersion, String[] strArr, String[] strArr2, String[] strArr3, String str, int r8, String str2, byte[] bArr) {
    ...
    public enum Kind {
        ...
        /* renamed from: id */
        private final int f1517id;

        @JvmStatic
        public static final Kind getById(int r1) {
            return Companion.getById(r1);
        }
        ...
        public static final class Companion {
            ...
            @JvmStatic
            public final Kind getById(int r2) {
                Kind kind = (Kind) Kind.entryById.get(Integer.valueOf(r2));
