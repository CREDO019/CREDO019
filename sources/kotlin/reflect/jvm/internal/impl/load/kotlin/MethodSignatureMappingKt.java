...
public final class MethodSignatureMappingKt {
    ...
    public static /* synthetic */ String computeJvmDescriptor$default(FunctionDescriptor functionDescriptor, boolean z, boolean z2, int r4, Object obj) {
        if ((r4 & 1) != 0) {
            z = true;
        }
        if ((r4 & 2) != 0) {
    ...
    public static final boolean forceSingleValueParameterBoxing(CallableDescriptor f) {
        ...
        if (f instanceof FunctionDescriptor) {
            ...
            if (Intrinsics.areEqual(functionDescriptor.getName().asString(), "remove") && functionDescriptor.getValueParameters().size() == 1 && !C5828SpecialBuiltinMembers.isFromJavaOrBuiltins((CallableMemberDescriptor) f)) {
