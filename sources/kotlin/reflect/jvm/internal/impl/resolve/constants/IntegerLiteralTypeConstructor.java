...
public final class IntegerLiteralTypeConstructor implements TypeConstructor {
    ...
    public static final class Companion {
        ...
        public /* synthetic */ class WhenMappings {
            ...
            static {
                ...
                r0[Mode.COMMON_SUPER_TYPE.ordinal()] = 1;
                r0[Mode.INTERSECTION_TYPE.ordinal()] = 2;
        ...
        private final SimpleType fold(IntegerLiteralTypeConstructor integerLiteralTypeConstructor, IntegerLiteralTypeConstructor integerLiteralTypeConstructor2, Mode mode) {
            Set intersect;
            int r9 = WhenMappings.$EnumSwitchMapping$0[mode.ordinal()];
            if (r9 == 1) {
    ...
    private IntegerLiteralTypeConstructor(long j, ModuleDescriptor moduleDescriptor, Set<? extends KotlinType> set) {
        ...
        this.supertypes$delegate = LazyKt.lazy(new Functions<List<SimpleType>>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.constants.IntegerLiteralTypeConstructor$supertypes$2
