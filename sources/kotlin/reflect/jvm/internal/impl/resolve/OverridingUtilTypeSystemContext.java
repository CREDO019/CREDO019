...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public TypeArgumentMarker get(TypeArgumentListMarker typeArgumentListMarker, int r3) {
        return ClassicTypeSystemContext.DefaultImpls.get(this, typeArgumentListMarker, r3);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public TypeArgumentMarker getArgument(KotlinTypeMarker kotlinTypeMarker, int r2) {
        return ClassicTypeSystemContext.DefaultImpls.getArgument(this, kotlinTypeMarker, r2);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public TypeArgumentMarker getArgumentOrNull(SimpleTypeMarker simpleTypeMarker, int r3) {
        return ClassicTypeSystemContext.DefaultImpls.getArgumentOrNull(this, simpleTypeMarker, r3);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public TypeParameterMarker getParameter(TypeConstructorMarker typeConstructorMarker, int r2) {
        return ClassicTypeSystemContext.DefaultImpls.getParameter(this, typeConstructorMarker, r2);
    }
    ...
    public TypeCheckerState newTypeCheckerState(boolean z, boolean z2) {
        return ClassicTypeCheckerState.createClassicTypeCheckerState$default(z, z2, this, null, this.kotlinTypeRefiner, 8, null);
    }
