...
public final class CapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    public /* synthetic */ CapturedType(TypeProjection typeProjection, CapturedTypeConstructorImpl capturedTypeConstructorImpl, boolean z, Annotations annotations, int r5, DefaultConstructorMarker defaultConstructorMarker) {
        this(typeProjection, (r5 & 2) != 0 ? new CapturedTypeConstructorImpl(typeProjection) : capturedTypeConstructorImpl, (r5 & 4) != 0 ? false : z, (r5 & 8) != 0 ? Annotations.Companion.getEMPTY() : annotations);
    }
