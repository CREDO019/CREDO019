...
public final class StaticScopeForKotlinEnum extends MemberScopeImpl {
    ...
    public /* bridge */ /* synthetic */ ClassifierDescriptor mo3013getContributedClassifier(Name name, LookupLocation lookupLocation) {
    ...
    public StaticScopeForKotlinEnum(StorageManager storageManager, ClassDescriptor containingClass) {
        ...
        this.functions$delegate = storageManager.createLazyValue(new Functions<List<? extends SimpleFunctionDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.StaticScopeForKotlinEnum$functions$2
