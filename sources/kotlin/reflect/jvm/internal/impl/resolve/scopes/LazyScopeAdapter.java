...
public final class LazyScopeAdapter extends AbstractScopeAdapter {
    ...
    */
    ...
    public LazyScopeAdapter(StorageManager storageManager, final Functions<? extends MemberScope> getScope) {
        Intrinsics.checkNotNullParameter(storageManager, "storageManager");
        Intrinsics.checkNotNullParameter(getScope, "getScope");
        this.lazyScope = storageManager.createLazyValue(new Functions<MemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.LazyScopeAdapter$lazyScope$1
