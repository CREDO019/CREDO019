...
public final class SubstitutingScope implements MemberScope {
    ...
    public SubstitutingScope(MemberScope workerScope, TypeSubstitutor givenSubstitutor) {
        ...
        this._allDescriptors$delegate = LazyKt.lazy(new Functions<Collection<? extends DeclarationDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.SubstitutingScope$_allDescriptors$2
    ...
    public ClassifierDescriptor mo3013getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor contributedClassifier = this.workerScope.mo3013getContributedClassifier(name, location);
