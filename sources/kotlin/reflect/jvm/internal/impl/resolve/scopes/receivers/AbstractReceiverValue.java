...
public abstract class AbstractReceiverValue implements ReceiverValue {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int r7) {
        String str = (r7 == 1 || r7 == 2) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
        Object[] objArr = new Object[(r7 == 1 || r7 == 2) ? 2 : 3];
        if (r7 == 1 || r7 == 2) {
