...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            int[] r0 = new int[RenderingFormat.values().length];
            r0[RenderingFormat.PLAIN.ordinal()] = 1;
            r0[RenderingFormat.HTML.ordinal()] = 2;
            $EnumSwitchMapping$0 = r0;
            int[] r02 = new int[ParameterNameRenderingPolicy.values().length];
            r02[ParameterNameRenderingPolicy.ALL.ordinal()] = 1;
            r02[ParameterNameRenderingPolicy.ONLY_NON_SYNTHESIZED.ordinal()] = 2;
            r02[ParameterNameRenderingPolicy.NONE.ordinal()] = 3;
    ...
    public DescriptorRendererImpl(DescriptorRendererOptionsImpl options) {
        ...
        options.isLocked();
        this.functionTypeAnnotationsRenderer$delegate = LazyKt.lazy(new Functions<DescriptorRendererImpl>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$functionTypeAnnotationsRenderer$2
    ...
    private final String renderKeyword(String str) {
        int r0 = WhenMappings.$EnumSwitchMapping$0[getTextFormat().ordinal()];
        if (r0 != 1) {
            if (r0 == 2) {
    ...
    /* renamed from: lt */
    private final String m161lt() {
        return escape("<");
    }

    /* renamed from: gt */
    private final String m162gt() {
        return escape(">");
    }
    ...
    static /* synthetic */ void renderTypeConstructorAndArguments$default(DescriptorRendererImpl descriptorRendererImpl, StringBuilder sb, KotlinType kotlinType, TypeConstructor typeConstructor, int r4, Object obj) {
        if ((r4 & 2) != 0) {
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if (mo3011getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : mo3011getDeclarationDescriptor instanceof ClassDescriptor ? true : mo3011getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(mo3011getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(Intrinsics.stringPlus("Unexpected classifier: ", mo3011getDeclarationDescriptor.getClass()).toString());
    }
    ...
    static /* synthetic */ void renderAnnotations$default(DescriptorRendererImpl descriptorRendererImpl, StringBuilder sb, Annotated annotated, AnnotationUseSiteTarget annotationUseSiteTarget, int r4, Object obj) {
        if ((r4 & 2) != 0) {
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (annotationUseSiteTarget != null) {
            sb.append(Intrinsics.stringPlus(annotationUseSiteTarget.getRenderName(), ParameterizedMessage.ERROR_MSG_SEPARATOR));
        }
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo3011getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ...
        if (annotationClass != null && (mo3004getUnsubstitutedPrimaryConstructor = annotationClass.mo3004getUnsubstitutedPrimaryConstructor()) != null) {
    ...
    public final String renderConstant(ConstantValue<?> constantValue) {
        ...
        if (constantValue instanceof KClassValue) {
            ...
            if (value instanceof KClassValue.Value.LocalClass) {
                ...
                int r2 = 0;
                while (r2 < normalClass.getArrayDimensions()) {
                    r2++;
    ...
    */
    ...
    private final void renderValueParameters(Collection<? extends ValueParameterDescriptor> collection, boolean z, StringBuilder sb) {
        ...
        for (ValueParameterDescriptor valueParameterDescriptor : collection) {
            getValueParametersHandler().appendBeforeValueParameter(valueParameterDescriptor, r2, size, sb);
            renderValueParameter(valueParameterDescriptor, shouldRenderParameterNames, sb, false);
            getValueParametersHandler().appendAfterValueParameter(valueParameterDescriptor, r2, size, sb);
            r2++;
        }
    ...
    private final boolean shouldRenderParameterNames(boolean z) {
        int r0 = WhenMappings.$EnumSwitchMapping$1[getParameterNameRenderingPolicy().ordinal()];
        if (r0 != 1) {
            if (r0 != 2) {
                if (r0 == 3) {
                    return false;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:29:0x0092, code lost:
        if ((getDebugMode() ? r10.declaresDefaultValue() : kotlin.reflect.jvm.internal.impl.resolve.descriptorUtil.DescriptorUtils.declaresOrInheritsDefaultValue(r10)) != false) goto L23;
     */
    ...
    */
    ...
    static /* synthetic */ void renderValVarPrefix$default(DescriptorRendererImpl descriptorRendererImpl, VariableDescriptor variableDescriptor, StringBuilder sb, boolean z, int r4, Object obj) {
        if ((r4 & 4) != 0) {
            z = false;
        }
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ...
        if (!getIncludePropertyConstant() || (mo3006getCompileTimeInitializer = variableDescriptor.mo3006getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(mo3006getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo3004getUnsubstitutedPrimaryConstructor = classDescriptor.mo3004getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo3004getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo3004getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "primaryConstructor.visibility");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = mo3004getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "primaryConstructor.valueParameters");
            renderValueParameters(valueParameters, mo3004getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Intrinsics.checkNotNullExpressionValue(mo3012getSupertypes, "klass.typeConstructor.supertypes");
        if (mo3012getSupertypes.isEmpty()) {
            return;
        }
        if (mo3012getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo3012getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo3012getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    private final class RenderDeclarationDescriptorVisitor implements DeclarationDescriptorVisitor<Unit, StringBuilder> {
        ...
        public /* synthetic */ class WhenMappings {
            ...
            static {
                int[] r0 = new int[PropertyAccessorRenderingPolicy.values().length];
                r0[PropertyAccessorRenderingPolicy.PRETTY.ordinal()] = 1;
                r0[PropertyAccessorRenderingPolicy.DEBUG.ordinal()] = 2;
                r0[PropertyAccessorRenderingPolicy.NONE.ordinal()] = 3;
                $EnumSwitchMapping$0 = r0;
            }
        }
        ...
        private final void visitPropertyAccessorDescriptor(PropertyAccessorDescriptor propertyAccessorDescriptor, StringBuilder sb, String str) {
            int r0 = WhenMappings.$EnumSwitchMapping$0[this.this$0.getPropertyAccessorRenderingPolicy().ordinal()];
            if (r0 != 1) {
                if (r0 != 2) {
                    return;
                }
