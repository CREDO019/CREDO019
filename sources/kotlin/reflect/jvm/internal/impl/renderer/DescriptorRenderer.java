...
public abstract class DescriptorRenderer {
    ...
    public static /* synthetic */ String renderAnnotation$default(DescriptorRenderer descriptorRenderer, AnnotationDescriptor annotationDescriptor, AnnotationUseSiteTarget annotationUseSiteTarget, int r3, Object obj) {
        if (obj == null) {
            if ((r3 & 2) != 0) {
    ...
    public interface ValueParametersHandler {
        void appendAfterValueParameter(ValueParameterDescriptor valueParameterDescriptor, int r2, int r3, StringBuilder sb);

        void appendAfterValueParameters(int r1, StringBuilder sb);

        void appendBeforeValueParameter(ValueParameterDescriptor valueParameterDescriptor, int r2, int r3, StringBuilder sb);

        void appendBeforeValueParameters(int r1, StringBuilder sb);
        ...
        public static final class DEFAULT implements ValueParametersHandler {
            ...
            public void appendBeforeValueParameter(ValueParameterDescriptor parameter, int r2, int r3, StringBuilder builder) {
            ...
            @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer.ValueParametersHandler
            public void appendBeforeValueParameters(int r1, StringBuilder builder) {
                Intrinsics.checkNotNullParameter(builder, "builder");
                builder.append("(");
            }

            @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer.ValueParametersHandler
            public void appendAfterValueParameters(int r1, StringBuilder builder) {
                Intrinsics.checkNotNullParameter(builder, "builder");
                builder.append(")");
            }

            @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer.ValueParametersHandler
            public void appendAfterValueParameter(ValueParameterDescriptor parameter, int r3, int r4, StringBuilder builder) {
                Intrinsics.checkNotNullParameter(parameter, "parameter");
                Intrinsics.checkNotNullParameter(builder, "builder");
                if (r3 != r4 - 1) {
                    builder.append(", ");
    ...
    public static final class Companion {
        ...
        public /* synthetic */ class WhenMappings {
            ...
            static {
                int[] r0 = new int[ClassKind.values().length];
                r0[ClassKind.CLASS.ordinal()] = 1;
                r0[ClassKind.INTERFACE.ordinal()] = 2;
                r0[ClassKind.ENUM_CLASS.ordinal()] = 3;
                r0[ClassKind.OBJECT.ordinal()] = 4;
                r0[ClassKind.ANNOTATION_CLASS.ordinal()] = 5;
                r0[ClassKind.ENUM_ENTRY.ordinal()] = 6;
