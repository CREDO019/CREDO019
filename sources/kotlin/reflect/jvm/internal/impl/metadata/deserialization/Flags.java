...
public class Flags {
    ...
    */
    ...
    public static abstract class FlagField<E> {
        ...
        private FlagField(int r1, int r2) {
            this.offset = r1;
            this.bitWidth = r2;
        }
    }
    ...
    public static class BooleanFlagField extends FlagField<Boolean> {
        ...
        public BooleanFlagField(int r3) {
            super(r3, 1);
        }
        ...
        public Boolean get(int r3) {
            Boolean valueOf = Boolean.valueOf((r3 & (1 << this.offset)) != 0);
            if (valueOf == null) {
                $$$reportNull$$$0(0);
            }
            return valueOf;
    ...
    public static class EnumLiteFlagField<E extends Internal.EnumLite> extends FlagField<E> {
        ...
        public EnumLiteFlagField(int r3, E[] eArr) {
            super(r3, bitWidth(eArr));
            this.values = eArr;
        }
        ...
        public E get(int r6) {
            E[] eArr;
            int r62 = (r6 & (((1 << this.bitWidth) - 1) << this.offset)) >> this.offset;
            for (E e : this.values) {
                if (e.getNumber() == r62) {
                    return e;
                }
