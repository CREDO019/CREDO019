...
public abstract class ReflectJavaMember extends ReflectJavaElement implements ReflectJavaAnnotationOwner, ReflectJavaModifierListOwner, JavaMember {
    ...
    public final List<JavaValueParameter> getValueParameters(Type[] parameterTypes, Annotation[][] parameterAnnotations, boolean z) {
        ...
        while (r5 < length) {
            int r6 = r5 + 1;
            ReflectJavaType create = ReflectJavaType.Factory.create(parameterTypes[r5]);
            if (loadParameterNames == null) {
                str = null;
            } else {
                str = (String) CollectionsKt.getOrNull(loadParameterNames, r5 + size);
                if (str == null) {
                    throw new IllegalStateException(("No parameter with index " + r5 + '+' + size + " (name=" + getName() + " type=" + create + ") in " + this).toString());
                }
            }
            arrayList.add(new ReflectJavaValueParameter(create, parameterAnnotations[r5], str, z && r5 == ArraysKt.getLastIndex(parameterTypes)));
            r5 = r6;
        }
        return arrayList;
    }
