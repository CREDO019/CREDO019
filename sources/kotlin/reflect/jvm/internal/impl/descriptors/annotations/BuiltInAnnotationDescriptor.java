...
public final class BuiltInAnnotationDescriptor implements AnnotationDescriptor {
    ...
    public BuiltInAnnotationDescriptor(KotlinBuiltIns builtIns, FqName fqName, Map<Name, ? extends ConstantValue<?>> allValueArguments) {
        ...
        this.type$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Functions) new Functions<SimpleType>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.annotations.BuiltInAnnotationDescriptor$type$2
