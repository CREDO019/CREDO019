...
public enum KotlinTarget {
    ...
    /* synthetic */ KotlinTarget(String str, boolean z, int r5, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, (r5 & 2) != 0 ? true : z);
    }
    ...
    static {
        ...
        int r3 = 0;
        while (r3 < length) {
            KotlinTarget kotlinTarget = values[r3];
            r3++;
        ...
        int r5 = 0;
        while (r5 < length2) {
            KotlinTarget kotlinTarget2 = values2[r5];
            r5++;
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(TuplesKt.m176to(annotationUseSiteTarget, kotlinTarget10), TuplesKt.m176to(AnnotationUseSiteTarget.FIELD, kotlinTarget6), TuplesKt.m176to(AnnotationUseSiteTarget.PROPERTY, kotlinTarget5), TuplesKt.m176to(AnnotationUseSiteTarget.FILE, kotlinTarget9), TuplesKt.m176to(AnnotationUseSiteTarget.PROPERTY_GETTER, kotlinTarget8), TuplesKt.m176to(AnnotationUseSiteTarget.PROPERTY_SETTER, kotlinTarget7), TuplesKt.m176to(AnnotationUseSiteTarget.RECEIVER, kotlinTarget10), TuplesKt.m176to(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget10), TuplesKt.m176to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget6));
    }
