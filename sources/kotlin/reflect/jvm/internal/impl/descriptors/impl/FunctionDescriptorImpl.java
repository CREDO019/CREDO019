...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public FunctionDescriptorImpl initialize(ReceiverParameterDescriptor receiverParameterDescriptor, ReceiverParameterDescriptor receiverParameterDescriptor2, List<? extends TypeParameterDescriptor> list, List<ValueParameterDescriptor> list2, KotlinType kotlinType, Modality modality, DescriptorVisibility descriptorVisibility) {
        ...
        for (int r3 = 0; r3 < list.size(); r3++) {
            TypeParameterDescriptor typeParameterDescriptor = list.get(r3);
            if (typeParameterDescriptor.getIndex() != r3) {
                throw new IllegalStateException(typeParameterDescriptor + " index is " + typeParameterDescriptor.getIndex() + " but position is " + r3);
            }
        }
        for (int r2 = 0; r2 < list2.size(); r2++) {
            ValueParameterDescriptor valueParameterDescriptor = list2.get(r2);
            if (valueParameterDescriptor.getIndex() != r2 + 0) {
                throw new IllegalStateException(valueParameterDescriptor + "index is " + valueParameterDescriptor.getIndex() + " but position is " + r2);
            }
        }
        return this;
    }
    ...
    public class CopyConfiguration implements FunctionDescriptor.CopyBuilder<FunctionDescriptor> {
        ...
        private static /* synthetic */ void $$$reportNull$$$0(int r16) {
            String str;
            int r2;
            switch (r16) {
                case 8:
