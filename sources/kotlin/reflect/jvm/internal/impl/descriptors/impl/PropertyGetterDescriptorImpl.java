...
public class PropertyGetterDescriptorImpl extends PropertyAccessorDescriptorImpl implements PropertyGetterDescriptor {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int r9) {
        String str = (r9 == 6 || r9 == 7 || r9 == 8) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
        Object[] objArr = new Object[(r9 == 6 || r9 == 7 || r9 == 8) ? 2 : 3];
        switch (r9) {
            case 1:
