...
public final class ScopesHolderForClass<T extends MemberScope> {
    ...
    private ScopesHolderForClass(ClassDescriptor classDescriptor, StorageManager storageManager, Function1<? super KotlinTypeRefiner, ? extends T> function1, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        this.scopeForOwnerModule$delegate = storageManager.createLazyValue(new Functions<T>(this) { // from class: kotlin.reflect.jvm.internal.impl.descriptors.ScopesHolderForClass$scopeForOwnerModule$2
    ...
    public final T getScope(final KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (kotlinTypeRefiner.isRefinementNeededForModule(DescriptorUtils.getModule(this.classDescriptor))) {
            ...
            return !kotlinTypeRefiner.isRefinementNeededForTypeConstructor(typeConstructor) ? getScopeForOwnerModule() : (T) kotlinTypeRefiner.getOrPutScopeForClass(this.classDescriptor, new Functions<T>(this) { // from class: kotlin.reflect.jvm.internal.impl.descriptors.ScopesHolderForClass$getScope$1
                final /* synthetic */ ScopesHolderForClass<T> this$0;
