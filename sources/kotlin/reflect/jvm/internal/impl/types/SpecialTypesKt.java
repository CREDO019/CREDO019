...
public final class SpecialTypesKt {
    ...
    public static /* synthetic */ SimpleType makeSimpleTypeDefinitelyNotNullOrNotNull$default(SimpleType simpleType, boolean z, int r2, Object obj) {
        if ((r2 & 1) != 0) {
            z = false;
        }
    ...
    public static /* synthetic */ UnwrappedType makeDefinitelyNotNullOrNotNull$default(UnwrappedType unwrappedType, boolean z, int r2, Object obj) {
        if ((r2 & 1) != 0) {
            z = false;
        }
    ...
    private static final IntersectionTypeConstructor makeDefinitelyNotNullOrNotNull(IntersectionTypeConstructor intersectionTypeConstructor) {
        ...
        Collection<KotlinType> mo3012getSupertypes = intersectionTypeConstructor.mo3012getSupertypes();
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo3012getSupertypes, 10));
        Iterator<T> it = mo3012getSupertypes.iterator();
        boolean z = false;
        while (true) {
            kotlinType = null;
            if (!it.hasNext()) {
