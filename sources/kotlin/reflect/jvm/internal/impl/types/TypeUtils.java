...
public class TypeUtils {
    ...
    */
    ...
    public static List<KotlinType> getImmediateSupertypes(KotlinType kotlinType) {
        ...
        Collection<KotlinType> mo3012getSupertypes = kotlinType.getConstructor().mo3012getSupertypes();
        ArrayList arrayList = new ArrayList(mo3012getSupertypes.size());
        for (KotlinType kotlinType2 : mo3012getSupertypes) {
    ...
    public static boolean isNullableType(KotlinType kotlinType) {
        ...
        if (kotlinType instanceof StubTypes) {
            TypeParameterDescriptor originalTypeParameter = ((NewTypeVariableConstructor) ((StubTypes) kotlinType).getOriginalTypeVariable()).getOriginalTypeParameter();
            return originalTypeParameter == null || hasNullableSuperType(originalTypeParameter.getDefaultType());
        }
        TypeConstructor constructor = kotlinType.getConstructor();
        if (constructor instanceof IntersectionTypeConstructor) {
            for (KotlinType kotlinType2 : constructor.mo3012getSupertypes()) {
    ...
    public static boolean hasNullableSuperType(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo3011getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
        ...
        if (smartSet == null || !smartSet.contains(kotlinType)) {
            ...
            if (function12 == null || !function12.invoke(unwrap).booleanValue()) {
                ...
                if (flexibleType == null || !(contains(flexibleType.getLowerBound(), function1, function12, smartSet) || contains(flexibleType.getUpperBound(), function1, function12, smartSet))) {
                    ...
                    TypeConstructor constructor = kotlinType.getConstructor();
                    if (constructor instanceof IntersectionTypeConstructor) {
                        for (KotlinType kotlinType2 : ((IntersectionTypeConstructor) constructor).mo3012getSupertypes()) {
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo3011getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo3011getDeclarationDescriptor();
        }
        return null;
    }
}
