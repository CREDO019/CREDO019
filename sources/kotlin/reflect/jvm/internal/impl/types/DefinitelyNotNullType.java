...
public final class DefinitelyNotNullType extends DelegatingSimpleType implements TypeCapabilities, DefinitelyNotNullTypeMarker {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ DefinitelyNotNullType makeDefinitelyNotNull$default(Companion companion, UnwrappedType unwrappedType, boolean z, int r3, Object obj) {
            if ((r3 & 2) != 0) {
                z = false;
            }
        ...
        private final boolean makesSenseToBeDefinitelyNotNull(UnwrappedType unwrappedType, boolean z) {
            ...
            if (canHaveUndefinedNullability(unwrappedType)) {
                ...
                TypeParameterDescriptorImpl typeParameterDescriptorImpl = mo3011getDeclarationDescriptor instanceof TypeParameterDescriptorImpl ? (TypeParameterDescriptorImpl) mo3011getDeclarationDescriptor : null;
                ...
                if (z && (unwrappedType.getConstructor().mo3011getDeclarationDescriptor() instanceof TypeParameterDescriptor)) {
                    return TypeUtils.isNullableType(unwrappedType);
                }
        ...
        private final boolean canHaveUndefinedNullability(UnwrappedType unwrappedType) {
            return (unwrappedType.getConstructor() instanceof NewTypeVariableConstructor) || (unwrappedType.getConstructor().mo3011getDeclarationDescriptor() instanceof TypeParameterDescriptor) || (unwrappedType instanceof NewCapturedType) || (unwrappedType instanceof StubTypeForBuilderInference);
        }
    }
    ...
    public boolean isTypeVariable() {
        return (getDelegate().getConstructor() instanceof NewTypeVariableConstructor) || (getDelegate().getConstructor().mo3011getDeclarationDescriptor() instanceof TypeParameterDescriptor);
    }
