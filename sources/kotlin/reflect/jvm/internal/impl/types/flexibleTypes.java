...
public final class flexibleTypes extends FlexibleType implements TypeCapabilities {
    ...
    public boolean isTypeVariable() {
        return (getLowerBound().getConstructor().mo3011getDeclarationDescriptor() instanceof TypeParameterDescriptor) && Intrinsics.areEqual(getLowerBound().getConstructor(), getUpperBound().getConstructor());
    }
