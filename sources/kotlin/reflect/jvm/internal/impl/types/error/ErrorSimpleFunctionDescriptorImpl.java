...
public class ErrorSimpleFunctionDescriptorImpl extends SimpleFunctionDescriptorImpl {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int r8) {
        String str = (r8 == 6 || r8 == 7) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
        Object[] objArr = new Object[(r8 == 6 || r8 == 7) ? 2 : 3];
        switch (r8) {
            case 1:
                objArr[0] = "ownerScope";
                break;
        ...
        return new FunctionDescriptor.CopyBuilder<SimpleFunctionDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.types.error.ErrorSimpleFunctionDescriptorImpl.1
            ...
            */
            private static /* synthetic */ void $$$reportNull$$$0(int r24) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.types.error.ErrorSimpleFunctionDescriptorImpl.C49031.$$$reportNull$$$0(int):void");
            }
