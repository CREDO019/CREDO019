...
public final class NewCapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    public /* synthetic */ NewCapturedType(CaptureStatus captureStatus, NewCapturedTypeConstructor newCapturedTypeConstructor, UnwrappedType unwrappedType, Annotations annotations, boolean z, boolean z2, int r14, DefaultConstructorMarker defaultConstructorMarker) {
        this(captureStatus, newCapturedTypeConstructor, unwrappedType, (r14 & 8) != 0 ? Annotations.Companion.getEMPTY() : annotations, (r14 & 16) != 0 ? false : z, (r14 & 32) != 0 ? false : z2);
    }
