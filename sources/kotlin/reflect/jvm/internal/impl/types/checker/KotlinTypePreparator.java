    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo3012getSupertypes = capturedTypeConstructorImpl.mo3012getSupertypes();
            ...
            Collection<KotlinType> mo3012getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo3012getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo3012getSupertypes2, 10));
            for (KotlinType kotlinType2 : mo3012getSupertypes2) {
            ...
            Collection<KotlinType> mo3012getSupertypes3 = intersectionTypeConstructor2.mo3012getSupertypes();
            ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo3012getSupertypes3, 10));
            for (KotlinType kotlinType3 : mo3012getSupertypes3) {
