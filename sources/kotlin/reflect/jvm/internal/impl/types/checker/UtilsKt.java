...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType immediateSupertype : constructor2.mo3012getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        m3017debugInfo$lambda1$unaryPlus(Intrinsics.stringPlus("type: ", typeConstructor), sb);
        m3017debugInfo$lambda1$unaryPlus(Intrinsics.stringPlus("hashCode: ", Integer.valueOf(typeConstructor.hashCode())), sb);
        m3017debugInfo$lambda1$unaryPlus(Intrinsics.stringPlus("javaClass: ", typeConstructor.getClass().getCanonicalName()), sb);
        for (ClassifierDescriptor mo3011getDeclarationDescriptor = typeConstructor.mo3011getDeclarationDescriptor(); mo3011getDeclarationDescriptor != null; mo3011getDeclarationDescriptor = mo3011getDeclarationDescriptor.getContainingDeclaration()) {
            m3017debugInfo$lambda1$unaryPlus(Intrinsics.stringPlus("fqName: ", DescriptorRenderer.FQ_NAMES_IN_TYPES.render(mo3011getDeclarationDescriptor)), sb);
            m3017debugInfo$lambda1$unaryPlus(Intrinsics.stringPlus("javaClass: ", mo3011getDeclarationDescriptor.getClass().getCanonicalName()), sb);
        }
    ...
    private static final StringBuilder m3017debugInfo$lambda1$unaryPlus(String str, StringBuilder sb) {
