...
public class TypeCheckingProcedure {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int r9) {
        String str = (r9 == 7 || r9 == 10) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
        Object[] objArr = new Object[(r9 == 7 || r9 == 10) ? 2 : 3];
        switch (r9) {
            case 1:
            case 3:
            case 18:
