...
public final class TypeIntersector {
    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> mo3012getSupertypes = simpleType.getConstructor().mo3012getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo3012getSupertypes, "type.constructor.supertypes");
                Collection<KotlinType> collection = mo3012getSupertypes;
    ...
    private final SimpleType intersectTypesWithoutIntersectionType(final Set<? extends SimpleType> set) {
        ...
        new Functions<String>() { // from class: kotlin.reflect.jvm.internal.impl.types.checker.TypeIntersector$intersectTypesWithoutIntersectionType$errorMessage$1
        ...
        Collection<SimpleType> filterTypes = filterTypes(set2, new C4901x702eebb8(this));
        filterTypes.isEmpty();
        SimpleType findIntersectionType = IntegerLiteralTypeConstructor.Companion.findIntersectionType(filterTypes);
        if (findIntersectionType == null) {
            Collection<SimpleType> filterTypes2 = filterTypes(filterTypes, new C4902xc97d8c34(NewKotlinTypeChecker.Companion.getDefault()));
    ...
    */
    ...
    private static final class ResultNullability {
        ...
        public /* synthetic */ ResultNullability(String str, int r2, DefaultConstructorMarker defaultConstructorMarker) {
            this(str, r2);
        }
        ...
        private ResultNullability(String str, int r2) {
        }

        /* compiled from: IntersectionType.kt */
        /* loaded from: classes5.dex */
        static final class ACCEPT_NULL extends ResultNullability {
            ACCEPT_NULL(String str, int r3) {
                super(str, r3, null);
            }
