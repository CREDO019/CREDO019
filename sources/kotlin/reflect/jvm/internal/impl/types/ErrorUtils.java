...
public class ErrorUtils {
    ...
    private static final ModuleDescriptor ERROR_MODULE = new ModuleDescriptor() { // from class: kotlin.reflect.jvm.internal.impl.types.ErrorUtils.1
        ...
        */
        private static /* synthetic */ void $$$reportNull$$$0(int r12) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.types.ErrorUtils.C48941.$$$reportNull$$$0(int):void");
        }
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int r9) {
        String str = (r9 == 4 || r9 == 6 || r9 == 19) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
        Object[] objArr = new Object[(r9 == 4 || r9 == 6 || r9 == 19) ? 2 : 3];
        switch (r9) {
            case 1:
            case 2:
            case 3:
    ...
    public static class ErrorScope implements MemberScope {
        ...
        */
        ...
        public ClassifierDescriptor mo3013getContributedClassifier(Name name, LookupLocation lookupLocation) {
            if (name == null) {
                $$$reportNull$$$0(1);
            }
            if (lookupLocation == null) {
    ...
    public static class ErrorClassDescriptor extends ClassDescriptorImpl {
        private static /* synthetic */ void $$$reportNull$$$0(int r9) {
            String str = (r9 == 2 || r9 == 5 || r9 == 8) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
            Object[] objArr = new Object[(r9 == 2 || r9 == 5 || r9 == 8) ? 2 : 3];
            switch (r9) {
                case 1:
    ...
    public static TypeConstructor createErrorTypeConstructorWithCustomDebugName(final String str, final ErrorClassDescriptor errorClassDescriptor) {
        ...
        return new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.types.ErrorUtils.2
            private static /* synthetic */ void $$$reportNull$$$0(int r7) {
                String str2 = r7 != 3 ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
                Object[] objArr = new Object[r7 != 3 ? 2 : 3];
                if (r7 != 3) {
    ...
    public static class UninferredParameterTypeConstructor implements TypeConstructor {
        ...
        private static /* synthetic */ void $$$reportNull$$$0(int r10) {
            String str = (r10 == 1 || r10 == 2 || r10 == 3 || r10 == 4 || r10 == 6) ? "@NotNull method %s.%s must not return null" : "Argument for @NotNull parameter '%s' of %s.%s must not be null";
            Object[] objArr = new Object[(r10 == 1 || r10 == 2 || r10 == 3 || r10 == 4 || r10 == 6) ? 2 : 3];
            switch (r10) {
                case 1:
                case 2:
                case 3:
            ...
            String format = String.format(str, objArr);
            if (r10 != 1 && r10 != 2 && r10 != 3 && r10 != 4 && r10 != 6) {
                throw new IllegalArgumentException(format);
            }
            throw new IllegalStateException(format);
        }
        ...
        /* renamed from: getSupertypes */
        public Collection<KotlinType> mo3012getSupertypes() {
            Collection<KotlinType> mo3012getSupertypes = this.errorTypeConstructor.mo3012getSupertypes();
            if (mo3012getSupertypes == null) {
                $$$reportNull$$$0(3);
            }
        ...
        /* renamed from: getDeclarationDescriptor */
        public ClassifierDescriptor mo3011getDeclarationDescriptor() {
            return this.errorTypeConstructor.mo3011getDeclarationDescriptor();
        }
