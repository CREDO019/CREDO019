...
public final class CloneableClassScope extends GivenFunctionsMemberScope {
    ...
    public List<FunctionDescriptor> computeDeclaredFunctions() {
        ...
        create.initialize((ReceiverParameterDescriptor) null, getContainingClass().getThisAsReceiverParameter(), CollectionsKt.emptyList(), CollectionsKt.emptyList(), (KotlinType) DescriptorUtils.getBuiltIns(getContainingClass()).getAnyType(), Modality.OPEN, DescriptorVisibilities.PROTECTED);
