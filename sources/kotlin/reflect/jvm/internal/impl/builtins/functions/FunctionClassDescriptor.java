...
public final class FunctionClassDescriptor extends AbstractClassDescriptor {
    ...
    public /* bridge */ /* synthetic */ ClassDescriptor mo3003getCompanionObjectDescriptor() {
        return (ClassDescriptor) getCompanionObjectDescriptor();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    /* renamed from: getUnsubstitutedPrimaryConstructor  reason: collision with other method in class */
    public /* bridge */ /* synthetic */ ClassConstructorDescriptor mo3004getUnsubstitutedPrimaryConstructor() {
    ...
    public FunctionClassDescriptor(StorageManager storageManager, PackageFragmentDescriptor containingDeclaration, FunctionClassKind functionKind, int r6) {
        super(storageManager, functionKind.numberedClassName(r6));
        ...
        IntRange intRange = new IntRange(1, r6);
    ...
    private final class FunctionTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public /* synthetic */ class WhenMappings {
            ...
            static {
                ...
                r0[FunctionClassKind.KFunction.ordinal()] = 2;
                r0[FunctionClassKind.SuspendFunction.ordinal()] = 3;
                r0[FunctionClassKind.KSuspendFunction.ordinal()] = 4;
        ...
        public Collection<KotlinType> computeSupertypes() {
            List listOf;
            int r0 = WhenMappings.$EnumSwitchMapping$0[this.this$0.getFunctionKind().ordinal()];
            if (r0 == 1) {
        ...
        public FunctionClassDescriptor mo3011getDeclarationDescriptor() {
            return this.this$0;
        }

        public String toString() {
            return mo3011getDeclarationDescriptor().toString();
        }
