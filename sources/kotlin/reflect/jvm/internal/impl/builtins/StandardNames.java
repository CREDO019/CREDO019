...
public final class StandardNames {
    ...
    public static final class FqNames {
        ...
        static {
            ...
            int r4 = 0;
            while (r4 < length) {
                PrimitiveType primitiveType = values[r4];
                r4++;
            ...
            int r42 = 0;
            while (r42 < length2) {
                PrimitiveType primitiveType2 = values2[r42];
                r42++;
            ...
            int r43 = 0;
            while (r43 < length3) {
                PrimitiveType primitiveType3 = values3[r43];
                r43++;
            ...
            while (r3 < length4) {
                PrimitiveType primitiveType4 = values4[r3];
                r3++;
    ...
    @JvmStatic
    public static final String getFunctionName(int r1) {
        return Intrinsics.stringPlus("Function", Integer.valueOf(r1));
    }

    @JvmStatic
    public static final ClassId getFunctionClassId(int r2) {
        return new ClassId(BUILT_INS_PACKAGE_FQ_NAME, Name.identifier(getFunctionName(r2)));
    }

    @JvmStatic
    public static final String getSuspendFunctionName(int r1) {
        return Intrinsics.stringPlus(FunctionClassKind.SuspendFunction.getClassNamePrefix(), Integer.valueOf(r1));
    }
