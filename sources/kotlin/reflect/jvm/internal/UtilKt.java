...
public final class UtilKt {
    ...
    static /* synthetic */ Class loadClass$default(ClassLoader classLoader, ClassId classId, int r2, int r3, Object obj) {
        if ((r3 & 4) != 0) {
            r2 = 0;
        }
        return loadClass(classLoader, classId, r2);
    }

    private static final Class<?> loadClass(ClassLoader classLoader, ClassId classId, int r5) {
        ...
        return loadClass(classLoader, asString, asString2, r5);
    }

    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int r10) {
        ...
        if (r10 > 0) {
            str3 = StringsKt.repeat("[", r10) + Matrix.MATRIX_TYPE_RANDOM_LT + str3 + ';';
        }
    ...
    private static final Annotation toAnnotationInstance(AnnotationDescriptor annotationDescriptor) {
        ...
        while (it.hasNext()) {
            ...
            Tuples m176to = runtimeValue == null ? null : TuplesKt.m176to(name.asString(), runtimeValue);
            if (m176to != null) {
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            return C5827Util.getEnumConstantByName(loadClass$default, component2.asString());
            ...
            if (value2 instanceof KClassValue.Value.NormalClass) {
                ...
                ClassifierDescriptor mo3011getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo3011getDeclarationDescriptor();
    ...
    */
    ...
    public static final boolean isInlineClassType(KType kType) {
        ...
        return kTypeImpl != null && inlineClassesUtils.isInlineClassType(kTypeImpl.getType());
    }
