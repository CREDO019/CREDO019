...
public final class KClasses {
    ...
    public static final KType getDefaultType(final KClass<?> kClass) {
        ...
        return new KTypeImpl(defaultType, new Functions<Type>() { // from class: kotlin.reflect.full.KClasses$defaultType$1
