...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m2936getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m1748boximpl(obj);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> m2936getResultxLWZpok = m2936getResultxLWZpok();
                if (m2936getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(m2936getResultxLWZpok.m1758unboximpl());
                }
            }
        }
    }
