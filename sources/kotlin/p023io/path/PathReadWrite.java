...
class PathReadWrite {
    ...
    static /* synthetic */ BufferedReader bufferedReader$default(Path path, Charset charset, int r3, OpenOption[] options, int r5, Object obj) throws IOException {
        if ((r5 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((r5 & 2) != 0) {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(options, "options");
        return new BufferedReader(new InputStreamReader(Files.newInputStream(path, (OpenOption[]) Arrays.copyOf(options, options.length)), charset), r3);
    }

    private static final BufferedReader bufferedReader(Path path, Charset charset, int r5, OpenOption... options) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(options, "options");
        return new BufferedReader(new InputStreamReader(Files.newInputStream(path, (OpenOption[]) Arrays.copyOf(options, options.length)), charset), r5);
    }

    static /* synthetic */ OutputStreamWriter writer$default(Path path, Charset charset, OpenOption[] options, int r3, Object obj) throws IOException {
        if ((r3 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ BufferedWriter bufferedWriter$default(Path path, Charset charset, int r3, OpenOption[] options, int r5, Object obj) throws IOException {
        if ((r5 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((r5 & 2) != 0) {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(options, "options");
        return new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(path, (OpenOption[]) Arrays.copyOf(options, options.length)), charset), r3);
    }

    private static final BufferedWriter bufferedWriter(Path path, Charset charset, int r5, OpenOption... options) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(options, "options");
        return new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(path, (OpenOption[]) Arrays.copyOf(options, options.length)), charset), r5);
    }
    ...
    public static /* synthetic */ String readText$default(Path path, Charset charset, int r2, Object obj) throws IOException {
        if ((r2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    public static /* synthetic */ void writeText$default(Path path, CharSequence charSequence, Charset charset, OpenOption[] openOptionArr, int r4, Object obj) throws IOException {
        if ((r4 & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    public static /* synthetic */ void appendText$default(Path path, CharSequence charSequence, Charset charset, int r3, Object obj) throws IOException {
        if ((r3 & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    static /* synthetic */ void forEachLine$default(Path path, Charset charset, Function1 action, int r4, Object obj) throws IOException {
        if ((r4 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ List readLines$default(Path path, Charset charset, int r2, Object obj) throws IOException {
        if ((r2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ Object useLines$default(Path path, Charset charset, Function1 block, int r4, Object obj) throws IOException {
        if ((r4 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ Path writeLines$default(Path path, Iterable lines, Charset charset, OpenOption[] options, int r4, Object obj) throws IOException {
        if ((r4 & 2) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ Path writeLines$default(Path path, Sequence lines, Charset charset, OpenOption[] options, int r4, Object obj) throws IOException {
        if ((r4 & 2) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ Path appendLines$default(Path path, Iterable lines, Charset charset, int r4, Object obj) throws IOException {
        if ((r4 & 2) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    static /* synthetic */ Path appendLines$default(Path path, Sequence lines, Charset charset, int r4, Object obj) throws IOException {
        if ((r4 & 2) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
