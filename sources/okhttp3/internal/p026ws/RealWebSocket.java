...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final void checkUpgradeSuccess$okhttp(C5015Response response, Exchange exchange) throws IOException {
        Intrinsics.checkNotNullParameter(response, "response");
        if (response.code() != 101) {
            throw new ProtocolException("Expected HTTP 101 response but was '" + response.code() + ' ' + response.message() + '\'');
        }
        String header$default = C5015Response.header$default(response, "Connection", null, 2, null);
        if (!StringsKt.equals(HttpHeaders.UPGRADE, header$default, true)) {
            throw new ProtocolException("Expected 'Connection' header value 'Upgrade' but was '" + header$default + '\'');
        }
        String header$default2 = C5015Response.header$default(response, HttpHeaders.UPGRADE, null, 2, null);
        if (!StringsKt.equals("websocket", header$default2, true)) {
            throw new ProtocolException("Expected 'Upgrade' header value 'websocket' but was '" + header$default2 + '\'');
        }
        String header$default3 = C5015Response.header$default(response, HttpHeaders.SEC_WEBSOCKET_ACCEPT, null, 2, null);
        ByteString.Companion companion = ByteString.Companion;
    ...
    @Override // okhttp3.internal.p026ws.WebSocketReader.FrameCallback
    public void onReadClose(int r6, String reason) {
        ...
        try {
            this.listener.onClosing(this, r6, reason);
            if (streams != null) {
                this.listener.onClosed(this, r6, reason);
            }
        } finally {
            if (streams != null) {
    ...
    private final synchronized boolean send(ByteString byteString, int r8) {
        if (!this.failed && !this.enqueuedClose) {
            ...
            this.messageAndCloseQueue.add(new Message(r8, byteString));
            runWriter();
            return true;
        }
        return false;
    ...
    @Override // okhttp3.WebSocket
    public boolean close(int r3, String str) {
        return close(r3, str, 60000L);
    }

    public final synchronized boolean close(int r9, String str, long j) {
        WebSocketProtocol.INSTANCE.validateCloseCode(r9);
        ...
        if (!this.failed && !this.enqueuedClose) {
            ...
            this.messageAndCloseQueue.add(new Close(r9, byteString, j));
            runWriter();
            return true;
        }
        return false;
    ...
    /* JADX WARN: Removed duplicated region for block: B:30:0x0117 A[Catch: all -> 0x01de, TRY_ENTER, TryCatch #4 {all -> 0x01de, blocks: (B:30:0x0117, B:32:0x0122, B:34:0x012a, B:36:0x012e, B:37:0x013e, B:39:0x014f, B:44:0x0154, B:45:0x015b, B:46:0x015c, B:48:0x0162, B:50:0x0166, B:38:0x013f), top: B:93:0x0115 }] */
    /* JADX WARN: Removed duplicated region for block: B:32:0x0122 A[Catch: all -> 0x01de, TryCatch #4 {all -> 0x01de, blocks: (B:30:0x0117, B:32:0x0122, B:34:0x012a, B:36:0x012e, B:37:0x013e, B:39:0x014f, B:44:0x0154, B:45:0x015b, B:46:0x015c, B:48:0x0162, B:50:0x0166, B:38:0x013f), top: B:93:0x0115 }] */
    ...
    */
    ...
    public final void writePingFrame$okhttp() {
        synchronized (this) {
            ...
            if (webSocketWriter != null) {
                int r1 = this.awaitingPong ? this.sentPingCount : -1;
                this.sentPingCount++;
    ...
    public final void failWebSocket(Exception e, C5015Response c5015Response) {
        Intrinsics.checkNotNullParameter(e, "e");
        synchronized (this) {
            if (this.failed) {
                return;
            ...
            Unit unit = Unit.INSTANCE;
            try {
                this.listener.onFailure(this, e, c5015Response);
            } finally {
                if (streams != null) {
                    Util.closeQuietly(streams);
                }
    ...
    /* compiled from: RealWebSocket.kt */
    @Metadata(m185bv = {1, 0, 3}, m184d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, m183d2 = {"Lokhttp3/internal/ws/RealWebSocket$Message;", "", "formatOpcode", "", "data", "Lokio/ByteString;", "(ILokio/ByteString;)V", "getData", "()Lokio/ByteString;", "getFormatOpcode", "()I", "okhttp"}, m182k = 1, m181mv = {1, 4, 0})
    ...
    public static final class Message {
        ...
        public Message(int r2, ByteString data) {
            Intrinsics.checkNotNullParameter(data, "data");
            this.formatOpcode = r2;
            this.data = data;
        }
    ...
    /* compiled from: RealWebSocket.kt */
    @Metadata(m185bv = {1, 0, 3}, m184d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\b\b\u0000\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, m183d2 = {"Lokhttp3/internal/ws/RealWebSocket$Close;", "", "code", "", "reason", "Lokio/ByteString;", "cancelAfterCloseMillis", "", "(ILokio/ByteString;J)V", "getCancelAfterCloseMillis", "()J", "getCode", "()I", "getReason", "()Lokio/ByteString;", "okhttp"}, m182k = 1, m181mv = {1, 4, 0})
    ...
    public static final class Close {
        ...
        public Close(int r1, ByteString byteString, long j) {
            this.code = r1;
    ...
    /* compiled from: RealWebSocket.kt */
    @Metadata(m185bv = {1, 0, 3}, m184d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\b&\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, m183d2 = {"Lokhttp3/internal/ws/RealWebSocket$Streams;", "Ljava/io/Closeable;", "client", "", "source", "Lokio/BufferedSource;", "sink", "Lokio/BufferedSink;", "(ZLokio/BufferedSource;Lokio/BufferedSink;)V", "getClient", "()Z", "getSink", "()Lokio/BufferedSink;", "getSource", "()Lokio/BufferedSource;", "okhttp"}, m182k = 1, m181mv = {1, 4, 0})
    ...
    /* compiled from: RealWebSocket.kt */
    @Metadata(m185bv = {1, 0, 3}, m184d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, m183d2 = {"Lokhttp3/internal/ws/RealWebSocket$WriterTask;", "Lokhttp3/internal/concurrent/Task;", "(Lokhttp3/internal/ws/RealWebSocket;)V", "runOnce", "", "okhttp"}, m182k = 1, m181mv = {1, 4, 0})
    ...
    /* compiled from: RealWebSocket.kt */
    @Metadata(m185bv = {1, 0, 3}, m184d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u0014\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, m183d2 = {"Lokhttp3/internal/ws/RealWebSocket$Companion;", "", "()V", "CANCEL_AFTER_CLOSE_MILLIS", "", "DEFAULT_MINIMUM_DEFLATE_SIZE", "MAX_QUEUE_SIZE", "ONLY_HTTP1", "", "Lokhttp3/Protocol;", "okhttp"}, m182k = 1, m181mv = {1, 4, 0})
