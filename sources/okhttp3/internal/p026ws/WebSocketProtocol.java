...
public final class WebSocketProtocol {
    ...
    public final String closeCodeExceptionMessage(int r3) {
        if (r3 < 1000 || r3 >= 5000) {
            return "Code must be in range [1000,5000): " + r3;
        } else if ((1004 > r3 || 1006 < r3) && (1015 > r3 || 2999 < r3)) {
            return null;
        } else {
            return "Code " + r3 + " is reserved and may not be used.";
        }
    }

    public final void validateCloseCode(int r2) {
        String closeCodeExceptionMessage = closeCodeExceptionMessage(r2);
