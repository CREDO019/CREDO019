...
public final class WebSocketWriter implements Closeable {
    ...
    public final void writeClose(int r2, ByteString byteString) throws IOException {
        ByteString byteString2 = ByteString.EMPTY;
        if (r2 != 0 || byteString != null) {
            if (r2 != 0) {
                WebSocketProtocol.INSTANCE.validateCloseCode(r2);
            }
            Buffer buffer = new Buffer();
            buffer.writeShort(r2);
            if (byteString != null) {
    ...
    private final void writeControlFrame(int r7, ByteString byteString) throws IOException {
    ...
    public final void writeMessageFrame(int r6, ByteString data) throws IOException {
        ...
        this.sinkBuffer.writeByte(r62);
        int r0 = this.isClient ? 128 : 0;
        if (size <= 125) {
            this.sinkBuffer.writeByte(((int) size) | r0);
        } else if (size <= WebSocketProtocol.PAYLOAD_SHORT_MAX) {
            this.sinkBuffer.writeByte(r0 | 126);
            this.sinkBuffer.writeShort((int) size);
        } else {
            this.sinkBuffer.writeByte(r0 | 127);
