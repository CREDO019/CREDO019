...
public final class Exchange {
    ...
    public final C5015Response.Builder readResponseHeaders(boolean z) throws IOException {
        try {
            C5015Response.Builder readResponseHeaders = this.codec.readResponseHeaders(z);
    ...
    public final void responseHeadersEnd(C5015Response response) {
        Intrinsics.checkNotNullParameter(response, "response");
        this.eventListener.responseHeadersEnd(this.call, response);
    }

    public final ResponseBody openResponseBody(C5015Response response) throws IOException {
        Intrinsics.checkNotNullParameter(response, "response");
        try {
