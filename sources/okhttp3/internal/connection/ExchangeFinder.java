...
public final class ExchangeFinder {
    ...
    private final RealConnection findHealthyConnection(int r3, int r4, int r5, int r6, boolean z, boolean z2) throws IOException {
        while (true) {
            RealConnection findConnection = findConnection(r3, r4, r5, r6, z);
