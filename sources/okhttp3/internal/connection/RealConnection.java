...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x00ad A[Catch: IOException -> 0x010c, TRY_LEAVE, TryCatch #2 {IOException -> 0x010c, blocks: (B:21:0x00a5, B:23:0x00ad), top: B:71:0x00a5 }] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:61:0x016d A[EDGE_INSN: B:74:0x016d->B:61:0x016d ?: BREAK  ] */
    /*
    ...
    */
    ...
    private final void connectTunnel(int r7, int r8, int r9, Call call, EventListener eventListener) throws IOException {
        Request createTunnelRequest = createTunnelRequest();
        HttpUrl url = createTunnelRequest.url();
        for (int r2 = 0; r2 < 21; r2++) {
            connectSocket(r7, r8, call, eventListener);
            createTunnelRequest = createTunnel(r8, r9, createTunnelRequest, url);
    ...
    private final void connectSocket(int r5, int r6, Call call, EventListener eventListener) throws IOException {
        Socket socket;
        int r2;
        Proxy proxy = this.route.proxy();
        Address address = this.route.address();
        Proxy.Type type = proxy.type();
        if (type != null && ((r2 = WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) == 1 || r2 == 2)) {
        ...
        try {
            Platform.Companion.get().connectSocket(socket, this.route.socketAddress(), r5);
            try {
    ...
    private final void establishProtocol(ConnectionSpecSelector connectionSpecSelector, int r3, Call call, EventListener eventListener) throws IOException {
    ...
    private final void startHttp2(int r8) throws IOException {
        ...
        Http2Connection build = new Http2Connection.Builder(true, TaskRunner.INSTANCE).socket(socket, this.route.address().url().host(), bufferedSource, bufferedSink).listener(this).pingIntervalMillis(r8).build();
    ...
    private final void connectTls(ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            ...
            try {
                ...
                this.handshake = new Handshake(handshake.tlsVersion(), handshake.cipherSuite(), handshake.localCertificates(), new Functions<List<? extends Certificate>>() { // from class: okhttp3.internal.connection.RealConnection$connectTls$1
                ...
                certificatePinner.check$okhttp(address.url().host(), new Functions<List<? extends X509Certificate>>() { // from class: okhttp3.internal.connection.RealConnection$connectTls$2
                    /* JADX INFO: Access modifiers changed from: package-private */
                    {
                        super(0);
                    }
    ...
    private final Request createTunnel(int r10, int r11, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            bufferedSource.timeout().timeout(r10, TimeUnit.MILLISECONDS);
            bufferedSink.timeout().timeout(r11, TimeUnit.MILLISECONDS);
            http1ExchangeCodec.writeRequest(request.headers(), str);
            http1ExchangeCodec.finishRequest();
            C5015Response.Builder readResponseHeaders = http1ExchangeCodec.readResponseHeaders(false);
            Intrinsics.checkNotNull(readResponseHeaders);
            C5015Response build = readResponseHeaders.request(request).build();
            ...
            if (code == 200) {
                ...
                if (StringsKt.equals("close", C5015Response.header$default(build, "Connection", null, 2, null), true)) {
                    return authenticate;
                }
    ...
    private final Request createTunnelRequest() throws IOException {
        ...
        Request authenticate = this.route.address().proxyAuthenticator().authenticate(this.route, new C5015Response.Builder().request(build).protocol(Protocol.HTTP_1_1).code(407).message("Preemptive Authenticate").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1L).receivedResponseAtMillis(-1L).header("Proxy-Authenticate", "OkHttp-Preemptive").build());
    ...
    /* compiled from: RealConnection.kt */
    @Metadata(m185bv = {1, 0, 3}, m184d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0004R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0012"}, m183d2 = {"Lokhttp3/internal/connection/RealConnection$Companion;", "", "()V", "IDLE_CONNECTION_HEALTHY_NS", "", "MAX_TUNNEL_ATTEMPTS", "", "NPE_THROW_WITH_NULL", "", "newTestConnection", "Lokhttp3/internal/connection/RealConnection;", "connectionPool", "Lokhttp3/internal/connection/RealConnectionPool;", "route", "Lokhttp3/Route;", "socket", "Ljava/net/Socket;", "idleAtNs", "okhttp"}, m182k = 1, m181mv = {1, 4, 0})
    /* loaded from: classes5.dex */
