...
public class SoundLevelCircleDrawable extends Drawable {
    ...
    private static Paint newColorPaint(int r2) {
    ...
    public SoundLevelCircleDrawable(Params params) {
        ...
        this.paintIndicatorHalo = newColorPaint(r3);
        this.paintIndicatorCenter = newColorPaint(r0);
    }
    ...
    public static class Params {
        ...
        public Params(float f, float f2, float f3, float f4, int r5, int r6) {
            this.maxRadius = f;
            this.minRadius = f2;
