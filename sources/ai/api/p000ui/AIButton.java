...
public class AIButton extends SoundLevelButton implements AIListener {
    ...
    public AIButton(Context context, AttributeSet attributeSet, int r3) {
    ...
    @Override // ai.api.p000ui.SoundLevelButton
    public void onClick(View view) {
        super.onClick(view);
        if (this.aiService != null) {
            int r2 = C00177.$SwitchMap$ai$api$ui$AIButton$MicState[this.currentState.ordinal()];
            if (r2 == 1) {
    ...
    @Override // ai.api.p000ui.SoundLevelButton, android.widget.ImageView, android.view.View
    public int[] onCreateDrawableState(int r3) {
        int[] onCreateDrawableState = super.onCreateDrawableState(r3 + 1);
        if (this.currentState != null) {
            int r0 = C00177.$SwitchMap$ai$api$ui$AIButton$MicState[this.currentState.ordinal()];
            if (r0 == 2) {
    ...
    protected void changeState(MicState micState) {
        int r0 = C00177.$SwitchMap$ai$api$ui$AIButton$MicState[micState.ordinal()];
        if (r0 == 1) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // ai.api.p000ui.SoundLevelButton, ai.api.p000ui.MaskedColorView
