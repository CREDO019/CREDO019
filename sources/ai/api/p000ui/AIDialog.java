...
public class AIDialog {
    ...
    public AIDialog(Context context, AIConfiguration aIConfiguration) {
        this(context, aIConfiguration, C0001R.layout.aidialog);
    }

    public AIDialog(Context context, AIConfiguration aIConfiguration, int r5) {
        ...
        this.partialResultsTextView = (TextView) dialog.findViewById(C0001R.C0004id.partialResultsTextView);
        AIButton aIButton = (AIButton) dialog.findViewById(C0001R.C0004id.micButton);
    ...
    private void setAIButtonCallback(AIButton aIButton) {
        aIButton.setResultsListener(new AIButton.AIButtonListener() { // from class: ai.api.ui.AIDialog.2
            @Override // ai.api.p000ui.AIButton.AIButtonListener
