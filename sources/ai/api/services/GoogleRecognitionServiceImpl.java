...
public class GoogleRecognitionServiceImpl extends AIService {
    ...
    public void updateStopRunnable(int r4) {
    ...
    public class InternalRecognitionListener implements RecognitionListener {
        ...
        public void onError(int r4) {
            AIError aIError;
            if (r4 != 7 || GoogleRecognitionServiceImpl.this.wasReadyForSpeech) {
                if (GoogleRecognitionServiceImpl.this.recognitionActive) {
                    if (GoogleRecognitionServiceImpl.this.errorMessages.containsKey(Integer.valueOf(r4))) {
                        aIError = new AIError("Speech recognition engine error: " + ((String) GoogleRecognitionServiceImpl.this.errorMessages.get(Integer.valueOf(r4))));
                    } else {
                        aIError = new AIError("Speech recognition engine error: " + r4);
                    }
