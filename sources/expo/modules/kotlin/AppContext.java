...
public final class AppContext implements CurrentActivityProvider, AppContextActivityResultCaller {
    ...
    public AppContext(ModulesProvider modulesProvider, expo.modules.core.ModuleRegistry legacyModuleRegistry, WeakReference<ReactApplicationContext> reactContextHolder) {
        ...
        this.registry = new ModuleRegistry(new WeakReference(this));
        ...
        getRegistry().register(new ErrorManagerModule());
        getRegistry().register(new NativeModulesProxyModule());
        getRegistry().register(modulesProvider);
        CoreLogger.getLogger().info("✅ AppContext was initialized");
    }
            ...
            try {
                ...
                if (valueOf != null) {
                    ...
                    if (nativeCallInvokerHolder != null) {
                        ...
                        CoreLogger.getLogger().info("✅ JSI interop was installed");
                    } else {
    ...
    public final File getPersistentFilesDirectory() {
        ...
        File persistentFilesDirectory = appDirectories == null ? null : appDirectories.getPersistentFilesDirectory();
        if (persistentFilesDirectory != null) {
    ...
    public final File getCacheDirectory() {
        AppDirectoriesModuleInterface appDirectories = getAppDirectories();
        File cacheDirectory = appDirectories == null ? null : appDirectories.getCacheDirectory();
    ...
    public final void onDestroy$expo_modules_core_release() {
        ...
        CoreLogger.getLogger().info("✅ AppContext was destroyed");
    }
    ...
    public final void onHostResume$expo_modules_core_release() {
        ...
        if (!(currentActivity instanceof AppCompatActivity)) {
            ...
            String localClassName = currentActivity2 == null ? null : currentActivity2.getLocalClassName();
    ...
    public final void onActivityResult$expo_modules_core_release(Activity activity, int r5, int r6, Intent intent) {
        Intrinsics.checkNotNullParameter(activity, "activity");
        this.activityResultsManager.onActivityResult(activity, r5, r6, intent);
        this.registry.post(EventName.ON_ACTIVITY_RESULT, activity, new OnActivityResultPayload(r5, r6, intent));
    }
    ...
    public final <T extends View> T findView(int r3) {
        ReactApplicationContext reactApplicationContext = this.reactContextHolder.get();
        if (reactApplicationContext == null) {
            return null;
        }
        UIManager uIManagerForReactTag = UIManagerHelper.getUIManagerForReactTag(reactApplicationContext, r3);
        View resolveView = uIManagerForReactTag == null ? null : uIManagerForReactTag.resolveView(r3);
