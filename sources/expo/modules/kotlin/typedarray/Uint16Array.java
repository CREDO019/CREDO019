...
public final class Uint16Array implements TypedArray, GenericTypedArray<UShort> {
    ...
    public /* bridge */ /* synthetic */ UShort get(int r1) {
        return UShort.m2021boximpl(m1679getBwKQO78(r1));
    }
    ...
    @Override // expo.modules.kotlin.typedarray.GenericTypedArray
    public /* bridge */ /* synthetic */ void set(int r1, UShort uShort) {
        m1680seti8woANY(r1, uShort.m2076unboximpl());
    }

    /* renamed from: get-BwKQO78  reason: not valid java name */
    public short m1679getBwKQO78(int r2) {
        Uint16Array uint16Array = this;
        if (r2 >= 0 && r2 < uint16Array.getLength()) {
            return UShort.m2027constructorimpl(read2Byte(r2 * 2));
        }
        throw new IndexOutOfBoundsException();
    }

    /* renamed from: set-i8woANY  reason: not valid java name */
    public void m1680seti8woANY(int r2, short s) {
        Uint16Array uint16Array = this;
        if (r2 >= 0 && r2 < uint16Array.getLength()) {
            write2Byte(r2 * 2, s);
            return;
