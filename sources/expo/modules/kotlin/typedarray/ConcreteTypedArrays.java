...
/* renamed from: expo.modules.kotlin.typedarray.BigInt64Array */
/* loaded from: classes4.dex */
public final class ConcreteTypedArrays implements TypedArray, GenericTypedArray<Long> {
    ...
    public ConcreteTypedArrays(JavaScriptTypedArray rawArray) {
    ...
    public /* bridge */ /* synthetic */ void set(int r3, Long l) {
        set(r3, l.longValue());
    }
    ...
    public Long get(int r3) {
        ConcreteTypedArrays concreteTypedArrays = this;
        if (r3 >= 0 && r3 < concreteTypedArrays.getLength()) {
            return Long.valueOf(read8Byte(r3 * 8));
        }
    ...
    public void set(int r2, long j) {
        ConcreteTypedArrays concreteTypedArrays = this;
        if (r2 >= 0 && r2 < concreteTypedArrays.getLength()) {
            write8Byte(r2 * 8, j);
            return;
        }
        throw new IndexOutOfBoundsException();
