...
public final class Uint8Array implements TypedArray, GenericTypedArray<UByte> {
    ...
    public /* bridge */ /* synthetic */ UByte get(int r1) {
        return UByte.m1761boximpl(m1683getWa3L5BU(r1));
    }
    ...
    public /* bridge */ /* synthetic */ void set(int r1, UByte uByte) {
        m1684setEK6454(r1, uByte.m1816unboximpl());
    }

    /* renamed from: get-Wa3L5BU  reason: not valid java name */
    public byte m1683getWa3L5BU(int r2) {
        Uint8Array uint8Array = this;
        if (r2 >= 0 && r2 < uint8Array.getLength()) {
    ...
    public void m1684setEK6454(int r2, byte b) {
        Uint8Array uint8Array = this;
        if (r2 >= 0 && r2 < uint8Array.getLength()) {
            writeByte(r2 * 1, b);
            return;
