...
public final class Uint8ClampedArray implements TypedArray, GenericTypedArray<UByte> {
    ...
    public /* bridge */ /* synthetic */ UByte get(int r1) {
        return UByte.m1761boximpl(m1685getWa3L5BU(r1));
    }
    ...
    @Override // expo.modules.kotlin.typedarray.GenericTypedArray
    public /* bridge */ /* synthetic */ void set(int r1, UByte uByte) {
        m1686setEK6454(r1, uByte.m1816unboximpl());
    }

    /* renamed from: get-Wa3L5BU  reason: not valid java name */
    public byte m1685getWa3L5BU(int r2) {
        Uint8ClampedArray uint8ClampedArray = this;
        if (r2 >= 0 && r2 < uint8ClampedArray.getLength()) {
            return UByte.m1767constructorimpl(readByte(r2 * 1));
        }
        throw new IndexOutOfBoundsException();
    }

    /* renamed from: set-EK-6454  reason: not valid java name */
    public void m1686setEK6454(int r2, byte b) {
        Uint8ClampedArray uint8ClampedArray = this;
        if (r2 >= 0 && r2 < uint8ClampedArray.getLength()) {
            writeByte(r2 * 1, b);
            return;
