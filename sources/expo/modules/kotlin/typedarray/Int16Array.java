...
public final class Int16Array implements TypedArray, GenericTypedArray<Short> {
    ...
    public /* bridge */ /* synthetic */ void set(int r1, Short sh) {
        set(r1, sh.shortValue());
    }

    @Override // expo.modules.kotlin.typedarray.GenericTypedArray
    public Short get(int r2) {
        Int16Array int16Array = this;
        if (r2 >= 0 && r2 < int16Array.getLength()) {
            return Short.valueOf(read2Byte(r2 * 2));
        }
        throw new IndexOutOfBoundsException();
    }

    public void set(int r2, short s) {
        Int16Array int16Array = this;
        if (r2 >= 0 && r2 < int16Array.getLength()) {
            write2Byte(r2 * 2, s);
            return;
