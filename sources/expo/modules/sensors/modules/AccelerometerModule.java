...
public final class AccelerometerModule extends BaseSensorModule {
    ...
    public AccelerometerModule(Context context) {
        super(context);
        this.eventName = "accelerometerDidUpdate";
    }
    ...
    public SensorServiceInterface getSensorService() {
        Object module = getModuleRegistry().getModule(AccelerometerServiceInterface.class);
    ...
    public final void isAvailableAsync(Promise promise) {
        ...
        promise.resolve(Boolean.valueOf(((SensorManager) systemService).getDefaultSensor(1) != null));
    }
}
