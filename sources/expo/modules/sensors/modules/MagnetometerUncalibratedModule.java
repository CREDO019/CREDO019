...
public final class MagnetometerUncalibratedModule extends BaseSensorModule {
    ...
    public MagnetometerUncalibratedModule(Context context) {
        super(context);
        this.eventName = "magnetometerUncalibratedDidUpdate";
    }
    ...
    public SensorServiceInterface getSensorService() {
        Object module = getModuleRegistry().getModule(MagnetometerUncalibratedServiceInterface.class);
    ...
    public final void isAvailableAsync(Promise promise) {
        ...
        promise.resolve(Boolean.valueOf(((SensorManager) systemService).getDefaultSensor(14) != null));
    }
}
