...
public final class LightSensorModule extends BaseSensorModule {
    ...
    public LightSensorModule(Context context) {
        super(context);
        this.eventName = "lightSensorDidUpdate";
    }
    ...
    public SensorServiceInterface getSensorService() {
        Object module = getModuleRegistry().getModule(LightSensorServiceInterface.class);
    ...
    public final void isAvailableAsync(Promise promise) {
        ...
        promise.resolve(Boolean.valueOf(((SensorManager) systemService).getDefaultSensor(5) != null));
    }
}
