...
public final class MagnetometerModule extends BaseSensorModule {
    ...
    public MagnetometerModule(Context context) {
        super(context);
        this.eventName = "magnetometerDidUpdate";
    }
    ...
    public SensorServiceInterface getSensorService() {
        Object module = getModuleRegistry().getModule(MagnetometerServiceInterface.class);
    ...
    public final void isAvailableAsync(Promise promise) {
        ...
        promise.resolve(Boolean.valueOf(((SensorManager) systemService).getDefaultSensor(2) != null));
    }
}
