...
public class AttributeCertificateHolder implements CertSelector, Selector {
    ...
    public AttributeCertificateHolder(int r5, String str, String str2, byte[] bArr) {
        this.holder = new Holder(new ObjectDigestInfo(r5, new ASN1ObjectIdentifier(str2), new AlgorithmIdentifier(new ASN1ObjectIdentifier(str)), Arrays.clone(bArr)));
    }
    ...
    private Object[] getNames(GeneralName[] generalNameArr) {
        ...
        for (int r1 = 0; r1 != generalNameArr.length; r1++) {
            if (generalNameArr[r1].getTagNo() == 4) {
                try {
                    arrayList.add(new X500Principal(generalNameArr[r1].getName().toASN1Primitive().getEncoded()));
    ...
    private Principal[] getPrincipals(GeneralNames generalNames) {
        ...
        for (int r1 = 0; r1 != names.length; r1++) {
            if (names[r1] instanceof Principal) {
                arrayList.add(names[r1]);
            }
        }
