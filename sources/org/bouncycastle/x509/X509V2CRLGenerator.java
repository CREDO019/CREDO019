...
public class X509V2CRLGenerator {
    ...
    public void addCRLEntry(BigInteger bigInteger, Date date, int r5) {
        this.tbsGen.addCRLEntry(new ASN1Integer(bigInteger), new Time(date), r5);
    }

    public void addCRLEntry(BigInteger bigInteger, Date date, int r5, Date date2) {
        this.tbsGen.addCRLEntry(new ASN1Integer(bigInteger), new Time(date), r5, new ASN1GeneralizedTime(date2));
    }
