                            ...
                            if ((!this.targetNames.isEmpty() || !this.targetGroups.isEmpty()) && (extensionValue = x509AttributeCertificate.getExtensionValue(Extension.targetInformation.getId())) != null) {
                                try {
                                    ...
                                    if (!this.targetNames.isEmpty()) {
                                        ...
                                        for (Targets targets : targetsObjects) {
                                            ...
                                            int r5 = 0;
                                            while (true) {
                                                if (r5 >= targets2.length) {
                                                    break;
                                                } else if (this.targetNames.contains(GeneralName.getInstance(targets2[r5].getTargetName()))) {
                                                    z = true;
                                                    break;
                                                } else {
                                                    r5++;
                                ...
                                if (!this.targetGroups.isEmpty()) {
                                    ...
                                    for (Targets targets3 : targetsObjects) {
                                        ...
                                        int r52 = 0;
                                        while (true) {
                                            if (r52 >= targets4.length) {
                                                break;
                                            } else if (this.targetGroups.contains(GeneralName.getInstance(targets4[r52].getTargetGroup()))) {
                                                z2 = true;
                                                break;
                                            } else {
                                                r52++;
