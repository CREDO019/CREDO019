...
public class AttributeCertificateIssuer implements CertSelector, Selector {
    ...
    private Object[] getNames() {
        ...
        for (int r2 = 0; r2 != names.length; r2++) {
            if (names[r2].getTagNo() == 4) {
                try {
                    arrayList.add(new X500Principal(names[r2].getName().toASN1Primitive().getEncoded()));
    ...
    public Principal[] getPrincipals() {
        ...
        for (int r2 = 0; r2 != names.length; r2++) {
            if (names[r2] instanceof Principal) {
                arrayList.add(names[r2]);
            }
        }
