...
public class X509V2AttributeCertificate implements X509AttributeCertificate {
    ...
    public X509Attribute[] getAttributes() {
        ...
        for (int r2 = 0; r2 != attributes.size(); r2++) {
            x509AttributeArr[r2] = new X509Attribute(attributes.getObjectAt(r2));
        }
    ...
    public X509Attribute[] getAttributes(String str) {
        ...
        for (int r2 = 0; r2 != attributes.size(); r2++) {
            X509Attribute x509Attribute = new X509Attribute(attributes.getObjectAt(r2));
