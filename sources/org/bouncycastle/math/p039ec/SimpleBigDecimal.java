...
class SimpleBigDecimal {
    ...
    public SimpleBigDecimal(BigInteger bigInteger, int r2) {
        if (r2 < 0) {
    ...
    public static SimpleBigDecimal getInstance(BigInteger bigInteger, int r2) {
        return new SimpleBigDecimal(bigInteger.shiftLeft(r2), r2);
    }
    ...
    public SimpleBigDecimal adjustScale(int r4) {
        if (r4 >= 0) {
            int r0 = this.scale;
            return r4 == r0 ? this : new SimpleBigDecimal(this.bigInt.shiftLeft(r4 - r0), r4);
        }
        throw new IllegalArgumentException("scale may not be negative");
    }
    ...
    public SimpleBigDecimal multiply(SimpleBigDecimal simpleBigDecimal) {
        ...
        int r1 = this.scale;
        return new SimpleBigDecimal(multiply, r1 + r1);
    }
    ...
    public SimpleBigDecimal shiftLeft(int r3) {
        return new SimpleBigDecimal(this.bigInt.shiftLeft(r3), this.scale);
    }
    ...
    public String toString() {
        ...
        int r4 = this.scale - length;
        for (int r6 = 0; r6 < r4; r6++) {
            cArr[r6] = '0';
        }
        for (int r5 = 0; r5 < length; r5++) {
            cArr[r4 + r5] = bigInteger2.charAt(r5);
        }
