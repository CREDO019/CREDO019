...
public class WTauNafMultiplier extends AbstractECMultiplier {
    ...
    private static ECPoint.AbstractF2m multiplyFromWTnaf(final ECPoint.AbstractF2m abstractF2m, byte[] bArr) {
        ...
        for (int r3 = 0; r3 < preComp.length; r3++) {
            abstractF2mArr[r3] = (ECPoint.AbstractF2m) preComp[r3].negate();
        }
        ...
        for (int length = bArr.length - 1; length >= 0; length--) {
            ...
            byte b = bArr[length];
            if (b != 0) {
                abstractF2m3 = (ECPoint.AbstractF2m) abstractF2m3.tauPow(r4).add(b > 0 ? preComp[b >>> 1] : abstractF2mArr[(-b) >>> 1]);
                r4 = 0;
            }
        }
        return r4 > 0 ? abstractF2m3.tauPow(r4) : abstractF2m3;
    }
