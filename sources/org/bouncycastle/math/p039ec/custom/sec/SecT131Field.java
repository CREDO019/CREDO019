...
public class SecT131Field {
    ...
    protected static void implMulw(long[] jArr, long j, long j2, long[] jArr2, int r25) {
        jArr[1] = j2;
        jArr[2] = jArr[1] << 1;
        jArr[3] = jArr[2] ^ j2;
        jArr[4] = jArr[2] << 1;
        ...
        jArr[7] = jArr[6] ^ j2;
        int r3 = (int) j;
        long j3 = (((jArr[r3 & 7] ^ (jArr[(r3 >>> 3) & 7] << 3)) ^ (jArr[(r3 >>> 6) & 7] << 6)) ^ (jArr[(r3 >>> 9) & 7] << 9)) ^ (jArr[(r3 >>> 12) & 7] << 12);
        long j4 = 0;
        int r32 = 30;
        do {
            int r14 = (int) (j >>> r32);
            long j5 = (jArr[(r14 >>> 12) & 7] << 12) ^ (((jArr[r14 & 7] ^ (jArr[(r14 >>> 3) & 7] << 3)) ^ (jArr[(r14 >>> 6) & 7] << 6)) ^ (jArr[(r14 >>> 9) & 7] << 9));
            j3 ^= j5 << r32;
            j4 ^= j5 >>> (-r32);
            r32 -= 15;
        } while (r32 > 0);
        jArr2[r25] = M44 & j3;
        jArr2[r25 + 1] = (j3 >>> 44) ^ (j4 << 20);
    }
    ...
    public static void reduce61(long[] jArr, int r13) {
        ...
        long j = jArr[r0];
        long j2 = j >>> 3;
        jArr[r13] = jArr[r13] ^ ((((j2 << 2) ^ j2) ^ (j2 << 3)) ^ (j2 << 8));
        int r132 = r13 + 1;
        jArr[r132] = (j2 >>> 56) ^ jArr[r132];
        jArr[r0] = j & M03;
    }
