...
public class SecT283Field {
    ...
    protected static void implMulw(long[] jArr, long j, long j2, long[] jArr2, int r23) {
        jArr[1] = j2;
        jArr[2] = jArr[1] << 1;
        jArr[3] = jArr[2] ^ j2;
        jArr[4] = jArr[2] << 1;
        ...
        do {
            int r12 = (int) (j >>> r10);
            long j5 = (jArr[(r12 >>> 6) & 7] << 6) ^ (jArr[r12 & 7] ^ (jArr[(r12 >>> 3) & 7] << 3));
            j3 ^= j5 << r10;
            j4 ^= j5 >>> (-r10);
            r10 -= 9;
        } while (r10 > 0);
        jArr2[r23] = M57 & j3;
        jArr2[r23 + 1] = (((((j & 72198606942111744L) & ((j2 << 7) >> 63)) >>> 8) ^ j4) << 7) ^ (j3 >>> 57);
    }
    ...
    public static void reduce37(long[] jArr, int r12) {
        ...
        long j = jArr[r0];
        long j2 = j >>> 27;
        jArr[r12] = ((j2 << 12) ^ (((j2 << 5) ^ j2) ^ (j2 << 7))) ^ jArr[r12];
        jArr[r0] = j & M27;
    }
