    ...
    */
    public void close() throws java.io.IOException {
        ...
        L40:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.p035io.CipherOutputStream.close():void");
    }
    ...
    public void write(byte[] bArr, int r3, int r4) throws IOException {
        byte[] update = this.cipher.update(bArr, r3, r4);
        if (update != null) {
