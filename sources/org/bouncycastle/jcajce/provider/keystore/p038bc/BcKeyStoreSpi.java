package org.bouncycastle.jcajce.provider.keystore.p038bc;
...
import org.bouncycastle.crypto.p034io.DigestInputStream;
import org.bouncycastle.crypto.p034io.DigestOutputStream;
import org.bouncycastle.crypto.p034io.MacInputStream;
import org.bouncycastle.crypto.p034io.MacOutputStream;
import org.bouncycastle.jcajce.p035io.CipherInputStream;
import org.bouncycastle.jcajce.p035io.CipherOutputStream;
...
import org.bouncycastle.util.p041io.TeeOutputStream;
...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    public static class BouncyCastleStore extends BcKeyStoreSpi {
        ...
        @Override // org.bouncycastle.jcajce.provider.keystore.p038bc.BcKeyStoreSpi, java.security.KeyStoreSpi
    ...
    public class StoreEntry {
        ...
        StoreEntry(String str, Date date, int r4, Object obj) {
            new Date();
            this.alias = str;
            this.date = date;
            this.type = r4;
        ...
        StoreEntry(String str, Date date, int r4, Object obj, Certificate[] certificateArr) {
            new Date();
            this.alias = str;
            this.date = date;
            this.type = r4;
                ...
                try {
                    ...
                    try {
                        ...
                        if (decodeKey != null) {
                            ...
                            dataOutputStream.writeInt(r8);
                            DataOutputStream dataOutputStream2 = new DataOutputStream(new CipherOutputStream(dataOutputStream, BcKeyStoreSpi.this.makePBECipher(BcKeyStoreSpi.KEY_CIPHER, 1, cArr, bArr3, r8)));
    ...
    public void engineStore(OutputStream outputStream, char[] cArr) throws IOException {
        ...
        for (int r2 = 0; r2 != PKCS12PasswordToBytes.length; r2++) {
            PKCS12PasswordToBytes[r2] = 0;
        }
        ...
        for (int read = dataInputStream.read(); read > 0; read = dataInputStream.read()) {
            ...
            if (readInt != 0) {
                ...
                for (int r3 = 0; r3 != readInt; r3++) {
                    certificateArr[r3] = decodeCertificate(dataInputStream);
                }
            }
    ...
    protected Cipher makePBECipher(String str, int r4, char[] cArr, byte[] bArr, int r7) throws IOException {
        try {
            PBEKeySpec pBEKeySpec = new PBEKeySpec(cArr);
            SecretKeyFactory createSecretKeyFactory = this.helper.createSecretKeyFactory(str);
            PBEParameterSpec pBEParameterSpec = new PBEParameterSpec(bArr, r7);
            Cipher createCipher = this.helper.createCipher(str);
            createCipher.init(r4, createSecretKeyFactory.generateSecret(pBEKeySpec), pBEParameterSpec);
            return createCipher;
        } catch (Exception e) {
    ...
    protected void saveStore(OutputStream outputStream) throws IOException {
        ...
        while (true) {
            ...
            if (certificateChain == null) {
                ...
                for (int r2 = 0; r2 != certificateChain.length; r2++) {
                    encodeCertificate(certificateChain[r2], dataOutputStream);
                }
            }
