...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    protected byte[] bigIntToBytes(BigInteger bigInteger) {
        int bitLength = (this.f2186p.bitLength() + 7) / 8;
    ...
    protected Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        if (this.f2187x != null) {
            if (key instanceof DHPublicKey) {
                ...
                if (dHPublicKey.getParams().getG().equals(this.f2185g) && dHPublicKey.getParams().getP().equals(this.f2186p)) {
                    BigInteger y = dHPublicKey.getY();
                    if (y != null && y.compareTo(TWO) >= 0) {
                        BigInteger bigInteger = this.f2186p;
                        ...
                        if (y.compareTo(bigInteger.subtract(bigInteger2)) < 0) {
                            if (this.unifiedAgreement != null) {
                                ...
                                BigInteger modPow = y.modPow(this.f2187x, this.f2186p);
    ...
    public int engineGenerateSecret(byte[] bArr, int r3) throws IllegalStateException, ShortBufferException {
        if (this.f2187x != null) {
            return super.engineGenerateSecret(bArr, r3);
        }
        throw new IllegalStateException("Diffie-Hellman not initialised.");
    }
    ...
    protected void engineInit(Key key, SecureRandom secureRandom) throws InvalidKeyException {
        ...
        this.f2186p = dHPrivateKey.getParams().getP();
        this.f2185g = dHPrivateKey.getParams().getG();
    ...
    protected void engineInit(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec == null) {
            ...
            this.f2186p = dHParameterSpec.getP();
            this.f2185g = dHParameterSpec.getG();
