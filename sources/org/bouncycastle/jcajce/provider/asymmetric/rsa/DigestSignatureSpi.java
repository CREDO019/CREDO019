...
public class DigestSignatureSpi extends SignatureSpi {
    ...
    @Override // java.security.SignatureSpi
    protected void engineUpdate(byte[] bArr, int r3, int r4) throws SignatureException {
    ...
    protected boolean engineVerify(byte[] bArr) throws SignatureException {
        ...
        int r3 = derEncode[3] + 4;
        int r4 = r3 + 2;
        int r6 = 0;
        for (int r5 = 0; r5 < derEncode.length - r4; r5++) {
            r6 |= processBlock[r3 + r5] ^ derEncode[r4 + r5];
        }
        for (int r42 = 0; r42 < r3; r42++) {
            r6 |= processBlock[r42] ^ derEncode[r42];
        }
        return r6 == 0;
    }
}
