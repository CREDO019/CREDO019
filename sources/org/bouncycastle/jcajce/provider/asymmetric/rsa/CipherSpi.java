...
public class CipherSpi extends BaseCipherSpi {
    ...
    @Override // javax.crypto.CipherSpi
    protected void engineInit(int r6, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        CipherParameters generatePrivateKeyParameter;
        if (algorithmParameterSpec != null && !(algorithmParameterSpec instanceof OAEPParameterSpec)) {
            throw new InvalidAlgorithmParameterException("unknown parameter type: " + algorithmParameterSpec.getClass().getName());
        }
        if (key instanceof RSAPublicKey) {
            if (this.privateKeyOnly && r6 == 1) {
        ...
        if (r6 != 1) {
            if (r6 != 2) {
                if (r6 != 3) {
                    if (r6 != 4) {
                        throw new InvalidParameterException("unknown opmode " + r6 + " passed to RSA");
                    }
                }
            }
