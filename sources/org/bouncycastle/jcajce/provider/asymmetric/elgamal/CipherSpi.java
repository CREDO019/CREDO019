...
public class CipherSpi extends BaseCipherSpi {
    ...
    protected int engineDoFinal(byte[] bArr, int r4, int r5, byte[] bArr2, int r7) throws IllegalBlockSizeException, BadPaddingException, ShortBufferException {
        if (engineGetOutputSize(r5) + r7 <= bArr2.length) {
            if (bArr != null) {
                this.bOut.write(bArr, r4, r5);
            }
            ...
            for (int r42 = 0; r42 != output.length; r42++) {
                bArr2[r7 + r42] = output[r42];
            }
    ...
    @Override // javax.crypto.CipherSpi
    protected void engineInit(int r1, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
    ...
    @Override // javax.crypto.CipherSpi
    protected void engineInit(int r5, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (r5 != 1) {
            if (r5 != 2) {
                if (r5 != 3) {
                    if (r5 != 4) {
                        throw new InvalidParameterException("unknown opmode " + r5 + " passed to ElGamal");
                    }
                }
            }
    ...
    @Override // javax.crypto.CipherSpi
    protected int engineUpdate(byte[] bArr, int r2, int r3, byte[] bArr2, int r5) {
        this.bOut.write(bArr, r2, r3);
        return 0;
    }
