...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public KeyFactorySpi(String str, boolean z, int r3) {
        this.algorithm = str;
        this.isXdh = z;
        this.specificBase = r3;
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof X509EncodedKeySpec) {
            ...
            int r1 = this.specificBase;
            if (r1 == 0 || r1 == encoded[8]) {
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (this.isXdh) {
            int r1 = this.specificBase;
            if ((r1 == 0 || r1 == 111) && algorithm.equals((ASN1Primitive) EdECObjectIdentifiers.id_X448)) {
                return new BCXDHPrivateKey(privateKeyInfo);
            }
            int r12 = this.specificBase;
            if ((r12 == 0 || r12 == 110) && algorithm.equals((ASN1Primitive) EdECObjectIdentifiers.id_X25519)) {
                return new BCXDHPrivateKey(privateKeyInfo);
            }
            ...
            if ((r13 == 0 || r13 == 113) && algorithm.equals((ASN1Primitive) EdECObjectIdentifiers.id_Ed448)) {
