...
public class BCECGOST3410_2012PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private void extractBytes(byte[] bArr, int r6, int r7, BigInteger bigInteger) {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            int r2 = algorithm.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) ? 64 : 32;
            int r0 = r2 * 2;
            byte[] bArr = new byte[r0 + 1];
            bArr[0] = 4;
            for (int r4 = 1; r4 <= r2; r4++) {
                bArr[r4] = octets[r2 - r4];
                bArr[r4 + r2] = octets[r0 - r4];
            }
    ...
    public byte[] getEncoded() {
        ...
        if (gostParams == null) {
            ...
            if (eCParameterSpec instanceof ECNamedCurveSpec) {
                ...
                x962Parameters = z ? new GOST3410PublicKeyAlgParameters(aSN1ObjectIdentifier2, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512) : new GOST3410PublicKeyAlgParameters(aSN1ObjectIdentifier2, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256);
            } else {
        ...
        int r52 = r5 / 2;
        extractBytes(bArr, r52, 0, bigInteger);
        extractBytes(bArr, r52, r2, bigInteger2);
        try {
