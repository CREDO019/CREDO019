...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    private CRL getCRL() throws CRLException {
        ...
        int r1 = this.sCrlDataObjectCount;
        this.sCrlDataObjectCount = r1 + 1;
        return createCRL(CertificateList.getInstance(aSN1Set2.getObjectAt(r1)));
    }
    ...
    private Certificate getCertificate() throws CertificateParsingException {
        if (this.sData != null) {
            while (this.sDataObjectCount < this.sData.size()) {
                ASN1Set aSN1Set = this.sData;
                int r1 = this.sDataObjectCount;
                this.sDataObjectCount = r1 + 1;
                ASN1Encodable objectAt = aSN1Set.getObjectAt(r1);
