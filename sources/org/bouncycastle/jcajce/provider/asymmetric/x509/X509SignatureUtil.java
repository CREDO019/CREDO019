...
class X509SignatureUtil {
    ...
    private static String findAlgName(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        if (provider == null || (lookupAlg2 = lookupAlg(provider, aSN1ObjectIdentifier)) == null) {
            ...
            for (int r2 = 0; r2 != providers.length; r2++) {
                if (provider != providers[r2] && (lookupAlg = lookupAlg(providers[r2], aSN1ObjectIdentifier)) != null) {
                    return lookupAlg;
                }
            }
    ...
    public static void prettyPrintSignature(byte[] bArr, StringBuffer stringBuffer, String str) {
        ...
        while (r0 < bArr.length) {
            ...
            stringBuffer.append("                       ");
            stringBuffer.append(r0 < length2 ? Hex.toHexString(bArr, r0, 20) : Hex.toHexString(bArr, r0, bArr.length - r0));
            stringBuffer.append(str);
            r0 += 20;
        }
    }
