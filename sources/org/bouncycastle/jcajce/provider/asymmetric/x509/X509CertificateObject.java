...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private static boolean[] createKeyUsage(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            boolean[] zArr = new boolean[r7];
            for (int r3 = 0; r3 != length; r3++) {
                zArr[r3] = (bytes[r3 / 8] & (128 >>> (r3 % 8))) != 0;
            }
            return zArr;
        } catch (Exception e) {
    ...
    private X509CertificateInternal getInternalCertificate() {
        ...
        synchronized (this.cacheLock) {
            ...
            try {
                ...
                bArr = this.f2202c.getEncoded(ASN1Encoding.DER);
            } catch (IOException e) {
                bArr = null;
                x509CertificateEncodingException = new X509CertificateEncodingException(e);
            }
            X509CertificateInternal x509CertificateInternal3 = new X509CertificateInternal(this.bcHelper, this.f2202c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, bArr, x509CertificateEncodingException);
            synchronized (this.cacheLock) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f2202c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f2202c.getSignature())) {
                return false;
            }
