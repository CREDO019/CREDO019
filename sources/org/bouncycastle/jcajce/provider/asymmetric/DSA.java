...
public class DSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            for (int r2 = 0; r2 != DSAUtil.dsaOids.length; r2++) {
                configurableProvider.addAlgorithm("Alg.Alias.Signature." + DSAUtil.dsaOids[r2], "DSA");
                registerOid(configurableProvider, DSAUtil.dsaOids[r2], "DSA", keyFactorySpi);
                registerOidAlgorithmParameterGenerator(configurableProvider, DSAUtil.dsaOids[r2], "DSA");
            }
        }
    }
}
