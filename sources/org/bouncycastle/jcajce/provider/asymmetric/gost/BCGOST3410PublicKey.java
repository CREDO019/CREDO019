...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    public BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            for (int r2 = 0; r2 != octets.length; r2++) {
                bArr[r2] = octets[(octets.length - 1) - r2];
            }
            this.f2198y = new BigInteger(1, bArr);
    ...
    public BCGOST3410PublicKey(GOST3410PublicKeyParameters gOST3410PublicKeyParameters, GOST3410ParameterSpec gOST3410ParameterSpec) {
        this.f2198y = gOST3410PublicKeyParameters.getY();
        this.gost3410Spec = gOST3410ParameterSpec;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCGOST3410PublicKey(GOST3410PublicKey gOST3410PublicKey) {
        this.f2198y = gOST3410PublicKey.getY();
        this.gost3410Spec = gOST3410PublicKey.getParameters();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCGOST3410PublicKey(GOST3410PublicKeySpec gOST3410PublicKeySpec) {
        this.f2198y = gOST3410PublicKeySpec.getY();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BCGOST3410PublicKey) {
            ...
            return this.f2198y.equals(bCGOST3410PublicKey.f2198y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec);
        }
        return false;
    }
    ...
    public byte[] getEncoded() {
        ...
        for (int r1 = 0; r1 != bArr.length; r1++) {
            bArr[r1] = byteArray[(byteArray.length - 1) - r1];
        }
        try {
    ...
    public int hashCode() {
        return this.f2198y.hashCode() ^ this.gost3410Spec.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString("GOST3410", this.f2198y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
