...
public abstract class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    /* loaded from: classes5.dex */
    public static class C5287EC extends KeyPairGeneratorSpi {
        ...
        public C5287EC(String str, ProviderConfiguration providerConfiguration) {
            super(str);
            this.engine = new ECKeyPairGenerator();
            this.ecParams = null;
            this.strength = 239;
        ...
        @Override // java.security.KeyPairGenerator, java.security.KeyPairGeneratorSpi
        public void initialize(int r2, SecureRandom secureRandom) {
            this.strength = r2;
            this.random = secureRandom;
            ECGenParameterSpec eCGenParameterSpec = (ECGenParameterSpec) ecParameters.get(Integers.valueOf(r2));
    ...
    /* loaded from: classes5.dex */
    public static class ECDH extends C5287EC {
        public ECDH() {
    ...
    /* loaded from: classes5.dex */
    public static class ECDHC extends C5287EC {
        public ECDHC() {
    ...
    /* loaded from: classes5.dex */
    public static class ECDSA extends C5287EC {
        public ECDSA() {
    ...
    /* loaded from: classes5.dex */
    public static class ECMQV extends C5287EC {
        public ECMQV() {
