...
public class EC5Util {
    ...
    static {
        ...
        customCurves.put(new ECCurve.C5335Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor()), curve);
    }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C5335Fp c5335Fp = new ECCurve.C5335Fp(((ECFieldFp) field).getP(), a, b);
            return customCurves.containsKey(c5335Fp) ? (ECCurve) customCurves.get(c5335Fp) : c5335Fp;
        }
    ...
    public static ECPoint convertPoint(org.bouncycastle.math.p039ec.ECPoint eCPoint) {
        org.bouncycastle.math.p039ec.ECPoint normalize = eCPoint.normalize();
        return new ECPoint(normalize.getAffineXCoord().toBigInteger(), normalize.getAffineYCoord().toBigInteger());
    }

    public static org.bouncycastle.math.p039ec.ECPoint convertPoint(ECParameterSpec eCParameterSpec, ECPoint eCPoint) {
        return convertPoint(convertCurve(eCParameterSpec.getCurve()), eCPoint);
    }

    public static org.bouncycastle.math.p039ec.ECPoint convertPoint(ECCurve eCCurve, ECPoint eCPoint) {
    ...
    public static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec) {
        ...
        org.bouncycastle.math.p039ec.ECPoint convertPoint = convertPoint(convertCurve, eCParameterSpec.getGenerator());
