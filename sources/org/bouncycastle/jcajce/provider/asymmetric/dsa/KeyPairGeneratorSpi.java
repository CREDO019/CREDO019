...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
                ...
                synchronized (lock) {
                    if (params.containsKey(valueOf)) {
                        ...
                        if (r3 == 1024) {
                            ...
                            DSAParameterGenerationParameters dSAParameterGenerationParameters = new DSAParameterGenerationParameters(r3, 256, defaultCertainty, this.random);
    ...
    @Override // java.security.KeyPairGenerator, java.security.KeyPairGeneratorSpi
    public void initialize(int r5, SecureRandom secureRandom) {
        boolean z;
        if (r5 < 512 || r5 > 4096 || ((r5 < 1024 && r5 % 64 != 0) || (r5 >= 1024 && r5 % 1024 != 0))) {
            throw new InvalidParameterException("strength must be from 512 - 4096 and a multiple of 1024 above 1024");
        }
        DSAParameterSpec dSADefaultParameters = BouncyCastleProvider.CONFIGURATION.getDSADefaultParameters(r5);
