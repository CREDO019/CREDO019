...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f2189y;

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f2189y = dSAPublicKey.getY();
        this.dsaSpec = dSAPublicKey.getParams();
        this.lwKeyParams = new DSAPublicKeyParameters(this.f2189y, DSAUtil.toDSAParameters(this.dsaSpec));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f2189y = dSAPublicKeySpec.getY();
    ...
    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f2189y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f2189y = dSAPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (this.dsaSpec == null) {
            ...
            aSN1Integer = new ASN1Integer(this.f2189y);
        } else {
    ...
    public String toString() {
        ...
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f2189y, getParams()));
        stringBuffer.append("]");
