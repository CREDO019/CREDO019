...
public final class RC2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        protected byte[] engineGetEncoded() {
            return Arrays.clone(this.f2209iv);
        }

        @Override // java.security.AlgorithmParametersSpi
        protected byte[] engineGetEncoded(String str) throws IOException {
            if (isASN1FormatString(str)) {
                int r3 = this.parameterVersion;
                return r3 == -1 ? new RC2CBCParameter(engineGetEncoded()).getEncoded() : new RC2CBCParameter(r3, engineGetEncoded()).getEncoded();
        ...
        protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f2209iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
                ...
                this.f2209iv = rC2ParameterSpec.getIV();
            }
        }

        @Override // java.security.AlgorithmParametersSpi
        protected void engineInit(byte[] bArr) throws IOException {
            this.f2209iv = Arrays.clone(bArr);
        }
        ...
        protected void engineInit(byte[] bArr, String str) throws IOException {
            ...
            this.f2209iv = rC2CBCParameter.getIV();
        }
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            int r0;
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (r0 = this.parameterVersion) != -1) {
                return r0 < 256 ? new RC2ParameterSpec(ekb[this.parameterVersion], this.f2209iv) : new RC2ParameterSpec(this.parameterVersion, this.f2209iv);
            } else if (cls == IvParameterSpec.class) {
                return new IvParameterSpec(this.f2209iv);
            } else {
