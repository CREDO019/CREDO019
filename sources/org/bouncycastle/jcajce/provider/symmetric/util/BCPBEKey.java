...
public class BCPBEKey implements PBEKey, Destroyable {
    ...
    public BCPBEKey(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier, int r5, int r6, int r7, int r8, PBEKeySpec pBEKeySpec, CipherParameters cipherParameters) {
    ...
    public byte[] getEncoded() {
        ...
        if (cipherParameters == null) {
            int r0 = this.type;
            return r0 == 2 ? PBEParametersGenerator.PKCS12PasswordToBytes(this.password) : r0 == 5 ? PBEParametersGenerator.PKCS5PasswordToUTF8Bytes(this.password) : PBEParametersGenerator.PKCS5PasswordToBytes(this.password);
        }
