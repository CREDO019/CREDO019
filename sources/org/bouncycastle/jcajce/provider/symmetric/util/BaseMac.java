...
public class BaseMac extends MacSpi implements PBE {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public BaseMac(Mac mac, int r2, int r3, int r4) {
        this.macEngine = mac;
        this.scheme = r2;
        this.pbeHash = r3;
        this.keySize = r4;
        ...
        if (key instanceof PKCS12Key) {
            try {
                ...
                try {
                    ...
                    if (this.macEngine.getAlgorithmName().startsWith("GOST")) {
                        ...
                        if ((mac instanceof HMac) && !mac.getAlgorithmName().startsWith("SHA-1")) {
                            if (this.macEngine.getAlgorithmName().startsWith(McElieceCCA2KeyGenParameterSpec.SHA224)) {
                                ...
                                r2 = 8;
                                r5 = BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT;
                    ...
                    makePBEMacParameters = PBE.Util.makePBEMacParameters(secretKey, 2, r2, r5, pBEParameterSpec);
    ...
    @Override // javax.crypto.MacSpi
    protected void engineUpdate(byte[] bArr, int r3, int r4) {
        this.macEngine.update(bArr, r3, r4);
    }
}
