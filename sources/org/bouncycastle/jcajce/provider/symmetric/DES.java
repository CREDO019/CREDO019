...
public final class DES {
    ...
    public static class DESPBEKeyFactory extends BaseSecretKeyFactory {
        ...
        public DESPBEKeyFactory(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z, int r4, int r5, int r6, int r7) {
    ...
    public static class KeyGenerator extends BaseKeyGenerator {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // org.bouncycastle.jcajce.provider.symmetric.util.BaseKeyGenerator, javax.crypto.KeyGeneratorSpi
        public void engineInit(int r1, SecureRandom secureRandom) {
            super.engineInit(r1, secureRandom);
        }
    }
