...
public class PBEPBKDF2 {
    ...
    public static class BasePBKDF2 extends BaseSecretKeyFactory {
        ...
        public BasePBKDF2(String str, int r3) {
            this(str, r3, 1);
        }

        public BasePBKDF2(String str, int r3, int r4) {
            super(str, PKCSObjectIdentifiers.id_PBKDF2);
            this.scheme = r3;
            this.defaultDigest = r4;
        }
        ...
        public SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
            if (keySpec instanceof PBEKeySpec) {
                ...
                if (pBEKeySpec.getSalt() == null) {
                    ...
                    int r5 = this.defaultDigest;
                    int keyLength2 = pBEKeySpec.getKeyLength();
                    return new BCPBEKey(this.algName, this.algOid, this.scheme, r5, keyLength2, -1, pBEKeySpec, PBE.Util.makePBEMacParameters(pBEKeySpec, this.scheme, r5, keyLength2));
                } else {
