...
public class Skein {
    ...
    public static class DigestSkein1024 extends BCMessageDigest implements Cloneable {
        public DigestSkein1024(int r3) {
            super(new SkeinDigest(1024, r3));
        }
    ...
    public static class DigestSkein256 extends BCMessageDigest implements Cloneable {
        public DigestSkein256(int r3) {
            super(new SkeinDigest(256, r3));
        }
    ...
    public static class DigestSkein512 extends BCMessageDigest implements Cloneable {
        public DigestSkein512(int r3) {
            super(new SkeinDigest(512, r3));
        }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int r7, int r8) {
            String str = "Skein-MAC-" + r7 + "-" + r8;
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + r7 + "/" + r8, str);
            StringBuilder sb2 = new StringBuilder();
            sb2.append("KeyGenerator.");
            sb2.append(str);
            configurableProvider.addAlgorithm(sb2.toString(), str2 + "$SkeinMacKeyGenerator_" + r7 + "_" + r8);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + r7 + "/" + r8, str);
        }
