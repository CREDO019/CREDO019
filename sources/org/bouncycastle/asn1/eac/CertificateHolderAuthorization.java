...
public class CertificateHolderAuthorization extends ASN1Object {
    ...
    /* renamed from: IS */
    public static final int f1603IS = 0;
    ...
    public CertificateHolderAuthorization(ASN1ObjectIdentifier aSN1ObjectIdentifier, int r2) throws IOException {
        setOid(aSN1ObjectIdentifier);
        setAccessRights((byte) r2);
    }
    ...
    public static String getRoleDescription(int r1) {
        return (String) AuthorizationRole.get(Integers.valueOf(r1));
    }
