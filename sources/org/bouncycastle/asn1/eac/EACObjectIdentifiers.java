...
public interface EACObjectIdentifiers {
    ...
    static {
        ...
        id_PK = branch;
        id_PK_DH = branch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_PK_ECDH = branch.branch("2");
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("2.2.3");
        id_CA = branch2;
        ASN1ObjectIdentifier branch3 = branch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_CA_DH = branch3;
        id_CA_DH_3DES_CBC_CBC = branch3.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ASN1ObjectIdentifier branch4 = branch2.branch("2");
        id_CA_ECDH = branch4;
        id_CA_ECDH_3DES_CBC_CBC = branch4.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ASN1ObjectIdentifier branch5 = aSN1ObjectIdentifier.branch("2.2.2");
        id_TA = branch5;
        ASN1ObjectIdentifier branch6 = branch5.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_TA_RSA = branch6;
        id_TA_RSA_v1_5_SHA_1 = branch6.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        id_TA_ECDSA = branch7;
        id_TA_ECDSA_SHA_1 = branch7.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
