...
public class EACTags {
    ...
    public static int decodeTag(int r4) {
        int r0 = 0;
        boolean z = false;
        for (int r2 = 24; r2 >= 0; r2 -= 8) {
            int r3 = (r4 >> r2) & 255;
            if (r3 != 0) {
                if (z) {
                    r0 = (r0 << 7) | (r3 & 127);
    ...
    public static int encodeTag(ASN1ApplicationSpecific aSN1ApplicationSpecific) {
        int r0 = aSN1ApplicationSpecific.isConstructed() ? 96 : 64;
        int applicationTag = aSN1ApplicationSpecific.getApplicationTag();
        if (applicationTag <= 31) {
            return r0 | applicationTag;
        }
        int r02 = r0 | 31;
        while (true) {
            int r03 = (r02 << 8) | (applicationTag & 127);
            applicationTag >>= 7;
            if (applicationTag <= 0) {
                return r03;
            }
    ...
    public static int getTag(int r0) {
        return decodeTag(r0);
    }

    public static int getTagNo(int r3) {
        for (int r0 = 24; r0 >= 0; r0 -= 8) {
            int r1 = 255 << r0;
            if ((r1 & r3) != 0) {
                return r3 & (~r1);
            }
