...
public class PKIBody extends ASN1Object implements ASN1Choice {
    ...
    public PKIBody(int r1, ASN1Encodable aSN1Encodable) {
        this.tagNo = r1;
        this.body = getBodyForType(r1, aSN1Encodable);
    }
    ...
    private static ASN1Encodable getBodyForType(int r2, ASN1Encodable aSN1Encodable) {
        switch (r2) {
            case 0:
            ...
            default:
                throw new IllegalArgumentException("unknown tag number: " + r2);
        }
    }
