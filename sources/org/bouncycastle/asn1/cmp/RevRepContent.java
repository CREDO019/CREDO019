...
public class RevRepContent extends ASN1Object {
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int r4, ASN1Encodable aSN1Encodable) {
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add(new DERTaggedObject(true, r4, aSN1Encodable));
        }
    }
    ...
    public CertificateList[] getCrls() {
        ...
        for (int r2 = 0; r2 != size; r2++) {
            certificateListArr[r2] = CertificateList.getInstance(this.crls.getObjectAt(r2));
        }
    ...
    public CertId[] getRevCerts() {
        ...
        for (int r2 = 0; r2 != size; r2++) {
            certIdArr[r2] = CertId.getInstance(this.revCerts.getObjectAt(r2));
        }
        return certIdArr;
    }
    ...
    public PKIStatusInfo[] getStatus() {
        ...
        for (int r2 = 0; r2 != size; r2++) {
            pKIStatusInfoArr[r2] = PKIStatusInfo.getInstance(this.status.getObjectAt(r2));
        }
