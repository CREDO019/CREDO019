...
public class PKIFreeText extends ASN1Object {
    ...
    public DERUTF8String getStringAt(int r2) {
        ASN1UTF8String stringAtUTF8 = getStringAtUTF8(r2);
    ...
    public ASN1UTF8String getStringAtUTF8(int r2) {
        return (ASN1UTF8String) this.strings.getObjectAt(r2);
    }
