...
public class PKIHeader extends ASN1Object {
    ...
    public PKIHeader(int r4, GeneralName generalName, GeneralName generalName2) {
        this(new ASN1Integer(r4), generalName, generalName2);
    }
    ...
    public InfoTypeAndValue[] getGeneralInfo() {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            infoTypeAndValueArr[r2] = InfoTypeAndValue.getInstance(this.generalInfo.getObjectAt(r2));
        }
