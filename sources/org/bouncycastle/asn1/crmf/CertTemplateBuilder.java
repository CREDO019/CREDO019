...
public class CertTemplateBuilder {
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int r3, boolean z, ASN1Encodable aSN1Encodable) {
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add(new DERTaggedObject(z, r3, aSN1Encodable));
        }
    }
    ...
    public CertTemplateBuilder setVersion(int r4) {
        this.version = new ASN1Integer(r4);
        return this;
    }
}
