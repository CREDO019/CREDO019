...
public class EncryptedValue extends ASN1Object {
    ...
    private EncryptedValue(ASN1Sequence aSN1Sequence) {
        int r1 = 0;
        while (aSN1Sequence.getObjectAt(r1) instanceof ASN1TaggedObject) {
            ASN1TaggedObject aSN1TaggedObject = (ASN1TaggedObject) aSN1Sequence.getObjectAt(r1);
        ...
        this.encValue = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(r1));
    }
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int r4, ASN1Encodable aSN1Encodable) {
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add(new DERTaggedObject(false, r4, aSN1Encodable));
        }
    }
