...
public abstract class ASN1External extends ASN1Primitive {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ASN1External(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Integer aSN1Integer, ASN1Primitive aSN1Primitive, int r4, ASN1Primitive aSN1Primitive2) {
        this.directReference = aSN1ObjectIdentifier;
        this.indirectReference = aSN1Integer;
        this.dataValueDescriptor = aSN1Primitive;
        this.encoding = checkEncoding(r4);
        this.externalContent = checkExternalContent(r4, aSN1Primitive2);
    }
    ...
    public ASN1External(ASN1Sequence aSN1Sequence) {
        ...
        if (objFromSequence instanceof ASN1Integer) {
            ...
            r0++;
            objFromSequence = getObjFromSequence(aSN1Sequence, r0);
        }
    ...
    private static int checkEncoding(int r3) {
        if (r3 < 0 || r3 > 2) {
            throw new IllegalArgumentException("invalid encoding value: " + r3);
        }
        return r3;
    }

    private static ASN1Primitive checkExternalContent(int r1, ASN1Primitive aSN1Primitive) {
    ...
    private static ASN1Primitive getObjFromSequence(ASN1Sequence aSN1Sequence, int r2) {
        if (aSN1Sequence.size() > r2) {
            return aSN1Sequence.getObjectAt(r2).toASN1Primitive();
        }
