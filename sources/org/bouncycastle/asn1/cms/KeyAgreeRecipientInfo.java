...
public class KeyAgreeRecipientInfo extends ASN1Object {
    ...
    private KeyAgreeRecipientInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.keyEncryptionAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r1));
        this.recipientEncryptedKeys = (ASN1Sequence) aSN1Sequence.getObjectAt(r1 + 1);
    }
