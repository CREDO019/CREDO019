...
public class CMSAlgorithmProtection extends ASN1Object {
    ...
    public CMSAlgorithmProtection(AlgorithmIdentifier algorithmIdentifier, int r3, AlgorithmIdentifier algorithmIdentifier2) {
        ...
        if (r3 == 1) {
            ...
            throw new IllegalArgumentException("Unknown type: " + r3);
        }
    }
