...
public class AttributeTable {
    ...
    public AttributeTable(ASN1EncodableVector aSN1EncodableVector) {
        this.attributes = new Hashtable();
        for (int r0 = 0; r0 != aSN1EncodableVector.size(); r0++) {
            Attribute attribute = Attribute.getInstance(aSN1EncodableVector.get(r0));
    ...
    public AttributeTable(ASN1Set aSN1Set) {
        this.attributes = new Hashtable();
        for (int r0 = 0; r0 != aSN1Set.size(); r0++) {
            Attribute attribute = Attribute.getInstance(aSN1Set.getObjectAt(r0));
            addAttribute(attribute.getAttrType(), attribute);
        }
    }
    ...
    public int size() {
        ...
        while (elements.hasMoreElements()) {
            ...
            r1 = nextElement instanceof Vector ? r1 + ((Vector) nextElement).size() : r1 + 1;
        }
        return r1;
    }
