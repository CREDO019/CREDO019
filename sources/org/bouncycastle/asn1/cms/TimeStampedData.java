...
public class TimeStampedData extends ASN1Object {
    ...
    private TimeStampedData(ASN1Sequence aSN1Sequence) {
        ...
        if ((aSN1Sequence.getObjectAt(r0) instanceof MetaData) || (aSN1Sequence.getObjectAt(r0) instanceof ASN1Sequence)) {
            this.metaData = MetaData.getInstance(aSN1Sequence.getObjectAt(r0));
            r0++;
        }
        if (aSN1Sequence.getObjectAt(r0) instanceof ASN1OctetString) {
            this.content = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(r0));
            r0++;
        }
        this.temporalEvidence = Evidence.getInstance(aSN1Sequence.getObjectAt(r0));
    }
