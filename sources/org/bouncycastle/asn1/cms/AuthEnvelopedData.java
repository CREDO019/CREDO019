...
public class AuthEnvelopedData extends ASN1Object {
    ...
    private AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        int r2 = r1 + 1;
        this.authEncryptedContentInfo = EncryptedContentInfo.getInstance(aSN1Sequence.getObjectAt(r1).toASN1Primitive());
        int r12 = r2 + 1;
        ASN1Primitive aSN1Primitive2 = aSN1Sequence.getObjectAt(r2).toASN1Primitive();
        if (aSN1Primitive2 instanceof ASN1TaggedObject) {
            this.authAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Primitive2, false);
            aSN1Primitive2 = aSN1Sequence.getObjectAt(r12).toASN1Primitive();
            r12++;
        ...
        if (aSN1Sequence.size() > r12) {
            this.unauthAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r12).toASN1Primitive(), false);
        }
    }
