...
public class MetaData extends ASN1Object {
    ...
    private MetaData(ASN1Sequence aSN1Sequence) {
        ...
        if (r1 < aSN1Sequence.size() && (aSN1Sequence.getObjectAt(r1) instanceof ASN1IA5String)) {
            this.mediaType = ASN1IA5String.getInstance(aSN1Sequence.getObjectAt(r1));
            r1++;
        }
        if (r1 < aSN1Sequence.size()) {
            this.otherMetaData = Attributes.getInstance(aSN1Sequence.getObjectAt(r1));
        }
    }
