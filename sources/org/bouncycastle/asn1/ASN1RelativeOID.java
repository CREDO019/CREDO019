...
public class ASN1RelativeOID extends ASN1Primitive {
    ...
    private ASN1RelativeOID(byte[] bArr, boolean z) {
        ...
        for (int r8 = 0; r8 != bArr2.length; r8++) {
            int r12 = bArr2[r8] & 255;
            if (j <= LONG_LIMIT) {
                long j2 = j + (r12 & 127);
                if ((r12 & 128) == 0) {
                    if (z2) {
                ...
                BigInteger or = (bigInteger == null ? BigInteger.valueOf(j) : bigInteger).or(BigInteger.valueOf(r12 & 127));
                if ((r12 & 128) == 0) {
                    if (z2) {
                        z2 = false;
                    } else {
    ...
    */
    ...
    public static void writeField(ByteArrayOutputStream byteArrayOutputStream, long j) {
        ...
        while (j >= 128) {
            j >>= 7;
            r2--;
            bArr[r2] = (byte) (((int) j) | 128);
        }
        byteArrayOutputStream.write(bArr, r2, 9 - r2);
    }
    ...
    public static void writeField(ByteArrayOutputStream byteArrayOutputStream, BigInteger bigInteger) {
        ...
        int r4 = bitLength - 1;
        for (int r5 = r4; r5 >= 0; r5--) {
            bArr[r5] = (byte) (bigInteger.intValue() | 128);
            bigInteger = bigInteger.shiftRight(7);
        }
        bArr[r4] = (byte) (bArr[r4] & Byte.MAX_VALUE);
