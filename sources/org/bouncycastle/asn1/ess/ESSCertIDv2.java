...
public class ESSCertIDv2 extends ASN1Object {
    ...
    private ESSCertIDv2(ASN1Sequence aSN1Sequence) {
        ...
        int r1 = r0 + 1;
        this.certHash = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(r0).toASN1Primitive()).getOctets();
        if (aSN1Sequence.size() > r1) {
            this.issuerSerial = IssuerSerial.getInstance(aSN1Sequence.getObjectAt(r1));
        }
    }
