...
public class KeyUsage extends ASN1Object {
    ...
    public KeyUsage(int r2) {
        this.bitString = new DERBitString(r2);
    }
    ...
    public boolean hasUsages(int r2) {
        return (this.bitString.intValue() & r2) == r2;
    }
    ...
    public String toString() {
        ...
        if (bytes.length == 1) {
            ...
            sb = new StringBuilder();
            sb.append("KeyUsage: 0x");
            r0 = (bytes[0] & 255) | ((bytes[1] & 255) << 8);
        }
        sb.append(Integer.toHexString(r0));
        return sb.toString();
    }
}
