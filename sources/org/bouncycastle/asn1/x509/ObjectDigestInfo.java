...
public class ObjectDigestInfo extends ASN1Object {
    ...
    public ObjectDigestInfo(int r2, ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
        this.digestedObjectType = new ASN1Enumerated(r2);
        if (r2 == 2) {
    ...
    private ObjectDigestInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.digestAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r0 + 1));
        this.objectDigest = DERBitString.getInstance((Object) aSN1Sequence.getObjectAt(r0 + 2));
    }
