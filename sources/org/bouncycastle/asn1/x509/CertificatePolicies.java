...
public class CertificatePolicies extends ASN1Object {
    ...
    private CertificatePolicies(ASN1Sequence aSN1Sequence) {
        ...
        for (int r0 = 0; r0 != aSN1Sequence.size(); r0++) {
            this.policyInformation[r0] = PolicyInformation.getInstance(aSN1Sequence.getObjectAt(r0));
        }
    }
    ...
    public PolicyInformation getPolicyInformation(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        while (true) {
            ...
            if (r0 == policyInformationArr.length) {
                return null;
            }
            if (aSN1ObjectIdentifier.equals((ASN1Primitive) policyInformationArr[r0].getPolicyIdentifier())) {
                return this.policyInformation[r0];
            }
            r0++;
        }
    }
    ...
    public String toString() {
        ...
        for (int r1 = 0; r1 < this.policyInformation.length; r1++) {
            if (stringBuffer.length() != 0) {
                stringBuffer.append(", ");
            }
            stringBuffer.append(this.policyInformation[r1]);
        }
