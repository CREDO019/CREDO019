...
public class BasicConstraints extends ASN1Object {
    ...
    public BasicConstraints(int r4) {
        this.f1650cA = ASN1Boolean.getInstance(false);
        this.pathLenConstraint = null;
        this.f1650cA = ASN1Boolean.getInstance(true);
        this.pathLenConstraint = new ASN1Integer(r4);
    }
    ...
    private BasicConstraints(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Boolean) {
            this.f1650cA = ASN1Boolean.getInstance(aSN1Sequence.getObjectAt(0));
        } else {
            this.f1650cA = null;
            this.pathLenConstraint = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(0));
        }
        if (aSN1Sequence.size() > 1) {
            if (this.f1650cA == null) {
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f1650cA;
