    ...
    */
    ...
    public Object[] getValues() {
        ...
        if (getValueType() == 1) {
            ...
            while (r1 != size) {
                aSN1OctetStringArr[r1] = (ASN1OctetString) this.values.elementAt(r1);
                r1++;
            }
            ...
            while (r1 != size2) {
                aSN1ObjectIdentifierArr[r1] = (ASN1ObjectIdentifier) this.values.elementAt(r1);
                r1++;
            }
            ...
            while (r1 != size3) {
                aSN1UTF8StringArr[r1] = (ASN1UTF8String) this.values.elementAt(r1);
                r1++;
            }
