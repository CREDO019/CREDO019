...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    */
    ...
    private int hashCollection(Collection collection) {
        ...
        for (Object obj : collection) {
            r0 += obj instanceof byte[] ? Arrays.hashCode((byte[]) obj) : obj.hashCode();
        }
        return r0;
    }
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(minMaxIPs[0], minMaxIPs[2]), min(minMaxIPs[1], minMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m128or(minMaxIPs[0], minMaxIPs[2]), m128or(bArr4, bArr6)));
    }
    ...
    private boolean isIPConstrained(byte[] bArr, byte[] bArr2) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            bArr4[r2] = (byte) (bArr2[r2] & bArr3[r2]);
            bArr5[r2] = (byte) (bArr[r2] & bArr3[r2]);
        }
    ...
    private static byte[] max(byte[] bArr, byte[] bArr2) {
        for (int r0 = 0; r0 < bArr.length; r0++) {
            if ((bArr[r0] & 65535) > (65535 & bArr2[r0])) {
                return bArr;
            }
        }
        return bArr2;
    ...
    private byte[][] minMaxIPs(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        for (int r6 = 0; r6 < length; r6++) {
            ...
            bArr6[r6] = (byte) ((bArr[r6] & bArr2[r6]) | (~bArr2[r6]));
            bArr7[r6] = (byte) (bArr3[r6] & bArr4[r6]);
            bArr8[r6] = (byte) ((bArr3[r6] & bArr4[r6]) | (~bArr4[r6]));
        }
        return new byte[][]{bArr5, bArr6, bArr7, bArr8};
    }

    /* renamed from: or */
    private static byte[] m128or(byte[] bArr, byte[] bArr2) {
    ...
    private String stringifyIP(byte[] bArr) {
        ...
        for (int r2 = 0; r2 < bArr.length / 2; r2++) {
            if (sb.length() > 0) {
                sb.append(".");
            }
            sb.append(Integer.toString(bArr[r2] & 255));
        }
        sb.append("/");
        boolean z = true;
    ...
    */
    ...
    private static boolean withinDNSubtree(ASN1Sequence aSN1Sequence, ASN1Sequence aSN1Sequence2) {
        if (aSN1Sequence2.size() >= 1 && aSN1Sequence2.size() <= aSN1Sequence.size()) {
            ...
            int r4 = 0;
            while (true) {
                if (r3 >= aSN1Sequence.size()) {
                    r3 = r4;
                    break;
                } else if (IETFUtils.rDNAreEqual(rdn, RDN.getInstance(aSN1Sequence.getObjectAt(r3)))) {
                    break;
                } else {
                    r4 = r3;
                    r3++;
            ...
            if (aSN1Sequence2.size() > aSN1Sequence.size() - r3) {
                return false;
            }
            for (int r0 = 0; r0 < aSN1Sequence2.size(); r0++) {
                RDN rdn2 = RDN.getInstance(aSN1Sequence2.getObjectAt(r0));
                RDN rdn3 = RDN.getInstance(aSN1Sequence.getObjectAt(r3 + r0));
    ...
    private boolean withinDomain(String str, String str2) {
        ...
        for (int r4 = -1; r4 < split.length; r4++) {
            if (r4 == -1) {
                if (split2[r4 + length].equals("")) {
                    return false;
                }
            } else if (!split[r4].equalsIgnoreCase(split2[r4 + length])) {
                return false;
            }
        }
        return true;
    ...
    @Override // org.bouncycastle.asn1.x509.NameConstraintValidator
    public void intersectEmptyPermittedSubtree(int r4) {
        if (r4 == 0) {
            ...
            throw new IllegalStateException("Unknown tag encountered: " + r4);
        }
    }
    ...
    public void intersectPermittedSubtree(GeneralSubtree[] generalSubtreeArr) {
        ...
        for (int r1 = 0; r1 != generalSubtreeArr.length; r1++) {
            GeneralSubtree generalSubtree = generalSubtreeArr[r1];
