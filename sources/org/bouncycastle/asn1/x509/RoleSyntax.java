...
public class RoleSyntax extends ASN1Object {
    ...
    private RoleSyntax(ASN1Sequence aSN1Sequence) {
        ...
        for (int r2 = 0; r2 != aSN1Sequence.size(); r2++) {
            ASN1TaggedObject aSN1TaggedObject = ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(r2));
    ...
    public String[] getRoleAuthorityAsString() {
        ...
        for (int r1 = 0; r1 < names.length; r1++) {
            ASN1Encodable name = names[r1].getName();
            if (name instanceof ASN1String) {
                strArr[r1] = ((ASN1String) name).getString();
            } else {
                strArr[r1] = name.toString();
            }
        }
        return strArr;
    }
    ...
    public String toString() {
        ...
        if (generalNames == null || generalNames.getNames().length == 0) {
            ...
            for (int r2 = 1; r2 < roleAuthorityAsString.length; r2++) {
                stringBuffer.append(", ");
                stringBuffer.append(roleAuthorityAsString[r2]);
            }
            stringBuffer.append(']');
        }
