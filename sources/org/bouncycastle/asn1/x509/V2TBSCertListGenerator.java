...
public class V2TBSCertListGenerator {
    ...
    private static ASN1Sequence createReasonExtension(int r3) {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(2);
        CRLReason lookup = CRLReason.lookup(r3);
        try {
    ...
    public void addCRLEntry(ASN1Integer aSN1Integer, ASN1UTCTime aSN1UTCTime, int r4) {
        addCRLEntry(aSN1Integer, new Time(aSN1UTCTime), r4);
    }

    public void addCRLEntry(ASN1Integer aSN1Integer, Time time, int r4) {
        addCRLEntry(aSN1Integer, time, r4, null);
    }
    ...
    public void addCRLEntry(ASN1Integer aSN1Integer, Time time, int r6, ASN1GeneralizedTime aSN1GeneralizedTime) {
        ...
        if (r6 != 0) {
            ...
            if (r6 >= aSN1SequenceArr.length) {
                createReasonExtension = createReasonExtension(r6);
            } else if (r6 < 0) {
                throw new IllegalArgumentException("invalid reason value: " + r6);
            } else {
                createReasonExtension = aSN1SequenceArr[r6];
            }
