...
public class DisplayText extends ASN1Object implements ASN1Choice {
    ...
    public DisplayText(int r3, String str) {
        str = str.length() > 200 ? str.substring(0, 200) : str;
        this.contentType = r3;
        this.contents = r3 != 0 ? r3 != 1 ? r3 != 2 ? r3 != 3 ? new DERUTF8String(str) : new DERVisibleString(str) : new DERUTF8String(str) : new DERBMPString(str) : new DERIA5String(str);
    }
