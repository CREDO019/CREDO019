...
public class ExtendedKeyUsage extends ASN1Object {
    ...
    public ExtendedKeyUsage(KeyPurposeId[] keyPurposeIdArr) {
        ...
        for (int r1 = 0; r1 != keyPurposeIdArr.length; r1++) {
            aSN1EncodableVector.add(keyPurposeIdArr[r1]);
            this.usageTable.put(keyPurposeIdArr[r1], keyPurposeIdArr[r1]);
        }
        this.seq = new DERSequence(aSN1EncodableVector);
    }
    ...
    public KeyPurposeId[] getUsages() {
        ...
        int r2 = 0;
        while (objects.hasMoreElements()) {
            keyPurposeIdArr[r2] = KeyPurposeId.getInstance(objects.nextElement());
            r2++;
        }
