...
public class CRLReason extends ASN1Object {
    ...
    private CRLReason(int r2) {
        if (r2 < 0) {
            throw new IllegalArgumentException("Invalid CRL reason : not in (0..MAX)");
        }
        this.value = new ASN1Enumerated(r2);
    }
    ...
    public static CRLReason lookup(int r3) {
        Integer valueOf = Integers.valueOf(r3);
        Hashtable hashtable = table;
        if (!hashtable.containsKey(valueOf)) {
            hashtable.put(valueOf, new CRLReason(r3));
        }
    ...
    public String toString() {
        ...
        String str = (intValue < 0 || intValue > 10) ? Constants.COLLATION_INVALID : reasonString[intValue];
