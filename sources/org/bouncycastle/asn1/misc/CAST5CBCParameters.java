...
public class CAST5CBCParameters extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f1612iv;
    ASN1Integer keyLength;

    private CAST5CBCParameters(ASN1Sequence aSN1Sequence) {
        this.f1612iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
        this.keyLength = (ASN1Integer) aSN1Sequence.getObjectAt(1);
    }

    public CAST5CBCParameters(byte[] bArr, int r4) {
        this.f1612iv = new DEROctetString(Arrays.clone(bArr));
        this.keyLength = new ASN1Integer(r4);
    }
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f1612iv.getOctets());
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f1612iv);
