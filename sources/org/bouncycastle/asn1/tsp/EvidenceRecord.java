...
public class EvidenceRecord extends ASN1Object {
    ...
    private EvidenceRecord(ASN1Sequence aSN1Sequence) {
        ...
        for (int r1 = 2; r1 != aSN1Sequence.size() - 1; r1++) {
            ASN1Encodable objectAt = aSN1Sequence.getObjectAt(r1);
    ...
    public AlgorithmIdentifier[] getDigestAlgorithms() {
        ...
        for (int r2 = 0; r2 != size; r2++) {
            algorithmIdentifierArr[r2] = AlgorithmIdentifier.getInstance(this.digestAlgorithms.getObjectAt(r2));
        }
