...
public class Accuracy extends ASN1Object {
    ...
    private Accuracy(ASN1Sequence aSN1Sequence) {
        ...
        for (int r1 = 0; r1 < aSN1Sequence.size(); r1++) {
            if (aSN1Sequence.getObjectAt(r1) instanceof ASN1Integer) {
                this.seconds = (ASN1Integer) aSN1Sequence.getObjectAt(r1);
            } else if (aSN1Sequence.getObjectAt(r1) instanceof ASN1TaggedObject) {
