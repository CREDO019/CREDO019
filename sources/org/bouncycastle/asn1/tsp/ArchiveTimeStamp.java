...
public class ArchiveTimeStamp extends ASN1Object {
    ...
    private ArchiveTimeStamp(ASN1Sequence aSN1Sequence) {
        ...
        for (int r5 = 0; r5 < aSN1Sequence.size() - 1; r5++) {
            ASN1Encodable objectAt = aSN1Sequence.getObjectAt(r5);
    ...
    public PartialHashtree[] getReducedHashTree() {
        ...
        for (int r2 = 0; r2 != size; r2++) {
            partialHashtreeArr[r2] = PartialHashtree.getInstance(this.reducedHashTree.getObjectAt(r2));
        }
