...
public class ResponseData extends ASN1Object {
    ...
    /* renamed from: V1 */
    private static final ASN1Integer f1614V1 = new ASN1Integer(0);
    ...
    private ResponseData(ASN1Sequence aSN1Sequence) {
        ...
        if ((aSN1Sequence.getObjectAt(0) instanceof ASN1TaggedObject) && ((ASN1TaggedObject) aSN1Sequence.getObjectAt(0)).getTagNo() == 0) {
            ...
            this.version = f1614V1;
        }
        int r1 = r0 + 1;
        this.responderID = ResponderID.getInstance(aSN1Sequence.getObjectAt(r0));
        int r02 = r1 + 1;
        this.producedAt = ASN1GeneralizedTime.getInstance(aSN1Sequence.getObjectAt(r1));
        int r12 = r02 + 1;
        this.responses = (ASN1Sequence) aSN1Sequence.getObjectAt(r02);
        if (aSN1Sequence.size() > r12) {
            this.responseExtensions = Extensions.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r12), true);
        }
    }
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, Extensions extensions) {
        this(f1614V1, responderID, aSN1GeneralizedTime, aSN1Sequence, extensions);
    }
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, X509Extensions x509Extensions) {
        this(f1614V1, responderID, ASN1GeneralizedTime.getInstance(aSN1GeneralizedTime), aSN1Sequence, Extensions.getInstance(x509Extensions));
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.versionPresent || !this.version.equals((ASN1Primitive) f1614V1)) {
