...
public class TBSRequest extends ASN1Object {
    ...
    /* renamed from: V1 */
    private static final ASN1Integer f1615V1 = new ASN1Integer(0);
    ...
    private TBSRequest(ASN1Sequence aSN1Sequence) {
        ...
        if ((aSN1Sequence.getObjectAt(0) instanceof ASN1TaggedObject) && ((ASN1TaggedObject) aSN1Sequence.getObjectAt(0)).getTagNo() == 0) {
            ...
            this.version = f1615V1;
        }
        if (aSN1Sequence.getObjectAt(r0) instanceof ASN1TaggedObject) {
            this.requestorName = GeneralName.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r0), true);
            r0++;
        }
        int r1 = r0 + 1;
        this.requestList = (ASN1Sequence) aSN1Sequence.getObjectAt(r0);
        if (aSN1Sequence.size() == r1 + 1) {
            this.requestExtensions = Extensions.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r1), true);
        }
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (!this.version.equals((ASN1Primitive) f1615V1) || this.versionSet) {
