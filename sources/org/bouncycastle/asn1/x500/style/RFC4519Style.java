...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    /* renamed from: c */
    public static final ASN1ObjectIdentifier f1642c;

    /* renamed from: cn */
    public static final ASN1ObjectIdentifier f1643cn;

    /* renamed from: dc */
    public static final ASN1ObjectIdentifier f1644dc;
    ...
    /* renamed from: l */
    public static final ASN1ObjectIdentifier f1645l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* renamed from: o */
    public static final ASN1ObjectIdentifier f1646o;

    /* renamed from: ou */
    public static final ASN1ObjectIdentifier f1647ou;
    ...
    /* renamed from: sn */
    public static final ASN1ObjectIdentifier f1648sn;

    /* renamed from: st */
    public static final ASN1ObjectIdentifier f1649st;
    ...
    static {
        ...
        hashtable.put(intern19, NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST);
        ...
        hashtable2.put(NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST, intern19);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        return aSN1ObjectIdentifier.equals((ASN1Primitive) f1644dc) ? new DERIA5String(str) : (aSN1ObjectIdentifier.equals((ASN1Primitive) f1642c) || aSN1ObjectIdentifier.equals((ASN1Primitive) serialNumber) || aSN1ObjectIdentifier.equals((ASN1Primitive) dnQualifier) || aSN1ObjectIdentifier.equals((ASN1Primitive) telephoneNumber)) ? new DERPrintableString(str) : super.encodeStringValue(aSN1ObjectIdentifier, str);
    }
    ...
    public RDN[] fromString(String str) {
        ...
        for (int r2 = 0; r2 != rDNsFromString.length; r2++) {
            rdnArr[(length - r2) - 1] = rDNsFromString[r2];
        }
        return rdnArr;
    }
