...
public class CertEtcToken extends ASN1Object implements ASN1Choice {
    ...
    public CertEtcToken(int r1, ASN1Encodable aSN1Encodable) {
        this.tagNo = r1;
    ...
    public static CertEtcToken[] arrayFromSequence(ASN1Sequence aSN1Sequence) {
        ...
        for (int r2 = 0; r2 != size; r2++) {
            certEtcTokenArr[r2] = getInstance(aSN1Sequence.getObjectAt(r2));
        }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (extension == null) {
            ...
            int r2 = this.tagNo;
            return new DERTaggedObject(zArr[r2], r2, this.value);
        }
