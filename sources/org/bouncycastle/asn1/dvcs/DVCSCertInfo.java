...
public class DVCSCertInfo extends ASN1Object {
    ...
    private DVCSCertInfo(ASN1Sequence aSN1Sequence) {
        ...
        int r2 = r4 + 1;
        this.messageImprint = DigestInfo.getInstance(aSN1Sequence.getObjectAt(r4));
        int r42 = r2 + 1;
        this.serialNumber = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(r2));
        int r22 = r42 + 1;
        this.responseTime = DVCSTime.getInstance(aSN1Sequence.getObjectAt(r42));
        while (r22 < aSN1Sequence.size()) {
            int r43 = r22 + 1;
            ASN1Encodable objectAt2 = aSN1Sequence.getObjectAt(r22);
