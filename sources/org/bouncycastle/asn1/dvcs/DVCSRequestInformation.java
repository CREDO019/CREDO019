...
public class DVCSRequestInformation extends ASN1Object {
    ...
    private DVCSRequestInformation(ASN1Sequence aSN1Sequence) {
        ...
        this.service = ServiceType.getInstance(aSN1Sequence.getObjectAt(r2));
        for (int r3 = r2 + 1; r3 < aSN1Sequence.size(); r3++) {
            ASN1Encodable objectAt = aSN1Sequence.getObjectAt(r3);
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int r2 = 0; r2 < 5; r2++) {
            int r5 = r3[r2];
            ASN1Encodable aSN1Encodable = aSN1EncodableArr[r2];
            if (aSN1Encodable != null) {
                aSN1EncodableVector.add(new DERTaggedObject(false, r5, aSN1Encodable));
            }
        }
