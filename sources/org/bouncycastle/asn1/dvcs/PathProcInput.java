...
public class PathProcInput extends ASN1Object {
    ...
    private static PolicyInformation[] fromSequence(ASN1Sequence aSN1Sequence) {
        ...
        for (int r2 = 0; r2 != size; r2++) {
            policyInformationArr[r2] = PolicyInformation.getInstance(aSN1Sequence.getObjectAt(r2));
        }
    ...
    public static PathProcInput getInstance(Object obj) {
        ...
        if (obj != null) {
            ...
            for (int r3 = 1; r3 < aSN1Sequence.size(); r3++) {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        while (true) {
            ...
            if (r3 == policyInformationArr.length) {
                break;
            }
            aSN1EncodableVector2.add(policyInformationArr[r3]);
            r3++;
        }
