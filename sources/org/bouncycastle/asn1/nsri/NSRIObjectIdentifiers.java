...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_pad_null = branch.branch(SessionDescription.SUPPORTED_SDP_VERSION);
        id_pad_1 = branch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        id_aria128_ecb = branch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
