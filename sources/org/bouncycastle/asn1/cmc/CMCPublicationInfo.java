...
public class CMCPublicationInfo extends ASN1Object {
    ...
    public CMCPublicationInfo(AlgorithmIdentifier algorithmIdentifier, byte[][] bArr, PKIPublicationInfo pKIPublicationInfo) {
        ...
        for (int r0 = 0; r0 != bArr.length; r0++) {
            aSN1EncodableVector.add(new DEROctetString(Arrays.clone(bArr[r0])));
        }
    ...
    public byte[][] getCertHashes() {
        ...
        for (int r2 = 0; r2 != size; r2++) {
            bArr[r2] = Arrays.clone(ASN1OctetString.getInstance(this.certHashes.getObjectAt(r2)).getOctets());
        }
        return bArr;
    }
