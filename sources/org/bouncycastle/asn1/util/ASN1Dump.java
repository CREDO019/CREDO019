...
public class ASN1Dump {
    ...
    public static void _dumpAsString(String str, boolean z, ASN1Primitive aSN1Primitive, StringBuffer stringBuffer) {
        ...
        if (!(aSN1Primitive instanceof ASN1Null)) {
            ...
            if (aSN1Primitive instanceof ASN1Sequence) {
                ...
                while (r2 < size) {
                    _dumpAsString(str3, z, aSN1Sequence.getObjectAt(r2).toASN1Primitive(), stringBuffer);
                    r2++;
                }
                return;
                ...
                while (r2 < size2) {
                    _dumpAsString(str4, z, aSN1Set.getObjectAt(r2).toASN1Primitive(), stringBuffer);
                    r2++;
                }
                return;
            } else {
    ...
    private static String calculateAscString(byte[] bArr, int r5, int r6) {
        StringBuffer stringBuffer = new StringBuffer();
        for (int r1 = r5; r1 != r5 + r6; r1++) {
            if (bArr[r1] >= 32 && bArr[r1] <= 126) {
                stringBuffer.append((char) bArr[r1]);
            }
        }
    ...
    private static String dumpBinaryDataAsString(String str, byte[] bArr) {
        ...
        String str2 = str + TAB;
        stringBuffer.append(lineSeparator);
        for (int r3 = 0; r3 < bArr.length; r3 += 32) {
            int length = bArr.length - r3;
            stringBuffer.append(str2);
            if (length > 32) {
                stringBuffer.append(Strings.fromByteArray(Hex.encode(bArr, r3, 32)));
                stringBuffer.append(TAB);
                calculateAscString = calculateAscString(bArr, r3, 32);
            } else {
                stringBuffer.append(Strings.fromByteArray(Hex.encode(bArr, r3, bArr.length - r3)));
                for (int length2 = bArr.length - r3; length2 != 32; length2++) {
                    stringBuffer.append("  ");
                }
                stringBuffer.append(TAB);
                calculateAscString = calculateAscString(bArr, r3, bArr.length - r3);
            }
