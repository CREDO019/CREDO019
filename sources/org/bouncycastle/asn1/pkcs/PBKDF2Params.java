...
public class PBKDF2Params extends ASN1Object {
    ...
    public PBKDF2Params(byte[] bArr, int r3) {
        this(bArr, r3, 0);
    }

    public PBKDF2Params(byte[] bArr, int r3, int r4) {
        this(bArr, r3, r4, null);
    }

    public PBKDF2Params(byte[] bArr, int r4, int r5, AlgorithmIdentifier algorithmIdentifier) {
        this.octStr = new DEROctetString(Arrays.clone(bArr));
        this.iterationCount = new ASN1Integer(r4);
        this.keyLength = r5 > 0 ? new ASN1Integer(r5) : null;
        this.prf = algorithmIdentifier;
    }

    public PBKDF2Params(byte[] bArr, int r3, AlgorithmIdentifier algorithmIdentifier) {
        this(bArr, r3, 0, algorithmIdentifier);
    }
