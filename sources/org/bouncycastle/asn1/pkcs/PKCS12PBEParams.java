...
public class PKCS12PBEParams extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f1621iv;

    private PKCS12PBEParams(ASN1Sequence aSN1Sequence) {
        this.f1621iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
        this.iterations = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(1));
    }

    public PKCS12PBEParams(byte[] bArr, int r4) {
        this.f1621iv = new DEROctetString(bArr);
        this.iterations = new ASN1Integer(r4);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f1621iv);
