...
public class RC2CBCParameter extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f1622iv;
    ASN1Integer version;

    public RC2CBCParameter(int r4, byte[] bArr) {
        this.version = new ASN1Integer(r4);
        this.f1622iv = new DEROctetString(bArr);
    }
    ...
    private RC2CBCParameter(ASN1Sequence aSN1Sequence) {
        ...
        this.f1622iv = (ASN1OctetString) objectAt;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f1622iv);
