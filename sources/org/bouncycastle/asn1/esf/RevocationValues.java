...
public class RevocationValues extends ASN1Object {
    ...
    public CertificateList[] getCrlVals() {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            certificateListArr[r1] = CertificateList.getInstance(this.crlVals.getObjectAt(r1));
        }
    ...
    public BasicOCSPResponse[] getOcspVals() {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            basicOCSPResponseArr[r1] = BasicOCSPResponse.getInstance(this.ocspVals.getObjectAt(r1));
        }
