...
public class ECPrivateKey extends ASN1Object {
    ...
    public ECPrivateKey(int r4, BigInteger bigInteger) {
        byte[] asUnsignedByteArray = BigIntegers.asUnsignedByteArray((r4 + 7) / 8, bigInteger);
    ...
    public ECPrivateKey(int r4, BigInteger bigInteger, ASN1BitString aSN1BitString, ASN1Encodable aSN1Encodable) {
        byte[] asUnsignedByteArray = BigIntegers.asUnsignedByteArray((r4 + 7) / 8, bigInteger);
    ...
    public ECPrivateKey(int r2, BigInteger bigInteger, ASN1Encodable aSN1Encodable) {
        this(r2, bigInteger, null, aSN1Encodable);
    }
    ...
    private ASN1Object getObjectInTag(int r4, int r5) {
        Enumeration objects = this.seq.getObjects();
        while (objects.hasMoreElements()) {
            ASN1Encodable aSN1Encodable = (ASN1Encodable) objects.nextElement();
            if (aSN1Encodable instanceof ASN1TaggedObject) {
                ASN1TaggedObject aSN1TaggedObject = (ASN1TaggedObject) aSN1Encodable;
                if (aSN1TaggedObject.hasContextTag(r4)) {
                    return r5 < 0 ? aSN1TaggedObject.getExplicitBaseObject().toASN1Primitive() : aSN1TaggedObject.getBaseUniversal(true, r5);
                }
            }
        }
        return null;
