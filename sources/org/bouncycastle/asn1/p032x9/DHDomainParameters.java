...
public class DHDomainParameters extends ASN1Object {
    ...
    /* renamed from: g */
    private ASN1Integer f1667g;

    /* renamed from: j */
    private ASN1Integer f1668j;

    /* renamed from: p */
    private ASN1Integer f1669p;

    /* renamed from: q */
    private ASN1Integer f1670q;
    ...
    public DHDomainParameters(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, DHValidationParms dHValidationParms) {
        ...
        this.f1669p = new ASN1Integer(bigInteger);
        this.f1667g = new ASN1Integer(bigInteger2);
        this.f1670q = new ASN1Integer(bigInteger3);
        this.f1668j = new ASN1Integer(bigInteger4);
    ...
    public DHDomainParameters(ASN1Integer aSN1Integer, ASN1Integer aSN1Integer2, ASN1Integer aSN1Integer3, ASN1Integer aSN1Integer4, DHValidationParms dHValidationParms) {
        ...
        this.f1669p = aSN1Integer;
        this.f1667g = aSN1Integer2;
        this.f1670q = aSN1Integer3;
        this.f1668j = aSN1Integer4;
        this.validationParms = dHValidationParms;
    }
    ...
    private DHDomainParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f1669p = ASN1Integer.getInstance(objects.nextElement());
        this.f1667g = ASN1Integer.getInstance(objects.nextElement());
        this.f1670q = ASN1Integer.getInstance(objects.nextElement());
        ASN1Encodable next = getNext(objects);
        if (next != null && (next instanceof ASN1Integer)) {
            this.f1668j = ASN1Integer.getInstance(next);
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f1669p);
        aSN1EncodableVector.add(this.f1667g);
        aSN1EncodableVector.add(this.f1670q);
        ASN1Integer aSN1Integer = this.f1668j;
        if (aSN1Integer != null) {
