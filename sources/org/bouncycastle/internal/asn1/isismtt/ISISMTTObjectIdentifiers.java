...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_cp_accredited = branch.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch(ExifInterface.GPS_MEASUREMENT_3D);
        id_isismtt_at = branch2;
        id_isismtt_at_dateOfCertGen = branch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
