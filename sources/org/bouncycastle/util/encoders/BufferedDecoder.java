...
public class BufferedDecoder {
    ...
    public BufferedDecoder(Translator translator, int r2) {
    ...
    public int processByte(byte b, byte[] bArr, int r10) {
        ...
        bArr2[r0] = b;
        if (r2 == bArr2.length) {
            int decode = this.translator.decode(bArr2, 0, bArr2.length, bArr, r10);
            this.bufOff = 0;
            return decode;
        }
        return 0;
    ...
    public int processBytes(byte[] bArr, int r12, int r13, byte[] bArr2, int r15) {
        if (r13 >= 0) {
            ...
            if (r13 > r1) {
                ...
                byte[] bArr4 = this.buf;
                int decode = translator.decode(bArr4, 0, bArr4.length, bArr2, r15) + 0;
                this.bufOff = 0;
                int r132 = r13 - r1;
                int r122 = r12 + r1;
                int r7 = r15 + decode;
                int length2 = r132 - (r132 % this.buf.length);
                r3 = decode + this.translator.decode(bArr, r122, length2, bArr2, r7);
                r13 = r132 - length2;
                r12 = r122 + length2;
            }
            if (r13 != 0) {
