...
public class Ieee1609Dot2BaseTypes {
    ...
    static {
        ...
        UINT8 = integer;
        OERDefinition.Builder integer2 = OERDefinition.integer(0L, (long) WebSocketProtocol.PAYLOAD_SHORT_MAX);
        UINT16 = integer2;
        OERDefinition.Builder integer3 = OERDefinition.integer(0L, (long) BodyPartID.bodyIdMax);
        UINT32 = integer3;
        ...
        OERDefinition.Builder label18 = OERDefinition.choice(label16.label("opaque"), OERDefinition.nullValue().label(TtmlNode.COMBINE_ALL), OERDefinition.extension(), label17.label("bitmapSspRange")).label("SspRange");
        SspRange = label18;
