...
public class SequenceOfRectangularRegion extends ASN1Object {
    ...
    public static SequenceOfRectangularRegion getInstance(Object obj) {
        return obj instanceof SequenceOfRectangularRegion ? (SequenceOfRectangularRegion) obj : new SequenceOfRectangularRegion(C5386Utils.fillList(RectangularRegion.class, ASN1Sequence.getInstance(obj)));
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        return C5386Utils.toSequence(this.rectangularRegions);
    }
}
