...
public class SequenceOfIdentifiedRegion extends ASN1Object {
    ...
    public static SequenceOfIdentifiedRegion getInstance(Object obj) {
        return obj instanceof SequenceOfIdentifiedRegion ? (SequenceOfIdentifiedRegion) obj : new SequenceOfIdentifiedRegion(C5386Utils.fillList(IdentifiedRegion.class, ASN1Sequence.getInstance(obj)));
    }
