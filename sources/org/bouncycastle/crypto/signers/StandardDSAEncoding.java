...
public class StandardDSAEncoding implements DSAEncoding {
    ...
    protected BigInteger decodeValue(BigInteger bigInteger, ASN1Sequence aSN1Sequence, int r3) {
        return checkValue(bigInteger, ((ASN1Integer) aSN1Sequence.getObjectAt(r3)).getValue());
    }
