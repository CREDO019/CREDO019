...
public class X931Signer implements Signer {
    ...
    private void createSignatureBlock(int r5) {
        int r1;
        byte[] bArr;
        int digestSize = this.digest.getDigestSize();
        if (r5 == 188) {
            byte[] bArr2 = this.block;
            r1 = (bArr2.length - digestSize) - 1;
            this.digest.doFinal(bArr2, r1);
            ...
            bArr4[bArr4.length - 2] = (byte) (r5 >>> 8);
            bArr4[bArr4.length - 1] = (byte) r5;
            r1 = length;
        }
        this.block[0] = 107;
        for (int r52 = r1 - 2; r52 != 0; r52--) {
            this.block[r52] = -69;
        }
        this.block[r1 - 1] = -70;
    }
