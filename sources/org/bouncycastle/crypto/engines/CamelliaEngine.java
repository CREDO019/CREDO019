...
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private int[] f1908kw = new int[8];

    /* renamed from: ke */
    private int[] f1907ke = new int[12];
    ...
    private void camelliaF2(int[] r13, int[] r14, int r15) {
        int r1 = r13[0] ^ r14[r15 + 0];
        int[] r2 = SBOX4_4404;
        int r3 = r2[r1 & 255];
        int[] r4 = SBOX3_3033;
        int r32 = r3 ^ r4[(r1 >>> 8) & 255];
        int[] r5 = SBOX2_0222;
        int r33 = r32 ^ r5[(r1 >>> 16) & 255];
        int[] r6 = SBOX1_1110;
        int r12 = r6[(r1 >>> 24) & 255] ^ r33;
        int r7 = r13[1] ^ r14[r15 + 1];
        int r72 = (r5[(r7 >>> 24) & 255] ^ ((r6[r7 & 255] ^ r2[(r7 >>> 8) & 255]) ^ r4[(r7 >>> 16) & 255])) ^ r12;
        r13[2] = r13[2] ^ r72;
        r13[3] = (rightRotate(r12, 8) ^ r72) ^ r13[3];
        int r16 = r13[2] ^ r14[r15 + 2];
        int r17 = r6[(r16 >>> 24) & 255] ^ ((r2[r16 & 255] ^ r4[(r16 >>> 8) & 255]) ^ r5[(r16 >>> 16) & 255]);
        int r142 = r14[r15 + 3] ^ r13[3];
        int r143 = (r5[(r142 >>> 24) & 255] ^ ((r6[r142 & 255] ^ r2[(r142 >>> 8) & 255]) ^ r4[(r142 >>> 16) & 255])) ^ r17;
        r13[0] = r13[0] ^ r143;
        r13[1] = (r143 ^ rightRotate(r17, 8)) ^ r13[1];
    }
    ...
    private int processBlock192or256(byte[] bArr, int r10, byte[] bArr2, int r12) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f1907ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyIs128) {
            ...
            r23[16] = r7[0];
            r23[17] = r7[1];
            decroldq(17, r3, 0, this.f1907ke, 0);
            ...
            decroldq(15, r5, 0, this.f1907ke, 4);
        ...
        if (z) {
            ...
            roldqo32(51, r6, 0, this.f1908kw, 4);
            return;
        }
        r26[4] = r3[0];
        r26[5] = r3[1];
        ...
        roldqo32(51, r6, 0, this.f1908kw, 0);
    }
