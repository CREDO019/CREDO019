...
public class CBCBlockCipherMac implements Mac {
    ...
    public CBCBlockCipherMac(BlockCipher blockCipher, int r3) {
        this(blockCipher, r3, null);
    }

    public CBCBlockCipherMac(BlockCipher blockCipher, int r3, BlockCipherPadding blockCipherPadding) {
        if (r3 % 8 != 0) {
