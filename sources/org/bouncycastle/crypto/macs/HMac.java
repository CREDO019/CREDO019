...
public class HMac implements Mac {
    ...
    private HMac(Digest digest, int r3) {
        this.digest = digest;
        int digestSize = digest.getDigestSize();
        this.digestSize = digestSize;
        this.blockLength = r3;
        this.inputPad = new byte[r3];
        this.outputBuf = new byte[r3 + digestSize];
    }
    ...
    private static void xorPad(byte[] bArr, int r3, byte b) {
        for (int r0 = 0; r0 < r3; r0++) {
            bArr[r0] = (byte) (bArr[r0] ^ b);
        }
    }

    @Override // org.bouncycastle.crypto.Mac
    public int doFinal(byte[] bArr, int r7) {
        ...
        int doFinal = this.digest.doFinal(bArr, r7);
        int r72 = this.blockLength;
        while (true) {
