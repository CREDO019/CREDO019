...
public final class CryptoServicesRegistrar {
    ...
    private static int chooseLowerBound(int r1) {
        if (r1 > 1024) {
            if (r1 <= 2048) {
                return 224;
            }
    ...
    public static <T> T getSizedProperty(Property property, int r5) {
        Object[] lookupProperty = lookupProperty(property);
        if (lookupProperty == null) {
            return null;
        }
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            while (r3 != lookupProperty.length) {
                ?? r4 = (T) ((DHParameters) lookupProperty[r3]);
                if (r4.getP().bitLength() == r5) {
                    return r4;
                }
                r3++;
            }
            ...
            while (r3 != lookupProperty.length) {
                ?? r42 = (T) ((DSAParameters) lookupProperty[r3]);
                if (r42.getP().bitLength() == r5) {
                    return r42;
                }
                r3++;
            }
