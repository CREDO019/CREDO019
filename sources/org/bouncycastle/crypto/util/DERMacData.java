...
public final class DERMacData {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int r0 = C52501.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            if (r0 == 1 || r0 == 2) {
    ...
    /* synthetic */ DERMacData(byte[] bArr, C52501 c52501) {
        this(bArr);
    }
