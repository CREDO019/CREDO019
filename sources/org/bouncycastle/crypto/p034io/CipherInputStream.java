...
public class CipherInputStream extends FilterInputStream {
    ...
    public CipherInputStream(InputStream inputStream, BufferedBlockCipher bufferedBlockCipher, int r3) {
        super(inputStream);
        this.bufferedBlockCipher = bufferedBlockCipher;
        this.inBuf = new byte[r3];
    ...
    public CipherInputStream(InputStream inputStream, StreamCipher streamCipher, int r3) {
        super(inputStream);
    ...
    public CipherInputStream(InputStream inputStream, AEADBlockCipher aEADBlockCipher, int r3) {
        super(inputStream);
