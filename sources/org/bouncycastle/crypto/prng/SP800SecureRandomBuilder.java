...
public class SP800SecureRandomBuilder {
    ...
    private static class CTRDRBGProvider implements DRBGProvider {
        ...
        public CTRDRBGProvider(BlockCipher blockCipher, int r2, byte[] bArr, byte[] bArr2, int r5) {
            this.blockCipher = blockCipher;
            this.keySizeInBits = r2;
            this.nonce = bArr;
            this.personalizationString = bArr2;
            this.securityStrength = r5;
        }
    ...
    private static class HMacDRBGProvider implements DRBGProvider {
        ...
        public HMacDRBGProvider(Mac mac, byte[] bArr, byte[] bArr2, int r4) {
            this.hMac = mac;
            this.nonce = bArr;
            this.personalizationString = bArr2;
            this.securityStrength = r4;
        }
    ...
    private static class HashDRBGProvider implements DRBGProvider {
        ...
        public HashDRBGProvider(Digest digest, byte[] bArr, byte[] bArr2, int r4) {
            this.digest = digest;
            this.nonce = bArr;
            this.personalizationString = bArr2;
            this.securityStrength = r4;
    ...
    public SP800SecureRandom buildCTR(BlockCipher blockCipher, int r12, byte[] bArr, boolean z) {
        return new SP800SecureRandom(this.random, this.entropySourceProvider.get(this.entropyBitsRequired), new CTRDRBGProvider(blockCipher, r12, bArr, this.personalizationString, this.securityStrength), z);
    }
    ...
    public SP800SecureRandomBuilder setEntropyBitsRequired(int r1) {
        this.entropyBitsRequired = r1;
        return this;
    }
    ...
    public SP800SecureRandomBuilder setSecurityStrength(int r1) {
        this.securityStrength = r1;
        return this;
    }
}
