...
public class KGCMUtil_256 {
    ...
    public static void square(long[] jArr, long[] jArr2) {
        ...
        for (int r2 = 0; r2 < 4; r2++) {
            Interleave.expand64To128(jArr[r2], jArr3, r2 << 1);
        }
        while (true) {
            r0--;
            if (r0 < 4) {
            ...
            long j = jArr3[r0];
            int r12 = r0 - 4;
            jArr3[r12] = jArr3[r12] ^ ((((j << 2) ^ j) ^ (j << 5)) ^ (j << 10));
            int r122 = r12 + 1;
            jArr3[r122] = ((j >>> 54) ^ ((j >>> 62) ^ (j >>> 59))) ^ jArr3[r122];
        }
    }

    /* renamed from: x */
    public static void m28x(long[] jArr) {
        jArr[0] = 2;
        jArr[1] = 0;
        jArr[2] = 0;
        jArr[3] = 0;
