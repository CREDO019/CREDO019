...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        if (digest instanceof ExtendedDigest) {
            this.f2002u = digest.getDigestSize();
            this.f2003v = ((ExtendedDigest) digest).getByteLength();
            return;
        }
    ...
    private byte[] generateDerivedKey(int r17, int r18) {
        ...
        while (r14 <= r12) {
            ...
            for (int r15 = 1; r15 < this.iterationCount; r15++) {
                this.digest.update(bArr7, r5, r11);
                this.digest.doFinal(bArr7, r5);
            }
            for (int r7 = 0; r7 != r8; r7++) {
                bArr6[r7] = bArr7[r7 % r11];
            }
            int r72 = 0;
            while (true) {
                int r152 = this.f2003v;
                if (r72 == length3 / r152) {
                    break;
                }
            ...
            if (r14 == r12) {
                ...
                System.arraycopy(bArr7, 0, bArr4, (r14 - 1) * this.f2002u, r11);
            }
            r14++;
            r5 = 0;
        }
