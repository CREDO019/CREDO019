...
public class SRP6Util {
    ...
    private static byte[] getPadded(BigInteger bigInteger, int r4) {
        byte[] asUnsignedByteArray = BigIntegers.asUnsignedByteArray(bigInteger);
        if (asUnsignedByteArray.length < r4) {
            byte[] bArr = new byte[r4];
            System.arraycopy(asUnsignedByteArray, 0, bArr, r4 - asUnsignedByteArray.length, asUnsignedByteArray.length);
            return bArr;
        }
