...
public class XDHUnifiedAgreement implements RawAgreement {
    ...
    public void calculateAgreement(CipherParameters cipherParameters, byte[] bArr, int r5) {
        ...
        this.xAgreement.calculateAgreement(xDHUPublicParameters.getEphemeralPublicKey(), bArr, r5);
        this.xAgreement.init(this.privParams.getStaticPrivateKey());
        this.xAgreement.calculateAgreement(xDHUPublicParameters.getStaticPublicKey(), bArr, r5 + this.xAgreement.getAgreementSize());
    }
