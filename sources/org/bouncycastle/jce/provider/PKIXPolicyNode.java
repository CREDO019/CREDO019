...
public class PKIXPolicyNode implements PolicyNode {
    ...
    public PKIXPolicyNode(List list, int r2, Set set, PolicyNode policyNode, Set set2, String str, boolean z) {
        this.children = list;
        this.depth = r2;
    ...
    public String toString(String str) {
        ...
        for (int r1 = 0; r1 < this.children.size(); r1++) {
            stringBuffer.append(((PKIXPolicyNode) this.children.get(r1)).toString(str + "    "));
        }
        stringBuffer.append(str);
        stringBuffer.append("}\n");
