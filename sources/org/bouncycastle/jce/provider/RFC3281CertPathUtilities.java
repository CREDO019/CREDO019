    ...
    */
    ...
    public static CertPath processAttrCert1(X509AttributeCertificate x509AttributeCertificate, PKIXExtendedParameters pKIXExtendedParameters) throws CertPathValidatorException {
        ...
        if (x509AttributeCertificate.getHolder().getIssuer() != null) {
            ...
            for (int r7 = 0; r7 < issuer.length; r7++) {
                try {
                    if (issuer[r7] instanceof X500Principal) {
                        x509CertSelector.setIssuer(((X500Principal) issuer[r7]).getEncoded());
                    }
        ...
        if (x509AttributeCertificate.getHolder().getEntityNames() != null) {
            ...
            for (int r5 = 0; r5 < entityNames.length; r5++) {
                try {
                    if (entityNames[r5] instanceof X500Principal) {
                        x509CertStoreSelector.setIssuer(((X500Principal) entityNames[r5]).getEncoded());
                    }
