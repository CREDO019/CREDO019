...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f2222q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }

    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f2222q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f2222q = jCEECPublicKey.f2222q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.algorithm = str;
        this.f2222q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f2222q.getCurve() == null) {
                this.f2222q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f2222q.getAffineXCoord().toBigInteger(), this.f2222q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f2222q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
    ...
    private void extractBytes(byte[] bArr, int r7, BigInteger bigInteger) {
        ...
        for (int r1 = 0; r1 != 32; r1++) {
            bArr[r7 + r1] = byteArray[(byteArray.length - 1) - r1];
        }
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                bArr[0] = 4;
                for (int r5 = 1; r5 <= 32; r5++) {
                    bArr[r5] = octets[32 - r5];
                    bArr[r5 + 32] = octets[64 - r5];
                }
                ...
                this.f2222q = curve2.decodePoint(bArr);
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            this.f2222q = new X9ECPoint(curve, dEROctetString).getPoint();
        } else {
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f2222q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f2222q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f2222q.getDetachedPoint() : this.f2222q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f2222q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f2222q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f2222q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
