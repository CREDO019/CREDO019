...
public class X509LDAPCertStoreParameters implements X509StoreParameters, CertStoreParameters {
    ...
    private int addHashCode(int r1, Object obj) {
        return (r1 * 29) + (obj == null ? 0 : obj.hashCode());
    }
    ...
    public static X509LDAPCertStoreParameters getInstance(LDAPCertStoreParameters lDAPCertStoreParameters) {
        return new Builder("ldap://" + lDAPCertStoreParameters.getServerName() + ParameterizedMessage.ERROR_MSG_SEPARATOR + lDAPCertStoreParameters.getPort(), "").build();
    }
