...
public class BCGMSSPublicKey implements CipherParameters, PublicKey {
    ...
    public String toString() {
        ...
        for (int r1 = 0; r1 < this.gmssParameterSet.getHeightOfTrees().length; r1++) {
            str = str + "Layer " + r1 + " : " + this.gmssParameterSet.getHeightOfTrees()[r1] + " WinternitzParameter: " + this.gmssParameterSet.getWinternitzParameter()[r1] + " K: " + this.gmssParameterSet.getK()[r1] + "\n";
        }
        return str;
    }
}
