...
public class BCLMSPrivateKey implements PrivateKey, LMSPrivateKey {
    ...
    public LMSPrivateKey extractKeyShard(int r3) {
        LMSKeyParameters lMSKeyParameters = this.keyParams;
        return lMSKeyParameters instanceof LMSPrivateKeyParameters ? new BCLMSPrivateKey(((LMSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(r3)) : new BCLMSPrivateKey(((HSSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(r3));
    }
