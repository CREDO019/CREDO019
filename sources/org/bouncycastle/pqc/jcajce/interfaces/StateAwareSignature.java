...
public interface StateAwareSignature {
    ...
    int sign(byte[] bArr, int r2, int r3) throws SignatureException;
    ...
    void update(byte[] bArr, int r2, int r3) throws SignatureException;

    boolean verify(byte[] bArr) throws SignatureException;

    boolean verify(byte[] bArr, int r2, int r3) throws SignatureException;
}
