...
public class XMSSPrivateKey extends ASN1Object {
    ...
    public XMSSPrivateKey(int r2, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5) {
        this.version = 0;
        this.index = r2;
    ...
    public XMSSPrivateKey(int r2, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, int r8) {
        this.version = 1;
        this.index = r2;
        this.secretKeySeed = Arrays.clone(bArr);
        this.secretKeyPRF = Arrays.clone(bArr2);
    ...
    private XMSSPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence2.size() == 6) {
            ...
            r0 = ASN1Integer.getInstance(aSN1TaggedObject, false).intValueExact();
