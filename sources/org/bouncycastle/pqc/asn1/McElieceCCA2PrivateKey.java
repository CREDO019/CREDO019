...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    public McElieceCCA2PrivateKey(int r1, int r2, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, Permutation permutation, AlgorithmIdentifier algorithmIdentifier) {
        this.f2388n = r1;
        this.f2387k = r2;
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f2388n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f2387k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f2388n));
        aSN1EncodableVector.add(new ASN1Integer(this.f2387k));
