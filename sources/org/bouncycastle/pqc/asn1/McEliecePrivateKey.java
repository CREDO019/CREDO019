...
public class McEliecePrivateKey extends ASN1Object {
    ...
    public McEliecePrivateKey(int r1, int r2, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, Permutation permutation, Permutation permutation2, GF2Matrix gF2Matrix) {
        this.f2393n = r1;
        this.f2392k = r2;
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f2393n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f2392k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f2393n));
        aSN1EncodableVector.add(new ASN1Integer(this.f2392k));
