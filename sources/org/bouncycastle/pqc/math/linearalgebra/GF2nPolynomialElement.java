...
public class GF2nPolynomialElement extends GF2nElement {
    ...
    public GF2nPolynomialElement(GF2nPolynomialField gF2nPolynomialField, int[] r4) {
        this.mField = gF2nPolynomialField;
        this.mDegree = this.mField.getDegree();
        GF2Polynomial gF2Polynomial = new GF2Polynomial(this.mDegree, r4);
        this.polynomial = gF2Polynomial;
    ...
    private GF2nPolynomialElement halfTrace() throws RuntimeException {
        if ((this.mDegree & 1) != 0) {
            ...
            for (int r2 = 1; r2 <= ((this.mDegree - 1) >> 1); r2++) {
    ...
    private void reducePentanomialBitwise(int[] r6) {
        int r0 = this.mDegree - r6[2];
        int r1 = this.mDegree - r6[1];
        int r3 = this.mDegree - r6[0];
        for (int length = this.polynomial.getLength() - 1; length >= this.mDegree; length--) {
            if (this.polynomial.testBit(length)) {
                ...
                this.polynomial.xorBit(length - r0);
                this.polynomial.xorBit(length - r1);
                this.polynomial.xorBit(length - r3);
    ...
    private void reduceTrinomialBitwise(int r4) {
        int r0 = this.mDegree - r4;
    ...
    public GF2nPolynomialElement power(int r6) {
        if (r6 == 1) {
            return new GF2nPolynomialElement(this);
        }
    ...
    public void squareRootThis() {
        ...
        this.polynomial.reduceN();
        for (int r0 = 0; r0 < this.mField.getDegree() - 1; r0++) {
            squareThis();
        }
    }
    ...
    public void squareThisMatrix() {
        ...
        for (int r1 = 0; r1 < this.mDegree; r1++) {
            if (this.polynomial.vectorMult(((GF2nPolynomialField) this.mField).squaringMatrix[(this.mDegree - r1) - 1])) {
                gF2Polynomial.setBit(r1);
            }
        }
        this.polynomial = gF2Polynomial;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // org.bouncycastle.pqc.math.linearalgebra.GF2nElement
    public boolean testBit(int r2) {
        return this.polynomial.testBit(r2);
    }
    ...
    public String toString(int r2) {
        return this.polynomial.toString(r2);
    }

    @Override // org.bouncycastle.pqc.math.linearalgebra.GF2nElement
    public int trace() {
        GF2nPolynomialElement gF2nPolynomialElement = new GF2nPolynomialElement(this);
        for (int r2 = 1; r2 < this.mDegree; r2++) {
            gF2nPolynomialElement.squareThis();
            gF2nPolynomialElement.addToThis(this);
        }
