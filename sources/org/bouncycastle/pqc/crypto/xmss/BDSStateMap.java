...
public class BDSStateMap implements Serializable {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public BDS get(int r2) {
        return this.bdsState.get(Integers.valueOf(r2));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void put(int r2, BDS bds) {
        this.bdsState.put(Integers.valueOf(r2), bds);
    }

    BDS update(int r4, byte[] bArr, byte[] bArr2, OTSHashAddress oTSHashAddress) {
        return this.bdsState.put(Integers.valueOf(r4), this.bdsState.get(Integers.valueOf(r4)).getNextState(bArr, bArr2, oTSHashAddress));
    }
    ...
    public void updateState(XMSSMTParameters xMSSMTParameters, long j, byte[] bArr, byte[] bArr2) {
        ...
        for (int r11 = 1; r11 < xMSSMTParameters.getLayers(); r11++) {
            ...
            if (this.bdsState.get(Integer.valueOf(r11)) == null || XMSSUtil.isNewBDSInitNeeded(j, height, r11)) {
                this.bdsState.put(Integer.valueOf(r11), new BDS(xMSSParameters, bArr, bArr2, oTSHashAddress2));
            }
            if (leafIndex2 < r12 && XMSSUtil.isNewAuthenticationPathNeeded(j, height, r11)) {
