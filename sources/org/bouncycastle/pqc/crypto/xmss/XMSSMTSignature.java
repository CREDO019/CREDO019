...
public final class XMSSMTSignature implements XMSSStoreableObjectInterface, Encodable {
    ...
    private XMSSMTSignature(Builder builder) {
        ...
        int r3 = ceil + 0;
        this.random = XMSSUtil.extractBytesAtOffset(bArr, r3, treeDigestSize);
        this.reducedSignatures = new ArrayList();
        for (int r32 = r3 + treeDigestSize; r32 < bArr.length; r32 += height) {
            this.reducedSignatures.add(new XMSSReducedSignature.Builder(this.params.getXMSSParameters()).withReducedSignature(XMSSUtil.extractBytesAtOffset(bArr, r32, height)).build());
        }
    }
    ...
    public byte[] toByteArray() {
        ...
        int r2 = ceil + 0;
        XMSSUtil.copyBytesAtOffset(bArr, this.random, r2);
        int r22 = r2 + treeDigestSize;
        for (XMSSReducedSignature xMSSReducedSignature : this.reducedSignatures) {
            XMSSUtil.copyBytesAtOffset(bArr, xMSSReducedSignature.toByteArray(), r22);
            r22 += height;
        }
        return bArr;
    }
