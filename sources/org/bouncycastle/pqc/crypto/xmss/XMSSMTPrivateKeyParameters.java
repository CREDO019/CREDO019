...
public final class XMSSMTPrivateKeyParameters extends XMSSMTKeyParameters implements XMSSStoreableObjectInterface, Encodable {
    ...
    private XMSSMTPrivateKeyParameters(Builder builder) {
        ...
        if (bArr != null) {
            ...
            int r3 = (height + 7) / 8;
            this.index = XMSSUtil.bytesToXBigEndian(bArr, 0, r3);
            if (!XMSSUtil.isIndexValid(height, this.index)) {
                throw new IllegalArgumentException("index out of bounds");
            }
            int r32 = r3 + 0;
            this.secretKeySeed = XMSSUtil.extractBytesAtOffset(bArr, r32, treeDigestSize);
            int r33 = r32 + treeDigestSize;
            this.secretKeyPRF = XMSSUtil.extractBytesAtOffset(bArr, r33, treeDigestSize);
            int r34 = r33 + treeDigestSize;
            this.publicSeed = XMSSUtil.extractBytesAtOffset(bArr, r34, treeDigestSize);
            int r35 = r34 + treeDigestSize;
            this.root = XMSSUtil.extractBytesAtOffset(bArr, r35, treeDigestSize);
            int r36 = r35 + treeDigestSize;
            try {
                this.bdsState = ((BDSStateMap) XMSSUtil.deserialize(XMSSUtil.extractBytesAtOffset(bArr, r36, bArr.length - r36), BDSStateMap.class)).withWOTSDigest(builder.xmss.getTreeDigestOID());
                return;
            } catch (IOException e) {
    ...
    public XMSSMTPrivateKeyParameters extractKeyShard(int r8) {
    ...
    public byte[] toByteArray() {
        ...
        synchronized (this) {
            ...
            int r1 = height + 0;
            XMSSUtil.copyBytesAtOffset(bArr, this.secretKeySeed, r1);
            int r12 = r1 + treeDigestSize;
            XMSSUtil.copyBytesAtOffset(bArr, this.secretKeyPRF, r12);
            int r13 = r12 + treeDigestSize;
            XMSSUtil.copyBytesAtOffset(bArr, this.publicSeed, r13);
            XMSSUtil.copyBytesAtOffset(bArr, this.root, r13 + treeDigestSize);
            try {
