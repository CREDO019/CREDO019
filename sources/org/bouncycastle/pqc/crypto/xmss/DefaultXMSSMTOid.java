...
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    private DefaultXMSSMTOid(int r1, String str) {
        this.oid = r1;
        this.stringRepresentation = str;
    }

    private static String createKey(String str, int r2, int r3, int r4, int r5, int r6) {
        Objects.requireNonNull(str, "algorithmName == null");
        return str + "-" + r2 + "-" + r3 + "-" + r4 + "-" + r5 + "-" + r6;
    }

    public static DefaultXMSSMTOid lookup(String str, int r2, int r3, int r4, int r5, int r6) {
        Objects.requireNonNull(str, "algorithmName == null");
        return oidLookupTable.get(createKey(str, r2, r3, r4, r5, r6));
    }
