...
class ADRS {
    ...
    public void setChainAddress(int r3) {
        Pack.intToBigEndian(r3, this.value, 24);
    }

    public void setHashAddress(int r3) {
        Pack.intToBigEndian(r3, this.value, 28);
    }

    public void setKeyPairAddress(int r3) {
        Pack.intToBigEndian(r3, this.value, 20);
    }

    public void setLayerAddress(int r3) {
        Pack.intToBigEndian(r3, this.value, 0);
    }
    ...
    public void setTreeHeight(int r3) {
        Pack.intToBigEndian(r3, this.value, 24);
    }

    public void setTreeIndex(int r3) {
        Pack.intToBigEndian(r3, this.value, 28);
    }

    public void setType(int r4) {
        Pack.intToBigEndian(r4, this.value, 16);
