...
public class SubjectPublicKeyInfoFactory {
    ...
    public static SubjectPublicKeyInfo createSubjectPublicKeyInfo(AsymmetricKeyParameter asymmetricKeyParameter) throws IOException {
        if (asymmetricKeyParameter instanceof QTESLAPublicKeyParameters) {
            ...
            return new SubjectPublicKeyInfo(C5397Utils.qTeslaLookupAlgID(qTESLAPublicKeyParameters.getSecurityCategory()), qTESLAPublicKeyParameters.getPublicData());
            ...
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(PQCObjectIdentifiers.sphincs256, new SPHINCS256KeyParams(C5397Utils.sphincs256LookupTreeAlgID(sPHINCSPublicKeyParameters.getTreeDigest()))), sPHINCSPublicKeyParameters.getKeyData());
            ...
            if (asymmetricKeyParameter instanceof LMSPublicKeyParameters) {
                ...
                if (asymmetricKeyParameter instanceof McElieceCCA2PublicKeyParameters) {
                    ...
                    return new SubjectPublicKeyInfo(new AlgorithmIdentifier(PQCObjectIdentifiers.mcElieceCca2), new McElieceCCA2PublicKey(mcElieceCCA2PublicKeyParameters.getN(), mcElieceCCA2PublicKeyParameters.getT(), mcElieceCCA2PublicKeyParameters.getG(), C5397Utils.getAlgorithmIdentifier(mcElieceCCA2PublicKeyParameters.getDigest())));
                }
