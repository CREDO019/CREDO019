...
public class LMOtsSignature implements Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        if (lMOtsParameters == null ? lMOtsSignature.type == null : lMOtsParameters.equals(lMOtsSignature.type)) {
            if (Arrays.equals(this.f2428C, lMOtsSignature.f2428C)) {
                return Arrays.equals(this.f2429y, lMOtsSignature.f2429y);
            }
            return false;
        }
        return false;
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.type.getType()).bytes(this.f2428C).bytes(this.f2429y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return ((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f2428C)) * 31) + Arrays.hashCode(this.f2429y);
    }
}
