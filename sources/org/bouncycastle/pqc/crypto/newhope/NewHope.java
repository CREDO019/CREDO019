...
class NewHope {
    ...
    static void decodeB(short[] sArr, short[] sArr2, byte[] bArr) {
        ...
        for (int r4 = 0; r4 < 256; r4++) {
            int r0 = r4 * 4;
            int r1 = bArr[r4 + 1792] & 255;
            sArr2[r0 + 0] = (short) (r1 & 3);
            sArr2[r0 + 1] = (short) ((r1 >>> 2) & 3);
            sArr2[r0 + 2] = (short) ((r1 >>> 4) & 3);
            sArr2[r0 + 3] = (short) (r1 >>> 6);
        }
    }
    ...
    static void encodeB(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int r5 = 0; r5 < 256; r5++) {
            int r0 = r5 * 4;
            bArr[r5 + 1792] = (byte) ((sArr2[r0 + 3] << 6) | sArr2[r0] | (sArr2[r0 + 1] << 2) | (sArr2[r0 + 2] << 4));
        }
    }
