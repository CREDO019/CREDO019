...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream inputStream, int r1) throws IOException {
        return ByteArrayOutputStream.toBufferedInputStream(inputStream, r1);
    }
    ...
    public static BufferedReader toBufferedReader(Reader reader, int r2) {
        return reader instanceof BufferedReader ? (BufferedReader) reader : new BufferedReader(reader, r2);
    }
    ...
    public static BufferedReader buffer(Reader reader, int r2) {
        return reader instanceof BufferedReader ? (BufferedReader) reader : new BufferedReader(reader, r2);
    }
    ...
    public static BufferedWriter buffer(Writer writer, int r2) {
        return writer instanceof BufferedWriter ? (BufferedWriter) writer : new BufferedWriter(writer, r2);
    }
    ...
    public static BufferedOutputStream buffer(OutputStream outputStream, int r2) {
        Objects.requireNonNull(outputStream);
    ...
    public static BufferedInputStream buffer(InputStream inputStream, int r2) {
        Objects.requireNonNull(inputStream);
    ...
    public static byte[] toByteArray(InputStream inputStream, int r5) throws IOException {
        if (r5 < 0) {
            throw new IllegalArgumentException("Size must be equal or greater than zero: " + r5);
        }
        int r0 = 0;
        if (r5 == 0) {
            return new byte[0];
        ...
        while (r0 < r5) {
            int read = inputStream.read(bArr, r0, r5 - r0);
            if (read == -1) {
                break;
            }
            r0 += read;
        ...
        throw new IOException("Unexpected read size. current: " + r0 + ", expected: " + r5);
    }
    ...
    public static byte[] toByteArray(URI r0) throws IOException {
        return toByteArray(r0.toURL());
    }
    ...
    @Deprecated
    public static String toString(URI r1) throws IOException {
        return toString(r1, Charset.defaultCharset());
    }

    public static String toString(URI r0, Charset charset) throws IOException {
        return toString(r0.toURL(), Charsets.toCharset(charset));
    }

    public static String toString(URI r0, String str) throws IOException {
        return toString(r0, Charsets.toCharset(str));
    }
    ...
    public static void writeChunked(byte[] bArr, OutputStream outputStream) throws IOException {
        if (bArr != null) {
            ...
            while (length > 0) {
                ...
                outputStream.write(bArr, r1, min);
                length -= min;
                r1 += min;
            }
        }
    ...
    public static long copy(InputStream inputStream, OutputStream outputStream, int r2) throws IOException {
        return copyLarge(inputStream, outputStream, new byte[r2]);
    }
    ...
    public static long copyLarge(InputStream inputStream, OutputStream outputStream, long j, long j2, byte[] bArr) throws IOException {
        ...
        int r8 = (j2 > 0L ? 1 : (j2 == 0L ? 0 : -1));
        if (r8 == 0) {
            return 0L;
        }
        int length = bArr.length;
        int r2 = (r8 <= 0 || j2 >= ((long) length)) ? length : (int) j2;
        while (r2 > 0) {
            int read = inputStream.read(bArr, 0, r2);
            if (-1 == read) {
                break;
            }
            outputStream.write(bArr, 0, read);
    ...
    */
    public static boolean contentEqualsIgnoreEOL(java.io.Reader r4, java.io.Reader r5) throws java.io.IOException {
        ...
        L32:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.p028io.IOUtils.contentEqualsIgnoreEOL(java.io.Reader, java.io.Reader):boolean");
    }
    ...
    public static int read(Reader reader, char[] cArr, int r5, int r6) throws IOException {
        if (r6 < 0) {
            throw new IllegalArgumentException("Length must not be negative: " + r6);
        }
        int r0 = r6;
        while (r0 > 0) {
            int read = reader.read(cArr, (r6 - r0) + r5, r0);
            if (-1 == read) {
                break;
            }
            r0 -= read;
    ...
    public static int read(InputStream inputStream, byte[] bArr, int r5, int r6) throws IOException {
        ...
        int r0 = r6;
        while (r0 > 0) {
            int read = inputStream.read(bArr, (r6 - r0) + r5, r0);
            if (-1 == read) {
                break;
            }
            r0 -= read;
    ...
    public static void readFully(Reader reader, char[] cArr, int r3, int r4) throws IOException {
        int read = read(reader, cArr, r3, r4);
        if (read == r4) {
            return;
        }
        throw new EOFException("Length to read: " + r4 + " actual: " + read);
    }
    ...
    public static byte[] readFully(InputStream inputStream, int r3) throws IOException {
        byte[] bArr = new byte[r3];
        readFully(inputStream, bArr, 0, r3);
        return bArr;
    }
