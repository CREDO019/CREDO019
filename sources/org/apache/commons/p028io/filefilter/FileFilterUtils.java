...
public class FileFilterUtils {
    ...
    /* renamed from: or */
    public static IOFileFilter m143or(IOFileFilter... iOFileFilterArr) {
    ...
    public static List<IOFileFilter> toList(IOFileFilter... iOFileFilterArr) {
        ...
        for (int r1 = 0; r1 < iOFileFilterArr.length; r1++) {
            if (iOFileFilterArr[r1] == null) {
                throw new IllegalArgumentException("The filter[" + r1 + "] is null");
            }
            arrayList.add(iOFileFilterArr[r1]);
        }
        return arrayList;
    }
