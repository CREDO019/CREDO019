...
public class Nysiis implements StringEncoder {
    ...
    public String nysiis(String str) {
        ...
        while (r4 < length) {
            int r5 = length - 1;
            char c = SPACE;
            char c2 = r4 < r5 ? charArray[r4 + 1] : SPACE;
            if (r4 < length - 2) {
                c = charArray[r4 + 2];
            }
            int r7 = r4 - 1;
            char[] transcodeRemaining = transcodeRemaining(charArray[r7], charArray[r4], c2, c);
            System.arraycopy(transcodeRemaining, 0, charArray, r4, transcodeRemaining.length);
            if (charArray[r4] != charArray[r7]) {
                sb.append(charArray[r4]);
            }
            r4++;
        }
        if (sb.length() > 1) {
