...
public class Hex implements BinaryEncoder, BinaryDecoder {
    ...
    public static byte[] decodeHex(char[] cArr) throws DecoderException {
        ...
        while (r2 < length) {
            int r22 = r2 + 1;
            r2 = r22 + 1;
            bArr[r3] = (byte) (((toDigit(cArr[r2], r2) << 4) | toDigit(cArr[r22], r22)) & 255);
            r3++;
        }
        return bArr;
    }
    ...
    protected static char[] encodeHex(byte[] bArr, char[] cArr) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            int r4 = r3 + 1;
            cArr2[r3] = cArr[(bArr[r2] & 240) >>> 4];
            r3 = r4 + 1;
            cArr2[r4] = cArr[bArr[r2] & Ascii.f1128SI];
        }
        return cArr2;
    }
    ...
    protected static int toDigit(char c, int r4) throws DecoderException {
        int digit = Character.digit(c, 16);
        if (digit != -1) {
            return digit;
        }
        throw new DecoderException("Illegal hexadecimal character " + c + " at index " + r4);
    }
