...
public class Validate {
    ...
    public static <T> T[] noNullElements(T[] tArr, String str, Object... objArr) {
        notNull(tArr);
        for (int r0 = 0; r0 < tArr.length; r0++) {
            if (tArr[r0] == null) {
                throw new IllegalArgumentException(String.format(str, ArrayUtils.add((Integer[]) objArr, Integer.valueOf(r0))));
            }
        }
        return tArr;
    }
    ...
    public static <T extends Iterable<?>> T noNullElements(T t, String str, Object... objArr) {
        ...
        for (Object obj : t) {
            if (obj == null) {
                throw new IllegalArgumentException(String.format(str, ArrayUtils.addAll(objArr, Integer.valueOf(r2))));
            }
            r2++;
        }
        return t;
    ...
    public static <T> T[] validIndex(T[] tArr, int r2, String str, Object... objArr) {
        notNull(tArr);
        if (r2 < 0 || r2 >= tArr.length) {
            throw new IndexOutOfBoundsException(String.format(str, objArr));
        }
        return tArr;
    }

    public static <T> T[] validIndex(T[] tArr, int r4) {
        return (T[]) validIndex(tArr, r4, DEFAULT_VALID_INDEX_ARRAY_EX_MESSAGE, Integer.valueOf(r4));
    }

    public static <T extends Collection<?>> T validIndex(T t, int r2, String str, Object... objArr) {
        notNull(t);
        if (r2 < 0 || r2 >= t.size()) {
            throw new IndexOutOfBoundsException(String.format(str, objArr));
        }
    ...
    public static <T extends Collection<?>> T validIndex(T t, int r4) {
        return (T) validIndex(t, r4, DEFAULT_VALID_INDEX_COLLECTION_EX_MESSAGE, Integer.valueOf(r4));
    }

    public static <T extends CharSequence> T validIndex(T t, int r2, String str, Object... objArr) {
        notNull(t);
        if (r2 < 0 || r2 >= t.length()) {
            throw new IndexOutOfBoundsException(String.format(str, objArr));
        }
    ...
    public static <T extends CharSequence> T validIndex(T t, int r4) {
        return (T) validIndex(t, r4, DEFAULT_VALID_INDEX_CHAR_SEQUENCE_EX_MESSAGE, Integer.valueOf(r4));
    }
