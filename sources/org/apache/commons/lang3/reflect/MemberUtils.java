...
abstract class MemberUtils {
    ...
    public static int compareConstructorFit(Constructor<?> constructor, Constructor<?> constructor2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m137of(constructor), Executable.m137of(constructor2), clsArr);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int compareMethodFit(Method method, Method method2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m136of(method), Executable.m136of(method2), clsArr);
    }
    ...
    private static float getTotalTransformationCost(Class<?>[] clsArr, Executable executable) {
        ...
        boolean z = false;
        float f = 0.0f;
        for (int r6 = 0; r6 < j; r6++) {
            f += getObjectTransformationCost(clsArr[r6], parameterTypes[r6]);
        }
        if (isVarArgs) {
    ...
    public static boolean isMatchingMethod(Method method, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m136of(method), clsArr);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isMatchingConstructor(Constructor<?> constructor, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m137of(constructor), clsArr);
    }
    ...
    private static boolean isMatchingExecutable(Executable executable, Class<?>[] clsArr) {
        ...
        if (executable.isVarArgs()) {
            int r5 = 0;
            while (r5 < parameterTypes.length - 1 && r5 < clsArr.length) {
                if (!ClassUtils.isAssignable(clsArr[r5], parameterTypes[r5], true)) {
                    return false;
                }
                r5++;
            }
            Class<?> componentType = parameterTypes[parameterTypes.length - 1].getComponentType();
            while (r5 < clsArr.length) {
                if (!ClassUtils.isAssignable(clsArr[r5], componentType, true)) {
                    return false;
                }
                r5++;
            }
    ...
    public static final class Executable {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: of */
        public static Executable m136of(Method method) {
            return new Executable(method);
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: of */
        public static Executable m137of(Constructor<?> constructor) {
