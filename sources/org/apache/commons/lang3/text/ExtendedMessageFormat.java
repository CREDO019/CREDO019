...
public class ExtendedMessageFormat extends MessageFormat {
        ...
        while (parsePosition.getIndex() < str.length()) {
            ...
            if (c == '\'') {
                ...
                if (c == '{') {
                    ...
                    Validate.isTrue(arrayList.size() == r6);
                    Validate.isTrue(arrayList2.size() == r6);
                    if (charArray[parsePosition.getIndex()] != '}') {
    ...
    @Override // java.text.MessageFormat
    public void setFormat(int r1, Format format) {
        throw new UnsupportedOperationException();
    }

    @Override // java.text.MessageFormat
    public void setFormatByArgumentIndex(int r1, Format format) {
        throw new UnsupportedOperationException();
    }
        ...
        if (containsElements(arrayList)) {
            ...
            while (parsePosition.getIndex() < str.length()) {
                ...
                if (charAt == '\'') {
                    ...
                    if (r2 == 1 && (str2 = arrayList.get((r3 = r3 + 1))) != null) {
                        sb.append(START_FMT);
                        sb.append(str2);
                    }
                } else {
