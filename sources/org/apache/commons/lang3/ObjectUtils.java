...
public class ObjectUtils {
        ...
        if (t.getClass().isArray()) {
            ...
            if (componentType.isPrimitive()) {
                ...
                while (true) {
                    ...
                    Array.set(t2, r2, Array.get(t, r2));
                    length = r2;
                }
            } else {
    ...
    public static byte CONST_BYTE(int r3) {
        if (r3 < -128 || r3 > 127) {
            throw new IllegalArgumentException("Supplied value must be a valid byte literal between -128 and 127: [" + r3 + "]");
        }
        return (byte) r3;
    }
    ...
    public static short CONST_SHORT(int r3) {
        if (r3 < -32768 || r3 > 32767) {
            throw new IllegalArgumentException("Supplied value must be a valid byte literal between -32768 and 32767: [" + r3 + "]");
        }
        return (short) r3;
    }
}
