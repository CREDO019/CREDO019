...
abstract class FormatCache<F extends Format> {
    ...
    public F getDateTimeInstance(int r1, int r2, TimeZone timeZone, Locale locale) {
        return getDateTimeInstance(Integer.valueOf(r1), Integer.valueOf(r2), timeZone, locale);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public F getDateInstance(int r2, TimeZone timeZone, Locale locale) {
        return getDateTimeInstance(Integer.valueOf(r2), (Integer) null, timeZone, locale);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public F getTimeInstance(int r2, TimeZone timeZone, Locale locale) {
        return getDateTimeInstance((Integer) null, Integer.valueOf(r2), timeZone, locale);
    }
