...
public class BooleanUtils {
    ...
    public static int toInteger(boolean z, int r1, int r2) {
        return z ? r1 : r2;
    }
    ...
    public static Boolean toBooleanObject(int r0) {
        return r0 == 0 ? Boolean.FALSE : Boolean.TRUE;
    }
    ...
    public static Boolean toBooleanObject(int r0, int r1, int r2, int r3) {
        if (r0 == r1) {
            return Boolean.TRUE;
        }
        if (r0 == r2) {
    ...
    public static int toInteger(Boolean bool, int r1, int r2, int r3) {
        return bool == null ? r3 : bool.booleanValue() ? r1 : r2;
    }
    ...
    public static String toStringOnOff(Boolean bool) {
        return toString(bool, "on", Debug.DEBUG_PROPERTY_VALUE_OFF, null);
    }
    ...
    public static String toStringOnOff(boolean z) {
        return toString(z, "on", Debug.DEBUG_PROPERTY_VALUE_OFF);
    }
    ...
    /* renamed from: or */
    public static boolean m141or(boolean... zArr) {
        if (zArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        }
        if (zArr.length == 0) {
    ...
    /* renamed from: or */
    public static Boolean m142or(Boolean... boolArr) {
        if (boolArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        }
        if (boolArr.length == 0) {
        ...
        try {
            return m141or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
        } catch (NullPointerException unused) {
            throw new IllegalArgumentException("The array must not contain any null elements");
        }
    }
