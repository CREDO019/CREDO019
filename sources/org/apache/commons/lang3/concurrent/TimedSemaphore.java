...
public class TimedSemaphore {
    ...
    public TimedSemaphore(long j, TimeUnit timeUnit, int r10) {
        this(null, j, timeUnit, r10);
    }

    public TimedSemaphore(ScheduledExecutorService scheduledExecutorService, long j, TimeUnit timeUnit, int r12) {
    ...
    synchronized void endOfPeriod() {
        int r0 = this.acquireCount;
        this.lastCallsPerPeriod = r0;
        this.totalAcquireCount += r0;
        this.periodCount++;
        this.acquireCount = 0;
        notifyAll();
    }
