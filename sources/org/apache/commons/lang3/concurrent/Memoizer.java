...
public class Memoizer<I, O> implements Computable<I, O> {
    ...
    public O compute(final I r4) throws InterruptedException {
        FutureTask futureTask;
        while (true) {
            Future<O> future = this.cache.get(r4);
            if (future == null && (future = this.cache.putIfAbsent(r4, (futureTask = new FutureTask(new Callable<O>() { // from class: org.apache.commons.lang3.concurrent.Memoizer.1
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.concurrent.Callable
                public O call() throws InterruptedException {
                    return (O) Memoizer.this.computable.compute(r4);
                }
            })))) == null) {
                futureTask.run();
                future = futureTask;
