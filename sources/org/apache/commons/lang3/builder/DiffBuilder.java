...
public class DiffBuilder implements Builder<DiffResult> {
    ...
    public DiffBuilder append(String str, final int r4, final int r5) {
        validateFieldNameNotNull(str);
        if (!this.objectsTriviallyEqual && r4 != r5) {
    ...
    public DiffBuilder append(String str, final int[] r4, final int[] r5) {
        validateFieldNameNotNull(str);
        if (!this.objectsTriviallyEqual && !Arrays.equals(r4, r5)) {
