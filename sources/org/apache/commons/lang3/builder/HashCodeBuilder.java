...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    public static int reflectionHashCode(int r7, int r8, Object obj) {
        return reflectionHashCode(r7, r8, obj, false, null, new String[0]);
    }

    public static int reflectionHashCode(int r7, int r8, Object obj, boolean z) {
        return reflectionHashCode(r7, r8, obj, z, null, new String[0]);
    }

    public static <T> int reflectionHashCode(int r3, int r4, T t, boolean z, Class<? super T> cls, String... strArr) {
        Validate.isTrue(t != null, "The object to build a hash code for must not be null", new Object[0]);
        HashCodeBuilder hashCodeBuilder = new HashCodeBuilder(r3, r4);
    ...
    public HashCodeBuilder(int r6, int r7) {
        this.iTotal = 0;
        Validate.isTrue(r6 % 2 != 0, "HashCodeBuilder requires an odd initial value", new Object[0]);
        Validate.isTrue(r7 % 2 != 0, "HashCodeBuilder requires an odd multiplier", new Object[0]);
        this.iConstant = r7;
        this.iTotal = r6;
    }
    ...
    public HashCodeBuilder append(int r3) {
        this.iTotal = (this.iTotal * this.iConstant) + r3;
        return this;
    }

    public HashCodeBuilder append(int[] r4) {
        if (r4 == null) {
            this.iTotal *= this.iConstant;
        } else {
            for (int r2 : r4) {
    ...
    public HashCodeBuilder appendSuper(int r3) {
        this.iTotal = (this.iTotal * this.iConstant) + r3;
        return this;
    }
