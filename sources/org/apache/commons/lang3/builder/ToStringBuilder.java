...
public class ToStringBuilder implements Builder<String> {
    ...
    public ToStringBuilder append(int r4) {
        this.style.append(this.buffer, (String) null, r4);
        return this;
    }

    public ToStringBuilder append(int[] r4) {
        this.style.append(this.buffer, (String) null, r4, (Boolean) null);
        return this;
    }
    ...
    public ToStringBuilder append(String str, int r4) {
        this.style.append(this.buffer, str, r4);
        return this;
    }

    public ToStringBuilder append(String str, int[] r5) {
        this.style.append(this.buffer, str, r5, (Boolean) null);
        return this;
    }

    public ToStringBuilder append(String str, int[] r4, boolean z) {
        this.style.append(this.buffer, str, r4, Boolean.valueOf(z));
        return this;
    }
