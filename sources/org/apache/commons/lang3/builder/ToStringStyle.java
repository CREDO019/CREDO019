...
public abstract class ToStringStyle implements Serializable {
    ...
    protected void removeLastFieldSeparator(StringBuffer stringBuffer) {
        ...
        while (true) {
            if (r3 >= length2) {
                z = true;
                break;
            } else if (stringBuffer.charAt((length - 1) - r3) != this.fieldSeparator.charAt((length2 - 1) - r3)) {
                break;
            } else {
                r3++;
            }
    ...
    public void append(StringBuffer stringBuffer, String str, int r3) {
        appendFieldStart(stringBuffer, str);
        appendDetail(stringBuffer, str, r3);
        appendFieldEnd(stringBuffer, str);
    }

    protected void appendDetail(StringBuffer stringBuffer, String str, int r3) {
    ...
    public void appendDetail(StringBuffer stringBuffer, String str, long[] jArr) {
        ...
        for (int r0 = 0; r0 < jArr.length; r0++) {
            ...
            appendDetail(stringBuffer, str, jArr[r0]);
        }
        stringBuffer.append(this.arrayEnd);
    }
    ...
    public void append(StringBuffer stringBuffer, String str, int[] r3, Boolean bool) {
        appendFieldStart(stringBuffer, str);
        if (r3 == null) {
            appendNullText(stringBuffer, str);
        } else if (isFullDetail(bool)) {
            ...
            appendSummary(stringBuffer, str, r3);
        }
        appendFieldEnd(stringBuffer, str);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void appendDetail(StringBuffer stringBuffer, String str, int[] r5) {
        stringBuffer.append(this.arrayStart);
        for (int r0 = 0; r0 < r5.length; r0++) {
            if (r0 > 0) {
                stringBuffer.append(this.arraySeparator);
            }
            appendDetail(stringBuffer, str, r5[r0]);
        }
        stringBuffer.append(this.arrayEnd);
    }

    protected void appendSummary(StringBuffer stringBuffer, String str, int[] r3) {
        appendSummarySize(stringBuffer, str, r3.length);
    }
    ...
    public void appendDetail(StringBuffer stringBuffer, String str, short[] sArr) {
        ...
        for (int r0 = 0; r0 < sArr.length; r0++) {
            ...
            appendDetail(stringBuffer, str, sArr[r0]);
        }
        stringBuffer.append(this.arrayEnd);
    }
    ...
    public void appendDetail(StringBuffer stringBuffer, String str, byte[] bArr) {
        ...
        for (int r0 = 0; r0 < bArr.length; r0++) {
            ...
            appendDetail(stringBuffer, str, bArr[r0]);
        }
        stringBuffer.append(this.arrayEnd);
    }
    ...
    public void appendDetail(StringBuffer stringBuffer, String str, char[] cArr) {
        ...
        for (int r0 = 0; r0 < cArr.length; r0++) {
            ...
            appendDetail(stringBuffer, str, cArr[r0]);
        }
        stringBuffer.append(this.arrayEnd);
    }
    ...
    public void appendDetail(StringBuffer stringBuffer, String str, double[] dArr) {
        stringBuffer.append(this.arrayStart);
        for (int r0 = 0; r0 < dArr.length; r0++) {
            if (r0 > 0) {
                stringBuffer.append(this.arraySeparator);
            }
            appendDetail(stringBuffer, str, dArr[r0]);
        }
        stringBuffer.append(this.arrayEnd);
    }
    ...
    public void appendDetail(StringBuffer stringBuffer, String str, float[] fArr) {
        stringBuffer.append(this.arrayStart);
        for (int r0 = 0; r0 < fArr.length; r0++) {
            if (r0 > 0) {
                stringBuffer.append(this.arraySeparator);
            }
            appendDetail(stringBuffer, str, fArr[r0]);
        }
        stringBuffer.append(this.arrayEnd);
    }
    ...
    public void appendDetail(StringBuffer stringBuffer, String str, boolean[] zArr) {
        stringBuffer.append(this.arrayStart);
        for (int r0 = 0; r0 < zArr.length; r0++) {
            if (r0 > 0) {
                stringBuffer.append(this.arraySeparator);
            }
            appendDetail(stringBuffer, str, zArr[r0]);
        }
        stringBuffer.append(this.arrayEnd);
    }
    ...
    protected void appendSummarySize(StringBuffer stringBuffer, String str, int r3) {
    ...
    private static final class JsonToStringStyle extends ToStringStyle {
        ...
        JsonToStringStyle() {
            ...
            setArrayEnd("]");
            setFieldSeparator(",");
            setFieldNameValueSeparator(ParameterizedMessage.ERROR_MSG_SEPARATOR);
            setNullText("null");
        ...
        @Override // org.apache.commons.lang3.builder.ToStringStyle
        public void append(StringBuffer stringBuffer, String str, int[] r4, Boolean bool) {
            if (str == null) {
                throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
            }
            if (!isFullDetail(bool)) {
            ...
            super.append(stringBuffer, str, r4, bool);
        }
