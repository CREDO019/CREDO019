...
public final class GzipSource implements Source {
    ...
    private final void checkEqual(String str, int r6, int r7) {
        if (r7 == r6) {
            return;
        }
        String format = String.format("%s: actual 0x%08x != expected 0x%08x", Arrays.copyOf(new Object[]{str, Integer.valueOf(r7), Integer.valueOf(r6)}, 3));
