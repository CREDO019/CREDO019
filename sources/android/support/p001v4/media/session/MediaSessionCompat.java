...
public class MediaSessionCompat {
                ...
                try {
                    ...
                    if (command.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (sessionImplIfCallbackIsSet.mQueue != null) {
                            int r6 = extras.getInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX, -1);
                            if (r6 >= 0 && r6 < sessionImplIfCallbackIsSet.mQueue.size()) {
                                queueItem = sessionImplIfCallbackIsSet.mQueue.get(r6);
                            }
                            if (queueItem != null) {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    if (r3 == 2) {
                        ...
                        streamMaxVolume = MediaSessionImplBase.this.mAudioManager.getStreamMaxVolume(r4);
                        streamVolume = MediaSessionImplBase.this.mAudioManager.getStreamVolume(r4);
                        r5 = 2;
                    }
                }
                return new ParcelableVolumeInfo(r3, r4, r5, streamMaxVolume, streamVolume);
            }
    ...
    static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        ...
        @Override // android.support.p001v4.media.session.MediaSessionCompat.MediaSessionImplApi21
        public MediaSession createFwkMediaSession(Context context, String tag, Bundle sessionInfo) {
