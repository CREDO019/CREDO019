...
public final class MediaBrowserCompat {
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        private boolean isCurrent(Messenger callback, String funcName) {
            int r3;
            if (this.mCallbacksMessenger != callback || (r3 = this.mState) == 0 || r3 == 1) {
                int r32 = this.mState;
                if (r32 == 0 || r32 == 1) {
                    return false;
                }
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle options) {
            for (int r0 = 0; r0 < this.mOptionsList.size(); r0++) {
                if (MediaBrowserCompatUtils.areSameOptions(this.mOptionsList.get(r0), options)) {
        ...
        public void putCallback(Bundle options, SubscriptionCallback callback) {
            for (int r0 = 0; r0 < this.mOptionsList.size(); r0++) {
                if (MediaBrowserCompatUtils.areSameOptions(this.mOptionsList.get(r0), options)) {
                    this.mCallbacks.set(r0, callback);
                    return;
                }
            }
