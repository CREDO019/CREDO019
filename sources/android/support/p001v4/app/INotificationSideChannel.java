...
public interface INotificationSideChannel extends IInterface {
    ...
    public static class Default implements INotificationSideChannel {
        ...
        public void cancel(String str, int r2, String str2) throws RemoteException {
        }
        ...
        @Override // android.support.p001v4.app.INotificationSideChannel
        public void notify(String str, int r2, String str2, Notification notification) throws RemoteException {
        }
    }
    ...
    public static abstract class Stub extends Binder implements INotificationSideChannel {
        ...
        public static class Proxy implements INotificationSideChannel {
            ...
            @Override // android.support.p001v4.app.INotificationSideChannel
            public void notify(String str, int r6, String str2, Notification notification) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().notify(str, r6, str2, notification);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            @Override // android.support.p001v4.app.INotificationSideChannel
            public void cancel(String str, int r7, String str2) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeString(str);
                    ...
                    Stub.getDefaultImpl().cancel(str, r7, str2);
                } finally {
                    obtain.recycle();
                }
            }
