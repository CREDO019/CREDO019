...
public interface ICustomTabsService extends IInterface {
    ...
    boolean receiveFile(ICustomTabsCallback iCustomTabsCallback, Uri uri, int r3, Bundle bundle) throws RemoteException;
    ...
    boolean validateRelationship(ICustomTabsCallback iCustomTabsCallback, int r2, Uri uri, Bundle bundle) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ICustomTabsService {
        ...
        public static class Proxy implements ICustomTabsService {
            ...
            @Override // android.support.customtabs.ICustomTabsService
            public boolean validateRelationship(ICustomTabsCallback iCustomTabsCallback, int r8, Uri uri, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (!this.mRemote.transact(9, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().validateRelationship(iCustomTabsCallback, r8, uri, bundle);
                    }
                    obtain2.readException();
                    return obtain2.readInt() != 0;
                } finally {
            ...
            @Override // android.support.customtabs.ICustomTabsService
            public boolean receiveFile(ICustomTabsCallback iCustomTabsCallback, Uri uri, int r9, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (!this.mRemote.transact(12, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().receiveFile(iCustomTabsCallback, uri, r9, bundle);
                    }
                    obtain2.readException();
                    return obtain2.readInt() != 0;
                } finally {
