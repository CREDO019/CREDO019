...
public interface ICustomTabsCallback extends IInterface {
    ...
    public static class Default implements ICustomTabsCallback {
        ...
        @Override // android.support.customtabs.ICustomTabsCallback
        public void onNavigationEvent(int r1, Bundle bundle) throws RemoteException {
        }
        ...
        @Override // android.support.customtabs.ICustomTabsCallback
        public void onRelationshipValidationResult(int r1, Uri uri, boolean z, Bundle bundle) throws RemoteException {
        }
    }
    ...
    void onNavigationEvent(int r1, Bundle bundle) throws RemoteException;

    void onPostMessage(String str, Bundle bundle) throws RemoteException;

    void onRelationshipValidationResult(int r1, Uri uri, boolean z, Bundle bundle) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ICustomTabsCallback {
        ...
        public static class Proxy implements ICustomTabsCallback {
            ...
            @Override // android.support.customtabs.ICustomTabsCallback
            public void onNavigationEvent(int r6, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(2, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onNavigationEvent(r6, bundle);
                    } else {
            ...
            @Override // android.support.customtabs.ICustomTabsCallback
            public void onRelationshipValidationResult(int r6, Uri uri, boolean z, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (!this.mRemote.transact(6, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onRelationshipValidationResult(r6, uri, z, bundle);
                    } else {
                        obtain2.readException();
                    }
                } finally {
