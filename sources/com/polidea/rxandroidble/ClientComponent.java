...
public interface ClientComponent {
    ...
    public static abstract class ClientModuleBinder {
        ...
        @Binds
        abstract Func1<RxBleInternalScanResult, ScanResult> provideScanResultMapper(InternalToExternalScanResultConverter internalToExternalScanResultConverter);
    }
    ...
    public static class ClientModule {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Provides
        public LocationServicesStatus provideLocationServicesStatus(@Named("device-sdk") int r2, Provider<LocationServicesStatusApi18> provider, Provider<LocationServicesStatusApi23> provider2) {
            if (r2 < 23) {
                return provider.get();
            }
        ...
        @Provides
        public Observable<Boolean> provideLocationServicesOkObservable(@Named("device-sdk") int r2, Provider<LocationServicesOkObservableApi23> provider) {
            if (r2 < 23) {
        ...
        @Provides
        public boolean provideIsAndroidWear(@Named("device-sdk") int r2) {
            return r2 >= 20 && this.context.getPackageManager().hasSystemFeature("android.hardware.type.watch");
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        @ClientScope
        @Provides
        public static ScanSetupBuilder provideScanSetupProvider(@Named("device-sdk") int r1, Provider<ScanSetupBuilderImplApi18> provider, Provider<ScanSetupBuilderImplApi21> provider2, Provider<ScanSetupBuilderImplApi23> provider3) {
            if (r1 < 21) {
                return provider.get();
            }
            if (r1 < 23) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Provides
        public static ScanPreconditionsVerifier provideScanPreconditionVerifier(@Named("device-sdk") int r1, Provider<ScanPreconditionsVerifierApi18> provider, Provider<ScanPreconditionsVerifierApi24> provider2) {
            if (r1 < 24) {
                return provider.get();
            }
            return provider2.get();
