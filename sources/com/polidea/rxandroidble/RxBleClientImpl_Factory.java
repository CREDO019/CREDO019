...
public final class RxBleClientImpl_Factory implements Factory<RxBleClientImpl> {
    ...
    public static RxBleClientImpl newRxBleClientImpl(RxBleAdapterWrapper rxBleAdapterWrapper, ClientOperationQueue clientOperationQueue, Observable<RxBleAdapterStateObservable.BleAdapterState> observable, UUIDUtil uUIDUtil, LocationServicesStatus locationServicesStatus, Lazy<ClientStateObservable> lazy, RxBleDeviceProvider rxBleDeviceProvider, ScanSetupBuilder scanSetupBuilder, ScanPreconditionsVerifier scanPreconditionsVerifier, Func1<RxBleInternalScanResult, ScanResult> func1, Scheduler scheduler, ClientComponent.ClientComponentFinalizer clientComponentFinalizer) {
        return new RxBleClientImpl(rxBleAdapterWrapper, clientOperationQueue, observable, uUIDUtil, locationServicesStatus, lazy, rxBleDeviceProvider, scanSetupBuilder, scanPreconditionsVerifier, func1, scheduler, clientComponentFinalizer);
    }
}
