...
public final class C3796x9cd4449f implements Factory<LocationServicesStatus> {
    ...
    public C3796x9cd4449f(ClientComponent.ClientModule clientModule, Provider<Integer> provider, Provider<LocationServicesStatusApi18> provider2, Provider<LocationServicesStatusApi23> provider3) {
    ...
    public static C3796x9cd4449f create(ClientComponent.ClientModule clientModule, Provider<Integer> provider, Provider<LocationServicesStatusApi18> provider2, Provider<LocationServicesStatusApi23> provider3) {
        return new C3796x9cd4449f(clientModule, provider, provider2, provider3);
    }

    public static LocationServicesStatus proxyProvideLocationServicesStatus(ClientComponent.ClientModule clientModule, int r1, Provider<LocationServicesStatusApi18> provider, Provider<LocationServicesStatusApi23> provider2) {
        return (LocationServicesStatus) Preconditions.checkNotNull(clientModule.provideLocationServicesStatus(r1, provider, provider2), "Cannot return null from a non-@Nullable @Provides method");
    }
}
