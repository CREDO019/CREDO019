...
public class RxBleServicesLogger {
    ...
    @Inject
    public RxBleServicesLogger(CharacteristicPropertiesParser characteristicPropertiesParser) {
    ...
    public void log(RxBleDeviceServices rxBleDeviceServices, BluetoothDevice bluetoothDevice) {
        if (RxBleLog.isAtLeast(2)) {
            RxBleLog.m237v("Preparing services description", new Object[0]);
            RxBleLog.m237v(prepareServicesDescription(rxBleDeviceServices, bluetoothDevice), new Object[0]);
        }
    }
