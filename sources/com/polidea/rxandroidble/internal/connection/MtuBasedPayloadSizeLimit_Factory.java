...
public final class MtuBasedPayloadSizeLimit_Factory implements Factory<MtuBasedPayloadSizeLimit> {
    ...
    public static MtuBasedPayloadSizeLimit newMtuBasedPayloadSizeLimit(RxBleConnection rxBleConnection, int r2) {
        return new MtuBasedPayloadSizeLimit(rxBleConnection, r2);
    }
}
