...
public class StandardUUIDsParser {
    ...
    static {
        ...
        hashMap2.put("2A80", HttpHeaders.AGE);
        ...
        hashMap2.put("2A01", AppearanceModule.NAME);
    ...
    public static String getServiceName(UUID r1) {
        String standardizedUUIDComponent = getStandardizedUUIDComponent(r1);
    ...
    public static String getCharacteristicName(UUID r1) {
        String standardizedUUIDComponent = getStandardizedUUIDComponent(r1);
        if (standardizedUUIDComponent != null) {
    ...
    public static String getDescriptorName(UUID r1) {
        String standardizedUUIDComponent = getStandardizedUUIDComponent(r1);
        if (standardizedUUIDComponent != null) {
    ...
    private static String getStandardizedUUIDComponent(UUID r2) {
        String upperCase = r2.toString().toUpperCase();
