...
public class ErrorConverter {
    ...
    private BleError toError(int r2, String str, BleGattOperationType bleGattOperationType, String str2, String str3, String str4, String str5) {
        if (BleGattOperationType.CONNECTION_STATE == bleGattOperationType) {
            BleError bleError = new BleError(BleErrorCode.DeviceDisconnected, str, Integer.valueOf(r2));
            bleError.deviceID = str2;
            return bleError;
        } else if (BleGattOperationType.SERVICE_DISCOVERY == bleGattOperationType) {
            BleError bleError2 = new BleError(BleErrorCode.ServicesDiscoveryFailed, str, Integer.valueOf(r2));
            ...
            BleError bleError3 = new BleError(BleErrorCode.CharacteristicReadFailed, str, Integer.valueOf(r2));
            ...
            BleError bleError4 = new BleError(BleErrorCode.CharacteristicWriteFailed, str, Integer.valueOf(r2));
            ...
            BleError bleError5 = new BleError(BleErrorCode.DescriptorReadFailed, str, Integer.valueOf(r2));
            ...
            BleError bleError6 = new BleError(BleErrorCode.DescriptorWriteFailed, str, Integer.valueOf(r2));
            ...
            BleError bleError7 = new BleError(BleErrorCode.DeviceRSSIReadFailed, str, Integer.valueOf(r2));
            bleError7.deviceID = str2;
            return bleError7;
        } else if (BleGattOperationType.ON_MTU_CHANGED == bleGattOperationType) {
            BleError bleError8 = new BleError(BleErrorCode.DeviceMTUChangeFailed, str, Integer.valueOf(r2));
            bleError8.deviceID = str2;
            return bleError8;
        } else {
            BleGattOperationType bleGattOperationType2 = BleGattOperationType.CONNECTION_PRIORITY_CHANGE;
            return new BleError(BleErrorCode.UnknownError, str, Integer.valueOf(r2));
        }
    }
