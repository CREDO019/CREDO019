...
public abstract class YogaNodeJNIBase extends YogaNode implements Cloneable {
    ...
    @Override // com.facebook.yoga.YogaNode
    public YogaNodeJNIBase getChildAt(int r2) {
        List<YogaNodeJNIBase> list = this.mChildren;
        if (list == null) {
    ...
    @Override // com.facebook.yoga.YogaNode
    public void addChildAt(YogaNode yogaNode, int r6) {
        if (yogaNode instanceof YogaNodeJNIBase) {
            ...
            this.mChildren.add(r6, yogaNodeJNIBase);
            yogaNodeJNIBase.mOwner = this;
            YogaNative.jni_YGNodeInsertChildJNI(this.mNativePointer, yogaNodeJNIBase.mNativePointer, r6);
        }
    }
    ...
    public void swapChildAt(YogaNode yogaNode, int r6) {
        if (yogaNode instanceof YogaNodeJNIBase) {
            YogaNodeJNIBase yogaNodeJNIBase = (YogaNodeJNIBase) yogaNode;
            this.mChildren.remove(r6);
            this.mChildren.add(r6, yogaNodeJNIBase);
            yogaNodeJNIBase.mOwner = this;
            YogaNative.jni_YGNodeSwapChildJNI(this.mNativePointer, yogaNodeJNIBase.mNativePointer, r6);
        }
    }
    ...
    public YogaNodeJNIBase cloneWithChildren() {
        try {
            ...
            for (int r1 = 0; r1 < yogaNodeJNIBase.getChildCount(); r1++) {
                yogaNodeJNIBase.swapChildAt(yogaNodeJNIBase.getChildAt(r1).cloneWithChildren(), r1);
            }
    ...
    @Override // com.facebook.yoga.YogaNode
    public YogaNodeJNIBase removeChildAt(int r5) {
        List<YogaNodeJNIBase> list = this.mChildren;
        if (list == null) {
            throw new IllegalStateException("Trying to remove a child of a YogaNode that does not have children");
        }
        YogaNodeJNIBase remove = list.remove(r5);
        remove.mOwner = null;
    ...
    public void calculateLayout(float f, float f2) {
        ...
        for (int r2 = 0; r2 < arrayList.size(); r2++) {
            YogaNodeJNIBase yogaNodeJNIBase = (YogaNodeJNIBase) arrayList.get(r2);
        ...
        for (int r1 = 0; r1 < yogaNodeJNIBaseArr.length; r1++) {
            jArr[r1] = yogaNodeJNIBaseArr[r1].mNativePointer;
        }
    ...
    public final long measure(float f, int r9, float f2, int r11) {
        if (!isMeasureDefined()) {
            throw new RuntimeException("Measure function isn't defined!");
        }
        return this.mMeasureFunction.measure(this, f, YogaMeasureMode.fromInt(r9), f2, YogaMeasureMode.fromInt(r11));
    }
    ...
    private final long replaceChild(YogaNodeJNIBase yogaNodeJNIBase, int r3) {
        List<YogaNodeJNIBase> list = this.mChildren;
        if (list == null) {
            throw new IllegalStateException("Cannot replace child. YogaNode does not have children");
        }
        list.remove(r3);
        this.mChildren.add(r3, yogaNodeJNIBase);
        yogaNodeJNIBase.mOwner = this;
    ...
    static /* synthetic */ class C17451 {
        ...
        static {
            int[] r0 = new int[YogaEdge.values().length];
            $SwitchMap$com$facebook$yoga$YogaEdge = r0;
            try {
                r0[YogaEdge.LEFT.ordinal()] = 1;
    ...
    public float getLayoutMargin(YogaEdge yogaEdge) {
        ...
        switch (C17451.$SwitchMap$com$facebook$yoga$YogaEdge[yogaEdge.ordinal()]) {
            case 1:
                return this.arr[6];
            case 2:
                return this.arr[7];
    ...
    public float getLayoutPadding(YogaEdge yogaEdge) {
        ...
        if (fArr != null) {
            if ((((int) fArr[0]) & 2) == 2) {
                int r0 = 10 - ((((int) fArr[0]) & 1) != 1 ? 4 : 0);
                switch (C17451.$SwitchMap$com$facebook$yoga$YogaEdge[yogaEdge.ordinal()]) {
                    case 1:
                        return this.arr[r0];
                    case 2:
                        return this.arr[r0 + 1];
                    case 3:
                        return this.arr[r0 + 2];
                    case 4:
                        return this.arr[r0 + 3];
                    case 5:
                        if (getLayoutDirection() == YogaDirection.RTL) {
                            return this.arr[r0 + 2];
                        }
    ...
    public float getLayoutBorder(YogaEdge yogaEdge) {
        ...
        if (fArr != null) {
            if ((((int) fArr[0]) & 4) == 4) {
                int r2 = (14 - ((((int) fArr[0]) & 1) == 1 ? 0 : 4)) - ((((int) fArr[0]) & 2) != 2 ? 4 : 0);
                switch (C17451.$SwitchMap$com$facebook$yoga$YogaEdge[yogaEdge.ordinal()]) {
                    case 1:
                        return this.arr[r2];
                    case 2:
                        return this.arr[r2 + 1];
                    case 3:
                        return this.arr[r2 + 2];
                    case 4:
                        return this.arr[r2 + 3];
                    case 5:
                        if (getLayoutDirection() == YogaDirection.RTL) {
                            return this.arr[r2 + 2];
                        }
