...
public class HeifExifUtil {
    ...
    public static int getOrientation(final InputStream inputStream) {
        ...
        FLog.m1340d(TAG, "Trying to read Heif Exif information before Android N -> ignoring");
        return 0;
    }
    ...
    private static class HeifExifUtilAndroidN {
        ...
        static int getOrientation(final InputStream inputStream) {
            try {
                ...
                FLog.m1335d(HeifExifUtil.TAG, "Failed reading Heif Exif orientation -> ignoring", (Throwable) e);
                return 0;
            }
        }
    }
