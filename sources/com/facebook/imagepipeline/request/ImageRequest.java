...
public class ImageRequest {
    public static final InterfaceC1181Fn<ImageRequest, Uri> REQUEST_TO_URI_FN = new InterfaceC1181Fn<ImageRequest, Uri>() { // from class: com.facebook.imagepipeline.request.ImageRequest.1
        @Override // com.facebook.common.internal.InterfaceC1181Fn
        @Nullable
    ...
    public boolean equals(@Nullable Object o) {
        if (o instanceof ImageRequest) {
            ...
            if (sUseCachedHashcodeInEquals) {
                int r0 = this.mHashcode;
                int r2 = imageRequest.mHashcode;
                if (r0 != 0 && r2 != 0 && r0 != r2) {
                    return false;
                }
            }
