...
public class CloseableStaticBitmap extends CloseableBitmap implements HasBitmap {
    ...
    public CloseableStaticBitmap(Bitmap bitmap, ResourceReleaser<Bitmap> resourceReleaser, QualityInfo qualityInfo, int rotationAngle, int exifOrientation) {
        ...
        this.mBitmapReference = CloseableReference.m1272of(this.mBitmap, (ResourceReleaser) Preconditions.checkNotNull(resourceReleaser));
    ...
    public int getWidth() {
        int r0;
        if (this.mRotationAngle % RotationOptions.ROTATE_180 != 0 || (r0 = this.mExifOrientation) == 5 || r0 == 7) {
