...
public class ImagePipelineFactory {
    ...
    public static synchronized void initialize(ImagePipelineConfigInterface imagePipelineConfig, boolean forceSinglePipelineInstance) {
        synchronized (ImagePipelineFactory.class) {
            if (sInstance != null) {
                FLog.m1292w(TAG, "ImagePipelineFactory has already been initialized! `ImagePipelineFactory.initialize(...)` should only be called once to avoid unexpected behavior.");
            }
