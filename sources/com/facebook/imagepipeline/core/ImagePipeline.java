...
public class ImagePipeline {
    ...
    public boolean isInDiskCacheSync(final ImageRequest imageRequest) {
        CacheKey encodedCacheKey = this.mCacheKeyFactory.getEncodedCacheKey(imageRequest, null);
        int r3 = C13219.f154x9ce557aa[imageRequest.getCacheChoice().ordinal()];
        if (r3 != 1) {
            if (r3 != 2) {
                return false;
            }
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C13219 {
        ...
        static {
            int[] r0 = new int[ImageRequest.CacheChoice.values().length];
            f154x9ce557aa = r0;
            try {
                r0[ImageRequest.CacheChoice.DEFAULT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f154x9ce557aa[ImageRequest.CacheChoice.SMALL.ordinal()] = 2;
