...
public class ImagePipelineConfig implements ImagePipelineConfigInterface {
    ...
    private ImagePipelineConfig(Builder builder) {
        ...
        int r2 = builder.mHttpConnectionTimeout < 0 ? HttpUrlConnectionNetworkFetcher.HTTP_DEFAULT_TIMEOUT : builder.mHttpConnectionTimeout;
        this.mHttpNetworkTimeout = r2;
        if (FrescoSystrace.isTracing()) {
            FrescoSystrace.beginSection("ImagePipelineConfig->mNetworkFetcher");
        }
        this.mNetworkFetcher = builder.mNetworkFetcher == null ? new HttpUrlConnectionNetworkFetcher(r2) : builder.mNetworkFetcher;
        if (FrescoSystrace.isTracing()) {
