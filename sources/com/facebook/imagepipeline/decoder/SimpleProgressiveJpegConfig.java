...
public class SimpleProgressiveJpegConfig implements ProgressiveJpegConfig {
    ...
    public int getNextScanNumberToDecode(int scanNumber) {
        ...
        for (int r1 = 0; r1 < scansToDecode.size(); r1++) {
            if (scansToDecode.get(r1).intValue() > scanNumber) {
                return scansToDecode.get(r1).intValue();
            }
        }
    ...
    public QualityInfo getQualityInfo(int scanNumber) {
        return ImmutableQualityInfo.m1265of(scanNumber, scanNumber >= this.mDynamicValueConfig.getGoodEnoughScanNumber(), false);
    }
}
