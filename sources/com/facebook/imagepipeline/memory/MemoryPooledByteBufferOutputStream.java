...
public class MemoryPooledByteBufferOutputStream extends PooledByteBufferOutputStream {
    ...
    public MemoryPooledByteBufferOutputStream(MemoryChunkPool pool, int initialCapacity) {
        ...
        this.mCount = 0;
        this.mBufRef = CloseableReference.m1272of(memoryChunkPool.get(initialCapacity), memoryChunkPool);
    }
    ...
    void realloc(int newLength) {
        ...
        this.mBufRef.close();
        this.mBufRef = CloseableReference.m1272of(memoryChunk, this.mPool);
    }
