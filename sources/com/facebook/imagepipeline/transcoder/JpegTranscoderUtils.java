...
public class JpegTranscoderUtils {
    ...
    public static final ImmutableList<Integer> INVERTED_EXIF_ORIENTATIONS = ImmutableList.m1358of((Object[]) new Integer[]{2, 7, 4, 5});
    ...
    public static int getSoftwareNumerator(RotationOptions rotationOptions, @Nullable ResizeOptions resizeOptions, EncodedImage encodedImage, boolean resizingEnabled) {
        if (resizingEnabled && resizeOptions != null) {
            ...
            z = (rotationAngle == 90 || rotationAngle == 270 || forceRotatedInvertedExifOrientation == 5 || forceRotatedInvertedExifOrientation == 7) ? true : true;
