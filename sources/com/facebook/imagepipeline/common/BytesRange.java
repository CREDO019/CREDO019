...
public class BytesRange {
    ...
    public String toHttpRangeHeaderValue() {
        return String.format(null, "bytes=%s-%s", valueOrEmpty(this.from), valueOrEmpty(this.f153to));
    }

    public boolean contains(@Nullable BytesRange compare) {
        return compare != null && this.from <= compare.from && this.f153to >= compare.f153to;
    }

    public String toString() {
        return String.format(null, "%s-%s", valueOrEmpty(this.from), valueOrEmpty(this.f153to));
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof BytesRange) {
            ...
            return this.from == bytesRange.from && this.f153to == bytesRange.f153to;
        }
        return false;
    }
