...
public class ImageDecodeOptions {
    ...
    public int hashCode() {
        int r0 = (((((((((this.minDecodeIntervalMs * 31) + this.maxDimensionPx) * 31) + (this.decodePreviewFrame ? 1 : 0)) * 31) + (this.useLastFrameForPreview ? 1 : 0)) * 31) + (this.decodeAllFrames ? 1 : 0)) * 31) + (this.forceStaticImage ? 1 : 0);
        if (!this.excludeBitmapConfigFromComparison) {
            r0 = (r0 * 31) + this.bitmapConfig.ordinal();
        }
        if (!this.excludeBitmapConfigFromComparison) {
            int r02 = r0 * 31;
            Bitmap.Config config = this.animatedBitmapConfig;
            r0 = r02 + (config != null ? config.ordinal() : 0);
        }
        int r03 = r0 * 31;
        ImageDecoder imageDecoder = this.customImageDecoder;
        int hashCode = (r03 + (imageDecoder != null ? imageDecoder.hashCode() : 0)) * 31;
