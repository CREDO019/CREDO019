...
public class ReactDrawerLayoutManager extends ViewGroupManager<ReactDrawerLayout> implements AndroidDrawerLayoutManagerInterface<ReactDrawerLayout> {
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m1260of("openDrawer", 1, "closeDrawer", 2);
    }

    @Override // com.facebook.react.uimanager.ViewManager
    public void receiveCommand(ReactDrawerLayout reactDrawerLayout, int r2, ReadableArray readableArray) {
        if (r2 == 1) {
            reactDrawerLayout.openDrawer();
        } else if (r2 != 2) {
        } else {
    ...
    public Map getExportedViewConstants() {
        return MapBuilder.m1261of("DrawerPosition", MapBuilder.m1260of("Left", Integer.valueOf((int) GravityCompat.START), "Right", Integer.valueOf((int) GravityCompat.END)));
    }
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.m1258of(DrawerSlideEvent.EVENT_NAME, MapBuilder.m1261of("registrationName", "onDrawerSlide"), DrawerOpenedEvent.EVENT_NAME, MapBuilder.m1261of("registrationName", "onDrawerOpen"), DrawerClosedEvent.EVENT_NAME, MapBuilder.m1261of("registrationName", "onDrawerClose"), DrawerStateChangedEvent.EVENT_NAME, MapBuilder.m1261of("registrationName", "onDrawerStateChanged")));
        return exportedCustomDirectEventTypeConstants;
    }

    @Override // com.facebook.react.uimanager.ViewGroupManager
    public void addView(ReactDrawerLayout reactDrawerLayout, View view, int r5) {
        if (getChildCount(reactDrawerLayout) >= 2) {
            throw new JSApplicationIllegalArgumentException("The Drawer cannot have more than two children");
        }
        if (r5 != 0 && r5 != 1) {
            throw new JSApplicationIllegalArgumentException("The only valid indices for drawer's child are 0 or 1. Got " + r5 + " instead.");
        }
        reactDrawerLayout.addView(view, r5);
    ...
    public static class DrawerEventEmitter implements DrawerLayout.DrawerListener {
        ...
        public void onDrawerStateChanged(int r5) {
            this.mEventDispatcher.dispatchEvent(new DrawerStateChangedEvent(UIManagerHelper.getSurfaceId(this.mDrawerLayout), this.mDrawerLayout.getId(), r5));
        }
    }
}
