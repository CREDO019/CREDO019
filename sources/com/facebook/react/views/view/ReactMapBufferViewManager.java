...
public final class ReactMapBufferViewManager implements ReactViewManagerWrapper {
    ...
    public View createView(int r8, ThemedReactContext reactContext, Object obj, StateWrapper stateWrapper, JSResponderHandler jsResponderHandler) {
        ...
        ?? createView = viewManager.createView(r8, reactContext, obj instanceof ReactStylesDiffMap ? (ReactStylesDiffMap) obj : null, stateWrapper, jsResponderHandler);
    ...
    public void receiveCommand(View root, int r3, ReadableArray readableArray) {
        Intrinsics.checkNotNullParameter(root, "root");
        viewManager.receiveCommand((ReactViewGroup) root, r3, readableArray);
    }

    @Override // com.facebook.react.views.view.ReactViewManagerWrapper
    public void setPadding(View view, int r9, int r10, int r11, int r12) {
        Intrinsics.checkNotNullParameter(view, "view");
        viewManager.setPadding((ReactViewGroup) view, r9, r10, r11, r12);
    }
