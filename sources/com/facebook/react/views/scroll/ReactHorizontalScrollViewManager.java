...
public class ReactHorizontalScrollViewManager extends ViewGroupManager<ReactHorizontalScrollView> implements ReactScrollViewCommandHelper.ScrollCommandHandler<ReactHorizontalScrollView> {
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public void receiveCommand(ReactHorizontalScrollView reactHorizontalScrollView, int r2, ReadableArray readableArray) {
        ReactScrollViewCommandHelper.receiveCommand(this, reactHorizontalScrollView, r2, readableArray);
    }
    ...
    public void setBottomFillColor(ReactHorizontalScrollView reactHorizontalScrollView, int r2) {
        reactHorizontalScrollView.setEndFillColor(r2);
    }

    @ReactPropGroup(defaultFloat = Float.NaN, names = {ViewProps.BORDER_RADIUS, ViewProps.BORDER_TOP_LEFT_RADIUS, ViewProps.BORDER_TOP_RIGHT_RADIUS, ViewProps.BORDER_BOTTOM_RIGHT_RADIUS, ViewProps.BORDER_BOTTOM_LEFT_RADIUS})
    public void setBorderRadius(ReactHorizontalScrollView reactHorizontalScrollView, int r3, float f) {
        ...
        if (r3 == 0) {
            ...
            reactHorizontalScrollView.setBorderRadius(f, r3 - 1);
        }
    }
    ...
    public void setBorderWidth(ReactHorizontalScrollView reactHorizontalScrollView, int r3, float f) {
        if (!YogaConstants.isUndefined(f)) {
            f = PixelUtil.toPixelFromDIP(f);
        }
        reactHorizontalScrollView.setBorderWidth(SPACING_TYPES[r3], f);
    }

    @ReactPropGroup(customType = "Color", names = {ViewProps.BORDER_COLOR, ViewProps.BORDER_LEFT_COLOR, ViewProps.BORDER_RIGHT_COLOR, ViewProps.BORDER_TOP_COLOR, ViewProps.BORDER_BOTTOM_COLOR})
    public void setBorderColor(ReactHorizontalScrollView reactHorizontalScrollView, int r5, Integer num) {
        reactHorizontalScrollView.setBorderColor(SPACING_TYPES[r5], num == null ? Float.NaN : num.intValue() & ViewCompat.MEASURED_SIZE_MASK, num != null ? num.intValue() >>> 24 : Float.NaN);
    }
    ...
    public void setFadingEdgeLength(ReactHorizontalScrollView reactHorizontalScrollView, int r3) {
        if (r3 > 0) {
            reactHorizontalScrollView.setHorizontalFadingEdgeEnabled(true);
            reactHorizontalScrollView.setFadingEdgeLength(r3);
            return;
        }
    ...
    public void setScrollEventThrottle(ReactHorizontalScrollView reactHorizontalScrollView, int r2) {
        reactHorizontalScrollView.setScrollEventThrottle(r2);
    }
}
