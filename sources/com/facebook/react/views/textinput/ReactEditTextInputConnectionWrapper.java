...
class ReactEditTextInputConnectionWrapper extends InputConnectionWrapper {
    ...
    @Override // android.view.inputmethod.InputConnectionWrapper, android.view.inputmethod.InputConnection
    public boolean setComposingText(CharSequence charSequence, int r7) {
        int selectionStart = this.mEditText.getSelectionStart();
        int selectionEnd = this.mEditText.getSelectionEnd();
        boolean composingText = super.setComposingText(charSequence, r7);
        int selectionStart2 = this.mEditText.getSelectionStart();
        boolean z = false;
        dispatchKeyEventOrEnqueue((((selectionStart2 < selectionStart || selectionStart2 <= 0) ? true : true) || (!(selectionStart == selectionEnd) && (selectionStart2 == selectionStart))) ? BACKSPACE_KEY_VALUE : String.valueOf(this.mEditText.getText().charAt(selectionStart2 - 1)));
        return composingText;
    }

    @Override // android.view.inputmethod.InputConnectionWrapper, android.view.inputmethod.InputConnection
    public boolean commitText(CharSequence charSequence, int r5) {
