...
public class ReactImageView extends GenericDraweeView {
    ...
    public class TilePostprocessor extends BasePostprocessor {
        ...
        public CloseableReference<Bitmap> process(Bitmap bitmap, PlatformBitmapFactory platformBitmapFactory) {
            ...
            try {
                ...
                return createBitmap.mo1490clone();
            } finally {
    ...
    public void setShouldNotifyLoadEvents(boolean z) {
        ...
        if (!z) {
            ...
            this.mDownloadListener = new ReactImageDownloadListener<ImageInfo>() { // from class: com.facebook.react.views.image.ReactImageView.1
                ...
                public void onProgressChange(int r5, int r6) {
                    eventDispatcherForReactTag.dispatchEvent(ImageLoadEvent.createProgressEvent(UIManagerHelper.getSurfaceId(ReactImageView.this), ReactImageView.this.getId(), ReactImageView.this.mImageSource.getSource(), r5, r6));
                }
    ...
    public void setBackgroundColor(int r2) {
        if (this.mBackgroundColor != r2) {
            this.mBackgroundColor = r2;
            this.mBackgroundImageDrawable = new RoundedColorDrawable(r2);
            this.mIsDirty = true;
        }
    }

    public void setBorderColor(int r2) {
        if (this.mBorderColor != r2) {
            this.mBorderColor = r2;
            this.mIsDirty = true;
        }
    }

    public void setOverlayColor(int r2) {
        if (this.mOverlayColor != r2) {
            this.mOverlayColor = r2;
            this.mIsDirty = true;
        }
    }
    ...
    public void setBorderRadius(float f, int r4) {
        ...
        if (readableArray == null || readableArray.size() == 0) {
            ...
            if (readableArray.size() == 1) {
                ...
                for (int r4 = 0; r4 < readableArray.size(); r4++) {
                    ReadableMap map = readableArray.getMap(r4);
    ...
    public void setFadeDuration(int r1) {
        this.mFadeDurationMs = r1;
    }
            ...
            if (!hasMultipleSources() || (getWidth() > 0 && getHeight() > 0)) {
                ...
                if (!shouldResize || (getWidth() > 0 && getHeight() > 0)) {
                    if (!isTiled() || (getWidth() > 0 && getHeight() > 0)) {
                        ...
                        int r3 = this.mOverlayColor;
                        if (r3 != 0) {
                            roundingParams.setOverlayColor(r3);
                        } else {
                            roundingParams.setRoundingMethod(RoundingParams.RoundingMethod.BITMAP_ONLY);
                        }
                        hierarchy.setRoundingParams(roundingParams);
                        int r2 = this.mFadeDurationMs;
                        if (r2 < 0) {
                            r2 = this.mImageSource.isResource() ? 0 : 300;
                        }
                        hierarchy.setFadeDuration(r2);
