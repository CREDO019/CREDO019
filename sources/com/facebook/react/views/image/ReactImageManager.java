...
public class ReactImageManager extends SimpleViewManager<ReactImageView> {
    ...
    public void setBorderRadius(ReactImageView reactImageView, int r3, float f) {
        ...
        if (r3 == 0) {
            ...
            reactImageView.setBorderRadius(f, r3 - 1);
        }
    }
    ...
    public void setFadeDuration(ReactImageView reactImageView, int r2) {
        reactImageView.setFadeDuration(r2);
    }
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.m1257of(ImageLoadEvent.eventNameForType(4), MapBuilder.m1261of("registrationName", "onLoadStart"), ImageLoadEvent.eventNameForType(5), MapBuilder.m1261of("registrationName", "onProgress"), ImageLoadEvent.eventNameForType(2), MapBuilder.m1261of("registrationName", "onLoad"), ImageLoadEvent.eventNameForType(1), MapBuilder.m1261of("registrationName", "onError"), ImageLoadEvent.eventNameForType(3), MapBuilder.m1261of("registrationName", "onLoadEnd")));
