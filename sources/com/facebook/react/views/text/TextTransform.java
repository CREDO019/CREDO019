...
public enum TextTransform {
    ...
    static /* synthetic */ class C17221 {
        ...
        static {
            int[] r0 = new int[TextTransform.values().length];
            $SwitchMap$com$facebook$react$views$text$TextTransform = r0;
            try {
                r0[TextTransform.UPPERCASE.ordinal()] = 1;
    ...
    public static String apply(String str, TextTransform textTransform) {
        ...
        int r2 = C17221.$SwitchMap$com$facebook$react$views$text$TextTransform[textTransform.ordinal()];
        if (r2 != 1) {
            if (r2 != 2) {
                return r2 != 3 ? str : capitalize(str);
            }
    ...
    private static String capitalize(String str) {
        ...
        while (true) {
            ...
            if (first != -1) {
                String substring = str.substring(r3, first);
