...
public class ReactTextView extends AppCompatTextView implements ReactCompoundView {
    ...
    private static WritableMap inlineViewJson(int r4, int r5, int r6, int r7, int r8, int r9) {
        WritableMap createMap = Arguments.createMap();
        if (r4 == 8) {
            createMap.putString("visibility", "gone");
            createMap.putInt("index", r5);
        } else if (r4 == 0) {
            createMap.putString("visibility", ViewProps.VISIBLE);
            createMap.putInt("index", r5);
            createMap.putDouble("left", PixelUtil.toDIPFromPixel(r6));
            createMap.putDouble(ViewProps.TOP, PixelUtil.toDIPFromPixel(r7));
            createMap.putDouble("right", PixelUtil.toDIPFromPixel(r8));
            createMap.putDouble(ViewProps.BOTTOM, PixelUtil.toDIPFromPixel(r9));
        } else {
    ...
    */
    ...
    public void setText(ReactTextUpdate reactTextUpdate) {
        ...
        int r1 = this.mLinkifyMaskType;
        if (r1 > 0) {
            Linkify.addLinks(text, r1);
        ...
        if (paddingLeft != -1.0f && paddingBottom != -1.0f && paddingRight != -1.0f && r5 != 0) {
    ...
    public int reactTagForTouch(float f, float f2) {
        ...
        int lineForVertical = layout.getLineForVertical(r8);
        int lineLeft = (int) layout.getLineLeft(lineForVertical);
        int lineRight = (int) layout.getLineRight(lineForVertical);
        if ((text instanceof Spanned) && r7 >= lineLeft && r7 <= lineRight) {
            Spanned spanned = (Spanned) text;
            try {
                int offsetForHorizontal = layout.getOffsetForHorizontal(lineForVertical, r7);
                ...
                if (reactTagSpanArr != null) {
                    ...
                    for (int r2 = 0; r2 < reactTagSpanArr.length; r2++) {
                        int spanStart = spanned.getSpanStart(reactTagSpanArr[r2]);
                        int spanEnd = spanned.getSpanEnd(reactTagSpanArr[r2]);
                        if (spanEnd >= offsetForHorizontal && (r5 = spanEnd - spanStart) <= length) {
                            id = reactTagSpanArr[r2].getReactTag();
                            length = r5;
                        }
                    }
                }
            } catch (ArrayIndexOutOfBoundsException e) {
                FLog.m1328e(ReactConstants.TAG, "Crash in HorizontalMeasurementProvider: " + e.getMessage());
            }
        }
        return id;
    }
    ...
    void setGravityHorizontal(int r3) {
        if (r3 == 0) {
    ...
    public void setNumberOfLines(int r2) {
        if (r2 == 0) {
            r2 = Integer.MAX_VALUE;
        }
        this.mNumberOfLines = r2;
        setSingleLine(r2 == 1);
    ...
    public void setLinkifyMask(int r1) {
        this.mLinkifyMaskType = r1;
    }
