...
public class ReactModalHostManager extends ViewGroupManager<ReactModalHostView> implements ModalHostViewManagerInterface<ReactModalHostView> {
    ...
    public void setIdentifier(ReactModalHostView reactModalHostView, int r2) {
    }
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.builder().put(RequestCloseEvent.EVENT_NAME, MapBuilder.m1261of("registrationName", "onRequestClose")).put(ShowEvent.EVENT_NAME, MapBuilder.m1261of("registrationName", "onShow")).put("topDismiss", MapBuilder.m1261of("registrationName", "onDismiss")).put("topOrientationChange", MapBuilder.m1261of("registrationName", "onOrientationChange")).build());
