...
public class PreAllocateViewMountItem implements MountItem {
    ...
    public PreAllocateViewMountItem(int r1, int r2, String str, Object obj, StateWrapper stateWrapper, EventEmitterWrapper eventEmitterWrapper, boolean z) {
        this.mComponent = str;
        this.mSurfaceId = r1;
        this.mProps = obj;
    ...
    public void execute(MountingManager mountingManager) {
        ...
        if (surfaceManager == null) {
            ...
            FLog.m1328e(str, "Skipping View PreAllocation; no SurfaceMountingManager found for [" + this.mSurfaceId + "]");
            return;
        }
