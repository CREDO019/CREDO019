...
public class Binding {
    ...
    public native void renderTemplateToSurface(int r1, String str);

    public native void setConstraints(int r1, float f, float f2, float f3, float f4, float f5, float f6, boolean z, boolean z2);

    public native void setPixelDensity(float f);

    public native void startSurface(int r1, String str, NativeMap nativeMap);

    public native void startSurfaceWithConstraints(int r1, String str, NativeMap nativeMap, float f, float f2, float f3, float f4, float f5, float f6, boolean z, boolean z2);

    public native void stopSurface(int r1);
