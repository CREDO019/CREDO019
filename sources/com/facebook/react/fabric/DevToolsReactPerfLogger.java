...
public class DevToolsReactPerfLogger implements ReactMarker.FabricMarkerListener {
    ...
    public static class FabricCommitPoint {
        ...
        private FabricCommitPoint(int r3) {
            this.mPoints = new HashMap();
            this.mCommitNumber = r3;
        }
    ...
    public void logFabricMarker(ReactMarkerConstants reactMarkerConstants, String str, int r5, long j) {
        if (isFabricCommitMarker(reactMarkerConstants)) {
            FabricCommitPoint fabricCommitPoint = this.mFabricCommitMarkers.get(Integer.valueOf(r5));
            if (fabricCommitPoint == null) {
                fabricCommitPoint = new FabricCommitPoint(r5);
                this.mFabricCommitMarkers.put(Integer.valueOf(r5), fabricCommitPoint);
            }
            ...
            if (reactMarkerConstants == ReactMarkerConstants.FABRIC_BATCH_EXECUTION_END) {
                ...
                this.mFabricCommitMarkers.remove(Integer.valueOf(r5));
            }
        }
    }
