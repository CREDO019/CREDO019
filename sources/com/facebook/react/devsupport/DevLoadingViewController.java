...
public class DevLoadingViewController {
    ...
    public void showForUrl(String str) {
        ...
        try {
            ...
            int r2 = C1413R.string.catalyst_loading_from_url;
            showMessage(context.getString(r2, url.getHost() + ParameterizedMessage.ERROR_MSG_SEPARATOR + port));
        } catch (MalformedURLException e) {
            FLog.m1328e(ReactConstants.TAG, "Bundle url format is invalid. \n\n" + e.toString());
        }
    }
    ...
    public void showForRemoteJSEnabled() {
        ...
        showMessage(context.getString(C1413R.string.catalyst_debug_connecting));
    }
    ...
    public void showInternal(String str) {
        ...
        if (popupWindow == null || !popupWindow.isShowing()) {
            ...
            if (currentActivity == null) {
                FLog.m1328e(ReactConstants.TAG, "Unable to display loading message because react activity isn't available");
                return;
            }
            Rect rect = new Rect();
            currentActivity.getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
            int r1 = rect.top;
            TextView textView = (TextView) ((LayoutInflater) currentActivity.getSystemService("layout_inflater")).inflate(C1413R.layout.dev_loading_view, (ViewGroup) null);
            ...
            this.mDevLoadingPopup.showAtLocation(currentActivity.getWindow().getDecorView(), 0, 0, r1);
        }
    }
