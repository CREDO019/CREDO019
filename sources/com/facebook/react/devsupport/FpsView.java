...
public class FpsView extends FrameLayout {
    ...
    public FpsView(ReactContext reactContext) {
        super(reactContext);
        inflate(reactContext, C1413R.layout.fps_view, this);
        this.mTextView = (TextView) findViewById(C1413R.C1417id.fps_text);
    ...
    public void setCurrentFPS(double d, double d2, int r7, int r8) {
        String format = String.format(Locale.US, "UI: %.1f fps\n%d dropped so far\n%d stutters (4+) so far\nJS: %.1f fps", Double.valueOf(d), Integer.valueOf(r7), Integer.valueOf(r8), Double.valueOf(d2));
        this.mTextView.setText(format);
        FLog.m1340d(ReactConstants.TAG, format);
    }
