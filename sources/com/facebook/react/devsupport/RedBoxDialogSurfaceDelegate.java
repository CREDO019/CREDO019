...
public class RedBoxDialogSurfaceDelegate implements SurfaceDelegate {
    ...
    public void createContentView(String str) {
        ...
        if (currentActivity == null || currentActivity.isFinishing()) {
            ...
            FLog.m1328e(ReactConstants.TAG, sb.toString());
            return;
        }
    ...
    public void show() {
        ...
        if (this.mDialog == null) {
            Dialog dialog = new Dialog(currentActivity, C1413R.C1420style.Theme_Catalyst_RedBox) { // from class: com.facebook.react.devsupport.RedBoxDialogSurfaceDelegate.1
                @Override // android.app.Dialog, android.view.KeyEvent.Callback
                public boolean onKeyUp(int r3, KeyEvent keyEvent) {
                    if (r3 == 82) {
                        RedBoxDialogSurfaceDelegate.this.mDevSupportManager.showDevOptionsDialog();
                        return true;
                    }
                    if (RedBoxDialogSurfaceDelegate.this.mDoubleTapReloadRecognizer.didDoubleTapR(r3, getCurrentFocus())) {
