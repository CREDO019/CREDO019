...
public final class BridgeDevSupportManager extends DevSupportManagerBase {
    ...
    public BridgeDevSupportManager(Context context, ReactInstanceDevHelper reactInstanceDevHelper, String str, boolean z, RedBoxHandler redBoxHandler, DevBundleDownloadListener devBundleDownloadListener, int r7, Map<String, RequestHandler> map, SurfaceDelegateFactory surfaceDelegateFactory) {
        super(context, reactInstanceDevHelper, str, z, redBoxHandler, devBundleDownloadListener, r7, map, surfaceDelegateFactory);
        String string;
        ...
        if (getDevSettings().isRemoteJSDebugEnabled()) {
            string = context.getString(C1413R.string.catalyst_debug_stop);
        } else {
            string = context.getString(C1413R.string.catalyst_debug);
        }
    ...
    public WebsocketJavaScriptExecutor.JSExecutorConnectCallback getExecutorConnectCallback(final SimpleSettableFuture<Boolean> simpleSettableFuture) {
        return new WebsocketJavaScriptExecutor.JSExecutorConnectCallback() { // from class: com.facebook.react.devsupport.BridgeDevSupportManager.4
            ...
            public void onFailure(Throwable th) {
                BridgeDevSupportManager.this.hideDevLoadingView();
                FLog.m1327e(ReactConstants.TAG, "Failed to connect to debugger!", th);
                simpleSettableFuture.setException(new IOException(BridgeDevSupportManager.this.getApplicationContext().getString(C1413R.string.catalyst_debug_error), th));
            }
        };
    }
    ...
    public void toggleJSSamplingProfiler() {
        ...
        try {
            ...
            try {
                ...
                FLog.m1328e(ReactConstants.TAG, "Could not create temporary file for saving results from Sampling Profiler");
