...
public class DebugServerException extends RuntimeException {
    ...
    private DebugServerException(String str, String str2, int r5, int r6) {
        super(str + "\n  at " + str2 + ParameterizedMessage.ERROR_MSG_SEPARATOR + r5 + ParameterizedMessage.ERROR_MSG_SEPARATOR + r6);
    ...
    public static DebugServerException parse(String str, String str2) {
        ...
        try {
            ...
            return new DebugServerException(jSONObject.getString(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE), shortenFileName(jSONObject.getString("filename")), jSONObject.getInt("lineNumber"), jSONObject.getInt("column"));
        } catch (JSONException e) {
            FLog.m1287w(ReactConstants.TAG, "Could not parse DebugServerException from: " + str2, e);
            return null;
        }
    }
