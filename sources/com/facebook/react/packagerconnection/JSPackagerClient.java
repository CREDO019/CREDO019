...
public final class JSPackagerClient implements ReconnectingWebSocket.MessageCallback {
    ...
    public class ResponderImpl implements Responder {
        ...
        public void respond(Object obj) {
            try {
                ...
                jSONObject.put(Constants.AMP_PLAN_VERSION, 2);
                jSONObject.put("id", this.mId);
                jSONObject.put("result", obj);
                JSPackagerClient.this.mWebSocket.sendMessage(jSONObject.toString());
            } catch (Exception e) {
                FLog.m1327e(JSPackagerClient.TAG, "Responding failed", e);
            }
        }
        ...
        public void error(Object obj) {
            try {
                ...
                FLog.m1327e(JSPackagerClient.TAG, "Responding with error failed", e);
            }
        }
    }
    ...
    public void onMessage(String str) {
        try {
            ...
            int optInt = jSONObject.optInt(Constants.AMP_PLAN_VERSION);
            String optString = jSONObject.optString("method");
            Object opt = jSONObject.opt("id");
            Object opt2 = jSONObject.opt(OutcomeEventsTable.COLUMN_NAME_PARAMS);
            if (optInt != 2) {
                String str2 = TAG;
                FLog.m1328e(str2, "Message with incompatible or missing version of protocol received: " + optInt);
            ...
            FLog.m1327e(TAG, "Handling the message failed", e);
        }
    }

    @Override // com.facebook.react.packagerconnection.ReconnectingWebSocket.MessageCallback
    public void onMessage(ByteString byteString) {
        FLog.m1288w(TAG, "Websocket received message with payload of unexpected type binary");
    }
    ...
    private void abortOnMessage(Object obj, String str) {
        ...
        String str2 = TAG;
        FLog.m1328e(str2, "Handling the message failed with reason: " + str);
    }
}
