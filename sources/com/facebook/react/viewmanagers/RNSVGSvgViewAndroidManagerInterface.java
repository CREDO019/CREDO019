...
public interface RNSVGSvgViewAndroidManagerInterface<T extends View> {
    ...
    void setMeetOrSlice(T t, int r2);
    ...
    void setNextFocusDown(T t, int r2);

    void setNextFocusForward(T t, int r2);

    void setNextFocusLeft(T t, int r2);

    void setNextFocusRight(T t, int r2);

    void setNextFocusUp(T t, int r2);
