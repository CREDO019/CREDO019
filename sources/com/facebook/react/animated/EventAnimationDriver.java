...
class EventAnimationDriver implements RCTEventEmitter {
    ...
    public void receiveEvent(int r6, String str, WritableMap writableMap) {
        List<String> list;
        ReadableArray array;
        if (writableMap == null) {
        ...
        for (int r62 = 0; r62 < this.mEventPath.size() - 1; r62++) {
            if (writableMap != null) {
                String str2 = this.mEventPath.get(r62);
                ...
                int parseInt = Integer.parseInt(this.mEventPath.get(r62));
