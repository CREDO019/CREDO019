...
public class AndroidInfoHelpers {
    ...
    private static Integer getDevServerPort(Context context) {
        return Integer.valueOf(context.getResources().getInteger(C1413R.integer.react_native_dev_server_port));
    }
    ...
    private static String getServerIpAddress(int r4) {
        ...
        return String.format(Locale.US, "%s:%d", metroHostPropValue2, Integer.valueOf(r4));
    }
    ...
    */
    private static synchronized java.lang.String getMetroHostPropValue() {
        ...
        L5a:
            ...
            com.facebook.common.logging.FLog.m1287w(r4, r5, r1)     // Catch: java.lang.Throwable -> L73
            java.lang.String r1 = ""
