...
public class DialogModule extends NativeDialogManagerAndroidSpec implements LifecycleEventListener {
    ...
    static final Map<String, Object> CONSTANTS = MapBuilder.m1257of(ACTION_BUTTON_CLICKED, ACTION_BUTTON_CLICKED, "dismissed", "dismissed", KEY_BUTTON_POSITIVE, -1, KEY_BUTTON_NEGATIVE, -2, KEY_BUTTON_NEUTRAL, -3);
    ...
    public class AlertFragmentListener implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
        ...
        public void onClick(DialogInterface dialogInterface, int r5) {
            ...
            this.mCallback.invoke(DialogModule.ACTION_BUTTON_CLICKED, Integer.valueOf(r5));
    ...
    public void onHostResume() {
        ...
        if (fragmentManagerHelper != null) {
            ...
            FLog.m1292w(DialogModule.class, "onHostResume called but no FragmentManager found");
        }
    }
    ...
    public void showAlert(ReadableMap readableMap, Callback callback, final Callback callback2) {
        ...
        if (readableMap.hasKey(KEY_ITEMS)) {
            ...
            for (int r1 = 0; r1 < array.size(); r1++) {
                charSequenceArr[r1] = array.getString(r1);
            }
