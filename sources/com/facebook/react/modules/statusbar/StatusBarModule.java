...
public class StatusBarModule extends NativeStatusBarManagerAndroidSpec {
    ...
    public void setColor(double d, final boolean z) {
        ...
        if (currentActivity == null) {
            FLog.m1288w(ReactConstants.TAG, "StatusBarModule: Ignored status bar change, current activity is null.");
        } else {
            UiThreadUtil.runOnUiThread(new GuardedRunnable(getReactApplicationContext()) { // from class: com.facebook.react.modules.statusbar.StatusBarModule.1
                ...
                public void runGuarded() {
                    ...
                    if (z) {
                        ValueAnimator ofObject = ValueAnimator.ofObject(new ArgbEvaluator(), Integer.valueOf(currentActivity.getWindow().getStatusBarColor()), Integer.valueOf(r5));
                    ...
                    currentActivity.getWindow().setStatusBarColor(r5);
                }
            });
        }
    }
