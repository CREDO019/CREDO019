...
public class ForwardingCookieHandler extends CookieHandler {
    ...
    public Map<String, List<String>> get(URI r1, Map<String, List<String>> map) throws IOException {
        CookieManager cookieManager = getCookieManager();
        if (cookieManager == null) {
            return Collections.emptyMap();
        }
        String cookie = cookieManager.getCookie(r1.toString());
    ...
    @Override // java.net.CookieHandler
    public void put(URI r3, Map<String, List<String>> map) throws IOException {
        String str = r3.toString();
        for (Map.Entry<String, List<String>> entry : map.entrySet()) {
            String key = entry.getKey();
            if (key != null && isCookieHeader(key)) {
                addCookies(str, entry.getValue());
            }
        }
    }
