...
public class OkHttpClientProvider {
    ...
    public static OkHttpClient.Builder createClientBuilder(Context context, int r5) {
        OkHttpClient.Builder createClientBuilder = createClientBuilder();
        return r5 == 0 ? createClientBuilder : createClientBuilder.cache(new Cache(new File(context.getCacheDir(), "http-cache"), r5));
    }
}
