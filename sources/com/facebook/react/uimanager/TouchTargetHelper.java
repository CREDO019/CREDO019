...
public class TouchTargetHelper {
    ...
    public static int findTargetTagForTouch(float f, float f2, ViewGroup viewGroup, int[] r4) {
        return findTargetTagAndCoordinatesForTouch(f, f2, viewGroup, mEventCoords, r4);
    }

    public static int findTargetTagAndCoordinatesForTouch(float f, float f2, ViewGroup viewGroup, float[] fArr, int[] r6) {
        ...
        if (r6 != null) {
            r6[0] = findClosestReactAncestor.getId();
        }
    ...
    public static List<ViewTarget> findTargetPathAndCoordinatesForTouch(float f, float f2, ViewGroup viewGroup, float[] fArr) {
        ...
        if (findTouchTargetViewWithPointerEvents != null) {
            ...
            if (r6 > 0) {
                arrayList = arrayList.subList(r6, arrayList.size());
            }
    ...
    private static View findTouchTargetView(float[] fArr, View view, EnumSet<TouchTargetReturnType> enumSet, List<ViewTarget> list) {
        if (enumSet.contains(TouchTargetReturnType.CHILD) && (view instanceof ViewGroup)) {
            ...
            for (int r4 = childCount - 1; r4 >= 0; r4--) {
                View childAt = viewGroup.getChildAt(reactZIndexedViewGroup != null ? reactZIndexedViewGroup.getZIndexMappedChildIndex(r4) : r4);
    ...
    public static class ViewTarget {
        ...
        private ViewTarget(int r1, View view) {
            this.mViewId = r1;
            this.mView = view;
        }
