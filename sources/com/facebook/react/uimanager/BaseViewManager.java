...
public abstract class BaseViewManager<T extends View, C extends LayoutShadowNode> extends ViewManager<T, C> implements BaseViewManagerInterface<T> {
    ...
    static {
        ...
        hashMap.put(STATE_BUSY, Integer.valueOf(C1413R.string.state_busy_description));
        hashMap.put(STATE_EXPANDED, Integer.valueOf(C1413R.string.state_expanded_description));
        hashMap.put("collapsed", Integer.valueOf(C1413R.string.state_collapsed_description));
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.facebook.react.uimanager.ViewManager
    public T prepareToRecycleView(ThemedReactContext themedReactContext, T t) {
        t.setTag(C1413R.C1417id.pointer_enter, null);
        t.setTag(C1413R.C1417id.pointer_leave, null);
        t.setTag(C1413R.C1417id.pointer_move, null);
        t.setTag(C1413R.C1417id.react_test_id, null);
        t.setTag(C1413R.C1417id.view_tag_native_id, null);
        t.setTag(C1413R.C1417id.labelled_by, null);
        t.setTag(C1413R.C1417id.accessibility_label, null);
        t.setTag(C1413R.C1417id.accessibility_hint, null);
        t.setTag(C1413R.C1417id.accessibility_role, null);
        t.setTag(C1413R.C1417id.accessibility_state, null);
        t.setTag(C1413R.C1417id.accessibility_actions, null);
        t.setTag(C1413R.C1417id.accessibility_value, null);
        setTransform(t, null);
        t.setPivotX(0.0f);
        t.setPivotY(0.0f);
        t.setTop(0);
    ...
    public void setBackgroundColor(T t, int r2) {
        t.setBackgroundColor(r2);
    }
    ...
    public void setShadowColor(T t, int r4) {
        if (Build.VERSION.SDK_INT >= 28) {
            t.setOutlineAmbientShadowColor(r4);
            t.setOutlineSpotShadowColor(r4);
        }
    }
    ...
    public void setTestId(T t, String str) {
        t.setTag(C1413R.C1417id.react_test_id, str);
        t.setTag(str);
    }
    ...
    public void setNativeId(T t, String str) {
        t.setTag(C1413R.C1417id.view_tag_native_id, str);
    ...
    public void setAccessibilityLabelledBy(T t, Dynamic dynamic) {
        ...
        if (dynamic.getType() == ReadableType.String) {
            t.setTag(C1413R.C1417id.labelled_by, dynamic.asString());
        } else if (dynamic.getType() == ReadableType.Array) {
            t.setTag(C1413R.C1417id.labelled_by, dynamic.asArray().getString(0));
        }
    }
    ...
    public void setAccessibilityLabel(T t, String str) {
        t.setTag(C1413R.C1417id.accessibility_label, str);
    ...
    public void setAccessibilityHint(T t, String str) {
        t.setTag(C1413R.C1417id.accessibility_hint, str);
        updateViewContentDescription(t);
    }
    ...
    public void setAccessibilityRole(T t, String str) {
        ...
        t.setTag(C1413R.C1417id.accessibility_role, ReactAccessibilityDelegate.AccessibilityRole.fromValue(str));
    }

    @Override // com.facebook.react.uimanager.BaseViewManagerInterface
    @ReactProp(name = ViewProps.ACCESSIBILITY_COLLECTION)
    public void setAccessibilityCollection(T t, ReadableMap readableMap) {
        t.setTag(C1413R.C1417id.accessibility_collection, readableMap);
    }
    ...
    public void setAccessibilityCollectionItem(T t, ReadableMap readableMap) {
        t.setTag(C1413R.C1417id.accessibility_collection_item, readableMap);
    }
    ...
    public void setViewState(T t, ReadableMap readableMap) {
        ...
        if (readableMap.hasKey("selected")) {
            ...
            if (t.isAccessibilityFocused() && isSelected && !z) {
                t.announceForAccessibility(t.getContext().getString(C1413R.string.state_unselected_description));
            }
        } else {
            t.setSelected(false);
        }
        t.setTag(C1413R.C1417id.accessibility_state, readableMap);
    ...
    private void updateViewContentDescription(T t) {
        Dynamic dynamic;
        int r6;
        String str = (String) t.getTag(C1413R.C1417id.accessibility_label);
        ReadableMap readableMap = (ReadableMap) t.getTag(C1413R.C1417id.accessibility_state);
        String str2 = (String) t.getTag(C1413R.C1417id.accessibility_hint);
        ArrayList arrayList = new ArrayList();
        ReadableMap readableMap2 = (ReadableMap) t.getTag(C1413R.C1417id.accessibility_value);
        if (str != null) {
            arrayList.add(str);
        }
        if (readableMap != null) {
            ...
            while (keySetIterator.hasNextKey()) {
                ...
                if (nextKey.equals(STATE_CHECKED) && dynamic2.getType() == ReadableType.String && dynamic2.asString().equals(STATE_MIXED)) {
                    arrayList.add(t.getContext().getString(C1413R.string.state_mixed_description));
                } else if (nextKey.equals(STATE_BUSY) && dynamic2.getType() == ReadableType.Boolean && dynamic2.asBoolean()) {
                    arrayList.add(t.getContext().getString(C1413R.string.state_busy_description));
                } else if (nextKey.equals(STATE_EXPANDED) && dynamic2.getType() == ReadableType.Boolean) {
                    Context context = t.getContext();
                    if (dynamic2.asBoolean()) {
                        r6 = C1413R.string.state_expanded_description;
                    } else {
                        r6 = C1413R.string.state_collapsed_description;
                    }
                    arrayList.add(context.getString(r6));
                }
            }
        }
    ...
    public void setAccessibilityActions(T t, ReadableArray readableArray) {
        ...
        t.setTag(C1413R.C1417id.accessibility_actions, readableArray);
    }
    ...
    public void setAccessibilityValue(T t, ReadableMap readableMap) {
        ...
        t.setTag(C1413R.C1417id.accessibility_value, readableMap);
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.builder().put(PointerEventHelper.POINTER_CANCEL, MapBuilder.m1261of("phasedRegistrationNames", MapBuilder.m1260of("bubbled", "onPointerCancel", "captured", "onPointerCancelCapture"))).put(PointerEventHelper.POINTER_DOWN, MapBuilder.m1261of("phasedRegistrationNames", MapBuilder.m1260of("bubbled", "onPointerDown", "captured", "onPointerDownCapture"))).put(PointerEventHelper.POINTER_ENTER, MapBuilder.m1261of("phasedRegistrationNames", MapBuilder.m1259of("bubbled", "onPointerEnter", "captured", "onPointerEnterCapture", "skipBubbling", true))).put(PointerEventHelper.POINTER_LEAVE, MapBuilder.m1261of("phasedRegistrationNames", MapBuilder.m1259of("bubbled", "onPointerLeave", "captured", "onPointerLeaveCapture", "skipBubbling", true))).put(PointerEventHelper.POINTER_MOVE, MapBuilder.m1261of("phasedRegistrationNames", MapBuilder.m1260of("bubbled", "onPointerMove", "captured", "onPointerMoveCapture"))).put(PointerEventHelper.POINTER_UP, MapBuilder.m1261of("phasedRegistrationNames", MapBuilder.m1260of("bubbled", "onPointerUp", "captured", "onPointerUpCapture"))).build());
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.builder().put(ReactAccessibilityDelegate.TOP_ACCESSIBILITY_ACTION_EVENT, MapBuilder.m1261of("registrationName", "onAccessibilityAction")).build());
        return exportedCustomDirectEventTypeConstants;
    }
    ...
    private void logUnsupportedPropertyWarning(String str) {
        FLog.m1286w(ReactConstants.TAG, "%s doesn't support property '%s'", getName(), str);
    }

    @ReactProp(name = "onPointerEnter")
    public void setPointerEnter(T t, boolean z) {
        t.setTag(C1413R.C1417id.pointer_enter, Boolean.valueOf(z));
    }

    @ReactProp(name = "onPointerEnterCapture")
    public void setPointerEnterCapture(T t, boolean z) {
        t.setTag(C1413R.C1417id.pointer_enter_capture, Boolean.valueOf(z));
    }

    @ReactProp(name = "onPointerLeave")
    public void setPointerLeave(T t, boolean z) {
        t.setTag(C1413R.C1417id.pointer_leave, Boolean.valueOf(z));
    }

    @ReactProp(name = "onPointerLeaveCapture")
    public void setPointerLeaveCapture(T t, boolean z) {
        t.setTag(C1413R.C1417id.pointer_leave_capture, Boolean.valueOf(z));
    }

    @ReactProp(name = "onPointerMove")
    public void setPointerMove(T t, boolean z) {
        t.setTag(C1413R.C1417id.pointer_move, Boolean.valueOf(z));
    }

    @ReactProp(name = "onPointerMoveCapture")
    public void setPointerMoveCapture(T t, boolean z) {
        t.setTag(C1413R.C1417id.pointer_move_capture, Boolean.valueOf(z));
    }
}
