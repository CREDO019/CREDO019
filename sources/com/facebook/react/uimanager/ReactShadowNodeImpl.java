...
public class ReactShadowNodeImpl implements ReactShadowNode<ReactShadowNodeImpl> {
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void addChildAt(ReactShadowNodeImpl reactShadowNodeImpl, int r4) {
        if (this.mChildren == null) {
            this.mChildren = new ArrayList<>(4);
        }
        this.mChildren.add(r4, reactShadowNodeImpl);
        ...
        if (this.mYogaNode != null && !isYogaLeafNode()) {
            ...
            this.mYogaNode.addChildAt(yogaNode, r4);
        }
        markUpdated();
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public ReactShadowNodeImpl removeChildAt(int r4) {
        ArrayList<ReactShadowNodeImpl> arrayList = this.mChildren;
        if (arrayList == null) {
            throw new ArrayIndexOutOfBoundsException("Index " + r4 + " out of bounds: node has no children");
        }
        ReactShadowNodeImpl remove = arrayList.remove(r4);
        remove.mParent = null;
        if (this.mYogaNode != null && !isYogaLeafNode()) {
            this.mYogaNode.removeChildAt(r4);
        }
        markUpdated();
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public final ReactShadowNodeImpl getChildAt(int r4) {
        ArrayList<ReactShadowNodeImpl> arrayList = this.mChildren;
        if (arrayList == null) {
            throw new ArrayIndexOutOfBoundsException("Index " + r4 + " out of bounds: node has no children");
        }
    ...
    public void removeAndDisposeAllChildren() {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            r0 += childAt.getTotalNativeNodeContributionToParent();
            childAt.dispose();
        }
        ((ArrayList) Assertions.assertNotNull(this.mChildren)).clear();
        markUpdated();
        this.mTotalNativeChildren -= r0;
        updateNativeChildrenCountInParent(-r0);
    }

    private void updateNativeChildrenCountInParent(int r4) {
        if (getNativeKind() != NativeKind.PARENT) {
            for (ReactShadowNodeImpl parent = getParent(); parent != null; parent = parent.getParent()) {
                parent.mTotalNativeChildren += r4;
    ...
    public boolean dispatchUpdates(float f, float f2, UIViewOperationQueue uIViewOperationQueue, NativeViewHierarchyOptimizer nativeViewHierarchyOptimizer) {
        ...
        if (hasNewLayout()) {
            ...
            int r10 = round3 - round;
            int r11 = round4 - round2;
            z = (round5 == this.mScreenX && round6 == this.mScreenY && r10 == this.mScreenWidth && r11 == this.mScreenHeight) ? true : true;
            this.mScreenX = round5;
            this.mScreenY = round6;
            this.mScreenWidth = r10;
            this.mScreenHeight = r11;
            if (z) {
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setReactTag(int r1) {
        this.mReactTag = r1;
    }
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public final void setRootTag(int r1) {
        this.mRootTag = r1;
    }
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public final void addNativeChildAt(ReactShadowNodeImpl reactShadowNodeImpl, int r6) {
        ...
        this.mNativeChildren.add(r6, reactShadowNodeImpl);
        reactShadowNodeImpl.mNativeParent = this;
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public final ReactShadowNodeImpl removeNativeChildAt(int r2) {
        Assertions.assertNotNull(this.mNativeChildren);
        ReactShadowNodeImpl remove = this.mNativeChildren.remove(r2);
    ...
    public final int getNativeOffsetForChild(ReactShadowNodeImpl reactShadowNodeImpl) {
        ...
        while (true) {
            ...
            ReactShadowNodeImpl childAt = getChildAt(r1);
            if (reactShadowNodeImpl == childAt) {
                z = true;
                break;
            }
            r2 += childAt.getTotalNativeNodeContributionToParent();
            r1++;
        }
        if (z) {
            return r2;
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setMargin(int r2, float f) {
        this.mYogaNode.setMargin(YogaEdge.fromInt(r2), f);
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setMarginPercent(int r2, float f) {
        this.mYogaNode.setMarginPercent(YogaEdge.fromInt(r2), f);
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setMarginAuto(int r2) {
        this.mYogaNode.setMarginAuto(YogaEdge.fromInt(r2));
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public final float getPadding(int r2) {
        return this.mYogaNode.getLayoutPadding(YogaEdge.fromInt(r2));
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public final YogaValue getStylePadding(int r2) {
        return this.mYogaNode.getPadding(YogaEdge.fromInt(r2));
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setDefaultPadding(int r2, float f) {
        this.mDefaultPadding.set(r2, f);
        updatePadding();
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setPadding(int r2, float f) {
        this.mPadding[r2] = f;
        this.mPaddingIsPercent[r2] = false;
        updatePadding();
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setPaddingPercent(int r2, float f) {
        this.mPadding[r2] = f;
        this.mPaddingIsPercent[r2] = !YogaConstants.isUndefined(f);
        updatePadding();
    }
    ...
    */
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setBorder(int r2, float f) {
        this.mYogaNode.setBorder(YogaEdge.fromInt(r2), f);
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setPosition(int r2, float f) {
        this.mYogaNode.setPosition(YogaEdge.fromInt(r2), f);
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setPositionPercent(int r2, float f) {
        this.mYogaNode.setPositionPercent(YogaEdge.fromInt(r2), f);
    }
    ...
    private void getHierarchyInfoWithIndentation(StringBuilder sb, int r5) {
        ...
        for (int r0 = 0; r0 < getChildCount(); r0++) {
            getChildAt(r0).getHierarchyInfoWithIndentation(sb, r5 + 1);
        }
    }
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setMeasureSpecs(int r1, int r2) {
        this.mWidthMeasureSpec = Integer.valueOf(r1);
        this.mHeightMeasureSpec = Integer.valueOf(r2);
    }
