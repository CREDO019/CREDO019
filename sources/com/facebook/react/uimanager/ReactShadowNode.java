...
public interface ReactShadowNode<T extends ReactShadowNode> {
    void addChildAt(T t, int r2);

    void addNativeChildAt(T t, int r2);
    ...
    YogaValue getStylePadding(int r1);
    ...
    T removeChildAt(int r1);

    T removeNativeChildAt(int r1);
    ...
    void setBorder(int r1, float f);

    void setDefaultPadding(int r1, float f);
    ...
    void setMargin(int r1, float f);

    void setMarginAuto(int r1);

    void setMarginPercent(int r1, float f);

    void setMeasureFunction(YogaMeasureFunction yogaMeasureFunction);

    void setMeasureSpecs(int r1, int r2);

    void setOverflow(YogaOverflow yogaOverflow);

    void setPadding(int r1, float f);

    void setPaddingPercent(int r1, float f);

    void setPosition(int r1, float f);

    void setPositionPercent(int r1, float f);

    void setPositionType(YogaPositionType yogaPositionType);

    void setReactTag(int r1);

    void setRootTag(int r1);
