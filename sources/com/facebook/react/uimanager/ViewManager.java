...
public abstract class ViewManager<T extends View, C extends ReactShadowNode> extends BaseJavaModule {
    ...
    @Deprecated
    public void receiveCommand(T t, int r2, ReadableArray readableArray) {
    }
    ...
    public void setPadding(T t, int r2, int r3, int r4, int r5) {
    }
    ...
    protected void setupViewRecycling(int r1) {
        this.mRecyclableViewsBufferSize = r1;
        setupViewRecycling();
    }

    private Stack<T> getRecyclableViewStack(int r4) {
        HashMap<Integer, Stack<T>> hashMap = this.mRecyclableViews;
        if (hashMap == null) {
            return null;
        }
        if (!hashMap.containsKey(Integer.valueOf(r4))) {
            this.mRecyclableViews.put(Integer.valueOf(r4), new Stack<>());
        }
        return this.mRecyclableViews.get(Integer.valueOf(r4));
    }
    ...
    public T createView(int r1, ThemedReactContext themedReactContext, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper, JSResponderHandler jSResponderHandler) {
        T createViewInstance = createViewInstance(r1, themedReactContext, reactStylesDiffMap, stateWrapper);
    ...
    protected T createViewInstance(int r3, ThemedReactContext themedReactContext, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper) {
    ...
    public void onDropViewInstance(T t) {
        ...
        if (context == null) {
            String str = NAME;
            FLog.m1328e(str, "onDropViewInstance: view [" + t.getId() + "] has a null context");
        } else if (!(context instanceof ThemedReactContext)) {
            String str2 = NAME;
            FLog.m1328e(str2, "onDropViewInstance: view [" + t.getId() + "] has a context that is not a ThemedReactContext: " + context);
        } else {
    ...
    public void onSurfaceStopped(int r2) {
        HashMap<Integer, Stack<T>> hashMap = this.mRecyclableViews;
        if (hashMap != null) {
            hashMap.remove(Integer.valueOf(r2));
        }
    }
