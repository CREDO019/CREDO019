...
public class BlackHoleEventDispatcher implements EventDispatcher {
    ...
    @Override // com.facebook.react.uimanager.events.EventDispatcher
    public void registerEventEmitter(int r1, RCTEventEmitter rCTEventEmitter) {
    }

    @Override // com.facebook.react.uimanager.events.EventDispatcher
    public void registerEventEmitter(int r1, RCTModernEventEmitter rCTModernEventEmitter) {
    }
    ...
    @Override // com.facebook.react.uimanager.events.EventDispatcher
    public void unregisterEventEmitter(int r1) {
    }
    ...
    public void dispatchEvent(Event event) {
        ...
        FLog.m1340d(simpleName, "Trying to emit event to JS, but the React instance isn't ready. Event: " + event.getEventName());
    }
}
