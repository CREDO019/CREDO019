...
public interface EventDispatcher {
    ...
    @Deprecated
    void registerEventEmitter(int r1, RCTEventEmitter rCTEventEmitter);

    void registerEventEmitter(int r1, RCTModernEventEmitter rCTModernEventEmitter);
    ...
    void unregisterEventEmitter(int r1);
}
