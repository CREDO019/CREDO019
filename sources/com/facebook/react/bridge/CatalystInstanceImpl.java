...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    private native void jniCallJSCallback(int r1, NativeArray nativeArray);
    ...
    private native void jniHandleMemoryPressure(int r1);

    private native void jniLoadScriptFromAssets(AssetManager assetManager, String str, boolean z);

    private native void jniLoadScriptFromFile(String str, String str2, boolean z);

    private native void jniRegisterSegment(int r1, String str);
    ...
    /* synthetic */ CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, JSExceptionHandler jSExceptionHandler, RunnableC14731 runnableC14731) {
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, JSExceptionHandler jSExceptionHandler) {
        ...
        FLog.m1340d(ReactConstants.TAG, "Initializing React Xplat Bridge.");
        ...
        FLog.m1340d(ReactConstants.TAG, "Initializing React Xplat Bridge before initializeBridge");
        ...
        FLog.m1340d(ReactConstants.TAG, "Initializing React Xplat Bridge after initializeBridge");
        com.facebook.systrace.Systrace.endSection(0L);
    ...
    @Override // com.facebook.react.bridge.CatalystInstance
    public void registerSegment(int r1, String str) {
        jniRegisterSegment(r1, str);
    }
    ...
    public void runJSBundle() {
        FLog.m1340d(ReactConstants.TAG, "CatalystInstanceImpl.runJSBundle()");
    ...
    public void callFunction(PendingJSCall pendingJSCall) {
        if (this.mDestroyed) {
            ...
            FLog.m1288w(ReactConstants.TAG, "Calling JS function after bridge has been destroyed: " + pendingJSCall2);
            return;
        }
    ...
    public void invokeCallback(int r2, NativeArrayInterface nativeArrayInterface) {
        if (this.mDestroyed) {
            FLog.m1288w(ReactConstants.TAG, "Invoking JS callback after bridge has been destroyed.");
        } else {
            jniCallJSCallback(r2, (NativeArray) nativeArrayInterface);
        }
    }

    @Override // com.facebook.react.bridge.CatalystInstance
    public void destroy() {
        FLog.m1340d(ReactConstants.TAG, "CatalystInstanceImpl.destroy() start");
        ...
        this.mNativeModulesQueueThread.runOnQueue(new RunnableC14731());
    ...
    /* loaded from: classes.dex */
    public class RunnableC14731 implements Runnable {
        RunnableC14731() {
        }
        ...
        public void run() {
            ...
            CatalystInstanceImpl.this.getReactQueueConfiguration().getJSQueueThread().runOnQueue(new RunnableC14741());
        }

        /* renamed from: com.facebook.react.bridge.CatalystInstanceImpl$1$1 */
        /* loaded from: classes.dex */
        class RunnableC14741 implements Runnable {
            RunnableC14741() {
            }
                    ...
                    public void run() {
                        AsyncTask.execute(new Runnable() { // from class: com.facebook.react.bridge.CatalystInstanceImpl.1.1.1.1
                            ...
                            public void run() {
                                ...
                                FLog.m1340d(ReactConstants.TAG, "CatalystInstanceImpl.destroy() end");
    ...
    public void initialize() {
        FLog.m1340d(ReactConstants.TAG, "CatalystInstanceImpl.initialize()");
    ...
    public void handleMemoryPressure(int r2) {
        if (this.mDestroyed) {
            return;
        }
        jniHandleMemoryPressure(r2);
    }
    ...
    private class NativeExceptionHandler implements QueueThreadExceptionHandler {
        ...
        /* synthetic */ NativeExceptionHandler(CatalystInstanceImpl catalystInstanceImpl, RunnableC14731 runnableC14731) {
            this();
        }
    ...
    public static class Builder {
        ...
        public CatalystInstanceImpl build() {
            return new CatalystInstanceImpl((ReactQueueConfigurationSpec) Assertions.assertNotNull(this.mReactQueueConfigurationSpec), (JavaScriptExecutor) Assertions.assertNotNull(this.mJSExecutor), (NativeModuleRegistry) Assertions.assertNotNull(this.mRegistry), (JSBundleLoader) Assertions.assertNotNull(this.mJSBundleLoader), (JSExceptionHandler) Assertions.assertNotNull(this.mJSExceptionHandler), null);
        }
    }
}
