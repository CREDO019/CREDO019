...
public class MessageQueueThreadImpl implements MessageQueueThread {
    ...
    public boolean runOnQueue(Runnable runnable) {
        if (this.mIsFinished) {
            FLog.m1288w(ReactConstants.TAG, "Tried to enqueue runnable on already finished thread: '" + getName() + "... dropping Runnable.");
            return false;
        }
    ...
    /* loaded from: classes.dex */
    static /* synthetic */ class C15125 {

        /* renamed from: $SwitchMap$com$facebook$react$bridge$queue$MessageQueueThreadSpec$ThreadType */
        static final /* synthetic */ int[] f162x16463f8b;

        static {
            int[] r0 = new int[MessageQueueThreadSpec.ThreadType.values().length];
            f162x16463f8b = r0;
            try {
                r0[MessageQueueThreadSpec.ThreadType.MAIN_UI.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f162x16463f8b[MessageQueueThreadSpec.ThreadType.NEW_BACKGROUND.ordinal()] = 2;
    ...
    public static MessageQueueThreadImpl create(MessageQueueThreadSpec messageQueueThreadSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        int r0 = C15125.f162x16463f8b[messageQueueThreadSpec.getThreadType().ordinal()];
        if (r0 != 1) {
            if (r0 == 2) {
