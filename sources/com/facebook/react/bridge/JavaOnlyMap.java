...
public class JavaOnlyMap implements ReadableMap, WritableMap {
    ...
    /* renamed from: of */
    public static JavaOnlyMap m1263of(Object... objArr) {
    ...
    public static JavaOnlyMap deepClone(ReadableMap readableMap) {
        ...
        while (keySetIterator.hasNextKey()) {
            ...
            switch (C14992.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                case 1:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C14992 {
    ...
    private JavaOnlyMap(Object... objArr) {
        ...
        for (int r0 = 0; r0 < objArr.length; r0 += 2) {
            Object obj = objArr[r0 + 1];
            if (obj instanceof Number) {
                obj = Double.valueOf(((Number) obj).doubleValue());
            }
            this.mBackingMap.put(objArr[r0], obj);
        }
    }
    ...
    @Override // com.facebook.react.bridge.WritableMap
    public void putInt(String str, int r6) {
        this.mBackingMap.put(str, new Double(r6));
    }
