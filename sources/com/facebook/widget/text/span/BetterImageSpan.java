...
public class BetterImageSpan extends ReplacementSpan {
    ...
    public int getSize(Paint paint, CharSequence text, int start, int end, Paint.FontMetricsInt fontMetrics) {
        ...
        int r2 = this.mHeight + offsetAboveBaseline;
        ...
        if (r2 > fontMetrics.descent) {
            fontMetrics.descent = r2;
        }
        if (r2 > fontMetrics.bottom) {
            fontMetrics.bottom = r2;
        }
        return this.mWidth;
    }
