...
public class ContextChain implements Parcelable {
    ...
    public String toString() {
        if (this.mSerializedString == null) {
            this.mSerializedString = this.mTag + ParameterizedMessage.ERROR_MSG_SEPARATOR + this.mName;
