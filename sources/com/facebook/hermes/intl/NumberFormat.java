...
public class NumberFormat {
    ...
    private void setNumberFormatUnitOptions(Map<String, Object> map) throws JSRangeErrorException {
        this.mResolvedStyle = (IPlatformNumberFormatter.Style) OptionHelpers.searchEnum(IPlatformNumberFormatter.Style.class, JSObjects.getJavaString(OptionHelpers.GetOption(map, TtmlNode.TAG_STYLE, OptionHelpers.OptionType.STRING, new String[]{"decimal", "percent", "currency", "unit"}, "decimal")));
    ...
    public Map<String, Object> resolvedOptions() throws JSRangeErrorException {
        ...
        int r1 = this.mResolvedMinimumIntegerDigits;
        if (r1 != -1) {
            linkedHashMap.put("minimumIntegerDigits", Integer.valueOf(r1));
        }
        if (this.mRoundingType == IPlatformNumberFormatter.RoundingType.SIGNIFICANT_DIGITS) {
            int r12 = this.mResolvedMaximumSignificantDigits;
            if (r12 != -1) {
                linkedHashMap.put("minimumSignificantDigits", Integer.valueOf(r12));
            }
            int r13 = this.mResolvedMinimumSignificantDigits;
            if (r13 != -1) {
                linkedHashMap.put("maximumSignificantDigits", Integer.valueOf(r13));
            }
        } else if (this.mRoundingType == IPlatformNumberFormatter.RoundingType.FRACTION_DIGITS) {
            int r14 = this.mResolvedMinimumFractionDigits;
            if (r14 != -1) {
                linkedHashMap.put("minimumFractionDigits", Integer.valueOf(r14));
            }
            int r15 = this.mResolvedMaximumFractionDigits;
            if (r15 != -1) {
                linkedHashMap.put("maximumFractionDigits", Integer.valueOf(r15));
            }
        }
