...
public class PlatformNumberFormatterICU implements IPlatformNumberFormatter {
    ...
    @Override // com.facebook.hermes.intl.IPlatformNumberFormatter
    public PlatformNumberFormatterICU setMinIntergerDigits(int r2) {
        if (r2 != -1) {
            this.mNumberFormat.setMinimumIntegerDigits(r2);
        }
        return this;
    }

    @Override // com.facebook.hermes.intl.IPlatformNumberFormatter
    public PlatformNumberFormatterICU setSignificantDigits(IPlatformNumberFormatter.RoundingType roundingType, int r3, int r4) throws JSRangeErrorException {
        if ((this.mNumberFormat instanceof DecimalFormat) && roundingType == IPlatformNumberFormatter.RoundingType.SIGNIFICANT_DIGITS) {
            ...
            if (r3 >= 0) {
                decimalFormat.setMinimumSignificantDigits(r3);
            }
            if (r4 >= 0) {
                if (r4 < decimalFormat.getMinimumSignificantDigits()) {
                    throw new JSRangeErrorException("maximumSignificantDigits should be at least equal to minimumSignificantDigits");
                }
                decimalFormat.setMaximumSignificantDigits(r4);
            }
    ...
    @Override // com.facebook.hermes.intl.IPlatformNumberFormatter
    public PlatformNumberFormatterICU setFractionDigits(IPlatformNumberFormatter.RoundingType roundingType, int r3, int r4) {
        if (roundingType == IPlatformNumberFormatter.RoundingType.FRACTION_DIGITS) {
            if (r3 >= 0) {
                this.mNumberFormat.setMinimumFractionDigits(r3);
            }
            if (r4 >= 0) {
                this.mNumberFormat.setMaximumFractionDigits(r4);
            }
            android.icu.text.NumberFormat numberFormat = this.mNumberFormat;
            if (numberFormat instanceof DecimalFormat) {
    ...
    public PlatformNumberFormatterICU setSignDisplay(IPlatformNumberFormatter.SignDisplay signDisplay) {
        ...
        if (numberFormat instanceof DecimalFormat) {
            DecimalFormat decimalFormat = (DecimalFormat) numberFormat;
            DecimalFormatSymbols decimalFormatSymbols = decimalFormat.getDecimalFormatSymbols();
            int r7 = C12651.f151xa920794a[signDisplay.ordinal()];
            if (r7 == 1) {
    ...
    /* renamed from: com.facebook.hermes.intl.PlatformNumberFormatterICU$1 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C12651 {

        /* renamed from: $SwitchMap$com$facebook$hermes$intl$IPlatformNumberFormatter$SignDisplay */
        static final /* synthetic */ int[] f151xa920794a;

        static {
            int[] r0 = new int[IPlatformNumberFormatter.SignDisplay.values().length];
            f151xa920794a = r0;
            try {
                r0[IPlatformNumberFormatter.SignDisplay.NEVER.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f151xa920794a[IPlatformNumberFormatter.SignDisplay.ALWAYS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f151xa920794a[IPlatformNumberFormatter.SignDisplay.EXCEPTZERO.ordinal()] = 3;
