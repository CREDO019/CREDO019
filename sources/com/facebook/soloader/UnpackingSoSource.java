...
public abstract class UnpackingSoSource extends DirectorySoSource {
    ...
    public static final class DsoManifest {
        ...
        static final DsoManifest read(DataInput dataInput) throws IOException {
            ...
            for (int r2 = 0; r2 < readInt; r2++) {
                dsoArr[r2] = new Dso(dataInput.readUTF(), dataInput.readUTF());
            }
        ...
        public final void write(DataOutput dataOutput) throws IOException {
            ...
            while (true) {
                ...
                dataOutput.writeUTF(dsoArr[r0].name);
                dataOutput.writeUTF(this.dsos[r0].hash);
                r0++;
            }
        }
    }
    ...
    private void deleteUnmentionedFiles(Dso[] dsoArr) throws IOException {
        ...
        for (String str : list) {
            if (!str.equals(STATE_FILE_NAME) && !str.equals(LOCK_FILE_NAME) && !str.equals(INSTANCE_LOCK_FILE_NAME) && !str.equals(DEPS_FILE_NAME) && !str.equals(MANIFEST_FILE_NAME)) {
                boolean z = false;
                for (int r5 = 0; !z && r5 < dsoArr.length; r5++) {
                    if (dsoArr[r5].name.equals(getSoNameFromFileName(str))) {
                        z = true;
                    }
                }
                if (!z) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:13:0x0043 A[Catch: all -> 0x0036, TryCatch #4 {all -> 0x0036, blocks: (B:4:0x0031, B:13:0x0043, B:14:0x004a, B:15:0x0054, B:17:0x005a, B:34:0x00a8, B:9:0x003a, B:20:0x0062, B:22:0x0067, B:24:0x0079, B:27:0x008c, B:28:0x008f, B:32:0x00a3), top: B:50:0x0031 }] */
    /* JADX WARN: Removed duplicated region for block: B:17:0x005a A[Catch: all -> 0x0036, TRY_LEAVE, TryCatch #4 {all -> 0x0036, blocks: (B:4:0x0031, B:13:0x0043, B:14:0x004a, B:15:0x0054, B:17:0x005a, B:34:0x00a8, B:9:0x003a, B:20:0x0062, B:22:0x0067, B:24:0x0079, B:27:0x008c, B:28:0x008f, B:32:0x00a3), top: B:50:0x0031 }] */
    /*
    ...
    */
        ...
        return new Runnable() { // from class: com.facebook.soloader.UnpackingSoSource.1
            ...
            public void run() {
                try {
                    ...
                    randomAccessFile.setLength(randomAccessFile.getFilePointer());
                    randomAccessFile.close();
                    RandomAccessFile randomAccessFile2 = new RandomAccessFile(new File(UnpackingSoSource.this.soDirectory, UnpackingSoSource.MANIFEST_FILE_NAME), "rw");
    ...
    protected byte[] getDepsBlock() throws IOException {
        ...
        try {
            ...
            for (int r1 = 0; r1 < dsoArr.length; r1++) {
                obtain.writeString(dsoArr[r1].name);
                obtain.writeString(dsoArr[r1].hash);
            }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.facebook.soloader.SoSource
    public void prepare(int r11) throws IOException {
        ...
        try {
            ...
            if (refreshLocked(orCreateLock, r11, getDepsBlock())) {
                orCreateLock = null;
            } else {
    ...
    @Override // com.facebook.soloader.DirectorySoSource, com.facebook.soloader.SoSource
    public int loadLibrary(String str, int r4, StrictMode.ThreadPolicy threadPolicy) throws IOException {
        int loadLibraryFrom;
        synchronized (getLibraryLock(str)) {
            loadLibraryFrom = loadLibraryFrom(str, r4, this.soDirectory, threadPolicy);
        }
