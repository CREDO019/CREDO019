...
public final class MinElf {
    ...
    private static String[] extract_DT_NEEDED_no_retries(ElfByteChannel elfByteChannel) throws IOException {
        ...
        int r2 = getu16(elfByteChannel, allocate, z ? 42L : 54L);
        ...
        while (true) {
            ...
            if (j20 != 0) {
                ...
                while (true) {
                    ...
                    if (j24 == 1) {
                        strArr[r9] = getSz(elfByteChannel, allocate, (z2 ? getu32(elfByteChannel, allocate, j3 + 4) : get64(elfByteChannel, allocate, j3 + 8)) + j4);
    ...
    private static void read(ElfByteChannel elfByteChannel, ByteBuffer byteBuffer, int r5, long j) throws IOException {
        int read;
