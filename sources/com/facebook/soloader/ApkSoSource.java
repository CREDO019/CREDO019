...
public class ApkSoSource extends ExtractFromZipSoSource {
    ...
    public ApkSoSource(Context context, String str, int r5) {
        this(context, new File(context.getApplicationInfo().sourceDir), str, r5);
    }

    public ApkSoSource(Context context, File file, String str, int r5) {
        ...
        */
        protected boolean shouldExtract(java.util.zip.ZipEntry r10, java.lang.String r11) {
            ...
            L3e:
                ...
                java.io.File r7 = r9.mLibDir     // Catch: java.io.IOException -> L68
