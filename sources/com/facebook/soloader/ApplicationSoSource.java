...
public class ApplicationSoSource extends SoSource {
    ...
    public ApplicationSoSource(Context context, int r4) {
        ...
        this.flags = r4;
        this.soSource = new DirectorySoSource(new File(this.applicationContext.getApplicationInfo().nativeLibraryDir), r4);
    }
    ...
    public boolean checkAndMaybeUpdate() throws IOException {
        ...
        int r0 = this.flags | 1;
        this.flags = r0;
        DirectorySoSource directorySoSource = new DirectorySoSource(nativeLibDirFromContext, r0);
    ...
    public int loadLibrary(String str, int r3, StrictMode.ThreadPolicy threadPolicy) throws IOException {
        return this.soSource.loadLibrary(str, r3, threadPolicy);
    }
    ...
    @Override // com.facebook.soloader.SoSource
    public void prepare(int r2) throws IOException {
        this.soSource.prepare(r2);
    }
