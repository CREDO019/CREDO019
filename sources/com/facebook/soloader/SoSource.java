...
public abstract class SoSource {
    ...
    public abstract int loadLibrary(String str, int r2, StrictMode.ThreadPolicy threadPolicy) throws IOException;

    /* JADX INFO: Access modifiers changed from: protected */
    public void prepare(int r1) throws IOException {
    }
