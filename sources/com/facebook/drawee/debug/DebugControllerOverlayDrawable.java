...
public class DebugControllerOverlayDrawable extends Drawable implements ImageLoadingTimeListener {
    ...
    public void draw(Canvas canvas) {
        ...
        int r0 = this.mFrameCount;
        if (r0 > 0) {
            addDebugText(canvas, "anim", format("f %d, l %d", Integer.valueOf(r0), Integer.valueOf(this.mLoopCount)));
        }
    ...
    private void prepareDebugTextParameters(Rect bounds, int numberOfLines, int maxLineLengthEm) {
        ...
        int r4 = min + 8;
        this.mLineIncrementPx = r4;
        if (this.mTextGravity == 80) {
            this.mLineIncrementPx = r4 * (-1);
        }
    ...
    private void addDebugText(Canvas canvas, String label, String value, int valueColor) {
        ...
        int r2 = this.mCurrentTextXPx;
        int r3 = this.mCurrentTextYPx;
        canvas.drawRect(r2 - 4, r3 + 8, r2 + measureText + measureText2 + 4.0f, r3 + this.mLineIncrementPx + 8, this.mPaint);
        this.mPaint.setColor(-1);
