...
public class ForwardingControllerListener<INFO> implements ControllerListener<INFO>, OnDrawControllerListener<INFO> {
    ...
    /* renamed from: of */
    public static <INFO> ForwardingControllerListener<INFO> m1269of(ControllerListener<? super INFO> listener) {
    ...
    /* renamed from: of */
    public static <INFO> ForwardingControllerListener<INFO> m1268of(ControllerListener<? super INFO> listener1, ControllerListener<? super INFO> listener2) {
        ForwardingControllerListener<INFO> create = create();
    ...
    public synchronized void onSubmit(String id, Object callerContext) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            try {
                ControllerListener<? super INFO> controllerListener = this.mListeners.get(r1);
