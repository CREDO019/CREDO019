...
public class GenericDraweeHierarchy implements SettableDraweeHierarchy {
    ...
    public GenericDraweeHierarchy(GenericDraweeHierarchyBuilder builder) {
        ...
        int r0 = (size == 0 ? 1 : size) + (builder.getPressedStateOverlay() != null ? 1 : 0);
        Drawable[] drawableArr = new Drawable[r0 + 6];
        ...
        if (r0 > 0) {
            if (builder.getOverlays() != null) {
                ...
                for (Drawable drawable : builder.getOverlays()) {
                    drawableArr[r3 + 6] = buildBranch(drawable, null);
                    r3++;
                }
            }
            if (builder.getPressedStateOverlay() != null) {
                drawableArr[r3 + 6] = buildBranch(builder.getPressedStateOverlay(), null);
            }
        }
    ...
    public void setRoundingParams(@Nullable RoundingParams roundingParams) {
        ...
        for (int r4 = 0; r4 < this.mFadeDrawable.getNumberOfLayers(); r4++) {
            WrappingUtils.updateLeafRounding(getParentDrawableAtIndex(r4), this.mRoundingParams, this.mResources);
        }
    }
