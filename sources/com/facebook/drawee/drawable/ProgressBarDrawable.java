...
public class ProgressBarDrawable extends Drawable implements CloneableDrawable {
    ...
    public boolean getPadding(Rect padding) {
        int r0 = this.mPadding;
        padding.set(r0, r0, r0, r0);
    ...
    private void drawHorizontalBar(Canvas canvas, int level, int color) {
        ...
        int r8 = bounds.left + this.mPadding;
        int r0 = bounds.bottom - this.mPadding;
        int r2 = this.mBarWidth;
        int r02 = r0 - r2;
        this.mRect.set(r8, r02, r8 + (((bounds.width() - (this.mPadding * 2)) * level) / 10000), r02 + r2);
    ...
    private void drawVerticalBar(Canvas canvas, int level, int color) {
        Rect bounds = getBounds();
        int r8 = bounds.left + this.mPadding;
        int r0 = bounds.top + this.mPadding;
        this.mRect.set(r8, r0, r8 + this.mBarWidth, r0 + (((bounds.height() - (this.mPadding * 2)) * level) / 10000));
        drawBar(canvas, color);
    }
