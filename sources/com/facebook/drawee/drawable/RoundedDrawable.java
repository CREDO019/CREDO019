...
public abstract class RoundedDrawable extends Drawable implements Rounded, TransformAwareDrawable {
    ...
    public void setRadius(float radius) {
        int r2 = (radius > 0.0f ? 1 : (radius == 0.0f ? 0 : -1));
        Preconditions.checkState(r2 >= 0);
        Arrays.fill(this.mCornerRadii, radius);
        this.mRadiiNonZero = r2 != 0;
        this.mIsPathDirty = true;
        invalidateSelf();
    }
    ...
    public void setRadii(float[] radii) {
        if (radii == null) {
            ...
            for (int r3 = 0; r3 < 8; r3++) {
                this.mRadiiNonZero |= radii[r3] > 0.0f;
            }
        }
        this.mIsPathDirty = true;
        invalidateSelf();
        ...
        if (this.mIsPathDirty) {
            ...
            if (this.mIsCircle) {
                ...
                while (true) {
                    ...
                    fArr[r0] = (this.mCornerRadii[r0] + this.mPadding) - (this.mBorderWidth / 2.0f);
                    r0++;
                }
            ...
            if (this.mIsCircle) {
                ...
                for (int r2 = 0; r2 < this.mBorderRadii.length; r2++) {
                    this.mInsideBorderRadii[r2] = this.mCornerRadii[r2] - this.mBorderWidth;
                }
