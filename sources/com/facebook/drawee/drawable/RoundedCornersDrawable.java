...
public class RoundedCornersDrawable extends ForwardingDrawable implements Rounded {
    ...
    private void updatePath() {
        ...
        if (this.mIsCircle) {
            ...
            while (true) {
                ...
                fArr[r0] = (this.mRadii[r0] + this.mPadding) - (this.mBorderWidth / 2.0f);
                r0++;
            }
    ...
    static /* synthetic */ class C12161 {
        ...
        static final /* synthetic */ int[] f126xda0cffae;

        static {
            int[] r0 = new int[Type.values().length];
            f126xda0cffae = r0;
            try {
                r0[Type.CLIPPING.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f126xda0cffae[Type.OVERLAY_COLOR.ordinal()] = 2;
    ...
    public void draw(Canvas canvas) {
        ...
        int r0 = C12161.f126xda0cffae[this.mType.ordinal()];
        if (r0 == 1) {
