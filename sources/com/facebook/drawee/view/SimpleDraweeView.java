...
import com.facebook.drawee.C1198R;
...
public class SimpleDraweeView extends GenericDraweeView {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            if (attrs != null) {
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C1198R.styleable.SimpleDraweeView);
                if (obtainStyledAttributes.hasValue(C1198R.styleable.SimpleDraweeView_actualImageUri)) {
                    setImageURI(Uri.parse(obtainStyledAttributes.getString(C1198R.styleable.SimpleDraweeView_actualImageUri)), (Object) null);
                } else if (obtainStyledAttributes.hasValue(C1198R.styleable.SimpleDraweeView_actualImageResource) && (resourceId = obtainStyledAttributes.getResourceId(C1198R.styleable.SimpleDraweeView_actualImageResource, -1)) != -1) {
                    if (isInEditMode()) {
