...
public class DraweeConfig {
    ...
    private DraweeConfig(Builder builder) {
        ...
        if (builder.mDebugOverlayEnabledSupplier == null) {
            m1349of = Suppliers.m1349of(false);
        } else {
            m1349of = builder.mDebugOverlayEnabledSupplier;
        }
        this.mDebugOverlayEnabledSupplier = m1349of;
    ...
    public static class Builder {
        ...
        public Builder setDrawDebugOverlay(boolean drawDebugOverlay) {
            return setDebugOverlayEnabledSupplier(Suppliers.m1349of(Boolean.valueOf(drawDebugOverlay)));
        }
