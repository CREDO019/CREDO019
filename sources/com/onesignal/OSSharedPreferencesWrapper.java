...
class OSSharedPreferencesWrapper implements OSSharedPreferences {
    ...
    @Override // com.onesignal.OSSharedPreferences
    public int getInt(String str, String str2, int r3) {
        return OneSignalPrefs.getInt(str, str2, r3);
    }

    @Override // com.onesignal.OSSharedPreferences
    public void saveInt(String str, String str2, int r3) {
        OneSignalPrefs.saveInt(str, str2, r3);
    }
