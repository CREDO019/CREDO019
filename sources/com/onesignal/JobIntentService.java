...
public abstract class JobIntentService extends Service {
    ...
    public static void enqueueWork(Context context, Class cls, int r3, Intent intent, boolean z) {
        enqueueWork(context, new ComponentName(context, cls), r3, intent, z);
    }

    public static void enqueueWork(Context context, ComponentName componentName, int r5, Intent intent, boolean z) {
        if (intent == null) {
            throw new IllegalArgumentException("work must not be null");
        }
        synchronized (sLock) {
            WorkEnqueuer workEnqueuer = getWorkEnqueuer(context, componentName, true, r5, z);
            workEnqueuer.ensureJobId(r5);
            try {
                workEnqueuer.enqueueWork(intent);
            } catch (IllegalStateException e) {
                if (z) {
                    getWorkEnqueuer(context, componentName, true, r5, false).enqueueWork(intent);
                } else {
                    throw e;
                }
            }
    ...
    static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z, int r7, boolean z2) {
        ...
        if (workEnqueuer == null) {
            if (Build.VERSION.SDK_INT < 26 || z2) {
                ...
                compatWorkEnqueuer = new JobWorkEnqueuer(context, componentName, r7);
            }
