...
public class OSInAppMessageAction {
    ...
    /* renamed from: ID */
    private static final String f1299ID = "id";
    ...
    private void parseOutcomes(JSONObject jSONObject) throws JSONException {
        ...
        for (int r0 = 0; r0 < jSONArray.length(); r0++) {
            this.outcomes.add(new OSInAppMessageOutcome((JSONObject) jSONArray.get(r0)));
        }
    }
    ...
    private void parsePrompts(JSONObject jSONObject) throws JSONException {
        ...
        for (int r0 = 0; r0 < jSONArray.length(); r0++) {
            String string = jSONArray.getString(r0);
            string.hashCode();
            if (string.equals("push")) {
                this.prompts.add(new OSInAppMessagePushPrompt());
            } else if (string.equals(GeofencingGooglePlayServicesProvider.LOCATION_EXTRA_ID)) {
