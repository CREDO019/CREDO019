...
public final class RNGestureHandlerButtonViewManager extends ViewGroupManager<ButtonViewGroup> implements RNGestureHandlerButtonManagerInterface<ButtonViewGroup> {
    ...
    public void setRippleRadius(ButtonViewGroup view, int r3) {
        Intrinsics.checkNotNullParameter(view, "view");
        view.setRippleRadius(Integer.valueOf(r3));
    }
    ...
    public static final class ButtonViewGroup extends ViewGroup implements NativeViewGestureHandler.NativeViewGestureHandlerHook {
        ...
        private static View.OnClickListener dummyClickListener = new View.OnClickListener() { // from class: com.swmansion.gesturehandler.react.RNGestureHandlerButtonViewManager$ButtonViewGroup$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                RNGestureHandlerButtonViewManager.ButtonViewGroup.m1538dummyClickListener$lambda5(view);
            }
        };

        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: dummyClickListener$lambda-5  reason: not valid java name */
        public static final void m1538dummyClickListener$lambda5(View view) {
        }
        ...
        private final void withBackgroundUpdate(Functions<Unit> functions) {
            functions.invoke();
            this.needBackgroundUpdate = true;
        }
        ...
        private final Drawable createSelectableDrawable() {
            ...
            int[][] r0 = {new int[]{16842910}};
            Integer num = this.rippleRadius;
            Integer num2 = this.rippleColor;
            if (num2 != null) {
                Intrinsics.checkNotNull(num2);
                colorStateList = new ColorStateList(r0, new int[]{num2.intValue()});
            } else {
                getContext().getTheme().resolveAttribute(16843820, resolveOutValue, true);
                colorStateList = new ColorStateList(r0, new int[]{resolveOutValue.data});
            }
        ...
        static /* synthetic */ boolean isChildTouched$default(ButtonViewGroup buttonViewGroup, Sequence sequence, int r2, Object obj) {
            if ((r2 & 1) != 0) {
                sequence = androidx.core.view.ViewGroup.getChildren(buttonViewGroup);
            }
        ...
        private final boolean isChildTouched(Sequence<? extends View> sequence) {
            for (View view : sequence) {
                ...
                if ((view instanceof ViewGroup) && isChildTouched(androidx.core.view.ViewGroup.getChildren((ViewGroup) view))) {
                    return true;
                }
            }
            return false;
    ...
    /* compiled from: RNGestureHandlerButtonViewManager.kt */
    @Metadata(m184d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m183d2 = {"Lcom/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager$Companion;", "", "()V", "REACT_CLASS", "", "react-native-gesture-handler_release"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes3.dex */
    public static final class Companion {
        public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
            this();
