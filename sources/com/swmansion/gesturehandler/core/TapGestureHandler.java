...
public final class TapGestureHandler extends GestureHandler<TapGestureHandler> {
    ...
    private final Runnable failDelayed = new Runnable() { // from class: com.swmansion.gesturehandler.core.TapGestureHandler$$ExternalSyntheticLambda0
        ...
        public final void run() {
            TapGestureHandler.m1536failDelayed$lambda0(TapGestureHandler.this);
        }
    };
    ...
    public static final void m1536failDelayed$lambda0(TapGestureHandler this$0) {
    ...
    public final TapGestureHandler setNumberOfTaps(int r2) {
        this.numberOfTaps = r2;
        return this;
    }
    ...
    public final TapGestureHandler setMinNumberOfPointers(int r2) {
        this.minNumberOfPointers = r2;
        return this;
    }
    ...
    private final void endTap() {
        ...
        int r0 = this.tapsSoFar + 1;
        this.tapsSoFar = r0;
        if (r0 == this.numberOfTaps && this.currentMaxNumberOfPointers >= this.minNumberOfPointers) {
            activate();
            return;
        }
        Handler handler2 = this.handler;
    ...
    /* compiled from: TapGestureHandler.kt */
    @Metadata(m184d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082T¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m183d2 = {"Lcom/swmansion/gesturehandler/core/TapGestureHandler$Companion;", "", "()V", "DEFAULT_MAX_DELAY_MS", "", "DEFAULT_MAX_DURATION_MS", "DEFAULT_MIN_NUMBER_OF_POINTERS", "", "DEFAULT_NUMBER_OF_TAPS", "MAX_VALUE_IGNORE", "", "react-native-gesture-handler_release"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes3.dex */
