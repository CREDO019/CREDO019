...
public class ScreenFragment extends Fragment {
    ...
    /* compiled from: ScreenFragment.kt */
    @Metadata(m184d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m183d2 = {"Lcom/swmansion/rnscreens/ScreenFragment$ScreenLifecycleEvent;", "", "(Ljava/lang/String;I)V", "Appear", "WillAppear", "Disappear", "WillDisappear", "react-native-screens_release"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes4.dex */
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            int[] r0 = new int[ScreenLifecycleEvent.values().length];
            r0[ScreenLifecycleEvent.WillAppear.ordinal()] = 1;
            r0[ScreenLifecycleEvent.Appear.ordinal()] = 2;
            r0[ScreenLifecycleEvent.WillDisappear.ordinal()] = 3;
            r0[ScreenLifecycleEvent.Disappear.ordinal()] = 4;
    ...
    /* compiled from: ScreenFragment.kt */
    @Metadata(m184d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0005\u001a\u00020\u0006H\u0016¨\u0006\u0007"}, m183d2 = {"Lcom/swmansion/rnscreens/ScreenFragment$ScreensFrameLayout;", "Landroid/widget/FrameLayout;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "clearFocus", "", "react-native-screens_release"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes4.dex */
    ...
    private final boolean canDispatchEvent(ScreenLifecycleEvent screenLifecycleEvent) {
        int r4 = WhenMappings.$EnumSwitchMapping$0[screenLifecycleEvent.ordinal()];
        if (r4 != 1) {
            if (r4 != 2) {
                if (r4 != 3) {
                    if (r4 != 4) {
    ...
    private final void dispatchEvent(ScreenLifecycleEvent screenLifecycleEvent, ScreenFragment screenFragment) {
        ...
        if ((screenFragment instanceof ScreenStackFragment) && screenFragment.canDispatchEvent(screenLifecycleEvent)) {
            ...
            int r1 = WhenMappings.$EnumSwitchMapping$0[screenLifecycleEvent.ordinal()];
            if (r1 == 1) {
            ...
            if (isResumed()) {
                UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.swmansion.rnscreens.ScreenFragment$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ScreenFragment.m1547dispatchViewAnimationEvent$lambda8(z, this);
                    }
                });
            } else if (z) {
                dispatchOnDisappear();
    ...
    public static final void m1547dispatchViewAnimationEvent$lambda8(boolean z, ScreenFragment this$0) {
    ...
    /* compiled from: ScreenFragment.kt */
    @Metadata(m184d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004H\u0005¨\u0006\u0006"}, m183d2 = {"Lcom/swmansion/rnscreens/ScreenFragment$Companion;", "", "()V", "recycleView", "Landroid/view/View;", "view", "react-native-screens_release"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes4.dex */
