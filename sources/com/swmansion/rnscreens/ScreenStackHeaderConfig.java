...
public final class ScreenStackHeaderConfig extends ViewGroup {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            int[] r0 = new int[ScreenStackHeaderSubview.Type.values().length];
            r0[ScreenStackHeaderSubview.Type.LEFT.ordinal()] = 1;
            r0[ScreenStackHeaderSubview.Type.RIGHT.ordinal()] = 2;
            r0[ScreenStackHeaderSubview.Type.CENTER.ordinal()] = 3;
    ...
    public ScreenStackHeaderConfig(Context context) {
        ...
        this.mBackClickListener = new View.OnClickListener() { // from class: com.swmansion.rnscreens.ScreenStackHeaderConfig$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                ScreenStackHeaderConfig.m1549mBackClickListener$lambda1(ScreenStackHeaderConfig.this, view);
            }
        };
        setVisibility(8);
        ...
        if (context.getTheme().resolveAttribute(C4176R.attr.colorPrimary, typedValue, true)) {
    ...
    public static final void m1549mBackClickListener$lambda1(ScreenStackHeaderConfig this$0, View view) {
    ...
    public final void onUpdate() {
        ...
        if (this.mIsAttachedToWindow && z && !this.mDestroyed) {
            ...
            int r5 = this.mDefaultStartInset;
            customToolbar.setContentInsetsRelative(r5, r5);
            ...
            int r52 = this.mTitleColor;
            if (r52 != 0) {
                this.toolbar.setTitleTextColor(r52);
            }
            ...
            for (int r6 = 0; r6 < size; r6++) {
                ScreenStackHeaderSubview screenStackHeaderSubview = this.mConfigSubviews.get(r6);
                ...
                if (type == ScreenStackHeaderSubview.Type.BACK) {
                    ...
                    int r8 = WhenMappings.$EnumSwitchMapping$0[type.ordinal()];
                    if (r8 == 1) {
    ...
    public final ScreenStackHeaderSubview getConfigSubview(int r2) {
        ScreenStackHeaderSubview screenStackHeaderSubview = this.mConfigSubviews.get(r2);
    ...
    public final void removeConfigSubview(int r2) {
        this.mConfigSubviews.remove(r2);
        maybeUpdate();
    }
    ...
    public final void addConfigSubview(ScreenStackHeaderSubview child, int r3) {
        Intrinsics.checkNotNullParameter(child, "child");
        this.mConfigSubviews.add(r3, child);
        maybeUpdate();
    }
    ...
    private final TextView getTitleTextView() {
        ...
        for (int r1 = 0; r1 < childCount; r1++) {
            View childAt = this.toolbar.getChildAt(r1);
    ...
    public final void setTitleColor(int r1) {
        this.mTitleColor = r1;
    }

    public final void setTintColor(int r1) {
        this.mTintColor = r1;
    }
