...
public final class ScreenWindowTraits {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            int[] r0 = new int[Screen.WindowTraits.values().length];
            r0[Screen.WindowTraits.ORIENTATION.ordinal()] = 1;
            r0[Screen.WindowTraits.COLOR.ordinal()] = 2;
            r0[Screen.WindowTraits.STYLE.ordinal()] = 3;
            r0[Screen.WindowTraits.TRANSLUCENT.ordinal()] = 4;
            r0[Screen.WindowTraits.HIDDEN.ordinal()] = 5;
            r0[Screen.WindowTraits.ANIMATED.ordinal()] = 6;
            r0[Screen.WindowTraits.NAVIGATION_BAR_COLOR.ordinal()] = 7;
            r0[Screen.WindowTraits.NAVIGATION_BAR_HIDDEN.ordinal()] = 8;
    ...
    public final void setStyle$react_native_screens_release(Screen screen, final Activity activity, ReactContext reactContext) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.swmansion.rnscreens.ScreenWindowTraits$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ScreenWindowTraits.m1552setStyle$lambda0(activity, str);
            }
        });
    }
    ...
    public static final void m1552setStyle$lambda0(Activity activity, String style) {
    ...
    public final void setHidden$react_native_screens_release(Screen screen, Activity activity) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.swmansion.rnscreens.ScreenWindowTraits$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ScreenWindowTraits.m1550setHidden$lambda1(booleanValue, windowInsetsControllerCompat);
            }
        });
    }
    ...
    public static final void m1550setHidden$lambda1(boolean z, WindowInsetsControllerCompat controller) {
    ...
    public final void setNavigationBarColor$react_native_screens_release(Screen screen, Activity activity) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.swmansion.rnscreens.ScreenWindowTraits$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                ScreenWindowTraits.m1551setNavigationBarColor$lambda2(window, navigationBarColor2);
            }
        });
    ...
    public static final void m1551setNavigationBarColor$lambda2(Window window, int r3) {
        new WindowInsetsControllerCompat(window, window.getDecorView()).setAppearanceLightNavigationBars(INSTANCE.isColorLight(r3));
    }
    ...
    private final boolean isColorLight(int r10) {
        return ((double) 1) - ((((((double) Color.red(r10)) * 0.299d) + (((double) Color.green(r10)) * 0.587d)) + (((double) Color.blue(r10)) * 0.114d)) / ((double) 255)) < 0.5d;
    }
}
