...
public class ScreenContainer<T extends ScreenFragment> extends ViewGroup {
    ...
    protected void onLayout(boolean z, int r3, int r4, int r5, int r6) {
        ...
        for (int r42 = 0; r42 < childCount; r42++) {
            getChildAt(r42).layout(0, 0, getWidth(), getHeight());
        }
    }
    ...
    public final void addScreen(Screen screen, int r4) {
        Intrinsics.checkNotNullParameter(screen, "screen");
        T adapt = adapt(screen);
        screen.setFragment(adapt);
        this.mScreenFragments.add(r4, adapt);
        screen.setContainer(this);
        onScreenChanged();
    }

    public void removeScreenAt(int r3) {
        this.mScreenFragments.get(r3).getScreen().setContainer(null);
        this.mScreenFragments.remove(r3);
        onScreenChanged();
    }
    ...
    public final Screen getScreenAt(int r2) {
        return this.mScreenFragments.get(r2).getScreen();
    }
        ...
        if (reactContext != null) {
            reactContext.runOnUiQueueThread(new Runnable() { // from class: com.swmansion.rnscreens.ScreenContainer$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ScreenContainer.m1546onScreenChanged$lambda7(ScreenContainer.this);
                }
            });
        }
    }
    ...
    public static final void m1546onScreenChanged$lambda7(ScreenContainer this$0) {
    ...
    public final void performUpdates() {
        ...
        if (this.mNeedUpdate && this.mIsAttached && (fragmentManager = this.mFragmentManager) != null) {
            boolean z = true;
            if ((fragmentManager == null || !fragmentManager.isDestroyed()) ? false : false) {
                return;
            }
