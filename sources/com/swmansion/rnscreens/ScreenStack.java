...
public final class ScreenStack extends ScreenContainer<ScreenStackFragment> {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            int[] r0 = new int[Screen.StackAnimation.values().length];
            r0[Screen.StackAnimation.DEFAULT.ordinal()] = 1;
            r0[Screen.StackAnimation.NONE.ordinal()] = 2;
            r0[Screen.StackAnimation.FADE.ordinal()] = 3;
            r0[Screen.StackAnimation.SLIDE_FROM_RIGHT.ordinal()] = 4;
            r0[Screen.StackAnimation.SLIDE_FROM_LEFT.ordinal()] = 5;
            r0[Screen.StackAnimation.SLIDE_FROM_BOTTOM.ordinal()] = 6;
            r0[Screen.StackAnimation.FADE_FROM_BOTTOM.ordinal()] = 7;
    ...
    public final Screen getRootScreen() {
        ...
        for (int r1 = 0; r1 < screenCount; r1++) {
            Screen screenAt = getScreenAt(r1);
    ...
    @Override // com.swmansion.rnscreens.ScreenContainer
    public void removeScreenAt(int r3) {
        TypeIntrinsics.asMutableCollection(this.mDismissed).remove(getScreenAt(r3).getFragment());
        super.removeScreenAt(r3);
    }
        ...
        if (stackAnimation != null) {
            if (z) {
                switch (WhenMappings.$EnumSwitchMapping$0[stackAnimation.ordinal()]) {
                    case 1:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_default_enter_in, C4176R.anim.rns_default_enter_out);
                        break;
                    case 2:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_no_animation_20, C4176R.anim.rns_no_animation_20);
                        break;
                    case 3:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_fade_in, C4176R.anim.rns_fade_out);
                        break;
                    case 4:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_slide_in_from_right, C4176R.anim.rns_slide_out_to_left);
                        break;
                    case 5:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_slide_in_from_left, C4176R.anim.rns_slide_out_to_right);
                        break;
                    case 6:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_slide_in_from_bottom, C4176R.anim.rns_no_animation_medium);
                        break;
                    case 7:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_fade_from_bottom, C4176R.anim.rns_no_animation_350);
                        break;
                }
            } else {
                switch (WhenMappings.$EnumSwitchMapping$0[stackAnimation.ordinal()]) {
                    case 1:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_default_exit_in, C4176R.anim.rns_default_exit_out);
                        break;
                    case 2:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_no_animation_20, C4176R.anim.rns_no_animation_20);
                        break;
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_no_animation_medium, C4176R.anim.rns_slide_out_to_bottom);
                        break;
                    case 7:
                        createTransaction.setCustomAnimations(C4176R.anim.rns_no_animation_250, C4176R.anim.rns_fade_to_bottom);
                        break;
                }
            }
        }
            ...
            while (it3.hasNext()) {
                ...
                createTransaction.add(getId(), screenStackFragment9).runOnCommit(new Runnable() { // from class: com.swmansion.rnscreens.ScreenStack$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ScreenStack.m1548onUpdate$lambda2$lambda1(ScreenStackFragment.this);
                    }
                });
            }
    ...
    public static final void m1548onUpdate$lambda2$lambda1(ScreenStackFragment screenStackFragment) {
        Screen screen;
    ...
    /* compiled from: ScreenStack.kt */
    @Metadata(m184d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0002J\u0010\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0002¨\u0006\b"}, m183d2 = {"Lcom/swmansion/rnscreens/ScreenStack$Companion;", "", "()V", "isTransparent", "", "fragment", "Lcom/swmansion/rnscreens/ScreenStackFragment;", "needsDrawReordering", "react-native-screens_release"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes4.dex */
