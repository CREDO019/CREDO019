            ...
            new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) { // from class: com.reactnativecommunity.asyncstorage.AsyncStorageModule.1
                ...
                */
                public void doInBackgroundGuarded(java.lang.Void... r20) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.reactnativecommunity.asyncstorage.AsyncStorageModule.AsyncTaskC39681.doInBackgroundGuarded(java.lang.Void[]):void");
                }
                    ...
                    try {
                        try {
                            ...
                            for (int r4 = 0; r4 < readableArray.size(); r4++) {
                                if (readableArray.getArray(r4).size() != 2) {
                                    ...
                                    try {
                                        ...
                                        FLog.m1287w(ReactConstants.TAG, e.getMessage(), e);
                                ...
                                } else if (readableArray.getArray(r4).getString(0) == null) {
                                    WritableMap invalidKeyError = AsyncStorageErrorUtil.getInvalidKeyError(null);
                                    try {
                                        AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                                        return;
                                    } catch (Exception e2) {
                                        FLog.m1287w(ReactConstants.TAG, e2.getMessage(), e2);
                                ...
                                } else if (readableArray.getArray(r4).getString(1) == null) {
                                    WritableMap invalidValueError2 = AsyncStorageErrorUtil.getInvalidValueError(null);
                                    try {
                                        AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                                        return;
                                    } catch (Exception e3) {
                                        FLog.m1287w(ReactConstants.TAG, e3.getMessage(), e3);
                                    ...
                                    compileStatement.bindString(1, readableArray.getArray(r4).getString(0));
                                    compileStatement.bindString(2, readableArray.getArray(r4).getString(1));
                            ...
                            try {
                                ...
                                FLog.m1287w(ReactConstants.TAG, e4.getMessage(), e4);
                                writableMap = AsyncStorageErrorUtil.getError(null, e4.getMessage());
                            }
                        } catch (Exception e5) {
                            FLog.m1287w(ReactConstants.TAG, e5.getMessage(), e5);
                            WritableMap error = AsyncStorageErrorUtil.getError(null, e5.getMessage());
                            try {
                                AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                            } catch (Exception e6) {
                                FLog.m1287w(ReactConstants.TAG, e6.getMessage(), e6);
                                if (error == null) {
                        ...
                        try {
                            ...
                            FLog.m1287w(ReactConstants.TAG, e7.getMessage(), e7);
                ...
                public void doInBackgroundGuarded(Void... voidArr) {
                    ...
                    try {
                        if (AsyncStorageModule.this.ensureDatabase()) {
                            try {
                                AsyncStorageModule.this.mReactDatabaseSupplier.get().beginTransaction();
                                for (int r0 = 0; r0 < readableArray.size(); r0 += 999) {
                                    int min = Math.min(readableArray.size() - r0, 999);
                                    AsyncStorageModule.this.mReactDatabaseSupplier.get().delete("catalystLocalStorage", AsyncLocalStorageUtil.buildKeySelection(min), AsyncLocalStorageUtil.buildKeySelectionArgs(readableArray, r0, min));
                                }
                                AsyncStorageModule.this.mReactDatabaseSupplier.get().setTransactionSuccessful();
                                try {
                                    AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                ...
                try {
                    ...
                    try {
                        ...
                        for (int r0 = 0; r0 < readableArray.size(); r0++) {
                            if (readableArray.getArray(r0).size() != 2) {
                                WritableMap invalidValueError = AsyncStorageErrorUtil.getInvalidValueError(null);
                                try {
                                    AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                                    return;
                            ...
                            } else if (readableArray.getArray(r0).getString(0) == null) {
                                WritableMap invalidKeyError = AsyncStorageErrorUtil.getInvalidKeyError(null);
                                try {
                                    AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                                    return;
                            ...
                            } else if (readableArray.getArray(r0).getString(1) == null) {
                                WritableMap invalidValueError2 = AsyncStorageErrorUtil.getInvalidValueError(null);
                                try {
                                    AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                                    return;
                            ...
                            } else if (!AsyncLocalStorageUtil.mergeImpl(AsyncStorageModule.this.mReactDatabaseSupplier.get(), readableArray.getArray(r0).getString(0), readableArray.getArray(r0).getString(1))) {
                    ...
                    try {
                        ...
                        FLog.m1287w(ReactConstants.TAG, e8.getMessage(), e8);
