...
class SvgViewManager extends ReactViewManager implements RNSVGSvgViewAndroidManagerInterface<SvgView> {
    ...
    public static void setSvgView(int r1, SvgView svgView) {
        mTagToSvgView.put(r1, svgView);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void runWhenViewIsAvailable(int r1, Runnable runnable) {
        mTagToRunnable.put(r1, runnable);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Nullable
    public static SvgView getSvgViewByTag(int r1) {
        return mTagToSvgView.get(r1);
    }
    ...
    public void setMeetOrSlice(SvgView svgView, int r2) {
        svgView.setMeetOrSlice(r2);
    }
    ...
    @Override // com.facebook.react.viewmanagers.RNSVGSvgViewAndroidManagerInterface
    public void setNextFocusDown(SvgView svgView, int r2) {
        super.nextFocusDown(svgView, r2);
    }
    ...
    @Override // com.facebook.react.viewmanagers.RNSVGSvgViewAndroidManagerInterface
    public void setNextFocusRight(SvgView svgView, int r2) {
        super.nextFocusRight(svgView, r2);
    }
    ...
    @Override // com.facebook.react.viewmanagers.RNSVGSvgViewAndroidManagerInterface
    public void setNextFocusForward(SvgView svgView, int r2) {
        super.nextFocusForward(svgView, r2);
    }

    @Override // com.facebook.react.viewmanagers.RNSVGSvgViewAndroidManagerInterface
    public void setNextFocusUp(SvgView svgView, int r2) {
        super.nextFocusUp(svgView, r2);
    }
    ...
    @Override // com.facebook.react.viewmanagers.RNSVGSvgViewAndroidManagerInterface
    public void setNextFocusLeft(SvgView svgView, int r2) {
        super.nextFocusLeft(svgView, r2);
    }
