...
public class ImageView extends RenderableView {
    ...
    /* renamed from: mW */
    private SVGLength f1252mW;

    /* renamed from: mX */
    private SVGLength f1253mX;

    /* renamed from: mY */
    private SVGLength f1254mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f1253mX = SVGLength.from(dynamic);
        invalidate();
    }

    public void setX(String str) {
        this.f1253mX = SVGLength.from(str);
        invalidate();
    }

    public void setX(Double d) {
        this.f1253mX = SVGLength.from(d);
        invalidate();
    }

    public void setY(Dynamic dynamic) {
        this.f1254mY = SVGLength.from(dynamic);
        invalidate();
    }

    public void setY(String str) {
        this.f1254mY = SVGLength.from(str);
        invalidate();
    }

    public void setY(Double d) {
        this.f1254mY = SVGLength.from(d);
        invalidate();
    }

    public void setWidth(Dynamic dynamic) {
        this.f1252mW = SVGLength.from(dynamic);
        invalidate();
    }

    public void setWidth(String str) {
        this.f1252mW = SVGLength.from(str);
        invalidate();
    }

    public void setWidth(Double d) {
        this.f1252mW = SVGLength.from(d);
        invalidate();
    }

    public void setHeight(Dynamic dynamic) {
        this.f1251mH = SVGLength.from(dynamic);
        invalidate();
    }

    public void setHeight(String str) {
        this.f1251mH = SVGLength.from(str);
        invalidate();
    }

    public void setHeight(Double d) {
        this.f1251mH = SVGLength.from(d);
        invalidate();
    }
    ...
    private void loadBitmap(ImagePipeline imagePipeline, ImageRequest imageRequest) {
        ...
        imagePipeline.fetchDecodedImage(imageRequest, this.mContext).subscribe(new BaseBitmapDataSubscriber() { // from class: com.horcrux.svg.ImageView.1
            ...
            public void onFailureImpl(DataSource<CloseableReference<CloseableImage>> dataSource) {
                ImageView.this.mLoading.set(false);
                FLog.m1285w(ReactConstants.TAG, dataSource.getFailureCause(), "RNSVG: fetchDecodedImage failed!", new Object[0]);
            }
    ...
    private RectF getRect() {
        double relativeOnWidth = relativeOnWidth(this.f1253mX);
        double relativeOnHeight = relativeOnHeight(this.f1254mY);
        double relativeOnWidth2 = relativeOnWidth(this.f1252mW);
        double relativeOnHeight2 = relativeOnHeight(this.f1251mH);
