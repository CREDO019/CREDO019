...
public class RNFetchBlobUtils {
        ...
        try {
            try {
                ...
                for (int r4 = 0; r4 < length; r4++) {
                    sb.append(String.format("%02x", Integer.valueOf(digest[r4] & 255)));
                }
                return sb.toString();
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public static void emitWarningEvent(String str) {
        ...
        ((DeviceEventManagerModule.RCTDeviceEventEmitter) C0908RNFetchBlob.RCTContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)).emit(RNFetchBlobConst.EVENT_MESSAGE, createMap);
    }
    ...
    public static OkHttpClient.Builder getUnsafeOkHttpClient(OkHttpClient okHttpClient) {
        try {
            ...
            newBuilder.hostnameVerifier(new HostnameVerifier() { // from class: com.RNFetchBlob.RNFetchBlobUtils.2
