...
public final class SafeAreaProvider extends ReactViewGroup implements ViewTreeObserver.OnPreDrawListener {
    ...
    private final void maybeUpdateInsets() {
        ...
        if (function3 == null || (safeAreaInsets = SafeAreaUtils.getSafeAreaInsets((safeAreaProvider = this))) == null) {
            return;
        }
        View rootView = getRootView();
        Objects.requireNonNull(rootView, "null cannot be cast to non-null type android.view.ViewGroup");
        Rect frame = SafeAreaUtils.getFrame((ViewGroup) rootView, safeAreaProvider);
        if (frame == null) {
            return;
        }
