...
public final class Version {
    ...
    private Version(int r5, int[] r6, ECBlocks... eCBlocksArr) {
        ECB[] eCBlocks;
        ...
        for (ECB ecb : eCBlocksArr[0].getECBlocks()) {
            r1 += ecb.getCount() * (ecb.getDataCodewords() + eCCodewordsPerBlock);
        }
    ...
    public static Version decodeVersionInformation(int r5) {
        ...
        while (true) {
            ...
            if (r0 >= r3.length) {
                if (r2 <= 3) {
                    return getVersionForNumber(r1);
                }
                return null;
            }
            int r32 = r3[r0];
            if (r32 == r5) {
                return getVersionForNumber(r0 + 7);
            }
            int numBitsDiffering = FormatInformation.numBitsDiffering(r5, r32);
            if (numBitsDiffering < r2) {
                r1 = r0 + 7;
                r2 = numBitsDiffering;
            }
            r0++;
    ...
    public BitMatrix buildFunctionPattern() {
        ...
        int r4 = dimensionForVersion - 8;
        bitMatrix.setRegion(r4, 0, 8, 9);
        bitMatrix.setRegion(0, r4, 9, 8);
        ...
        for (int r5 = 0; r5 < length; r5++) {
            ...
            for (int r7 = 0; r7 < length; r7++) {
                if ((r5 != 0 || (r7 != 0 && r7 != length - 1)) && (r5 != length - 1 || r7 != 0)) {
                    bitMatrix.setRegion(this.alignmentPatternCenters[r7] - 2, r6, 5, 5);
                }
            }
        }
        int r42 = dimensionForVersion - 17;
        bitMatrix.setRegion(6, 9, 1, r42);
        bitMatrix.setRegion(9, 6, r42, 1);
        if (this.versionNumber > 6) {
            int r0 = dimensionForVersion - 11;
            bitMatrix.setRegion(r0, 0, 3, 6);
            bitMatrix.setRegion(0, r0, 6, 3);
        }
        return bitMatrix;
    }
