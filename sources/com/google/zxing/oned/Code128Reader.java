...
public final class Code128Reader extends OneDReader {
        ...
        while (nextSet < size) {
            if (bitArray.get(nextSet) != z) {
                ...
                if (r6 == 5) {
                    ...
                    int r10 = -1;
                    for (int r9 = 103; r9 <= 105; r9++) {
                        float patternMatchVariance = patternMatchVariance(r3, CODE_PATTERNS[r9], 0.7f);
                        if (patternMatchVariance < f) {
                            r10 = r9;
                            f = patternMatchVariance;
                        }
                    }
                    if (r10 >= 0 && bitArray.isRange(Math.max(0, r4 - ((nextSet - r4) / 2)), r4, false)) {
                        return new int[]{r4, nextSet, r10};
                    }
                    r4 += r3[0] + r3[1];
                    int r92 = r6 - 1;
                    System.arraycopy(r3, 2, r3, 0, r92);
                    r3[r92] = 0;
                    r3[r6] = 0;
                    r6--;
                } else {
    ...
    private static int decodeCode(BitArray bitArray, int[] r4, int r5) throws NotFoundException {
        recordPattern(bitArray, r5, r4);
        float f = MAX_AVG_VARIANCE;
        int r52 = -1;
        int r0 = 0;
        while (true) {
            int[][] r1 = CODE_PATTERNS;
            if (r0 >= r1.length) {
                break;
            }
            float patternMatchVariance = patternMatchVariance(r4, r1[r0], 0.7f);
            if (patternMatchVariance < f) {
                r52 = r0;
                f = patternMatchVariance;
            }
