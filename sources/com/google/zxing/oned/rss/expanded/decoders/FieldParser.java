...
final class FieldParser {
    ...
    private static String processFixedAI(int r2, int r3, String str) throws NotFoundException {
        if (str.length() < r2) {
            throw NotFoundException.getNotFoundInstance();
        }
        ...
        String substring2 = str.substring(r2, r32);
        String str2 = "(" + substring + ')' + substring2;
        String parseFieldsInGeneralPurpose = parseFieldsInGeneralPurpose(str.substring(r32));
    ...
    private static String processVariableAI(int r2, int r3, String str) throws NotFoundException {
        String substring = str.substring(0, r2);
        int r32 = r3 + r2;
        if (str.length() < r32) {
            r32 = str.length();
