...
public final class MultiFormatUPCEANReader extends OneDReader {
    ...
    public Result decodeRow(int r12, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        boolean z;
        int[] findStartGuardPattern = UPCEANReader.findStartGuardPattern(bitArray);
        for (UPCEANReader uPCEANReader : this.readers) {
            try {
                Result decodeRow = uPCEANReader.decodeRow(r12, bitArray, findStartGuardPattern, map);
