...
public final class UPCEWriter extends UPCEANWriter {
    ...
    public boolean[] encode(String str) {
        ...
        int r1 = UPCEReader.NUMSYS_AND_CHECK_DIGIT_PATTERNS[digit][Character.digit(str.charAt(7), 10)];
        boolean[] zArr = new boolean[51];
        int appendPattern = appendPattern(zArr, 0, UPCEANReader.START_END_PATTERN, true) + 0;
        for (int r6 = 1; r6 <= 6; r6++) {
            int digit2 = Character.digit(str.charAt(r6), 10);
            if (((r1 >> (6 - r6)) & 1) == 1) {
                digit2 += 10;
            }
