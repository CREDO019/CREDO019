...
class DetectionResultColumn {
    ...
    public final Codeword getCodewordNearby(int r5) {
        Codeword codeword;
        Codeword codeword2;
        Codeword codeword3 = getCodeword(r5);
        if (codeword3 != null) {
            return codeword3;
        }
        for (int r0 = 1; r0 < 5; r0++) {
            int imageRowToCodewordIndex = imageRowToCodewordIndex(r5) - r0;
            if (imageRowToCodewordIndex >= 0 && (codeword2 = this.codewords[imageRowToCodewordIndex]) != null) {
                return codeword2;
            }
            int imageRowToCodewordIndex2 = imageRowToCodewordIndex(r5) + r0;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void setCodeword(int r2, Codeword codeword) {
        this.codewords[imageRowToCodewordIndex(r2)] = codeword;
    }
    ...
    public String toString() {
        ...
        try {
            ...
            for (Codeword codeword : this.codewords) {
                if (codeword == null) {
                    formatter.format("%3d:    |   %n", Integer.valueOf(r5));
                    r5++;
                } else {
                    formatter.format("%3d: %3d|%3d%n", Integer.valueOf(r5), Integer.valueOf(codeword.getRowNumber()), Integer.valueOf(codeword.getValue()));
                    r5++;
                }
            }
