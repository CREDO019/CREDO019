...
public final class PerspectiveTransform {
    ...
    public void transformPoints(float[] fArr) {
        ...
        float f8 = this.a32;
        float f9 = this.a33;
        for (int r12 = 0; r12 < length; r12 += 2) {
            float f10 = fArr[r12];
            int r14 = r12 + 1;
            float f11 = fArr[r14];
            float f12 = (f3 * f10) + (f6 * f11) + f9;
            fArr[r12] = (((f * f10) + (f4 * f11)) + f7) / f12;
            fArr[r14] = (((f10 * f2) + (f11 * f5)) + f8) / f12;
        }
    }
    ...
    public void transformPoints(float[] fArr, float[] fArr2) {
        ...
        for (int r1 = 0; r1 < length; r1++) {
            ...
            fArr[r1] = (((this.a11 * f) + (this.a21 * f2)) + this.a31) / f3;
            fArr2[r1] = (((this.a12 * f) + (this.a22 * f2)) + this.a32) / f3;
        }
    }
