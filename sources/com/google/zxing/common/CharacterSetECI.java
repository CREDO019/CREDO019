...
public enum CharacterSetECI {
    ...
    static {
        ...
        for (CharacterSetECI characterSetECI : values()) {
            for (int r8 : characterSetECI.values) {
                VALUE_TO_ECI.put(Integer.valueOf(r8), characterSetECI);
            }
    ...
    CharacterSetECI(int r5) {
        this(new int[]{r5}, new String[0]);
    }

    CharacterSetECI(int r3, String... strArr) {
