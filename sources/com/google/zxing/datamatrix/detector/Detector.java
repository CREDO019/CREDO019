...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        int r5 = transitions + 2;
        if ((transitions2 & 1) == 1) {
            transitions2++;
        }
        int r15 = transitions2 + 2;
        if (r5 * 4 >= r15 * 7 || r15 * 4 >= r5 * 7) {
            resultPoint2 = resultPoint13;
            ResultPoint correctTopRightRectangular = correctTopRightRectangular(resultPoint12, resultPoint11, resultPoint13, resultPoint, r5, r15);
            ...
            int r20 = transitions3;
            if ((transitions4 & 1) == 1) {
                transitions4++;
            }
            sampleGrid = sampleGrid(this.image, resultPoint2, resultPoint12, resultPoint11, resultPoint, r20, transitions4);
        } else {
            ResultPoint correctTopRight = correctTopRight(resultPoint12, resultPoint11, resultPoint13, resultPoint, Math.min(r15, r5));
            ...
            int r21 = max;
            sampleGrid = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, resultPoint, r21, r21);
            resultPoint2 = resultPoint13;
        }
        return new DetectorResult(sampleGrid, new ResultPoint[]{resultPoint2, resultPoint12, resultPoint11, resultPoint});
    }

    private ResultPoint correctTopRightRectangular(ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int r10, int r11) {
        float distance = distance(resultPoint, resultPoint2) / r10;
        ...
        float distance3 = distance(resultPoint, resultPoint3) / r11;
        ...
        if (isValid(resultPoint5)) {
            return (isValid(resultPoint6) && Math.abs(r10 - transitionsBetween(resultPoint3, resultPoint5).getTransitions()) + Math.abs(r11 - transitionsBetween(resultPoint2, resultPoint5).getTransitions()) > Math.abs(r10 - transitionsBetween(resultPoint3, resultPoint6).getTransitions()) + Math.abs(r11 - transitionsBetween(resultPoint2, resultPoint6).getTransitions())) ? resultPoint6 : resultPoint5;
    ...
    private ResultPoint correctTopRight(ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int r10) {
        float f = r10;
    ...
    private static BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int r25, int r26) throws NotFoundException {
        float f = r25 - 0.5f;
        float f2 = r26 - 0.5f;
        return GridSampler.getInstance().sampleGrid(bitMatrix, r25, r26, 0.5f, 0.5f, f, 0.5f, f, f2, 0.5f, f2, resultPoint.getX(), resultPoint.getY(), resultPoint4.getX(), resultPoint4.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint2.getX(), resultPoint2.getY());
    }
    ...
    private ResultPointsAndTransitions transitionsBetween(ResultPoint resultPoint, ResultPoint resultPoint2) {
        ...
        return new ResultPointsAndTransitions(resultPoint, resultPoint2, r7);
    }
    ...
    public static final class ResultPointsAndTransitions {
        ...
        /* renamed from: to */
        private final ResultPoint f1219to;
        private final int transitions;

        private ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int r3) {
            this.from = resultPoint;
            this.f1219to = resultPoint2;
            this.transitions = r3;
        }
        ...
        public String toString() {
            return this.from + "/" + this.f1219to + IOUtils.DIR_SEPARATOR_UNIX + this.transitions;
        }
    }
