...
public final class Version {
    ...
    private Version(int r2, int r3, int r4, int r5, int r6, ECBlocks eCBlocks) {
        ECB[] eCBlocks2;
        ...
        for (ECB ecb : eCBlocks.getECBlocks()) {
            r62 += ecb.getCount() * (ecb.getDataCodewords() + eCCodewords);
        }
    ...
    public static Version getVersionForDimensions(int r5, int r6) throws FormatException {
        ...
        for (Version version : VERSIONS) {
            if (version.symbolSizeRows == r5 && version.symbolSizeColumns == r6) {
                return version;
            }
        }
        throw FormatException.getFormatInstance();
    ...
    public static final class ECBlocks {
        ...
        private ECBlocks(int r2, ECB ecb) {
            this.ecCodewords = r2;
            this.ecBlocks = new ECB[]{ecb};
        }

        private ECBlocks(int r2, ECB ecb, ECB ecb2) {
            this.ecCodewords = r2;
