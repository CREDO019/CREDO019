...
public final class Base256Encoder implements Encoder {
    ...
    public void encode(EncoderContext encoderContext) {
        ...
        for (int r1 = 0; r1 < length2; r1++) {
            encoderContext.writeCodeword(randomize255State(sb.charAt(r1), encoderContext.getCodewordCount() + 1));
        }
    }

    private static char randomize255State(char c, int r2) {
        int r1 = c + ((r2 * 149) % 255) + 1;
        return r1 <= 255 ? (char) r1 : (char) (r1 + InputDeviceCompat.SOURCE_ANY);
    }
}
