...
public class C40Encoder implements Encoder {
    ...
    private int backtrackOneCharacter(EncoderContext encoderContext, StringBuilder sb, StringBuilder sb2, int r5) {
        int length = sb.length();
        sb.delete(length - r5, length);
        encoderContext.pos--;
    ...
    private static String encodeToCodewords(CharSequence charSequence, int r5) {
        int charAt = (charSequence.charAt(r5) * 1600) + (charSequence.charAt(r5 + 1) * '(') + charSequence.charAt(r5 + 2) + 1;
