...
public final class URIParsedResult extends ParsedResult {
    ...
    private static boolean isColonFollowedByPortNumber(String str, int r2) {
        int r22 = r2 + 1;
        int indexOf = str.indexOf(47, r22);
        if (indexOf < 0) {
            indexOf = str.length();
        }
        return ResultParser.isSubstringOfDigits(str, r22, indexOf - r22);
    }
}
