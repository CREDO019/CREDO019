...
public final class VEventResultParser extends ResultParser {
    ...
    public CalendarParsedResult parse(Result result) {
        ...
        if (matchVCardPrefixedField != null) {
            for (int r4 = 0; r4 < matchVCardPrefixedField.length; r4++) {
                matchVCardPrefixedField[r4] = stripMailto(matchVCardPrefixedField[r4]);
            }
        }
    ...
    private static String[] matchVCardPrefixedField(CharSequence charSequence, String str, boolean z) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            strArr[r1] = matchVCardPrefixedField.get(r1).get(0);
        }
        return strArr;
    }
