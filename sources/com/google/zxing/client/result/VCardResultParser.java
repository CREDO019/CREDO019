...
public final class VCardResultParser extends ResultParser {
    ...
    public static List<List<String>> matchVCardPrefixedField(CharSequence charSequence, String str, boolean z, boolean z2) {
        ...
        while (r4 < length) {
            ...
            if (group != null) {
                ...
                str3 = null;
                while (r11 < length2) {
                    String str4 = split[r11];
                    if (arrayList == null) {
                        arrayList = new ArrayList(1);
                    }
                    arrayList.add(str4);
                    String[] split2 = EQUALS.split(str4, r8);
                    if (split2.length > 1) {
            ...
            int r2 = end;
            while (true) {
                indexOf = str.indexOf(10, r2);
                if (indexOf < 0) {
                    break;
                }
                if (indexOf < str.length() - 1) {
                    int r32 = indexOf + 1;
                    if (str.charAt(r32) == ' ' || str.charAt(r32) == '\t') {
                        r2 = indexOf + 2;
                    }
                }
                if (!z3) {
        ...
        while (r3 < length) {
            ...
            if (charAt2 != '\n' && charAt2 != '\r') {
                if (charAt2 != '=') {
                    ...
                    sb.append(charAt2);
                } else if (r3 < length - 2 && (charAt = charSequence.charAt(r3 + 1)) != '\r' && charAt != '\n') {
                    r3 += 2;
    ...
    private static void formatNames(Iterable<List<String>> iterable) {
        ...
        if (iterable != null) {
            for (List<String> list : iterable) {
                ...
                int r4 = 0;
                int r5 = 0;
                while (r4 < 4 && (indexOf = str.indexOf(59, r5)) >= 0) {
                    strArr[r4] = str.substring(r5, indexOf);
                    r4++;
                    r5 = indexOf + 1;
                }
                strArr[r4] = str.substring(r5);
    ...
    private static void maybeAppendComponent(String[] strArr, int r2, StringBuilder sb) {
        if (strArr[r2] == null || strArr[r2].isEmpty()) {
            return;
        }
        if (sb.length() > 0) {
            sb.append(' ');
