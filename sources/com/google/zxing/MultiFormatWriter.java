...
public final class MultiFormatWriter implements Writer {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C33651 {
        static final /* synthetic */ int[] $SwitchMap$com$google$zxing$BarcodeFormat;

        static {
            int[] r0 = new int[BarcodeFormat.values().length];
            $SwitchMap$com$google$zxing$BarcodeFormat = r0;
            try {
                r0[BarcodeFormat.EAN_8.ordinal()] = 1;
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int r10, int r11, Map<EncodeHintType, ?> map) throws WriterException {
        Writer eAN8Writer;
        switch (C33651.$SwitchMap$com$google$zxing$BarcodeFormat[barcodeFormat.ordinal()]) {
            case 1:
        ...
        return eAN8Writer.encode(str, barcodeFormat, r10, r11, map);
    }
}
