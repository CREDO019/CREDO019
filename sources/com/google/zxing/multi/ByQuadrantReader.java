...
public final class ByQuadrantReader implements Reader {
    ...
    public Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        try {
            ...
            int r2 = width / 2;
            int r3 = height / 2;
            Result decode4 = this.delegate.decode(binaryBitmap.crop(r2, r3, width, height), map);
            makeAbsolute(decode4.getResultPoints(), r2, r3);
            return decode4;
        }
    }
    ...
    private static void makeAbsolute(ResultPoint[] resultPointArr, int r6, int r7) {
        if (resultPointArr != null) {
            for (int r0 = 0; r0 < resultPointArr.length; r0++) {
                ResultPoint resultPoint = resultPointArr[r0];
                resultPointArr[r0] = new ResultPoint(resultPoint.getX() + r6, resultPoint.getY() + r7);
            }
        }
    }
}
