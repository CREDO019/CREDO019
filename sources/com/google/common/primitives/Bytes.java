...
public final class Bytes {
    ...
    public static int indexOf(byte[] bArr, byte b, int r3, int r4) {
        while (r3 < r4) {
            if (bArr[r3] == b) {
                return r3;
            }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int lastIndexOf(byte[] bArr, byte b, int r3, int r4) {
    ...
    public static byte[] concat(byte[]... bArr) {
        ...
        int r4 = 0;
        for (byte[] bArr4 : bArr) {
            System.arraycopy(bArr4, 0, bArr3, r4, bArr4.length);
            r4 += bArr4.length;
        }
        return bArr3;
    }

    public static byte[] ensureCapacity(byte[] bArr, int r5, int r6) {
        Preconditions.checkArgument(r5 >= 0, "Invalid minLength: %s", r5);
        Preconditions.checkArgument(r6 >= 0, "Invalid padding: %s", r6);
        return bArr.length < r5 ? Arrays.copyOf(bArr, r5 + r6) : bArr;
    }
    ...
    public static byte[] toArray(Collection<? extends Number> collection) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            bArr[r2] = ((Number) Preconditions.checkNotNull(array[r2])).byteValue();
        }
        return bArr;
    }
    ...
    private static class ByteArrayAsList extends AbstractList<Byte> implements RandomAccess, Serializable {
        ...
        ByteArrayAsList(byte[] bArr, int r2, int r3) {
            this.array = bArr;
            this.start = r2;
            this.end = r3;
        }
        ...
        @Override // java.util.AbstractList, java.util.List
        public Byte set(int r4, Byte b) {
            Preconditions.checkElementIndex(r4, size());
            byte[] bArr = this.array;
            int r1 = this.start;
            byte b2 = bArr[r1 + r4];
            bArr[r1 + r4] = ((Byte) Preconditions.checkNotNull(b)).byteValue();
        ...
        public List<Byte> subList(int r4, int r5) {
            ...
            byte[] bArr = this.array;
            int r2 = this.start;
            return new ByteArrayAsList(bArr, r4 + r2, r2 + r5);
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            if (obj instanceof ByteArrayAsList) {
                ...
                for (int r2 = 0; r2 < size; r2++) {
                    if (this.array[this.start + r2] != byteArrayAsList.array[byteArrayAsList.start + r2]) {
                        return false;
                    }
                }
                return true;
        ...
        public int hashCode() {
            ...
            for (int r0 = this.start; r0 < this.end; r0++) {
                r1 = (r1 * 31) + Bytes.hashCode(this.array[r0]);
            }
            return r1;
        }
