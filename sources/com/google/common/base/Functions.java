...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f1133f;

        /* renamed from: g */
        private final Function<B, C> f1134g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f1134g = (Function) Preconditions.checkNotNull(function);
            this.f1133f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        @ParametricNullness
        public C apply(@ParametricNullness A a) {
            return this.f1134g.apply(this.f1133f.apply(a));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            if (obj instanceof FunctionComposition) {
                ...
                return this.f1133f.equals(functionComposition.f1133f) && this.f1134g.equals(functionComposition.f1134g);
            }
            return false;
        }

        public int hashCode() {
            return this.f1133f.hashCode() ^ this.f1134g.hashCode();
        }

        public String toString() {
            String valueOf = String.valueOf(this.f1134g);
            String valueOf2 = String.valueOf(this.f1133f);
