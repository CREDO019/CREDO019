...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m436or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m435or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy(predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m437or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m438in(Collection<? extends T> collection) {
    ...
    public static class AndPredicate<T> implements Predicate<T>, Serializable {
        ...
        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness T t) {
            for (int r1 = 0; r1 < this.components.size(); r1++) {
                if (!this.components.get(r1).apply(t)) {
                    return false;
                }
            }
            return true;
    ...
    public static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f1135f;

        /* renamed from: p */
        final Predicate<B> f1136p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f1136p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f1135f = (Function) Preconditions.checkNotNull(function);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness A a) {
            return this.f1136p.apply(this.f1135f.apply(a));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            if (obj instanceof CompositionPredicate) {
                ...
                return this.f1135f.equals(compositionPredicate.f1135f) && this.f1136p.equals(compositionPredicate.f1136p);
            }
            return false;
        }

        public int hashCode() {
            return this.f1135f.hashCode() ^ this.f1136p.hashCode();
        }

        public String toString() {
            String valueOf = String.valueOf(this.f1136p);
            String valueOf2 = String.valueOf(this.f1135f);
