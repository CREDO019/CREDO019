...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    private static boolean isSmall(int r1, int r2) {
        return r1 <= 1023 && r2 > (r1 * 4) * 16;
    }
    ...
    /* renamed from: is */
    public static CharMatcher m443is(char c) {
        return new C2695Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length != 0) {
            ...
            return m443is(charSequence.charAt(0));
        }
        return none();
    }
    ...
    /* renamed from: or */
    public CharMatcher mo442or(CharMatcher charMatcher) {
        return new C2696Or(this, charMatcher);
    }
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(r3, bitSet, concat)) { // from class: com.google.common.base.CharMatcher.1
    ...
    private static CharMatcher precomputedPositive(int r2, BitSet bitSet, String str) {
        if (r2 != 0) {
            if (r2 != 1) {
                if (r2 == 2) {
                    char nextSetBit = (char) bitSet.nextSetBit(0);
                    return isEither(nextSetBit, (char) bitSet.nextSetBit(nextSetBit + 1));
                } else if (isSmall(r2, bitSet.length())) {
                    return SmallCharMatcher.from(bitSet, str);
                } else {
                    return new BitSetMatcher(bitSet, str);
                }
            }
            return m443is((char) bitSet.nextSetBit(0));
        }
        return none();
    }

    void setBits(BitSet bitSet) {
        for (int r0 = 65535; r0 >= 0; r0--) {
            if (matches((char) r0)) {
                bitSet.set(r0);
            }
        }
    ...
    public int indexIn(CharSequence charSequence, int r4) {
        int length = charSequence.length();
        Preconditions.checkPositionIndex(r4, length);
        while (r4 < length) {
            if (matches(charSequence.charAt(r4))) {
                return r4;
            }
            r4++;
        }
    ...
    public int countIn(CharSequence charSequence) {
        ...
        for (int r0 = 0; r0 < charSequence.length(); r0++) {
            if (matches(charSequence.charAt(r0))) {
                r1++;
            }
        }
        return r1;
    ...
    public String removeFrom(CharSequence charSequence) {
        ...
        while (true) {
            ...
            while (indexIn != charArray.length) {
                ...
                charArray[indexIn - r2] = charArray[indexIn];
                indexIn++;
            }
            return new String(charArray, 0, indexIn - r2);
            r2++;
        }
    }
    ...
    public String replaceFrom(CharSequence charSequence, CharSequence charSequence2) {
        ...
        do {
            sb.append((CharSequence) charSequence3, r1, indexIn);
            sb.append(charSequence2);
            r1 = indexIn + 1;
            indexIn = indexIn(charSequence3, r1);
        } while (indexIn != -1);
        sb.append((CharSequence) charSequence3, r1, length2);
        return sb.toString();
    }
    ...
    public String trimFrom(CharSequence charSequence) {
        int length = charSequence.length();
        int r1 = 0;
        while (r1 < length && matches(charSequence.charAt(r1))) {
            r1++;
        }
        int r0 = length - 1;
        while (r0 > r1 && matches(charSequence.charAt(r0))) {
            r0--;
        }
        return charSequence.subSequence(r1, r0 + 1).toString();
    }

    public String trimLeadingFrom(CharSequence charSequence) {
        int length = charSequence.length();
        for (int r1 = 0; r1 < length; r1++) {
            if (!matches(charSequence.charAt(r1))) {
    ...
    public String collapseFrom(CharSequence charSequence, char c) {
        ...
        while (r1 < length) {
            ...
            if (matches(charAt)) {
                if (charAt != c || (r1 != length - 1 && matches(charSequence.charAt(r1 + 1)))) {
                    StringBuilder sb = new StringBuilder(length);
                    sb.append(charSequence, 0, r1);
                    sb.append(c);
                    return finishCollapseFrom(charSequence, r1 + 1, length, c, sb, true);
                }
                r1++;
            }
            r1++;
    ...
    public String trimAndCollapseFrom(CharSequence charSequence, char c) {
        ...
        int r1 = length - 1;
        int r5 = 0;
        while (r5 < length && matches(charSequence.charAt(r5))) {
            r5++;
        }
        int r0 = r1;
        while (r0 > r5 && matches(charSequence.charAt(r0))) {
            r0--;
        }
        if (r5 == 0 && r0 == r1) {
        ...
        int r6 = r0 + 1;
        return finishCollapseFrom(charSequence, r5, r6, c, new StringBuilder(r6 - r5), false);
    }

    private String finishCollapseFrom(CharSequence charSequence, int r4, int r5, char c, StringBuilder sb, boolean z) {
        while (r4 < r5) {
    ...
    public static String showCharacter(char c) {
        ...
        for (int r1 = 0; r1 < 4; r1++) {
            cArr[5 - r1] = "0123456789ABCDEF".charAt(c & 15);
            c = (char) (c >> 4);
        }
    ...
    public static final class Any extends NamedFastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public int indexIn(CharSequence charSequence, int r2) {
            int length = charSequence.length();
            Preconditions.checkPositionIndex(r2, length);
            if (r2 == length) {
                return -1;
            }
            return r2;
    ...
    public static final class None extends NamedFastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public int indexIn(CharSequence charSequence, int r2) {
            Preconditions.checkPositionIndex(r2, charSequence.length());
            return -1;
        }
    ...
    private static class RangesMatcher extends CharMatcher {
        ...
        RangesMatcher(String str, char[] cArr, char[] cArr2) {
            ...
            while (r5 < cArr.length) {
                Preconditions.checkArgument(cArr[r5] <= cArr2[r5]);
                int r0 = r5 + 1;
                if (r0 < cArr.length) {
                    Preconditions.checkArgument(cArr2[r5] < cArr[r0]);
                }
                r5 = r0;
            }
        }
        ...
        public boolean matches(char c) {
            ...
            int r0 = (~binarySearch) - 1;
            return r0 >= 0 && c <= this.rangeEnds[r0];
        }
    ...
    private static final class Digit extends RangesMatcher {
        ...
        private static char[] nines() {
            ...
            for (int r2 = 0; r2 < 37; r2++) {
                cArr[r2] = (char) (ZEROES.charAt(r2) + '\t');
            }
            return cArr;
        }
    ...
    /* loaded from: classes3.dex */
    public static final class C2696Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C2696Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* loaded from: classes3.dex */
    public static final class C2695Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo442or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo442or(charMatcher);
        }
