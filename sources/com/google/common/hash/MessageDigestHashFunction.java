...
final class MessageDigestHashFunction extends AbstractHashFunction implements Serializable {
    ...
    MessageDigestHashFunction(String str, int r4, String str2) {
        this.toString = (String) Preconditions.checkNotNull(str2);
        MessageDigest messageDigest = getMessageDigest(str);
        this.prototype = messageDigest;
        int digestLength = messageDigest.getDigestLength();
        Preconditions.checkArgument(r4 >= 4 && r4 <= digestLength, "bytes (%s) must be >= 4 and < %s", r4, digestLength);
        this.bytes = r4;
        this.supportsClone = supportsClone(messageDigest);
    }
    ...
    private static final class SerializedForm implements Serializable {
        ...
        private SerializedForm(String str, int r2, String str2) {
    ...
    private static final class MessageDigestHasher extends AbstractByteHasher {
        ...
        private MessageDigestHasher(MessageDigest messageDigest, int r2) {
        ...
        @Override // com.google.common.hash.AbstractByteHasher
        protected void update(byte[] bArr, int r3, int r4) {
            checkNotDone();
