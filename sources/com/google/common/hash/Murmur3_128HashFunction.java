...
public final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public Murmur3_128HashFunction(int r1) {
        this.seed = r1;
    }
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f1164C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f1165C2 = 5545529020109919103L;
        private static final int CHUNK_SIZE = 16;

        /* renamed from: h1 */
        private long f1166h1;

        /* renamed from: h2 */
        private long f1167h2;
        private int length;
        ...
        private void bmix64(long j, long j2) {
            long mixK1 = mixK1(j) ^ this.f1166h1;
            this.f1166h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            long j3 = this.f1167h2;
            this.f1166h1 = ((rotateLeft + j3) * 5) + 1390208809;
            long mixK2 = mixK2(j2) ^ j3;
            this.f1167h2 = mixK2;
            this.f1167h2 = ((Long.rotateLeft(mixK2, 31) + this.f1166h1) * 5) + 944331445;
        }
        ...
        protected void processRemaining(ByteBuffer byteBuffer) {
            ...
            switch (byteBuffer.remaining()) {
                case 1:
                    ...
                    this.f1166h1 ^= mixK1(j7);
                    this.f1167h2 ^= mixK2(j15);
                    return;
                case 2:
                    j2 = 0;
        ...
        protected HashCode makeHash() {
            ...
            int r2 = this.length;
            long j2 = j ^ r2;
            long j3 = this.f1167h2 ^ r2;
            long j4 = j2 + j3;
            this.f1166h1 = j4;
            this.f1167h2 = j3 + j4;
            this.f1166h1 = fmix64(j4);
            long fmix64 = fmix64(this.f1167h2);
            long j5 = this.f1166h1 + fmix64;
            this.f1166h1 = j5;
            this.f1167h2 = fmix64 + j5;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f1166h1).putLong(this.f1167h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f1164C1, 31) * f1165C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f1165C2, 33) * f1164C1;
        }
    }
}
