...
abstract class AbstractCompositeHashFunction extends AbstractHashFunction {
    ...
    public Hasher newHasher() {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            hasherArr[r2] = this.functions[r2].newHasher();
        }
        return fromHashers(hasherArr);
    }

    @Override // com.google.common.hash.AbstractHashFunction, com.google.common.hash.HashFunction
    public Hasher newHasher(int r5) {
        Preconditions.checkArgument(r5 >= 0);
        int length = this.functions.length;
        Hasher[] hasherArr = new Hasher[length];
        for (int r0 = 0; r0 < length; r0++) {
            hasherArr[r0] = this.functions[r0].newHasher(r5);
        }
        return fromHashers(hasherArr);
    }
