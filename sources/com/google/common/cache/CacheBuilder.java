...
public final class CacheBuilder<K, V> {
    ...
    static final Supplier<? extends AbstractCache.StatsCounter> NULL_STATS_COUNTER = Suppliers.ofInstance(new AbstractCache.StatsCounter() { // from class: com.google.common.cache.CacheBuilder.1
        ...
        @Override // com.google.common.cache.AbstractCache.StatsCounter
        public void recordMisses(int r1) {
        }
    ...
    public CacheBuilder<K, V> initialCapacity(int r6) {
        int r0 = this.initialCapacity;
        Preconditions.checkState(r0 == -1, "initial capacity was already set to %s", r0);
        Preconditions.checkArgument(r6 >= 0);
        this.initialCapacity = r6;
        return this;
    }
    ...
    public CacheBuilder<K, V> concurrencyLevel(int r6) {
        int r0 = this.concurrencyLevel;
        Preconditions.checkState(r0 == -1, "concurrency level was already set to %s", r0);
        Preconditions.checkArgument(r6 > 0);
        this.concurrencyLevel = r6;
        return this;
    }
    ...
    public String toString() {
        ...
        int r1 = this.initialCapacity;
        if (r1 != -1) {
            stringHelper.add("initialCapacity", r1);
        }
        int r12 = this.concurrencyLevel;
        if (r12 != -1) {
            stringHelper.add("concurrencyLevel", r12);
        }
        long j = this.maximumSize;
        if (j != -1) {
