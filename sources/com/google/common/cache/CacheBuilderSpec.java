...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m431on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m431on('=').trimResults();
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C27281.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                newBuilder.weakKeys();
            } else {
        ...
        if (this.valueStrength != null) {
            int r1 = C27281.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (r1 == 1) {
    ...
    public static /* synthetic */ class C27281 {
        ...
        static {
            int[] r0 = new int[LocalCache.Strength.values().length];
            $SwitchMap$com$google$common$cache$LocalCache$Strength = r0;
            try {
                r0[LocalCache.Strength.WEAK.ordinal()] = 1;
    ...
    static abstract class IntegerParser implements ValueParser {
        protected abstract void parseInteger(CacheBuilderSpec cacheBuilderSpec, int r2);
    ...
    static class InitialCapacityParser extends IntegerParser {
        ...
        protected void parseInteger(CacheBuilderSpec cacheBuilderSpec, int r5) {
            ...
            cacheBuilderSpec.initialCapacity = Integer.valueOf(r5);
        }
    }
    ...
    static class ConcurrencyLevelParser extends IntegerParser {
        ...
        protected void parseInteger(CacheBuilderSpec cacheBuilderSpec, int r5) {
            ...
            cacheBuilderSpec.concurrencyLevel = Integer.valueOf(r5);
        }
    }
