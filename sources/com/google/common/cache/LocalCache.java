...
public class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final Queue<?> DISCARDING_QUEUE = new AbstractQueue<Object>() { // from class: com.google.common.cache.LocalCache.2
        ...
        public Iterator<Object> iterator() {
            return ImmutableSet.m362of().iterator();
        }
    };
    ...
    public enum Strength {
        STRONG { // from class: com.google.common.cache.LocalCache.Strength.1
            ...
            <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v, int r4) {
                if (r4 == 1) {
                    return new StrongValueReference(v);
                }
                return new WeightedStrongValueReference(v, r4);
            }
        ...
        SOFT { // from class: com.google.common.cache.LocalCache.Strength.2
            @Override // com.google.common.cache.LocalCache.Strength
            <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v, int r5) {
                if (r5 == 1) {
                    return new SoftValueReference(segment.valueReferenceQueue, v, referenceEntry);
                }
                return new WeightedSoftValueReference(segment.valueReferenceQueue, v, referenceEntry, r5);
            }
        ...
        WEAK { // from class: com.google.common.cache.LocalCache.Strength.3
            ...
            <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v, int r5) {
                ...
                return new WeightedWeakValueReference(segment.valueReferenceQueue, v, referenceEntry, r5);
            }
        ...
        abstract <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v, int r4);
    }
    ...
    LocalCache(CacheBuilder<? super K, ? super V> cacheBuilder, @NullableDecl CacheLoader<? super K, V> cacheLoader) {
        ...
        int r2 = 1;
        int r3 = 0;
        while (r2 < this.concurrencyLevel && (!evictsBySize() || r2 * 20 <= this.maxWeight)) {
            r3++;
            r2 <<= 1;
        }
        this.segmentShift = 32 - r3;
        this.segmentMask = r2 - 1;
        this.segments = newSegmentArray(r2);
        int r32 = min / r2;
        while (r1 < (r32 * r2 < min ? r32 + 1 : r32)) {
            r1 <<= 1;
        }
        if (evictsBySize()) {
            ...
            while (true) {
                ...
                segmentArr[r0] = createSegment(r1, j3, cacheBuilder.getStatsCounterSupplier().get());
                r0++;
            }
        } else {
            while (true) {
                Segment<K, V>[] segmentArr2 = this.segments;
                if (r0 >= segmentArr2.length) {
                    return;
                }
                segmentArr2[r0] = createSegment(r1, -1L, cacheBuilder.getStatsCounterSupplier().get());
                r0++;
            }
        }
    }
    ...
    public enum EntryFactory {
        STRONG { // from class: com.google.common.cache.LocalCache.EntryFactory.1
            ...
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
                return new StrongEntry(k, r3, referenceEntry);
            }
        },
        STRONG_ACCESS { // from class: com.google.common.cache.LocalCache.EntryFactory.2
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
                return new StrongAccessEntry(k, r3, referenceEntry);
            }
        ...
        STRONG_WRITE { // from class: com.google.common.cache.LocalCache.EntryFactory.3
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
                return new StrongWriteEntry(k, r3, referenceEntry);
            }
        ...
        STRONG_ACCESS_WRITE { // from class: com.google.common.cache.LocalCache.EntryFactory.4
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
                return new StrongAccessWriteEntry(k, r3, referenceEntry);
            }
        ...
        WEAK { // from class: com.google.common.cache.LocalCache.EntryFactory.5
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r4, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
                return new WeakEntry(segment.keyReferenceQueue, k, r4, referenceEntry);
            }
        },
        WEAK_ACCESS { // from class: com.google.common.cache.LocalCache.EntryFactory.6
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r4, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
                return new WeakAccessEntry(segment.keyReferenceQueue, k, r4, referenceEntry);
            }
        ...
        WEAK_WRITE { // from class: com.google.common.cache.LocalCache.EntryFactory.7
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r4, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
                return new WeakWriteEntry(segment.keyReferenceQueue, k, r4, referenceEntry);
            }
        ...
        WEAK_ACCESS_WRITE { // from class: com.google.common.cache.LocalCache.EntryFactory.8
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r4, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
                return new WeakAccessWriteEntry(segment.keyReferenceQueue, k, r4, referenceEntry);
            }
        ...
        abstract <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry);
    ...
    static class StrongEntry<K, V> extends AbstractReferenceEntry<K, V> {
        ...
        StrongEntry(K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            this.key = k;
            this.hash = r3;
    ...
    static final class StrongAccessEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongAccessEntry(K k, int r2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(k, r2, referenceEntry);
    ...
    static final class StrongWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongWriteEntry(K k, int r2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(k, r2, referenceEntry);
    ...
    static final class StrongAccessWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongAccessWriteEntry(K k, int r2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(k, r2, referenceEntry);
            this.accessTime = Long.MAX_VALUE;
            this.nextAccess = LocalCache.nullEntry();
            this.previousAccess = LocalCache.nullEntry();
    ...
    static class WeakEntry<K, V> extends WeakReference<K> implements ReferenceEntry<K, V> {
        ...
        WeakEntry(ReferenceQueue<K> referenceQueue, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
    ...
    static final class WeakAccessEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakAccessEntry(ReferenceQueue<K> referenceQueue, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k, r3, referenceEntry);
            this.accessTime = Long.MAX_VALUE;
            this.nextAccess = LocalCache.nullEntry();
            this.previousAccess = LocalCache.nullEntry();
        }
    ...
    static final class WeakWriteEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakWriteEntry(ReferenceQueue<K> referenceQueue, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k, r3, referenceEntry);
            this.writeTime = Long.MAX_VALUE;
            this.nextWrite = LocalCache.nullEntry();
            this.previousWrite = LocalCache.nullEntry();
    ...
    static final class WeakAccessWriteEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakAccessWriteEntry(ReferenceQueue<K> referenceQueue, K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k, r3, referenceEntry);
            this.accessTime = Long.MAX_VALUE;
            this.nextAccess = LocalCache.nullEntry();
            this.previousAccess = LocalCache.nullEntry();
    ...
    static final class WeightedWeakValueReference<K, V> extends WeakValueReference<K, V> {
        ...
        WeightedWeakValueReference(ReferenceQueue<V> referenceQueue, V v, ReferenceEntry<K, V> referenceEntry, int r4) {
    ...
    static final class WeightedSoftValueReference<K, V> extends SoftValueReference<K, V> {
        ...
        WeightedSoftValueReference(ReferenceQueue<V> referenceQueue, V v, ReferenceEntry<K, V> referenceEntry, int r4) {
            super(referenceQueue, v, referenceEntry);
            this.weight = r4;
        }
    ...
    static final class WeightedStrongValueReference<K, V> extends StrongValueReference<K, V> {
        ...
        WeightedStrongValueReference(V v, int r2) {
            super(v);
            this.weight = r2;
        }
    ...
    ReferenceEntry<K, V> newEntry(K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
        Segment<K, V> segmentFor = segmentFor(r3);
        segmentFor.lock();
        try {
            return segmentFor.newEntry(k, r3, referenceEntry);
        } finally {
            segmentFor.unlock();
        }
    }
    ...
    ValueReference<K, V> newValueReference(ReferenceEntry<K, V> referenceEntry, V v, int r5) {
        return this.valueStrength.referenceValue(segmentFor(referenceEntry.getHash()), referenceEntry, Preconditions.checkNotNull(v), r5);
    }
    ...
    Segment<K, V> segmentFor(int r3) {
        return this.segments[(r3 >>> this.segmentShift) & this.segmentMask];
    }

    Segment<K, V> createSegment(int r8, long j, AbstractCache.StatsCounter statsCounter) {
        return new Segment<>(this, r8, j, statsCounter);
    }
    ...
    final Segment<K, V>[] newSegmentArray(int r1) {
    ...
    public static class Segment<K, V> extends ReentrantLock {
        ...
        Segment(LocalCache<K, V> localCache, int r3, long j, AbstractCache.StatsCounter statsCounter) {
        ...
        AtomicReferenceArray<ReferenceEntry<K, V>> newEntryArray(int r2) {
        ...
        void initTable(AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray) {
            ...
            if (!this.map.customWeigher()) {
                int r0 = this.threshold;
                if (r0 == this.maxSegmentWeight) {
                    this.threshold = r0 + 1;
                }
            }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        ReferenceEntry<K, V> newEntry(K k, int r3, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            return this.map.entryFactory.newEntry(this, Preconditions.checkNotNull(k), r3, referenceEntry);
        }
        ...
        V get(K k, int r11, CacheLoader<? super K, V> cacheLoader) throws ExecutionException {
            ReferenceEntry<K, V> entry;
            Preconditions.checkNotNull(k);
            Preconditions.checkNotNull(cacheLoader);
            try {
                try {
                    if (this.count != 0 && (entry = getEntry(k, r11)) != null) {
                        long read = this.map.ticker.read();
                        V liveValue = getLiveValue(entry, read);
                        if (liveValue != null) {
                            recordRead(entry, read);
                            this.statsCounter.recordHits(1);
                            return scheduleRefresh(entry, k, r11, liveValue, read, cacheLoader);
                        }
                    ...
                    return lockedGetOrLoad(k, r11, cacheLoader);
        ...
        @NullableDecl
        V get(Object obj, int r12) {
            try {
                if (this.count != 0) {
                    long read = this.map.ticker.read();
                    ReferenceEntry<K, V> liveEntry = getLiveEntry(obj, r12, read);
                    if (liveEntry == null) {
                        return null;
                    }
                    ...
                    if (v != null) {
                        ...
                        return scheduleRefresh(liveEntry, liveEntry.getKey(), r12, v, read, this.map.defaultLoader);
                    }
        ...
        V lockedGetOrLoad(K k, int r19, CacheLoader<? super K, V> cacheLoader) throws ExecutionException {
            ...
            try {
                ...
                int r10 = this.count - 1;
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
                int length = r19 & (atomicReferenceArray.length() - 1);
                ...
                while (true) {
                    ...
                    if (referenceEntry2.getHash() != r19 || key == null || !this.map.keyEquivalence.equivalent(k, key)) {
                        ...
                        if (valueReference2.isLoading()) {
                            ...
                            if (v == null) {
                                enqueueNotification(key, r19, v, valueReference2.getWeight(), RemovalCause.COLLECTED);
                            } else if (this.map.isExpired(referenceEntry2, read)) {
                                enqueueNotification(key, r19, v, valueReference2.getWeight(), RemovalCause.EXPIRED);
                            } else {
                ...
                if (z) {
                    ...
                    if (referenceEntry2 == null) {
                        referenceEntry2 = newEntry(k, r19, referenceEntry);
                ...
                if (z) {
                    try {
                        synchronized (referenceEntry2) {
                            loadSync = loadSync(k, r19, loadingValueReference, cacheLoader);
                        }
                        return loadSync;
                    } finally {
        ...
        V loadSync(K k, int r2, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> cacheLoader) throws ExecutionException {
            return getAndRecordStats(k, r2, loadingValueReference, loadingValueReference.loadFuture(k, cacheLoader));
        }

        ListenableFuture<V> loadAsync(final K k, final int r9, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> cacheLoader) {
            ...
            loadFuture.addListener(new Runnable() { // from class: com.google.common.cache.LocalCache.Segment.1
                ...
                public void run() {
                    try {
                        Segment.this.getAndRecordStats(k, r9, loadingValueReference, loadFuture);
                    } catch (Throwable th) {
        ...
        V getAndRecordStats(K k, int r6, LoadingValueReference<K, V> loadingValueReference, ListenableFuture<V> listenableFuture) throws ExecutionException {
            V v;
            try {
            ...
            try {
                ...
                storeLoadedValue(k, r6, loadingValueReference, v);
                if (v == null) {
                    this.statsCounter.recordLoadException(loadingValueReference.elapsedNanos());
                    removeLoadingValue(k, r6, loadingValueReference);
                }
                return v;
            } catch (Throwable th2) {
                th = th2;
        ...
        V scheduleRefresh(ReferenceEntry<K, V> referenceEntry, K k, int r6, V v, long j, CacheLoader<? super K, V> cacheLoader) {
            V refresh;
            return (!this.map.refreshes() || j - referenceEntry.getWriteTime() <= this.map.refreshNanos || referenceEntry.getValueReference().isLoading() || (refresh = refresh(k, r6, cacheLoader, true)) == null) ? v : refresh;
        }

        @NullableDecl
        V refresh(K k, int r3, CacheLoader<? super K, V> cacheLoader, boolean z) {
            LoadingValueReference<K, V> insertLoadingValueReference = insertLoadingValueReference(k, r3, z);
            if (insertLoadingValueReference == null) {
                return null;
            }
            ListenableFuture<V> loadAsync = loadAsync(k, r3, insertLoadingValueReference, cacheLoader);
            if (loadAsync.isDone()) {
                try {
        ...
        @NullableDecl
        LoadingValueReference<K, V> insertLoadingValueReference(K k, int r10, boolean z) {
            lock();
            try {
                long read = this.map.ticker.read();
                preWriteCleanup(read);
                ...
                for (ReferenceEntry<K, V> referenceEntry2 = referenceEntry; referenceEntry2 != null; referenceEntry2 = referenceEntry2.getNext()) {
                    K key = referenceEntry2.getKey();
                    if (referenceEntry2.getHash() == r10 && key != null && this.map.keyEquivalence.equivalent(k, key)) {
                ...
                ReferenceEntry<K, V> newEntry = newEntry(k, r10, referenceEntry);
        ...
        void recordWrite(ReferenceEntry<K, V> referenceEntry, int r6, long j) {
            drainRecencyQueue();
            this.totalWeight += r6;
            if (this.map.recordsAccess()) {
                referenceEntry.setAccessTime(j);
        ...
        void enqueueNotification(@NullableDecl K k, int r6, @NullableDecl V v, int r8, RemovalCause removalCause) {
            this.totalWeight -= r8;
        ...
        ReferenceEntry<K, V> getFirst(int r3) {
            AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
            return atomicReferenceArray.get(r3 & (atomicReferenceArray.length() - 1));
        }

        @NullableDecl
        ReferenceEntry<K, V> getEntry(Object obj, int r5) {
            for (ReferenceEntry<K, V> first = getFirst(r5); first != null; first = first.getNext()) {
                if (first.getHash() == r5) {
                    K key = first.getKey();
                    if (key == null) {
                        tryDrainReferenceQueues();
        ...
        @NullableDecl
        ReferenceEntry<K, V> getLiveEntry(Object obj, int r3, long j) {
            ReferenceEntry<K, V> entry = getEntry(obj, r3);
            if (entry == null) {
                return null;
            }
        ...
        boolean containsKey(Object obj, int r6) {
            try {
                if (this.count != 0) {
                    ReferenceEntry<K, V> liveEntry = getLiveEntry(obj, r6, this.map.ticker.read());
                    if (liveEntry == null) {
                        return false;
                    }
            ...
            try {
                if (this.count != 0) {
                    ...
                    for (int r5 = 0; r5 < length; r5++) {
                        for (ReferenceEntry<K, V> referenceEntry = atomicReferenceArray.get(r5); referenceEntry != null; referenceEntry = referenceEntry.getNext()) {
        ...
        @NullableDecl
        V put(K k, int r16, V v, boolean z) {
            int r0;
            lock();
            try {
                long read = this.map.ticker.read();
                ...
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
                int length = r16 & (atomicReferenceArray.length() - 1);
                ReferenceEntry<K, V> referenceEntry = atomicReferenceArray.get(length);
                ReferenceEntry<K, V> referenceEntry2 = referenceEntry;
                while (true) {
                    if (referenceEntry2 != null) {
                        K key = referenceEntry2.getKey();
                        if (referenceEntry2.getHash() != r16 || key == null || !this.map.keyEquivalence.equivalent(k, key)) {
                            referenceEntry2 = referenceEntry2.getNext();
                        } else {
                            ValueReference<K, V> valueReference = referenceEntry2.getValueReference();
                            ...
                            if (v2 != null) {
                                if (z) {
                                    ...
                                    this.modCount++;
                                    enqueueNotification(k, r16, v2, valueReference.getWeight(), RemovalCause.REPLACED);
                            ...
                            if (valueReference.isActive()) {
                                enqueueNotification(k, r16, v2, valueReference.getWeight(), RemovalCause.COLLECTED);
                                setValue(referenceEntry2, k, v, read);
                                r0 = this.count;
                            } else {
                                setValue(referenceEntry2, k, v, read);
                        ...
                        this.modCount++;
                        ReferenceEntry<K, V> newEntry = newEntry(k, r16, referenceEntry);
        ...
        void expand() {
            ...
            for (int r5 = 0; r5 < length; r5++) {
                ReferenceEntry<K, V> referenceEntry = atomicReferenceArray.get(r5);
        ...
        */
        ...
        boolean storeLoadedValue(K k, int r17, LoadingValueReference<K, V> loadingValueReference, V v) {
            lock();
            try {
                long read = this.map.ticker.read();
                preWriteCleanup(read);
                ...
                int r11 = r1;
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
                int length = r17 & (atomicReferenceArray.length() - 1);
                ReferenceEntry<K, V> referenceEntry = atomicReferenceArray.get(length);
                ReferenceEntry<K, V> referenceEntry2 = referenceEntry;
                while (true) {
                    if (referenceEntry2 != null) {
                        K key = referenceEntry2.getKey();
                        if (referenceEntry2.getHash() != r17 || key == null || !this.map.keyEquivalence.equivalent(k, key)) {
                            referenceEntry2 = referenceEntry2.getNext();
                        } else {
                            ValueReference<K, V> valueReference = referenceEntry2.getValueReference();
                            V v2 = valueReference.get();
                            if (loadingValueReference != valueReference && (v2 != null || valueReference == LocalCache.UNSET)) {
                                enqueueNotification(k, r17, v, 0, RemovalCause.REPLACED);
                                return false;
                            }
                            this.modCount++;
                            if (loadingValueReference.isActive()) {
                                enqueueNotification(k, r17, v2, loadingValueReference.getWeight(), v2 == null ? RemovalCause.COLLECTED : RemovalCause.REPLACED);
                                r11--;
                            }
                            setValue(referenceEntry2, k, v, read);
                            this.count = r11;
                        ...
                        this.modCount++;
                        ReferenceEntry<K, V> newEntry = newEntry(k, r17, referenceEntry);
                        setValue(newEntry, k, v, read);
                        atomicReferenceArray.set(length, newEntry);
                        this.count = r11;
                        evictEntries(newEntry);
            ...
            if (this.count != 0) {
                ...
                try {
                    ...
                    for (int r2 = 0; r2 < atomicReferenceArray.length(); r2++) {
                        for (ReferenceEntry<K, V> referenceEntry = atomicReferenceArray.get(r2); referenceEntry != null; referenceEntry = referenceEntry.getNext()) {
                    ...
                    for (int r22 = 0; r22 < atomicReferenceArray.length(); r22++) {
                        atomicReferenceArray.set(r22, null);
                    }
        ...
        @NullableDecl
        ReferenceEntry<K, V> removeValueFromChain(ReferenceEntry<K, V> referenceEntry, ReferenceEntry<K, V> referenceEntry2, @NullableDecl K k, int r10, V v, ValueReference<K, V> valueReference, RemovalCause removalCause) {
            enqueueNotification(k, r10, v, valueReference.getWeight(), removalCause);
            this.writeQueue.remove(referenceEntry2);
            this.accessQueue.remove(referenceEntry2);
            if (valueReference.isLoading()) {
        ...
        boolean reclaimKey(ReferenceEntry<K, V> referenceEntry, int r14) {
            lock();
            try {
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
                int length = (atomicReferenceArray.length() - 1) & r14;
                ReferenceEntry<K, V> referenceEntry2 = atomicReferenceArray.get(length);
                for (ReferenceEntry<K, V> referenceEntry3 = referenceEntry2; referenceEntry3 != null; referenceEntry3 = referenceEntry3.getNext()) {
                    if (referenceEntry3 == referenceEntry) {
                        this.modCount++;
                        atomicReferenceArray.set(length, removeValueFromChain(referenceEntry2, referenceEntry3, referenceEntry3.getKey(), r14, referenceEntry3.getValueReference().get(), referenceEntry3.getValueReference(), RemovalCause.COLLECTED));
                        this.count--;
                        return true;
                    }
                }
        ...
        boolean reclaimValue(K k, int r14, ValueReference<K, V> valueReference) {
            lock();
            try {
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
                int length = (atomicReferenceArray.length() - 1) & r14;
                ...
                for (ReferenceEntry<K, V> referenceEntry2 = referenceEntry; referenceEntry2 != null; referenceEntry2 = referenceEntry2.getNext()) {
                    K key = referenceEntry2.getKey();
                    if (referenceEntry2.getHash() == r14 && key != null && this.map.keyEquivalence.equivalent(k, key)) {
                        ...
                        this.modCount++;
                        atomicReferenceArray.set(length, removeValueFromChain(referenceEntry, referenceEntry2, key, r14, valueReference.get(), valueReference, RemovalCause.COLLECTED));
                        this.count--;
                        return true;
                    }
                }
        ...
        boolean removeLoadingValue(K k, int r10, LoadingValueReference<K, V> loadingValueReference) {
            lock();
            try {
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
                int length = (atomicReferenceArray.length() - 1) & r10;
        ...
        boolean removeEntry(ReferenceEntry<K, V> referenceEntry, int r14, RemovalCause removalCause) {
            AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
            int length = (atomicReferenceArray.length() - 1) & r14;
            ReferenceEntry<K, V> referenceEntry2 = atomicReferenceArray.get(length);
            for (ReferenceEntry<K, V> referenceEntry3 = referenceEntry2; referenceEntry3 != null; referenceEntry3 = referenceEntry3.getNext()) {
                if (referenceEntry3 == referenceEntry) {
                    this.modCount++;
                    atomicReferenceArray.set(length, removeValueFromChain(referenceEntry2, referenceEntry3, referenceEntry3.getKey(), r14, referenceEntry3.getValueReference().get(), referenceEntry3.getValueReference(), removalCause));
                    this.count--;
                    return true;
                }
            }
    ...
    ImmutableMap<K, V> getAllPresent(Iterable<?> iterable) {
        ...
        this.globalStatsCounter.recordHits(r1);
        this.globalStatsCounter.recordMisses(r2);
    ...
    ImmutableMap<K, V> getAll(Iterable<? extends K> iterable) throws ExecutionException {
        ...
        try {
            ...
            this.globalStatsCounter.recordHits(r2);
            this.globalStatsCounter.recordMisses(r3);
        }
    }
    ...
    */
    ...
    public boolean containsValue(@NullableDecl Object obj) {
        ...
        while (r8 < 3) {
            ...
            while (r12 < length) {
                ...
                int r14 = segment.count;
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = segment.table;
                for (int r15 = 0; r15 < atomicReferenceArray.length(); r15++) {
    ...
    public abstract class HashIterator<T> implements Iterator<T> {
        ...
        final void advance() {
            ...
            while (this.nextSegmentIndex >= 0) {
                ...
                Segment<K, V> segment = segmentArr[r1];
        ...
        boolean nextInTable() {
            while (true) {
                ...
                ReferenceEntry<K, V> referenceEntry = atomicReferenceArray.get(r0);
    ...
    static class ManualSerializationProxy<K, V> extends ForwardingCache<K, V> implements Serializable {
        ...
        private ManualSerializationProxy(Strength strength, Strength strength2, Equivalence<Object> equivalence, Equivalence<Object> equivalence2, long j, long j2, long j3, Weigher<K, V> weigher, int r12, RemovalListener<? super K, ? super V> removalListener, Ticker ticker, CacheLoader<? super K, V> cacheLoader) {
