...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    public final double roundToDouble(X x, RoundingMode roundingMode) {
        ...
        if (Double.isInfinite(roundToDoubleArbitrarily)) {
            switch (C30921.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
        ...
        switch (C30921.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
                ...
                int r14 = C30921.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (r14 == 2) {
    ...
    static /* synthetic */ class C30921 {
        ...
        static {
            ...
            try {
                r0[RoundingMode.DOWN.ordinal()] = 1;
