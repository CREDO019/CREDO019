...
final class MathPreconditions {
    ...
    public static int checkPositive(String str, int r4) {
        if (r4 > 0) {
            return r4;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int checkNonNegative(String str, int r4) {
        if (r4 >= 0) {
            return r4;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void checkNoOverflow(boolean z, String str, int r4, int r5) {
        if (z) {
            return;
        }
        StringBuilder sb = new StringBuilder(String.valueOf(str).length() + 36);
