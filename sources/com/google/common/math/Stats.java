...
public final class Stats implements Serializable {
    ...
    /* renamed from: of */
    public static Stats m289of(Iterable<? extends Number> iterable) {
    ...
    /* renamed from: of */
    public static Stats m288of(Iterator<? extends Number> it) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m287of(double... dArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m286of(int... r1) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(r1);
        return statsAccumulator.snapshot();
    }

    /* renamed from: of */
    public static Stats m285of(long... jArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    public static double meanOf(double... dArr) {
        ...
        for (int r2 = 1; r2 < dArr.length; r2++) {
            double d2 = dArr[r2];
            d = (Doubles.isFinite(d2) && Doubles.isFinite(d)) ? d + ((d2 - d) / (r2 + 1)) : StatsAccumulator.calculateNewMeanNonFinite(d, d2);
        }
        return d;
    }

    public static double meanOf(int... r7) {
        Preconditions.checkArgument(r7.length > 0);
        double d = r7[0];
        for (int r2 = 1; r2 < r7.length; r2++) {
            double d2 = r7[r2];
            d = (Doubles.isFinite(d2) && Doubles.isFinite(d)) ? d + ((d2 - d) / (r2 + 1)) : StatsAccumulator.calculateNewMeanNonFinite(d, d2);
        }
        return d;
