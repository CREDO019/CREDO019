...
public abstract class Invokable<T, R> implements AnnotatedElement, Member {
    ...
    public final TypeToken<? extends R> getReturnType() {
        return (TypeToken<? extends R>) TypeToken.m255of(getGenericReturnType());
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int r3 = 0; r3 < genericParameterTypes.length; r3++) {
            builder.add((ImmutableList.Builder) new Parameter(this, r3, TypeToken.m255of(genericParameterTypes[r3]), parameterAnnotations[r3]));
        }
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        ...
        for (Type type : getGenericExceptionTypes()) {
            builder.add((ImmutableList.Builder) TypeToken.m255of(type));
        }
        return builder.build();
    }

    public final <R1 extends R> Invokable<T, R1> returning(Class<R1> cls) {
        return returning(TypeToken.m256of((Class) cls));
    }
    ...
    public TypeToken<T> getOwnerType() {
        return TypeToken.m256of((Class) getDeclaringClass());
    }
