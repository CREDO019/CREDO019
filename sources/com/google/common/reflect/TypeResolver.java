...
public final class TypeResolver {
        ...
        new TypeVisitor() { // from class: com.google.common.reflect.TypeResolver.1
            ...
            void visitWildcardType(WildcardType wildcardType) {
                ...
                if (type3 instanceof WildcardType) {
                    ...
                    for (int r9 = 0; r9 < upperBounds.length; r9++) {
                        TypeResolver.populateTypeMappings(map, upperBounds[r9], upperBounds2[r9]);
                    }
                    for (int r6 = 0; r6 < lowerBounds.length; r6++) {
                        TypeResolver.populateTypeMappings(map, lowerBounds[r6], lowerBounds2[r6]);
                    }
                }
            }
            ...
            void visitParameterizedType(ParameterizedType parameterizedType) {
                ...
                for (int r5 = 0; r5 < actualTypeArguments.length; r5++) {
                    TypeResolver.populateTypeMappings(map, actualTypeArguments[r5], actualTypeArguments2[r5]);
                }
            }
    ...
    public Type[] resolveTypesInPlace(Type[] typeArr) {
        for (int r0 = 0; r0 < typeArr.length; r0++) {
            typeArr[r0] = resolveType(typeArr[r0]);
        }
        return typeArr;
    }
    ...
    public Type[] resolveTypes(Type[] typeArr) {
        ...
        for (int r1 = 0; r1 < typeArr.length; r1++) {
            typeArr2[r1] = resolveType(typeArr[r1]);
        }
        return typeArr2;
    }
    ...
    private static final class TypeMappingIntrospector extends TypeVisitor {
        ...
        void visitParameterizedType(ParameterizedType parameterizedType) {
            ...
            for (int r3 = 0; r3 < typeParameters.length; r3++) {
                map(new TypeVariableKey(typeParameters[r3]), actualTypeArguments[r3]);
            }
            visit(cls);
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f1203id;
        ...
        final Type capture(Type type) {
            ...
            if (type instanceof ParameterizedType) {
                ...
                for (int r3 = 0; r3 < actualTypeArguments.length; r3++) {
                    actualTypeArguments[r3] = forTypeVariable(typeParameters[r3]).capture(actualTypeArguments[r3]);
                }
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            int incrementAndGet = this.f1203id.incrementAndGet();
            String join = Joiner.m441on((char) Typography.amp).join(typeArr);
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f1203id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f1203id);
        }
