...
public abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    abstract void collectOneValue(int r1, @ParametricNullness InputT r2);
                    ...
                    public void run() {
                        try {
                            if (next.isCancelled()) {
                                ...
                                AggregateFuture.this.collectValueFromNonCancelledFuture(r0, next);
                            }
                        } finally {
    ...
    public void collectValueFromNonCancelledFuture(int r1, Future<? extends InputT> future) {
        try {
            collectOneValue(r1, Futures.getDone(future));
    ...
    private void processCompleted(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
        if (immutableCollection != null) {
            ...
            while (it.hasNext()) {
                ...
                if (!next.isCancelled()) {
                    collectValueFromNonCancelledFuture(r0, next);
                }
                r0++;
            }
        }
