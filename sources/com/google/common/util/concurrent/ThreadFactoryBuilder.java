...
public final class ThreadFactoryBuilder {
    ...
    public ThreadFactoryBuilder setPriority(int r5) {
        Preconditions.checkArgument(r5 >= 1, "Thread priority (%s) must be >= %s", r5, 1);
        Preconditions.checkArgument(r5 <= 10, "Thread priority (%s) must be <= %s", r5, 10);
