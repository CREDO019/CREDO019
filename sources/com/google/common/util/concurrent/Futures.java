...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    public static <I, O> Future<O> lazyTransform(final Future<I> future, final Function<? super I, ? extends O> function) {
        ...
        return new Future<O>() { // from class: com.google.common.util.concurrent.Futures.2
            ...
            private O applyTransformation(I r2) throws ExecutionException {
                try {
                    return (O) function.apply(r2);
                } catch (Throwable th) {
    ...
    public static <T> ImmutableList<ListenableFuture<T>> inCompletionOrder(Iterable<? extends ListenableFuture<? extends T>> iterable) {
        ...
        for (int r4 = 0; r4 < gwtCompatibleToArray.length; r4++) {
        ...
        for (final int r3 = 0; r3 < gwtCompatibleToArray.length; r3++) {
            gwtCompatibleToArray[r3].addListener(new Runnable() { // from class: com.google.common.util.concurrent.Futures.3
                @Override // java.lang.Runnable
                public void run() {
                    InCompletionOrderState.this.recordInputCompletion(build, r3);
                }
            }, MoreExecutors.directExecutor());
        }
        return build;
    ...
    private static final class InCompletionOrderFuture<T> extends AbstractFuture<T> {
        ...
        public String pendingToString() {
            ...
            if (inCompletionOrderState != null) {
                ...
                int r0 = ((InCompletionOrderState) inCompletionOrderState).incompleteOutputCount.get();
    ...
    public static final class InCompletionOrderState<T> {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void recordInputCompletion(ImmutableList<AbstractFuture<T>> immutableList, int r5) {
            ListenableFuture<? extends T> listenableFuture = this.inputFutures[r5];
            Objects.requireNonNull(listenableFuture);
            this.inputFutures[r5] = null;
            for (int r52 = this.delegateIndex; r52 < immutableList.size(); r52++) {
                if (immutableList.get(r52).setFuture(listenableFuture)) {
                    recordCompletion();
                    this.delegateIndex = r52 + 1;
                    return;
                }
            }
