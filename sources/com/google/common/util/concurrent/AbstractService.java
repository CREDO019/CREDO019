...
public abstract class AbstractService implements Service {
    ...
    public final Service stopAsync() {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C31506.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                    case 1:
    ...
    public final void notifyFailed(Throwable th) {
        ...
        try {
            Service.State state = state();
            int r1 = C31506.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (r1 != 1) {
                if (r1 == 2 || r1 == 3 || r1 == 4) {
