...
public final class Uninterruptibles {
    ...
    public static boolean tryAcquireUninterruptibly(Semaphore semaphore, int r4, long j, TimeUnit timeUnit) {
        boolean z = false;
        try {
            long nanos = timeUnit.toNanos(j);
            while (true) {
            ...
            return semaphore.tryAcquire(r4, nanos, TimeUnit.NANOSECONDS);
        } finally {
            if (z) {
                Thread.currentThread().interrupt();
            }
