...
abstract class AggregateFutureState<OutputT> extends AbstractFuture.TrustedFuture<OutputT> {
    ...
    static /* synthetic */ int access$306(AggregateFutureState aggregateFutureState) {
        int r0 = aggregateFutureState.remaining - 1;
        aggregateFutureState.remaining = r0;
        return r0;
    }
    ...
    public AggregateFutureState(int r2) {
        this.remaining = r2;
    }
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        void compareAndSetSeenExceptions(AggregateFutureState<?> aggregateFutureState, @CheckForNull Set<Throwable> set, Set<Throwable> set2) {
            C0255xc40028dd.m1422m(this.seenExceptionsUpdater, aggregateFutureState, set, set2);
        }
