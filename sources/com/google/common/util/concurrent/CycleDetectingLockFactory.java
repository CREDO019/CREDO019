...
public class CycleDetectingLockFactory {
    ...
    static <E extends Enum<E>> Map<E, LockGraphNode> createNodes(Class<E> cls) {
        ...
        for (int r9 = 1; r9 < length; r9++) {
            ((LockGraphNode) newArrayListWithCapacity.get(r9)).checkAcquiredLocks(Policies.THROW, newArrayListWithCapacity.subList(0, r9));
        }
        while (r4 < length - 1) {
            r4++;
            ((LockGraphNode) newArrayListWithCapacity.get(r4)).checkAcquiredLocks(Policies.DISABLED, newArrayListWithCapacity.subList(r4, length));
        }
    ...
    public static class ExampleStackTrace extends IllegalStateException {
        ...
        static final ImmutableSet<String> EXCLUDED_CLASS_NAMES = ImmutableSet.m359of(CycleDetectingLockFactory.class.getName(), ExampleStackTrace.class.getName(), LockGraphNode.class.getName());
