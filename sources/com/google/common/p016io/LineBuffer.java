    ...
    */
    public void add(char[] r7, int r8, int r9) throws java.io.IOException {
        ...
        L52:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.p016io.LineBuffer.add(char[], int, int):void");
    }

    private boolean finishLine(boolean z) throws IOException {
        handleLine(this.line.toString(), this.sawReturn ? z ? IOUtils.LINE_SEPARATOR_WINDOWS : StringUtils.f1569CR : z ? "\n" : "");
