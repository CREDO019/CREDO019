...
public abstract class ByteSource {
    ...
    public class AsCharSource extends CharSource {
        ...
        @Override // com.google.common.p016io.CharSource
    ...
    public final class SlicedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (sizeIfKnown.isPresent()) {
                ...
                return Optional.m439of(Long.valueOf(Math.min(this.length, longValue - Math.min(this.offset, longValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        ByteArrayByteSource(byte[] bArr, int r2, int r3) {
            this.bytes = bArr;
            this.offset = r2;
            this.length = r3;
        }
        ...
        @Override // com.google.common.p016io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m439of(Long.valueOf(this.length));
        }
        ...
        public byte[] read() {
            ...
            int r1 = this.offset;
            return Arrays.copyOfRange(bArr, r1, this.length + r1);
        }
    ...
    public static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        @Override // com.google.common.p016io.ByteSource.ByteArrayByteSource
        public String toString() {
            return "ByteSource.empty()";
        }
        ...
        @Override // com.google.common.p016io.ByteSource.ByteArrayByteSource, com.google.common.p016io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
    }
    ...
    public static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            for (ByteSource byteSource : iterable) {
                ...
                if (j < 0) {
                    return Optional.m439of(Long.MAX_VALUE);
                }
            }
            return Optional.m439of(Long.valueOf(j));
        }
