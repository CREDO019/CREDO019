...
public final class CharStreams {
    ...
    private static final class NullWriter extends Writer {
        ...
        public void write(char[] cArr, int r2, int r3) {
            Preconditions.checkPositionIndexes(r2, r3 + r2, cArr.length);
        }
        ...
        public void write(String str, int r2, int r3) {
            Preconditions.checkPositionIndexes(r2, r3 + r2, str.length());
        }

        @Override // java.io.Writer, java.lang.Appendable
        public Writer append(@CheckForNull CharSequence charSequence, int r2, int r3) {
            Preconditions.checkPositionIndexes(r2, r3, charSequence == null ? 4 : charSequence.length());
            return this;
        }
    }
