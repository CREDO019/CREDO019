...
final class ReaderInputStream extends InputStream {
    ...
    ReaderInputStream(Reader reader, CharsetEncoder charsetEncoder, int r5) {
        ...
        Preconditions.checkArgument(r5 > 0, "bufferSize must be positive: %s", r5);
        charsetEncoder.reset();
        CharBuffer allocate = CharBuffer.allocate(r5);
        this.charBuffer = allocate;
        Java8Compatibility.flip(allocate);
        this.byteBuffer = ByteBuffer.allocate(r5);
    }
    ...
    */
    public int read(byte[] r8, int r9, int r10) throws java.io.IOException {
        ...
        L21:
            ...
            com.google.common.p016io.Java8Compatibility.clear(r3)
            goto L2e
        L29:
            if (r2 <= 0) goto L2c
            goto L2d
        ...
        L6f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.p016io.ReaderInputStream.read(byte[], int, int):int");
    }
    ...
    private int drain(byte[] bArr, int r3, int r4) {
        int min = Math.min(r4, this.byteBuffer.remaining());
        this.byteBuffer.get(bArr, r3, min);
        return min;
    }
}
