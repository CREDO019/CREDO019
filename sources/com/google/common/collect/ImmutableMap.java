...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m390of() {
        return (ImmutableMap<K, V>) RegularImmutableMap.EMPTY;
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m389of(K k, V v) {
        CollectPreconditions.checkEntryNotNull(k, v);
        return RegularImmutableMap.create(1, new Object[]{k, v});
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m388of(K k, V v, K k2, V v2) {
        CollectPreconditions.checkEntryNotNull(k, v);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m387of(K k, V v, K k2, V v2, K k3, V v3) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m386of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m385of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m384of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m383of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m382of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m381of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m380of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    public static <K, V> Builder<K, V> builderWithExpectedSize(int r1) {
    ...
    public static class Builder<K, V> {
        ...
        public Builder(int r1) {
            this.alternatingKeysAndValues = new Object[r1 * 2];
            this.size = 0;
        ...
        private void ensureCapacity(int r3) {
            ...
            if (r32 > objArr.length) {
                this.alternatingKeysAndValues = Arrays.copyOf(objArr, ImmutableCollection.Builder.expandedCapacity(objArr.length, r32));
                this.entriesUsed = false;
            }
        }
        ...
        public void sortEntries() {
            ...
            if (this.valueComparator != null) {
                ...
                while (true) {
                    ...
                    int r5 = r2 * 2;
                    Object obj = this.alternatingKeysAndValues[r5];
                    Objects.requireNonNull(obj);
                    Object obj2 = this.alternatingKeysAndValues[r5 + 1];
                    Objects.requireNonNull(obj2);
                    entryArr[r2] = new AbstractMap.SimpleImmutableEntry(obj, obj2);
                    r2++;
                }
                Arrays.sort(entryArr, 0, r3, Ordering.from(this.valueComparator).onResultOf(Maps.valueFunction()));
                for (int r1 = 0; r1 < this.size; r1++) {
                    int r32 = r1 * 2;
                    this.alternatingKeysAndValues[r32] = entryArr[r1].getKey();
                    this.alternatingKeysAndValues[r32 + 1] = entryArr[r1].getValue();
                }
            }
        }
    }
    ...
    public ImmutableSetMultimap<K, V> asMultimap() {
        if (isEmpty()) {
            return ImmutableSetMultimap.m355of();
        }
    ...
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
        ...
        public ImmutableSet<V> get(@CheckForNull Object obj) {
            ...
            return ImmutableSet.m361of(obj2);
        }
                ...
                public Map.Entry<K, ImmutableSet<V>> next() {
                    ...
                    return new AbstractMapEntry<K, ImmutableSet<V>>(this) { // from class: com.google.common.collect.ImmutableMap.MapViewOfValuesAsSingletonSets.1.1
                        ...
                        public ImmutableSet<V> getValue() {
                            return ImmutableSet.m361of(entry.getValue());
                        }
                    };
                }
            };
    ...
    static class SerializedForm<K, V> implements Serializable {
        ...
        public SerializedForm(ImmutableMap<K, V> immutableMap) {
            ...
            while (it.hasNext()) {
                ...
                objArr[r2] = next.getKey();
                objArr2[r2] = next.getValue();
                r2++;
            }
            this.keys = objArr;
            this.values = objArr2;
        ...
        final Object legacyReadResolve() {
            ...
            for (int r3 = 0; r3 < objArr.length; r3++) {
                makeBuilder.put((K) objArr[r3], (V) objArr2[r3]);
            }
            return makeBuilder.build();
        }

        Builder<K, V> makeBuilder(int r2) {
