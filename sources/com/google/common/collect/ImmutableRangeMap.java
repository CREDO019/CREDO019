...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m409of(), ImmutableList.m409of());
    private static final long serialVersionUID = 0;
    private final transient ImmutableList<Range<K>> ranges;
    private final transient ImmutableList<V> values;

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m366of() {
        return (ImmutableRangeMap<K, V>) EMPTY;
    }

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m365of(Range<K> range, V v) {
        return new ImmutableRangeMap<>(ImmutableList.m408of(range), ImmutableList.m408of(v));
    }
    ...
    public static final class Builder<K extends Comparable<?>, V> {
        ...
        public ImmutableRangeMap<K, V> build() {
            ...
            for (int r2 = 0; r2 < this.entries.size(); r2++) {
                Range<K> key = this.entries.get(r2).getKey();
                if (r2 > 0) {
                    Range<K> key2 = this.entries.get(r2 - 1).getKey();
                ...
                builder2.add((ImmutableList.Builder) this.entries.get(r2).getValue());
            }
            return new ImmutableRangeMap<>(builder.build(), builder2.build());
        }
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        final int r2 = binarySearch2 - binarySearch;
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(this, new ImmutableList<Range<K>>() { // from class: com.google.common.collect.ImmutableRangeMap.1
            ...
            public Range<K> get(int r3) {
                Preconditions.checkElementIndex(r3, r2);
                return (r3 == 0 || r3 == r2 + (-1)) ? ((Range) ImmutableRangeMap.this.ranges.get(r3 + binarySearch)).intersection(range) : (Range) ImmutableRangeMap.this.ranges.get(r3 + binarySearch);
            }
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> range2) {
                ...
                return ImmutableRangeMap.m366of();
            }
        };
    }
