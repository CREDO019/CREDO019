...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    public static <E> RegularImmutableSortedSet<E> emptySet(Comparator<? super E> comparator) {
        ...
        return new RegularImmutableSortedSet<>(ImmutableList.m409of(), comparator);
    }

    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m314of() {
        return RegularImmutableSortedSet.NATURAL_EMPTY_SET;
    }

    /* JADX WARN: Incorrect types in method signature: <E::Ljava/lang/Comparable<-TE;>;>(TE;)Lcom/google/common/collect/ImmutableSortedSet<TE;>; */
    /* renamed from: of */
    public static ImmutableSortedSet m313of(Comparable comparable) {
        return new RegularImmutableSortedSet(ImmutableList.m408of(comparable), Ordering.natural());
    }
    ...
    /* renamed from: of */
    public static ImmutableSortedSet m311of(Comparable comparable, Comparable comparable2, Comparable comparable3) {
        return construct(Ordering.natural(), 3, comparable, comparable2, comparable3);
    }

    /* JADX WARN: Incorrect types in method signature: <E::Ljava/lang/Comparable<-TE;>;>(TE;TE;TE;TE;)Lcom/google/common/collect/ImmutableSortedSet<TE;>; */
    /* renamed from: of */
    public static ImmutableSortedSet m310of(Comparable comparable, Comparable comparable2, Comparable comparable3, Comparable comparable4) {
        return construct(Ordering.natural(), 4, comparable, comparable2, comparable3, comparable4);
    }

    /* JADX WARN: Incorrect types in method signature: <E::Ljava/lang/Comparable<-TE;>;>(TE;TE;TE;TE;TE;)Lcom/google/common/collect/ImmutableSortedSet<TE;>; */
    /* renamed from: of */
    public static ImmutableSortedSet m309of(Comparable comparable, Comparable comparable2, Comparable comparable3, Comparable comparable4, Comparable comparable5) {
    ...
    /* renamed from: of */
    public static ImmutableSortedSet m308of(Comparable comparable, Comparable comparable2, Comparable comparable3, Comparable comparable4, Comparable comparable5, Comparable comparable6, Comparable... comparableArr) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Multi-variable type inference failed */
    public static <E> ImmutableSortedSet<E> construct(Comparator<? super E> comparator, int r5, E... eArr) {
        if (r5 == 0) {
            return emptySet(comparator);
        }
        ObjectArrays.checkElementsNotNull(eArr, r5);
        Arrays.sort(eArr, 0, r5, comparator);
        int r1 = 1;
        for (int r0 = 1; r0 < r5; r0++) {
            Object obj = (Object) eArr[r0];
            if (comparator.compare(obj, (Object) eArr[r1 - 1]) != 0) {
                eArr[r1] = obj;
                r1++;
            }
        }
        Arrays.fill(eArr, r1, r5, (Object) null);
        if (r1 < eArr.length / 2) {
            eArr = (E[]) Arrays.copyOf(eArr, r1);
        }
        return new RegularImmutableSortedSet(ImmutableList.asImmutableList(eArr, r1), comparator);
    }
