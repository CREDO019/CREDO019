...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    public static <K, V> LinkedListMultimap<K, V> create(int r1) {
        return new LinkedListMultimap<>(r1);
    }
    ...
    private LinkedListMultimap(int r1) {
        this.keyToKeyList = Platform.newHashMapWithExpectedSize(r1);
    }
    ...
    private class NodeIterator implements ListIterator<Map.Entry<K, V>> {
        ...
        NodeIterator(int r4) {
            ...
            Preconditions.checkPositionIndex(r4, size);
            if (r4 >= size / 2) {
    ...
    public class ValueForKeyIterator implements ListIterator<V> {
        ...
        public ValueForKeyIterator(@ParametricNullness K k, int r6) {
            KeyList keyList = (KeyList) LinkedListMultimap.this.keyToKeyList.get(k);
            int r0 = keyList == null ? 0 : keyList.count;
            Preconditions.checkPositionIndex(r6, r0);
            if (r6 >= r0 / 2) {
    ...
    public List<V> get(@ParametricNullness final K k) {
        return new AbstractSequentialList<V>() { // from class: com.google.common.collect.LinkedListMultimap.1
            ...
            public ListIterator<V> listIterator(int r4) {
                return new ValueForKeyIterator(k, r4);
            }
        };
    }
    ...
    public List<V> createValues() {
        return new AbstractSequentialList<V>() { // from class: com.google.common.collect.LinkedListMultimap.1ValuesImpl
            ...
            @Override // java.util.AbstractSequentialList, java.util.AbstractList, java.util.List
            public ListIterator<V> listIterator(int r3) {
                final NodeIterator nodeIterator = new NodeIterator(r3);
    ...
    public List<Map.Entry<K, V>> createEntries() {
        return new AbstractSequentialList<Map.Entry<K, V>>() { // from class: com.google.common.collect.LinkedListMultimap.1EntriesImpl
            ...
            @Override // java.util.AbstractSequentialList, java.util.AbstractList, java.util.List
            public ListIterator<Map.Entry<K, V>> listIterator(int r3) {
                return new NodeIterator(r3);
            }
        };
    }
