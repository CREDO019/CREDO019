...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    public static <K, V> LinkedHashMultimap<K, V> create(int r1, int r2) {
        return new LinkedHashMultimap<>(Maps.capacity(r1), Maps.capacity(r2));
    }
    ...
    public static final class ValueEntry<K, V> extends ImmutableEntry<K, V> implements ValueSetLink<K, V> {
        ...
        ValueEntry(@ParametricNullness K k, @ParametricNullness V v, int r3, @CheckForNull ValueEntry<K, V> valueEntry) {
            super(k, v);
            this.smearedValueHash = r3;
        ...
        boolean matchesValue(@CheckForNull Object obj, int r3) {
            return this.smearedValueHash == r3 && Objects.equal(getValue(), obj);
        }
    ...
    private LinkedHashMultimap(int r1, int r2) {
        super(Platform.newLinkedHashMapWithExpectedSize(r1));
        this.valueSetCapacity = 2;
        CollectPreconditions.checkNonnegative(r2, "expectedValuesPerKey");
        this.valueSetCapacity = r2;
    ...
    public final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        ValueSet(@ParametricNullness K k, int r3) {
            this.key = k;
            this.hashTable = new ValueEntry[Hashing.closedTableSize(r3, 1.0d)];
        }
        ...
        private void rehashIfNecessary() {
            if (Hashing.needsResizing(this.size, this.hashTable.length, 1.0d)) {
                ...
                for (ValueSetLink valueSetLink = (ValueSetLink<K, V>) this.firstEntry; valueSetLink != this; valueSetLink = (ValueSetLink<K, V>) valueSetLink.getSuccessorInValueSet()) {
                    ...
                    int r4 = valueEntry.smearedValueHash & r0;
                    valueEntry.nextInValueBucket = valueEntryArr[r4];
                    valueEntryArr[r4] = valueEntry;
                }
            }
        }
