...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m301of() {
        return (ImmutableTable<R, C, V>) SparseImmutableTable.EMPTY;
    }

    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m300of(R r, C c, V v) {
    ...
    public ImmutableMap<R, V> column(C c) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(c), ImmutableMap.m390of());
    }
    ...
    public ImmutableMap<C, V> row(R r) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(r), ImmutableMap.m390of());
    }
    ...
    static final class SerializedForm implements Serializable {
        ...
        private SerializedForm(Object[] objArr, Object[] objArr2, Object[] objArr3, int[] r4, int[] r5) {
            this.rowKeys = objArr;
            this.columnKeys = objArr2;
            this.cellValues = objArr3;
            this.cellRowIndices = r4;
            this.cellColumnIndices = r5;
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        public static SerializedForm create(ImmutableTable<?, ?, ?> immutableTable, int[] r8, int[] r9) {
            return new SerializedForm(immutableTable.rowKeySet().toArray(), immutableTable.columnKeySet().toArray(), immutableTable.values().toArray(), r8, r9);
        }
        ...
        Object readResolve() {
            ...
            int r3 = 0;
            if (objArr.length == 1) {
                return ImmutableTable.m300of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
            ImmutableList.Builder builder = new ImmutableList.Builder(objArr.length);
            while (true) {
                Object[] objArr2 = this.cellValues;
                if (r3 < objArr2.length) {
                    builder.add((ImmutableList.Builder) ImmutableTable.cellOf(this.rowKeys[this.cellRowIndices[r3]], this.columnKeys[this.cellColumnIndices[r3]], objArr2[r3]));
                    r3++;
                } else {
