...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    FluentIterable(Iterable<E> iterable) {
        this.iterableDelegate = Optional.m439of(iterable);
    }

    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo432or((Optional<Iterable<E>>) this);
    }
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.FluentIterable.3
            ...
            public Iterator<T> iterator() {
                return Iterators.concat(new AbstractIndexedListIterator<Iterator<? extends T>>(iterableArr.length) { // from class: com.google.common.collect.FluentIterable.3.1
                    ...
                    public Iterator<? extends T> get(int r2) {
                        return iterableArr[r2].iterator();
                    }
                });
            }
        };
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m424of() {
        return from(Collections.emptyList());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m423of(@ParametricNullness E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m439of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m439of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m439of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
    ...
    public final FluentIterable<E> skip(int r2) {
        return from(Iterables.skip(getDelegate(), r2));
    }

    public final FluentIterable<E> limit(int r2) {
        return from(Iterables.limit(getDelegate(), r2));
    }
    ...
    public final E get(int r2) {
        return (E) Iterables.get(getDelegate(), r2);
    }
