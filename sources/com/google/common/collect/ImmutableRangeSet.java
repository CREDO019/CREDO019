...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m409of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m408of(Range.all()));
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m364of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m363of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m408of(range));
    }
    ...
    public boolean intersects(Range<C> range) {
        ...
        if (binarySearch >= this.ranges.size() || !this.ranges.get(binarySearch).isConnected(range) || this.ranges.get(binarySearch).intersection(range).isEmpty()) {
            if (binarySearch > 0) {
                ...
                if (this.ranges.get(r0).isConnected(range) && !this.ranges.get(r0).intersection(range).isEmpty()) {
                    return true;
                }
            }
            return false;
    ...
    public final class ComplementRanges extends ImmutableList<Range<C>> {
        ...
        public Range<C> get(int r4) {
            Cut<C> cut;
            Cut<C> cut2;
            Preconditions.checkElementIndex(r4, this.size);
            if (!this.positiveBoundedBelow) {
                cut = ((Range) ImmutableRangeSet.this.ranges.get(r4)).upperBound;
            } else {
                cut = r4 == 0 ? Cut.belowAll() : ((Range) ImmutableRangeSet.this.ranges.get(r4 - 1)).upperBound;
            }
            if (!this.positiveBoundedAbove || r4 != this.size - 1) {
                cut2 = ((Range) ImmutableRangeSet.this.ranges.get(r4 + (!this.positiveBoundedBelow ? 1 : 0))).lowerBound;
            } else {
                cut2 = Cut.aboveAll();
            }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.isEmpty()) {
            ...
            ImmutableRangeSet<C> m364of = m364of();
            this.complement = m364of;
            return m364of;
        } else {
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        final int r1 = size - binarySearch;
        if (r1 == 0) {
            return ImmutableList.m409of();
        }
        return (ImmutableList<Range<C>>) new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
            ...
            @Override // java.util.List
            public Range<C> get(int r3) {
                Preconditions.checkElementIndex(r3, r1);
                return (r3 == 0 || r3 == r1 + (-1)) ? ((Range) ImmutableRangeSet.this.ranges.get(r3 + binarySearch)).intersection(range) : (Range) ImmutableRangeSet.this.ranges.get(r3 + binarySearch);
            }
        };
    }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> discreteDomain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m314of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableRangeSet.m364of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m408of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
