...
public final class Synchronized {
    ...
    public static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        ...
        @Override // java.util.List
        public boolean addAll(int r3, Collection<? extends E> collection) {
            boolean addAll;
            synchronized (this.mutex) {
                addAll = delegate().addAll(r3, collection);
            }
            return addAll;
        }
        ...
        public E set(int r3, E e) {
            E e2;
            synchronized (this.mutex) {
                e2 = delegate().set(r3, e);
            }
            return e2;
        }

        @Override // java.util.List
        public List<E> subList(int r3, int r4) {
            List<E> list;
            synchronized (this.mutex) {
                list = Synchronized.list(delegate().subList(r3, r4), this.mutex);
            }
            return list;
        }
    ...
    public static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
        ...
        @Override // com.google.common.collect.Multiset
        public int add(E e, int r4) {
            int add;
            synchronized (this.mutex) {
                add = delegate().add(e, r4);
            }
            return add;
        }

        @Override // com.google.common.collect.Multiset
        public int remove(@CheckForNull Object obj, int r4) {
            int remove;
            synchronized (this.mutex) {
                remove = delegate().remove(obj, r4);
            }
            return remove;
        }

        @Override // com.google.common.collect.Multiset
        public int setCount(E e, int r4) {
            int count;
            synchronized (this.mutex) {
                count = delegate().setCount(e, r4);
            }
            return count;
        }

        @Override // com.google.common.collect.Multiset
        public boolean setCount(E e, int r4, int r5) {
            boolean count;
            synchronized (this.mutex) {
                count = delegate().setCount(e, r4, r5);
            }
            return count;
        }
