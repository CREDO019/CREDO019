...
public abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    abstract Table.Cell<R, C, V> getCell(int r1);
    ...
    public final ImmutableSet<Table.Cell<R, C, V>> createCellSet() {
        return isEmpty() ? ImmutableSet.m362of() : new CellSet();
    }
    ...
    public final class CellSet extends IndexedImmutableSet<Table.Cell<R, C, V>> {
        ...
        public Table.Cell<R, C, V> get(int r2) {
            return RegularImmutableTable.this.getCell(r2);
        }
    ...
    public final ImmutableCollection<V> createValues() {
        return isEmpty() ? ImmutableList.m409of() : new Values();
    }
    ...
    public final class Values extends ImmutableList<V> {
        ...
        public V get(int r2) {
            return (V) RegularImmutableTable.this.getValue(r2);
        }
    }
