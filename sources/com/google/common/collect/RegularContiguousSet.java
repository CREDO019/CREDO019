...
public final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
    ...
    public UnmodifiableIterator<C> iterator() {
        return new AbstractSequentialIterator<C>(first()) { // from class: com.google.common.collect.RegularContiguousSet.1
            ...
            protected /* bridge */ /* synthetic */ Object computeNext(Object obj) {
                return computeNext((C29091) ((Comparable) obj));
            }
    ...
    public UnmodifiableIterator<C> descendingIterator() {
        return new AbstractSequentialIterator<C>(last()) { // from class: com.google.common.collect.RegularContiguousSet.2
            ...
            @CheckForNull
            protected /* bridge */ /* synthetic */ Object computeNext(Object obj) {
                return computeNext((C29102) ((Comparable) obj));
            }
        ...
        if (this.domain.supportsFastOffset) {
            return new ImmutableAsList<C>() { // from class: com.google.common.collect.RegularContiguousSet.3
                ...
                public C get(int r5) {
                    ...
                    return (C) RegularContiguousSet.this.domain.offset(RegularContiguousSet.this.first(), r5);
                }
            };
        }
