...
public abstract class ImmutableMultiset<E> extends ImmutableMultisetGwtSerializationDependencies<E> implements Multiset<E> {
    ...
    abstract Multiset.Entry<E> getEntry(int r1);

    @Override // com.google.common.collect.ImmutableCollection
    abstract Object writeReplace();

    /* renamed from: of */
    public static <E> ImmutableMultiset<E> m373of() {
        return RegularImmutableMultiset.EMPTY;
    }

    /* renamed from: of */
    public static <E> ImmutableMultiset<E> m372of(E e) {
        return copyFromElements(e);
    }

    /* renamed from: of */
    public static <E> ImmutableMultiset<E> m371of(E e, E e2) {
        return copyFromElements(e, e2);
    }

    /* renamed from: of */
    public static <E> ImmutableMultiset<E> m370of(E e, E e2, E e3) {
        return copyFromElements(e, e2, e3);
    }

    /* renamed from: of */
    public static <E> ImmutableMultiset<E> m369of(E e, E e2, E e3, E e4) {
        return copyFromElements(e, e2, e3, e4);
    }

    /* renamed from: of */
    public static <E> ImmutableMultiset<E> m368of(E e, E e2, E e3, E e4, E e5) {
        return copyFromElements(e, e2, e3, e4, e5);
    }

    /* renamed from: of */
    public static <E> ImmutableMultiset<E> m367of(E e, E e2, E e3, E e4, E e5, E e6, E... eArr) {
    ...
    @Override // com.google.common.collect.Multiset
    @Deprecated
    public final int add(E e, int r2) {
        throw new UnsupportedOperationException();
    }

    @Override // com.google.common.collect.Multiset
    @Deprecated
    public final int remove(@CheckForNull Object obj, int r2) {
        throw new UnsupportedOperationException();
    }

    @Override // com.google.common.collect.Multiset
    @Deprecated
    public final int setCount(E e, int r2) {
        throw new UnsupportedOperationException();
    }

    @Override // com.google.common.collect.Multiset
    @Deprecated
    public final boolean setCount(E e, int r2, int r3) {
        throw new UnsupportedOperationException();
    }
    ...
    public int copyIntoArray(Object[] objArr, int r6) {
        ...
        while (it.hasNext()) {
            ...
            Arrays.fill(objArr, r6, next.getCount() + r6, next.getElement());
            r6 += next.getCount();
        }
        return r6;
    }
    ...
    private ImmutableSet<Multiset.Entry<E>> createEntrySet() {
        return isEmpty() ? ImmutableSet.m362of() : new EntrySet();
    }
    ...
    public final class EntrySet extends IndexedImmutableSet<Multiset.Entry<E>> {
        ...
        public Multiset.Entry<E> get(int r2) {
            return ImmutableMultiset.this.getEntry(r2);
        }
    ...
    public static class Builder<E> extends ImmutableCollection.Builder<E> {
        ...
        public Builder(int r2) {
            ...
            this.contents = ObjectCountHashMap.createWithExpectedSize(r2);
        }
        ...
        public Builder<E> addCopies(E e, int r5) {
            ...
            objectCountHashMap.put(e, r5 + objectCountHashMap.get(e));
            return this;
        }

        /* JADX WARN: Multi-variable type inference failed */
        public Builder<E> setCount(E e, int r5) {
            Objects.requireNonNull(this.contents);
            if (r5 == 0 && !this.isLinkedHash) {
            ...
            if (r5 == 0) {
                ...
                this.contents.put(Preconditions.checkNotNull(e), r5);
            }
            return this;
        }
        ...
        public ImmutableMultiset<E> build() {
            ...
            if (this.contents.size() == 0) {
                return ImmutableMultiset.m373of();
            }
