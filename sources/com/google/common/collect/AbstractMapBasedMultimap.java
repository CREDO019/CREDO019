...
public abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    static /* synthetic */ int access$208(AbstractMapBasedMultimap abstractMapBasedMultimap) {
        int r0 = abstractMapBasedMultimap.totalSize;
        abstractMapBasedMultimap.totalSize = r0 + 1;
        return r0;
    }
    ...
    static /* synthetic */ int access$212(AbstractMapBasedMultimap abstractMapBasedMultimap, int r2) {
        int r0 = abstractMapBasedMultimap.totalSize + r2;
        abstractMapBasedMultimap.totalSize = r0;
        return r0;
    }

    static /* synthetic */ int access$220(AbstractMapBasedMultimap abstractMapBasedMultimap, int r2) {
        int r0 = abstractMapBasedMultimap.totalSize - r2;
        abstractMapBasedMultimap.totalSize = r0;
        return r0;
    }
    ...
    public class WrappedList extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements List<V> {
        ...
        public boolean addAll(int r3, Collection<? extends V> collection) {
            if (collection.isEmpty()) {
                return false;
            }
            int size = size();
            boolean addAll = getListDelegate().addAll(r3, collection);
            if (addAll) {
        ...
        public V get(int r2) {
            refreshIfEmpty();
            return getListDelegate().get(r2);
        }

        @Override // java.util.List
        @ParametricNullness
        public V set(int r2, @ParametricNullness V v) {
            refreshIfEmpty();
            return getListDelegate().set(r2, v);
        }

        @Override // java.util.List
        public void add(int r3, @ParametricNullness V v) {
            refreshIfEmpty();
            boolean isEmpty = getDelegate().isEmpty();
            getListDelegate().add(r3, v);
            AbstractMapBasedMultimap.access$208(AbstractMapBasedMultimap.this);
            if (isEmpty) {
                addToMap();
            }
        ...
        public V remove(int r2) {
            refreshIfEmpty();
            V remove = getListDelegate().remove(r2);
            AbstractMapBasedMultimap.access$210(AbstractMapBasedMultimap.this);
            removeIfEmpty();
            return remove;
        }
        ...
        @Override // java.util.List
        public ListIterator<V> listIterator(int r2) {
            refreshIfEmpty();
            return new WrappedListIterator(r2);
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // java.util.List
        public List<V> subList(int r4, int r5) {
            refreshIfEmpty();
            return AbstractMapBasedMultimap.this.wrapList(getKey(), getListDelegate().subList(r4, r5), getAncestor() == null ? this : getAncestor());
        }
        ...
        private class WrappedListIterator extends AbstractMapBasedMultimap<K, V>.WrappedCollection.WrappedIterator implements ListIterator<V> {
            ...
            public WrappedListIterator(int r3) {
                super(WrappedList.this.getListDelegate().listIterator(r3));
            }
    ...
    private class KeySet extends Maps.KeySet<K, Collection<V>> {
        ...
        public boolean remove(@CheckForNull Object obj) {
            ...
            if (remove != null) {
                r1 = remove.size();
                remove.clear();
                AbstractMapBasedMultimap.access$220(AbstractMapBasedMultimap.this, r1);
            } else {
                r1 = 0;
            }
            return r1 > 0;
