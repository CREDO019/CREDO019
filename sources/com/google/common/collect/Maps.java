...
public final class Maps {
    ...
    public static <K, V> HashMap<K, V> newHashMapWithExpectedSize(int r1) {
        return new HashMap<>(capacity(r1));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int capacity(int r1) {
        if (r1 < 3) {
            CollectPreconditions.checkNonnegative(r1, "expectedSize");
            return r1 + 1;
        } else if (r1 < 1073741824) {
    ...
    public static <K, V> LinkedHashMap<K, V> newLinkedHashMapWithExpectedSize(int r1) {
        return new LinkedHashMap<>(capacity(r1));
    }
    ...
    public static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.common.collect.Maps.3
            ...
            public /* bridge */ /* synthetic */ Object transform(@ParametricNullness Object obj) {
                return transform((C28623<K, V>) obj);
            }
    ...
    public static <E> ImmutableMap<E, Integer> indexMap(Collection<E> collection) {
        ...
        int r1 = 0;
        for (E e : collection) {
            builder.put(e, Integer.valueOf(r1));
            r1++;
        }
        return builder.build();
    }
