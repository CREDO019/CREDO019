...
public final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    static final RegularImmutableSortedSet<Comparable> NATURAL_EMPTY_SET = new RegularImmutableSortedSet<>(ImmutableList.m409of(), Ordering.natural());
    ...
    public int copyIntoArray(Object[] objArr, int r3) {
        return this.elements.copyIntoArray(objArr, r3);
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RegularImmutableSortedSet<E> getSubSet(int r3, int r4) {
        if (r3 == 0 && r4 == size()) {
            return this;
        }
        if (r3 < r4) {
            return new RegularImmutableSortedSet<>(this.elements.subList(r3, r4), this.comparator);
        }
