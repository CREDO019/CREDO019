...
public final class Multisets {
    ...
    static class UnmodifiableMultiset<E> extends ForwardingMultiset<E> implements Serializable {
        ...
        @Override // com.google.common.collect.ForwardingMultiset, com.google.common.collect.Multiset
        public int add(@ParametricNullness E e, int r2) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override // com.google.common.collect.ForwardingMultiset, com.google.common.collect.Multiset
        public int remove(@CheckForNull Object obj, int r2) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override // com.google.common.collect.ForwardingMultiset, com.google.common.collect.Multiset
        public int setCount(@ParametricNullness E e, int r2) {
            throw new UnsupportedOperationException();
        }

        @Override // com.google.common.collect.ForwardingMultiset, com.google.common.collect.Multiset
        public boolean setCount(@ParametricNullness E e, int r2, int r3) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    public static <E> Multiset.Entry<E> immutableEntry(@ParametricNullness E e, int r2) {
        return new ImmutableEntry(e, r2);
    }
    ...
    public static class ImmutableEntry<E> extends AbstractEntry<E> implements Serializable {
        ...
        ImmutableEntry(@ParametricNullness E e, int r2) {
            this.element = e;
            this.count = r2;
            CollectPreconditions.checkNonnegative(r2, NewHtcHomeBadger.COUNT);
        }
    ...
    public static final class FilteredMultiset<E> extends ViewMultiset<E> {
        ...
        public int add(@ParametricNullness E e, int r5) {
            Preconditions.checkArgument(this.predicate.apply(e), "Element %s does not match predicate %s", e, this.predicate);
            return this.unfiltered.add(e, r5);
        }

        @Override // com.google.common.collect.AbstractMultiset, com.google.common.collect.Multiset
        public int remove(@CheckForNull Object obj, int r3) {
            CollectPreconditions.checkNonnegative(r3, "occurrences");
            if (r3 == 0) {
                return count(obj);
            }
            if (contains(obj)) {
                return this.unfiltered.remove(obj, r3);
            }
            return 0;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <E> int setCountImpl(Multiset<E> multiset, @ParametricNullness E e, int r3) {
        CollectPreconditions.checkNonnegative(r3, NewHtcHomeBadger.COUNT);
        int count = multiset.count(e);
        int r32 = r3 - count;
        if (r32 > 0) {
            multiset.add(e, r32);
        } else if (r32 < 0) {
            multiset.remove(e, -r32);
        }
        return count;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static <E> boolean setCountImpl(Multiset<E> multiset, @ParametricNullness E e, int r3, int r4) {
        CollectPreconditions.checkNonnegative(r3, "oldCount");
        CollectPreconditions.checkNonnegative(r4, "newCount");
        if (multiset.count(e) == r3) {
            multiset.setCount(e, r4);
            return true;
        }
        return false;
    }
