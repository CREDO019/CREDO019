...
public final class Graphs {
            ...
            for (N n2 : graph.nodes()) {
                if (!hashSet.contains(n2)) {
                    ...
                    for (Object obj2 : reachableNodes) {
                        int r8 = r6 + 1;
                        for (Object obj3 : Iterables.limit(reachableNodes, r6)) {
                ...
                public Iterator<EndpointPair<N>> iterator() {
                    return Iterators.transform(TransposedGraph.this.delegate().incidentEdges(this.node).iterator(), new Function<EndpointPair<N>, EndpointPair<N>>() { // from class: com.google.common.graph.Graphs.TransposedGraph.1.1
                        ...
                        public EndpointPair<N> apply(EndpointPair<N> endpointPair) {
                            return EndpointPair.m296of((Graph<?>) TransposedGraph.this.delegate(), (Object) endpointPair.nodeV(), (Object) endpointPair.nodeU());
                        }
                    });
                }
            };
    ...
    private static class TransposedNetwork<N, E> extends ForwardingNetwork<N, E> {
        ...
        public EndpointPair<N> incidentNodes(E e) {
            ...
            return EndpointPair.m295of((Network<?, ?>) this.network, (Object) incidentNodes.nodeV(), (Object) incidentNodes.nodeU());
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int checkNonNegative(int r2) {
        Preconditions.checkArgument(r2 >= 0, "Not true that %s is non-negative.", r2);
        return r2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int checkPositive(int r2) {
        Preconditions.checkArgument(r2 > 0, "Not true that %s is positive.", r2);
        return r2;
    }
