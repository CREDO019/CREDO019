...
public final class NetworkBuilder<N, E> extends AbstractGraphBuilder<N> {
    ...
    public NetworkBuilder<N, E> expectedNodeCount(int r1) {
        this.expectedNodeCount = Optional.m439of(Integer.valueOf(Graphs.checkNonNegative(r1)));
        return this;
    }

    public NetworkBuilder<N, E> expectedEdgeCount(int r1) {
        this.expectedEdgeCount = Optional.m439of(Integer.valueOf(Graphs.checkNonNegative(r1)));
        return this;
    }
