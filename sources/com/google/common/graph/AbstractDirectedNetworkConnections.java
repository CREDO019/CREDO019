...
public abstract class AbstractDirectedNetworkConnections<N, E> implements NetworkConnections<N, E> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractDirectedNetworkConnections(Map<E, N> map, Map<E, N> map2, int r4) {
        this.inEdgeMap = (Map) Preconditions.checkNotNull(map);
        this.outEdgeMap = (Map) Preconditions.checkNotNull(map2);
        this.selfLoopCount = Graphs.checkNonNegative(r4);
        Preconditions.checkState(r4 <= map.size() && r4 <= map2.size());
    }
    ...
    public N removeInEdge(E e, boolean z) {
        if (z) {
            int r2 = this.selfLoopCount - 1;
            this.selfLoopCount = r2;
    ...
    public void addInEdge(E e, N n, boolean z) {
        ...
        if (z) {
            int r4 = this.selfLoopCount + 1;
            this.selfLoopCount = r4;
            Graphs.checkPositive(r4);
        }
