...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    /* loaded from: classes3.dex */
    public class C30001 extends AbstractGraph<N> {
        C30001() {
        }
        ...
        public /* bridge */ /* synthetic */ Iterable predecessors(Object obj) {
            return predecessors((C30001) obj);
        }
            ...
            return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractNetwork.1.1
                ...
                public boolean contains(@CheckForNull Object obj) {
                    if (obj instanceof EndpointPair) {
                        ...
                        return C30001.this.isOrderingCompatible(endpointPair) && C30001.this.nodes().contains(endpointPair.nodeU()) && C30001.this.successors((C30001) endpointPair.nodeU()).contains(endpointPair.nodeV());
                    }
                    return false;
                }
            };
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m361of((Object) e));
    }
