...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* renamed from: of */
    public static <N, V> UndirectedGraphConnections<N, V> m293of(ElementOrder<N> elementOrder) {
        int r0 = C30462.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (r0 != 1) {
            if (r0 == 2) {
