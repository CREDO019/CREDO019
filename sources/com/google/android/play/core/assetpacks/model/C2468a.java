...
public final class C2468a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f773a;

    /* renamed from: b */
    private static final Map<Integer, String> f774b;
    ...
    /* renamed from: a */
    public static String m843a(int r4) {
        Map<Integer, String> map = f773a;
        Integer valueOf = Integer.valueOf(r4);
        if (map.containsKey(valueOf)) {
            String str = map.get(valueOf);
            String str2 = f774b.get(valueOf);
