...
final class C2593a {
    ...
    /* renamed from: a */
    private final C2595c f902a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2593a(C2595c c2595c) {
        this.f902a = c2595c;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: b */
    public static final synchronized void m609b(Context context, Set<File> set) {
        synchronized (C2593a.class) {
            AssetManager assets = context.getAssets();
            for (File file : set) {
                int intValue = ((Integer) C2532bq.m741a(assets, "addAssetPath", Integer.class, String.class, file.getPath())).intValue();
    ...
    */
    public final synchronized boolean m610a(android.content.Context r5, java.util.Set<java.lang.String> r6) {
        /*
            r4 = this;
            monitor-enter(r4)
        ...
        L22:
            ...
            com.google.android.play.core.splitcompat.c r3 = r4.f902a     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            java.io.File r2 = r3.m601b(r2)     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            r1.add(r2)     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            goto L22
        L38:
            m609b(r5, r1)     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            if (r0 == 0) goto L40
        ...
        L5b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.splitcompat.C2593a.m610a(android.content.Context, java.util.Set):boolean");
    }
}
