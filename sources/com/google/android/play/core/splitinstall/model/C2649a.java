...
public final class C2649a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f1007a;

    /* renamed from: b */
    private static final Map<Integer, String> f1008b;
    ...
    /* renamed from: a */
    public static String m520a(int r4) {
        Map<Integer, String> map = f1007a;
        Integer valueOf = Integer.valueOf(r4);
        if (map.containsKey(valueOf)) {
            Map<Integer, String> map2 = f1008b;
