...
public final class C2487a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f801a;

    /* renamed from: b */
    private static final Map<Integer, String> f802b;
    ...
    /* renamed from: a */
    public static String m815a(int r4) {
        Map<Integer, String> map = f801a;
        Integer valueOf = Integer.valueOf(r4);
        if (map.containsKey(valueOf)) {
            Map<Integer, String> map2 = f802b;
