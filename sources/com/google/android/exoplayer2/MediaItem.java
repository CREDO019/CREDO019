...
public final class MediaItem implements Bundleable {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            this.subtitleConfigurations = ImmutableList.m409of();
        ...
        @Deprecated
        public Builder setDrmUuid(UUID r2) {
            this.drmConfiguration.setNullableScheme(r2);
            return this;
        }
        ...
        public Builder setSubtitles(List<Subtitle> list) {
            this.subtitleConfigurations = list != null ? ImmutableList.copyOf((Collection) list) : ImmutableList.m409of();
            return this;
        }
    ...
    public static final class DrmConfiguration {
        ...
        public static final class Builder {
            ...
            public Builder(UUID r1) {
                this.scheme = r1;
                this.licenseRequestHeaders = ImmutableMap.m390of();
                this.forcedSessionTrackTypes = ImmutableList.m409of();
            }
            ...
            public Builder setScheme(UUID r1) {
                this.scheme = r1;
                return this;
            }
            ...
            @Deprecated
            public Builder setNullableScheme(UUID r1) {
                this.scheme = r1;
                return this;
            }
            ...
            public Builder setForceSessionsForAudioAndVideoTracks(boolean z) {
                ImmutableList m409of;
                if (z) {
                    m409of = ImmutableList.m407of(2, 1);
                } else {
                    m409of = ImmutableList.m409of();
                }
                setForcedSessionTrackTypes(m409of);
                return this;
            }
        ...
        private DrmConfiguration(Builder builder) {
            ...
            UUID r0 = (UUID) Assertions.checkNotNull(builder.scheme);
            this.scheme = r0;
            this.uuid = r0;
    ...
    public static class LocalConfiguration {
        ...
        private LocalConfiguration(Uri uri, String str, DrmConfiguration drmConfiguration, AdsConfiguration adsConfiguration, List<StreamKey> list, String str2, ImmutableList<SubtitleConfiguration> immutableList, Object obj) {
            ...
            for (int r2 = 0; r2 < immutableList.size(); r2++) {
                builder.add((ImmutableList.Builder) immutableList.get(r2).buildUpon().buildSubtitle());
            }
    ...
    public static final class LiveConfiguration implements Bundleable {
        ...
        public static final class Builder {
            ...
            public Builder() {
                this.targetOffsetMs = C1856C.TIME_UNSET;
                this.minOffsetMs = C1856C.TIME_UNSET;
                this.maxOffsetMs = C1856C.TIME_UNSET;
        ...
        public int hashCode() {
            ...
            int r1 = ((((((int) (j ^ (j >>> 32))) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31) + ((int) (j3 ^ (j3 >>> 32)))) * 31;
            float f = this.minPlaybackSpeed;
            int floatToIntBits = (r1 + (f != 0.0f ? Float.floatToIntBits(f) : 0)) * 31;
        ...
        public static /* synthetic */ LiveConfiguration lambda$static$0(Bundle bundle) {
            return new LiveConfiguration(bundle.getLong(keyForField(0), C1856C.TIME_UNSET), bundle.getLong(keyForField(1), C1856C.TIME_UNSET), bundle.getLong(keyForField(2), C1856C.TIME_UNSET), bundle.getFloat(keyForField(3), -3.4028235E38f), bundle.getFloat(keyForField(4), -3.4028235E38f));
        }
    ...
    public static class SubtitleConfiguration {
        ...
        public static final class Builder {
            ...
            private Builder(SubtitleConfiguration subtitleConfiguration) {
                ...
                this.f215id = subtitleConfiguration.f214id;
            }
        ...
        private SubtitleConfiguration(Uri uri, String str, String str2, int r4, int r5, String str3, String str4) {
            this.uri = uri;
            this.mimeType = str;
            this.language = str2;
            this.selectionFlags = r4;
            this.roleFlags = r5;
            this.label = str3;
            this.f214id = str4;
        }
    ...
    public static final class Subtitle extends SubtitleConfiguration {
        ...
        @Deprecated
        public Subtitle(Uri uri, String str, String str2, int r11) {
            this(uri, str, str2, r11, 0, null);
        }

        @Deprecated
        public Subtitle(Uri uri, String str, String str2, int r13, int r14, String str3) {
            super(uri, str, str2, r13, r14, str3, null);
        }
