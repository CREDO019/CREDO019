...
public interface AnalyticsListener {
    ...
    public final /* synthetic */ class CC {
        ...
        public static void $default$onAudioSessionIdChanged(AnalyticsListener _this, EventTime eventTime, int r2) {
        }

        public static void $default$onAudioSinkError(AnalyticsListener _this, EventTime eventTime, Exception exc) {
        }

        public static void $default$onAudioUnderrun(AnalyticsListener _this, EventTime eventTime, int r2, long j, long j2) {
        }
        ...
        public static void $default$onBandwidthEstimate(AnalyticsListener _this, EventTime eventTime, int r2, long j, long j2) {
        }
        ...
        @Deprecated
        public static void $default$onDecoderDisabled(AnalyticsListener _this, EventTime eventTime, int r2, DecoderCounters decoderCounters) {
        }

        @Deprecated
        public static void $default$onDecoderEnabled(AnalyticsListener _this, EventTime eventTime, int r2, DecoderCounters decoderCounters) {
        }

        @Deprecated
        public static void $default$onDecoderInitialized(AnalyticsListener _this, EventTime eventTime, int r2, String str, long j) {
        }

        @Deprecated
        public static void $default$onDecoderInputFormatChanged(AnalyticsListener _this, EventTime eventTime, int r2, Format format) {
        }

        public static void $default$onDeviceInfoChanged(AnalyticsListener _this, EventTime eventTime, DeviceInfo deviceInfo) {
        }

        public static void $default$onDeviceVolumeChanged(AnalyticsListener _this, EventTime eventTime, int r2, boolean z) {
        }
        ...
        public static void $default$onDrmSessionAcquired(AnalyticsListener _this, EventTime eventTime, int r2) {
        }
        ...
        public static void $default$onDroppedVideoFrames(AnalyticsListener _this, EventTime eventTime, int r2, long j) {
        }
        ...
        public static void $default$onMediaItemTransition(AnalyticsListener _this, EventTime eventTime, MediaItem mediaItem, int r3) {
        }
        ...
        public static void $default$onPlayWhenReadyChanged(AnalyticsListener _this, EventTime eventTime, boolean z, int r3) {
        }
        ...
        public static void $default$onPlaybackStateChanged(AnalyticsListener _this, EventTime eventTime, int r2) {
        }

        public static void $default$onPlaybackSuppressionReasonChanged(AnalyticsListener _this, EventTime eventTime, int r2) {
        }
        ...
        @Deprecated
        public static void $default$onPlayerStateChanged(AnalyticsListener _this, EventTime eventTime, boolean z, int r3) {
        }
        ...
        @Deprecated
        public static void $default$onPositionDiscontinuity(AnalyticsListener _this, EventTime eventTime, int r2) {
        }

        public static void $default$onPositionDiscontinuity(AnalyticsListener _this, EventTime eventTime, Player.PositionInfo positionInfo, Player.PositionInfo positionInfo2, int r4) {
        }

        public static void $default$onRenderedFirstFrame(AnalyticsListener _this, EventTime eventTime, Object obj, long j) {
        }

        public static void $default$onRepeatModeChanged(AnalyticsListener _this, EventTime eventTime, int r2) {
        }
        ...
        public static void $default$onSurfaceSizeChanged(AnalyticsListener _this, EventTime eventTime, int r2, int r3) {
        }

        public static void $default$onTimelineChanged(AnalyticsListener _this, EventTime eventTime, int r2) {
        }
        ...
        public static void $default$onVideoFrameProcessingOffset(AnalyticsListener _this, EventTime eventTime, long j, int r4) {
        }
        ...
        @Deprecated
        public static void $default$onVideoSizeChanged(AnalyticsListener _this, EventTime eventTime, int r2, int r3, int r4, float f) {
        }
    ...
    void onAudioSessionIdChanged(EventTime eventTime, int r2);

    void onAudioSinkError(EventTime eventTime, Exception exc);

    void onAudioUnderrun(EventTime eventTime, int r2, long j, long j2);

    void onAvailableCommandsChanged(EventTime eventTime, Player.Commands commands);

    void onBandwidthEstimate(EventTime eventTime, int r2, long j, long j2);
    ...
    @Deprecated
    void onDecoderDisabled(EventTime eventTime, int r2, DecoderCounters decoderCounters);

    @Deprecated
    void onDecoderEnabled(EventTime eventTime, int r2, DecoderCounters decoderCounters);

    @Deprecated
    void onDecoderInitialized(EventTime eventTime, int r2, String str, long j);

    @Deprecated
    void onDecoderInputFormatChanged(EventTime eventTime, int r2, Format format);

    void onDeviceInfoChanged(EventTime eventTime, DeviceInfo deviceInfo);

    void onDeviceVolumeChanged(EventTime eventTime, int r2, boolean z);
    ...
    void onDrmSessionAcquired(EventTime eventTime, int r2);

    void onDrmSessionManagerError(EventTime eventTime, Exception exc);

    void onDrmSessionReleased(EventTime eventTime);

    void onDroppedVideoFrames(EventTime eventTime, int r2, long j);
    ...
    void onMediaItemTransition(EventTime eventTime, MediaItem mediaItem, int r3);

    void onMediaMetadataChanged(EventTime eventTime, MediaMetadata mediaMetadata);

    void onMetadata(EventTime eventTime, Metadata metadata);

    void onPlayWhenReadyChanged(EventTime eventTime, boolean z, int r3);

    void onPlaybackParametersChanged(EventTime eventTime, PlaybackParameters playbackParameters);

    void onPlaybackStateChanged(EventTime eventTime, int r2);

    void onPlaybackSuppressionReasonChanged(EventTime eventTime, int r2);
    ...
    @Deprecated
    void onPlayerStateChanged(EventTime eventTime, boolean z, int r3);

    void onPlaylistMetadataChanged(EventTime eventTime, MediaMetadata mediaMetadata);

    @Deprecated
    void onPositionDiscontinuity(EventTime eventTime, int r2);

    void onPositionDiscontinuity(EventTime eventTime, Player.PositionInfo positionInfo, Player.PositionInfo positionInfo2, int r4);

    void onRenderedFirstFrame(EventTime eventTime, Object obj, long j);

    void onRepeatModeChanged(EventTime eventTime, int r2);
    ...
    void onSurfaceSizeChanged(EventTime eventTime, int r2, int r3);

    void onTimelineChanged(EventTime eventTime, int r2);
    ...
    void onVideoFrameProcessingOffset(EventTime eventTime, long j, int r4);
    ...
    @Deprecated
    void onVideoSizeChanged(EventTime eventTime, int r2, int r3, int r4, float f);
    ...
    public static final class Events {
        ...
        public Events(FlagSet flagSet, SparseArray<EventTime> sparseArray) {
            ...
            for (int r1 = 0; r1 < flagSet.size(); r1++) {
                int r2 = flagSet.get(r1);
                sparseArray2.append(r2, (EventTime) Assertions.checkNotNull(sparseArray.get(r2)));
            }
            this.eventTimes = sparseArray2;
        }

        public EventTime getEventTime(int r2) {
            return (EventTime) Assertions.checkNotNull(this.eventTimes.get(r2));
        }

        public boolean contains(int r2) {
            return this.flags.contains(r2);
        }

        public boolean containsAny(int... r2) {
            return this.flags.containsAny(r2);
        }
    ...
    public static final class EventTime {
        ...
        public EventTime(long j, Timeline timeline, int r4, MediaSource.MediaPeriodId mediaPeriodId, long j2, Timeline timeline2, int r9, MediaSource.MediaPeriodId mediaPeriodId2, long j3, long j4) {
            this.realtimeMs = j;
