...
public class TrackSelectionParameters implements Bundleable {
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            this.preferredVideoMimeTypes = ImmutableList.m409of();
            this.preferredVideoRoleFlags = 0;
            this.preferredAudioLanguages = ImmutableList.m409of();
            this.preferredAudioRoleFlags = 0;
            this.maxAudioChannelCount = Integer.MAX_VALUE;
            this.maxAudioBitrate = Integer.MAX_VALUE;
            this.preferredAudioMimeTypes = ImmutableList.m409of();
            this.preferredTextLanguages = ImmutableList.m409of();
        ...
        public Builder(Bundle bundle) {
            ...
            this.overrides = new HashMap<>();
            for (int r2 = 0; r2 < fromBundleList.size(); r2++) {
                TrackSelectionOverride trackSelectionOverride = (TrackSelectionOverride) fromBundleList.get(r2);
                this.overrides.put(trackSelectionOverride.mediaTrackGroup, trackSelectionOverride);
            }
            int[] r7 = (int[]) MoreObjects.firstNonNull(bundle.getIntArray(TrackSelectionParameters.keyForField(24)), new int[0]);
            this.disabledTrackTypes = new HashSet<>();
            for (int r22 : r7) {
                this.disabledTrackTypes.add(Integer.valueOf(r22));
            }
        }
        ...
        public Builder setViewportSize(int r1, int r2, boolean z) {
            this.viewportWidth = r1;
            this.viewportHeight = r2;
        ...
        public Builder setPreferredVideoRoleFlags(int r1) {
            this.preferredVideoRoleFlags = r1;
            return this;
        }
        ...
        public Builder setPreferredTextRoleFlags(int r1) {
            this.preferredTextRoleFlags = r1;
            return this;
        }

        public Builder setIgnoredTextSelectionFlags(int r1) {
            this.ignoredTextSelectionFlags = r1;
            return this;
        }
        ...
        public Builder setTrackTypeDisabled(int r1, boolean z) {
            if (z) {
                this.disabledTrackTypes.add(Integer.valueOf(r1));
            } else {
                this.disabledTrackTypes.remove(Integer.valueOf(r1));
            }
            return this;
        }
        ...
        private void m1149x58dbf263(Context context) {
            CaptioningManager captioningManager;
            if ((Util.SDK_INT >= 23 || Looper.myLooper() != null) && (captioningManager = (CaptioningManager) context.getSystemService("captioning")) != null && captioningManager.isEnabled()) {
                this.preferredTextRoleFlags = 1088;
                Locale locale = captioningManager.getLocale();
                if (locale != null) {
                    this.preferredTextLanguages = ImmutableList.m408of(Util.getLocaleLanguageTag(locale));
                }
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public static String keyForField(int r1) {
