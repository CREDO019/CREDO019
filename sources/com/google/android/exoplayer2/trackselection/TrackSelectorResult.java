...
public final class TrackSelectorResult {
    ...
    public boolean isRendererEnabled(int r2) {
        return this.rendererConfigurations[r2] != null;
    }
    ...
    public boolean isEquivalent(TrackSelectorResult trackSelectorResult) {
        ...
        for (int r1 = 0; r1 < this.selections.length; r1++) {
            if (!isEquivalent(trackSelectorResult, r1)) {
                return false;
            }
        }
        return true;
    ...
    public boolean isEquivalent(TrackSelectorResult trackSelectorResult, int r5) {
        return trackSelectorResult != null && Util.areEqual(this.rendererConfigurations[r5], trackSelectorResult.rendererConfigurations[r5]) && Util.areEqual(this.selections[r5], trackSelectorResult.selections[r5]);
    }
}
