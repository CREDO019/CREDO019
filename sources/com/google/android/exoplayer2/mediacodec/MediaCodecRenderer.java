...
public abstract class MediaCodecRenderer extends BaseRenderer {
    private static final byte[] ADAPTATION_WORKAROUND_BUFFER = {0, 0, 1, 103, 66, -64, Ascii.f1132VT, -38, 37, -112, 0, 0, 1, 104, -50, Ascii.f1128SI, 19, 32, 0, 0, 1, 101, -120, -124, 13, -50, 113, Ascii.CAN, -96, 0, 47, -65, Ascii.f1122FS, 49, -61, 39, 93, 120};
    ...
    protected abstract boolean processOutputBuffer(long j, long j2, MediaCodecAdapter mediaCodecAdapter, ByteBuffer byteBuffer, int r7, int r8, int r9, long j3, boolean z, boolean z2, Format format) throws ExoPlaybackException;
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        public DecoderInitializationException(Format format, Throwable th, boolean z, int r14) {
            this("Decoder init failed: [" + r14 + "], " + format, th, format.sampleMimeType, z, null, buildCustomDiagnosticInfo(r14), null);
        }
        ...
        private static String buildCustomDiagnosticInfo(int r3) {
            String str = r3 < 0 ? "neg_" : "";
            return "com.google.android.exoplayer2.mediacodec.MediaCodecRenderer_" + str + Math.abs(r3);
        }
    }

    public MediaCodecRenderer(int r2, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, boolean z, float f) {
        super(r2);
        ...
        this.renderTimeLimitMs = C1856C.TIME_UNSET;
        this.pendingOutputStreamStartPositionsUs = new long[10];
        this.pendingOutputStreamOffsetsUs = new long[10];
        this.pendingOutputStreamSwitchTimesUs = new long[10];
        this.outputStreamStartPositionUs = C1856C.TIME_UNSET;
        this.outputStreamOffsetUs = C1856C.TIME_UNSET;
        ...
        this.inputIndex = -1;
        this.outputIndex = -1;
        this.codecHotswapDeadlineMs = C1856C.TIME_UNSET;
        this.largestQueuedPresentationTimeUs = C1856C.TIME_UNSET;
        this.lastBufferInStreamPresentationTimeUs = C1856C.TIME_UNSET;
    ...
    public void onStreamChanged(Format[] formatArr, long j, long j2) throws ExoPlaybackException {
        if (this.outputStreamOffsetUs == C1856C.TIME_UNSET) {
            Assertions.checkState(this.outputStreamStartPositionUs == C1856C.TIME_UNSET);
            this.outputStreamStartPositionUs = j;
            this.outputStreamOffsetUs = j2;
            return;
        }
        int r0 = this.pendingOutputStreamOffsetCount;
        if (r0 == this.pendingOutputStreamOffsetsUs.length) {
            Log.m1132w(TAG, "Too many stream changes, so dropping offset: " + this.pendingOutputStreamOffsetsUs[this.pendingOutputStreamOffsetCount - 1]);
        } else {
            this.pendingOutputStreamOffsetCount = r0 + 1;
        }
        long[] jArr = this.pendingOutputStreamStartPositionsUs;
        int r1 = this.pendingOutputStreamOffsetCount;
        jArr[r1 - 1] = j;
        this.pendingOutputStreamOffsetsUs[r1 - 1] = j2;
        this.pendingOutputStreamSwitchTimesUs[r1 - 1] = this.largestQueuedPresentationTimeUs;
    }
    ...
    public void onPositionReset(long j, boolean z) throws ExoPlaybackException {
        ...
        int r5 = this.pendingOutputStreamOffsetCount;
        if (r5 != 0) {
            this.outputStreamOffsetUs = this.pendingOutputStreamOffsetsUs[r5 - 1];
            this.outputStreamStartPositionUs = this.pendingOutputStreamStartPositionsUs[r5 - 1];
    ...
    protected boolean flushOrReleaseCodec() {
        ...
        int r0 = this.codecDrainAction;
        if (r0 == 3 || this.codecNeedsFlushWorkaround || ((this.codecNeedsSosFlushWorkaround && !this.codecHasOutputMediaFormat) || (this.codecNeedsEosFlushWorkaround && this.codecReceivedEos))) {
            releaseCodec();
            return true;
        }
        if (r0 == 2) {
            ...
            if (Util.SDK_INT >= 23) {
                try {
                    ...
                    Log.m1131w(TAG, "Failed to update the DRM session, releasing the codec instead.", e);
                    releaseCodec();
                    return true;
                }
            }
    ...
    private boolean readSourceOmittingSampleData(int r4) throws ExoPlaybackException {
        FormatHolder formatHolder = getFormatHolder();
        this.noDataBuffer.clear();
        int readSource = readSource(formatHolder, this.noDataBuffer, r4 | 4);
        if (readSource == -5) {
    ...
    */
    private void maybeInitCodecWithFallback(android.media.MediaCrypto r8, boolean r9) throws com.google.android.exoplayer2.mediacodec.MediaCodecRenderer.DecoderInitializationException {
        ...
        L60:
            ...
            com.google.android.exoplayer2.util.Log.m1132w(r4, r3)     // Catch: java.lang.Exception -> L74
            r5 = 50
        ...
        L74:
            ...
            com.google.android.exoplayer2.util.Log.m1131w(r4, r5, r3)
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (decoderInfos.isEmpty() && z) {
            ...
            if (!decoderInfos.isEmpty()) {
                Log.m1132w(TAG, "Drm session requires secure decoder for " + this.inputFormat.sampleMimeType + ", but no secure decoder available. Trying to proceed with " + decoderInfos + ".");
            }
        }
        return decoderInfos;
    }
    ...
    private boolean shouldContinueRendering(long j) {
        return this.renderTimeLimitMs == C1856C.TIME_UNSET || SystemClock.elapsedRealtime() - j < this.renderTimeLimitMs;
    }
    ...
    private boolean feedInputBuffer() throws ExoPlaybackException {
        int r0;
        if (this.codec == null || (r0 = this.codecDrainState) == 2 || this.inputStreamEnded) {
            return false;
        }
        if (r0 == 0 && shouldReinitCodec()) {
        ...
        if (this.codecDrainState == 1) {
            ...
            if (this.codecReconfigurationState == 1) {
                for (int r02 = 0; r02 < this.codecInputFormat.initializationData.size(); r02++) {
                    this.buffer.data.put(this.codecInputFormat.initializationData.get(r02));
                }
    ...
    */
    ...
    public void onProcessedOutputBuffer(long j) {
        while (true) {
            int r0 = this.pendingOutputStreamOffsetCount;
            if (r0 == 0 || j < this.pendingOutputStreamSwitchTimesUs[0]) {
                return;
            }
            long[] jArr = this.pendingOutputStreamStartPositionsUs;
            ...
            int r02 = r0 - 1;
            this.pendingOutputStreamOffsetCount = r02;
    ...
    public boolean isReady() {
        return this.inputFormat != null && (isSourceReady() || hasOutputBuffer() || (this.codecHotswapDeadlineMs != C1856C.TIME_UNSET && SystemClock.elapsedRealtime() < this.codecHotswapDeadlineMs));
    }
    ...
    private boolean drmNeedsCodecReinitialization(MediaCodecInfo mediaCodecInfo, Format format, DrmSession drmSession, DrmSession drmSession2) throws ExoPlaybackException {
        ...
        if (drmSession2 == null || drmSession == null || Util.SDK_INT < 23 || C1856C.PLAYREADY_UUID.equals(drmSession.getSchemeUuid()) || C1856C.PLAYREADY_UUID.equals(drmSession2.getSchemeUuid()) || (frameworkCryptoConfig = getFrameworkCryptoConfig(drmSession2)) == null) {
            return true;
        }
    ...
    private boolean isDecodeOnlyBuffer(long j) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            if (this.decodeOnlyPresentationTimestamps.get(r2).longValue() == j) {
                this.decodeOnlyPresentationTimestamps.remove(r2);
                return true;
            }
        }
        return false;
