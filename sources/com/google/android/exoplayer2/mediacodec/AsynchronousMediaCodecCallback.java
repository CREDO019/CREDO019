...
public final class AsynchronousMediaCodecCallback extends MediaCodec.Callback {
    ...
    public int dequeueInputBufferIndex() {
        synchronized (this.lock) {
            ...
            if (!this.availableInputBuffers.isEmpty()) {
                r2 = this.availableInputBuffers.remove();
            }
            return r2;
        }
    }
    ...
    public void onInputBufferAvailable(MediaCodec mediaCodec, int r3) {
        synchronized (this.lock) {
            this.availableInputBuffers.add(r3);
        }
    }

    @Override // android.media.MediaCodec.Callback
    public void onOutputBufferAvailable(MediaCodec mediaCodec, int r3, MediaCodec.BufferInfo bufferInfo) {
        synchronized (this.lock) {
            ...
            this.availableOutputBuffers.add(r3);
