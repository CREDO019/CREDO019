...
public class DefaultDrmSession implements DrmSession {
    ...
    public interface ReferenceCountListener {
        void onReferenceCountDecremented(DefaultDrmSession defaultDrmSession, int r2);

        void onReferenceCountIncremented(DefaultDrmSession defaultDrmSession, int r2);
    }
    ...
    public DefaultDrmSession(UUID r2, ExoMediaDrm exoMediaDrm, ProvisioningManager provisioningManager, ReferenceCountListener referenceCountListener, List<DrmInitData.SchemeData> list, int r7, boolean z, boolean z2, byte[] bArr, HashMap<String, String> hashMap, MediaDrmCallback mediaDrmCallback, Looper looper, LoadErrorHandlingPolicy loadErrorHandlingPolicy, PlayerId playerId) {
        if (r7 == 1 || r7 == 3) {
    ...
    public void onMediaDrmEvent(int r2) {
        if (r2 != 2) {
            return;
        }
        onKeysRequired();
    ...
    public void acquire(DrmSessionEventListener.EventDispatcher eventDispatcher) {
        if (this.referenceCount < 0) {
            Log.m1136e(TAG, "Session reference count less than zero: " + this.referenceCount);
    ...
    public void release(DrmSessionEventListener.EventDispatcher eventDispatcher) {
        ...
        if (r0 <= 0) {
            Log.m1136e(TAG, "release() called on a session that's already fully released.");
            return;
        }
        int r02 = r0 - 1;
        this.referenceCount = r02;
        if (r02 == 0) {
            this.state = 0;
    ...
    private void doLicense(boolean z) {
        ...
        if (r1 != 0 && r1 != 1) {
            ...
            Log.m1138d(TAG, "Offline license has expired or will expire soon. Remaining seconds: " + licenseDurationRemainingSec);
            postKeyRequest(bArr, 2, z);
        }
    }
    ...
    private long getLicenseDurationRemainingSec() {
        if (C1856C.WIDEVINE_UUID.equals(this.uuid)) {
    ...
    private void postKeyRequest(byte[] bArr, int r6, boolean z) {
        try {
            this.currentKeyRequest = this.mediaDrm.getKeyRequest(bArr, this.schemeDatas, r6, this.keyRequestParameters);
    ...
    public void onKeyResponse(Object obj, Object obj2) {
        if (obj == this.currentKeyRequest && isOpen()) {
            ...
            try {
                ...
                int r3 = this.mode;
                if ((r3 == 2 || (r3 == 0 && this.offlineLicenseKeySetId != null)) && provideKeyResponse != null && provideKeyResponse.length != 0) {
    ...
    private void onError(final Exception exc, int r3) {
        this.lastException = new DrmSession.DrmSessionException(exc, DrmUtil.getErrorCodeForMediaDrmException(exc, r3));
        Log.m1135e(TAG, "DRM session error", exc);
    ...
    public class RequestHandler extends Handler {
        ...
        void post(int r9, Object obj, boolean z) {
            obtainMessage(r9, new RequestTask(LoadEventInfo.getNewId(), z, SystemClock.elapsedRealtime(), obj)).sendToTarget();
        }
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                Log.m1131w(DefaultDrmSession.TAG, "Key/provisioning request produced an unexpected exception. Not retrying.", e2);
                bArr = e2;
            }
