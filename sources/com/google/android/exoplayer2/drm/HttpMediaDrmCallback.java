...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeProvisionRequest(UUID r3, ExoMediaDrm.ProvisionRequest provisionRequest) throws MediaDrmCallbackException {
    ...
    @Override // com.google.android.exoplayer2.drm.MediaDrmCallback
    public byte[] executeKeyRequest(UUID r8, ExoMediaDrm.KeyRequest keyRequest) throws MediaDrmCallbackException {
        String str;
        ...
        if (TextUtils.isEmpty(licenseServerUrl)) {
            throw new MediaDrmCallbackException(new DataSpec.Builder().setUri(Uri.EMPTY).build(), Uri.EMPTY, ImmutableMap.m390of(), 0L, new IllegalStateException("No license URL"));
        }
        HashMap hashMap = new HashMap();
        if (C1856C.PLAYREADY_UUID.equals(r8)) {
            str = "text/xml";
        } else {
            str = C1856C.CLEARKEY_UUID.equals(r8) ? "application/json" : "application/octet-stream";
        }
        ...
        while (true) {
            try {
                ...
                try {
                    ...
                    String redirectUrl = getRedirectUrl(e, r8);
                    if (redirectUrl == null) {
                        throw e;
                    }
                    r8++;
    ...
    private static String getRedirectUrl(HttpDataSource.InvalidResponseCodeException invalidResponseCodeException, int r4) {
        Map<String, List<String>> map;
        List<String> list;
        if (!((invalidResponseCodeException.responseCode == 307 || invalidResponseCodeException.responseCode == 308) && r4 < 5) || (map = invalidResponseCodeException.headerFields) == null || (list = map.get("Location")) == null || list.isEmpty()) {
            return null;
        }
        return list.get(0);
    }
