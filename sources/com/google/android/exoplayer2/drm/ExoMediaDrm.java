...
public interface ExoMediaDrm {
    ...
    public interface OnEventListener {
        void onEvent(ExoMediaDrm exoMediaDrm, byte[] bArr, int r3, int r4, byte[] bArr2);
    }
    ...
    public interface Provider {
        ExoMediaDrm acquireExoMediaDrm(UUID r1);
    }
    ...
    KeyRequest getKeyRequest(byte[] bArr, List<DrmInitData.SchemeData> list, int r3, HashMap<String, String> hashMap) throws NotProvisionedException;
    ...
    public static final class AppManagedProvider implements Provider {
        ...
        public ExoMediaDrm acquireExoMediaDrm(UUID r1) {
    ...
    public static final class KeyStatus {
        ...
        public KeyStatus(int r1, byte[] bArr) {
            this.statusCode = r1;
            this.keyId = bArr;
        }
    ...
    public static final class KeyRequest {
        ...
        public KeyRequest(byte[] bArr, String str, int r3) {
            this.data = bArr;
