...
public final class Requirements implements Parcelable {
    public static final Parcelable.Creator<Requirements> CREATOR = new Parcelable.Creator<Requirements>() { // from class: com.google.android.exoplayer2.scheduler.Requirements.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public Requirements[] newArray(int r1) {
            return new Requirements[r1];
        }
    };
    ...
    public Requirements(int r2) {
        this.requirements = (r2 & 2) != 0 ? r2 | 1 : r2;
    }
    ...
    public Requirements filterRequirements(int r2) {
        int r0 = this.requirements;
        int r22 = r2 & r0;
        return r22 == r0 ? this : new Requirements(r22);
    }
