...
public final class PlatformScheduler implements Scheduler {
    ...
    public PlatformScheduler(Context context, int r3) {
    ...
    private static JobInfo buildJobInfo(int r3, ComponentName componentName, Requirements requirements, String str, String str2) {
        ...
        if (!filterRequirements.equals(requirements)) {
            Log.m1132w(TAG, "Ignoring unsupported requirements: " + (filterRequirements.getRequirements() ^ requirements.getRequirements()));
        }
        JobInfo.Builder builder = new JobInfo.Builder(r3, componentName);
    ...
    public static final class PlatformSchedulerService extends JobService {
        ...
        public boolean onStartJob(JobParameters jobParameters) {
            ...
            Log.m1132w(PlatformScheduler.TAG, "Requirements not met: " + notMetRequirements);
