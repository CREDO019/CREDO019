...
public class DefaultDownloaderFactory implements DownloaderFactory {
    ...
    private Downloader createDownloader(DownloadRequest downloadRequest, int r5) {
        Constructor<? extends Downloader> constructor = CONSTRUCTORS.get(r5);
        if (constructor == null) {
            throw new IllegalStateException("Module missing for content type " + r5);
        }
        try {
            ...
            throw new IllegalStateException("Failed to instantiate downloader for content type " + r5);
        }
    }
