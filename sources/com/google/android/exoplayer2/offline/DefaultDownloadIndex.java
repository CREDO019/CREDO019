...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    @Override // com.google.android.exoplayer2.offline.DownloadIndex
    public DownloadCursor getDownloads(int... r3) throws DatabaseIOException {
        ensureInitialized();
        return new DownloadCursorImpl(getCursor(getStateQuery(r3), null));
    }
    ...
    @Override // com.google.android.exoplayer2.offline.WritableDownloadIndex
    public void setStopReason(int r5) throws DatabaseIOException {
        ensureInitialized();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put("stop_reason", Integer.valueOf(r5));
    ...
    @Override // com.google.android.exoplayer2.offline.WritableDownloadIndex
    public void setStopReason(String str, int r7) throws DatabaseIOException {
        ensureInitialized();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put("stop_reason", Integer.valueOf(r7));
    ...
    private void putDownloadInternal(Download download, SQLiteDatabase sQLiteDatabase) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put("id", download.request.f233id);
    ...
    static String encodeStreamKeys(List<StreamKey> list) {
        ...
        for (int r1 = 0; r1 < list.size(); r1++) {
            StreamKey streamKey = list.get(r1);
    ...
    private static String getStateQuery(int... r3) {
        if (r3.length == 0) {
            return "1";
        }
        StringBuilder sb = new StringBuilder();
    ...
    public static Download getDownloadForCurrentRow(Cursor cursor) {
        ...
        int r5 = cursor.getInt(6);
        return new Download(build, r5, cursor.getLong(7), cursor.getLong(8), cursor.getLong(9), cursor.getInt(10), r5 == 4 ? cursor.getInt(11) : 0, downloadProgress);
    }
    ...
    private static final class DownloadCursorImpl implements DownloadCursor {
        ...
        public boolean moveToPosition(int r2) {
            return this.cursor.moveToPosition(r2);
        }
