...
public abstract class DownloadService extends Service {
    ...
    public static boolean needsStartedService(int r1) {
        return r1 == 2 || r1 == 5 || r1 == 7;
    }

    protected abstract DownloadManager getDownloadManager();

    protected abstract Notification getForegroundNotification(List<Download> list, int r2);
    ...
    protected DownloadService(int r8, long j) {
        this(r8, j, null, 0, 0);
    }

    @Deprecated
    protected DownloadService(int r8, long j, String str, int r12) {
        this(r8, j, str, r12, 0);
    }

    protected DownloadService(int r2, long j, String str, int r6, int r7) {
        if (r2 == 0) {
        ...
        this.foregroundNotificationUpdater = new ForegroundNotificationUpdater(r2, j);
        this.channelId = str;
        this.channelNameResourceId = r6;
        this.channelDescriptionResourceId = r7;
    }
    ...
    public static Intent buildAddDownloadIntent(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, int r4, boolean z) {
        return getIntent(context, cls, ACTION_ADD_DOWNLOAD, z).putExtra(KEY_DOWNLOAD_REQUEST, downloadRequest).putExtra(KEY_STOP_REASON, r4);
    }
    ...
    public static Intent buildSetStopReasonIntent(Context context, Class<? extends DownloadService> cls, String str, int r4, boolean z) {
        return getIntent(context, cls, ACTION_SET_STOP_REASON, z).putExtra(KEY_CONTENT_ID, str).putExtra(KEY_STOP_REASON, r4);
    }
    ...
    public static void sendAddDownload(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, int r3, boolean z) {
        startService(context, buildAddDownloadIntent(context, cls, downloadRequest, r3, z), z);
    }
    ...
    public static void sendSetStopReason(Context context, Class<? extends DownloadService> cls, String str, int r3, boolean z) {
        startService(context, buildSetStopReasonIntent(context, cls, str, r3, z), z);
    }
        ...
        switch (c) {
            case 0:
                ...
                if (downloadRequest == null) {
                    Log.m1136e(TAG, "Ignored ADD_DOWNLOAD: Missing download_request extra");
                    break;
                } else {
            ...
            case 4:
                ...
                if (requirements == null) {
                    Log.m1136e(TAG, "Ignored SET_REQUIREMENTS: Missing requirements extra");
                    break;
                } else {
            ...
            case 6:
                if (!((Intent) Assertions.checkNotNull(intent)).hasExtra(KEY_STOP_REASON)) {
                    Log.m1136e(TAG, "Ignored SET_STOP_REASON: Missing stop_reason extra");
                    break;
                } else {
            ...
            case '\b':
                if (str == null) {
                    Log.m1136e(TAG, "Ignored REMOVE_DOWNLOAD: Missing content_id extra");
                    break;
                } else {
            ...
            default:
                Log.m1136e(TAG, "Ignored unrecognized action: " + str2);
                break;
        }
    ...
    public void notifyDownloads(List<Download> list) {
        if (this.foregroundNotificationUpdater != null) {
            for (int r0 = 0; r0 < list.size(); r0++) {
                if (needsStartedService(list.get(r0).state)) {
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public ForegroundNotificationUpdater(int r2, long j) {
            this.notificationId = r2;
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadService$DownloadManagerHelper$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DownloadService.DownloadManagerHelper.this.m1178x5d17c8bb(downloadService);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m1178x5d17c8bb(DownloadService downloadService) {
        ...
        public boolean updateScheduler() {
            ...
            if (!this.scheduler.getSupportedRequirements(requirements).equals(requirements)) {
                ...
                Log.m1132w(DownloadService.TAG, "Failed to schedule restart");
                cancelScheduler();
                return false;
            } else {
                return true;
        ...
        public void onDownloadChanged(DownloadManager downloadManager, Download download, Exception exc) {
            ...
            if (serviceMayNeedRestart() && DownloadService.needsStartedService(download.state)) {
                Log.m1132w(DownloadService.TAG, "DownloadService wasn't running. Restarting.");
                restartService();
            }
        }
        ...
        @Override // com.google.android.exoplayer2.offline.DownloadManager.Listener
        public void onRequirementsStateChanged(DownloadManager downloadManager, Requirements requirements, int r3) {
            updateScheduler();
        }
        ...
        public void onWaitingForRequirementsChanged(DownloadManager downloadManager, boolean z) {
            ...
            for (int r3 = 0; r3 < currentDownloads.size(); r3++) {
                if (currentDownloads.get(r3).state == 0) {
                    restartService();
                    return;
                }
            }
        ...
        private void restartService() {
            if (this.foregroundAllowed) {
                try {
                    ...
                    Log.m1132w(DownloadService.TAG, "Failed to restart (foreground launch restriction)");
                    return;
                }
            }
            try {
                ...
                Log.m1132w(DownloadService.TAG, "Failed to restart (process is idle)");
            }
        }
    }
}
