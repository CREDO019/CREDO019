...
public class DebugTextViewHelper {
    ...
    protected String getVideoString() {
        ...
        return "\n" + videoFormat.sampleMimeType + "(id:" + videoFormat.f212id + " r:" + videoFormat.width + "x" + videoFormat.height + getPixelAspectRatioString(videoFormat.pixelWidthHeightRatio) + getDecoderCountersBufferCountString(videoDecoderCounters) + " vfpo: " + getVideoFrameProcessingOffsetAverageString(videoDecoderCounters.totalVideoFrameProcessingOffsetUs, videoDecoderCounters.videoFrameProcessingOffsetCount) + ")";
    }
    ...
    protected String getAudioString() {
        ...
        return "\n" + audioFormat.sampleMimeType + "(id:" + audioFormat.f212id + " hz:" + audioFormat.sampleRate + " ch:" + audioFormat.channelCount + getDecoderCountersBufferCountString(audioDecoderCounters) + ")";
    }
    ...
    private static String getVideoFrameProcessingOffsetAverageString(long j, int r4) {
        return r4 == 0 ? "N/A" : String.valueOf((long) (j / r4));
    }
