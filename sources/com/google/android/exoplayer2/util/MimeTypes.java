...
public final class MimeTypes {
    ...
    public static String getMimeTypeFromMp4ObjectType(int r1) {
        if (r1 != 32) {
            if (r1 != 33) {
                if (r1 != 35) {
                    if (r1 != 64) {
    ...
    public static void registerCustomMimeType(String str, String str2, int r5) {
        CustomMimeType customMimeType = new CustomMimeType(str, str2, r5);
        ...
        while (true) {
            ...
            if (str.equals(arrayList.get(r52).mimeType)) {
    ...
    private static String getCustomMimeTypeForCodec(String str) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            CustomMimeType customMimeType = customMimeTypes.get(r1);
    ...
    public static final class Mp4aObjectType {
        ...
        public Mp4aObjectType(int r1, int r2) {
            this.objectTypeIndication = r1;
            this.audioObjectTypeIndication = r2;
        }

        public int getEncoding() {
            int r0 = this.audioObjectTypeIndication;
            if (r0 != 2) {
                if (r0 != 5) {
                    if (r0 != 29) {
                        if (r0 != 42) {
    ...
    public static final class CustomMimeType {
        ...
        public CustomMimeType(String str, String str2, int r3) {
            this.mimeType = str;
