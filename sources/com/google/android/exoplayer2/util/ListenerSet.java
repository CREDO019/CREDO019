...
public final class ListenerSet<T> {
    ...
    public void queueEvent(final int r4, final Event<T> event) {
        ...
        this.queuedEvents.add(new Runnable() { // from class: com.google.android.exoplayer2.util.ListenerSet$$ExternalSyntheticLambda1
            ...
            public final void run() {
                ListenerSet.lambda$queueEvent$0(copyOnWriteArraySet, r4, event);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void lambda$queueEvent$0(CopyOnWriteArraySet copyOnWriteArraySet, int r2, Event event) {
        Iterator it = copyOnWriteArraySet.iterator();
        while (it.hasNext()) {
            ((ListenerHolder) it.next()).invoke(r2, event);
        }
    }
    ...
    public void sendEvent(int r1, Event<T> event) {
        queueEvent(r1, event);
        flushEvents();
    }
    ...
    public static final class ListenerHolder<T> {
        ...
        public void invoke(int r2, Event<T> event) {
            if (this.released) {
                return;
            }
            if (r2 != -1) {
