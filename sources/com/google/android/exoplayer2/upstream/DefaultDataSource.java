...
public final class DefaultDataSource implements DataSource {
    ...
    public DefaultDataSource(Context context, String str, int r4, int r5, boolean z) {
        this(context, new DefaultHttpDataSource.Factory().setUserAgent(str).setConnectTimeoutMs(r4).setReadTimeoutMs(r5).setAllowCrossProtocolRedirects(z).createDataSource());
    }
    ...
    public int read(byte[] bArr, int r3, int r4) throws IOException {
        return ((DataSource) Assertions.checkNotNull(this.dataSource)).read(bArr, r3, r4);
    }
    ...
    private DataSource getRtmpDataSource() {
        if (this.rtmpDataSource == null) {
            try {
                ...
                Log.m1132w(TAG, "Attempting to play RTMP stream without depending on the RTMP extension");
            } catch (Exception e) {
    ...
    private void addListenersToDataSource(DataSource dataSource) {
        for (int r0 = 0; r0 < this.transferListeners.size(); r0++) {
            dataSource.addTransferListener(this.transferListeners.get(r0));
        }
    }
