...
public final class CacheDataSource implements DataSource {
    ...
    public static final class Factory implements DataSource.Factory {
        ...
        public Factory setUpstreamPriority(int r1) {
            this.upstreamPriority = r1;
            return this;
        }

        public Factory setFlags(int r1) {
            this.flags = r1;
            return this;
        }
        ...
        private CacheDataSource createDataSourceInternal(DataSource dataSource, int r14, int r15) {
            DataSink dataSink;
            ...
            return new CacheDataSource(cache, dataSource, this.cacheReadDataSourceFactory.createDataSource(), dataSink, this.cacheKeyFactory, r14, this.upstreamPriorityTaskManager, r15, this.eventListener);
        }
    }
    ...
    public CacheDataSource(Cache cache, DataSource dataSource, int r10) {
        this(cache, dataSource, new FileDataSource(), new CacheDataSink(cache, CacheDataSink.DEFAULT_FRAGMENT_SIZE), r10, null);
    }

    public CacheDataSource(Cache cache, DataSource dataSource, DataSource dataSource2, DataSink dataSink, int r13, EventListener eventListener) {
        this(cache, dataSource, dataSource2, dataSink, r13, eventListener, null);
    }

    public CacheDataSource(Cache cache, DataSource dataSource, DataSource dataSource2, DataSink dataSink, int r15, EventListener eventListener, CacheKeyFactory cacheKeyFactory) {
        this(cache, dataSource, dataSource2, dataSink, cacheKeyFactory, r15, null, 0, eventListener);
    }

    private CacheDataSource(Cache cache, DataSource dataSource, DataSource dataSource2, DataSink dataSink, CacheKeyFactory cacheKeyFactory, int r6, PriorityTaskManager priorityTaskManager, int r8, EventListener eventListener) {
        this.cache = cache;
        this.cacheReadDataSource = dataSource2;
        this.cacheKeyFactory = cacheKeyFactory == null ? CacheKeyFactory.DEFAULT : cacheKeyFactory;
        this.blockOnCache = (r6 & 1) != 0;
        this.ignoreCacheOnError = (r6 & 2) != 0;
        this.ignoreCacheForUnsetLengthRequests = (r6 & 4) != 0;
        if (dataSource != null) {
            dataSource = priorityTaskManager != null ? new PriorityDataSource(dataSource, priorityTaskManager, r8) : dataSource;
    ...
    public int read(byte[] bArr, int r14, int r15) throws IOException {
        ...
        try {
            ...
            int read = ((DataSource) Assertions.checkNotNull(this.currentDataSource)).read(bArr, r14, r15);
            if (read != -1) {
    ...
    private void notifyCacheIgnored(int r2) {
        ...
        if (eventListener != null) {
            eventListener.onCacheIgnored(r2);
        }
    }
