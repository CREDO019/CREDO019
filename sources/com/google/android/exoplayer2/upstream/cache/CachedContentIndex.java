...
public class CachedContentIndex {
    ...
    public void store() throws IOException {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            this.idToKey.remove(this.removedIds.keyAt(r1));
        }
    ...
    public int assignIdForKey(String str) {
        return getOrAdd(str).f253id;
    }

    public String getKeyForId(int r2) {
        return this.idToKey.get(r2);
    }
    ...
    public void maybeRemove(String str) {
        ...
        if (cachedContent != null && cachedContent.isEmpty() && cachedContent.isFullyUnlocked()) {
            ...
            int r4 = cachedContent.f253id;
            boolean z = this.newIds.get(r4);
            this.storage.onRemove(cachedContent, z);
            if (z) {
                this.idToKey.remove(r4);
                this.newIds.delete(r4);
                return;
            }
            this.idToKey.put(r4, null);
            this.removedIds.put(r4, true);
        }
    }
    ...
    static int getNewId(SparseArray<String> sparseArray) {
        ...
        if (keyAt < 0) {
            while (r1 < size && r1 == sparseArray.keyAt(r1)) {
                r1++;
            }
            return r1;
        }
    ...
    public static DefaultContentMetadata readContentMetadata(DataInputStream dataInputStream) throws IOException {
        ...
        for (int r3 = 0; r3 < readInt; r3++) {
            ...
            while (r9 != readInt2) {
                int r10 = r9 + min;
                bArr = Arrays.copyOf(bArr, r10);
                dataInputStream.readFully(bArr, r9, min);
                min = Math.min(readInt2 - r10, (int) INCREMENTAL_METADATA_READ_LENGTH);
                r9 = r10;
            }
    ...
    private static class LegacyStorage implements Storage {
                ...
                try {
                    ...
                    if (readInt >= 0 && readInt <= 2) {
                        ...
                        for (int r5 = 0; r5 < readInt2; r5++) {
                            ...
                            sparseArray.put(readCachedContent.f253id, readCachedContent.key);
                            r6 += hashCachedContent(readCachedContent, readInt);
                        }
        ...
        private void writeFile(HashMap<String, CachedContent> hashMap) throws IOException {
            ...
            try {
                ...
                for (CachedContent cachedContent : hashMap.values()) {
                    ...
                    r6 += hashCachedContent(cachedContent, 2);
                }
        ...
        private int hashCachedContent(CachedContent cachedContent, int r5) {
            int hashCode = (cachedContent.f253id * 31) + cachedContent.key.hashCode();
            if (r5 < 2) {
        ...
        private CachedContent readCachedContent(int r4, DataInputStream dataInputStream) throws IOException {
        ...
        private void writeCachedContent(CachedContent cachedContent, DataOutputStream dataOutputStream) throws IOException {
            dataOutputStream.writeInt(cachedContent.f253id);
    ...
    private static final class DatabaseStorage implements Storage {
        ...
        public void load(HashMap<String, CachedContent> hashMap, SparseArray<String> sparseArray) throws IOException {
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    ...
                    sparseArray.put(cachedContent.f253id, cachedContent.key);
                }
                if (cursor != null) {
                    cursor.close();
                }
        ...
        public void storeIncremental(HashMap<String, CachedContent> hashMap) throws IOException {
            ...
            try {
                SQLiteDatabase writableDatabase = this.databaseProvider.getWritableDatabase();
                writableDatabase.beginTransactionNonExclusive();
                for (int r0 = 0; r0 < this.pendingUpdates.size(); r0++) {
                    CachedContent valueAt = this.pendingUpdates.valueAt(r0);
                    if (valueAt == null) {
                        deleteRow(writableDatabase, this.pendingUpdates.keyAt(r0));
                    } else {
        ...
        @Override // com.google.android.exoplayer2.upstream.cache.CachedContentIndex.Storage
        public void onUpdate(CachedContent cachedContent) {
            this.pendingUpdates.put(cachedContent.f253id, cachedContent);
        }

        @Override // com.google.android.exoplayer2.upstream.cache.CachedContentIndex.Storage
        public void onRemove(CachedContent cachedContent, boolean z) {
            if (z) {
                this.pendingUpdates.delete(cachedContent.f253id);
            } else {
                this.pendingUpdates.put(cachedContent.f253id, null);
            }
        }
        ...
        private void deleteRow(SQLiteDatabase sQLiteDatabase, int r5) {
            sQLiteDatabase.delete((String) Assertions.checkNotNull(this.tableName), WHERE_ID_EQUALS, new String[]{Integer.toString(r5)});
        }
        ...
        private void addOrUpdateRow(SQLiteDatabase sQLiteDatabase, CachedContent cachedContent) throws IOException {
            ...
            contentValues.put("id", Integer.valueOf(cachedContent.f253id));
