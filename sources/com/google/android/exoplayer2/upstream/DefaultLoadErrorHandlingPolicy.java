...
public class DefaultLoadErrorHandlingPolicy implements LoadErrorHandlingPolicy {
    ...
    public DefaultLoadErrorHandlingPolicy(int r1) {
        this.minimumLoadableRetryCount = r1;
    }
    ...
    public long getRetryDelayMsFor(LoadErrorHandlingPolicy.LoadErrorInfo loadErrorInfo) {
        ...
        return ((iOException instanceof ParserException) || (iOException instanceof FileNotFoundException) || (iOException instanceof HttpDataSource.CleartextNotPermittedException) || (iOException instanceof Loader.UnexpectedLoaderException) || DataSourceException.isCausedByPositionOutOfRange(iOException)) ? C1856C.TIME_UNSET : Math.min((loadErrorInfo.errorCount - 1) * 1000, 5000);
    }

    @Override // com.google.android.exoplayer2.upstream.LoadErrorHandlingPolicy
    public int getMinimumLoadableRetryCount(int r3) {
        int r0 = this.minimumLoadableRetryCount;
        return r0 == -1 ? r3 == 7 ? 6 : 3 : r0;
    }
