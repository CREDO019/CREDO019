...
public final class DataSpec {
    ...
    public static final class Builder {
        ...
        public Builder setHttpMethod(int r1) {
            this.httpMethod = r1;
            return this;
        }
    ...
    public static String getStringForHttpMethod(int r1) {
        if (r1 != 1) {
            if (r1 != 2) {
                if (r1 == 3) {
                    return "HEAD";
    ...
    @Deprecated
    public DataSpec(Uri uri, int r10) {
        this(uri, 0L, -1L, null, r10);
    }
    ...
    @Deprecated
    public DataSpec(Uri uri, long j, long j2, String str, int r17) {
        this(uri, j, j, j2, str, r17);
    }

    @Deprecated
    public DataSpec(Uri uri, long j, long j2, String str, int r20, Map<String, String> map) {
        this(uri, 1, null, j, j, j2, str, r20, map);
    }

    @Deprecated
    public DataSpec(Uri uri, long j, long j2, long j3, String str, int r20) {
        this(uri, null, j, j2, j3, str, r20);
    }

    @Deprecated
    public DataSpec(Uri uri, byte[] bArr, long j, long j2, long j3, String str, int r22) {
        this(uri, bArr != null ? 2 : 1, bArr, j, j2, j3, str, r22);
    }

    @Deprecated
    public DataSpec(Uri uri, int r15, byte[] bArr, long j, long j2, long j3, String str, int r24) {
        this(uri, r15, bArr, j, j2, j3, str, r24, Collections.emptyMap());
    }

    @Deprecated
    public DataSpec(Uri uri, int r16, byte[] bArr, long j, long j2, long j3, String str, int r25, Map<String, String> map) {
        this(uri, j - j2, r16, bArr, map, j2, j3, str, r25, null);
    }

    private DataSpec(Uri uri, long j, int r19, byte[] bArr, Map<String, String> map, long j2, long j3, String str, int r27, Object obj) {
        byte[] bArr2 = bArr;
        long j4 = j + j2;
        boolean z = true;
    ...
    public boolean isFlagSet(int r2) {
