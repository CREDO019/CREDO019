...
public final class FileDataSource extends BaseDataSource {
    ...
    public static class FileDataSourceException extends DataSourceException {
        ...
        public FileDataSourceException(Throwable th, int r2) {
            super(th, r2);
        }

        public FileDataSourceException(String str, Throwable th, int r3) {
            super(str, th, r3);
        }
    }
    ...
    public int read(byte[] bArr, int r7, int r8) throws FileDataSourceException {
        if (r8 == 0) {
            return 0;
        }
        ...
        try {
            int read = ((RandomAccessFile) Util.castNonNull(this.file)).read(bArr, r7, (int) Math.min(this.bytesRemaining, r8));
            if (read > 0) {
    ...
    private static RandomAccessFile openLocalFile(Uri uri) throws FileDataSourceException {
        int r0 = PlaybackException.ERROR_CODE_IO_NO_PERMISSION;
        try {
            ...
            if (Util.SDK_INT < 21 || !Api21.isPermissionError(e.getCause())) {
                r0 = PlaybackException.ERROR_CODE_IO_FILE_NOT_FOUND;
            }
            throw new FileDataSourceException(e, r0);
