...
public interface BandwidthMeter {
    ...
    public interface EventListener {
        void onBandwidthSample(int r1, long j, long j2);
        ...
        public static final class EventDispatcher {
            ...
            public void bandwidthSample(final int r11, final long j, final long j2) {
                Iterator<HandlerAndListener> it = this.listeners.iterator();
                while (it.hasNext()) {
                    ...
                    if (!next.released) {
                        next.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.upstream.BandwidthMeter$EventListener$EventDispatcher$$ExternalSyntheticLambda0
                            ...
                            public final void run() {
                                BandwidthMeter.EventListener.EventDispatcher.HandlerAndListener.this.listener.onBandwidthSample(r11, j, j2);
                            }
                        });
                    }
                }
