...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI = ImmutableList.m404of(4800000L, 3100000L, 2100000L, 1500000L, 800000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_2G = ImmutableList.m404of(1500000L, 1000000L, 730000L, 440000L, 170000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_3G = ImmutableList.m404of(2200000L, 1400000L, 1100000L, 910000L, 620000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_4G = ImmutableList.m404of(3000000L, 1900000L, 1400000L, 1000000L, 660000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA = ImmutableList.m404of(6000000L, 4100000L, 3200000L, (long) Long.valueOf((long) Constants.SESSION_TIMEOUT_MILLIS), 1000000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA = ImmutableList.m404of(2800000L, 2400000L, 1600000L, 1100000L, 950000L);
    ...
    public static final class Builder {
        ...
        public Builder setSlidingWindowMaxWeight(int r1) {
            this.slidingWindowMaxWeight = r1;
            return this;
        }
        ...
        public Builder setInitialBitrateEstimate(int r2, long j) {
            this.initialBitrateEstimates.put(Integer.valueOf(r2), Long.valueOf(j));
            return this;
        }
    ...
    public DefaultBandwidthMeter() {
        this(null, ImmutableMap.m390of(), 2000, Clock.DEFAULT, false);
    }

    private DefaultBandwidthMeter(Context context, Map<Integer, Long> map, int r3, Clock clock, boolean z) {
        this.initialBitrateEstimates = ImmutableMap.copyOf((Map) map);
        this.eventDispatcher = new BandwidthMeter.EventListener.EventDispatcher();
        this.slidingPercentile = new SlidingPercentile(r3);
        this.clock = clock;
        this.resetOnNetworkTypeChange = z;
        if (context != null) {
            ...
            networkTypeObserver.register(new NetworkTypeObserver.Listener() { // from class: com.google.android.exoplayer2.upstream.DefaultBandwidthMeter$$ExternalSyntheticLambda0
                ...
                public final void onNetworkTypeChanged(int r2) {
                    DefaultBandwidthMeter.this.onNetworkTypeChanged(r2);
                }
            });
            return;
        }
    ...
    public synchronized void setNetworkTypeOverride(int r2) {
        this.networkTypeOverride = r2;
        this.networkTypeOverrideSet = true;
        onNetworkTypeChanged(r2);
    }
    ...
    @Override // com.google.android.exoplayer2.upstream.TransferListener
    public synchronized void onBytesTransferred(DataSource dataSource, DataSpec dataSpec, boolean z, int r4) {
        if (isTransferAtFullNetworkSpeed(dataSpec, z)) {
            this.sampleBytesTransferred += r4;
        }
    }
    ...
    public synchronized void onTransferEnd(DataSource dataSource, DataSpec dataSpec, boolean z) {
        if (isTransferAtFullNetworkSpeed(dataSpec, z)) {
            ...
            int r5 = (int) (elapsedRealtime - this.sampleStartTimeMs);
            this.totalElapsedTimeMs += r5;
            long j = this.totalBytesTransferred;
            long j2 = this.sampleBytesTransferred;
            this.totalBytesTransferred = j + j2;
            if (r5 > 0) {
                this.slidingPercentile.addSample((int) Math.sqrt(j2), (((float) j2) * 8000.0f) / r5);
                ...
                maybeNotifyBandwidthSample(r5, this.sampleBytesTransferred, this.bitrateEstimate);
    ...
    public synchronized void onNetworkTypeChanged(int r9) {
        int r0 = this.networkType;
        if (r0 == 0 || this.resetOnNetworkTypeChange) {
            if (this.networkTypeOverrideSet) {
                r9 = this.networkTypeOverride;
            }
            if (r0 == r9) {
                return;
            }
            this.networkType = r9;
            if (r9 != 1 && r9 != 0 && r9 != 8) {
                this.bitrateEstimate = getInitialBitrateEstimateForNetworkType(r9);
                long elapsedRealtime = this.clock.elapsedRealtime();
    ...
    private void maybeNotifyBandwidthSample(int r10, long j, long j2) {
        if (r10 == 0 && j == 0 && j2 == this.lastReportedBitrateEstimate) {
            return;
        }
        this.lastReportedBitrateEstimate = j2;
        this.eventDispatcher.bandwidthSample(r10, j, j2);
    }

    private long getInitialBitrateEstimateForNetworkType(int r3) {
        Long l = this.initialBitrateEstimates.get(Integer.valueOf(r3));
        if (l == null) {
