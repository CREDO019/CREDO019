...
public final class PriorityDataSource implements DataSource {
    ...
    public static final class Factory implements DataSource.Factory {
        ...
        public Factory(DataSource.Factory factory, PriorityTaskManager priorityTaskManager, int r3) {
    ...
    public PriorityDataSource(DataSource dataSource, PriorityTaskManager priorityTaskManager, int r3) {
    ...
    public int read(byte[] bArr, int r4, int r5) throws IOException {
        this.priorityTaskManager.proceedOrThrow(this.priority);
        return this.upstream.read(bArr, r4, r5);
    }
