...
public final class VersionTable {
    ...
    public static void setVersion(SQLiteDatabase sQLiteDatabase, int r3, String str, int r5) throws DatabaseIOException {
        try {
            sQLiteDatabase.execSQL(SQL_CREATE_TABLE_IF_NOT_EXISTS);
            ContentValues contentValues = new ContentValues();
            contentValues.put(COLUMN_FEATURE, Integer.valueOf(r3));
            contentValues.put(COLUMN_INSTANCE_UID, str);
            contentValues.put("version", Integer.valueOf(r5));
    ...
    public static void removeVersion(SQLiteDatabase sQLiteDatabase, int r3, String str) throws DatabaseIOException {
        try {
            if (Util.tableExists(sQLiteDatabase, TABLE_NAME)) {
                sQLiteDatabase.delete(TABLE_NAME, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(r3, str));
            }
        } catch (SQLException e) {
            throw new DatabaseIOException(e);
        }
    ...
    public static int getVersion(SQLiteDatabase sQLiteDatabase, int r11, String str) throws DatabaseIOException {
        try {
            if (Util.tableExists(sQLiteDatabase, TABLE_NAME)) {
                Cursor query = sQLiteDatabase.query(TABLE_NAME, new String[]{"version"}, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(r11, str), null, null, null);
                if (query.getCount() == 0) {
                    if (query != null) {
                        query.close();
                    }
    ...
    private static String[] featureAndInstanceUidArguments(int r2, String str) {
        return new String[]{Integer.toString(r2), str};
    }
}
