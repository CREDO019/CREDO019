...
public final class MdtaMetadataEntry implements Metadata.Entry {
    public static final Parcelable.Creator<MdtaMetadataEntry> CREATOR = new Parcelable.Creator<MdtaMetadataEntry>() { // from class: com.google.android.exoplayer2.metadata.mp4.MdtaMetadataEntry.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public MdtaMetadataEntry[] newArray(int r1) {
            return new MdtaMetadataEntry[r1];
        }
    };
    ...
    public MdtaMetadataEntry(String str, byte[] bArr, int r3, int r4) {
        this.key = str;
        this.value = bArr;
        this.localeIndicator = r3;
        this.typeIndicator = r4;
    }
