...
public final class Metadata implements Parcelable {
    public static final Parcelable.Creator<Metadata> CREATOR = new Parcelable.Creator<Metadata>() { // from class: com.google.android.exoplayer2.metadata.Metadata.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public Metadata[] newArray(int r1) {
            return new Metadata[r1];
        }
    };
    ...
    Metadata(Parcel parcel) {
        ...
        while (true) {
            ...
            entryArr[r0] = (Entry) parcel.readParcelable(Entry.class.getClassLoader());
            r0++;
        }
    }
    ...
    public Entry get(int r2) {
        return this.entries[r2];
    }
