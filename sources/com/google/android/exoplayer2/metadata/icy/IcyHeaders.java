...
public final class IcyHeaders implements Metadata.Entry {
    public static final Parcelable.Creator<IcyHeaders> CREATOR = new Parcelable.Creator<IcyHeaders>() { // from class: com.google.android.exoplayer2.metadata.icy.IcyHeaders.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public IcyHeaders[] newArray(int r1) {
            return new IcyHeaders[r1];
        }
    };
    ...
    */
    ...
    public IcyHeaders(int r2, String str, String str2, String str3, boolean z, int r7) {
        Assertions.checkArgument(r7 == -1 || r7 > 0);
        this.bitrate = r2;
        this.genre = str;
        this.name = str2;
        this.url = str3;
        this.isPublic = z;
        this.metadataInterval = r7;
    }
