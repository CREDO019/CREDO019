...
public final class EventMessage implements Metadata.Entry {
    ...
    public static final Parcelable.Creator<EventMessage> CREATOR = new Parcelable.Creator<EventMessage>() { // from class: com.google.android.exoplayer2.metadata.emsg.EventMessage.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public EventMessage[] newArray(int r1) {
            return new EventMessage[r1];
        }
    };
    ...
    public boolean equals(Object obj) {
        ...
        return this.durationMs == eventMessage.durationMs && this.f223id == eventMessage.f223id && Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) && Util.areEqual(this.value, eventMessage.value) && Arrays.equals(this.messageData, eventMessage.messageData);
    }

    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f223id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }
