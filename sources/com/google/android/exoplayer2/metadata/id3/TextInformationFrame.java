...
public final class TextInformationFrame extends Id3Frame {
    public static final Parcelable.Creator<TextInformationFrame> CREATOR = new Parcelable.Creator<TextInformationFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.TextInformationFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public TextInformationFrame[] newArray(int r1) {
            return new TextInformationFrame[r1];
        }
    };
    ...
    public boolean equals(Object obj) {
        ...
        return Util.areEqual(this.f229id, textInformationFrame.f229id) && Util.areEqual(this.description, textInformationFrame.description) && Util.areEqual(this.value, textInformationFrame.value);
    }
    ...
    public String toString() {
        return this.f229id + ": description=" + this.description + ": value=" + this.value;
    }
