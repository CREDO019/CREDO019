...
public final class ChapterFrame extends Id3Frame {
    public static final Parcelable.Creator<ChapterFrame> CREATOR = new Parcelable.Creator<ChapterFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.ChapterFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ChapterFrame[] newArray(int r1) {
            return new ChapterFrame[r1];
        }
    };

    /* renamed from: ID */
    public static final String f225ID = "CHAP";
    ...
    public ChapterFrame(String str, int r3, int r4, long j, long j2, Id3Frame[] id3FrameArr) {
        super(f225ID);
        this.chapterId = str;
        this.startTimeMs = r3;
        this.endTimeMs = r4;
    ...
    ChapterFrame(Parcel parcel) {
        ...
        for (int r1 = 0; r1 < readInt; r1++) {
            this.subFrames[r1] = (Id3Frame) parcel.readParcelable(Id3Frame.class.getClassLoader());
        }
    }
    ...
    public Id3Frame getSubFrame(int r2) {
        return this.subFrames[r2];
    }
    ...
    public int hashCode() {
        int r1 = (((((((527 + this.startTimeMs) * 31) + this.endTimeMs) * 31) + ((int) this.startOffset)) * 31) + ((int) this.endOffset)) * 31;
