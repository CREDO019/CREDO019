...
public final class ChapterTocFrame extends Id3Frame {
    public static final Parcelable.Creator<ChapterTocFrame> CREATOR = new Parcelable.Creator<ChapterTocFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.ChapterTocFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ChapterTocFrame[] newArray(int r1) {
            return new ChapterTocFrame[r1];
        }
    };

    /* renamed from: ID */
    public static final String f226ID = "CTOC";
    ...
    ChapterTocFrame(Parcel parcel) {
        ...
        for (int r2 = 0; r2 < readInt; r2++) {
            this.subFrames[r2] = (Id3Frame) parcel.readParcelable(Id3Frame.class.getClassLoader());
        }
    }
    ...
    public int hashCode() {
        int r1 = (((527 + (this.isRoot ? 1 : 0)) * 31) + (this.isOrdered ? 1 : 0)) * 31;
