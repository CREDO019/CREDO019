...
public final class ApicFrame extends Id3Frame {
    public static final Parcelable.Creator<ApicFrame> CREATOR = new Parcelable.Creator<ApicFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.ApicFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ApicFrame[] newArray(int r1) {
            return new ApicFrame[r1];
        }
    };

    /* renamed from: ID */
    public static final String f224ID = "APIC";
    public final String description;
    public final String mimeType;
    public final byte[] pictureData;
    public final int pictureType;

    public ApicFrame(String str, String str2, int r4, byte[] bArr) {
        super(f224ID);
        this.mimeType = str;
    ...
    public int hashCode() {
        int r1 = (527 + this.pictureType) * 31;
        String str = this.mimeType;
        int hashCode = (r1 + (str != null ? str.hashCode() : 0)) * 31;
    ...
    public String toString() {
        return this.f229id + ": mimeType=" + this.mimeType + ", description=" + this.description;
    }
