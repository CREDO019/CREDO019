...
public class PlaybackException extends Exception implements Bundleable {
    ...
    public static String getErrorCodeName(int r1) {
        if (r1 != 5001) {
            if (r1 != 5002) {
                switch (r1) {
                    case 1000:
                                        ...
                                        switch (r1) {
                                            ...
                                            default:
                                                switch (r1) {
                                                    ...
                                                    default:
                                                        return r1 >= 1000000 ? "custom error code" : "invalid error code";
                                                }
                                        }
                                }
                        }
    ...
    public PlaybackException(String str, Throwable th, int r10) {
        this(str, th, r10, Clock.DEFAULT.elapsedRealtime());
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public PlaybackException(String str, Throwable th, int r3, long j) {
        super(str, th);
        this.errorCode = r3;
        this.timestampMs = j;
    }
