...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    private DefaultLivePlaybackSpeedControl(float f, float f2, long j, float f3, long j2, long j3, float f4) {
        ...
        this.mediaConfigurationTargetLiveOffsetUs = C1856C.TIME_UNSET;
        this.targetLiveOffsetOverrideUs = C1856C.TIME_UNSET;
        this.minTargetLiveOffsetUs = C1856C.TIME_UNSET;
        this.maxTargetLiveOffsetUs = C1856C.TIME_UNSET;
        this.minPlaybackSpeed = f;
        this.maxPlaybackSpeed = f2;
        this.adjustedPlaybackSpeed = 1.0f;
        this.lastPlaybackSpeedUpdateMs = C1856C.TIME_UNSET;
        this.idealTargetLiveOffsetUs = C1856C.TIME_UNSET;
        this.currentTargetLiveOffsetUs = C1856C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetUs = C1856C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetDeviationUs = C1856C.TIME_UNSET;
    }
    ...
    public float getAdjustedPlaybackSpeed(long j, long j2) {
        if (this.mediaConfigurationTargetLiveOffsetUs == C1856C.TIME_UNSET) {
            return 1.0f;
        }
        updateSmoothedMinPossibleLiveOffsetUs(j, j2);
        if (this.lastPlaybackSpeedUpdateMs != C1856C.TIME_UNSET && SystemClock.elapsedRealtime() - this.lastPlaybackSpeedUpdateMs < this.minUpdateIntervalMs) {
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        long j3 = this.maxTargetLiveOffsetUs;
        if (j3 == C1856C.TIME_UNSET || constrainValue <= j3) {
            return;
        }
        this.currentTargetLiveOffsetUs = j3;
    }
