...
public final class PgsDecoder extends SimpleSubtitleDecoder {
    ...
    protected Subtitle decode(byte[] bArr, int r2, boolean z) throws SubtitleDecoderException {
        this.buffer.reset(bArr, r2);
    ...
    public static final class CueBuilder {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int r19) {
            if (r19 % 5 != 2) {
                return;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void parseBitmapSection(ParsableByteArray parsableByteArray, int r5) {
            ...
            if ((parsableByteArray.readUnsignedByte() & 128) != 0) {
                if (r52 < 7 || (readUnsignedInt24 = parsableByteArray.readUnsignedInt24()) < 4) {
                    return;
                }
            ...
            if (position >= limit || r52 <= 0) {
                return;
            }
            int min = Math.min(r52, limit - position);
            parsableByteArray.readBytes(this.bitmapData.getData(), position, min);
            this.bitmapData.setPosition(position + min);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void parseIdentifierSection(ParsableByteArray parsableByteArray, int r3) {
            if (r3 < 19) {
                return;
            }
        ...
        public Cue build() {
            ...
            int r0 = this.bitmapWidth * this.bitmapHeight;
            int[] r2 = new int[r0];
            int r3 = 0;
            while (r3 < r0) {
                ...
                if (readUnsignedByte != 0) {
                    r5 = r3 + 1;
                    r2[r3] = this.colors[readUnsignedByte];
                } else {
                    int readUnsignedByte2 = this.bitmapData.readUnsignedByte();
                    if (readUnsignedByte2 != 0) {
                        r5 = ((readUnsignedByte2 & 64) == 0 ? readUnsignedByte2 & 63 : ((readUnsignedByte2 & 63) << 8) | this.bitmapData.readUnsignedByte()) + r3;
                        Arrays.fill(r2, r3, r5, (readUnsignedByte2 & 128) == 0 ? 0 : this.colors[this.bitmapData.readUnsignedByte()]);
                    }
                }
                r3 = r5;
            }
            return new Cue.Builder().setBitmap(Bitmap.createBitmap(r2, this.bitmapWidth, this.bitmapHeight, Bitmap.Config.ARGB_8888)).setPosition(this.bitmapX / this.planeWidth).setPositionAnchor(0).setLine(this.bitmapY / this.planeHeight, 0).setLineAnchor(0).setSize(this.bitmapWidth / this.planeWidth).setBitmapHeight(this.bitmapHeight / this.planeHeight).build();
        }
