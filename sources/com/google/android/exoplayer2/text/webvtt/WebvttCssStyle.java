...
public final class WebvttCssStyle {
    ...
    /* renamed from: ON */
    private static final int f252ON = 1;
    ...
    public int getStyle() {
        int r0 = this.bold;
        if (r0 == -1 && this.italic == -1) {
            return -1;
        }
        return (r0 == 1 ? 1 : 0) | (this.italic == 1 ? 2 : 0);
    }
    ...
    public WebvttCssStyle setFontColor(int r1) {
        this.fontColor = r1;
    ...
    public WebvttCssStyle setBackgroundColor(int r1) {
    ...
    public WebvttCssStyle setFontSizeUnit(int r1) {
        this.fontSizeUnit = r1;
        return this;
    }
    ...
    public WebvttCssStyle setRubyPosition(int r1) {
        this.rubyPosition = r1;
        return this;
    }
    ...
    private static int updateScoreForMatch(int r1, String str, String str2, int r4) {
        if (str.isEmpty() || r1 == -1) {
            return r1;
        }
        if (str.equals(str2)) {
