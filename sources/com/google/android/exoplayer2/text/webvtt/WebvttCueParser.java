...
public final class WebvttCueParser {
    ...
    public static SpannedString parseCueText(String str, String str2, List<WebvttCssStyle> list) {
        ...
        int r4 = 0;
        while (r4 < str2.length()) {
            char charAt = str2.charAt(r4);
            if (charAt == '&') {
                r4++;
                int indexOf = str2.indexOf(59, r4);
                int indexOf2 = str2.indexOf(32, r4);
                if (indexOf == -1) {
                    indexOf = indexOf2;
                } else if (indexOf2 != -1) {
                ...
                if (indexOf != -1) {
                    applyEntity(str2.substring(r4, indexOf), spannableStringBuilder);
                    if (indexOf == indexOf2) {
                ...
                int r5 = r4 + 1;
                if (r5 < str2.length()) {
                    boolean z = str2.charAt(r5) == '/';
                    r5 = findEndOfTag(str2, r5);
                    int r9 = r5 - 2;
                    boolean z2 = str2.charAt(r9) == '/';
                    int r42 = r4 + (z ? 2 : 1);
                    if (!z2) {
                        r9 = r5 - 1;
                    }
                    String substring = str2.substring(r42, r9);
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            Log.m1132w(TAG, "Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                    ...
                    Log.m1132w(TAG, "Unknown cue setting " + str2 + ParameterizedMessage.ERROR_MSG_SEPARATOR + str3);
                }
            } catch (NumberFormatException unused) {
                Log.m1132w(TAG, "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (c) {
            ...
            case 3:
                return 0;
            default:
                Log.m1132w(TAG, "Invalid anchor value: " + str);
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m1132w(TAG, "Invalid 'vertical' value: " + str);
        return Integer.MIN_VALUE;
    }
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (c) {
            ...
            case 5:
                return 1;
            default:
                Log.m1132w(TAG, "Invalid alignment value: " + str);
                return 2;
        }
    }

    private static int findEndOfTag(String str, int r2) {
        int indexOf = str.indexOf(62, r2);
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (c) {
            ...
            case 3:
                ...
                return;
            default:
                Log.m1132w(TAG, "ignoring unsupported entity: '&" + str + ";'");
                return;
        }
    }
    ...
    private static void applySpansForTag(String str, StartTag startTag, List<Element> list, SpannableStringBuilder spannableStringBuilder, List<WebvttCssStyle> list2) {
        ...
        switch (c) {
            ...
            case 6:
                break;
            case 1:
                spannableStringBuilder.setSpan(new StyleSpan(1), r0, length, 33);
                break;
            case 2:
                applyDefaultColors(spannableStringBuilder, startTag.classes, r0, length);
                break;
            case 3:
                spannableStringBuilder.setSpan(new StyleSpan(2), r0, length, 33);
                break;
            case 4:
                spannableStringBuilder.setSpan(new UnderlineSpan(), r0, length, 33);
                break;
            case 7:
        ...
        for (int r5 = 0; r5 < applicableStyles.size(); r5++) {
            applyStyleToText(spannableStringBuilder, applicableStyles.get(r5).style, r0, length);
        }
    }
    ...
    private static void applyRubySpans(SpannableStringBuilder spannableStringBuilder, String str, StartTag startTag, List<Element> list, List<WebvttCssStyle> list2) {
        ...
        int r10 = startTag.position;
        int r2 = 0;
        for (int r11 = 0; r11 < arrayList.size(); r11++) {
            if (TAG_RUBY_TEXT.equals(((Element) arrayList.get(r11)).startTag.name)) {
                Element element = (Element) arrayList.get(r11);
                int firstKnownRubyPosition = firstKnownRubyPosition(getRubyPosition(list2, str, element.startTag), rubyPosition, 1);
                int r5 = element.startTag.position - r2;
                int r3 = element.endPosition - r2;
                CharSequence subSequence = spannableStringBuilder.subSequence(r5, r3);
                spannableStringBuilder.delete(r5, r3);
                spannableStringBuilder.setSpan(new RubySpan(subSequence.toString(), firstKnownRubyPosition), r10, r5, 33);
                r2 += subSequence.length();
                r10 = r5;
            }
        }
    }
    ...
    private static int getRubyPosition(List<WebvttCssStyle> list, String str, StartTag startTag) {
        ...
        for (int r3 = 0; r3 < applicableStyles.size(); r3++) {
            WebvttCssStyle webvttCssStyle = applicableStyles.get(r3).style;
    ...
    private static int firstKnownRubyPosition(int r1, int r2, int r3) {
        if (r1 != -1) {
            return r1;
        }
        if (r2 != -1) {
    ...
    private static void applyDefaultColors(SpannableStringBuilder spannableStringBuilder, Set<String> set, int r6, int r7) {
        for (String str : set) {
            Map<String, Integer> map = DEFAULT_TEXT_COLORS;
            if (map.containsKey(str)) {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(map.get(str).intValue()), r6, r7, 33);
            } else {
                Map<String, Integer> map2 = DEFAULT_BACKGROUND_COLORS;
                if (map2.containsKey(str)) {
                    spannableStringBuilder.setSpan(new BackgroundColorSpan(map2.get(str).intValue()), r6, r7, 33);
                }
            }
        }
    }

    private static void applyStyleToText(SpannableStringBuilder spannableStringBuilder, WebvttCssStyle webvttCssStyle, int r6, int r7) {
        if (webvttCssStyle == null) {
            return;
        }
        if (webvttCssStyle.getStyle() != -1) {
            SpanUtil.addOrReplaceSpan(spannableStringBuilder, new StyleSpan(webvttCssStyle.getStyle()), r6, r7, 33);
        }
        if (webvttCssStyle.isLinethrough()) {
            spannableStringBuilder.setSpan(new StrikethroughSpan(), r6, r7, 33);
        }
        if (webvttCssStyle.isUnderline()) {
            spannableStringBuilder.setSpan(new UnderlineSpan(), r6, r7, 33);
        }
        if (webvttCssStyle.hasFontColor()) {
            SpanUtil.addOrReplaceSpan(spannableStringBuilder, new ForegroundColorSpan(webvttCssStyle.getFontColor()), r6, r7, 33);
        }
        if (webvttCssStyle.hasBackgroundColor()) {
            SpanUtil.addOrReplaceSpan(spannableStringBuilder, new BackgroundColorSpan(webvttCssStyle.getBackgroundColor()), r6, r7, 33);
        }
        if (webvttCssStyle.getFontFamily() != null) {
            SpanUtil.addOrReplaceSpan(spannableStringBuilder, new TypefaceSpan(webvttCssStyle.getFontFamily()), r6, r7, 33);
        }
        int fontSizeUnit = webvttCssStyle.getFontSizeUnit();
        if (fontSizeUnit == 1) {
            SpanUtil.addOrReplaceSpan(spannableStringBuilder, new AbsoluteSizeSpan((int) webvttCssStyle.getFontSize(), true), r6, r7, 33);
        } else if (fontSizeUnit == 2) {
            SpanUtil.addOrReplaceSpan(spannableStringBuilder, new RelativeSizeSpan(webvttCssStyle.getFontSize()), r6, r7, 33);
        } else if (fontSizeUnit == 3) {
            SpanUtil.addOrReplaceSpan(spannableStringBuilder, new RelativeSizeSpan(webvttCssStyle.getFontSize() / 100.0f), r6, r7, 33);
        }
        if (webvttCssStyle.getCombineUpright()) {
            spannableStringBuilder.setSpan(new HorizontalTextInVerticalContextSpan(), r6, r7, 33);
        }
    }
    ...
    private static List<StyleMatch> getApplicableStyles(List<WebvttCssStyle> list, String str, StartTag startTag) {
        ...
        for (int r1 = 0; r1 < list.size(); r1++) {
            WebvttCssStyle webvttCssStyle = list.get(r1);
    ...
    public static final class WebvttCueInfoBuilder {
        ...
        private static float computeLine(float f, int r5) {
            int r2 = (f > (-3.4028235E38f) ? 1 : (f == (-3.4028235E38f) ? 0 : -1));
            if (r2 == 0 || r5 != 0 || (f >= 0.0f && f <= 1.0f)) {
                return r2 != 0 ? f : r5 == 0 ? 1.0f : -3.4028235E38f;
            }
            return 1.0f;
        }

        private static float derivePosition(int r1) {
            if (r1 != 4) {
                if (r1 != 5) {
        ...
        private static int derivePositionAnchor(int r2) {
            if (r2 != 1) {
                if (r2 != 3) {
                    if (r2 != 4) {
                        return r2 != 5 ? 1 : 2;
        ...
        public Cue.Builder toCueBuilder() {
            ...
            int r1 = this.positionAnchor;
            if (r1 == Integer.MIN_VALUE) {
                r1 = derivePositionAnchor(this.textAlignment);
            }
            Cue.Builder verticalType = new Cue.Builder().setTextAlignment(convertTextAlignment(this.textAlignment)).setLine(computeLine(this.line, this.lineType), this.lineType).setLineAnchor(this.lineAnchor).setPosition(f).setPositionAnchor(r1).setSize(Math.min(this.size, deriveMaxSize(r1, f))).setVerticalType(this.verticalType);
        ...
        private static Layout.Alignment convertTextAlignment(int r2) {
            if (r2 != 1) {
                if (r2 == 2) {
                ...
                if (r2 != 3) {
                    if (r2 != 4) {
                        if (r2 != 5) {
                            Log.m1132w(WebvttCueParser.TAG, "Unknown textAlignment: " + r2);
                            return null;
                        }
                    }
                }
        ...
        private static float deriveMaxSize(int r2, float f) {
            if (r2 != 0) {
                if (r2 == 1) {
    ...
    public static final class StyleMatch implements Comparable<StyleMatch> {
        ...
        public StyleMatch(int r1, WebvttCssStyle webvttCssStyle) {
            this.score = r1;
    ...
    public static final class StartTag {
        ...
        private StartTag(String str, int r2, String str2, Set<String> set) {
            this.position = r2;
            this.name = str;
            this.voice = str2;
            this.classes = set;
        ...
        public static StartTag buildStartTag(String str, int r6) {
            String str2;
            String trim = str.trim();
            Assertions.checkArgument(!trim.isEmpty());
            ...
            for (int r1 = 1; r1 < split.length; r1++) {
                hashSet.add(split[r1]);
            }
            return new StartTag(str3, r6, str2, hashSet);
        }
    ...
    public static class Element {
        ...
        private Element(StartTag startTag, int r2) {
