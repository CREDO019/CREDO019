...
public final class Cue implements Bundleable {
    ...
    @Deprecated
    public Cue(CharSequence charSequence, Layout.Alignment alignment, float f, int r15, int r16, float f2, int r18, float f3) {
        this(charSequence, alignment, f, r15, r16, f2, r18, f3, false, (int) ViewCompat.MEASURED_STATE_MASK);
    }

    @Deprecated
    public Cue(CharSequence charSequence, Layout.Alignment alignment, float f, int r22, int r23, float f2, int r25, float f3, int r27, float f4) {
        this(charSequence, alignment, null, null, f, r22, r23, f2, r25, r27, f4, f3, -3.4028235E38f, false, ViewCompat.MEASURED_STATE_MASK, Integer.MIN_VALUE, 0.0f);
    }

    @Deprecated
    public Cue(CharSequence charSequence, Layout.Alignment alignment, float f, int r22, int r23, float f2, int r25, float f3, boolean z, int r28) {
        this(charSequence, alignment, null, null, f, r22, r23, f2, r25, Integer.MIN_VALUE, -3.4028235E38f, f3, -3.4028235E38f, z, r28, Integer.MIN_VALUE, 0.0f);
    }

    private Cue(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f, int r10, int r11, float f2, int r13, int r14, float f3, float f4, float f5, boolean z, int r19, int r20, float f6) {
        ...
        this.lineAnchor = r11;
        this.position = f2;
        this.positionAnchor = r13;
        this.size = f4;
        this.bitmapHeight = f5;
        this.windowColorSet = z;
        this.windowColor = r19;
        this.textSizeType = r14;
        this.textSize = f3;
        this.verticalType = r20;
    ...
    public static final class Builder {
        ...
        public Builder setLine(float f, int r2) {
            this.line = f;
            this.lineType = r2;
            return this;
        }
        ...
        public Builder setLineAnchor(int r1) {
            this.lineAnchor = r1;
            return this;
        }
        ...
        public Builder setPositionAnchor(int r1) {
            this.positionAnchor = r1;
            return this;
        }
        ...
        public Builder setTextSize(float f, int r2) {
            this.textSize = f;
            this.textSizeType = r2;
            return this;
        }
        ...
        public Builder setWindowColor(int r1) {
            this.windowColor = r1;
        ...
        public Builder setVerticalType(int r1) {
            this.verticalType = r1;
            return this;
        }
