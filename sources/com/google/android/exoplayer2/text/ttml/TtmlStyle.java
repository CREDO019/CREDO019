...
final class TtmlStyle {
    ...
    /* renamed from: ON */
    private static final int f250ON = 1;
    ...
    public TtmlStyle setFontColor(int r1) {
        this.fontColor = r1;
    ...
    public TtmlStyle setBackgroundColor(int r1) {
    ...
    private TtmlStyle inherit(TtmlStyle ttmlStyle, boolean z) {
        ...
        if (ttmlStyle != null) {
            ...
            if (z && this.rubyType == -1 && (r4 = ttmlStyle.rubyType) != -1) {
                this.rubyType = r4;
            }
        }
        return this;
    ...
    public TtmlStyle setRubyType(int r1) {
        this.rubyType = r1;
        return this;
    }
    ...
    public TtmlStyle setRubyPosition(int r1) {
    ...
    public TtmlStyle setFontSizeUnit(int r1) {
