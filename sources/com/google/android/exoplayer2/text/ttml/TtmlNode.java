...
public final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C1856C.TIME_UNSET, C1856C.TIME_UNSET, null, null, "", null, null);
    }
    ...
    public boolean isActive(long j) {
        ...
        return (j2 == C1856C.TIME_UNSET && this.endTimeUs == C1856C.TIME_UNSET) || (j2 <= j && this.endTimeUs == C1856C.TIME_UNSET) || ((j2 == C1856C.TIME_UNSET && j < this.endTimeUs) || (j2 <= j && j < this.endTimeUs));
    }
    ...
    public TtmlNode getChild(int r2) {
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z) {
        ...
        for (int r2 = 0; r2 < this.children.size(); r2++) {
            this.children.get(r2).getEventTimes(treeSet, z || equals);
        }
    }
    ...
    private void traverseForImage(long j, String str, List<Pair<String, String>> list) {
        ...
        for (int r0 = 0; r0 < getChildCount(); r0++) {
            getChild(r0).traverseForImage(j, str, list);
        }
    }
    ...
    private void traverseForText(long j, boolean z, String str, Map<String, Cue.Builder> map) {
        ...
        if (this.isTextNode && z) {
            ...
            boolean equals = "p".equals(this.tag);
            for (int r8 = 0; r8 < getChildCount(); r8++) {
                getChild(r8).traverseForText(j, z || equals, str, map);
            }
            if (equals) {
    ...
    private void traverseForStyle(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2, String str, Map<String, Cue.Builder> map3) {
        ...
        if (isActive(j)) {
            ...
            for (r1 = 0; r1 < getChildCount(); r1++) {
                getChild(r1).traverseForStyle(j, map, map2, str2, map3);
            }
        }
    }

    private void applyStyleToOutput(Map<String, TtmlStyle> map, Cue.Builder builder, int r12, int r13, int r14) {
        ...
        if (resolveStyle != null) {
            TtmlRenderUtil.applyStylesToSpan(spannableStringBuilder2, r12, r13, resolveStyle, this.parent, map, r14);
    ...
    private static void cleanUpText(SpannableStringBuilder spannableStringBuilder) {
        ...
        for (int r0 = 0; r0 < spannableStringBuilder.length(); r0++) {
            if (spannableStringBuilder.charAt(r0) == ' ') {
                int r1 = r0 + 1;
                int r4 = r1;
                while (r4 < spannableStringBuilder.length() && spannableStringBuilder.charAt(r4) == ' ') {
                    r4++;
                }
                int r42 = r4 - r1;
                if (r42 > 0) {
                    spannableStringBuilder.delete(r0, r42 + r0);
                }
            }
        }
        ...
        for (int r02 = 0; r02 < spannableStringBuilder.length() - 1; r02++) {
            if (spannableStringBuilder.charAt(r02) == '\n') {
                int r43 = r02 + 1;
                if (spannableStringBuilder.charAt(r43) == ' ') {
                    spannableStringBuilder.delete(r43, r02 + 2);
                }
            }
        }
        ...
        for (int r2 = 0; r2 < spannableStringBuilder.length() - 1; r2++) {
            if (spannableStringBuilder.charAt(r2) == ' ') {
                int r03 = r2 + 1;
                if (spannableStringBuilder.charAt(r03) == '\n') {
                    spannableStringBuilder.delete(r2, r03);
                }
            }
        }
        if (spannableStringBuilder.length() <= 0 || spannableStringBuilder.charAt(spannableStringBuilder.length() - 1) != '\n') {
