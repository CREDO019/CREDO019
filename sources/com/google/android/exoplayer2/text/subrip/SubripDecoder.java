...
public final class SubripDecoder extends SimpleSubtitleDecoder {
    ...
    protected Subtitle decode(byte[] bArr, int r8, boolean z) {
            ...
            if (readLine == null) {
                ...
                try {
                    ...
                    if (matcher.matches()) {
                        ...
                        String str = null;
                        while (true) {
                            if (r82 >= this.tags.size()) {
                                break;
                            }
                            String str2 = this.tags.get(r82);
                        ...
                        Log.m1132w(TAG, "Skipping invalid timing: " + readLine2);
                    }
                } catch (NumberFormatException unused) {
                    Log.m1132w(TAG, "Skipping invalid index: " + readLine);
                }
            }
        }
    ...
    private static long parseTimecode(Matcher matcher, int r10) {
        String group = matcher.group(r10 + 1);
        long parseLong = (group != null ? Long.parseLong(group) * 60 * 60 * 1000 : 0L) + (Long.parseLong((String) Assertions.checkNotNull(matcher.group(r10 + 2))) * 60 * 1000) + (Long.parseLong((String) Assertions.checkNotNull(matcher.group(r10 + 3))) * 1000);
        String group2 = matcher.group(r10 + 4);
        if (group2 != null) {
    ...
    static float getFractionalPositionForAnchorType(int r1) {
        if (r1 != 0) {
            if (r1 != 1) {
                if (r1 == 2) {
                    return END_FRACTION;
