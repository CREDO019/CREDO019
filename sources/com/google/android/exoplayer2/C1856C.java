...
public final class C1856C {
    ...
    @Deprecated
    public static String getFormatSupportString(int r0) {
        return Util.getFormatSupportString(r0);
    }

    @Deprecated
    public static int getErrorCodeForMediaDrmErrorCode(int r0) {
        return Util.getErrorCodeForMediaDrmErrorCode(r0);
    }
}
