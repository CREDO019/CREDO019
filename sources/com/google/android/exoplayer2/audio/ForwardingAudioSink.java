...
public class ForwardingAudioSink implements AudioSink {
    ...
    @Override // com.google.android.exoplayer2.audio.AudioSink
    public void configure(Format format, int r3, int[] r4) throws AudioSink.ConfigurationException {
        this.sink.configure(format, r3, r4);
    }
    ...
    @Override // com.google.android.exoplayer2.audio.AudioSink
    public boolean handleBuffer(ByteBuffer byteBuffer, long j, int r5) throws AudioSink.InitializationException, AudioSink.WriteException {
        return this.sink.handleBuffer(byteBuffer, j, r5);
    }
    ...
    public void setAudioSessionId(int r2) {
        this.sink.setAudioSessionId(r2);
    }
