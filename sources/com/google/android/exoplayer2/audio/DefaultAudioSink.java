...
public final class DefaultAudioSink implements AudioSink {
    ...
    interface AudioTrackBufferSizeProvider {
        ...
        int getBufferSizeInBytes(int r1, int r2, int r3, int r4, int r5, double d);
    }
    ...
    public static final class Builder {
        ...
        public Builder setOffloadMode(int r1) {
            this.offloadMode = r1;
            return this;
        }
    ...
    @Deprecated
    public DefaultAudioSink(AudioCapabilities audioCapabilities, AudioProcessorChain audioProcessorChain, boolean z, boolean z2, int r7) {
        this(new Builder().setAudioCapabilities((AudioCapabilities) MoreObjects.firstNonNull(audioCapabilities, AudioCapabilities.DEFAULT_AUDIO_CAPABILITIES)).setAudioProcessorChain(audioProcessorChain).setEnableFloatOutput(z).setEnableAudioTrackPlaybackParams(z2).setOffloadMode(r7));
    }
    ...
    public int getFormatSupport(Format format) {
        if (!MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            Log.m1132w(TAG, "Invalid PCM encoding: " + format.pcmEncoding);
            return 0;
        }
    }
    ...
    @Override // com.google.android.exoplayer2.audio.AudioSink
    public void configure(Format format, int r22, int[] r23) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            r0 = Util.getPcmFrameSize(format.pcmEncoding, format.channelCount);
            ...
            if (Util.SDK_INT < 21 && format.channelCount == 8 && r23 == null) {
                r6 = new int[6];
            ...
            this.channelMappingAudioProcessor.setChannelMap(r6);
            ...
            int r62 = audioFormat.encoding;
            int r72 = audioFormat.sampleRate;
            int audioTrackChannelConfig = Util.getAudioTrackChannelConfig(audioFormat.channelCount);
            audioProcessorArr = audioProcessorArr2;
            r14 = Util.getPcmFrameSize(r62, audioFormat.channelCount);
            r11 = r62;
            r15 = r72;
            ...
            int r5 = format.sampleRate;
            if (useOffloadedPlayback(format, this.audioAttributes)) {
                audioProcessorArr = audioProcessorArr3;
                r15 = r5;
                r11 = MimeTypes.getEncoding((String) Assertions.checkNotNull(format.sampleMimeType), format.codecs);
        ...
        if (r22 != 0) {
            bufferSizeInBytes = r22;
            r19 = r11;
        } else {
            r19 = r11;
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(r15, intValue, r11), r11, r13, r14, r15, this.enableAudioTrackPlaybackParams ? 8.0d : 1.0d);
        }
        if (r19 == 0) {
            throw new AudioSink.ConfigurationException("Invalid output encoding (mode=" + r13 + ") for: " + format, format);
        } else if (intValue == 0) {
            throw new AudioSink.ConfigurationException("Invalid output channel config (mode=" + r13 + ") for: " + format, format);
        } else {
            this.offloadDisabledUntilNextConfiguration = false;
            Configuration configuration = new Configuration(format, r0, r13, r14, r15, intValue, r19, bufferSizeInBytes, audioProcessorArr);
    ...
    private void flushAudioProcessors() {
        ...
        while (true) {
            ...
            if (r0 >= audioProcessorArr.length) {
                return;
            }
            AudioProcessor audioProcessor = audioProcessorArr[r0];
            audioProcessor.flush();
            this.outputBuffers[r0] = audioProcessor.getOutput();
            r0++;
        }
    }
    ...
    @Override // com.google.android.exoplayer2.audio.AudioSink
    public boolean handleBuffer(ByteBuffer byteBuffer, long j, int r21) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        if (this.audioTrackPositionTracker.mayHandleBuffer(getWrittenFrames())) {
            if (this.inputBuffer == null) {
                ...
                if (this.configuration.outputMode == 0) {
                    ...
                    this.submittedEncodedFrames += this.framesPerEncodedSample * r21;
                }
                this.inputBuffer = byteBuffer;
                this.inputBufferAccessUnitCount = r21;
            }
            processBuffers(j);
            if (!this.inputBuffer.hasRemaining()) {
                ...
                Log.m1132w(TAG, "Resetting stalled audio track");
                flush();
                return true;
            } else {
                return false;
    ...
    private void processBuffers(long j) throws AudioSink.WriteException {
        ...
        while (r1 >= 0) {
            if (r1 > 0) {
                byteBuffer = this.outputBuffers[r1 - 1];
            } else {
            ...
            if (r1 == length) {
                ...
                AudioProcessor audioProcessor = this.activeAudioProcessors[r1];
                if (r1 > this.drainingAudioProcessorIndex) {
                    audioProcessor.queueInput(byteBuffer);
                }
                ByteBuffer output = audioProcessor.getOutput();
                this.outputBuffers[r1] = output;
    ...
    private void writeBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.WriteException {
        ...
        if (byteBuffer.hasRemaining()) {
            ...
            if (Util.SDK_INT < 21) {
                ...
                Assertions.checkState(j != C1856C.TIME_UNSET);
    ...
    private static boolean isAudioTrackDeadObject(int r2) {
        return (Util.SDK_INT >= 24 && r2 == -6) || r2 == ERROR_NATIVE_DEAD_OBJECT;
    }
    ...
    */
    ...
    @Override // com.google.android.exoplayer2.audio.AudioSink
    public void setAudioSessionId(int r2) {
        if (this.audioSessionId != r2) {
            this.audioSessionId = r2;
            this.externalAudioSessionIdProvided = r2 != 0;
            flush();
        }
    }
    ...
    public void setAuxEffectInfo(AuxEffectInfo auxEffectInfo) {
        ...
        int r0 = auxEffectInfo.effectId;
        float f = auxEffectInfo.sendLevel;
        if (this.audioTrack != null) {
            if (this.auxEffectInfo.effectId != r0) {
                this.audioTrack.attachAuxEffect(r0);
            }
            if (r0 != 0) {
    ...
    private void setAudioTrackPlaybackParametersV23(PlaybackParameters playbackParameters) {
        if (isAudioTrackInitialized()) {
            try {
                ...
                Log.m1131w(TAG, "Failed to set playback params", e);
            }
    ...
    private void setAudioProcessorPlaybackParametersAndSkipSilence(PlaybackParameters playbackParameters, boolean z) {
        ...
        MediaPositionParameters mediaPositionParameters2 = new MediaPositionParameters(playbackParameters, z, C1856C.TIME_UNSET, C1856C.TIME_UNSET);
        if (isAudioTrackInitialized()) {
    ...
    private boolean shouldUseFloatOutput(int r2) {
        return this.enableFloatOutput && Util.isEncodingHighResolutionPcm(r2);
    }
    ...
    private static int getFramesPerEncodedSample(int r2, ByteBuffer byteBuffer) {
        switch (r2) {
            case 5:
            case 6:
            case 18:
            ...
            case 13:
            default:
                throw new IllegalStateException("Unexpected audio encoding: " + r2);
            case 14:
    ...
    private static int writeNonBlockingV21(AudioTrack audioTrack, ByteBuffer byteBuffer, int r3) {
        return audioTrack.write(byteBuffer, r3, 1);
    }

    private int writeNonBlockingWithAvSyncV21(AudioTrack audioTrack, ByteBuffer byteBuffer, int r13, long j) {
        if (Util.SDK_INT >= 26) {
            return audioTrack.write(byteBuffer, r13, 1, j * 1000);
        }
        ...
        if (this.bytesUntilNextAvSync == 0) {
            this.avSyncHeader.putInt(4, r13);
            this.avSyncHeader.putLong(8, j * 1000);
            this.avSyncHeader.position(0);
            this.bytesUntilNextAvSync = r13;
        }
        ...
        int writeNonBlockingV21 = writeNonBlockingV21(audioTrack, byteBuffer, r13);
        if (writeNonBlockingV21 < 0) {
            this.bytesUntilNextAvSync = 0;
    ...
    public final class StreamEventCallbackV29 {
        ...
        public StreamEventCallbackV29() {
            this.callback = new AudioTrack.StreamEventCallback() { // from class: com.google.android.exoplayer2.audio.DefaultAudioSink.StreamEventCallbackV29.1
                ...
                public void onDataRequest(AudioTrack audioTrack, int r2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static AudioFormat getAudioFormat(int r1, int r2, int r3) {
        return new AudioFormat.Builder().setSampleRate(r1).setChannelMask(r2).setEncoding(r3).build();
    }

    private static int getAudioTrackMinBufferSize(int r0, int r1, int r2) {
        int minBufferSize = AudioTrack.getMinBufferSize(r0, r1, r2);
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            Log.m1132w(DefaultAudioSink.TAG, str);
        }
        ...
        public void onInvalidLatency(long j) {
            Log.m1132w(DefaultAudioSink.TAG, "Ignoring impossibly large audio latency: " + j);
        }
        ...
        @Override // com.google.android.exoplayer2.audio.AudioTrackPositionTracker.Listener
        public void onUnderrun(int r11, long j) {
            if (DefaultAudioSink.this.listener != null) {
                DefaultAudioSink.this.listener.onUnderrun(r11, j, SystemClock.elapsedRealtime() - DefaultAudioSink.this.lastFeedElapsedRealtimeMs);
            }
        }
    }
    ...
    public static final class Configuration {
        ...
        public Configuration(Format format, int r2, int r3, int r4, int r5, int r6, int r7, int r8, AudioProcessor[] audioProcessorArr) {
            this.inputFormat = format;
            this.inputPcmFrameSize = r2;
            this.outputMode = r3;
            this.outputPcmFrameSize = r4;
            this.outputSampleRate = r5;
            this.outputChannelConfig = r6;
            this.outputEncoding = r7;
            this.bufferSize = r8;
            this.availableAudioProcessors = audioProcessorArr;
        }

        public Configuration copyWithBufferSize(int r12) {
            return new Configuration(this.inputFormat, this.inputPcmFrameSize, this.outputMode, this.outputPcmFrameSize, this.outputSampleRate, this.outputChannelConfig, this.outputEncoding, r12, this.availableAudioProcessors);
        }
        ...
        public AudioTrack buildAudioTrack(boolean z, AudioAttributes audioAttributes, int r11) throws AudioSink.InitializationException {
            try {
                AudioTrack createAudioTrack = createAudioTrack(z, audioAttributes, r11);
        ...
        private AudioTrack createAudioTrack(boolean z, AudioAttributes audioAttributes, int r5) {
            if (Util.SDK_INT >= 29) {
                return createAudioTrackV29(z, audioAttributes, r5);
            }
            if (Util.SDK_INT >= 21) {
                return createAudioTrackV21(z, audioAttributes, r5);
            }
            return createAudioTrackV9(audioAttributes, r5);
        }

        private AudioTrack createAudioTrackV29(boolean z, AudioAttributes audioAttributes, int r6) {
            return new AudioTrack.Builder().setAudioAttributes(getAudioTrackAttributesV21(audioAttributes, z)).setAudioFormat(DefaultAudioSink.getAudioFormat(this.outputSampleRate, this.outputChannelConfig, this.outputEncoding)).setTransferMode(1).setBufferSizeInBytes(this.bufferSize).setSessionId(r6).setOffloadedPlayback(this.outputMode == 1).build();
        }

        private AudioTrack createAudioTrackV21(boolean z, AudioAttributes audioAttributes, int r10) {
            return new AudioTrack(getAudioTrackAttributesV21(audioAttributes, z), DefaultAudioSink.getAudioFormat(this.outputSampleRate, this.outputChannelConfig, this.outputEncoding), this.bufferSize, 1, r10);
        }

        private AudioTrack createAudioTrackV9(AudioAttributes audioAttributes, int r10) {
            ...
            return new AudioTrack(streamTypeForAudioUsage, this.outputSampleRate, this.outputChannelConfig, this.outputEncoding, this.bufferSize, 1, r10);
        }
