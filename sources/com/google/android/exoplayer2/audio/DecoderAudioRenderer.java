...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleDecoderOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.decoder != null) {
            try {
                ...
                Log.m1135e(TAG, "Audio codec error", e6);
    ...
    private boolean feedInputBuffer() throws DecoderException, ExoPlaybackException {
        ...
        if (readSource == -5) {
            ...
            if (!this.firstStreamSampleRead) {
                ...
                this.inputBuffer.addFlag(C1856C.BUFFER_FLAG_FIRST_SAMPLE);
            }
    ...
    private void maybeInitDecoder() throws ExoPlaybackException {
        ...
        try {
            ...
            Log.m1135e(TAG, "Audio codec error", e);
    ...
    private final class AudioSinkListener implements AudioSink.Listener {
        ...
        public void onUnderrun(int r8, long j, long j2) {
            DecoderAudioRenderer.this.eventDispatcher.underrun(r8, j, j2);
        }
        ...
        public void onAudioSinkError(Exception exc) {
            Log.m1135e(DecoderAudioRenderer.TAG, "Audio sink error", exc);
