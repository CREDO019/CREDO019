...
public final class Ac4Util {
    ...
    public static final class SyncFrameInfo {
        ...
        private SyncFrameInfo(int r1, int r2, int r3, int r4, int r5) {
            this.bitstreamVersion = r1;
    ...
    */
    ...
    public static int parseAc4SyncframeSize(byte[] bArr, int r5) {
        int r1 = 7;
        if (bArr.length < 7) {
            return -1;
        }
        int r0 = ((bArr[2] & 255) << 8) | (bArr[3] & 255);
        if (r0 == 65535) {
            r0 = ((bArr[4] & 255) << 16) | ((bArr[5] & 255) << 8) | (bArr[6] & 255);
        } else {
            r1 = 4;
        }
        if (r5 == 44097) {
    ...
    public static void getAc4SampleHeader(int r2, ParsableByteArray parsableByteArray) {
        ...
        data[2] = -1;
        data[3] = -1;
        data[4] = (byte) ((r2 >> 16) & 255);
        data[5] = (byte) ((r2 >> 8) & 255);
        data[6] = (byte) (r2 & 255);
    }

    private static int readVariableBits(ParsableBitArray parsableBitArray, int r3) {
        int r0 = 0;
        while (true) {
            int readBits = r0 + parsableBitArray.readBits(r3);
