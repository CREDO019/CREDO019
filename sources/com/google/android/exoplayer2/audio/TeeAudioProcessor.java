...
public final class TeeAudioProcessor extends BaseAudioProcessor {
    ...
    public interface AudioBufferSink {
        void flush(int r1, int r2, int r3);
    ...
    public static final class WavFileAudioBufferSink implements AudioBufferSink {
        ...
        public void flush(int r4, int r5, int r6) {
            try {
                reset();
            } catch (IOException e) {
                Log.m1135e(TAG, "Error resetting", e);
            }
            this.sampleRateHz = r4;
            this.channelCount = r5;
            this.encoding = r6;
        }
        ...
        public void handleBuffer(ByteBuffer byteBuffer) {
            try {
                ...
                Log.m1135e(TAG, "Error writing data", e);
            }
        }
        ...
        private void reset() throws IOException {
            ...
            try {
                ...
                Log.m1131w(TAG, "Error updating file size", e);
            }
            try {
        ...
        private String getNextOutputFileName() {
            int r1 = this.counter;
            this.counter = r1 + 1;
            return Util.formatInvariant("%s-%04d.wav", this.outputFileNamePrefix, Integer.valueOf(r1));
        }
    }
}
