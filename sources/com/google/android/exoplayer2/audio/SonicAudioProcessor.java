...
public final class SonicAudioProcessor implements AudioProcessor {
    ...
    public void setOutputSampleRateHz(int r1) {
        this.pendingOutputSampleRate = r1;
    }
    ...
    public AudioProcessor.AudioFormat configure(AudioProcessor.AudioFormat audioFormat) throws AudioProcessor.UnhandledAudioFormatException {
        ...
        int r0 = this.pendingOutputSampleRate;
        if (r0 == -1) {
            r0 = audioFormat.sampleRate;
        }
        this.pendingInputAudioFormat = audioFormat;
        AudioProcessor.AudioFormat audioFormat2 = new AudioProcessor.AudioFormat(r0, audioFormat.channelCount, 2);
