...
public interface Player {
    ...
    public interface Listener {
        ...
        public final /* synthetic */ class CC {
            ...
            public static void $default$onAudioSessionIdChanged(Listener _this, int r1) {
            }
            ...
            public static void $default$onDeviceVolumeChanged(Listener _this, int r1, boolean z) {
            }
            ...
            public static void $default$onMediaItemTransition(Listener _this, MediaItem mediaItem, int r2) {
            }
            ...
            public static void $default$onPlayWhenReadyChanged(Listener _this, boolean z, int r2) {
            }

            public static void $default$onPlaybackParametersChanged(Listener _this, PlaybackParameters playbackParameters) {
            }

            public static void $default$onPlaybackStateChanged(Listener _this, int r1) {
            }

            public static void $default$onPlaybackSuppressionReasonChanged(Listener _this, int r1) {
            }
            ...
            @Deprecated
            public static void $default$onPlayerStateChanged(Listener _this, boolean z, int r2) {
            }
            ...
            @Deprecated
            public static void $default$onPositionDiscontinuity(Listener _this, int r1) {
            }

            public static void $default$onPositionDiscontinuity(Listener _this, PositionInfo positionInfo, PositionInfo positionInfo2, int r3) {
            }

            public static void $default$onRenderedFirstFrame(Listener _this) {
            }

            public static void $default$onRepeatModeChanged(Listener _this, int r1) {
            }
            ...
            public static void $default$onSurfaceSizeChanged(Listener _this, int r1, int r2) {
            }

            public static void $default$onTimelineChanged(Listener _this, Timeline timeline, int r2) {
            }
        ...
        void onAudioSessionIdChanged(int r1);
        ...
        void onDeviceVolumeChanged(int r1, boolean z);
        ...
        void onMediaItemTransition(MediaItem mediaItem, int r2);

        void onMediaMetadataChanged(MediaMetadata mediaMetadata);

        void onMetadata(Metadata metadata);

        void onPlayWhenReadyChanged(boolean z, int r2);

        void onPlaybackParametersChanged(PlaybackParameters playbackParameters);

        void onPlaybackStateChanged(int r1);

        void onPlaybackSuppressionReasonChanged(int r1);
        ...
        @Deprecated
        void onPlayerStateChanged(boolean z, int r2);
        ...
        void onPositionDiscontinuity(PositionInfo positionInfo, PositionInfo positionInfo2, int r3);
        ...
        void onSurfaceSizeChanged(int r1, int r2);

        void onTimelineChanged(Timeline timeline, int r2);
    ...
    void addMediaItem(int r1, MediaItem mediaItem);

    void addMediaItem(MediaItem mediaItem);

    void addMediaItems(int r1, List<MediaItem> list);
    ...
    MediaItem getMediaItemAt(int r1);
    ...
    boolean isCommandAvailable(int r1);
    ...
    void moveMediaItem(int r1, int r2);

    void moveMediaItems(int r1, int r2, int r3);
    ...
    void removeMediaItem(int r1);

    void removeMediaItems(int r1, int r2);

    void seekBack();

    void seekForward();

    void seekTo(int r1, long j);
    ...
    void setMediaItems(List<MediaItem> list, int r2, long j);
    ...
    public static final class PositionInfo implements Bundleable {
        ...
        @Deprecated
        public PositionInfo(Object obj, int r14, Object obj2, int r16, long j, long j2, int r21, int r22) {
            this(obj, r14, MediaItem.EMPTY, obj2, r16, j, j2, r21, r22);
        }

        public PositionInfo(Object obj, int r2, MediaItem mediaItem, Object obj2, int r5, long j, long j2, int r10, int r11) {
            this.windowUid = obj;
            this.windowIndex = r2;
            this.mediaItemIndex = r2;
            this.mediaItem = mediaItem;
            this.periodUid = obj2;
            this.periodIndex = r5;
            this.positionMs = j;
            this.contentPositionMs = j2;
            this.adGroupIndex = r10;
            this.adIndexInAdGroup = r11;
        }
        ...
        public static PositionInfo fromBundle(Bundle bundle) {
            int r4 = bundle.getInt(keyForField(0), -1);
            Bundle bundle2 = bundle.getBundle(keyForField(1));
            return new PositionInfo(null, r4, bundle2 == null ? null : MediaItem.CREATOR.fromBundle(bundle2), null, bundle.getInt(keyForField(2), -1), bundle.getLong(keyForField(3), C1856C.TIME_UNSET), bundle.getLong(keyForField(4), C1856C.TIME_UNSET), bundle.getInt(keyForField(5), -1), bundle.getInt(keyForField(6), -1));
        }
    ...
    public static final class Commands implements Bundleable {
        ...
        public static final class Builder {
            ...
            public Builder add(int r2) {
                this.flagsBuilder.add(r2);
                return this;
            }

            public Builder addIf(int r2, boolean z) {
                this.flagsBuilder.addIf(r2, z);
                return this;
            }

            public Builder addAll(int... r2) {
                this.flagsBuilder.addAll(r2);
                return this;
            }
            ...
            public Builder remove(int r2) {
                this.flagsBuilder.remove(r2);
                return this;
            }

            public Builder removeIf(int r2, boolean z) {
                this.flagsBuilder.removeIf(r2, z);
                return this;
            }

            public Builder removeAll(int... r2) {
                this.flagsBuilder.removeAll(r2);
                return this;
            }
        ...
        public Bundle toBundle() {
            ...
            for (int r3 = 0; r3 < this.flags.size(); r3++) {
                arrayList.add(Integer.valueOf(this.flags.get(r3)));
            }
        ...
        public static Commands fromBundle(Bundle bundle) {
            ...
            for (int r0 = 0; r0 < integerArrayList.size(); r0++) {
                builder.add(integerArrayList.get(r0).intValue());
            }
