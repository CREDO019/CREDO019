...
public abstract class DecoderVideoRenderer extends BaseRenderer {
    ...
    protected abstract void setDecoderOutputMode(int r1);

    protected DecoderVideoRenderer(long j, Handler handler, VideoRendererEventListener videoRendererEventListener, int r6) {
        super(2);
        this.allowedJoiningTimeMs = j;
        this.maxDroppedFramesToNotify = r6;
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.decoder != null) {
            try {
                ...
                Log.m1135e(TAG, "Video codec error", e);
    ...
    protected void updateDroppedBufferCounters(int r3, int r4) {
        ...
        int r42 = this.consecutiveDroppedFrameCount + r32;
        this.consecutiveDroppedFrameCount = r42;
        DecoderCounters decoderCounters = this.decoderCounters;
        decoderCounters.maxConsecutiveDroppedBufferCount = Math.max(r42, decoderCounters.maxConsecutiveDroppedBufferCount);
    ...
    protected void renderOutputBuffer(VideoDecoderOutputBuffer videoDecoderOutputBuffer, long j, Format format) throws DecoderException {
        ...
        int r9 = videoDecoderOutputBuffer.mode;
        boolean z = r9 == 1 && this.outputSurface != null;
        boolean z2 = r9 == 0 && this.outputBufferRenderer != null;
        if (!z2 && !z) {
    ...
    private void maybeNotifyVideoSizeChanged(int r2, int r3) {
        VideoSize videoSize = this.reportedVideoSize;
        if (videoSize != null && videoSize.width == r2 && this.reportedVideoSize.height == r3) {
            return;
        }
        VideoSize videoSize2 = new VideoSize(r2, r3);
