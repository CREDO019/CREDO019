...
public final class PlaceholderSurface extends Surface {
    ...
    public static class PlaceholderSurfaceThread extends HandlerThread implements Handler.Callback {
        ...
        public PlaceholderSurface init(int r4) {
            boolean z;
            start();
            ...
            synchronized (this) {
                z = false;
                this.handler.obtainMessage(1, r4, 0).sendToTarget();
        ...
        public boolean handleMessage(Message message) {
            ...
            try {
                ...
                try {
                    ...
                    Log.m1135e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e);
                    this.initError = e;
                    synchronized (this) {
                        notify();
                    }
                } catch (RuntimeException e2) {
                    Log.m1135e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e2);
        ...
        private void initInternal(int r4) {
            ...
            this.eglSurfaceTexture.init(r4);
            this.surface = new PlaceholderSurface(this, this.eglSurfaceTexture.getSurfaceTexture(), r4 != 0);
        }
