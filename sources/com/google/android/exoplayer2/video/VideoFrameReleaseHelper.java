...
public final class VideoFrameReleaseHelper {
    ...
    public VideoFrameReleaseHelper(Context context) {
        ...
        this.vsyncDurationNs = C1856C.TIME_UNSET;
        this.vsyncOffsetNs = C1856C.TIME_UNSET;
        this.formatFrameRate = -1.0f;
        this.playbackSpeed = 1.0f;
        this.changeFrameRateStrategy = 0;
    }

    public void setChangeFrameRateStrategy(int r2) {
        if (this.changeFrameRateStrategy == r2) {
            return;
        }
        this.changeFrameRateStrategy = r2;
    ...
    public long adjustReleaseTime(long j) {
        ...
        if (this.lastAdjustedFrameIndex != -1 && this.frameRateEstimator.isSynced()) {
            ...
            if (!adjustmentAllowed(j, frameDurationNs)) {
                ...
                if (vSyncSampler != null || this.vsyncDurationNs == C1856C.TIME_UNSET) {
                    return j2;
                }
                long j3 = vSyncSampler.sampledVsyncTimeNs;
                return j3 == C1856C.TIME_UNSET ? j2 : closestVsync(j2, j3, this.vsyncDurationNs) - this.vsyncOffsetNs;
            }
        }
        j2 = j;
        this.pendingLastAdjustedFrameIndex = this.frameIndex;
    ...
    */
    ...
    public void updateDefaultDisplayRefreshRateParams(Display display) {
        ...
        Log.m1132w(TAG, "Unable to query display refresh rate");
        this.vsyncDurationNs = C1856C.TIME_UNSET;
        this.vsyncOffsetNs = C1856C.TIME_UNSET;
    }
    ...
    public static final class Api30 {
        ...
        public static void setSurfaceFrameRate(Surface surface, float f) {
            try {
                ...
                Log.m1135e(VideoFrameReleaseHelper.TAG, "Failed to call Surface.setFrameRate", e);
            }
        }
    }
    ...
    private static final class VSyncSampler implements Choreographer.FrameCallback, Handler.Callback {
        ...
        public volatile long sampledVsyncTimeNs = C1856C.TIME_UNSET;
        ...
        private void createChoreographerInstanceInternal() {
            try {
                ...
                Log.m1131w(VideoFrameReleaseHelper.TAG, "Vsync sampling disabled due to platform error", e);
            }
        }
        ...
        private void addObserverInternal() {
            ...
            if (choreographer != null) {
                int r1 = this.observerCount + 1;
                this.observerCount = r1;
                if (r1 == 1) {
        ...
        private void removeObserverInternal() {
            ...
            if (choreographer != null) {
                ...
                if (r1 == 0) {
                    ...
                    this.sampledVsyncTimeNs = C1856C.TIME_UNSET;
                }
            }
        }
    }
