...
public final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    public void setDefaultStereoMode(int r1) {
        this.defaultStereoMode = r1;
    }
    ...
    public SurfaceTexture init() {
        ...
        surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: com.google.android.exoplayer2.video.spherical.SceneRenderer$$ExternalSyntheticLambda0
            ...
            public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                SceneRenderer.this.m1115x44e5bf0(surfaceTexture2);
            }
        });
    ...
    public /* synthetic */ void m1115x44e5bf0(SurfaceTexture surfaceTexture) {
    ...
    private void setProjection(byte[] bArr, int r4, long j) {
        byte[] bArr2 = this.lastProjectionData;
        int r1 = this.lastStereoMode;
        this.lastProjectionData = bArr;
        if (r4 == -1) {
            r4 = this.defaultStereoMode;
        }
        this.lastStereoMode = r4;
        if (r1 == r4 && Arrays.equals(bArr2, this.lastProjectionData)) {
            return;
        }
