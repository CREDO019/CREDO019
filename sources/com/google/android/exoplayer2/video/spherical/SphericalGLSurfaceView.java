...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public void setDefaultStereoMode(int r2) {
        this.scene.setDefaultStereoMode(r2);
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SphericalGLSurfaceView.this.m1114xc1bb6354();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onDetachedFromWindow$0$com-google-android-exoplayer2-video-spherical-SphericalGLSurfaceView */
    public /* synthetic */ void m1114xc1bb6354() {
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                SphericalGLSurfaceView.this.m1113xe569531c(surfaceTexture);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onSurfaceTextureAvailable$1$com-google-android-exoplayer2-video-spherical-SphericalGLSurfaceView */
    public /* synthetic */ void m1113xe569531c(SurfaceTexture surfaceTexture) {
    ...
    final class Renderer implements GLSurfaceView.Renderer, TouchTracker.Listener, OrientationListener.Listener {
        ...
        @Override // android.opengl.GLSurfaceView.Renderer
        public void onSurfaceChanged(GL10 gl10, int r8, int r9) {
            GLES20.glViewport(0, 0, r8, r9);
            float f = r8 / r9;
