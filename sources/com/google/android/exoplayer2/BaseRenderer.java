...
public abstract class BaseRenderer implements Renderer, RendererCapabilities {
    ...
    public void handleMessage(int r1, Object obj) throws ExoPlaybackException {
    }
    ...
    @Override // com.google.android.exoplayer2.Renderer
    public final void init(int r1, PlayerId playerId) {
        this.index = r1;
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final ExoPlaybackException createRendererException(Throwable th, Format format, int r4) {
        return createRendererException(th, format, false, r4);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final ExoPlaybackException createRendererException(Throwable th, Format format, boolean z, int r13) {
        int r6;
        if (format != null && !this.throwRendererExceptionIsExecuting) {
            ...
            return ExoPlaybackException.createForRenderer(th, getName(), getIndex(), format, r6, z, r13);
        }
        r6 = 4;
        return ExoPlaybackException.createForRenderer(th, getName(), getIndex(), format, r6, z, r13);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final int readSource(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, int r8) {
        int readData = ((SampleStream) Assertions.checkNotNull(this.stream)).readData(formatHolder, decoderInputBuffer, r8);
        if (readData == -4) {
