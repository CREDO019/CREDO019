...
public final class TrueHdSampleRechunker {
    ...
    public void sampleMetadata(TrackOutput trackOutput, long j, int r7, int r8, int r9, TrackOutput.CryptoData cryptoData) {
        Assertions.checkState(this.chunkOffset <= r8 + r9, "TrueHD chunk samples must be contiguous in the sample queue.");
        if (this.foundSyncframe) {
            int r0 = this.chunkSampleCount;
            int r1 = r0 + 1;
            this.chunkSampleCount = r1;
            if (r0 == 0) {
                this.chunkTimeUs = j;
                this.chunkFlags = r7;
                this.chunkSize = 0;
