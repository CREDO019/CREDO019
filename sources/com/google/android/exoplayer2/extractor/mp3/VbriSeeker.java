...
final class VbriSeeker implements Seeker {
    ...
    public static VbriSeeker create(long j, long j2, MpegAudioUtil.Header header, ParsableByteArray parsableByteArray) {
        ...
        int r6 = header.sampleRate;
        long scaleLargeTimestamp = Util.scaleLargeTimestamp(readInt, 1000000 * (r6 >= 32000 ? 1152 : 576), r6);
        ...
        int r2 = 0;
        long j4 = j2;
        while (r2 < readUnsignedShort) {
            int r18 = readUnsignedShort2;
            long j5 = j3;
            jArr[r2] = (r2 * scaleLargeTimestamp) / readUnsignedShort;
            ...
            j4 += readUnsignedByte * r18;
            r2++;
            jArr = jArr;
            readUnsignedShort2 = r18;
            j3 = j5;
        }
        long[] jArr3 = jArr;
        if (j != -1 && j != j4) {
            Log.m1132w(TAG, "VBRI data size mismatch: " + j + ", " + j4);
        }
