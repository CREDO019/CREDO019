...
public abstract class BinarySearchSeeker {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public BinarySearchSeeker(SeekTimestampConverter seekTimestampConverter, TimestampSeeker timestampSeeker, long j, long j2, long j3, long j4, long j5, long j6, int r31) {
        this.timestampSeeker = timestampSeeker;
        this.minimumSearchRange = r31;
    ...
    public int handlePendingSeek(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        while (true) {
            ...
            if (ceilingBytePosition - floorBytePosition <= this.minimumSearchRange) {
                ...
                int r2 = searchForTimestamp.type;
                if (r2 == -3) {
    ...
    public static final class TimestampSearchResult {
        public static final TimestampSearchResult NO_TIMESTAMP_IN_RANGE_RESULT = new TimestampSearchResult(-3, C1856C.TIME_UNSET, -1);
        ...
        private TimestampSearchResult(int r1, long j, long j2) {
            this.type = r1;
        ...
        public static TimestampSearchResult targetFoundResult(long j) {
            return new TimestampSearchResult(0, C1856C.TIME_UNSET, j);
        }
    }
