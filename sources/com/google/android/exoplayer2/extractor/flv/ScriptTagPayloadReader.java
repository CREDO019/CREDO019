...
final class ScriptTagPayloadReader extends TagPayloadReader {
                ...
                if ((obj3 instanceof List) && (obj4 instanceof List)) {
                    ...
                    for (int r3 = 0; r3 < size; r3++) {
                        ...
                        if ((obj6 instanceof Double) && (obj5 instanceof Double)) {
                            this.keyFrameTimesUs[r3] = (long) (((Double) obj6).doubleValue() * 1000000.0d);
                            this.keyFrameTagPositions[r3] = ((Double) obj5).longValue();
                        } else {
                            this.keyFrameTimesUs = new long[0];
                            this.keyFrameTagPositions = new long[0];
                            break;
    ...
    private static ArrayList<Object> readAmfStrictArray(ParsableByteArray parsableByteArray) {
        ...
        for (int r2 = 0; r2 < readUnsignedIntToInt; r2++) {
    ...
    private static Object readAmfData(ParsableByteArray parsableByteArray, int r2) {
        if (r2 != 0) {
            if (r2 != 1) {
                if (r2 != 2) {
                    if (r2 != 3) {
