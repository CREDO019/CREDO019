...
final class VideoTagPayloadReader extends TagPayloadReader {
    ...
    protected boolean parseHeader(ParsableByteArray parsableByteArray) throws TagPayloadReader.UnsupportedFormatException {
        ...
        int r0 = (readUnsignedByte >> 4) & 15;
        int r4 = readUnsignedByte & 15;
        if (r4 != 7) {
            throw new TagPayloadReader.UnsupportedFormatException("Video format not supported: " + r4);
        }
        this.frameType = r0;
        return r0 != 5;
    }
    ...
    protected boolean parsePayload(ParsableByteArray parsableByteArray, long j) throws ParserException {
        ...
        if (readUnsignedByte == 0 && !this.hasOutputFormat) {
            ...
            int r6 = this.frameType == 1 ? 1 : 0;
            if (this.hasOutputKeyframe || r6 != 0) {
                byte[] data = this.nalLength.getData();
                data[0] = 0;
                data[1] = 0;
                data[2] = 0;
                int r0 = 4 - this.nalUnitLengthFieldLength;
                int r7 = 0;
                while (parsableByteArray.bytesLeft() > 0) {
                    parsableByteArray.readBytes(this.nalLength.getData(), r0, this.nalUnitLengthFieldLength);
                    ...
                    r7 = r7 + 4 + readUnsignedIntToInt;
                }
                this.output.sampleMetadata(readInt24, r6, r7, 0, null);
