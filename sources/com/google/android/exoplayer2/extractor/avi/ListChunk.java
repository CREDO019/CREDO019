...
final class ListChunk implements AviChunk {
    ...
    public static ListChunk parseFrom(int r7, ParsableByteArray parsableByteArray) {
        AviChunk createBox;
        ...
        while (parsableByteArray.bytesLeft() > 8) {
            ...
            if (readLittleEndianInt == 1414744396) {
                ...
                createBox = createBox(readLittleEndianInt, r2, parsableByteArray);
            }
            if (createBox != null) {
                if (createBox.getType() == 1752331379) {
                    r2 = ((AviStreamHeaderChunk) createBox).getTrackType();
                }
        ...
        return new ListChunk(r7, builder.build());
    }

    private ListChunk(int r1, ImmutableList<AviChunk> immutableList) {
        this.type = r1;
    ...
    private static AviChunk createBox(int r0, int r1, ParsableByteArray parsableByteArray) {
        switch (r0) {
            case AviExtractor.FOURCC_strf /* 1718776947 */:
                return StreamFormatChunk.parseFrom(r1, parsableByteArray);
