...
public final class AviExtractor implements Extractor {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        switch (this.state) {
            ...
            case 1:
                ...
                return 0;
            case 2:
                int r14 = this.hdrlSize - 4;
                ParsableByteArray parsableByteArray = new ParsableByteArray(r14);
                extractorInput.readFully(parsableByteArray.getData(), 0, r14);
    ...
    private void parseHdrlBody(ParsableByteArray parsableByteArray) throws IOException {
        ...
        while (it.hasNext()) {
            ...
            if (next.getType() == 1819440243) {
                int r4 = r2 + 1;
                ChunkReader processStreamList = processStreamList((ListChunk) next, r2);
    ...
    private ChunkReader getChunkReader(int r6) {
        ChunkReader[] chunkReaderArr;
        for (ChunkReader chunkReader : this.chunkReaders) {
            if (chunkReader.handlesChunkId(r6)) {
                return chunkReader;
            }
        }
        return null;
    ...
    private ChunkReader processStreamList(ListChunk listChunk, int r15) {
        ...
        if (aviStreamHeaderChunk == null) {
            Log.m1132w(TAG, "Missing Stream Header");
            return null;
        } else if (streamFormatChunk == null) {
            Log.m1132w(TAG, "Missing Stream Format");
            return null;
        } else {
            ...
            buildUpon.setId(r15);
            int r4 = aviStreamHeaderChunk.suggestedBufferSize;
            if (r4 != 0) {
            ...
            if (trackType == 1 || trackType == 2) {
                TrackOutput track = this.extractorOutput.track(r15, trackType);
                track.format(buildUpon.build());
                ChunkReader chunkReader = new ChunkReader(r15, trackType, durationUs, aviStreamHeaderChunk.length, track);
    ...
    public class AviSeekMap implements SeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j) {
            ...
            for (int r1 = 1; r1 < AviExtractor.this.chunkReaders.length; r1++) {
                SeekMap.SeekPoints seekPoints2 = AviExtractor.this.chunkReaders[r1].getSeekPoints(j);
