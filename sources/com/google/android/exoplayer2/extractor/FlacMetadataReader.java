...
public final class FlacMetadataReader {
    ...
    public static boolean readMetadataBlock(ExtractorInput extractorInput, FlacStreamMetadataHolder flacStreamMetadataHolder) throws IOException {
        ...
        if (readBits == 0) {
            ...
            if (readBits == 3) {
                ...
                flacStreamMetadataHolder.flacStreamMetadata = flacStreamMetadata.copyWithPictureFrames(ImmutableList.m408of(PictureFrame.fromPictureBlock(parsableByteArray)));
            } else {
    ...
    public static FlacStreamMetadata.SeekTable readSeekTableMetadataBlock(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            jArr[r5] = readLong;
            jArr2[r5] = parsableByteArray.readLong();
    ...
    private static FlacStreamMetadata.SeekTable readSeekTableMetadataBlock(ExtractorInput extractorInput, int r4) throws IOException {
        ParsableByteArray parsableByteArray = new ParsableByteArray(r4);
        extractorInput.readFully(parsableByteArray.getData(), 0, r4);
        return readSeekTableMetadataBlock(parsableByteArray);
    }

    private static List<String> readVorbisCommentMetadataBlock(ExtractorInput extractorInput, int r4) throws IOException {
        ParsableByteArray parsableByteArray = new ParsableByteArray(r4);
        extractorInput.readFully(parsableByteArray.getData(), 0, r4);
        parsableByteArray.skipBytes(4);
