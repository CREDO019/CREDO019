...
public final class PsBinarySearchSeeker extends BinarySearchSeeker {
                ...
                if (PsBinarySearchSeeker.peekIntAtPosition(parsableByteArray.getData(), parsableByteArray.getPosition()) != 442) {
                    ...
                    if (readScrValueFromPack != C1856C.TIME_UNSET) {
                        ...
                        if (adjustTsTimestamp > j) {
                            ...
                            return BinarySearchSeeker.TimestampSearchResult.targetFoundResult(j2 + r3);
                    ...
                    r0 = parsableByteArray.getPosition();
                }
            }
            if (j3 != C1856C.TIME_UNSET) {
                return BinarySearchSeeker.TimestampSearchResult.underestimatedResult(j3, j2 + r0);
            }
    ...
    public static int peekIntAtPosition(byte[] bArr, int r3) {
