...
final class TsBinarySearchSeeker extends BinarySearchSeeker {
    ...
    public TsBinarySearchSeeker(TimestampAdjuster timestampAdjuster, long j, long j2, int r22, int r23) {
        super(new BinarySearchSeeker.DefaultSeekTimestampConverter(), new TsPcrSeeker(r22, timestampAdjuster, r23), j, 0L, j + 1, 0L, j2, 188L, MINIMUM_SEARCH_RANGE_BYTES);
    }
    ...
    private static final class TsPcrSeeker implements BinarySearchSeeker.TimestampSeeker {
        ...
        public TsPcrSeeker(int r1, TimestampAdjuster timestampAdjuster, int r3) {
            this.pcrPid = r1;
