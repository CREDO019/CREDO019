...
public final class TsExtractor implements Extractor {
    ...
    static /* synthetic */ int access$108(TsExtractor tsExtractor) {
        int r0 = tsExtractor.remainingPmts;
        tsExtractor.remainingPmts = r0 + 1;
        return r0;
    }
    ...
    public TsExtractor(int r3) {
        this(1, r3, (int) DEFAULT_TIMESTAMP_SEARCH_BYTES);
    }

    public TsExtractor(int r4, int r5, int r6) {
        this(r4, new TimestampAdjuster(0L), new DefaultTsPayloadReaderFactory(r5), r6);
    }

    public TsExtractor(int r2, TimestampAdjuster timestampAdjuster, TsPayloadReader.Factory factory) {
        this(r2, timestampAdjuster, factory, DEFAULT_TIMESTAMP_SEARCH_BYTES);
    }

    public TsExtractor(int r1, TimestampAdjuster timestampAdjuster, TsPayloadReader.Factory factory, int r4) {
        this.payloadReaderFactory = (TsPayloadReader.Factory) Assertions.checkNotNull(factory);
        this.timestampSearchBytes = r4;
        this.mode = r1;
        if (r1 == 1 || r1 == 2) {
        ...
        this.durationReader = new TsDurationReader(r4);
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        for (int r2 = 0; r2 < 188; r2++) {
            int r3 = 0;
            while (true) {
                if (r3 >= 5) {
                    z = true;
                    break;
                } else if (data[(r3 * 188) + r2] != 71) {
                    z = false;
                    break;
                } else {
                    r3++;
    ...
    public void seek(long j, long j2) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            TimestampAdjuster timestampAdjuster = this.timestampAdjusters.get(r1);
            boolean z = timestampAdjuster.getTimestampOffsetUs() == C1856C.TIME_UNSET;
            if (!z) {
                long firstSampleTimestampUs = timestampAdjuster.getFirstSampleTimestampUs();
                z = (firstSampleTimestampUs == C1856C.TIME_UNSET || firstSampleTimestampUs == 0 || firstSampleTimestampUs == j2) ? false : true;
            }
            if (z) {
        ...
        for (int r11 = 0; r11 < this.tsPayloadReaders.size(); r11++) {
            this.tsPayloadReaders.valueAt(r11).seek();
        }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (fillBufferWithAtLeastOnePacket(extractorInput)) {
            ...
            int r11 = ((4194304 & readInt) != 0 ? 1 : 0) | 0;
            int r12 = (2096896 & readInt) >> 8;
            boolean z = (readInt & 32) != 0;
            TsPayloadReader tsPayloadReader = (readInt & 16) != 0 ? this.tsPayloadReaders.get(r12) : null;
            ...
            if (this.mode != 2) {
                int r5 = readInt & 15;
                int r6 = this.continuityCounters.get(r12, r5 - 1);
                this.continuityCounters.put(r12, r5);
                if (r6 == r5) {
                    this.tsPacketBuffer.setPosition(findEndOfFirstTsPacketInBuffer);
                    return 0;
                } else if (r5 != ((r6 + 1) & 15)) {
    ...
    private void maybeOutputSeekMap(long j) {
        ...
        if (this.durationReader.getDurationUs() != C1856C.TIME_UNSET) {
    ...
    private int findEndOfFirstTsPacketInBuffer() throws ParserException {
        ...
        int r3 = findSyncBytePosition + 188;
        if (r3 > limit) {
            int r1 = this.bytesSinceLastSync + (findSyncBytePosition - position);
            this.bytesSinceLastSync = r1;
            if (this.mode == 2 && r1 > 376) {
    ...
    private boolean shouldConsumePacketPayload(int r4) {
        return this.mode == 2 || this.tracksEnded || !this.trackPids.get(r4, false);
    }
    ...
    private void resetPayloadReaders() {
        ...
        for (int r3 = 0; r3 < size; r3++) {
            this.tsPayloadReaders.put(createInitialPayloadReaders.keyAt(r3), createInitialPayloadReaders.valueAt(r3));
        }
    ...
    private class PmtReader implements SectionPayloadReader {
        ...
        public void consume(ParsableByteArray parsableByteArray) {
            ...
            while (bytesLeft > 0) {
                ...
                this.pmtScratch.skipBits(r7);
                int readBits2 = this.pmtScratch.readBits(r10);
                this.pmtScratch.skipBits(r9);
                ...
                int r72 = TsExtractor.this.mode == 2 ? readBits : readBits2;
                if (!TsExtractor.this.trackIds.get(r72)) {
                    ...
                    if (TsExtractor.this.mode != 2 || readBits2 < this.trackIdToPidScratch.get(r72, 8192)) {
                        this.trackIdToPidScratch.put(r72, readBits2);
                        this.trackIdToReaderScratch.put(r72, createPayloadReader);
                    }
                }
                r7 = 3;
                r9 = 4;
            ...
            for (int r4 = 0; r4 < size; r4++) {
                int keyAt = this.trackIdToPidScratch.keyAt(r4);
                int valueAt = this.trackIdToPidScratch.valueAt(r4);
                TsExtractor.this.trackIds.put(keyAt, true);
                TsExtractor.this.trackPids.put(valueAt, true);
                TsPayloadReader valueAt2 = this.trackIdToReaderScratch.valueAt(r4);
                if (valueAt2 != null) {
        ...
        private TsPayloadReader.EsInfo readEsInfo(ParsableByteArray parsableByteArray, int r15) {
            int position = parsableByteArray.getPosition();
            int r152 = r15 + position;
            String str = null;
            ArrayList arrayList = null;
            int r3 = -1;
            while (parsableByteArray.getPosition() < r152) {
                ...
                if (readUnsignedByte == 5) {
                    ...
                    if (readUnsignedInt != TsExtractor.AC3_FORMAT_IDENTIFIER) {
                        if (readUnsignedInt != TsExtractor.E_AC3_FORMAT_IDENTIFIER) {
                            ...
                            r3 = TsExtractor.TS_STREAM_TYPE_AC4;
                        }
                        r3 = TsExtractor.TS_STREAM_TYPE_E_AC3;
                    }
                    r3 = TsExtractor.TS_STREAM_TYPE_AC3;
                } else {
                    if (readUnsignedByte != 106) {
                        if (readUnsignedByte != 122) {
                            if (readUnsignedByte == 127) {
                                ...
                                r3 = TsExtractor.TS_STREAM_TYPE_DTS;
            ...
            parsableByteArray.setPosition(r152);
            return new TsPayloadReader.EsInfo(r3, str, arrayList, Arrays.copyOfRange(parsableByteArray.getData(), position, r152));
        }
    }
}
