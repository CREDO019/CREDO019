...
final class VorbisReader extends StreamReader {
    ...
    static int readBits(byte b, int r1, int r2) {
        return (b >> r2) & (255 >>> (8 - r1));
    }
    ...
    public static final class VorbisSetup {
        ...
        public VorbisSetup(VorbisUtil.VorbisIdHeader vorbisIdHeader, VorbisUtil.CommentHeader commentHeader, byte[] bArr, VorbisUtil.Mode[] modeArr, int r5) {
