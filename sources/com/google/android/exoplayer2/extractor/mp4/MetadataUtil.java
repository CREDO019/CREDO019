...
final class MetadataUtil {
    ...
    */
    ...
    public static void setFormatGaplessInfo(int r1, GaplessInfoHolder gaplessInfoHolder, Format.Builder builder) {
        if (r1 == 1 && gaplessInfoHolder.hasGaplessInfo()) {
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        ...
        try {
            ...
            Log.m1138d(TAG, "Skipped unknown metadata entry: " + Atom.getAtomTypeString(readInt));
            return null;
        } finally {
    ...
    public static MdtaMetadataEntry parseMdtaMetadataEntryFromIlst(ParsableByteArray parsableByteArray, int r5, String str) {
        while (true) {
            ...
            if (parsableByteArray.readInt() == 1684108385) {
                ...
                parsableByteArray.readBytes(bArr, 0, r1);
    ...
    private static TextInformationFrame parseTextAttribute(int r4, String str, ParsableByteArray parsableByteArray) {
        int readInt = parsableByteArray.readInt();
        if (parsableByteArray.readInt() == 1684108385) {
            parsableByteArray.skipBytes(8);
            return new TextInformationFrame(str, null, parsableByteArray.readNullTerminatedString(readInt - 16));
        }
        Log.m1132w(TAG, "Failed to parse text attribute: " + Atom.getAtomTypeString(r4));
        return null;
    }

    private static CommentFrame parseCommentAttribute(int r3, ParsableByteArray parsableByteArray) {
        int readInt = parsableByteArray.readInt();
        if (parsableByteArray.readInt() == 1684108385) {
            parsableByteArray.skipBytes(8);
            String readNullTerminatedString = parsableByteArray.readNullTerminatedString(readInt - 16);
            return new CommentFrame(C1856C.LANGUAGE_UNDETERMINED, readNullTerminatedString, readNullTerminatedString);
        }
        Log.m1132w(TAG, "Failed to parse comment attribute: " + Atom.getAtomTypeString(r3));
        return null;
    }

    private static Id3Frame parseUint8Attribute(int r0, String str, ParsableByteArray parsableByteArray, boolean z, boolean z2) {
        ...
        if (parseUint8AttributeValue >= 0) {
            ...
            return new CommentFrame(C1856C.LANGUAGE_UNDETERMINED, str, Integer.toString(parseUint8AttributeValue));
        }
        Log.m1132w(TAG, "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(r0));
        return null;
    }

    private static TextInformationFrame parseIndexAndCountAttribute(int r4, String str, ParsableByteArray parsableByteArray) {
        int readInt = parsableByteArray.readInt();
        ...
        Log.m1132w(TAG, "Failed to parse index/count attribute: " + Atom.getAtomTypeString(r4));
        return null;
    }
    ...
    */
    private static com.google.android.exoplayer2.metadata.id3.TextInformationFrame parseStandardGenreAttribute(com.google.android.exoplayer2.util.ParsableByteArray r3) {
        ...
        L1c:
            ...
            com.google.android.exoplayer2.util.Log.m1132w(r3, r1)
            return r0
        */
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385) {
            ...
            if (str == null) {
                Log.m1132w(TAG, "Unrecognized cover art flags: " + parseFullAtomFlags);
                return null;
            }
            parsableByteArray.skipBytes(4);
            int r0 = readInt - 16;
            byte[] bArr = new byte[r0];
            parsableByteArray.readBytes(bArr, 0, r0);
            return new ApicFrame(str, null, 3, bArr);
        }
        Log.m1132w(TAG, "Failed to parse cover art attribute");
        return null;
    }

    private static Id3Frame parseInternalAttribute(ParsableByteArray parsableByteArray, int r11) {
        String str = null;
        String str2 = null;
        int r4 = -1;
        int r5 = -1;
        while (parsableByteArray.getPosition() < r11) {
            int position = parsableByteArray.getPosition();
            int readInt = parsableByteArray.readInt();
            int readInt2 = parsableByteArray.readInt();
            parsableByteArray.skipBytes(4);
        ...
        if (str == null || str2 == null || r4 == -1) {
            return null;
        }
        parsableByteArray.setPosition(r4);
        parsableByteArray.skipBytes(16);
        return new InternalFrame(str, str2, parsableByteArray.readNullTerminatedString(r5 - 16));
    }
    ...
    private static int parseUint8AttributeValue(ParsableByteArray parsableByteArray) {
        ...
        Log.m1132w(TAG, "Failed to parse uint8 attribute value");
        return -1;
    }
}
