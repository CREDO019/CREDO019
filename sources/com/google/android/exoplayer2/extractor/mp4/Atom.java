...
abstract class Atom {
    ...
    public static int parseFullAtomFlags(int r1) {
        return r1 & ViewCompat.MEASURED_SIZE_MASK;
    }
    ...
    static final class LeafAtom extends Atom {
        ...
        public LeafAtom(int r1, ParsableByteArray parsableByteArray) {
            super(r1);
    ...
    static final class ContainerAtom extends Atom {
        ...
        public ContainerAtom(int r1, long j) {
            super(r1);
            this.endPosition = j;
        ...
        public LeafAtom getLeafAtomOfType(int r5) {
            int size = this.leafChildren.size();
            for (int r1 = 0; r1 < size; r1++) {
                LeafAtom leafAtom = this.leafChildren.get(r1);
                if (leafAtom.type == r5) {
                    return leafAtom;
                }
            }
        ...
        public ContainerAtom getContainerAtomOfType(int r5) {
            int size = this.containerChildren.size();
            for (int r1 = 0; r1 < size; r1++) {
                ContainerAtom containerAtom = this.containerChildren.get(r1);
                if (containerAtom.type == r5) {
        ...
        public int getChildAtomOfTypeCount(int r6) {
            int size = this.leafChildren.size();
            int r3 = 0;
            for (int r2 = 0; r2 < size; r2++) {
                if (this.leafChildren.get(r2).type == r6) {
                    r3++;
                }
            }
            int size2 = this.containerChildren.size();
            for (int r1 = 0; r1 < size2; r1++) {
                if (this.containerChildren.get(r1).type == r6) {
                    r3++;
                }
            }
            return r3;
    ...
    public static String getAtomTypeString(int r2) {
