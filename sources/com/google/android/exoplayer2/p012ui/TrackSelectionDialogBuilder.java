...
public final class TrackSelectionDialogBuilder {
    ...
    public TrackSelectionDialogBuilder(Context context, CharSequence charSequence, final Player player, final int r6) {
        this.context = context;
        this.title = charSequence;
        ImmutableList<Tracks.Group> groups = player.getCurrentTracks().getGroups();
        this.trackGroups = new ArrayList();
        for (int r4 = 0; r4 < groups.size(); r4++) {
            Tracks.Group group = groups.get(r4);
            if (group.getType() == r6) {
        ...
        this.callback = new DialogCallback() { // from class: com.google.android.exoplayer2.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda1
            @Override // com.google.android.exoplayer2.p012ui.TrackSelectionDialogBuilder.DialogCallback
            public final void onTracksSelected(boolean z, Map map) {
                TrackSelectionDialogBuilder.lambda$new$0(Player.this, r6, z, map);
            }
        };
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void lambda$new$0(Player player, int r2, boolean z, Map map) {
        TrackSelectionParameters.Builder buildUpon = player.getTrackSelectionParameters().buildUpon();
        buildUpon.setTrackTypeDisabled(r2, z);
        buildUpon.clearOverridesOfType(r2);
    ...
    public TrackSelectionDialogBuilder setTheme(int r1) {
        this.themeResId = r1;
        return this;
    }
    ...
    public TrackSelectionDialogBuilder setOverride(TrackSelectionOverride trackSelectionOverride) {
        Map<TrackGroup, TrackSelectionOverride> m389of;
        if (trackSelectionOverride == null) {
            m389of = Collections.emptyMap();
        } else {
            m389of = ImmutableMap.m389of(trackSelectionOverride.mediaTrackGroup, trackSelectionOverride);
        }
        return setOverrides(m389of);
    }
    ...
    private Dialog buildForPlatform() {
        ...
        View inflate = LayoutInflater.from(builder.getContext()).inflate(C2058R.layout.exo_track_selection_dialog, (ViewGroup) null);
    ...
    private Dialog buildForAndroidX() {
        try {
            ...
            View inflate = LayoutInflater.from((Context) cls.getMethod("getContext", new Class[0]).invoke(newInstance, new Object[0])).inflate(C2058R.layout.exo_track_selection_dialog, (ViewGroup) null);
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        final TrackSelectionView trackSelectionView = (TrackSelectionView) view.findViewById(C2058R.C2062id.exo_track_selection_view);
        ...
        return new DialogInterface.OnClickListener() { // from class: com.google.android.exoplayer2.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda0
            ...
            public final void onClick(DialogInterface dialogInterface, int r4) {
                TrackSelectionDialogBuilder.this.m1139x1d103515(trackSelectionView, dialogInterface, r4);
            }
        };
    }
    ...
    public /* synthetic */ void m1139x1d103515(TrackSelectionView trackSelectionView, DialogInterface dialogInterface, int r3) {
