...
import com.google.android.exoplayer2.p012ui.PlayerControlView;
...
public class PlayerView extends FrameLayout implements AdViewProvider {
    ...
    public PlayerView(Context context, AttributeSet attributeSet, int r23) {
        ...
        int r4 = C2058R.layout.exo_player_view;
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2058R.styleable.PlayerView, r23, 0);
            try {
                boolean hasValue = obtainStyledAttributes.hasValue(C2058R.styleable.PlayerView_shutter_background_color);
                int color = obtainStyledAttributes.getColor(C2058R.styleable.PlayerView_shutter_background_color, 0);
                int resourceId = obtainStyledAttributes.getResourceId(C2058R.styleable.PlayerView_player_layout_id, r4);
                boolean z9 = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerView_use_artwork, true);
                int resourceId2 = obtainStyledAttributes.getResourceId(C2058R.styleable.PlayerView_default_artwork, 0);
                boolean z10 = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerView_use_controller, true);
                int r15 = obtainStyledAttributes.getInt(C2058R.styleable.PlayerView_surface_type, 1);
                int r5 = obtainStyledAttributes.getInt(C2058R.styleable.PlayerView_resize_mode, 0);
                int r7 = obtainStyledAttributes.getInt(C2058R.styleable.PlayerView_show_timeout, 5000);
                boolean z11 = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerView_hide_on_touch, true);
                boolean z12 = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerView_auto_show, true);
                r8 = obtainStyledAttributes.getInteger(C2058R.styleable.PlayerView_show_buffering, 0);
                this.keepContentOnPlayerReset = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerView_keep_content_on_player_reset, this.keepContentOnPlayerReset);
                boolean z13 = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerView_hide_during_ads, true);
        ...
        PlayerControlView playerControlView = (PlayerControlView) findViewById(C2058R.C2062id.exo_controller);
        ...
        if (playerControlView != null) {
            ...
            playerControlView2.setId(C2058R.C2062id.exo_controller);
        ...
        this.controllerShowTimeoutMs = playerControlView3 != null ? r232 : 0;
    ...
    public final class ComponentListener implements Player.Listener, View.OnLayoutChangeListener, View.OnClickListener, PlayerControlView.VisibilityListener {
        ...
        @Override // com.google.android.exoplayer2.p012ui.PlayerControlView.VisibilityListener
