...
import com.google.android.exoplayer2.p012ui.SpannedToHtmlConverter;
...
public final class SpannedToHtmlConverter {
    ...
    private static String getTextEmphasisPosition(int r1) {
        return r1 != 2 ? "over right" : "under left";
    }
    ...
    public static HtmlAndCss convert(CharSequence charSequence, float f) {
        if (charSequence == null) {
            return new HtmlAndCss("", ImmutableMap.m390of());
        }
        if (!(charSequence instanceof Spanned)) {
            return new HtmlAndCss(escapeHtml(charSequence), ImmutableMap.m390of());
        }
        ...
        int r3 = 0;
        while (r4 < findSpanTransitions.size()) {
            int keyAt = findSpanTransitions.keyAt(r4);
            sb.append(escapeHtml(spanned.subSequence(r3, keyAt)));
        ...
        sb.append(escapeHtml(spanned.subSequence(r3, spanned.length())));
    ...
    private static String getTextEmphasisStyle(int r3, int r4) {
    ...
    private static Transition getOrCreate(SparseArray<Transition> sparseArray, int r2) {
        Transition transition = sparseArray.get(r2);
        if (transition == null) {
            Transition transition2 = new Transition();
            sparseArray.put(r2, transition2);
            return transition2;
        }
        return transition;
    }
    ...
    public static final class SpanInfo {
        ...
        private SpanInfo(int r1, int r2, String str, String str2) {
            this.start = r1;
            this.end = r2;
            this.openingTag = str;
