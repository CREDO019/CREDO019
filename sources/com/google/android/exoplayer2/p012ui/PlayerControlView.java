...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(Context context, AttributeSet attributeSet, int r3) {
        this(context, attributeSet, r3, attributeSet);
    }

    public PlayerControlView(Context context, AttributeSet attributeSet, int r8, AttributeSet attributeSet2) {
        super(context, attributeSet, r8);
        int r7 = C2058R.layout.exo_player_control_view;
        this.showTimeoutMs = 5000;
        this.repeatToggleModes = 0;
        this.timeBarMinUpdateIntervalMs = 200;
        this.hideAtMs = C1856C.TIME_UNSET;
        ...
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C2058R.styleable.PlayerControlView, r8, 0);
            try {
                this.showTimeoutMs = obtainStyledAttributes.getInt(C2058R.styleable.PlayerControlView_show_timeout, this.showTimeoutMs);
                r7 = obtainStyledAttributes.getResourceId(C2058R.styleable.PlayerControlView_controller_layout_id, r7);
                this.repeatToggleModes = getRepeatToggleModes(obtainStyledAttributes, this.repeatToggleModes);
                this.showRewindButton = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerControlView_show_rewind_button, this.showRewindButton);
                this.showFastForwardButton = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerControlView_show_fastforward_button, this.showFastForwardButton);
                this.showPreviousButton = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerControlView_show_previous_button, this.showPreviousButton);
                this.showNextButton = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerControlView_show_next_button, this.showNextButton);
                this.showShuffleButton = obtainStyledAttributes.getBoolean(C2058R.styleable.PlayerControlView_show_shuffle_button, this.showShuffleButton);
                setTimeBarMinUpdateInterval(obtainStyledAttributes.getInt(C2058R.styleable.PlayerControlView_time_bar_min_update_interval, this.timeBarMinUpdateIntervalMs));
            } finally {
        ...
        LayoutInflater.from(context).inflate(r7, this);
        setDescendantFocusability(262144);
        TimeBar timeBar = (TimeBar) findViewById(C2058R.C2062id.exo_progress);
        View findViewById = findViewById(C2058R.C2062id.exo_progress_placeholder);
        if (timeBar != null) {
        ...
        View findViewById2 = findViewById(C2058R.C2062id.exo_play);
        this.playButton = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setOnClickListener(componentListener);
        }
        View findViewById3 = findViewById(C2058R.C2062id.exo_pause);
        this.pauseButton = findViewById3;
        if (findViewById3 != null) {
            findViewById3.setOnClickListener(componentListener);
        }
        View findViewById4 = findViewById(C2058R.C2062id.exo_prev);
        this.previousButton = findViewById4;
        if (findViewById4 != null) {
            findViewById4.setOnClickListener(componentListener);
        }
        View findViewById5 = findViewById(C2058R.C2062id.exo_next);
        this.nextButton = findViewById5;
        if (findViewById5 != null) {
            findViewById5.setOnClickListener(componentListener);
        }
        View findViewById6 = findViewById(C2058R.C2062id.exo_rew);
        this.rewindButton = findViewById6;
        if (findViewById6 != null) {
            findViewById6.setOnClickListener(componentListener);
        }
        View findViewById7 = findViewById(C2058R.C2062id.exo_ffwd);
        this.fastForwardButton = findViewById7;
        if (findViewById7 != null) {
            findViewById7.setOnClickListener(componentListener);
        }
        ImageView imageView = (ImageView) findViewById(C2058R.C2062id.exo_repeat_toggle);
        this.repeatToggleButton = imageView;
        if (imageView != null) {
            imageView.setOnClickListener(componentListener);
        }
        ImageView imageView2 = (ImageView) findViewById(C2058R.C2062id.exo_shuffle);
        this.shuffleButton = imageView2;
        if (imageView2 != null) {
            imageView2.setOnClickListener(componentListener);
        }
        View findViewById8 = findViewById(C2058R.C2062id.exo_vr);
        ...
        this.buttonAlphaDisabled = resources.getInteger(C2058R.integer.exo_media_button_opacity_percentage_disabled) / 100.0f;
        this.repeatOffButtonDrawable = resources.getDrawable(C2058R.C2060drawable.exo_controls_repeat_off);
        this.repeatOneButtonDrawable = resources.getDrawable(C2058R.C2060drawable.exo_controls_repeat_one);
        this.repeatAllButtonDrawable = resources.getDrawable(C2058R.C2060drawable.exo_controls_repeat_all);
        this.shuffleOnButtonDrawable = resources.getDrawable(C2058R.C2060drawable.exo_controls_shuffle_on);
        this.shuffleOffButtonDrawable = resources.getDrawable(C2058R.C2060drawable.exo_controls_shuffle_off);
        this.repeatOffButtonContentDescription = resources.getString(C2058R.string.exo_controls_repeat_off_description);
        this.repeatOneButtonContentDescription = resources.getString(C2058R.string.exo_controls_repeat_one_description);
        this.repeatAllButtonContentDescription = resources.getString(C2058R.string.exo_controls_repeat_all_description);
        this.shuffleOnContentDescription = resources.getString(C2058R.string.exo_controls_shuffle_on_description);
        this.shuffleOffContentDescription = resources.getString(C2058R.string.exo_controls_shuffle_off_description);
        this.currentPosition = C1856C.TIME_UNSET;
        this.currentBufferedPosition = C1856C.TIME_UNSET;
    }
    ...
    public void setRepeatToggleModes(int r4) {
        this.repeatToggleModes = r4;
        Player player = this.player;
        if (player != null) {
            int repeatMode = player.getRepeatMode();
            if (r4 == 0 && repeatMode != 0) {
                this.player.setRepeatMode(0);
            } else if (r4 == 1 && repeatMode == 2) {
                this.player.setRepeatMode(1);
            } else if (r4 == 2 && repeatMode == 1) {
    ...
    private void hideAfterTimeout() {
        ...
        if (this.showTimeoutMs > 0) {
            ...
            int r2 = this.showTimeoutMs;
            this.hideAtMs = uptimeMillis + r2;
            if (this.isAttachedToWindow) {
                postDelayed(this.hideAction, r2);
                return;
            }
            return;
        }
    ...
    private static int getRepeatToggleModes(TypedArray typedArray, int r2) {
        return typedArray.getInt(C2058R.styleable.PlayerControlView_repeat_toggle_modes, r2);
    }
