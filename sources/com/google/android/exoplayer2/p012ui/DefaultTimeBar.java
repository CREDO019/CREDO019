...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    private static int dpToPx(float f, int r1) {
        return (int) ((r1 * f) + 0.5f);
    }

    private static int pxToDp(float f, int r1) {
        return (int) (r1 / f);
    }
    ...
    public DefaultTimeBar(Context context, AttributeSet attributeSet, int r3) {
        this(context, attributeSet, r3, attributeSet);
    }

    public DefaultTimeBar(Context context, AttributeSet attributeSet, int r9, AttributeSet attributeSet2) {
        this(context, attributeSet, r9, attributeSet2, 0);
    }

    public DefaultTimeBar(Context context, AttributeSet attributeSet, int r21, AttributeSet attributeSet2, int r23) {
        super(context, attributeSet, r21);
        ...
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C2058R.styleable.DefaultTimeBar, r21, r23);
            try {
                Drawable drawable = obtainStyledAttributes.getDrawable(C2058R.styleable.DefaultTimeBar_scrubber_drawable);
                this.scrubberDrawable = drawable;
                if (drawable != null) {
                    setDrawableLayoutDirection(drawable);
                    dpToPx2 = Math.max(drawable.getMinimumHeight(), dpToPx2);
                }
                this.barHeight = obtainStyledAttributes.getDimensionPixelSize(C2058R.styleable.DefaultTimeBar_bar_height, dpToPx);
                this.touchTargetHeight = obtainStyledAttributes.getDimensionPixelSize(C2058R.styleable.DefaultTimeBar_touch_target_height, dpToPx2);
                this.barGravity = obtainStyledAttributes.getInt(C2058R.styleable.DefaultTimeBar_bar_gravity, 0);
                this.adMarkerWidth = obtainStyledAttributes.getDimensionPixelSize(C2058R.styleable.DefaultTimeBar_ad_marker_width, dpToPx3);
                this.scrubberEnabledSize = obtainStyledAttributes.getDimensionPixelSize(C2058R.styleable.DefaultTimeBar_scrubber_enabled_size, dpToPx4);
                this.scrubberDisabledSize = obtainStyledAttributes.getDimensionPixelSize(C2058R.styleable.DefaultTimeBar_scrubber_disabled_size, dpToPx5);
                this.scrubberDraggedSize = obtainStyledAttributes.getDimensionPixelSize(C2058R.styleable.DefaultTimeBar_scrubber_dragged_size, dpToPx6);
                int r0 = obtainStyledAttributes.getInt(C2058R.styleable.DefaultTimeBar_played_color, -1);
                int r6 = obtainStyledAttributes.getInt(C2058R.styleable.DefaultTimeBar_scrubber_color, -1);
                int r8 = obtainStyledAttributes.getInt(C2058R.styleable.DefaultTimeBar_buffered_color, DEFAULT_BUFFERED_COLOR);
                int r9 = obtainStyledAttributes.getInt(C2058R.styleable.DefaultTimeBar_unplayed_color, DEFAULT_UNPLAYED_COLOR);
                int r10 = obtainStyledAttributes.getInt(C2058R.styleable.DefaultTimeBar_ad_marker_color, DEFAULT_AD_MARKER_COLOR);
                int r11 = obtainStyledAttributes.getInt(C2058R.styleable.DefaultTimeBar_played_ad_marker_color, DEFAULT_PLAYED_AD_MARKER_COLOR);
                paint.setColor(r0);
                paint6.setColor(r6);
                paint2.setColor(r8);
                paint3.setColor(r9);
        ...
        this.stopScrubbingRunnable = new Runnable() { // from class: com.google.android.exoplayer2.ui.DefaultTimeBar$$ExternalSyntheticLambda1
            ...
            public final void run() {
                DefaultTimeBar.this.m1506lambda$new$0$comgoogleandroidexoplayer2uiDefaultTimeBar();
            }
        };
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.exoplayer2.ui.DefaultTimeBar$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DefaultTimeBar.this.m1507lambda$new$1$comgoogleandroidexoplayer2uiDefaultTimeBar(valueAnimator2);
            }
        });
        this.duration = C1856C.TIME_UNSET;
        this.keyTimeIncrement = C1856C.TIME_UNSET;
    ...
    public /* synthetic */ void m1506lambda$new$0$comgoogleandroidexoplayer2uiDefaultTimeBar() {
        stopScrubbing(false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$new$1$com-google-android-exoplayer2-ui-DefaultTimeBar  reason: not valid java name */
    public /* synthetic */ void m1507lambda$new$1$comgoogleandroidexoplayer2uiDefaultTimeBar(ValueAnimator valueAnimator) {
    ...
    public void setPlayedColor(int r2) {
        this.playedPaint.setColor(r2);
        invalidate(this.seekBounds);
    }

    public void setScrubberColor(int r2) {
        this.scrubberPaint.setColor(r2);
        invalidate(this.seekBounds);
    }

    public void setBufferedColor(int r2) {
        this.bufferedPaint.setColor(r2);
        invalidate(this.seekBounds);
    }

    public void setUnplayedColor(int r2) {
        this.unplayedPaint.setColor(r2);
        invalidate(this.seekBounds);
    }

    public void setAdMarkerColor(int r2) {
        this.adMarkerPaint.setColor(r2);
        invalidate(this.seekBounds);
    }

    public void setPlayedAdMarkerColor(int r2) {
        this.playedAdMarkerPaint.setColor(r2);
        invalidate(this.seekBounds);
    }

    @Override // com.google.android.exoplayer2.p012ui.TimeBar
    ...
    public void setDuration(long j) {
        ...
        this.duration = j;
        if (this.scrubbing && j == C1856C.TIME_UNSET) {
            stopScrubbing(true);
        }
        update();
    }
    ...
    @Override // com.google.android.exoplayer2.p012ui.TimeBar
    public void setAdGroupTimesMs(long[] jArr, boolean[] zArr, int r4) {
        Assertions.checkArgument(r4 == 0 || !(jArr == null || zArr == null));
        this.adGroupCount = r4;
        this.adGroupTimesMs = jArr;
        this.playedAdGroups = zArr;
        update();
    }

    @Override // android.view.View, com.google.android.exoplayer2.p012ui.TimeBar
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L76:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p012ui.DefaultTimeBar.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    public boolean onKeyDown(int r5, android.view.KeyEvent r6) {
        ...
        L30:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p012ui.DefaultTimeBar.onKeyDown(int, android.view.KeyEvent):boolean");
    }
    ...
    protected void onMeasure(int r3, int r4) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(r3), size);
        updateDrawableState();
    }
    ...
    protected void onLayout(boolean z, int r6, int r7, int r8, int r9) {
        ...
        int paddingRight = r82 - getPaddingRight();
        int r72 = this.scrubberPaddingDisabled ? 0 : this.scrubberPadding;
        if (this.barGravity == 1) {
            r1 = (r92 - getPaddingBottom()) - this.touchTargetHeight;
            int r3 = this.barHeight;
            r2 = ((r92 - getPaddingBottom()) - r3) - Math.max(r72 - (r3 / 2), 0);
        } else {
            r1 = (r92 - this.touchTargetHeight) / 2;
            r2 = (r92 - this.barHeight) / 2;
        }
        this.seekBounds.set(paddingLeft, r1, paddingRight, this.touchTargetHeight + r1);
        this.progressBar.set(this.seekBounds.left + r72, r2, this.seekBounds.right - r72, this.barHeight + r2);
        if (Util.SDK_INT >= 29) {
            setSystemGestureExclusionRectsV29(r82, r92);
        }
        update();
    }
    ...
    public void onRtlPropertiesChanged(int r2) {
        Drawable drawable = this.scrubberDrawable;
        if (drawable == null || !setDrawableLayoutDirection(drawable, r2)) {
            return;
        }
        invalidate();
    }
    ...
    @Override // android.view.View
    public boolean performAccessibilityAction(int r7, Bundle bundle) {
        if (super.performAccessibilityAction(r7, bundle)) {
            return true;
        }
        if (this.duration <= 0) {
            return false;
    ...
    private long getScrubberPosition() {
        if (this.progressBar.width() <= 0 || this.duration == C1856C.TIME_UNSET) {
            return 0L;
        }
    ...
    private void drawTimeBar(Canvas canvas) {
        ...
        int r1 = height + centerY;
        if (this.duration <= 0) {
            canvas.drawRect(this.progressBar.left, centerY, this.progressBar.right, r1, this.unplayedPaint);
            return;
        }
        int r3 = this.bufferedBar.left;
        int r4 = this.bufferedBar.right;
        int max = Math.max(Math.max(this.progressBar.left, r4), this.scrubberBar.right);
        if (max < this.progressBar.right) {
            canvas.drawRect(max, centerY, this.progressBar.right, r1, this.unplayedPaint);
        }
        int max2 = Math.max(r3, this.scrubberBar.right);
        if (r4 > max2) {
            canvas.drawRect(max2, centerY, r4, r1, this.bufferedPaint);
        }
        if (this.scrubberBar.width() > 0) {
            canvas.drawRect(this.scrubberBar.left, centerY, this.scrubberBar.right, r1, this.playedPaint);
        }
        ...
        int r5 = this.adMarkerWidth / 2;
        for (int r7 = 0; r7 < this.adGroupCount; r7++) {
            int min = this.progressBar.left + Math.min(this.progressBar.width() - this.adMarkerWidth, Math.max(0, ((int) ((this.progressBar.width() * Util.constrainValue(jArr[r7], 0L, this.duration)) / this.duration)) - r5));
            canvas.drawRect(min, centerY, min + this.adMarkerWidth, r1, zArr[r7] ? this.playedAdMarkerPaint : this.adMarkerPaint);
        }
    }
    ...
    private void drawPlayhead(Canvas canvas) {
        ...
        if (drawable == null) {
            if (this.scrubbing || isFocused()) {
                r2 = this.scrubberDraggedSize;
            } else {
                r2 = isEnabled() ? this.scrubberEnabledSize : this.scrubberDisabledSize;
            }
            canvas.drawCircle(constrainValue, centerY, (int) ((r2 * this.scrubberScale) / 2.0f), this.scrubberPaint);
            return;
        }
    ...
    private void setSystemGestureExclusionRectsV29(int r3, int r4) {
        Rect rect = this.lastExclusionRectangle;
        if (rect != null && rect.width() == r3 && this.lastExclusionRectangle.height() == r4) {
            return;
        }
        Rect rect2 = new Rect(0, 0, r3, r4);
    ...
    private static boolean setDrawableLayoutDirection(Drawable drawable, int r3) {
        return Util.SDK_INT >= 23 && drawable.setLayoutDirection(r3);
    }
}
