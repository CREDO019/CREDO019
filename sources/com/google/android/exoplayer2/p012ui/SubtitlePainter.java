...
final class SubtitlePainter {
    ...
    public void draw(Cue cue, CaptionStyleCompat captionStyleCompat, float f, float f2, float f3, Canvas canvas, int r11, int r12, int r13, int r14) {
        ...
        this.parentLeft = r11;
        this.parentTop = r12;
        this.parentRight = r13;
        this.parentBottom = r14;
        if (z) {
    ...
    */
    private void setupTextLayout() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p012ui.SubtitlePainter.setupTextLayout():void");
    }
    ...
    */
    private void setupBitmapLayout() {
        ...
        L64:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p012ui.SubtitlePainter.setupBitmapLayout():void");
    }
    ...
    private void drawTextLayout(Canvas canvas) {
        ...
        if (r3 == 1) {
            ...
            boolean z = r3 == 3;
            int r6 = z ? -1 : this.edgeColor;
            int r32 = z ? this.edgeColor : -1;
            float f3 = this.shadowRadius / 2.0f;
            this.textPaint.setColor(this.foregroundColor);
            this.textPaint.setStyle(Paint.Style.FILL);
            float f4 = -f3;
            this.textPaint.setShadowLayer(this.shadowRadius, f4, f4, r6);
            staticLayout2.draw(canvas);
            this.textPaint.setShadowLayer(this.shadowRadius, f3, f3, r32);
        }
        this.textPaint.setColor(this.foregroundColor);
        this.textPaint.setStyle(Paint.Style.FILL);
