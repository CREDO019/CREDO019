...
public final class SubtitleView extends FrameLayout {
    ...
    public interface Output {
        void update(List<Cue> list, CaptionStyleCompat captionStyleCompat, float f, int r4, float f2);
    }
    ...
    public void setViewType(int r3) {
        if (this.viewType == r3) {
            return;
        }
        if (r3 == 1) {
    ...
    public void setFixedTextSize(int r3, float f) {
        Resources resources;
        ...
        setTextSize(2, TypedValue.applyDimension(r3, f, resources.getDisplayMetrics()));
    }
    ...
    private void setTextSize(int r1, float f) {
        this.defaultTextSizeType = r1;
    ...
    private List<Cue> getCuesWithStylingPreferencesApplied() {
        ...
        for (int r1 = 0; r1 < this.cues.size(); r1++) {
            arrayList.add(removeEmbeddedStyling(this.cues.get(r1)));
        }
        return arrayList;
    }
