...
public class DefaultRenderersFactory implements RenderersFactory {
    ...
    protected void buildMiscellaneousRenderers(Context context, Handler handler, int r3, ArrayList<Renderer> arrayList) {
    }
    ...
    public DefaultRenderersFactory setExtensionRendererMode(int r1) {
        this.extensionRendererMode = r1;
        return this;
    }
    ...
    protected void buildVideoRenderers(Context context, int r16, MediaCodecSelector mediaCodecSelector, boolean z, Handler handler, VideoRendererEventListener videoRendererEventListener, long j, ArrayList<Renderer> arrayList) {
        int r8;
        ...
        try {
            ...
            try {
                try {
                    ...
                    Log.m1134i(TAG, "Loaded LibvpxVideoRenderer.");
                } catch (ClassNotFoundException unused2) {
                    size = r8;
                    r8 = size;
                    arrayList.add(r8, (Renderer) Class.forName("com.google.android.exoplayer2.ext.av1.Libgav1VideoRenderer").getConstructor(Long.TYPE, Handler.class, VideoRendererEventListener.class, Integer.TYPE).newInstance(Long.valueOf(j), handler, videoRendererEventListener, 50));
                    Log.m1134i(TAG, "Loaded Libgav1VideoRenderer.");
                }
                arrayList.add(r8, (Renderer) Class.forName("com.google.android.exoplayer2.ext.av1.Libgav1VideoRenderer").getConstructor(Long.TYPE, Handler.class, VideoRendererEventListener.class, Integer.TYPE).newInstance(Long.valueOf(j), handler, videoRendererEventListener, 50));
                Log.m1134i(TAG, "Loaded Libgav1VideoRenderer.");
    ...
    */
    ...
    protected void buildTextRenderers(Context context, TextOutput textOutput, Looper looper, int r4, ArrayList<Renderer> arrayList) {
        arrayList.add(new TextRenderer(textOutput, looper));
    }

    protected void buildMetadataRenderers(Context context, MetadataOutput metadataOutput, Looper looper, int r4, ArrayList<Renderer> arrayList) {
        arrayList.add(new MetadataRenderer(metadataOutput, looper));
    }

    protected void buildCameraMotionRenderers(Context context, int r2, ArrayList<Renderer> arrayList) {
