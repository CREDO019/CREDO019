...
public final class MediaMetadata implements Bundleable {
    ...
    public static final class Builder {
        ...
        public Builder maybeSetArtworkData(byte[] bArr, int r5) {
            if (this.artworkData == null || Util.areEqual(Integer.valueOf(r5), 3) || !Util.areEqual(this.artworkDataType, 3)) {
                this.artworkData = (byte[]) bArr.clone();
                this.artworkDataType = Integer.valueOf(r5);
            }
            return this;
        }
        ...
        public Builder populateFromMetadata(Metadata metadata) {
            for (int r0 = 0; r0 < metadata.length(); r0++) {
                metadata.get(r0).populateMediaMetadata(this);
            }
            return this;
        }
        ...
        public Builder populateFromMetadata(List<Metadata> list) {
            for (int r1 = 0; r1 < list.size(); r1++) {
                Metadata metadata = list.get(r1);
                for (int r3 = 0; r3 < metadata.length(); r3++) {
                    metadata.get(r3).populateMediaMetadata(this);
                }
            }
            return this;
        }
