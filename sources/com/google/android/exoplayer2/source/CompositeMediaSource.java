...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    protected int getWindowIndexForChildWindowIndex(T t, int r2) {
        return r2;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: onChildSourceInfoRefreshed */
    public abstract void m1175x365769cd(T t, MediaSource mediaSource, Timeline timeline);
    ...
    public final void prepareChildSource(final T t, MediaSource mediaSource) {
        ...
        MediaSource.MediaSourceCaller mediaSourceCaller = new MediaSource.MediaSourceCaller() { // from class: com.google.android.exoplayer2.source.CompositeMediaSource$$ExternalSyntheticLambda0
            ...
            public final void onSourceInfoRefreshed(MediaSource mediaSource2, Timeline timeline) {
                CompositeMediaSource.this.m1175x365769cd(t, mediaSource2, timeline);
            }
        };
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener, DrmSessionEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int r4, MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            if (mediaPeriodId != null) {
                mediaPeriodId2 = CompositeMediaSource.this.getMediaPeriodIdForChildMediaPeriodId(this.f235id, mediaPeriodId);
            ...
            int windowIndexForChildWindowIndex = CompositeMediaSource.this.getWindowIndexForChildWindowIndex(this.f235id, r4);
        ...
        private MediaLoadData maybeUpdateMediaLoadData(MediaLoadData mediaLoadData) {
            long mediaTimeForChildMediaTime = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f235id, mediaLoadData.mediaStartTimeMs);
            long mediaTimeForChildMediaTime2 = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f235id, mediaLoadData.mediaEndTimeMs);
