...
public abstract class SegmentBase {
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public long getSegmentNum(long j, long j2) {
            ...
            while (j5 <= j4) {
                long j6 = ((j4 - j5) / 2) + j5;
                int r2 = (getSegmentTimeUs(j6) > j ? 1 : (getSegmentTimeUs(j6) == j ? 0 : -1));
                if (r2 < 0) {
                    j5 = j6 + 1;
                } else if (r2 <= 0) {
                    return j6;
    ...
    public static final class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            if (urlTemplate != null) {
                return new RangedUri(urlTemplate.buildUri(representation.format.f212id, 0L, representation.format.bitrate, 0L), 0L, -1L);
            }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            return new RangedUri(this.mediaTemplate.buildUri(representation.format.f212id, j, representation.format.bitrate, j2), 0L, -1L);
        }
