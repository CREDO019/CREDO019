...
public final class DashDownloader extends SegmentDownloader<DashManifest> {
    ...
    public List<SegmentDownloader.Segment> getSegments(DataSource dataSource, DashManifest dashManifest, boolean z) throws IOException, InterruptedException {
        ...
        for (int r12 = 0; r12 < dashManifest.getPeriodCount(); r12++) {
            Period period = dashManifest.getPeriod(r12);
            long msToUs = Util.msToUs(period.startMs);
            long periodDurationUs = dashManifest.getPeriodDurationUs(r12);
            int r8 = 0;
            for (List<AdaptationSet> list = period.adaptationSets; r8 < list.size(); list = list) {
                addSegmentsForAdaptationSet(dataSource, list.get(r8), msToUs, periodDurationUs, z, arrayList);
                r8++;
            }
        }
        return arrayList;
    ...
    */
    ...
    private DashSegmentIndex getSegmentIndex(final DataSource dataSource, final int r3, final Representation representation, boolean z) throws IOException, InterruptedException {
        ...
        ChunkIndex chunkIndex = (ChunkIndex) execute(new RunnableFutureTask<ChunkIndex, IOException>(this) { // from class: com.google.android.exoplayer2.source.dash.offline.DashDownloader.1
            ...
            public ChunkIndex doWork() throws IOException {
                return DashUtil.loadChunkIndex(dataSource, r3, representation);
            }
        }, z);
        if (chunkIndex == null) {
            return null;
