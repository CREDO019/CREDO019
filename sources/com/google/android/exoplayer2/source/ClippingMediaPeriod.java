...
public final class ClippingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public ClippingMediaPeriod(MediaPeriod mediaPeriod, boolean z, long j, long j2) {
        ...
        this.pendingInitialDiscontinuityPositionUs = z ? j : C1856C.TIME_UNSET;
        this.startUs = j;
        this.endUs = j2;
    }
    ...
    */
    ...
    public long readDiscontinuity() {
        if (isPendingInitialDiscontinuity()) {
            ...
            this.pendingInitialDiscontinuityPositionUs = C1856C.TIME_UNSET;
            long readDiscontinuity = readDiscontinuity();
            return readDiscontinuity != C1856C.TIME_UNSET ? readDiscontinuity : j;
        }
        long readDiscontinuity2 = this.mediaPeriod.readDiscontinuity();
        if (readDiscontinuity2 == C1856C.TIME_UNSET) {
    ...
    */
    ...
    boolean isPendingInitialDiscontinuity() {
        return this.pendingInitialDiscontinuityPositionUs != C1856C.TIME_UNSET;
    }
    ...
    private final class ClippingSampleStream implements SampleStream {
        ...
        @Override // com.google.android.exoplayer2.source.SampleStream
        public int readData(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, int r13) {
            ...
            int readData = this.childStream.readData(formatHolder, decoderInputBuffer, r13);
            if (readData == -5) {
