...
public final class ProgressiveMediaSource extends BaseMediaSource implements ProgressiveMediaPeriod.Listener {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory(DataSource.Factory factory, ProgressiveMediaExtractor.Factory factory2, DrmSessionManagerProvider drmSessionManagerProvider, LoadErrorHandlingPolicy loadErrorHandlingPolicy, int r5) {
            this.dataSourceFactory = factory;
            this.progressiveMediaExtractorFactory = factory2;
            this.drmSessionManagerProvider = drmSessionManagerProvider;
            this.loadErrorHandlingPolicy = loadErrorHandlingPolicy;
            this.continueLoadingCheckIntervalBytes = r5;
        }
        ...
        public Factory setContinueLoadingCheckIntervalBytes(int r1) {
            this.continueLoadingCheckIntervalBytes = r1;
            return this;
        }
    ...
    private ProgressiveMediaSource(MediaItem mediaItem, DataSource.Factory factory, ProgressiveMediaExtractor.Factory factory2, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, int r7) {
        ...
        this.continueLoadingCheckIntervalBytes = r7;
        this.timelineIsPlaceholder = true;
        this.timelineDurationUs = C1856C.TIME_UNSET;
    }
    ...
    private void notifySourceInfoRefreshed() {
        ...
        if (this.timelineIsPlaceholder) {
            singlePeriodTimeline = new ForwardingTimeline(this, singlePeriodTimeline) { // from class: com.google.android.exoplayer2.source.ProgressiveMediaSource.1
                ...
                public Timeline.Window getWindow(int r1, Timeline.Window window, long j) {
                    super.getWindow(r1, window, j);
                    window.isPlaceholder = true;
                    return window;
                }

                @Override // com.google.android.exoplayer2.source.ForwardingTimeline, com.google.android.exoplayer2.Timeline
                public Timeline.Period getPeriod(int r1, Timeline.Period period, boolean z) {
                    super.getPeriod(r1, period, z);
