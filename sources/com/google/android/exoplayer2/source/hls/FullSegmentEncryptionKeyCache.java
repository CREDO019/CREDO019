...
final class FullSegmentEncryptionKeyCache {
    ...
    public FullSegmentEncryptionKeyCache(final int r8) {
        this.backingMap = new LinkedHashMap<Uri, byte[]>(this, r8 + 1, 1.0f, false) { // from class: com.google.android.exoplayer2.source.hls.FullSegmentEncryptionKeyCache.1
