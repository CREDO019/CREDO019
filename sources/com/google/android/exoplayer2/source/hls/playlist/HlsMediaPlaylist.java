...
public final class HlsMediaPlaylist extends HlsPlaylist {
    ...
    public static final class Segment extends SegmentBase {
        ...
        public Segment(String str, long j, long j2, String str2, String str3) {
            this(str, null, "", 0L, -1, C1856C.TIME_UNSET, null, str2, str3, j, j2, false, ImmutableList.m409of());
        }

        public Segment(String str, Segment segment, String str2, long j, int r23, long j2, DrmInitData drmInitData, String str3, String str4, long j3, long j4, boolean z, List<Part> list) {
            super(str, segment, j, r23, j2, drmInitData, str3, str4, j3, j4, z);
            this.title = str2;
            this.parts = ImmutableList.copyOf((Collection) list);
        }

        public Segment copyWith(long j, int r23) {
            ArrayList arrayList = new ArrayList();
            long j2 = j;
            for (int r1 = 0; r1 < this.parts.size(); r1++) {
                Part part = this.parts.get(r1);
                arrayList.add(part.copyWith(j2, r23));
                j2 += part.durationUs;
            }
            return new Segment(this.url, this.initializationSegment, this.title, this.durationUs, r23, j, this.drmInitData, this.fullSegmentEncryptionKeyUri, this.encryptionIV, this.byteRangeOffset, this.byteRangeLength, this.hasGapTag, arrayList);
        }
    }
    ...
    public static final class Part extends SegmentBase {
        ...
        public Part(String str, Segment segment, long j, int r22, long j2, DrmInitData drmInitData, String str2, String str3, long j3, long j4, boolean z, boolean z2, boolean z3) {
            super(str, segment, j, r22, j2, drmInitData, str2, str3, j3, j4, z);
            this.isIndependent = z2;
            this.isPreload = z3;
        }

        public Part copyWith(long j, int r23) {
            return new Part(this.url, this.initializationSegment, this.durationUs, r23, j, this.drmInitData, this.fullSegmentEncryptionKeyUri, this.encryptionIV, this.byteRangeOffset, this.byteRangeLength, this.hasGapTag, this.isIndependent, this.isPreload);
        }
    }
    ...
    public static class SegmentBase implements Comparable<Long> {
        ...
        private SegmentBase(String str, Segment segment, long j, int r5, long j2, DrmInitData drmInitData, String str2, String str3, long j3, long j4, boolean z) {
            this.url = str;
            this.initializationSegment = segment;
            this.durationUs = j;
            this.relativeDiscontinuitySequence = r5;
    ...
    public static final class RenditionReport {
        ...
        public RenditionReport(Uri uri, long j, int r4) {
            this.playlistUri = uri;
            this.lastMediaSequence = j;
            this.lastPartIndex = r4;
        }
    }

    public HlsMediaPlaylist(int r11, String str, List<String> list, long j, boolean z, long j2, boolean z2, int r20, long j3, int r23, long j4, long j5, boolean z3, boolean z4, boolean z5, DrmInitData drmInitData, List<Segment> list2, List<Part> list3, ServerControl serverControl, Map<Uri, RenditionReport> map) {
        super(str, list, z3);
        this.playlistType = r11;
        this.startTimeUs = j2;
        this.preciseStart = z;
        this.hasDiscontinuitySequence = z2;
        this.discontinuitySequence = r20;
    ...
    public HlsMediaPlaylist copyWith(long j, int r31) {
        return new HlsMediaPlaylist(this.playlistType, this.baseUri, this.tags, this.startOffsetUs, this.preciseStart, j, true, r31, this.mediaSequence, this.version, this.targetDurationUs, this.partTargetDurationUs, this.hasIndependentSegments, this.hasEndTag, this.hasProgramDateTime, this.protectionSchemes, this.segments, this.trailingParts, this.serverControl, this.renditionReports);
    }
