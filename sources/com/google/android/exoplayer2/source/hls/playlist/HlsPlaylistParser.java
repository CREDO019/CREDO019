...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    private static boolean checkPlaylistHeader(BufferedReader bufferedReader) throws IOException {
        ...
        for (int r3 = 0; r3 < 7; r3++) {
            if (skipIgnorableWhitespace != PLAYLIST_HEADER.charAt(r3)) {
                return false;
            }
    ...
    private static int skipIgnorableWhitespace(BufferedReader bufferedReader, boolean z, int r3) throws IOException {
        while (r3 != -1 && Character.isWhitespace(r3) && (z || !Util.isLinebreak(r3))) {
            ...
            if (hasNext) {
                ...
                if (next.startsWith(TAG_DEFINE)) {
                    ...
                    if (next.equals(TAG_INDEPENDENT_SEGMENTS)) {
                        ...
                        arrayList11.add(new HlsMultivariantPlaylist.Variant(resolveToUri, new Format.Builder().setId(arrayList11.size()).setContainerMimeType(MimeTypes.APPLICATION_M3U8).setCodecs(parseOptionalStringAttr).setAverageBitrate(parseOptionalIntAttr).setPeakBitrate(parseIntAttr).setWidth(r6).setHeight(r8).setFrameRate(f).setRoleFlags(r10).build(), parseOptionalStringAttr4, parseOptionalStringAttr5, parseOptionalStringAttr6, parseOptionalStringAttr7));
                        hashMap = hashMap4;
                ...
                for (int r4 = 0; r4 < arrayList11.size(); r4++) {
                    HlsMultivariantPlaylist.Variant variant = (HlsMultivariantPlaylist.Variant) arrayList11.get(r4);
                ...
                Format format2 = null;
                int r0 = 0;
                while (r0 < arrayList20.size()) {
                    ArrayList arrayList29 = arrayList20;
                    String str7 = (String) arrayList29.get(r0);
                    ...
                    switch (c) {
                        case 0:
                            ...
                            if (resolveToUri2 != null) {
                                ...
                                arrayList3 = arrayList23;
                                Log.m1132w(LOG_TAG, "EXT-X-MEDIA tag with missing mandatory URI attribute: skipping");
                                break;
                            }
                        case 1:
                            format = format2;
    ...
    private static HlsMultivariantPlaylist.Variant getVariantWithAudioGroup(ArrayList<HlsMultivariantPlaylist.Variant> arrayList, String str) {
        for (int r0 = 0; r0 < arrayList.size(); r0++) {
            HlsMultivariantPlaylist.Variant variant = arrayList.get(r0);
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMultivariantPlaylist hlsMultivariantPlaylist, HlsMediaPlaylist hlsMediaPlaylist, LineIterator lineIterator, String str) throws IOException {
        ...
        HlsMediaPlaylist.ServerControl serverControl = new HlsMediaPlaylist.ServerControl(C1856C.TIME_UNSET, false, C1856C.TIME_UNSET, C1856C.TIME_UNSET, false);
        ...
        long j14 = 0;
        int r2 = 0;
        long j15 = C1856C.TIME_UNSET;
        boolean z4 = false;
        boolean z5 = false;
        int r27 = 0;
        int r30 = 1;
        long j16 = C1856C.TIME_UNSET;
        long j17 = C1856C.TIME_UNSET;
        boolean z6 = false;
                ...
                if (next.startsWith(TAG_START)) {
                    ...
                    if (next.startsWith(TAG_SERVER_CONTROL)) {
                        ...
                        if (next.startsWith(TAG_TARGET_DURATION)) {
                            ...
                            r30 = parseIntAttr(next, REGEX_VERSION);
                        } else {
                            if (next.startsWith(TAG_DEFINE)) {
                                ...
                                int r14 = (int) (j8 - ((HlsMediaPlaylist) Util.castNonNull(hlsMediaPlaylist)).mediaSequence);
                                int r122 = parseIntAttr + r14;
                                if (r14 < 0 || r122 > hlsMediaPlaylist2.segments.size()) {
                                ...
                                long j19 = j11;
                                while (r14 < r122) {
                                    HlsMediaPlaylist.Segment segment2 = hlsMediaPlaylist2.segments.get(r14);
                                    int r42 = r122;
                                    String str16 = str15;
                                    if (j8 != hlsMediaPlaylist2.mediaSequence) {
                                        segment2 = segment2.copyWith(j19, (hlsMediaPlaylist2.discontinuitySequence - r27) + segment2.relativeDiscontinuitySequence);
                                    }
                                    ...
                                    int r0 = segment2.relativeDiscontinuitySequence;
                                ...
                                if (next.startsWith(TAG_KEY)) {
                                    ...
                                    if (next.startsWith(TAG_BYTERANGE)) {
                                        ...
                                        if (next.startsWith(TAG_DISCONTINUITY_SEQUENCE)) {
                                            r27 = Integer.parseInt(next.substring(next.indexOf(58) + 1));
                                            hlsMultivariantPlaylist2 = hlsMultivariantPlaylist;
                                            hlsMediaPlaylist2 = hlsMediaPlaylist;
                                            str9 = str3;
                                            str8 = str13;
                                                ...
                                                if (next.startsWith(TAG_RENDITION_REPORT)) {
                                                    ...
                                                    if (next.startsWith(TAG_PRELOAD_HINT)) {
                                                        if (part2 == null && TYPE_PART.equals(parseStringAttr(next, REGEX_PRELOAD_HINT_TYPE, hashMap3))) {
                                                            ...
                                                            int r22 = (parseOptionalLongAttr > (-1L) ? 1 : (parseOptionalLongAttr == (-1L) ? 0 : -1));
                                                            if (r22 == 0 || parseOptionalLongAttr2 != -1) {
                                                                part2 = new HlsMediaPlaylist.Part(parseStringAttr4, segment, 0L, r80, j10, drmInitData3, str12, segmentEncryptionIV, r22 != 0 ? parseOptionalLongAttr : 0L, parseOptionalLongAttr2, false, false, true);
                                                            }
                                                            hlsMultivariantPlaylist2 = hlsMultivariantPlaylist;
                                                            hlsMediaPlaylist2 = hlsMediaPlaylist;
                                                            str9 = str3;
                                                        ...
                                                        if (next.startsWith(TAG_PART)) {
                                                            ...
                                                            arrayList10.add(new HlsMediaPlaylist.Part(parseStringAttr5, segment, parseDoubleAttr, r80, j10, drmInitData3, str12, segmentEncryptionIV2, j14, j6, parseOptionalBooleanAttribute2, parseOptionalBooleanAttribute, false));
                                                            j10 += parseDoubleAttr;
                                                            if (r8 != 0) {
                                                                j14 += j6;
                                                            }
                                                            ...
                                                            if (next.startsWith("#")) {
                                                                ...
                                                                arrayList5.add(new HlsMediaPlaylist.Segment(replaceVariableReferences, segment != null ? segment : segment4, str6, j13, r80, j11, drmInitData, str12, segmentEncryptionIV3, j4, j18, z7, arrayList10));
                                                                j10 = j11 + j13;
        ...
        for (int r1 = 0; r1 < arrayList14.size(); r1++) {
            HlsMediaPlaylist.RenditionReport renditionReport = (HlsMediaPlaylist.RenditionReport) arrayList14.get(r1);
            long j23 = renditionReport.lastMediaSequence;
            if (j23 == -1) {
                j23 = (j8 + arrayList16.size()) - (arrayList10.isEmpty() ? 1L : 0L);
            }
            int r11 = renditionReport.lastPartIndex;
            if (r11 == -1 && j17 != C1856C.TIME_UNSET) {
                r11 = (arrayList10.isEmpty() ? ((HlsMediaPlaylist.Segment) Iterables.getLast(arrayList16)).parts : arrayList10).size() - 1;
            }
            hashMap5.put(renditionReport.playlistUri, new HlsMediaPlaylist.RenditionReport(renditionReport.playlistUri, j23, r11));
        }
        if (part4 != null) {
            arrayList10.add(part4);
        }
        return new HlsMediaPlaylist(r782, str, arrayList15, j15, z4, j7, z5, r27, j8, r30, j16, j17, z3, z6, j7 != 0, drmInitData2, arrayList16, arrayList10, serverControl2, hashMap5);
    }

    private static DrmInitData getPlaylistProtectionSchemes(String str, DrmInitData.SchemeData[] schemeDataArr) {
        DrmInitData.SchemeData[] schemeDataArr2 = new DrmInitData.SchemeData[schemeDataArr.length];
        for (int r1 = 0; r1 < schemeDataArr.length; r1++) {
            schemeDataArr2[r1] = schemeDataArr[r1].copyWithData(null);
        }
    ...
    private static int parseRoleFlags(String str, Map<String, String> map) {
        ...
        String[] split = Util.split(parseOptionalStringAttr, ",");
        int r0 = Util.contains(split, "public.accessibility.describes-video") ? 512 : 0;
        ...
        return Util.contains(split, "public.easy-to-read") ? r0 | 8192 : r0;
    }
    ...
    private static DrmInitData.SchemeData parseDrmSchemeData(String str, String str2, Map<String, String> map) throws ParserException {
        ...
        if (KEYFORMAT_WIDEVINE_PSSH_BINARY.equals(str2)) {
            ...
            return new DrmInitData.SchemeData(C1856C.WIDEVINE_UUID, MimeTypes.VIDEO_MP4, Base64.decode(parseStringAttr.substring(parseStringAttr.indexOf(44)), 0));
        } else if (KEYFORMAT_WIDEVINE_PSSH_JSON.equals(str2)) {
            return new DrmInitData.SchemeData(C1856C.WIDEVINE_UUID, "hls", Util.getUtf8Bytes(str));
        } else {
            if (KEYFORMAT_PLAYREADY.equals(str2) && IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(parseOptionalStringAttr)) {
                ...
                return new DrmInitData.SchemeData(C1856C.PLAYREADY_UUID, MimeTypes.VIDEO_MP4, PsshAtomUtil.buildPsshAtom(C1856C.PLAYREADY_UUID, Base64.decode(parseStringAttr2.substring(parseStringAttr2.indexOf(44)), 0)));
            }
            return null;
        }
    }
    ...
    private static String parseEncryptionScheme(String str) {
        return (METHOD_SAMPLE_AES_CENC.equals(str) || METHOD_SAMPLE_AES_CTR.equals(str)) ? C1856C.CENC_TYPE_cenc : C1856C.CENC_TYPE_cbcs;
    }
    ...
    private static int parseOptionalIntAttr(String str, Pattern pattern, int r2) {
        Matcher matcher = pattern.matcher(str);
        return matcher.find() ? Integer.parseInt((String) Assertions.checkNotNull(matcher.group(1))) : r2;
    }
