...
public final class HlsMediaChunk extends MediaChunk {
    ...
    public static HlsMediaChunk createInstance(HlsExtractorFactory hlsExtractorFactory, DataSource dataSource, Format format, long j, HlsMediaPlaylist hlsMediaPlaylist, HlsChunkSource.SegmentBaseHolder segmentBaseHolder, Uri uri, List<Format> list, int r50, Object obj, boolean z, TimestampAdjusterProvider timestampAdjusterProvider, HlsMediaChunk hlsMediaChunk, byte[] bArr, byte[] bArr2, boolean z2, PlayerId playerId) {
        ...
        int r1 = hlsMediaPlaylist.discontinuitySequence + segmentBase.relativeDiscontinuitySequence;
        if (hlsMediaChunk != null) {
            ...
            hlsMediaChunkExtractor = (z7 && z8 && !hlsMediaChunk.extractorInvalidated && hlsMediaChunk.discontinuitySequenceNumber == r1) ? hlsMediaChunk.extractor : null;
        } else {
            id3Decoder = new Id3Decoder();
            parsableByteArray = new ParsableByteArray(10);
            hlsMediaChunkExtractor = null;
        }
        return new HlsMediaChunk(hlsExtractorFactory, buildDataSource, build, format, z3, dataSource2, dataSpec, z4, uri, list, r50, obj, j2, j3, segmentBaseHolder.mediaSequence, segmentBaseHolder.partIndex, !segmentBaseHolder.isPreload, r1, segmentBase.hasGapTag, z, timestampAdjusterProvider.getAdjuster(r1), segmentBase.drmInitData, hlsMediaChunkExtractor, id3Decoder, parsableByteArray, z2, playerId);
    }
    ...
    private HlsMediaChunk(HlsExtractorFactory hlsExtractorFactory, DataSource dataSource, DataSpec dataSpec, Format format, boolean z, DataSource dataSource2, DataSpec dataSpec2, boolean z2, Uri uri, List<Format> list, int r25, Object obj, long j, long j2, long j3, int r33, boolean z3, int r35, boolean z4, boolean z5, TimestampAdjuster timestampAdjuster, DrmInitData drmInitData, HlsMediaChunkExtractor hlsMediaChunkExtractor, Id3Decoder id3Decoder, ParsableByteArray parsableByteArray, boolean z6, PlayerId playerId) {
        super(dataSource, dataSpec, format, r25, obj, j, j2, j3);
        this.mediaSegmentEncrypted = z;
        this.partIndex = r33;
        this.isPublished = z3;
        this.discontinuitySequenceNumber = r35;
        ...
        this.sampleQueueFirstSampleIndices = ImmutableList.m409of();
    ...
    public int getFirstSampleIndex(int r2) {
        Assertions.checkState(!this.shouldSpliceIn);
        if (r2 >= this.sampleQueueFirstSampleIndices.size()) {
            return 0;
        }
        return this.sampleQueueFirstSampleIndices.get(r2).intValue();
    }
    ...
    private DefaultExtractorInput prepareExtraction(DataSource dataSource, DataSpec dataSpec, boolean z) throws IOException {
        ...
        if (this.extractor == null) {
            ...
            if (createExtractor.isPackedAudioExtractor()) {
                ...
                if (peekId3PrivTimestamp != C1856C.TIME_UNSET) {
    ...
    private long peekId3PrivTimestamp(ExtractorInput extractorInput) throws IOException {
        ...
        if (r5 > this.scratchId3Data.capacity()) {
            byte[] data = this.scratchId3Data.getData();
            this.scratchId3Data.reset(r5);
        ...
        for (int r3 = 0; r3 < length; r3++) {
            Metadata.Entry entry = decode.get(r3);
