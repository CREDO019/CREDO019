...
public final class MediaParserHlsMediaChunkExtractor implements HlsMediaChunkExtractor {
    ...
    public static /* synthetic */ HlsMediaChunkExtractor lambda$static$0(Uri uri, Format format, List list, TimestampAdjuster timestampAdjuster, Map map, ExtractorInput extractorInput, PlayerId playerId) throws IOException {
        ...
        if (list != null) {
            for (int r8 = 0; r8 < list.size(); r8++) {
                builder.add((ImmutableList.Builder) MediaParserUtil.toCaptionsMediaFormat((Format) list.get(r8)));
            }
        } else {
    ...
    public MediaParserHlsMediaChunkExtractor(MediaParser mediaParser, OutputConsumerAdapterV30 outputConsumerAdapterV30, Format format, boolean z, ImmutableList<MediaFormat> immutableList, int r6, PlayerId playerId) {
    ...
    public static final class PeekingInputReader implements MediaParser.SeekableInputReader {
        ...
        public int read(byte[] bArr, int r3, int r4) throws IOException {
            int peek = this.extractorInput.peek(bArr, r3, r4);
