...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory setMetadataType(int r1) {
            this.metadataType = r1;
            return this;
        }
    ...
    private HlsMediaSource(MediaItem mediaItem, HlsDataSourceFactory hlsDataSourceFactory, HlsExtractorFactory hlsExtractorFactory, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, HlsPlaylistTracker hlsPlaylistTracker, long j, boolean z, int r12, boolean z2) {
    ...
    private SinglePeriodTimeline createTimelineForLive(HlsMediaPlaylist hlsMediaPlaylist, long j, long j2, HlsManifest hlsManifest) {
        ...
        if (this.liveConfiguration.targetOffsetMs != C1856C.TIME_UNSET) {
        ...
        return new SinglePeriodTimeline(j, j2, C1856C.TIME_UNSET, j3, hlsMediaPlaylist.durationUs, initialStartTimeUs, getLiveWindowDefaultStartPositionUs(hlsMediaPlaylist, liveEdgeOffsetUs), true, !hlsMediaPlaylist.hasEndTag, hlsMediaPlaylist.playlistType == 2 && hlsMediaPlaylist.hasPositiveStartOffset, hlsManifest, this.mediaItem, this.liveConfiguration);
    }
    ...
    private SinglePeriodTimeline createTimelineForOnDemand(HlsMediaPlaylist hlsMediaPlaylist, long j, long j2, HlsManifest hlsManifest) {
        long j3;
        if (hlsMediaPlaylist.startOffsetUs == C1856C.TIME_UNSET || hlsMediaPlaylist.segments.isEmpty()) {
            j3 = 0;
        ...
        return new SinglePeriodTimeline(j, j2, C1856C.TIME_UNSET, hlsMediaPlaylist.durationUs, hlsMediaPlaylist.durationUs, 0L, j3, true, false, true, hlsManifest, this.mediaItem, null);
    }
    ...
    private long getLiveWindowDefaultStartPositionUs(HlsMediaPlaylist hlsMediaPlaylist, long j) {
        long msToUs;
        if (hlsMediaPlaylist.startOffsetUs != C1856C.TIME_UNSET) {
    ...
    private void updateLiveConfiguration(HlsMediaPlaylist hlsMediaPlaylist, long j) {
        boolean z = this.mediaItem.liveConfiguration.minPlaybackSpeed == -3.4028235E38f && this.mediaItem.liveConfiguration.maxPlaybackSpeed == -3.4028235E38f && hlsMediaPlaylist.serverControl.holdBackUs == C1856C.TIME_UNSET && hlsMediaPlaylist.serverControl.partHoldBackUs == C1856C.TIME_UNSET;
    ...
    private static long getTargetLiveOffsetUs(HlsMediaPlaylist hlsMediaPlaylist, long j) {
        ...
        } else if (serverControl.partHoldBackUs != C1856C.TIME_UNSET && hlsMediaPlaylist.partTargetDurationUs != C1856C.TIME_UNSET) {
            j2 = serverControl.partHoldBackUs;
        } else if (serverControl.holdBackUs != C1856C.TIME_UNSET) {
    ...
    private static HlsMediaPlaylist.Part findClosestPrecedingIndependentPart(List<HlsMediaPlaylist.Part> list, long j) {
        ...
        for (int r1 = 0; r1 < list.size(); r1++) {
            HlsMediaPlaylist.Part part2 = list.get(r1);
