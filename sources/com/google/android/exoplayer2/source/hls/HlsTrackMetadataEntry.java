...
public final class HlsTrackMetadataEntry implements Metadata.Entry {
    public static final Parcelable.Creator<HlsTrackMetadataEntry> CREATOR = new Parcelable.Creator<HlsTrackMetadataEntry>() { // from class: com.google.android.exoplayer2.source.hls.HlsTrackMetadataEntry.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public HlsTrackMetadataEntry[] newArray(int r1) {
            return new HlsTrackMetadataEntry[r1];
        }
    };
    ...
    public static final class VariantInfo implements Parcelable {
        public static final Parcelable.Creator<VariantInfo> CREATOR = new Parcelable.Creator<VariantInfo>() { // from class: com.google.android.exoplayer2.source.hls.HlsTrackMetadataEntry.VariantInfo.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public VariantInfo[] newArray(int r1) {
                return new VariantInfo[r1];
            }
        };
        ...
        public VariantInfo(int r1, int r2, String str, String str2, String str3, String str4) {
        ...
        public int hashCode() {
            int r0 = ((this.averageBitrate * 31) + this.peakBitrate) * 31;
    ...
    public void writeToParcel(Parcel parcel, int r5) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            parcel.writeParcelable(this.variantInfos.get(r1), 0);
        }
    }
}
