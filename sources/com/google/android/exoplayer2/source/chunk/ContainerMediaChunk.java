...
public class ContainerMediaChunk extends BaseMediaChunk {
    ...
    public ContainerMediaChunk(DataSource dataSource, DataSpec dataSpec, Format format, int r7, Object obj, long j, long j2, long j3, long j4, long j5, int r19, long j6, ChunkExtractor chunkExtractor) {
        super(dataSource, dataSpec, format, r7, obj, j, j2, j3, j4, j5);
        this.chunkCount = r19;
    ...
    public final void load() throws IOException {
        if (this.nextLoadPosition == 0) {
            ...
            long j3 = j == C1856C.TIME_UNSET ? -9223372036854775807L : this.clippedStartTimeUs - this.sampleOffsetUs;
            if (this.clippedEndTimeUs != C1856C.TIME_UNSET) {
