...
public final class SilenceMediaSource extends BaseMediaSource {
    ...
    private static final class SilenceMediaPeriod implements MediaPeriod {
        ...
        public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
            ...
            for (int r0 = 0; r0 < exoTrackSelectionArr.length; r0++) {
                ...
                if (sampleStreamArr[r0] == null && exoTrackSelectionArr[r0] != null) {
                    ...
                    sampleStreamArr[r0] = silenceSampleStream;
                    zArr2[r0] = true;
                }
            }
        ...
        public long seekToUs(long j) {
            ...
            for (int r0 = 0; r0 < this.sampleStreams.size(); r0++) {
                ((SilenceSampleStream) this.sampleStreams.get(r0)).seekTo(constrainSeekPosition);
            }
            return constrainSeekPosition;
        }
    ...
    private static final class SilenceSampleStream implements SampleStream {
        ...
        @Override // com.google.android.exoplayer2.source.SampleStream
        public int readData(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, int r11) {
            if (!this.sentFormat || (r11 & 2) != 0) {
