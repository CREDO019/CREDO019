    ...
    */
    public void onChildSourceInfoRefreshed(java.lang.Void r13, com.google.android.exoplayer2.source.MediaSource r14, com.google.android.exoplayer2.Timeline r15) {
        ...
        L36:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r5 = r5.f236id
        ...
        L98:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r14 = r13.f236id
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r13 = r13.f236id
    ...
    private void setPreparePositionOverrideToUnpreparedMaskingPeriod(long j) {
        ...
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f236id.periodUid);
        if (indexOfPeriod == -1) {
            return;
        }
    ...
    public static final class MaskingTimeline extends ForwardingTimeline {
        ...
        public Timeline.Window getWindow(int r2, Timeline.Window window, long j) {
            this.timeline.getWindow(r2, window, j);
        ...
        public Timeline.Period getPeriod(int r2, Timeline.Period period, boolean z) {
            this.timeline.getPeriod(r2, period, z);
        ...
        public Object getUidOfPeriod(int r2) {
            Object uidOfPeriod = this.timeline.getUidOfPeriod(r2);
    ...
    public static final class PlaceholderTimeline extends Timeline {
        ...
        @Override // com.google.android.exoplayer2.Timeline
        public Timeline.Window getWindow(int r22, Timeline.Window window, long j) {
            window.set(Timeline.Window.SINGLE_WINDOW_UID, this.mediaItem, null, C1856C.TIME_UNSET, C1856C.TIME_UNSET, C1856C.TIME_UNSET, false, true, null, 0L, C1856C.TIME_UNSET, 0, 0, 0L);
        ...
        public Timeline.Period getPeriod(int r12, Timeline.Period period, boolean z) {
            period.set(z ? 0 : null, z ? MaskingTimeline.MASKING_EXTERNAL_PERIOD_UID : null, 0, C1856C.TIME_UNSET, 0L, AdPlaybackState.NONE, true);
            return period;
        }
