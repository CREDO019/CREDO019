...
public interface AdsLoader {
    ...
    void handlePrepareComplete(AdsMediaSource adsMediaSource, int r2, int r3);

    void handlePrepareError(AdsMediaSource adsMediaSource, int r2, int r3, IOException iOException);
