...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public static final class AdLoadException extends IOException {
        ...
        public static AdLoadException createForAdGroup(Exception exc, int r5) {
            return new AdLoadException(1, new IOException("Failed to load ad group " + r5, exc));
        }
        ...
        private AdLoadException(int r1, Exception exc) {
            super(exc);
            this.type = r1;
        }
    ...
    public void prepareSourceInternal(TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$$ExternalSyntheticLambda0
            ...
            public final void run() {
                AdsMediaSource.this.m1164x4dfad2b6(componentListener);
            }
        });
    }
    ...
    public /* synthetic */ void m1164x4dfad2b6(ComponentListener componentListener) {
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        if (((AdPlaybackState) Assertions.checkNotNull(this.adPlaybackState)).adGroupCount > 0 && mediaPeriodId.isAd()) {
            int r0 = mediaPeriodId.adGroupIndex;
            int r1 = mediaPeriodId.adIndexInAdGroup;
            AdMediaSourceHolder[][] adMediaSourceHolderArr = this.adMediaSourceHolders;
            if (adMediaSourceHolderArr[r0].length <= r1) {
                adMediaSourceHolderArr[r0] = (AdMediaSourceHolder[]) Arrays.copyOf(adMediaSourceHolderArr[r0], r1 + 1);
            }
            AdMediaSourceHolder adMediaSourceHolder = this.adMediaSourceHolders[r0][r1];
            if (adMediaSourceHolder == null) {
                adMediaSourceHolder = new AdMediaSourceHolder(mediaPeriodId);
                this.adMediaSourceHolders[r0][r1] = adMediaSourceHolder;
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f236id;
    ...
    public void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                AdsMediaSource.this.m1163x85e6f6b7(componentListener);
            }
        });
    }
    ...
    public /* synthetic */ void m1163x85e6f6b7(ComponentListener componentListener) {
    ...
    private void maybeUpdateAdMediaSources() {
        ...
        for (int r2 = 0; r2 < this.adMediaSourceHolders.length; r2++) {
            int r3 = 0;
            while (true) {
                AdMediaSourceHolder[][] adMediaSourceHolderArr = this.adMediaSourceHolders;
                if (r3 < adMediaSourceHolderArr[r2].length) {
                    AdMediaSourceHolder adMediaSourceHolder = adMediaSourceHolderArr[r2][r3];
                    AdPlaybackState.AdGroup adGroup = adPlaybackState.getAdGroup(r2);
                    if (adMediaSourceHolder != null && !adMediaSourceHolder.hasMediaSource() && r3 < adGroup.uris.length && (uri = adGroup.uris[r3]) != null) {
    ...
    private long[][] getAdDurationsUs() {
        ...
        while (true) {
            AdMediaSourceHolder[][] adMediaSourceHolderArr = this.adMediaSourceHolders;
            if (r2 >= adMediaSourceHolderArr.length) {
                return jArr;
            }
            jArr[r2] = new long[adMediaSourceHolderArr[r2].length];
            int r3 = 0;
            while (true) {
                AdMediaSourceHolder[][] adMediaSourceHolderArr2 = this.adMediaSourceHolders;
                if (r3 < adMediaSourceHolderArr2[r2].length) {
                    AdMediaSourceHolder adMediaSourceHolder = adMediaSourceHolderArr2[r2][r3];
                    jArr[r2][r3] = adMediaSourceHolder == null ? C1856C.TIME_UNSET : adMediaSourceHolder.getDurationUs();
                    r3++;
                }
            }
            r2++;
    ...
    public final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$ComponentListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.ComponentListener.this.m1160x9c1f3358(adPlaybackState);
                }
            });
        }
        ...
        public /* synthetic */ void m1160x9c1f3358(AdPlaybackState adPlaybackState) {
            if (this.stopped) {
                return;
            }
    ...
    public final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.AdPrepareListener.this.m1162x605e06cc(mediaPeriodId);
                }
            });
        }
        ...
        public /* synthetic */ void m1162x605e06cc(MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.AdPrepareListener.this.m1161x1f837766(mediaPeriodId, iOException);
                }
            });
        }
        ...
        public /* synthetic */ void m1161x1f837766(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
    ...
    public final class AdMediaSourceHolder {
        ...
        /* renamed from: id */
        private final MediaSource.MediaPeriodId f239id;
        private Timeline timeline;

        public AdMediaSourceHolder(MediaSource.MediaPeriodId mediaPeriodId) {
            this.f239id = mediaPeriodId;
        }

        public void initializeWithMediaSource(MediaSource mediaSource, Uri uri) {
            this.adMediaSource = mediaSource;
            this.adUri = uri;
            for (int r0 = 0; r0 < this.activeMediaPeriods.size(); r0++) {
                MaskingMediaPeriod maskingMediaPeriod = this.activeMediaPeriods.get(r0);
                maskingMediaPeriod.setMediaSource(mediaSource);
                maskingMediaPeriod.setPrepareListener(new AdPrepareListener(uri));
            }
            AdsMediaSource.this.prepareChildSource(this.f239id, mediaSource);
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline) {
            ...
            if (this.timeline == null) {
                ...
                for (int r1 = 0; r1 < this.activeMediaPeriods.size(); r1++) {
                    MaskingMediaPeriod maskingMediaPeriod = this.activeMediaPeriods.get(r1);
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f236id.windowSequenceNumber));
                }
            }
        ...
        public long getDurationUs() {
            Timeline timeline = this.timeline;
            return timeline == null ? C1856C.TIME_UNSET : timeline.getPeriod(0, AdsMediaSource.this.period).getDurationUs();
        }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f239id);
            }
        }
