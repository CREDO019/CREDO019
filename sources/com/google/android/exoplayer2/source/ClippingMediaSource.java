...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    public static final class IllegalClippingException extends IOException {
        ...
        private static String getReasonDescription(int r1) {
            return r1 != 0 ? r1 != 1 ? r1 != 2 ? EnvironmentCompat.MEDIA_UNKNOWN : "start exceeds end" : "not seekable to start" : "invalid period count";
        }

        public IllegalClippingException(int r3) {
            super("Illegal clipping: " + getReasonDescription(r3));
            this.reason = r3;
        }
    }
    ...
    private void refreshClippedTimeline(Timeline timeline) {
        ...
        if (this.clippingTimeline == null || this.mediaPeriods.isEmpty() || this.allowDynamicClippingUpdates) {
            ...
            for (int r3 = 0; r3 < size; r3++) {
                this.mediaPeriods.get(r3).updateClipping(this.periodStartUs, this.periodEndUs);
            }
            j = j3;
            j2 = j4;
        } else {
        ...
        try {
            ...
            for (int r2 = 0; r2 < this.mediaPeriods.size(); r2++) {
                this.mediaPeriods.get(r2).setClippingError(this.clippingError);
            }
        }
    }
    ...
    public static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public ClippingTimeline(Timeline timeline, long j, long j2) throws IllegalClippingException {
            ...
            if (window.durationUs != C1856C.TIME_UNSET) {
            ...
            this.startUs = max;
            this.endUs = max2;
            int r0 = (max2 > C1856C.TIME_UNSET ? 1 : (max2 == C1856C.TIME_UNSET ? 0 : -1));
            this.durationUs = r0 == 0 ? -9223372036854775807L : max2 - max;
            if (window.isDynamic && (r0 == 0 || (window.durationUs != C1856C.TIME_UNSET && max2 == window.durationUs))) {
                z = true;
            }
            this.isDynamic = z;
        }
        ...
        public Timeline.Window getWindow(int r5, Timeline.Window window, long j) {
            this.timeline.getWindow(0, window, 0L);
            window.positionInFirstPeriodUs += this.startUs;
            window.durationUs = this.durationUs;
            window.isDynamic = this.isDynamic;
            if (window.defaultPositionUs != C1856C.TIME_UNSET) {
                window.defaultPositionUs = Math.max(window.defaultPositionUs, this.startUs);
                int r52 = (this.endUs > C1856C.TIME_UNSET ? 1 : (this.endUs == C1856C.TIME_UNSET ? 0 : -1));
            ...
            if (window.presentationStartTimeMs != C1856C.TIME_UNSET) {
                window.presentationStartTimeMs += usToMs;
            }
            if (window.windowStartTimeMs != C1856C.TIME_UNSET) {
        ...
        public Timeline.Period getPeriod(int r13, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f218id, period.uid, 0, j == C1856C.TIME_UNSET ? -9223372036854775807L : j - positionInWindowUs, positionInWindowUs);
        }
    }
}
