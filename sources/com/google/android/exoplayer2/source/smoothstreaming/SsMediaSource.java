...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public SsMediaSource createMediaSource(SsManifest ssManifest, MediaItem mediaItem) {
            List<StreamKey> m409of;
            SsManifest ssManifest2 = ssManifest;
            Assertions.checkArgument(!ssManifest2.isLive);
            if (mediaItem.localConfiguration != null) {
                m409of = mediaItem.localConfiguration.streamKeys;
            } else {
                m409of = ImmutableList.m409of();
            }
            if (!m409of.isEmpty()) {
                ssManifest2 = ssManifest2.copy(m409of);
            }
    ...
    @Override // com.google.android.exoplayer2.upstream.Loader.Callback
    public Loader.LoadErrorAction onLoadError(ParsingLoadable<SsManifest> parsingLoadable, long j, long j2, IOException iOException, int r23) {
    ...
    private void processManifest() {
        ...
        for (int r2 = 0; r2 < this.mediaPeriods.size(); r2++) {
            this.mediaPeriods.get(r2).updateManifest(this.manifest);
        }
        ...
        if (j2 == Long.MAX_VALUE) {
            ...
            if (this.manifest.dvrWindowLengthUs != C1856C.TIME_UNSET && this.manifest.dvrWindowLengthUs > 0) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline((long) C1856C.TIME_UNSET, j4, j3, msToUs, true, true, true, (Object) this.manifest, this.mediaItem);
        } else {
            long j5 = this.manifest.durationUs != C1856C.TIME_UNSET ? this.manifest.durationUs : j - j2;
