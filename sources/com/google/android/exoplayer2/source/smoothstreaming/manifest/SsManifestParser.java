...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    public static abstract class ElementParser {
        ...
        protected final Object getNormalizedAttribute(String str) {
            for (int r0 = 0; r0 < this.normalizedAttributes.size(); r0++) {
                Pair<String, Object> pair = this.normalizedAttributes.get(r0);
        ...
        protected final int parseInt(XmlPullParser xmlPullParser, String str, int r4) throws ParserException {
            String attributeValue = xmlPullParser.getAttributeValue(null, str);
            if (attributeValue != null) {
                try {
        ...
        public Object build() {
            ...
            if (this.protectionElement != null) {
                ...
                for (int r3 = 0; r3 < size; r3++) {
                    SsManifest.StreamElement streamElement = streamElementArr[r3];
                    int r6 = streamElement.type;
                    if (r6 == 2 || r6 == 1) {
                        Format[] formatArr = streamElement.formats;
                        for (int r62 = 0; r62 < formatArr.length; r62++) {
                            formatArr[r62] = formatArr[r62].buildUpon().setDrmInitData(drmInitData).build();
                        }
                    }
                }
            }
    ...
    public static class ProtectionParser extends ElementParser {
        ...
        public Object build() {
            UUID r1 = this.uuid;
            return new SsManifest.ProtectionElement(r1, PsshAtomUtil.buildPsshAtom(r1, this.initData), buildTrackEncryptionBoxes(this.initData));
        }
        ...
        private static byte[] getProtectionElementKeyId(byte[] bArr) {
            ...
            for (int r2 = 0; r2 < bArr.length; r2 += 2) {
                sb.append((char) bArr[r2]);
            }
        ...
        private static void swap(byte[] bArr, int r3, int r4) {
            byte b = bArr[r3];
            bArr[r3] = bArr[r4];
            bArr[r4] = b;
        }
    ...
    public static class StreamIndexParser extends ElementParser {
        ...
        private void parseStreamFragmentStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            long parseLong = parseLong(xmlPullParser, KEY_FRAGMENT_START_TIME, C1856C.TIME_UNSET);
            int r6 = 1;
            ...
            this.lastChunkDuration = parseLong(xmlPullParser, KEY_FRAGMENT_DURATION, C1856C.TIME_UNSET);
            long parseLong2 = parseLong(xmlPullParser, KEY_FRAGMENT_REPEAT_COUNT, 1L);
            if (parseLong2 > 1 && this.lastChunkDuration == C1856C.TIME_UNSET) {
    ...
    public static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (intValue == 2) {
                ...
                builder.setContainerMimeType(MimeTypes.APPLICATION_MP4).setRoleFlags(r2);
            } else {
