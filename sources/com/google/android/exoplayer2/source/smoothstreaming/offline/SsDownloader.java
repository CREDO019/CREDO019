...
public final class SsDownloader extends SegmentDownloader<SsManifest> {
    ...
    public List<SegmentDownloader.Segment> getSegments(DataSource dataSource, SsManifest ssManifest, boolean z) {
        ...
        for (SsManifest.StreamElement streamElement : ssManifest.streamElements) {
            for (int r3 = 0; r3 < streamElement.formats.length; r3++) {
                for (int r4 = 0; r4 < streamElement.chunkCount; r4++) {
                    arrayList.add(new SegmentDownloader.Segment(streamElement.getStartTimeUs(r4), new DataSpec(streamElement.buildRequestUri(r3, r4))));
                }
            }
        }
        return arrayList;
