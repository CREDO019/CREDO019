...
public final class MediaDescription {
    ...
    public static final class RtpMapAttribute {
        ...
        private RtpMapAttribute(int r1, String str, int r3, int r4) {
            this.payloadType = r1;
            this.mediaEncoding = str;
            this.clockRate = r3;
            this.encodingParameters = r4;
        }
    ...
    public static final class Builder {
        ...
        public Builder(String str, int r2, String str2, int r4) {
            this.mediaType = str;
            this.port = r2;
        ...
        public Builder setBitrate(int r1) {
            this.bitrate = r1;
            return this;
        }
        ...
        private static String getRtpMapStringByPayloadType(int r4) {
            Assertions.checkArgument(r4 < 96);
            if (r4 != 0) {
                if (r4 != 8) {
                    if (r4 != 10) {
                        if (r4 == 11) {
                        ...
                        throw new IllegalStateException("Unsupported static paylod type " + r4);
                    }
        ...
        private static String constructAudioRtpMap(int r2, String str, int r4, int r5) {
            return Util.formatInvariant(RTP_MAP_ATTR_AUDIO_FMT, Integer.valueOf(r2), str, Integer.valueOf(r4), Integer.valueOf(r5));
        }
    }
