...
final class RtpExtractor implements Extractor {
    ...
    private volatile long firstTimestamp = C1856C.TIME_UNSET;
    private volatile int firstSequenceNumber = -1;
    private long nextRtpTimestamp = C1856C.TIME_UNSET;
    private long playbackStartTimeUs = C1856C.TIME_UNSET;
    ...
    public RtpExtractor(RtpPayloadFormat rtpPayloadFormat, int r3) {
        this.trackId = r3;
    ...
    public void setFirstSequenceNumber(int r1) {
        this.firstSequenceNumber = r1;
    }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (!this.firstPacketRead) {
            if (this.firstTimestamp == C1856C.TIME_UNSET) {
        ...
        synchronized (this.lock) {
            ...
            } else if (this.nextRtpTimestamp != C1856C.TIME_UNSET && this.playbackStartTimeUs != C1856C.TIME_UNSET) {
                this.reorderingQueue.reset();
                this.payloadReader.seek(this.nextRtpTimestamp, this.playbackStartTimeUs);
                this.isSeekPending = false;
                this.nextRtpTimestamp = C1856C.TIME_UNSET;
                this.playbackStartTimeUs = C1856C.TIME_UNSET;
            }
        }
        return 0;
    }
