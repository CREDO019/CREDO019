...
public final class RtpDataLoadable implements Loader.Loadable {
    ...
    private volatile long pendingSeekPositionUs = C1856C.TIME_UNSET;
    ...
    public RtpDataLoadable(int r1, RtspMediaTrack rtspMediaTrack, EventListener eventListener, ExtractorOutput extractorOutput, RtpDataChannel.Factory factory) {
        this.trackId = r1;
    ...
    public void setTimestamp(long j) {
        if (j == C1856C.TIME_UNSET || ((RtpExtractor) Assertions.checkNotNull(this.extractor)).hasReadFirstRtpPacket()) {
            return;
        }
        this.extractor.setFirstTimestamp(j);
    }

    public void setSequenceNumber(int r2) {
        if (((RtpExtractor) Assertions.checkNotNull(this.extractor)).hasReadFirstRtpPacket()) {
            return;
        }
        this.extractor.setFirstSequenceNumber(r2);
    }
        ...
        try {
            ...
            this.playbackThreadHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.rtsp.RtpDataLoadable$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RtpDataLoadable.this.m1155x79854435(transport, rtpDataChannel);
                }
            });
            ...
            while (!this.loadCancelled) {
                if (this.pendingSeekPositionUs != C1856C.TIME_UNSET) {
    ...
    public /* synthetic */ void m1155x79854435(String str, RtpDataChannel rtpDataChannel) {
