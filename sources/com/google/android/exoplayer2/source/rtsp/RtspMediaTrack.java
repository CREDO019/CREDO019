...
public final class RtspMediaTrack {
    ...
    static RtpPayloadFormat generatePayloadFormat(MediaDescription mediaDescription) {
        ...
        int r1 = mediaDescription.rtpMapAttribute.payloadType;
        ...
        int r4 = mediaDescription.rtpMapAttribute.clockRate;
        if ("audio".equals(mediaDescription.mediaType)) {
            r5 = inferChannelCount(mediaDescription.rtpMapAttribute.encodingParameters, mimeTypeFromRtpMediaType);
            builder.setSampleRate(r4).setChannelCount(r5);
        } else {
            r5 = -1;
        }
        ...
        switch (c) {
            case 0:
                Assertions.checkArgument(r5 != -1);
                Assertions.checkArgument(!fmtpParametersAsMap.isEmpty());
                processAacFmtpAttribute(builder, fmtpParametersAsMap, r5, r4);
                break;
            case 1:
            case 2:
                Assertions.checkArgument(r5 == 1, "Multi channel AMR is not currently supported.");
            ...
            case 3:
                Assertions.checkArgument(r5 != -1);
                Assertions.checkArgument(r4 == 48000, "Invalid OPUS clock rate.");
                break;
            case 4:
                Assertions.checkArgument(!fmtpParametersAsMap.isEmpty());
            ...
            case 7:
                ...
                break;
            case '\b':
                builder.setWidth(VoiceActivityDetector.FRAME_SIZE_IN_BYTES).setHeight(PsExtractor.VIDEO_STREAM_MASK);
                break;
            case '\t':
                builder.setWidth(VoiceActivityDetector.FRAME_SIZE_IN_BYTES).setHeight(PsExtractor.VIDEO_STREAM_MASK);
                break;
        ...
        return new RtpPayloadFormat(builder.build(), r1, r4, fmtpParametersAsMap);
    }

    private static int inferChannelCount(int r1, String str) {
        return r1 != -1 ? r1 : str.equals(MimeTypes.AUDIO_AC3) ? 6 : 1;
    }

    private static void processAacFmtpAttribute(Format.Builder builder, ImmutableMap<String, String> immutableMap, int r4, int r5) {
        ...
        builder.setInitializationData(ImmutableList.m408of(AacUtil.buildAacLcAudioSpecificConfig(r5, r4)));
    }
    ...
    private static void processMPEG4FmtpAttribute(Format.Builder builder, ImmutableMap<String, String> immutableMap) {
        ...
        if (str != null) {
            ...
            builder.setInitializationData(ImmutableList.m408of(bytesFromHexString));
    ...
    private static void processH264FmtpAttribute(Format.Builder builder, ImmutableMap<String, String> immutableMap) {
        ...
        ImmutableList m407of = ImmutableList.m407of(getInitializationDataFromParameterSet(split[0]), getInitializationDataFromParameterSet(split[1]));
        builder.setInitializationData(m407of);
        byte[] bArr = (byte[]) m407of.get(0);
