...
public final class RtspMessageChannel implements Closeable {
    ...
    public void registerInterleavedBinaryDataListener(int r2, InterleavedBinaryDataListener interleavedBinaryDataListener) {
        this.interleavedBinaryDataListeners.put(Integer.valueOf(r2), interleavedBinaryDataListener);
    }
        ...
        public void send(final List<String> list) {
            ...
            this.senderThreadHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.rtsp.RtspMessageChannel$Sender$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    RtspMessageChannel.Sender.this.m1152x9fa6909d(convertMessageToByteArray, list);
                }
            });
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: lambda$send$0$com-google-android-exoplayer2-source-rtsp-RtspMessageChannel$Sender */
        public /* synthetic */ void m1152x9fa6909d(byte[] bArr, List list) {
            try {
    ...
    private final class LoaderCallbackImpl implements Loader.Callback<Receiver> {
        ...
        @Override // com.google.android.exoplayer2.upstream.Loader.Callback
        public Loader.LoadErrorAction onLoadError(Receiver receiver, long j, long j2, IOException iOException, int r7) {
            if (!RtspMessageChannel.this.closed) {
