...
final class RtspSessionTiming {
    ...
    public static final RtspSessionTiming DEFAULT = new RtspSessionTiming(0, C1856C.TIME_UNSET);
    ...
    public boolean isLive() {
        return this.stopTimeMs == C1856C.TIME_UNSET;
    }
