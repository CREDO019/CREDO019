    ...
    public void consume(ParsableByteArray parsableByteArray, long j, int r20, boolean z) {
        ...
        if (!this.foundOpusIDHeader) {
            ...
            if (!this.foundOpusCommentHeader) {
                ...
                if (r20 != nextSequenceNumber) {
                    Log.m1132w(TAG, Util.formatInvariant("Received RTP packet with unexpected sequence number. Expected: %d; received: %d.", Integer.valueOf(nextSequenceNumber), Integer.valueOf(r20)));
                }
