...
final class RtpMpeg4Reader implements RtpPayloadReader {
    ...
    @Override // com.google.android.exoplayer2.source.rtsp.reader.RtpPayloadReader
    public void consume(ParsableByteArray parsableByteArray, long j, int r21, boolean z) {
        int nextSequenceNumber;
        Assertions.checkStateNotNull(this.trackOutput);
        int r2 = this.previousSequenceNumber;
        if (r2 != -1 && r21 != (nextSequenceNumber = RtpPacket.getNextSequenceNumber(r2))) {
            Log.m1132w(TAG, Util.formatInvariant("Received RTP packet with unexpected sequence number. Expected: %d; received: %d. Dropping packet.", Integer.valueOf(nextSequenceNumber), Integer.valueOf(r21)));
        }
        ...
        this.previousSequenceNumber = r21;
    }
