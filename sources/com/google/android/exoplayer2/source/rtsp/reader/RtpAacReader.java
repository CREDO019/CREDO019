...
final class RtpAacReader implements RtpPayloadReader {
    ...
    @Override // com.google.android.exoplayer2.source.rtsp.reader.RtpPayloadReader
    public void consume(ParsableByteArray parsableByteArray, long j, int r12, boolean z) {
        Assertions.checkNotNull(this.trackOutput);
        short readShort = parsableByteArray.readShort();
        int r0 = readShort / this.numBitsInAuHeader;
        ...
        for (int r122 = 0; r122 < r0; r122++) {
            ...
            sampleTimeUs += Util.scaleLargeTimestamp(r0, 1000000L, this.sampleRate);
        }
    }
    ...
    private static void outputSampleMetadata(TrackOutput trackOutput, long j, int r10) {
        trackOutput.sampleMetadata(j, 1, r10, 0, null);
    }
