...
final class RtpVp8Reader implements RtpPayloadReader {
    ...
    private long fragmentedSampleTimeUs = C1856C.TIME_UNSET;
    ...
    @Override // com.google.android.exoplayer2.source.rtsp.reader.RtpPayloadReader
    public void onReceivingFirstPacket(long j, int r7) {
        Assertions.checkState(this.firstReceivedTimestamp == C1856C.TIME_UNSET);
        this.firstReceivedTimestamp = j;
    }

    @Override // com.google.android.exoplayer2.source.rtsp.reader.RtpPayloadReader
    public void consume(ParsableByteArray parsableByteArray, long j, int r10, boolean z) {
        Assertions.checkStateNotNull(this.trackOutput);
        if (validateVp8Descriptor(parsableByteArray, r10)) {
    ...
    private boolean validateVp8Descriptor(ParsableByteArray parsableByteArray, int r8) {
        ...
        if ((readUnsignedByte & 16) == 16 && (readUnsignedByte & 7) == 0) {
            ...
            Log.m1132w(TAG, "RTP packet is not the start of a new VP8 partition, skipping.");
            return false;
        }
    ...
    private void outputSampleMetadataForFragmentedPackets() {
        ...
        this.fragmentedSampleTimeUs = C1856C.TIME_UNSET;
