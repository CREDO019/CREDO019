...
final class RtpAmrReader implements RtpPayloadReader {
    ...
    public void consume(ParsableByteArray parsableByteArray, long j, int r22, boolean z) {
        ...
        int r3 = this.previousSequenceNumber;
        if (r3 != -1 && r22 != (nextSequenceNumber = RtpPacket.getNextSequenceNumber(r3))) {
            Log.m1132w(TAG, Util.formatInvariant("Received RTP packet with unexpected sequence number. Expected: %d; received: %d.", Integer.valueOf(nextSequenceNumber), Integer.valueOf(r22)));
        }
    ...
    public static int getFrameSize(int r3, boolean z) {
        boolean z2 = (r3 >= 0 && r3 <= 8) || r3 == 15;
        ...
        if (z) {
            return AMR_WB_FRAME_TYPE_INDEX_TO_FRAME_SIZE[r3];
        }
        return AMR_NB_FRAME_TYPE_INDEX_TO_FRAME_SIZE[r3];
    }

    private static long toSampleTimeUs(long j, long j2, long j3, int r12) {
