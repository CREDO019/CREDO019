...
public abstract class BasePlayer implements Player {
    ...
    @Override // com.google.android.exoplayer2.Player
    public final void addMediaItem(int r1, MediaItem mediaItem) {
        addMediaItems(r1, Collections.singletonList(mediaItem));
    }
    ...
    @Override // com.google.android.exoplayer2.Player
    public final void moveMediaItem(int r2, int r3) {
        if (r2 != r3) {
            moveMediaItems(r2, r2 + 1, r3);
        }
    }

    @Override // com.google.android.exoplayer2.Player
    public final void removeMediaItem(int r2) {
        removeMediaItems(r2, r2 + 1);
    }
    ...
    @Override // com.google.android.exoplayer2.Player
    public final boolean isCommandAvailable(int r2) {
        return getAvailableCommands().contains(r2);
    }
    ...
    @Override // com.google.android.exoplayer2.Player
    public final MediaItem getMediaItemAt(int r3) {
        return getCurrentTimeline().getWindow(r3, this.window).mediaItem;
    }
    ...
    public final int getBufferedPercentage() {
        ...
        if (bufferedPosition == C1856C.TIME_UNSET || duration == C1856C.TIME_UNSET) {
            return 0;
        }
        if (duration == 0) {
            return 100;
    ...
    public final long getCurrentLiveOffset() {
        Timeline currentTimeline = getCurrentTimeline();
        return (currentTimeline.isEmpty() || currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).windowStartTimeMs == C1856C.TIME_UNSET) ? C1856C.TIME_UNSET : (this.window.getCurrentUnixTimeMs() - this.window.windowStartTimeMs) - getContentPosition();
    }
    ...
    public final long getContentDuration() {
        Timeline currentTimeline = getCurrentTimeline();
        return currentTimeline.isEmpty() ? C1856C.TIME_UNSET : currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).getDurationMs();
    }
