...
final class AutoValue_EventStoreConfig extends EventStoreConfig {
    ...
    private AutoValue_EventStoreConfig(long j, int r3, int r4, long j2, int r7) {
    ...
    static final class Builder extends EventStoreConfig.Builder {
        ...
        @Override // com.google.android.datatransport.runtime.scheduling.persistence.EventStoreConfig.Builder
        EventStoreConfig.Builder setLoadBatchSize(int r1) {
            this.loadBatchSize = Integer.valueOf(r1);
            return this;
        }

        @Override // com.google.android.datatransport.runtime.scheduling.persistence.EventStoreConfig.Builder
        EventStoreConfig.Builder setCriticalSectionEnterTimeoutMs(int r1) {
        ...
        @Override // com.google.android.datatransport.runtime.scheduling.persistence.EventStoreConfig.Builder
        EventStoreConfig.Builder setMaxBlobByteSizePerRow(int r1) {
