...
public final class AutoBatchedLogRequestEncoder implements Configurator {
    ...
    private static final class BatchedLogRequestEncoder implements ObjectEncoder<BatchedLogRequest> {
        ...
        private static final FieldDescriptor LOGREQUEST_DESCRIPTOR = FieldDescriptor.m250of("logRequest");
    ...
    private static final class LogRequestEncoder implements ObjectEncoder<LogRequest> {
        ...
        private static final FieldDescriptor REQUESTTIMEMS_DESCRIPTOR = FieldDescriptor.m250of("requestTimeMs");
        private static final FieldDescriptor REQUESTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m250of("requestUptimeMs");
        private static final FieldDescriptor CLIENTINFO_DESCRIPTOR = FieldDescriptor.m250of("clientInfo");
        private static final FieldDescriptor LOGSOURCE_DESCRIPTOR = FieldDescriptor.m250of("logSource");
        private static final FieldDescriptor LOGSOURCENAME_DESCRIPTOR = FieldDescriptor.m250of("logSourceName");
        private static final FieldDescriptor LOGEVENT_DESCRIPTOR = FieldDescriptor.m250of("logEvent");
        private static final FieldDescriptor QOSTIER_DESCRIPTOR = FieldDescriptor.m250of("qosTier");
    ...
    private static final class ClientInfoEncoder implements ObjectEncoder<ClientInfo> {
        ...
        private static final FieldDescriptor CLIENTTYPE_DESCRIPTOR = FieldDescriptor.m250of("clientType");
        private static final FieldDescriptor ANDROIDCLIENTINFO_DESCRIPTOR = FieldDescriptor.m250of("androidClientInfo");
    ...
    private static final class AndroidClientInfoEncoder implements ObjectEncoder<AndroidClientInfo> {
        ...
        private static final FieldDescriptor SDKVERSION_DESCRIPTOR = FieldDescriptor.m250of(UpdatesConfiguration.UPDATES_CONFIGURATION_SDK_VERSION_KEY);
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.m250of("model");
        private static final FieldDescriptor HARDWARE_DESCRIPTOR = FieldDescriptor.m250of("hardware");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m250of("device");
        private static final FieldDescriptor PRODUCT_DESCRIPTOR = FieldDescriptor.m250of("product");
        private static final FieldDescriptor OSBUILD_DESCRIPTOR = FieldDescriptor.m250of("osBuild");
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m250of("manufacturer");
        private static final FieldDescriptor FINGERPRINT_DESCRIPTOR = FieldDescriptor.m250of("fingerprint");
        private static final FieldDescriptor LOCALE_DESCRIPTOR = FieldDescriptor.m250of(Constants.LOCALE);
        private static final FieldDescriptor COUNTRY_DESCRIPTOR = FieldDescriptor.m250of(com.amplitude.api.Constants.AMP_TRACKING_OPTION_COUNTRY);
        private static final FieldDescriptor MCCMNC_DESCRIPTOR = FieldDescriptor.m250of("mccMnc");
        private static final FieldDescriptor APPLICATIONBUILD_DESCRIPTOR = FieldDescriptor.m250of("applicationBuild");
    ...
    private static final class LogEventEncoder implements ObjectEncoder<LogEvent> {
        ...
        private static final FieldDescriptor EVENTTIMEMS_DESCRIPTOR = FieldDescriptor.m250of("eventTimeMs");
        private static final FieldDescriptor EVENTCODE_DESCRIPTOR = FieldDescriptor.m250of("eventCode");
        private static final FieldDescriptor EVENTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m250of("eventUptimeMs");
        private static final FieldDescriptor SOURCEEXTENSION_DESCRIPTOR = FieldDescriptor.m250of("sourceExtension");
        private static final FieldDescriptor SOURCEEXTENSIONJSONPROTO3_DESCRIPTOR = FieldDescriptor.m250of("sourceExtensionJsonProto3");
        private static final FieldDescriptor TIMEZONEOFFSETSECONDS_DESCRIPTOR = FieldDescriptor.m250of("timezoneOffsetSeconds");
        private static final FieldDescriptor NETWORKCONNECTIONINFO_DESCRIPTOR = FieldDescriptor.m250of("networkConnectionInfo");
    ...
    private static final class NetworkConnectionInfoEncoder implements ObjectEncoder<NetworkConnectionInfo> {
        ...
        private static final FieldDescriptor NETWORKTYPE_DESCRIPTOR = FieldDescriptor.m250of("networkType");
        private static final FieldDescriptor MOBILESUBTYPE_DESCRIPTOR = FieldDescriptor.m250of("mobileSubtype");
