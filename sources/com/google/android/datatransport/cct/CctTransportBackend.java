...
public final class CctTransportBackend implements TransportBackend {
    ...
    CctTransportBackend(Context context, Clock clock, Clock clock2, int r5) {
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m1229e(LOG_TAG, "Unable to find version code for package", e);
            return -1;
        }
    }
    ...
    private BatchedLogRequest getRequestBody(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m1235of("proto"))) {
                    protoBuilder = LogEvent.protoBuilder(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m1235of("json"))) {
                    protoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m1227w(LOG_TAG, "Received event of unsupported encoding %s. Skipping...", encoding);
                }
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        Logging.m1232d(LOG_TAG, "Making request to: %s", httpRequest.url);
        ...
        try {
            ...
            try {
                ...
                Logging.m1228i(LOG_TAG, "Status Code: " + responseCode);
                Logging.m1228i(LOG_TAG, "Content-Type: " + httpURLConnection.getHeaderField("Content-Type"));
                Logging.m1228i(LOG_TAG, "Content-Encoding: " + httpURLConnection.getHeaderField("Content-Encoding"));
            ...
            e = e;
            Logging.m1229e(LOG_TAG, "Couldn't encode request, returning with 400", e);
            return new HttpResponse(400, null, 0L);
        } catch (ConnectException e2) {
            e = e2;
            Logging.m1229e(LOG_TAG, "Couldn't open connection, returning with 500", e);
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            ...
            if (httpResponse.code == 200) {
                return BackendResponse.m1234ok(httpResponse.nextRequestMillis);
            }
            ...
            Logging.m1229e(LOG_TAG, "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    public static /* synthetic */ HttpRequest lambda$send$0(HttpRequest httpRequest, HttpResponse httpResponse) {
        if (httpResponse.redirectUrl != null) {
            Logging.m1232d(LOG_TAG, "Following redirect to: %s", httpResponse.redirectUrl);
    ...
    public static final class HttpResponse {
        ...
        HttpResponse(int r1, URL url, long j) {
            this.code = r1;
