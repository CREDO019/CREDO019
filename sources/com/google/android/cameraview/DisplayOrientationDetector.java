...
abstract class DisplayOrientationDetector {
    ...
    public abstract void onDisplayOrientationChanged(int r1);
    ...
    public DisplayOrientationDetector(Context context) {
        this.mOrientationEventListener = new OrientationEventListener(context) { // from class: com.google.android.cameraview.DisplayOrientationDetector.1
            ...
            public void onOrientationChanged(int r3) {
                int rotation;
                if (r3 == -1 || DisplayOrientationDetector.this.mDisplay == null || this.mLastKnownRotation == (rotation = DisplayOrientationDetector.this.mDisplay.getRotation())) {
                    return;
                }
    ...
    void dispatchOnDisplayOrientationChanged(int r1) {
        this.mLastKnownDisplayOrientation = r1;
        onDisplayOrientationChanged(r1);
    }
}
