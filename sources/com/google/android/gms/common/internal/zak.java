...
public final class zak implements Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        int r4 = message.what;
        Log.wtf("GmsClientEvents", "Don't know how to handle message: " + r4, new Exception());
        return false;
    }
    ...
    public final void zad(Bundle bundle) {
        ...
        synchronized (this.zai) {
            ...
            while (it.hasNext()) {
                ...
                if (!this.zae || !this.zab.isConnected() || this.zaf.get() != r2) {
                    break;
        ...
        synchronized (this.zai) {
            ...
            while (it.hasNext()) {
                ...
                if (!this.zae || this.zaf.get() != r2) {
                    ...
                    connectionCallbacks.onConnectionSuspended(r6);
                }
            }
            this.zaa.clear();
            this.zag = false;
