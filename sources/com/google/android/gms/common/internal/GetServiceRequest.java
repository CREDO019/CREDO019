...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    public GetServiceRequest(int r1, int r2, int r3, String str, IBinder iBinder, Scope[] scopeArr, Bundle bundle, Account account, Feature[] featureArr, Feature[] featureArr2, boolean z, int r12, boolean z2, String str2) {
