...
public abstract class GmsClientSupervisor {
    ...
    public final void zzb(String str, String str2, int r4, ServiceConnection serviceConnection, String str3, boolean z) {
        zza(new zzn(str, str2, r4, z), serviceConnection, str3);
    }
