...
public final class DataBufferObserverSet implements DataBufferObserver, DataBufferObserver.Observable {
    ...
    public void onDataRangeChanged(int r3, int r4) {
        Iterator it = this.zaa.iterator();
        while (it.hasNext()) {
            ((DataBufferObserver) it.next()).onDataRangeChanged(r3, r4);
        }
    }
    ...
    public void onDataRangeInserted(int r3, int r4) {
        Iterator it = this.zaa.iterator();
        while (it.hasNext()) {
            ((DataBufferObserver) it.next()).onDataRangeInserted(r3, r4);
        }
    }
    ...
    public void onDataRangeMoved(int r3, int r4, int r5) {
        Iterator it = this.zaa.iterator();
        while (it.hasNext()) {
            ((DataBufferObserver) it.next()).onDataRangeMoved(r3, r4, r5);
        }
    }
    ...
    public void onDataRangeRemoved(int r3, int r4) {
        Iterator it = this.zaa.iterator();
        while (it.hasNext()) {
            ((DataBufferObserver) it.next()).onDataRangeRemoved(r3, r4);
        }
    }
