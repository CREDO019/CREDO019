...
public class DataBufferResponse<T, R extends AbstractDataBuffer<T> & Result> extends C2134Response<R> implements DataBuffer<T> {
    ...
    public final T get(int r2) {
        return (T) ((AbstractDataBuffer) getResult()).get(r2);
    }
