    ...
    public final void zaa() {
        ...
        if (arrayList.isEmpty()) {
            ...
            while (r5 < size) {
                ...
                r4 = zalVar.zab(context3, (Api.Client) arrayList2.get(r5));
                r5++;
                if (r4 == 0) {
                    break;
                }
            ...
            while (r5 < size2) {
                ...
                r4 = zalVar.zab(context, (Api.Client) arrayList.get(r5));
                r5++;
                if (r4 != 0) {
                    break;
                }
        ...
        if (r4 != 0) {
            ConnectionResult connectionResult = new ConnectionResult(r4, null);
