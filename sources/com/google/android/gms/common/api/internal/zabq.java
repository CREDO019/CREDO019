...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final void zaF() {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            zai zaiVar = (zai) arrayList.get(r2);
    ...
    public final void zaH(int r4) {
        ...
        zan();
        this.zaj = true;
        this.zae.zae(r4, this.zac.getLastDisconnectMessage());
    ...
    public static /* bridge */ /* synthetic */ void zam(zabq zabqVar, zabs zabsVar) {
        ...
        if (zabqVar.zak.remove(zabsVar)) {
            ...
            int size = arrayList.size();
            for (int r2 = 0; r2 < size; r2++) {
                zai zaiVar2 = (zai) arrayList.get(r2);
    ...
    public final void onConnectionSuspended(int r3) {
        ...
        handler2 = this.zaa.zat;
        handler2.post(new zabn(this, r3));
    }
