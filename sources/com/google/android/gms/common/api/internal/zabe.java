...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public zabe(Context context, Lock lock, Looper looper, ClientSettings clientSettings, GoogleApiAvailability googleApiAvailability, Api.AbstractClientBuilder abstractClientBuilder, Map map, List list, List list2, Map map2, int r17, int r18, ArrayList arrayList) {
    ...
    static String zag(int r1) {
        return r1 != 1 ? r1 != 2 ? r1 != 3 ? "UNKNOWN" : "SIGN_IN_MODE_NONE" : "SIGN_IN_MODE_OPTIONAL" : "SIGN_IN_MODE_REQUIRED";
    }
    ...
    private final void zal(int r13) {
        ...
        if (num == null) {
            this.zaw = Integer.valueOf(r13);
        } else if (num.intValue() != r13) {
            int intValue = this.zaw.intValue();
            throw new IllegalStateException("Cannot use sign-in mode: " + zag(r13) + ". Mode was already set to " + zag(intValue));
        }
        if (this.zal != null) {
            return;
        }
    ...
    public final void connect() {
        ...
        try {
            ...
            if (intValue == 3 || intValue == 1) {
                ...
                r1 = intValue;
                Preconditions.checkArgument(z, "Illegal sign-in mode: " + r1);
                zal(r1);
                zan();
                this.zaj.unlock();
            }
    ...
    */
    ...
    @Override // com.google.android.gms.common.api.internal.zabz
    public final void zac(int r6, boolean z) {
        if (r6 == 1) {
            if (!z && !this.zap) {
                this.zap = true;
    ...
    public final void connect(int r4) {
        ...
        try {
            Preconditions.checkArgument(z, "Illegal sign-in mode: " + r4);
            zal(r4);
            zan();
        } finally {
            this.zaj.unlock();
