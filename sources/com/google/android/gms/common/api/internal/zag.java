...
public final class zag extends zac {
    ...
    public zag(int r1, TaskApiCall taskApiCall, TaskCompletionSource taskCompletionSource, StatusExceptionMapper statusExceptionMapper) {
        super(r1);
        this.zab = taskCompletionSource;
        this.zaa = taskApiCall;
        this.zad = statusExceptionMapper;
        if (r1 == 2 && taskApiCall.shouldAutoResolveMissingFeatures()) {
