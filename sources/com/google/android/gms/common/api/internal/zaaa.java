...
public final class zaaa implements zaca {
    ...
    public static zaaa zag(Context context, zabe zabeVar, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map map, ClientSettings clientSettings, Map map2, Api.AbstractClientBuilder abstractClientBuilder, ArrayList arrayList) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            zat zatVar = (zat) arrayList.get(r1);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* bridge */ /* synthetic */ void zan(zaaa zaaaVar, int r2, boolean z) {
        zaaaVar.zab.zac(r2, z);
        zaaaVar.zak = null;
        zaaaVar.zaj = null;
    }
    ...
    private final PendingIntent zaz() {
        ...
        return PendingIntent.getActivity(this.zaa, System.identityHashCode(this.zab), this.zah.getSignInIntent(), com.google.android.gms.internal.base.zap.zaa | C1856C.BUFFER_FLAG_FIRST_SAMPLE);
    }
