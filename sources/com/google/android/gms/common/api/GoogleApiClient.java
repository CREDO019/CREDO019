...
public abstract class GoogleApiClient {
    ...
    public static void dumpAll(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        synchronized (set) {
            ...
            for (GoogleApiClient googleApiClient : set) {
                printWriter.append((CharSequence) str).append("GoogleApiClient#").println(r3);
    ...
    public static final class Builder {
        ...
        public Builder enableAutoManage(FragmentActivity fragmentActivity, int r4, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) fragmentActivity);
            Preconditions.checkArgument(r4 >= 0, "clientId must be non-negative");
            this.zal = r4;
        ...
        public Builder setGravityForPopups(int r1) {
            this.zad = r1;
            return this;
        }
