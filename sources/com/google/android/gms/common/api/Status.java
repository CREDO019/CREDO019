...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    public void writeToParcel(Parcel parcel, int r6) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 3, this.zze, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 4, getConnectionResult(), r6, false);
    ...
    public Status(int r7, String str, PendingIntent pendingIntent) {
        this(1, r7, str, pendingIntent, null);
    }
    ...
    @Deprecated
    public Status(ConnectionResult connectionResult, String str, int r9) {
        this(1, r9, str, connectionResult.getResolution(), connectionResult);
    }
}
