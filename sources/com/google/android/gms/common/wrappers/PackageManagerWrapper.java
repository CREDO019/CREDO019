...
public class PackageManagerWrapper {
    ...
    public ApplicationInfo getApplicationInfo(String str, int r3) throws PackageManager.NameNotFoundException {
        return this.zza.getPackageManager().getApplicationInfo(str, r3);
    }
    ...
    public PackageInfo getPackageInfo(String str, int r3) throws PackageManager.NameNotFoundException {
        return this.zza.getPackageManager().getPackageInfo(str, r3);
    }
    ...
    public final boolean zza(int r5, String str) {
        ...
        String[] packagesForUid = this.zza.getPackageManager().getPackagesForUid(r5);
