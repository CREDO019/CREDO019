...
public final class CollectionUtils {
    ...
    public static <K, V> Map<K, V> mapOfKeyValueArrays(K[] kArr, V[] vArr) {
        ...
        if (length != length2) {
            ...
            for (int r2 = 0; r2 < kArr.length; r2++) {
                zza.put(kArr[r2], vArr[r2]);
            }
            return Collections.unmodifiableMap(zza);
        }
    }

    public static <T> Set<T> mutableSetOfWithSize(int r1) {
        if (r1 == 0) {
            return new ArraySet();
        }
        return zzb(r1, true);
    ...
    private static Map zza(int r1, boolean z) {
        if (r1 <= 256) {
            return new ArrayMap(r1);
        }
        return new HashMap(r1, 1.0f);
    }

    private static Set zzb(int r2, boolean z) {
        float f = true != z ? 1.0f : 0.75f;
        if (r2 <= (true != z ? 256 : 128)) {
            return new ArraySet(r2);
        }
        return new HashSet(r2, f);
    }
