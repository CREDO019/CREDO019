...
public class WorkSourceUtil {
    ...
    public static WorkSource fromPackage(Context context, String str) {
        if (context != null && context.getPackageManager() != null && str != null) {
            try {
                ...
                int r3 = applicationInfo.uid;
                WorkSource workSource = new WorkSource();
                add(workSource, r3, str);
                return workSource;
    ...
    public static WorkSource fromPackageAndModuleExperimentalPi(Context context, String str, String str2) {
        ...
        if (method2 == null || (method = zzh) == null) {
            add(workSource, r2, str);
        } else {
            try {
                Object invoke = method2.invoke(workSource, new Object[0]);
                int r5 = zza;
                if (r2 != r5) {
                    method.invoke(invoke, Integer.valueOf(r2), str);
                }
                method.invoke(invoke, Integer.valueOf(r5), str2);
            } catch (Exception e) {
    ...
    public static int get(WorkSource workSource, int r4) {
        Method method = zze;
        if (method != null) {
            try {
                Object invoke = method.invoke(workSource, Integer.valueOf(r4));
    ...
    public static String getName(WorkSource workSource, int r4) {
        Method method = zzf;
        if (method != null) {
            try {
    ...
    public static List<String> getNames(WorkSource workSource) {
        ...
        if (size != 0) {
            for (int r1 = 0; r1 < size; r1++) {
                String name = getName(workSource, r1);
