...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public WebImage(int r1, Uri uri, int r3, int r4) {
        this.zaa = r1;
        this.zab = uri;
        this.zac = r3;
        this.zad = r4;
    ...
    public void writeToParcel(Parcel parcel, int r6) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 2, getUrl(), r6, false);
    ...
    public WebImage(Uri uri, int r3, int r4) throws IllegalArgumentException {
        this(1, uri, r3, r4);
        if (uri == null) {
