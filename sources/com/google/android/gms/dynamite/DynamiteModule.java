...
public final class DynamiteModule {
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            int r14 = selectModule.localVersion;
            int r15 = selectModule.remoteVersion;
            Log.i("DynamiteModule", "Considering local module " + str + ParameterizedMessage.ERROR_MSG_SEPARATOR + r14 + " and remote module " + str + ParameterizedMessage.ERROR_MSG_SEPARATOR + r15);
            int r7 = selectModule.selection;
            if (r7 != 0) {
                if (r7 == -1) {
                ...
                if (r7 != 1 || selectModule.remoteVersion != 0) {
                    if (r7 == -1) {
                        ...
                        throw new LoadingException("VersionPolicy returned invalid code:" + r7, null);
                    } else {
                        try {
                            int r142 = selectModule.remoteVersion;
                            try {
                                ...
                                if (bool != null) {
                                    if (bool.booleanValue()) {
                                        Log.i("DynamiteModule", "Selected remote version of " + str + ", version >= " + r142);
                                        synchronized (DynamiteModule.class) {
                                            zzrVar = zzl;
                                        }
                                        if (zzrVar == null) {
                                        ...
                                        if (valueOf.booleanValue()) {
                                            ...
                                            zze2 = zzrVar.zzf(ObjectWrapper.wrap(applicationContext), str, r142, ObjectWrapper.wrap(cursor2));
                                        } else {
                                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                                            zze2 = zzrVar.zze(ObjectWrapper.wrap(applicationContext), str, r142, ObjectWrapper.wrap(cursor2));
                                        }
                                        ...
                                        if (zze3 >= 3) {
                                            ...
                                            zzh2 = zzg2.zzi(ObjectWrapper.wrap(context), str, r142, ObjectWrapper.wrap(zznVar4.zza));
                                        } else if (zze3 == 2) {
                                            Log.w("DynamiteModule", "IDynamite loader version = 2");
                                            zzh2 = zzg2.zzj(ObjectWrapper.wrap(context), str, r142);
                                        } else {
                                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                                            zzh2 = zzg2.zzh(ObjectWrapper.wrap(context), str, r142);
                                        }
                            ...
                            if (r2 == 0 || versionPolicy.selectModule(context, str, new zzo(r2, 0)).selection != -1) {
            ...
            int r1 = selectModule.localVersion;
            int r22 = selectModule.remoteVersion;
            throw new LoadingException("No acceptable module " + str + " found. Local version is " + r1 + " and remote version is " + r22 + ".", null);
        } catch (Throwable th2) {
            if (longValue == 0) {
                zzh.remove();
            } else {
                        ...
                        if (zzg2 != null) {
                            try {
                                ...
                                if (zze2 >= 3) {
                                        ...
                                        if (cursor3 != null) {
                                            try {
                                                if (cursor3.moveToFirst()) {
                                                    int r12 = cursor3.getInt(0);
                                                    if (r12 <= 0 || !zze(cursor3)) {
                                                        cursor2 = cursor3;
                                                    }
                                                    if (cursor2 != null) {
                                                        cursor2.close();
                                    ...
                                    r3 = zzg2.zzg(ObjectWrapper.wrap(context), str, z);
                                } else {
                                    Log.w("DynamiteModule", "IDynamite loader version < 2, falling back to getModuleVersion2");
                                    r3 = zzg2.zzf(ObjectWrapper.wrap(context), str, z);
                                }
