...
public final class ClearcutLogger {
    ...
    public class LogEventBuilder {
        ...
        public LogEventBuilder setEventCode(int r2) {
            this.zzaa.zzbji = r2;
            return this;
        }
    }
    ...
    private ClearcutLogger(Context context, int r2, String str, String str2, String str3, boolean z, com.google.android.gms.clearcut.zzb zzbVar, Clock clock, zzc zzcVar, zza zzaVar) {
        this.zzk = -1;
    ...
    private static int[] zza(ArrayList<Integer> arrayList) {
        ...
        int[] r0 = new int[arrayList.size()];
        int size = arrayList.size();
        int r2 = 0;
        int r3 = 0;
        while (r2 < size) {
            Integer num = arrayList.get(r2);
            r2++;
            r0[r3] = num.intValue();
            r3++;
        }
