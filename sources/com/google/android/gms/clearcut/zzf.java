...
public final class zzf implements Parcelable.Creator<zze> {
    ...
    public final /* synthetic */ zze createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    r6 = SafeParcelReader.createIntArray(parcel, readHeader);
                    break;
                case 5:
                    strArr = SafeParcelReader.createStringArray(parcel, readHeader);
                    break;
                case 6:
                    r8 = SafeParcelReader.createIntArray(parcel, readHeader);
                    break;
                case 7:
        ...
        return new zze(zzrVar, bArr, r6, strArr, r8, bArr2, z, experimentTokensArr);
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ zze[] newArray(int r1) {
        return new zze[r1];
    }
}
