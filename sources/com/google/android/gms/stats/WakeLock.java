...
public class WakeLock {
    ...
    public WakeLock(Context context, int r9, String str) {
        this(context, r9, str, null, context == null ? null : context.getPackageName());
    }

    private WakeLock(Context context, int r9, String str, String str2, String str3) {
        this(context, r9, str, null, str3, null);
    }

    private WakeLock(Context context, int r4, String str, String str2, String str3, String str4) {
        this.zza = this;
        this.zzi = true;
        ...
        PowerManager.WakeLock newWakeLock = ((PowerManager) context.getSystemService("power")).newWakeLock(r4, str);
