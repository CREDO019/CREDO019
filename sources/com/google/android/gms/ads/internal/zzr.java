...
public final class zzr {
    ...
    public final void zzf(com.google.android.gms.ads.internal.client.zzl zzlVar, zzcgt zzcgtVar) {
        ...
        this.zzc.put("SDKVersion", zzcgtVar.zza);
        if (((Boolean) zzbkc.zza.zze()).booleanValue()) {
            try {
                Bundle zzc = zzeuk.zzc(this.zza, new JSONArray((String) zzbkc.zzb.zze()));
