...
public final class zzee extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        try {
            ...
            zzcgn.zzh("Failed to load metadata: Package name not found.", e);
        } catch (NullPointerException e2) {
            zzcgn.zzh("Failed to load metadata: Null pointer exception.", e2);
        }
        zzbuy zza = zzbuy.zza();
        if (bundle == null) {
            zzcgn.zzg("Metadata was null.");
        } else {
            try {
                            ...
                            if (str == null || str.matches("^/\\d+~.+$")) {
                                if (bool == null || !bool.booleanValue()) {
                                    if (!TextUtils.isEmpty(str2)) {
                                        zzcgn.zze("The Google Mobile Ads SDK is integrated by ".concat(String.valueOf(str2)));
                                    } else {
                                ...
                                zzcgn.zze("Publisher provided Google AdMob App ID in manifest: ".concat(str));
        ...
        if (bundle != null) {
            ...
            if (z) {
                zzcgn.zze("com.google.android.gms.ads.flag.OPTIMIZE_INITIALIZATION is enabled");
            }
            if (z2) {
                zzcgn.zze("com.google.android.gms.ads.flag.OPTIMIZE_AD_LOADING is enabled");
            }
        }
