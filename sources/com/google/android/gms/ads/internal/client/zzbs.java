...
public interface zzbs extends IInterface {
    ...
    void zzC(zzbc zzbcVar) throws RemoteException;

    void zzD(zzbf zzbfVar) throws RemoteException;

    void zzE(zzbw zzbwVar) throws RemoteException;

    void zzF(zzq zzqVar) throws RemoteException;

    void zzG(zzbz zzbzVar) throws RemoteException;

    void zzH(zzbdi zzbdiVar) throws RemoteException;
    ...
    void zzM(zzbzj zzbzjVar) throws RemoteException;

    void zzN(boolean z) throws RemoteException;

    void zzO(zzbjt zzbjtVar) throws RemoteException;

    void zzP(zzde zzdeVar) throws RemoteException;

    void zzQ(zzbzm zzbzmVar, String str) throws RemoteException;

    void zzR(String str) throws RemoteException;

    void zzS(zzcbw zzcbwVar) throws RemoteException;
