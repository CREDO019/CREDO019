...
public final class DynamicHeightSearchAdRequest {
    ...
    public static final class Builder {
        ...
        public Builder setAdTest(boolean z) {
            this.zzb.putString("csa_adtest", true != z ? Debug.DEBUG_PROPERTY_VALUE_OFF : "on");
            return this;
        }

        public Builder setAdjustableLineHeight(int r3) {
            this.zzb.putString("csa_adjustableLineHeight", Integer.toString(r3));
            return this;
        }
        ...
        public Builder setAttributionSpacingBelow(int r3) {
            this.zzb.putString("csa_attributionSpacingBelow", Integer.toString(r3));
            return this;
        }
        ...
        public Builder setCssWidth(int r3) {
            this.zzb.putString("csa_width", Integer.toString(r3));
            return this;
        }
        ...
        public Builder setFontSizeAnnotation(int r3) {
            this.zzb.putString("csa_fontSizeAnnotation", Integer.toString(r3));
            return this;
        }

        public Builder setFontSizeAttribution(int r3) {
            this.zzb.putString("csa_fontSizeAttribution", Integer.toString(r3));
            return this;
        }

        public Builder setFontSizeDescription(int r3) {
            this.zzb.putString("csa_fontSizeDescription", Integer.toString(r3));
            return this;
        }

        public Builder setFontSizeDomainLink(int r3) {
            this.zzb.putString("csa_fontSizeDomainLink", Integer.toString(r3));
            return this;
        }

        public Builder setFontSizeTitle(int r3) {
            this.zzb.putString("csa_fontSizeTitle", Integer.toString(r3));
            return this;
        }
        ...
        public Builder setLocationFontSize(int r3) {
            this.zzb.putString("csa_fontSizeLocation", Integer.toString(r3));
            return this;
        }
        ...
        public Builder setNumber(int r3) {
            this.zzb.putString("csa_number", Integer.toString(r3));
            return this;
        }

        public Builder setPage(int r3) {
            this.zzb.putString("csa_adPage", Integer.toString(r3));
            return this;
        }
        ...
        public Builder setVerticalSpacing(int r3) {
            this.zzb.putString("csa_verticalSpacing", Integer.toString(r3));
            return this;
        }
    }
