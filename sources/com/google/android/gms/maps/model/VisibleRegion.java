...
public final class VisibleRegion extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel parcel, int r6) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 2, this.nearLeft, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 3, this.nearRight, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 4, this.farLeft, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 5, this.farRight, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 6, this.latLngBounds, r6, false);
