...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    void setPositionWithRadius(LatLng latLng, int r2) throws RemoteException;

    void setPositionWithRadiusAndSource(LatLng latLng, int r2, @Nullable StreetViewSource streetViewSource) throws RemoteException;
