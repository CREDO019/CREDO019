...
public interface IGoogleMapDelegate extends IInterface {
    ...
    void animateCameraWithDurationAndCallback(IObjectWrapper iObjectWrapper, int r2, @Nullable zzd zzdVar) throws RemoteException;
    ...
    void setMapType(int r1) throws RemoteException;
    ...
    void setPadding(int r1, int r2, int r3, int r4) throws RemoteException;
