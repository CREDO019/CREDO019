...
public class GoogleMap {
    ...
    public interface OnCameraMoveStartedListener {
        ...
        void onCameraMoveStarted(int r1);
    }
    ...
    public final void setPadding(int r2, int r3, int r4, int r5) {
        try {
            this.zza.setPadding(r2, r3, r4, r5);
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public final void animateCamera(CameraUpdate cameraUpdate, int r4, CancelableCallback cancelableCallback) {
        try {
            Preconditions.checkNotNull(cameraUpdate, "CameraUpdate must not be null.");
            this.zza.animateCameraWithDurationAndCallback(cameraUpdate.zza(), r4, cancelableCallback == null ? null : new zzaa(cancelableCallback));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
