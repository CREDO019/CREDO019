...
public class StreetViewPanoramaView extends FrameLayout {
    ...
    public StreetViewPanoramaView(Context context, AttributeSet attributeSet, int r4) {
        super((Context) Preconditions.checkNotNull(context, "context must not be null"), attributeSet, r4);
        this.zza = new zzas(this, context, null);
    }
