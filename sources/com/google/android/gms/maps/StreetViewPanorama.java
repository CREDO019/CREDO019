...
public class StreetViewPanorama {
    ...
    public void setPosition(LatLng latLng, int r3) {
        try {
            this.zza.setPositionWithRadius(latLng, r3);
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }

    public void setPosition(LatLng latLng, int r3, StreetViewSource streetViewSource) {
        try {
            this.zza.setPositionWithRadiusAndSource(latLng, r3, streetViewSource);
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
