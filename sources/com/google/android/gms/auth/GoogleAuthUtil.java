...
public final class GoogleAuthUtil extends zzd {
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, int r1, String str) throws GoogleAuthException, IOException {
        return zzd.getAccountChangeEvents(context, r1, str);
    }
