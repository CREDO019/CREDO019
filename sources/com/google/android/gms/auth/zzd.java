...
public class zzd {
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, int r2, String str) throws GoogleAuthException, IOException {
        Preconditions.checkNotEmpty(str, "accountName must be provided");
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
        ensurePlayServicesAvailable(context, 8400000);
        return (List) zza(context, zzm, new zzg(str, r2));
    }
    ...
    private static void ensurePlayServicesAvailable(Context context, int r3) throws GoogleAuthException {
        try {
            GooglePlayServicesUtilLight.ensurePlayServicesAvailable(context.getApplicationContext(), r3);
    ...
    public static <T> T zza(T t) throws IOException {
        ...
        zzn.m1089w("GoogleAuthUtil", "Binder call returned null.");
        ...
        try {
            if (gmsClientSupervisor.bindService(componentName, blockingServiceConnection, "GoogleAuthUtil")) {
                try {
                    ...
                    zzn.m1092i("GoogleAuthUtil", "Error on service connection.", e);
