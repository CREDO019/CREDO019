...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    public CredentialRequest(int r1, boolean z, String[] strArr, CredentialPickerConfig credentialPickerConfig, CredentialPickerConfig credentialPickerConfig2, boolean z2, String str, String str2, boolean z3) {
        this.zba = r1;
        this.zbb = z;
    ...
    public void writeToParcel(Parcel parcel, int r6) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 3, getCredentialPickerConfig(), r6, false);
        SafeParcelWriter.writeParcelable(parcel, 4, getCredentialHintPickerConfig(), r6, false);
