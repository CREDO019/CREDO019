...
public class Credential extends AbstractSafeParcelable implements ReflectedParcelable {
            ...
            if (str4 != null) {
                ...
                if (TextUtils.isEmpty(str4)) {
                    ...
                    if (!parse.isAbsolute() || !parse.isHierarchical() || TextUtils.isEmpty(parse.getScheme()) || TextUtils.isEmpty(parse.getAuthority())) {
                        ...
                        bool = Boolean.valueOf(("http".equalsIgnoreCase(parse.getScheme()) || "https".equalsIgnoreCase(parse.getScheme())) ? true : true);
                    }
                }
    ...
    public void writeToParcel(Parcel parcel, int r6) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 3, getProfilePictureUri(), r6, false);
