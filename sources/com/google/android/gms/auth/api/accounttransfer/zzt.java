...
public class zzt extends zzaz {
    ...
    public zzt(Set<Integer> set, int r2, String str, int r4, byte[] bArr, PendingIntent pendingIntent, DeviceMetaData deviceMetaData) {
        this.zzba = set;
        this.zzv = r2;
        this.zzbn = str;
        this.zzbo = r4;
    ...
    public void writeToParcel(Parcel parcel, int r7) {
        ...
        if (set.contains(5)) {
            SafeParcelWriter.writeParcelable(parcel, 5, this.zzbq, r7, true);
        }
        if (set.contains(6)) {
            SafeParcelWriter.writeParcelable(parcel, 6, this.zzbr, r7, true);
        }
    ...
    @Override // com.google.android.gms.common.server.response.FastJsonResponse
    protected void setIntegerInternal(FastJsonResponse.Field<?, ?> field, String str, int r4) {
        int safeParcelableFieldId = field.getSafeParcelableFieldId();
        if (safeParcelableFieldId == 3) {
            this.zzbo = r4;
            this.zzba.add(Integer.valueOf(safeParcelableFieldId));
