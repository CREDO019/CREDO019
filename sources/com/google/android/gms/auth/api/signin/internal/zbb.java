    ...
    public final void run() {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                zba.m1093e("Unable to revoke access!", new Object[0]);
            }
            Logger logger = zba;
            StringBuilder sb = new StringBuilder(26);
            sb.append("Response Code: ");
            sb.append(responseCode);
            logger.m1095d(sb.toString(), new Object[0]);
        } catch (IOException e) {
            Logger logger2 = zba;
            String valueOf2 = String.valueOf(e.toString());
            logger2.m1093e(valueOf2.length() != 0 ? "IOException when revoking access: ".concat(valueOf2) : new String("IOException when revoking access: "), new Object[0]);
        } catch (Exception e2) {
            Logger logger3 = zba;
            String valueOf3 = String.valueOf(e2.toString());
            logger3.m1093e(valueOf3.length() != 0 ? "Exception when revoking access: ".concat(valueOf3) : new String("Exception when revoking access: "), new Object[0]);
        }
