...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    public GoogleSignInOptions(int r12, ArrayList arrayList, Account account, boolean z, boolean z2, boolean z3, String str, String str2, ArrayList arrayList2, String str3) {
        this(r12, arrayList, account, z, z2, z3, str, str2, zam(arrayList2), str3);
    }
    ...
    */
    ...
    public int hashCode() {
        ...
        for (int r3 = 0; r3 < size; r3++) {
            arrayList.add(((Scope) arrayList2.get(r3)).getScopeUri());
        }
    ...
    public void writeToParcel(Parcel parcel, int r6) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 3, getAccount(), r6, false);
    ...
    private GoogleSignInOptions(int r1, ArrayList arrayList, Account account, boolean z, boolean z2, boolean z3, String str, String str2, Map map, String str3) {
        this.zaf = r1;
        this.zah = arrayList;
        this.zai = account;
        this.zaj = z;
