...
public class InstanceID {
    ...
    public static String zzd(KeyPair keyPair) {
        try {
            ...
            digest[0] = (byte) ((digest[0] & Ascii.f1128SI) + 112);
    ...
    public final void zzd(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("X-delete", IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public String getToken(String str, String str2, Bundle bundle) throws IOException {
        ...
        if (zzf == null) {
            ...
            if (zzbu.get().booleanValue() && zze.contains(ParameterizedMessage.ERROR_MSG_SEPARATOR) && !zze.startsWith(String.valueOf(getId()).concat(ParameterizedMessage.ERROR_MSG_SEPARATOR))) {
