...
public final class zzee {
    ...
    public final void zzA(int r9, String str, Object obj, Object obj2, Object obj3) {
    ...
    public final void zzB(zzhj zzhjVar) {
        ...
        synchronized (this.zzf) {
            for (int r1 = 0; r1 < this.zzf.size(); r1++) {
                if (zzhjVar.equals(((Pair) this.zzf.get(r1)).first)) {
        ...
        synchronized (this.zzf) {
            ...
            while (true) {
                if (r1 >= this.zzf.size()) {
                    pair = null;
                    break;
                } else if (zzhjVar.equals(((Pair) this.zzf.get(r1)).first)) {
                    pair = (Pair) this.zzf.get(r1);
                    break;
                } else {
                    r1++;
                }
    ...
    public final Object zzh(int r4) {
        zzbz zzbzVar = new zzbz();
        zzU(new zzdl(this, zzbzVar, r4));
        return zzbz.zze(zzbzVar.zzb(C1856C.DEFAULT_SEEK_FORWARD_INCREMENT_MS), Object.class);
    }
