...
public class zzjy<MessageType extends zzkc<MessageType, BuilderType>, BuilderType extends zzjy<MessageType, BuilderType>> extends zzik<MessageType, BuilderType> {
    ...
    public final zzjy zzaD(byte[] bArr, int r9, int r10, zzjo zzjoVar) throws zzkm {
        if (this.zzb) {
            zzaI();
            this.zzb = false;
        }
        try {
            zzlr.zza().zzb(this.zza.getClass()).zzh(this.zza, bArr, 0, r10, new zzio(zzjoVar));
            return this;
        } catch (zzkm e) {
            throw e;
    ...
    */
    ...
    @Override // com.google.android.gms.internal.measurement.zzik
    public final /* bridge */ /* synthetic */ zzik zzaw(byte[] bArr, int r3, int r4) throws zzkm {
        zzaD(bArr, 0, r4, zzjo.zza());
        return this;
    }

    @Override // com.google.android.gms.internal.measurement.zzik
    public final /* bridge */ /* synthetic */ zzik zzax(byte[] bArr, int r2, int r3, zzjo zzjoVar) throws zzkm {
        zzaD(bArr, 0, r3, zzjoVar);
        return this;
    }
