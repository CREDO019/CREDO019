...
public class zzmh extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (r1 <= size) {
            int r2 = (r1 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzmb) this.zzb.get(r2)).zza());
            if (compareTo2 < 0) {
                size = r2 - 1;
    ...
    public final Object zzl(int r6) {
        zzn();
        Object value = ((zzmb) this.zzb.remove(r6)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzb == zzmhVar.zzb()) {
            for (int r4 = 0; r4 < zzb; r4++) {
                if (!zzg(r4).equals(zzmhVar.zzg(r4))) {
                    return false;
                }
            }
            if (zzb != size) {
    ...
    public final int hashCode() {
        ...
        for (int r1 = 0; r1 < zzb; r1++) {
            r2 += ((zzmb) this.zzb.get(r1)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int r2 = this.zza;
        if (size == r2) {
            zzmb zzmbVar = (zzmb) this.zzb.remove(r2 - 1);
            zzm().put(zzmbVar.zza(), zzmbVar.getValue());
        }
        this.zzb.add(r0, new zzmb(this, comparable, obj));
        return null;
    }
