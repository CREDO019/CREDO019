...
public interface zzccb extends IInterface {
    ...
    void zzg(IObjectWrapper iObjectWrapper, int r2) throws RemoteException;
    ...
    void zzk(IObjectWrapper iObjectWrapper, int r2) throws RemoteException;

    void zzl(IObjectWrapper iObjectWrapper) throws RemoteException;

    void zzm(IObjectWrapper iObjectWrapper, zzccc zzcccVar) throws RemoteException;
