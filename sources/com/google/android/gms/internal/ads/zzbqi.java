...
public abstract class zzbqi extends WebViewClient {
    ...
    @Override // android.webkit.WebViewClient
    public final void onReceivedError(WebView webView, int r3, String str, String str2) {
        WebViewClient delegate = getDelegate();
        if (delegate == null) {
            return;
        }
        delegate.onReceivedError(webView, r3, str, str2);
    }
    ...
    public final void onSafeBrowsingHit(WebView webView, WebResourceRequest webResourceRequest, int r4, SafeBrowsingResponse safeBrowsingResponse) {
        ...
        delegate.onSafeBrowsingHit(webView, webResourceRequest, r4, safeBrowsingResponse);
    }
