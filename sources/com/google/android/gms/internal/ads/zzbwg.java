...
public final class zzbwg implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    @Override // com.google.android.gms.ads.mediation.MediationBannerListener
    public final void onAdFailedToLoad(MediationBannerAdapter mediationBannerAdapter, int r3) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzcgn.zze("Adapter called onAdFailedToLoad with error. " + r3);
        try {
            this.zza.zzg(r3);
        } catch (RemoteException e) {
            zzcgn.zzl("#007 Could not call remote method.", e);
    ...
    public final void zze(MediationNativeAdapter mediationNativeAdapter, NativeCustomTemplateAd nativeCustomTemplateAd, String str) {
        if (nativeCustomTemplateAd instanceof zzbmv) {
            try {
                this.zza.zzr(((zzbmv) nativeCustomTemplateAd).zza(), str);
                return;
            } catch (RemoteException e) {
                zzcgn.zzl("#007 Could not call remote method.", e);
                return;
    ...
    public final void onAdFailedToLoad(MediationBannerAdapter mediationBannerAdapter, AdError adError) {
        ...
        zzcgn.zze("Adapter called onAdFailedToLoad with error. ErrorCode: " + code + ". ErrorMessage: " + message + ". ErrorDomain: " + domain);
        try {
    ...
    @Override // com.google.android.gms.ads.mediation.MediationInterstitialListener
    public final void onAdFailedToLoad(MediationInterstitialAdapter mediationInterstitialAdapter, int r3) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzcgn.zze("Adapter called onAdFailedToLoad with error " + r3 + ".");
        try {
            this.zza.zzg(r3);
    ...
    @Override // com.google.android.gms.ads.mediation.MediationNativeListener
    public final void onAdFailedToLoad(MediationNativeAdapter mediationNativeAdapter, int r3) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzcgn.zze("Adapter called onAdFailedToLoad with error " + r3 + ".");
        try {
            this.zza.zzg(r3);
