...
public final class zzbbn implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    private static final long zzc = ((Long) com.google.android.gms.ads.internal.client.zzay.zzc().zzb(zzbiy.zzbf)).longValue();
    ...
    public zzbbn(Context context, View view) {
        ...
        if (applicationContext instanceof Application) {
            ...
            this.zzj = new zzbbz(application, this);
        }
    ...
    private final int zzh(int r2) {
        return (int) (r2 / this.zzo.density);
    }

    private final void zzi(Activity activity, int r3) {
        Window window;
    ...
    */
    public final void zzj(int r33) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbbn.zzj(int):void");
    }
    ...
    private final void zzl(View view) {
        ...
        if (this.zza == null) {
            ...
            this.zza = new zzbbk(this);
            com.google.android.gms.ads.internal.zzt.zzw().zzc(this.zzd, this.zza, intentFilter);
        }
    ...
    private final void zzm(View view) {
        ...
        if (this.zza != null) {
            try {
                com.google.android.gms.ads.internal.zzt.zzw().zzd(this.zzd, this.zza);
