...
public class zzarw extends Binder implements IInterface {
    ...
    public boolean onTransact(int r2, Parcel parcel, Parcel parcel2, int r5) throws RemoteException {
        ...
        return zzbI(r2, parcel, parcel2, r5);
    }

    protected boolean zzbI(int r1, Parcel parcel, Parcel parcel2, int r4) throws RemoteException {
        throw null;
    }
}
