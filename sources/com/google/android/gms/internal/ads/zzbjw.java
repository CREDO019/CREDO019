...
public final class zzbjw {
    ...
    public static boolean zzg(Context context) {
        ...
        if (queryIntentActivities != null && resolveActivity != null) {
            for (int r2 = 0; r2 < queryIntentActivities.size(); r2++) {
                if (resolveActivity.activityInfo.name.equals(queryIntentActivities.get(r2).activityInfo.name)) {
    ...
    public final void zzb(Activity activity) {
        ...
        if (this.zzb == null && (zza = zzgvf.zza(activity)) != null) {
            ...
            this.zzc = zzgvgVar;
            CustomTabsClient.bindCustomTabsService(activity, zza, zzgvgVar);
        }
    }
