...
final class zzavp {
    ...
    public final long zze(zzauu zzauuVar, boolean z, boolean z2, int r8) throws IOException, InterruptedException {
        if (this.zzc == 0) {
            if (!zzauuVar.zzh(this.zzb, 0, 1, z)) {
                return -1L;
            }
        ...
        if (r6 != 1) {
            zzauuVar.zzh(this.zzb, 1, r6 - 1, false);
        }
        this.zzc = 0;
