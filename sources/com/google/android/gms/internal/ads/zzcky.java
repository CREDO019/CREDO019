...
public final class zzcky implements Runnable {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzcky(zzckz zzckzVar, String str, String str2, String str3, String str4) {
        this.zze = zzckzVar;
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
    ...
    public final void run() {
        ...
        if (!TextUtils.isEmpty(this.zzd)) {
            hashMap.put(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, this.zzd);
        }
