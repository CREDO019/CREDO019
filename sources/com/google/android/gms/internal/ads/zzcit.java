...
final class zzcit implements SensorEventListener {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void zza(zzcis zzcisVar) {
        this.zzh = zzcisVar;
    }
    ...
    public final void zzb() {
        ...
        this.zzg = zzfphVar;
        if (this.zza.registerListener(this, defaultSensor, 0, zzfphVar)) {
            return;
        }
