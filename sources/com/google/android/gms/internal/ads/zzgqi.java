...
interface zzgqi {
    ...
    @Deprecated
    void zzC(List list, zzgqq zzgqqVar, zzgnz zzgnzVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgqq zzgqqVar, zzgnz zzgnzVar) throws IOException;
    ...
    zzgnf zzp() throws IOException;

    @Deprecated
    Object zzr(zzgqq zzgqqVar, zzgnz zzgnzVar) throws IOException;

    Object zzs(zzgqq zzgqqVar, zzgnz zzgnzVar) throws IOException;
