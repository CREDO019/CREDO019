...
public final class zzhp implements zziu {
    ...
    private zzhp(zzhz zzhzVar) {
        this.zzyh = (zzhz) zzgt.zza(zzhzVar, "messageInfoFactory");
    }
    ...
    private static boolean zza(zzia zziaVar) {
        return zziaVar.zzhi() == zzgs.zzf.zzwt;
    }
