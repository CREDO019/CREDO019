...
public final class zzz extends zzb implements zzaa {
    ...
    public final zzy zza(IObjectWrapper iObjectWrapper, zzah zzahVar) throws RemoteException {
        zzy zzxVar;
        Parcel obtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
        zzd.zza(obtainAndWriteInterfaceToken, iObjectWrapper);
        zzd.zza(obtainAndWriteInterfaceToken, zzahVar);
        ...
        if (readStrongBinder == null) {
            ...
            if (queryLocalInterface instanceof zzy) {
                zzxVar = (zzy) queryLocalInterface;
            } else {
                zzxVar = new zzx(readStrongBinder);
            }
        }
        zza.recycle();
        return zzxVar;
