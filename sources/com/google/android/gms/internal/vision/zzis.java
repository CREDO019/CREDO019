...
public interface zzis {
    ...
    <T> T zza(zzir<T> zzirVar, zzgd zzgdVar) throws IOException;

    <T> T zza(Class<T> cls, zzgd zzgdVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzir<T> zzirVar, zzgd zzgdVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzht<K, V> zzhtVar, zzgd zzgdVar) throws IOException;

    @Deprecated
    <T> T zzb(Class<T> cls, zzgd zzgdVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzir<T> zzirVar, zzgd zzgdVar) throws IOException;

    @Deprecated
    <T> T zzc(zzir<T> zzirVar, zzgd zzgdVar) throws IOException;
