...
public enum zzcb {
    ...
    static {
        ...
        for (zzcb zzcbVar : values) {
            zzjb[zzcbVar.f264id] = zzcbVar;
        }
    }

    zzcb(int r4, zzcd zzcdVar, zzcq zzcqVar) {
        int r5;
        this.f264id = r4;
        this.zziy = zzcdVar;
        this.zzix = zzcqVar;
        int r2 = zzcc.zzje[zzcdVar.ordinal()];
        boolean z = true;
        this.zziz = (r2 == 1 || r2 == 2) ? zzcqVar.zzbq() : null;
        this.zzja = (zzcdVar != zzcd.SCALAR || (r5 = zzcc.zzjf[zzcqVar.ordinal()]) == 1 || r5 == 2 || r5 == 3) ? false : false;
    }

    /* renamed from: id */
    public final int m1087id() {
        return this.f264id;
    }
}
