...
public final class zzby<FieldDescriptorType extends zzca<FieldDescriptorType>> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zza(zzfl zzflVar, int r2, Object obj) {
        int zzr = zzbn.zzr(r2);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void zza(zzbn zzbnVar, zzfl zzflVar, int r3, Object obj) throws IOException {
        if (zzflVar == zzfl.zzql) {
    ...
    */
    ...
    private static int zzb(zzca<?> zzcaVar, Object obj) {
        ...
        if (zzcaVar.zzaw()) {
            ...
            if (zzcaVar.zzax()) {
                ...
                return zzbn.zzr(zzc) + r2 + zzbn.zzz(r2);
            }
            for (Object obj3 : list) {
                r2 += zza(zzau, zzc, obj3);
            }
            return r2;
        }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int r1 = 0; r1 < this.zzgt.zzdr(); r1++) {
            Map.Entry<FieldDescriptorType, Object> zzak = this.zzgt.zzak(r1);
    ...
    public final void zza(zzby<FieldDescriptorType> zzbyVar) {
        for (int r0 = 0; r0 < zzbyVar.zzgt.zzdr(); r0++) {
            zzc(zzbyVar.zzgt.zzak(r0));
        }
    ...
    public final int zzas() {
        int r1 = 0;
        for (int r0 = 0; r0 < this.zzgt.zzdr(); r0++) {
            Map.Entry<FieldDescriptorType, Object> zzak = this.zzgt.zzak(r0);
            r1 += zzb((zzca<?>) zzak.getKey(), zzak.getValue());
        }
        for (Map.Entry<FieldDescriptorType, Object> entry : this.zzgt.zzds()) {
            r1 += zzb((zzca<?>) entry.getKey(), entry.getValue());
        }
        return r1;
    }
    ...
    public final int zzat() {
        int r1 = 0;
        for (int r0 = 0; r0 < this.zzgt.zzdr(); r0++) {
            r1 += zzd((Map.Entry) this.zzgt.zzak(r0));
        }
        for (Map.Entry<FieldDescriptorType, Object> entry : this.zzgt.zzds()) {
            r1 += zzd((Map.Entry) entry);
        }
        return r1;
    }
