...
public final class zzp implements ClearcutLogger.zza {
    ...
    private static zzgw.zza.zzb zza(String str) {
        ...
        int indexOf2 = str.indexOf(47, r2);
        if (indexOf2 <= 0) {
        ...
        try {
            long parseLong = Long.parseLong(str.substring(r2, indexOf2));
    ...
    public final boolean zza(com.google.android.gms.clearcut.zze zzeVar) {
        ...
        int r1 = zzeVar.zzag.zzk;
        int r13 = zzeVar.zzaa != null ? zzeVar.zzaa.zzbji : 0;
        String str2 = null;
        if (!zzaw.get().booleanValue()) {
            if (str == null || str.isEmpty()) {
                str = r1 >= 0 ? String.valueOf(r1) : null;
            }
            if (str != null) {
        ...
        if (str != null) {
            ...
            for (zzgw.zza.zzb zzbVar : zzfs) {
                if (!zzbVar.zzfv() || zzbVar.getEventCode() == 0 || zzbVar.getEventCode() == r13) {
