...
public class zzei<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzei(int r1, zzej zzejVar) {
        this(r1);
    }
    ...
    private final int zza(K k) {
        ...
        while (r1 <= size) {
            int r2 = (r1 + size) / 2;
            int compareTo2 = k.compareTo((Comparable) this.zzom.get(r2).getKey());
            if (compareTo2 < 0) {
                size = r2 - 1;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <FieldDescriptorType extends zzca<FieldDescriptorType>> zzei<FieldDescriptorType, Object> zzaj(int r1) {
        return new zzej(r1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final V zzal(int r5) {
        zzdu();
        V v = (V) this.zzom.remove(r5).getValue();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof zzei) {
            ...
            for (int r4 = 0; r4 < zzdr; r4++) {
                if (!zzak(r4).equals(zzeiVar.zzak(r4))) {
                    return false;
                }
            }
            if (zzdr != size) {
    ...
    public int hashCode() {
        int zzdr = zzdr();
        int r2 = 0;
        for (int r1 = 0; r1 < zzdr; r1++) {
            r2 += this.zzom.get(r1).hashCode();
        }
        return this.zzon.size() > 0 ? r2 + this.zzon.hashCode() : r2;
    }
    ...
    public final V zza(K k, V v) {
        ...
        int r2 = this.zzol;
        if (size == r2) {
            zzep remove = this.zzom.remove(r2 - 1);
            zzdv().put((K) remove.getKey(), (V) remove.getValue());
        }
        this.zzom.add(r0, new zzep(this, k, v));
        return null;
    }

    public final Map.Entry<K, V> zzak(int r2) {
        return this.zzom.get(r2);
    }
