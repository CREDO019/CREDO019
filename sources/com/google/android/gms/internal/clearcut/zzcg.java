...
public abstract class zzcg<MessageType extends zzcg<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzas<MessageType, BuilderType> {
    ...
    static final class zze implements zzca<zze> {
        ...
        zze(zzck<?> zzckVar, int r2, zzfl zzflVar, boolean z, boolean z2) {
            this.zzjx = zzflVar;
        }
    ...
    public enum zzg {
        ...
        public static int[] m1086x126d66cb() {
            return (int[]) zzkk.clone();
        }
    }

    public static <ContainingType extends zzdo, Type> zzf<ContainingType, Type> zza(ContainingType containingtype, Type type, zzdo zzdoVar, zzck<?> zzckVar, int r10, zzfl zzflVar, Class cls) {
