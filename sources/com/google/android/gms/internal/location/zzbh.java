...
public final class zzbh extends AbstractSafeParcelable {
    ...
    public zzbh(int r1, zzbf zzbfVar, IBinder iBinder, IBinder iBinder2, PendingIntent pendingIntent, IBinder iBinder3, String str) {
        this.zza = r1;
        this.zzb = zzbfVar;
        zzai zzaiVar = null;
    ...
    public final void writeToParcel(Parcel parcel, int r7) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 2, this.zzb, r7, false);
        ...
        SafeParcelWriter.writeParcelable(parcel, 4, this.zze, r7, false);
