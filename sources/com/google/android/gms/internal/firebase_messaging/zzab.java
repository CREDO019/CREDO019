...
public final class zzab implements ObjectEncoderContext {
    ...
    private static ByteBuffer zzk(int r1) {
        return ByteBuffer.allocate(r1).order(ByteOrder.LITTLE_ENDIAN);
    }
    ...
    private final void zzn(int r6) throws IOException {
        while ((r6 & (-128)) != 0) {
            this.zzb.write((r6 & 127) | 128);
            r6 >>>= 7;
        }
        this.zzb.write(r6 & 127);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzab zzd(FieldDescriptor fieldDescriptor, int r3, boolean z) throws IOException {
        if (z && r3 == 0) {
            return this;
        }
        ...
        if (ordinal == 0) {
            ...
            zzn((zzm.zza() << 3) | 5);
            this.zzb.write(zzk(4).putInt(r3).array());
        }
        return this;
    }
    ...
    public final ObjectEncoderContext nested(String str) throws IOException {
        return nested(FieldDescriptor.m250of(str));
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public final /* bridge */ /* synthetic */ ObjectEncoderContext add(FieldDescriptor fieldDescriptor, int r3) throws IOException {
        zzd(fieldDescriptor, r3, true);
        return this;
    }
    ...
    public final ObjectEncoderContext add(String str, double d) throws IOException {
        zzb(FieldDescriptor.m250of(str), d, true);
        return this;
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public final ObjectEncoderContext add(String str, int r3) throws IOException {
        zzd(FieldDescriptor.m250of(str), r3, true);
        return this;
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public final ObjectEncoderContext add(String str, long j) throws IOException {
        zze(FieldDescriptor.m250of(str), j, true);
        return this;
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public final ObjectEncoderContext add(String str, Object obj) throws IOException {
        zza(FieldDescriptor.m250of(str), obj, true);
        return this;
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public final ObjectEncoderContext add(String str, boolean z) throws IOException {
        zzd(FieldDescriptor.m250of(str), z ? 1 : 0, true);
        return this;
    }
}
