...
public class Barcode extends AbstractSafeParcelable {
    ...
    public static class Address extends AbstractSafeParcelable {
        ...
        public Address(int r1, String[] strArr) {
            this.type = r1;
    ...
    public static class CalendarDateTime extends AbstractSafeParcelable {
        ...
        public CalendarDateTime(int r1, int r2, int r3, int r4, int r5, int r6, boolean z, String str) {
            this.year = r1;
            this.month = r2;
            this.day = r3;
            this.hours = r4;
    ...
    public static class CalendarEvent extends AbstractSafeParcelable {
        ...
        public void writeToParcel(Parcel parcel, int r6) {
            ...
            SafeParcelWriter.writeParcelable(parcel, 7, this.start, r6, false);
            SafeParcelWriter.writeParcelable(parcel, 8, this.end, r6, false);
            SafeParcelWriter.finishObjectHeader(parcel, beginObjectHeader);
        }
    }
    ...
    public static class ContactInfo extends AbstractSafeParcelable {
        ...
        public void writeToParcel(Parcel parcel, int r6) {
            int beginObjectHeader = SafeParcelWriter.beginObjectHeader(parcel);
            SafeParcelWriter.writeParcelable(parcel, 2, this.name, r6, false);
            SafeParcelWriter.writeString(parcel, 3, this.organization, false);
            SafeParcelWriter.writeString(parcel, 4, this.title, false);
            SafeParcelWriter.writeTypedArray(parcel, 5, this.phones, r6, false);
            SafeParcelWriter.writeTypedArray(parcel, 6, this.emails, r6, false);
            SafeParcelWriter.writeStringArray(parcel, 7, this.urls, false);
            SafeParcelWriter.writeTypedArray(parcel, 8, this.addresses, r6, false);
            SafeParcelWriter.finishObjectHeader(parcel, beginObjectHeader);
        }
    }
    ...
    public static class Email extends AbstractSafeParcelable {
        ...
        public Email(int r1, String str, String str2, String str3) {
            this.type = r1;
            this.address = str;
            this.subject = str2;
            this.body = str3;
    ...
    public static class Phone extends AbstractSafeParcelable {
        ...
        public Phone(int r1, String str) {
            this.type = r1;
            this.number = str;
        }
    ...
    public static class WiFi extends AbstractSafeParcelable {
        ...
        public WiFi(String str, String str2, int r3) {
            this.ssid = str;
            this.password = str2;
            this.encryptionType = r3;
        }
    ...
    public Barcode(int r1, String str, String str2, int r4, Point[] pointArr, Email email, Phone phone, Sms sms, WiFi wiFi, UrlBookmark urlBookmark, GeoPoint geoPoint, CalendarEvent calendarEvent, ContactInfo contactInfo, DriverLicense driverLicense, byte[] bArr) {
        this.format = r1;
        this.rawValue = str;
        this.rawBytes = bArr;
    ...
    public void writeToParcel(Parcel parcel, int r6) {
        ...
        SafeParcelWriter.writeTypedArray(parcel, 6, this.cornerPoints, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 7, this.email, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 8, this.phone, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 9, this.sms, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 10, this.wifi, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 11, this.url, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 12, this.geoPoint, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 13, this.calendarEvent, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 14, this.contactInfo, r6, false);
        SafeParcelWriter.writeParcelable(parcel, 15, this.driverLicense, r6, false);
    ...
    public Rect getBoundingBox() {
        ...
        while (true) {
            ...
            if (r4 < pointArr.length) {
                Point point = pointArr[r4];
                r2 = Math.min(r2, point.x);
                r0 = Math.max(r0, point.x);
                r3 = Math.min(r3, point.y);
                r1 = Math.max(r1, point.y);
                r4++;
            } else {
                return new Rect(r2, r3, r0, r1);
            }
        }
    }
}
