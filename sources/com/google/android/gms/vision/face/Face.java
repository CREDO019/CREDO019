...
public class Face {
    ...
    public Face(int r1, PointF pointF, float f, float f2, float f3, float f4, float f5, Landmark[] landmarkArr, Contour[] contourArr, float f6, float f7, float f8, float f9) {
        this.f268id = r1;
        this.zzby = pointF;
        this.width = f;
        this.height = f2;
