...
public final class zzd implements Parcelable.Creator<FaceParcel> {
    ...
    public final /* synthetic */ FaceParcel[] newArray(int r1) {
        return new FaceParcel[r1];
    }
    ...
    public final /* synthetic */ FaceParcel createFromParcel(Parcel parcel) {
        ...
        return new FaceParcel(r8, r9, f, f2, f3, f4, f5, f6, f7, landmarkParcelArr, f8, f9, f10, zzaVarArr, f11);
    }
}
