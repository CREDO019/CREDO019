...
public class FaceParcel extends AbstractSafeParcelable {
    ...
    public FaceParcel(int r1, int r2, float f, float f2, float f3, float f4, float f5, float f6, float f7, LandmarkParcel[] landmarkParcelArr, float f8, float f9, float f10, zza[] zzaVarArr, float f11) {
        this.versionCode = r1;
        this.f269id = r2;
        this.centerX = f;
        this.centerY = f2;
    ...
    public FaceParcel(int r18, int r19, float f, float f2, float f3, float f4, float f5, float f6, LandmarkParcel[] landmarkParcelArr, float f7, float f8, float f9) {
        this(r18, r19, f, f2, f3, f4, f5, f6, 0.0f, landmarkParcelArr, f7, f8, f9, new zza[0], -1.0f);
    }
    ...
    public void writeToParcel(Parcel parcel, int r6) {
        ...
        SafeParcelWriter.writeInt(parcel, 2, this.f269id);
        ...
        SafeParcelWriter.writeTypedArray(parcel, 9, this.zzdc, r6, false);
        ...
        SafeParcelWriter.writeTypedArray(parcel, 13, this.zzdd, r6, false);
