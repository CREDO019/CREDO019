...
final class zzf implements ServiceConnection {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void zza(int r6, String str) {
        if (Log.isLoggable("MessengerIpcClient", 3)) {
        ...
        zzp zzpVar = new zzp(r6, str);
        for (zzq<?> zzqVar : this.zzd) {
            zzqVar.zza(zzpVar);
        }
        this.zzd.clear();
        for (int r62 = 0; r62 < this.zze.size(); r62++) {
            this.zze.valueAt(r62).zza(zzpVar);
        }
        this.zze.clear();
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void zza(int r5) {
        zzq<?> zzqVar = this.zze.get(r5);
        if (zzqVar != null) {
