...
public class FlagProviderImpl extends com.google.android.gms.flags.zzd {
    ...
    @Override // com.google.android.gms.flags.zzc
    public boolean getBooleanFlagValue(String str, boolean z, int r3) {
        return !this.zzu ? z : zzb.zza(this.zzv, str, Boolean.valueOf(z)).booleanValue();
    }

    @Override // com.google.android.gms.flags.zzc
    public int getIntFlagValue(String str, int r2, int r3) {
        return !this.zzu ? r2 : zzd.zza(this.zzv, str, Integer.valueOf(r2)).intValue();
    }

    @Override // com.google.android.gms.flags.zzc
    public long getLongFlagValue(String str, long j, int r4) {
        return !this.zzu ? j : zzf.zza(this.zzv, str, Long.valueOf(j)).longValue();
    }

    @Override // com.google.android.gms.flags.zzc
    public String getStringFlagValue(String str, String str2, int r3) {
