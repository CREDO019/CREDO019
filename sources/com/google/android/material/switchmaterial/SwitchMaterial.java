...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C2151R.C2157style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2151R.attr.switchStyle);
    }
    ...
    */
    public SwitchMaterial(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            ...
            int[] r2 = com.google.android.material.C2151R.styleable.SwitchMaterial
            r7 = 0
            int[] r5 = new int[r7]
            r1 = r8
            r3 = r9
            android.content.res.TypedArray r8 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r9 = com.google.android.material.C2151R.styleable.SwitchMaterial_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C2151R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C2151R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C2151R.dimen.mtrl_switch_thumb_elevation);
            ...
            r4[0] = MaterialColors.layer(color, color2, 1.0f);
            r4[1] = compositeOverlayIfNeeded;
            r4[2] = MaterialColors.layer(color, color2, 0.38f);
            r4[3] = compositeOverlayIfNeeded;
            this.materialThemeColorsThumbTintList = new ColorStateList(r3, r4);
        }
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            int[][] r0 = ENABLED_CHECKED_STATES;
            int[] r1 = new int[r0.length];
            int color = MaterialColors.getColor(this, C2151R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C2151R.attr.colorControlActivated);
            int color3 = MaterialColors.getColor(this, C2151R.attr.colorOnSurface);
            r1[0] = MaterialColors.layer(color, color2, 0.54f);
            r1[1] = MaterialColors.layer(color, color3, 0.32f);
            r1[2] = MaterialColors.layer(color, color2, 0.12f);
            r1[3] = MaterialColors.layer(color, color3, 0.12f);
            this.materialThemeColorsTrackTintList = new ColorStateList(r0, r1);
        }
