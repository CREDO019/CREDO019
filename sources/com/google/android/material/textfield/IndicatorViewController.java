...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = context.getResources().getDimensionPixelSize(C2151R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void showHelper(CharSequence charSequence) {
        ...
        int r0 = this.captionDisplayed;
        if (r0 != 2) {
            this.captionToShow = 2;
        }
        updateCaptionViewsVisibility(r0, this.captionToShow, shouldAnimateCaptionView(this.helperTextView, charSequence));
    }
    ...
    void hideHelperText() {
        ...
        updateCaptionViewsVisibility(r0, this.captionToShow, shouldAnimateCaptionView(this.helperTextView, null));
    }
    ...
    public void showError(CharSequence charSequence) {
        ...
        updateCaptionViewsVisibility(r0, this.captionToShow, shouldAnimateCaptionView(this.errorView, charSequence));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void addIndicator(TextView textView, int r8) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void removeIndicator(TextView textView, int r3) {
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C2151R.C2155id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C2151R.C2155id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
    ...
    public void setErrorTextAppearance(int r3) {
        this.errorTextAppearance = r3;
        TextView textView = this.errorView;
        if (textView != null) {
            this.textInputView.setTextAppearanceCompatWithErrorFallback(textView, r3);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setHelperTextAppearance(int r2) {
        this.helperTextTextAppearance = r2;
        TextView textView = this.helperTextView;
        if (textView != null) {
            TextViewCompat.setTextAppearance(textView, r2);
        }
    }
}
