...
public class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    public PasswordToggleEndIconDelegate(TextInputLayout textInputLayout) {
        ...
        this.onEndIconChangedListener = new TextInputLayout.OnEndIconChangedListener() { // from class: com.google.android.material.textfield.PasswordToggleEndIconDelegate.3
            ...
            public void onEndIconChanged(TextInputLayout textInputLayout2, int r3) {
                EditText editText = textInputLayout2.getEditText();
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C2151R.C2154drawable.design_password_eye));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C2151R.string.password_toggle_content_description));
