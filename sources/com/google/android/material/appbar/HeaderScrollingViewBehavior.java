...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(CoordinatorLayout coordinatorLayout, View view, int r10, int r11, int r12, int r13) {
        View findFirstDependency;
        WindowInsetsCompat lastWindowInsets;
        int r0 = view.getLayoutParams().height;
        if ((r0 == -1 || r0 == -2) && (findFirstDependency = findFirstDependency(coordinatorLayout.getDependencies(view))) != null) {
            ...
            coordinatorLayout.onMeasureChild(view, r10, r11, View.MeasureSpec.makeMeasureSpec(scrollRange, r0 == -1 ? 1073741824 : Integer.MIN_VALUE), r13);
            return true;
        }
        return false;
    }
    ...
    public void layoutChild(CoordinatorLayout coordinatorLayout, View view, int r11) {
    ...
    public final int getOverlapPixelsForOffset(View view) {
        ...
        int r0 = this.overlayTop;
        return MathUtils.clamp((int) (overlapRatioForOffset * r0), 0, r0);
    }
