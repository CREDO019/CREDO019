...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int r9) {
        return setHeaderTopBottomOffset(coordinatorLayout, v, r9, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final int scroll(CoordinatorLayout coordinatorLayout, V v, int r10, int r11, int r12) {
