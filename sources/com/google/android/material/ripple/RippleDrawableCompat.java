...
public class RippleDrawableCompat extends Drawable implements Shapeable, TintAwareDrawable {
    ...
    public void setTint(int r2) {
        this.drawableState.delegate.setTint(r2);
    }
    ...
    protected boolean onStateChange(int[] r4) {
        boolean onStateChange = super.onStateChange(r4);
        if (this.drawableState.delegate.setState(r4)) {
            onStateChange = true;
        }
        boolean shouldDrawRippleCompat = RippleUtils.shouldDrawRippleCompat(r4);
    ...
    public void setAlpha(int r2) {
        this.drawableState.delegate.setAlpha(r2);
    }
