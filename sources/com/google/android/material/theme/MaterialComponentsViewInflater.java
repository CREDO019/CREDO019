...
public class MaterialComponentsViewInflater extends AppCompatViewInflater {
    ...
    protected boolean shouldInflateAppCompatButton(Context context, AttributeSet attributeSet) {
        if (Build.VERSION.SDK_INT == 23 || Build.VERSION.SDK_INT == 24 || Build.VERSION.SDK_INT == 25) {
            ...
            int r6 = floatingToolbarItemBackgroundResId;
            if (r6 != 0 && r6 != -1) {
                for (int r62 = 0; r62 < attributeSet.getAttributeCount(); r62++) {
                    if (attributeSet.getAttributeNameResource(r62) == 16842964) {
                        if (floatingToolbarItemBackgroundResId == attributeSet.getAttributeListValue(r62, null, 0)) {
                            return true;
                        }
                    }
                }
