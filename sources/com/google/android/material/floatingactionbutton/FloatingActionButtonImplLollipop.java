...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.floatingactionbutton.FloatingActionButtonImpl
    public void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int r6) {
        Drawable drawable;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.floatingactionbutton.FloatingActionButtonImpl
    public void onDrawableStateChanged(int[] r3) {
        if (Build.VERSION.SDK_INT == 21) {
    ...
    BorderDrawable createBorderDrawable(int r7, ColorStateList colorStateList) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C2151R.C2153color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C2151R.C2153color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C2151R.C2153color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C2151R.C2153color.design_fab_stroke_end_outer_color));
        borderDrawable.setBorderWidth(r7);
