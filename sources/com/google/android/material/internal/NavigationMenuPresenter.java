...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(C2151R.dimen.design_navigation_separator_vertical_padding);
    }

    @Override // androidx.appcompat.view.menu.MenuPresenter
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(C2151R.layout.design_navigation_menu, viewGroup, false);
            ...
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C2151R.layout.design_navigation_item_header, (ViewGroup) this.menuView, false);
    ...
    public View inflateHeaderView(int r4) {
        View inflate = this.layoutInflater.inflate(r4, (ViewGroup) this.headerLayout, false);
    ...
    public View getHeaderView(int r2) {
        return this.headerLayout.getChildAt(r2);
    }
    ...
    public static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, View.OnClickListener onClickListener) {
            super(layoutInflater.inflate(C2151R.layout.design_navigation_item, viewGroup, false));
    ...
    public static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C2151R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }
    ...
    public static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C2151R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }
            ...
            for (int r5 = 0; r5 < size; r5++) {
                ...
                if (menuItemImpl.hasSubMenu()) {
                    ...
                    if (groupId != r2) {
                        ...
                        appendTransparentIconIfMissing(r7, this.items.size());
                        z = true;
                    }
