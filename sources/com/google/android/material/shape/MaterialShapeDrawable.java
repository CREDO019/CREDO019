...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f) {
        int color = MaterialColors.getColor(context, C2151R.attr.colorSurface, "MaterialShapeDrawable");
    ...
    private MaterialShapeDrawable(MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathShadowListener = new ShapeAppearancePathProvider.PathListener() { // from class: com.google.android.material.shape.MaterialShapeDrawable.1
            ...
            public void onCornerPathCreated(ShapePath shapePath, Matrix matrix, int r4) {
                MaterialShapeDrawable.this.cornerShadowOperation[r4] = shapePath.createShadowCompatOperation(matrix);
            }

            @Override // com.google.android.material.shape.ShapeAppearancePathProvider.PathListener
            public void onEdgePathCreated(ShapePath shapePath, Matrix matrix, int r4) {
                MaterialShapeDrawable.this.edgeShadowOperation[r4] = shapePath.createShadowCompatOperation(matrix);
            }
        };
    }
    ...
    public void setShadowRadius(int r2) {
        this.drawableState.shadowCompatRadius = r2;
    }
