...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f293x = f;
        pathLineOperation.f294y = f2;
        ...
        return new ShadowCompatOperation() { // from class: com.google.android.material.shape.ShapePath.1
            ...
            public void draw(Matrix matrix2, ShadowRenderer shadowRenderer, int r5, Canvas canvas) {
                for (ShadowCompatOperation shadowCompatOperation : arrayList) {
                    shadowCompatOperation.draw(matrix, shadowRenderer, r5, canvas);
                }
            }
        };
    }
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int r8, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f294y - this.startY, this.operation.f293x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f294y - this.startY) / (this.operation.f293x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f293x, this.f294y);
