...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C2151R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C2151R.attr.materialCalendarStyle, C2151R.C2157style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C2151R.layout.mtrl_picker_fullscreen : C2151R.layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C2151R.C2155id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C2151R.C2155id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C2151R.C2155id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) inflate.findViewById(C2151R.C2155id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C2151R.C2155id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C2151R.C2155id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C2151R.C2155id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C2151R.C2155id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C2151R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C2151R.string.mtrl_picker_announce_current_selection), headerText));
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C2151R.C2155id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            string = checkableImageButton.getContext().getString(C2151R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            string = checkableImageButton.getContext().getString(C2151R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C2151R.C2154drawable.ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C2151R.C2154drawable.ic_edit_black_24dp));
        return stateListDrawable;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isFullscreen(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C2151R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{16843277});
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C2151R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C2151R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C2151R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C2151R.dimen.mtrl_calendar_days_of_week_height);
        return dimensionPixelSize + dimensionPixelSize2 + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C2151R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C2151R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C2151R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C2151R.dimen.mtrl_calendar_content_padding);
        int r1 = Month.today().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C2151R.dimen.mtrl_calendar_day_width) * r1) + ((r1 - 1) * resources.getDimensionPixelOffset(C2151R.dimen.mtrl_calendar_month_horizontal_padding));
    }
