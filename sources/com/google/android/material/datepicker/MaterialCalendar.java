...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T> MaterialCalendar<T> newInstance(DateSelector<T> dateSelector, int r4, CalendarConstraints calendarConstraints) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            r1 = C2151R.layout.mtrl_calendar_vertical;
            r9 = 1;
        } else {
            r1 = C2151R.layout.mtrl_calendar_horizontal;
            r9 = 0;
        }
        View inflate = cloneInContext.inflate(r1, viewGroup, false);
        GridView gridView = (GridView) inflate.findViewById(C2151R.C2155id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) inflate.findViewById(C2151R.C2155id.mtrl_calendar_months);
        this.recyclerView.setLayoutManager(new SmoothCalendarLayoutManager(getContext(), r9, false) { // from class: com.google.android.material.datepicker.MaterialCalendar.2
            ...
            public void calculateExtraLayoutSpace(RecyclerView.State state, int[] r4) {
                if (r9 == 0) {
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C2151R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) inflate.findViewById(C2151R.C2155id.mtrl_calendar_year_selector_frame);
        ...
        if (inflate.findViewById(C2151R.C2155id.month_navigation_fragment_toggle) != null) {
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    for (Pair<Long, Long> pair : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        if (pair.first != null && pair.second != null) {
                            ...
                            int r8 = spanCount;
                            while (r8 <= spanCount2) {
                                View findViewByPosition3 = gridLayoutManager.findViewByPosition(gridLayoutManager.getSpanCount() * r8);
                                if (findViewByPosition3 != null) {
                                    ...
                                    int left = r8 == spanCount ? findViewByPosition.getLeft() + (findViewByPosition.getWidth() / 2) : 0;
                                    if (r8 == spanCount2) {
    ...
    public static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C2151R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C2151R.C2155id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(C2151R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = MaterialCalendar.this.getString(C2151R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(string);
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C2151R.C2155id.month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(C2151R.C2155id.month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C2151R.C2155id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C2151R.C2155id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
