...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    protected FabTransformationBehavior.FabTransformationSpec onCreateMotionSpec(Context context, boolean z) {
        int r4;
        if (z) {
            r4 = C2151R.C2152animator.mtrl_fab_transformation_sheet_expand_spec;
        } else {
            r4 = C2151R.C2152animator.mtrl_fab_transformation_sheet_collapse_spec;
        }
        FabTransformationBehavior.FabTransformationSpec fabTransformationSpec = new FabTransformationBehavior.FabTransformationSpec();
        fabTransformationSpec.timings = MotionSpec.createFromResource(context, r4);
