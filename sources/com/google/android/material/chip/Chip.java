...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2151R.attr.chipStyle);
    }

    public Chip(Context context, AttributeSet attributeSet, int r11) {
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, r11, C2151R.C2157style.Widget_MaterialComponents_Chip_Action);
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2151R.styleable.Chip, r11, C2151R.C2157style.Widget_MaterialComponents_Chip_Action, new int[0]);
        if (Build.VERSION.SDK_INT < 23) {
            setTextColor(MaterialResources.getColorStateList(context, obtainStyledAttributes, C2151R.styleable.Chip_android_textColor));
        }
        boolean hasValue = obtainStyledAttributes.hasValue(C2151R.styleable.Chip_shapeAppearance);
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int r10) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2151R.styleable.Chip, r10, C2151R.C2157style.Widget_MaterialComponents_Chip_Action, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(C2151R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(obtainStyledAttributes.getDimension(C2151R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48))));
        obtainStyledAttributes.recycle();
    }
    ...
    */
    ...
    @Override // android.widget.TextView, android.view.View
    protected void onFocusChanged(boolean z, int r3, Rect rect) {
        super.onFocusChanged(z, r3, rect);
        this.touchHelper.onFocusChanged(z, r3, rect);
    }
        ...
        protected void onPopulateNodeForVirtualView(int r7, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (r7 == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int r3 = C2151R.string.mtrl_chip_close_icon_content_description;
    ...
    public void setChipBackgroundColorResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipBackgroundColorResource(r2);
        }
    }
    ...
    public void setChipMinHeightResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipMinHeightResource(r2);
        }
    }
    ...
    public void setChipCornerRadiusResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipCornerRadiusResource(r2);
        }
    }
    ...
    public void setChipStrokeColorResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipStrokeColorResource(r2);
        }
    }
    ...
    public void setChipStrokeWidthResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipStrokeWidthResource(r2);
        }
    }
    ...
    public void setChipIconVisible(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipIconVisible(r2);
        }
    }
    ...
    public void setChipIconResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipIconResource(r2);
        }
    }
    ...
    public void setChipIconTintResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipIconTintResource(r2);
        }
    }
    ...
    public void setChipIconSizeResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipIconSizeResource(r2);
        }
    }
    ...
    public void setCloseIconTintResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconTintResource(r2);
        }
    }
    ...
    public void setCloseIconSizeResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconSizeResource(r2);
        }
    }
    ...
    public void setCheckableResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCheckableResource(r2);
        }
    }
    ...
    public void setCheckedIconVisible(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCheckedIconVisible(r2);
        }
    }
    ...
    public void setCheckedIconResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCheckedIconResource(r2);
        }
    }
    ...
    public void setShowMotionSpecResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setShowMotionSpecResource(r2);
        }
    }
    ...
    public void setHideMotionSpecResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setHideMotionSpecResource(r2);
        }
    }
    ...
    public void setChipStartPaddingResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipStartPaddingResource(r2);
        }
    }
    ...
    public void setIconStartPaddingResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setIconStartPaddingResource(r2);
        }
    }
    ...
    public void setIconEndPaddingResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setIconEndPaddingResource(r2);
        }
    }
    ...
    public void setTextStartPaddingResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setTextStartPaddingResource(r2);
        }
    }
    ...
    public void setTextEndPaddingResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setTextEndPaddingResource(r2);
        }
    }
    ...
    public void setCloseIconStartPaddingResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconStartPaddingResource(r2);
        }
    }
    ...
    public void setCloseIconEndPaddingResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconEndPaddingResource(r2);
        }
    }
    ...
    public void setChipEndPaddingResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipEndPaddingResource(r2);
        }
    }
    ...
    public boolean ensureAccessibleTouchTarget(int r6) {
        ...
        int max = Math.max(0, r6 - this.chipDrawable.getIntrinsicHeight());
        int max2 = Math.max(0, r6 - this.chipDrawable.getIntrinsicWidth());
        if (max2 <= 0 && max <= 0) {
            removeBackgroundInset();
            return false;
        }
        int r2 = max2 > 0 ? max2 / 2 : 0;
        int r1 = max > 0 ? max / 2 : 0;
        if (this.insetBackgroundDrawable != null) {
            Rect rect = new Rect();
            this.insetBackgroundDrawable.getPadding(rect);
            if (rect.top == r1 && rect.bottom == r1 && rect.left == r2 && rect.right == r2) {
                return true;
            }
        }
        ...
        insetChipBackgroundDrawable(r2, r1, r2, r1);
        return true;
    }
