...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C2151R.C2157style.Widget_MaterialComponents_BottomAppBar;
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2151R.attr.bottomAppBarStyle);
    }
    ...
    */
    public BottomAppBar(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        /*
            ...
            int[] r2 = com.google.android.material.C2151R.styleable.BottomAppBar
            int[] r5 = new int[r6]
            r0 = r7
            r1 = r10
            r3 = r11
            ...
            int r11 = com.google.android.material.C2151R.styleable.BottomAppBar_backgroundTint
            ...
            int r0 = com.google.android.material.C2151R.styleable.BottomAppBar_elevation
            int r0 = r10.getDimensionPixelSize(r0, r6)
            int r1 = com.google.android.material.C2151R.styleable.BottomAppBar_fabCradleMargin
            int r1 = r10.getDimensionPixelOffset(r1, r6)
            float r1 = (float) r1
            int r2 = com.google.android.material.C2151R.styleable.BottomAppBar_fabCradleRoundedCornerRadius
            int r2 = r10.getDimensionPixelOffset(r2, r6)
            float r2 = (float) r2
            int r3 = com.google.android.material.C2151R.styleable.BottomAppBar_fabCradleVerticalOffset
            int r3 = r10.getDimensionPixelOffset(r3, r6)
            float r3 = (float) r3
            int r4 = com.google.android.material.C2151R.styleable.BottomAppBar_fabAlignmentMode
            int r4 = r10.getInt(r4, r6)
            r8.fabAlignmentMode = r4
            int r4 = com.google.android.material.C2151R.styleable.BottomAppBar_fabAnimationMode
            int r4 = r10.getInt(r4, r6)
            r8.fabAnimationMode = r4
            int r4 = com.google.android.material.C2151R.styleable.BottomAppBar_hideOnScroll
            boolean r4 = r10.getBoolean(r4, r6)
            r8.hideOnScroll = r4
            r10.recycle()
            android.content.res.Resources r10 = r8.getResources()
            int r4 = com.google.android.material.C2151R.dimen.mtrl_bottomappbar_fabOffsetEndMode
    ...
    */
    ...
    private void createFabTranslationXAnimation(int r4, List<Animator> list) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(findDependentFab(), "translationX", getFabTranslationX(r4));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public float getFabTranslationX(int r4) {
            ...
            this.fabLayoutListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.Behavior.1
                ...
                public void onLayoutChange(View view, int r2, int r3, int r4, int r5, int r6, int r7, int r8, int r9) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        int dimensionPixelOffset = bottomAppBar.getResources().getDimensionPixelOffset(C2151R.dimen.mtrl_bottomappbar_fab_bottom_margin);
