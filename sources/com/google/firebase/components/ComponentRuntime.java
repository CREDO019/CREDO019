...
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection) {
        ...
        arrayList.add(Component.m253of(eventBus, EventBus.class, Subscriber.class, Publisher.class));
        arrayList.add(Component.m253of(this, ComponentLoader.class, new Class[0]));
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.ComponentRuntime$$ExternalSyntheticLambda1
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return ComponentRuntime.this.m252xc080f8d8(component);
                    }
                }));
            }
    ...
    public /* synthetic */ Object m252xc080f8d8(Component component) {
    ...
    public <T> Deferred<T> getDeferred(Class<T> cls) {
        ...
        return OptionalProvider.m251of(provider);
    }
