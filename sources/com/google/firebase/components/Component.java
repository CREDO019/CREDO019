...
public final class Component<T> {
    ...
    private Component(Set<Class<? super T>> set, Set<Dependency> set2, int r3, int r4, ComponentFactory<T> componentFactory, Set<Class<?>> set3) {
        this.providedInterfaces = Collections.unmodifiableSet(set);
        this.dependencies = Collections.unmodifiableSet(set2);
        this.instantiation = r3;
        this.type = r4;
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m254of(Class<T> cls, final T t) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m253of(final T t, Class<T> cls, Class<? super T>... clsArr) {
    ...
    public static class Builder<T> {
        ...
        private Builder<T> setInstantiation(int r3) {
