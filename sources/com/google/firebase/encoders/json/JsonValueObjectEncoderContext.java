...
public final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, int r3) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(r3);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, int r2) throws IOException {
        return add(fieldDescriptor.getName(), r2);
    }
    ...
    @Override // com.google.firebase.encoders.ValueEncoderContext
    public JsonValueObjectEncoderContext add(int r4) throws IOException {
        maybeUnNest();
        this.jsonWriter.value(r4);
        return this;
    }
