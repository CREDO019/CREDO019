...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(ComponentDiscovery.forContext(context, ComponentDiscoveryService.class).discoverLazy()).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m253of(context, Context.class, new Class[0])).addComponent(Component.m253of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m253of(firebaseOptions, FirebaseOptions.class, new Class[0])).build();
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return FirebaseApp.this.m1516lambda$new$0$comgooglefirebaseFirebaseApp(context);
            }
        });
    }
    ...
    public /* synthetic */ DataCollectionConfigStorage m1516lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
