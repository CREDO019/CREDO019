...
public final class CommonNotificationBuilder {
    ...
    public static class DisplayNotificationInfo {
        ...
        /* renamed from: id */
        public final int f1208id = 0;
        public final NotificationCompat.Builder notificationBuilder;
        public final String tag;

        DisplayNotificationInfo(NotificationCompat.Builder builder, String str, int r3) {
    ...
    private static Integer getColor(Context context, String str, Bundle bundle) {
        ...
        int r5 = bundle.getInt(METADATA_DEFAULT_COLOR, 0);
        if (r5 != 0) {
            try {
                return Integer.valueOf(ContextCompat.getColor(context, r5));
    ...
    private static int getPendingIntentFlags(int r1) {
    ...
    private static int getSmallIcon(PackageManager packageManager, Resources resources, String str, String str2, Bundle bundle) {
        ...
        int r6 = bundle.getInt(METADATA_DEFAULT_ICON, 0);
        if (r6 == 0 || !isValidIcon(resources, r6)) {
            try {
                r6 = packageManager.getApplicationInfo(str, 0).icon;
            } catch (PackageManager.NameNotFoundException e) {
                String valueOf = String.valueOf(e);
    ...
    private static boolean isValidIcon(Resources resources, int r5) {
        if (Build.VERSION.SDK_INT != 26) {
            return true;
        }
        try {
            if (resources.getDrawable(r5, null) instanceof AdaptiveIconDrawable) {
