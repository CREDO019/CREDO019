...
public class MessagingAnalytics {
    ...
    static String getInstanceId(Bundle bundle) {
        String string = bundle.getString(Constants.MessagePayloadKeys.f1209TO);
    ...
    static long getProjectNumber(Bundle bundle) {
        ...
        if (!applicationId.startsWith("1:")) {
            ...
            String[] split = applicationId.split(ParameterizedMessage.ERROR_MSG_SEPARATOR);
            if (split.length < 2) {
                return 0L;
            }
            String str = split[1];
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, TransportFactory transportFactory) {
        ...
        try {
            Transport transport = transportFactory.getTransport(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, Encoding.m1235of("proto"), MessagingAnalytics$$Lambda$0.$instance);
    ...
    private static void setUserPropertyIfRequired(Bundle bundle) {
        ...
        if (IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(bundle.getString(Constants.AnalyticsKeys.TRACK_CONVERSIONS))) {
            ...
            if (analyticsConnector != null) {
                ...
                bundle2.putString(Constants.ScionAnalytics.PARAM_MEDIUM, OneSignalDbContract.NotificationTable.TABLE_NAME);
