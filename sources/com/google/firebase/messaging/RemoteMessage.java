...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                bundle.putString(Constants.MessagePayloadKeys.f1209TO, str);
            }
        }
    ...
    public static class Notification {
        ...
        private static String[] getLocalizationArgs(NotificationParams notificationParams, String str) {
            ...
            for (int r0 = 0; r0 < localizationArgsForKey.length; r0++) {
                strArr[r0] = String.valueOf(localizationArgsForKey[r0]);
            }
            return strArr;
        }
    ...
    public String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f1209TO);
    }
    ...
    public void writeToParcel(Parcel parcel, int r2) {
        RemoteMessageCreator.writeToParcel(this, parcel, r2);
    }
}
