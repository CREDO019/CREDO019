...
public @interface JsonFormat {
    ...
    public static class Features {
        ...
        private Features(int r1, int r2) {
            this._enabled = r1;
            this._disabled = r2;
        }
        ...
        public static Features construct(Feature[] featureArr, Feature[] featureArr2) {
            ...
            for (Feature feature : featureArr) {
                r3 |= 1 << feature.ordinal();
            }
            int r0 = 0;
            for (Feature feature2 : featureArr2) {
                r0 |= 1 << feature2.ordinal();
            }
            return new Features(r3, r0);
        }
        ...
        public Features withOverrides(Features features) {
            ...
            int r0 = features._disabled;
            int r1 = features._enabled;
            if (r0 == 0 && r1 == 0) {
                return this;
            }
            int r2 = this._enabled;
            if (r2 == 0 && this._disabled == 0) {
                return features;
            }
            int r5 = ((~r0) & r2) | r1;
            int r3 = this._disabled;
            int r02 = r0 | ((~r1) & r3);
            return (r5 == r2 && r02 == r3) ? this : new Features(r5, r02);
        }

        public Features with(Feature... featureArr) {
            int r0 = this._enabled;
            for (Feature feature : featureArr) {
                r0 |= 1 << feature.ordinal();
            }
            return r0 == this._enabled ? this : new Features(r0, this._disabled);
        }

        public Features without(Feature... featureArr) {
            int r0 = this._disabled;
            for (Feature feature : featureArr) {
                r0 |= 1 << feature.ordinal();
            }
            return r0 == this._disabled ? this : new Features(this._enabled, r0);
        }
