...
public class DefaultPrettyPrinter implements PrettyPrinter, Instantiatable<DefaultPrettyPrinter>, Serializable {
    ...
    public interface Indenter {
        ...
        void writeIndentation(JsonGenerator jsonGenerator, int r2) throws IOException;
    }
    ...
    public static class NopIndenter implements Indenter, Serializable {
        ...
        @Override // com.fasterxml.jackson.core.util.DefaultPrettyPrinter.Indenter
        public void writeIndentation(JsonGenerator jsonGenerator, int r2) throws IOException {
        }
    }
    ...
    @Override // com.fasterxml.jackson.core.PrettyPrinter
    public void writeEndObject(JsonGenerator jsonGenerator, int r3) throws IOException {
        if (!this._objectIndenter.isInline()) {
            this._nesting--;
        }
        if (r3 > 0) {
    ...
    @Override // com.fasterxml.jackson.core.PrettyPrinter
    public void writeEndArray(JsonGenerator jsonGenerator, int r3) throws IOException {
        if (!this._arrayIndenter.isInline()) {
            this._nesting--;
        }
        if (r3 > 0) {
