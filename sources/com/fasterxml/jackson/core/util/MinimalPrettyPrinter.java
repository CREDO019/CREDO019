...
public class MinimalPrettyPrinter implements PrettyPrinter, Serializable {
    ...
    @Override // com.fasterxml.jackson.core.PrettyPrinter
    public void writeEndObject(JsonGenerator jsonGenerator, int r2) throws IOException, JsonGenerationException {
        jsonGenerator.writeRaw('}');
    }
    ...
    @Override // com.fasterxml.jackson.core.PrettyPrinter
    public void writeEndArray(JsonGenerator jsonGenerator, int r2) throws IOException, JsonGenerationException {
        jsonGenerator.writeRaw(']');
    }
}
