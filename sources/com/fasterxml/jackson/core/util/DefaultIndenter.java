...
public class DefaultIndenter extends DefaultPrettyPrinter.NopIndenter {
    ...
    public DefaultIndenter(String str, String str2) {
        ...
        for (int r2 = 0; r2 < 16; r2++) {
            str.getChars(0, str.length(), this.indents, r3);
            r3 += str.length();
        }
        this.eol = str2;
    }
    ...
    @Override // com.fasterxml.jackson.core.util.DefaultPrettyPrinter.NopIndenter, com.fasterxml.jackson.core.util.DefaultPrettyPrinter.Indenter
    public void writeIndentation(JsonGenerator jsonGenerator, int r5) throws IOException {
        jsonGenerator.writeRaw(this.eol);
        if (r5 <= 0) {
            return;
        }
        int r52 = r5 * this.charsPerLevel;
        while (true) {
            char[] cArr = this.indents;
            if (r52 > cArr.length) {
                jsonGenerator.writeRaw(cArr, 0, cArr.length);
                r52 -= this.indents.length;
            } else {
                jsonGenerator.writeRaw(cArr, 0, r52);
                return;
            }
        }
    }
