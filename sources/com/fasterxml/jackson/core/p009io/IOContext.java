...
public class IOContext {
    ...
    public byte[] allocReadIOBuffer(int r3) {
        _verifyAlloc(this._readIOBuffer);
        byte[] allocByteBuffer = this._bufferRecycler.allocByteBuffer(0, r3);
        this._readIOBuffer = allocByteBuffer;
        return allocByteBuffer;
    }
    ...
    public byte[] allocWriteEncodingBuffer(int r3) {
        _verifyAlloc(this._writeEncodingBuffer);
        byte[] allocByteBuffer = this._bufferRecycler.allocByteBuffer(1, r3);
        this._writeEncodingBuffer = allocByteBuffer;
        return allocByteBuffer;
    }
    ...
    public char[] allocTokenBuffer(int r3) {
        _verifyAlloc(this._tokenCBuffer);
        char[] allocCharBuffer = this._bufferRecycler.allocCharBuffer(0, r3);
        this._tokenCBuffer = allocCharBuffer;
        return allocCharBuffer;
    }
    ...
    public char[] allocNameCopyBuffer(int r3) {
        _verifyAlloc(this._nameCopyBuffer);
        char[] allocCharBuffer = this._bufferRecycler.allocCharBuffer(3, r3);
