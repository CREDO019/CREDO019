...
public class SerializedString implements SerializableString, Serializable {
    ...
    @Override // com.fasterxml.jackson.core.SerializableString
    public int appendQuotedUTF8(byte[] bArr, int r6) {
        ...
        if (r6 + length > bArr.length) {
            return -1;
        }
        System.arraycopy(bArr2, 0, bArr, r6, length);
        return length;
    }

    @Override // com.fasterxml.jackson.core.SerializableString
    public int appendQuoted(char[] cArr, int r6) {
        ...
        if (r6 + length > cArr.length) {
            return -1;
        }
        System.arraycopy(cArr2, 0, cArr, r6, length);
        return length;
    }

    @Override // com.fasterxml.jackson.core.SerializableString
    public int appendUnquotedUTF8(byte[] bArr, int r6) {
    ...
    @Override // com.fasterxml.jackson.core.SerializableString
    public int appendUnquoted(char[] cArr, int r6) {
        String str = this._value;
        int length = str.length();
        if (r6 + length > cArr.length) {
            return -1;
        }
        str.getChars(0, length, cArr, r6);
        return length;
    }
