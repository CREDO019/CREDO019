...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    @Deprecated
    public abstract JsonGenerator setFeatureMask(int r1);
    ...
    public abstract int writeBinary(Base64Variant base64Variant, InputStream inputStream, int r3) throws IOException;

    public abstract void writeBinary(Base64Variant base64Variant, byte[] bArr, int r3, int r4) throws IOException;
    ...
    public abstract void writeNumber(int r1) throws IOException;
    ...
    public abstract void writeRaw(String str, int r2, int r3) throws IOException;

    public abstract void writeRaw(char[] cArr, int r2, int r3) throws IOException;

    public abstract void writeRawUTF8String(byte[] bArr, int r2, int r3) throws IOException;

    public abstract void writeRawValue(String str) throws IOException;

    public abstract void writeRawValue(String str, int r2, int r3) throws IOException;

    public abstract void writeRawValue(char[] cArr, int r2, int r3) throws IOException;
    ...
    public abstract void writeString(char[] cArr, int r2, int r3) throws IOException;

    public abstract void writeTree(TreeNode treeNode) throws IOException;

    public abstract void writeUTF8String(byte[] bArr, int r2, int r3) throws IOException;
    ...
    public enum Feature {
        ...
        public boolean enabledIn(int r2) {
    ...
    public JsonGenerator overrideStdFeatures(int r3, int r4) {
        return setFeatureMask((r3 & r4) | (getFeatureMask() & (~r4)));
    }
    ...
    public void writeStartArray(int r1) throws IOException {
        writeStartArray();
    }
    ...
    public void writeArray(int[] r2, int r3, int r4) throws IOException {
        ...
        _verifyOffsets(r2.length, r3, r4);
        writeStartArray();
        int r42 = r4 + r3;
        while (r3 < r42) {
            writeNumber(r2[r3]);
    ...
    public void writeArray(long[] jArr, int r4, int r5) throws IOException {
        if (jArr == null) {
            throw new IllegalArgumentException("null array");
        }
        _verifyOffsets(jArr.length, r4, r5);
        writeStartArray();
        int r52 = r5 + r4;
        while (r4 < r52) {
            writeNumber(jArr[r4]);
    ...
    public void writeArray(double[] dArr, int r4, int r5) throws IOException {
        if (dArr == null) {
            throw new IllegalArgumentException("null array");
        }
        _verifyOffsets(dArr.length, r4, r5);
        writeStartArray();
        int r52 = r5 + r4;
        while (r4 < r52) {
            writeNumber(dArr[r4]);
    ...
    public void writeBinary(byte[] bArr, int r3, int r4) throws IOException {
        writeBinary(Base64Variants.getDefaultVariant(), bArr, r3, r4);
    }
    ...
    public int writeBinary(InputStream inputStream, int r3) throws IOException {
        return writeBinary(Base64Variants.getDefaultVariant(), inputStream, r3);
    }
    ...
    public final void writeNumberField(String str, int r2) throws IOException {
        writeFieldName(str);
        writeNumber(r2);
    }
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int m1248id = currentToken.m1248id();
        if (m1248id == 5) {
            writeFieldName(jsonParser.getCurrentName());
            m1248id = jsonParser.nextToken().m1248id();
        }
        if (m1248id == 1) {
            writeStartObject();
    ...
    protected final void _verifyOffsets(int r4, int r5, int r6) {
        if (r5 < 0 || r5 + r6 > r4) {
            throw new IllegalArgumentException(String.format("invalid argument(s) (offset=%d, length=%d) for input array of %d element", Integer.valueOf(r5), Integer.valueOf(r6), Integer.valueOf(r4)));
        }
    }
