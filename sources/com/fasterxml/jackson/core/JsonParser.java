...
public abstract class JsonParser implements Closeable, Versioned {
    ...
    public int getValueAsInt(int r1) throws IOException {
        return r1;
    }
    ...
    public abstract boolean hasTokenId(int r1);
    ...
    @Deprecated
    public JsonParser setFeatureMask(int r1) {
        this._features = r1;
        return this;
    }

    public JsonParser overrideStdFeatures(int r3, int r4) {
        return setFeatureMask((r3 & r4) | (this._features & (~r4)));
    }

    public JsonParser overrideFormatFeatures(int r2, int r3) {
    ...
    public int nextIntValue(int r3) throws IOException {
        return nextToken() == JsonToken.VALUE_NUMBER_INT ? getIntValue() : r3;
    }
