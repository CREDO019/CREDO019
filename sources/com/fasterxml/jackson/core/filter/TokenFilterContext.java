...
public class TokenFilterContext extends JsonStreamContext {
    ...
    protected TokenFilterContext(int r1, TokenFilterContext tokenFilterContext, TokenFilter tokenFilter, boolean z) {
        this._type = r1;
    ...
    protected TokenFilterContext reset(int r1, TokenFilter tokenFilter, boolean z) {
        this._type = r1;
        this._filter = tokenFilter;
        this._index = -1;
    ...
    public TokenFilter checkValue(TokenFilter tokenFilter) {
        ...
        this._index = r0;
        if (this._type == 1) {
            return tokenFilter.includeElement(r0);
        }
        return tokenFilter.includeRootValue(r0);
    }
