    ...
    JsonToken(String str, int r6) {
        ...
        if (str == null) {
            ...
            for (int r5 = 0; r5 < length; r5++) {
                this._serializedBytes[r5] = (byte) this._serializedChars[r5];
            }
        }
        this._id = r6;
        this._isBoolean = r6 == 10 || r6 == 9;
        this._isNumber = r6 == 7 || r6 == 8;
        boolean z2 = r6 == 1 || r6 == 3;
        this._isStructStart = z2;
        boolean z3 = r6 == 2 || r6 == 4;
