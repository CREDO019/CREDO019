...
public class DataFormatDetector {
    ...
    public DataFormatDetector withMaxInputLookahead(int r5) {
        return r5 == this._maxInputLookahead ? this : new DataFormatDetector(this._detectors, this._optimalMatch, this._minimalMatch, r5);
    }

    private DataFormatDetector(JsonFactory[] jsonFactoryArr, MatchStrength matchStrength, MatchStrength matchStrength2, int r4) {
    ...
    public DataFormatMatcher findFormat(byte[] bArr, int r3, int r4) throws IOException {
        return _findFormat(new InputAccessor.Std(bArr, r3, r4));
    }
    ...
    public String toString() {
        ...
        if (length > 0) {
            ...
            for (int r1 = 1; r1 < length; r1++) {
                sb.append(", ");
                sb.append(this._detectors[r1].getFormatName());
            }
        }
        sb.append(']');
        return sb.toString();
    ...
    private DataFormatMatcher _findFormat(InputAccessor.Std std) throws IOException {
        ...
        while (true) {
            ...
            JsonFactory jsonFactory2 = jsonFactoryArr[r4];
            std.reset();
