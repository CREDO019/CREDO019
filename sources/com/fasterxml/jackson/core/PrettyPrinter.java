...
public interface PrettyPrinter {
    ...
    void writeEndArray(JsonGenerator jsonGenerator, int r2) throws IOException, JsonGenerationException;

    void writeEndObject(JsonGenerator jsonGenerator, int r2) throws IOException, JsonGenerationException;
