...
public class StdArraySerializers {
        ...
        public void serializeContents(short[] sArr, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, JsonGenerationException {
            ...
            if (this._valueTypeSerializer != null) {
                ...
                while (r0 < length) {
                    ...
                    jsonGenerator.writeNumber(sArr[r0]);
            ...
            while (r0 < length2) {
                jsonGenerator.writeNumber((int) sArr[r0]);
                r0++;
            }
        }
    ...
    public static class CharArraySerializer extends StdSerializer<char[]> {
        ...
        private final void _writeArrayContents(JsonGenerator jsonGenerator, char[] cArr) throws IOException, JsonGenerationException {
            ...
            for (int r1 = 0; r1 < length; r1++) {
                jsonGenerator.writeString(cArr, r1, 1);
            }
        }
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ...
            createSchemaNode2.put(SessionDescription.ATTR_TYPE, "string");
    ...
    public static class IntArraySerializer extends ArraySerializerBase<int[]> {
        ...
        @Override // com.fasterxml.jackson.databind.JsonSerializer
        public boolean isEmpty(SerializerProvider serializerProvider, int[] r2) {
            return r2 == null || r2.length == 0;
        }

        @Override // com.fasterxml.jackson.databind.ser.ContainerSerializer
        public boolean hasSingleElement(int[] r2) {
            return r2.length == 1;
        }

        @Override // com.fasterxml.jackson.databind.ser.std.ArraySerializerBase, com.fasterxml.jackson.databind.ser.std.StdSerializer, com.fasterxml.jackson.databind.JsonSerializer
        public final void serialize(int[] r3, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
            if (r3.length == 1 && ((this._unwrapSingle == null && serializerProvider.isEnabled(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED)) || this._unwrapSingle == Boolean.TRUE)) {
                serializeContents(r3, jsonGenerator, serializerProvider);
                return;
            }
            jsonGenerator.setCurrentValue(r3);
            jsonGenerator.writeArray(r3, 0, r3.length);
        }

        @Override // com.fasterxml.jackson.databind.ser.std.ArraySerializerBase
        public void serializeContents(int[] r3, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
            for (int r1 : r3) {
                jsonGenerator.writeNumber(r1);
            }
        }
        ...
        public void serializeContents(long[] jArr, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
            ...
            if (this._valueTypeSerializer != null) {
                ...
                while (r0 < length) {
                    ...
                    jsonGenerator.writeNumber(jArr[r0]);
                    this._valueTypeSerializer.writeTypeSuffixForScalar(null, jsonGenerator);
                    r0++;
                }
                return;
        ...
        public void serializeContents(float[] fArr, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, JsonGenerationException {
            ...
            if (this._valueTypeSerializer != null) {
                ...
                while (r0 < length) {
                    ...
                    jsonGenerator.writeNumber(fArr[r0]);
                    this._valueTypeSerializer.writeTypeSuffixForScalar(null, jsonGenerator);
                    r0++;
                }
                return;
