...
import com.fasterxml.jackson.core.p009io.SegmentedStringWriter;
...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable {
        ...
        public boolean useForType(JavaType javaType) {
            ...
            int r0 = C17533.f196x3ef634e7[this._appliesFor.ordinal()];
            if (r0 == 1) {
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C17533 {

        /* renamed from: $SwitchMap$com$fasterxml$jackson$databind$ObjectMapper$DefaultTyping */
        static final /* synthetic */ int[] f196x3ef634e7;

        static {
            int[] r0 = new int[DefaultTyping.values().length];
            f196x3ef634e7 = r0;
            try {
                r0[DefaultTyping.NON_CONCRETE_AND_ARRAYS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f196x3ef634e7[DefaultTyping.OBJECT_AND_NON_CONCRETE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f196x3ef634e7[DefaultTyping.NON_FINAL.ordinal()] = 3;
    ...
    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping) {
        return enableDefaultTyping(defaultTyping, JsonTypeInfo.EnumC1748As.WRAPPER_ARRAY);
    }

    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping, JsonTypeInfo.EnumC1748As enumC1748As) {
        if (enumC1748As == JsonTypeInfo.EnumC1748As.EXTERNAL_PROPERTY) {
            throw new IllegalArgumentException("Can not use includeAs of " + enumC1748As);
        }
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.EnumC1749Id.CLASS, (TypeIdResolver) null).inclusion(enumC1748As));
    }

    public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping defaultTyping, String str) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.EnumC1749Id.CLASS, (TypeIdResolver) null).inclusion(JsonTypeInfo.EnumC1748As.PROPERTY).typeProperty(str));
    }
    ...
    public <T> T readValue(byte[] bArr, int r3, int r4, Class<T> cls) throws IOException, JsonParseException, JsonMappingException {
        return (T) _readMapAndClose(this._jsonFactory.createParser(bArr, r3, r4), this._typeFactory.constructType(cls));
    }
    ...
    public <T> T readValue(byte[] bArr, int r3, int r4, TypeReference typeReference) throws IOException, JsonParseException, JsonMappingException {
        return (T) _readMapAndClose(this._jsonFactory.createParser(bArr, r3, r4), this._typeFactory.constructType(typeReference));
    }
    ...
    public <T> T readValue(byte[] bArr, int r3, int r4, JavaType javaType) throws IOException, JsonParseException, JsonMappingException {
        return (T) _readMapAndClose(this._jsonFactory.createParser(bArr, r3, r4), javaType);
    }
    ...
    protected Object _unwrapAndDeserialize(JsonParser jsonParser, DeserializationContext deserializationContext, DeserializationConfig deserializationConfig, JavaType javaType, JsonDeserializer<Object> jsonDeserializer) throws IOException {
        ...
        if (jsonParser.nextToken() != JsonToken.FIELD_NAME) {
            ...
            deserializationContext.reportWrongTokenException(jsonParser, jsonToken, "Current token not FIELD_NAME (to contain expected root name '" + simpleName + "'), but " + jsonParser.getCurrentToken(), new Object[0]);
        }
