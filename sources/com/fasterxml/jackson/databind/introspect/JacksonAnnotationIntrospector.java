...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    public String[] findEnumValues(Class<?> cls, Enum<?>[] enumArr, String[] strArr) {
        ...
        if (hashMap != null) {
            ...
            for (int r1 = 0; r1 < length; r1++) {
                String str = (String) hashMap.get(enumArr[r1].name());
                if (str != null) {
                    strArr[r1] = str;
                }
            }
    ...
    public JsonInclude.Include findSerializationInclusion(Annotated annotated, JsonInclude.Include include) {
        ...
        if (jsonInclude == null || (value = jsonInclude.value()) == JsonInclude.Include.USE_DEFAULTS) {
            ...
            if (jsonSerialize != null) {
                int r3 = C17581.f197xfdbfedae[jsonSerialize.include().ordinal()];
                if (r3 == 1) {
    ...
    static /* synthetic */ class C17581 {
        ...
        static final /* synthetic */ int[] f197xfdbfedae;

        static {
            int[] r0 = new int[JsonSerialize.Inclusion.values().length];
            f197xfdbfedae = r0;
            try {
                r0[JsonSerialize.Inclusion.ALWAYS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f197xfdbfedae[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f197xfdbfedae[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f197xfdbfedae[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f197xfdbfedae[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    public JsonInclude.Value findPropertyInclusion(Annotated annotated) {
        ...
        if (value == JsonInclude.Include.USE_DEFAULTS && (jsonSerialize = (JsonSerialize) _findAnnotation(annotated, JsonSerialize.class)) != null) {
            int r4 = C17581.f197xfdbfedae[jsonSerialize.include().ordinal()];
            if (r4 == 1) {
    ...
    public Class<?> findSerializationType(Annotated annotated) {
        ...
        return _classIfExplicit(jsonSerialize.m1242as());
    }
    ...
    public void findAndAddVirtualProperties(MapperConfig<?> mapperConfig, AnnotatedClass annotatedClass, List<BeanPropertyWriter> list) {
        ...
        for (int r6 = 0; r6 < length; r6++) {
            ...
            BeanPropertyWriter _constructVirtualProperty = _constructVirtualProperty(attrs[r6], mapperConfig, annotatedClass, javaType);
            if (prepend) {
                list.add(r6, _constructVirtualProperty);
            } else {
        ...
        for (int r5 = 0; r5 < length2; r5++) {
            BeanPropertyWriter _constructVirtualProperty2 = _constructVirtualProperty(props[r5], mapperConfig, annotatedClass);
            if (prepend) {
                list.add(r5, _constructVirtualProperty2);
            } else {
    ...
    public Class<?> findDeserializationType(Annotated annotated, JavaType javaType) {
        ...
        return _classIfExplicit(jsonDeserialize.m1243as());
    }
    ...
    protected TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            if (jsonTypeInfo.use() == JsonTypeInfo.EnumC1749Id.NONE) {
        ...
        JsonTypeInfo.EnumC1748As include = jsonTypeInfo.include();
        if (include == JsonTypeInfo.EnumC1748As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            include = JsonTypeInfo.EnumC1748As.PROPERTY;
        }
