...
public final class TypeFactory implements Serializable {
    ...
    private TypeBindings _bindingsForSubtype(JavaType javaType, int r6, Class<?> cls) {
        int containedTypeCount = javaType.containedTypeCount();
        if (containedTypeCount == r6) {
            if (r6 == 1) {
            ...
            for (int r1 = 0; r1 < containedTypeCount; r1++) {
                arrayList.add(javaType.containedType(r1));
            }
    ...
    public JavaType constructParametricType(Class<?> cls, Class<?>... clsArr) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            javaTypeArr[r2] = _fromClass(null, clsArr[r2], null);
        }
    ...
    protected JavaType _fromAny(ClassStack classStack, Type type, TypeBindings typeBindings) {
        ...
        if (this._modifiers != null) {
            ...
            int r3 = 0;
            while (r3 < length) {
                TypeModifier typeModifier = typeModifierArr[r3];
    ...
    protected JavaType[] _resolveSuperInterfaces(ClassStack classStack, Class<?> cls, TypeBindings typeBindings) {
        ...
        JavaType[] javaTypeArr = new JavaType[length];
        for (int r2 = 0; r2 < length; r2++) {
            javaTypeArr[r2] = _fromAny(classStack, genericInterfaces[r2], typeBindings);
        }
        return javaTypeArr;
    }
    ...
    protected JavaType _fromParamType(ClassStack classStack, ParameterizedType parameterizedType, TypeBindings typeBindings) {
        ...
        if (length == 0) {
            ...
            for (int r1 = 0; r1 < length; r1++) {
                javaTypeArr[r1] = _fromAny(classStack, actualTypeArguments[r1], typeBindings);
            }
