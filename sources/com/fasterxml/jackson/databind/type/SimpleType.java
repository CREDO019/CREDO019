...
public class SimpleType extends TypeBase {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public SimpleType(Class<?> cls, TypeBindings typeBindings, JavaType javaType, JavaType[] javaTypeArr, int r5, Object obj, Object obj2, boolean z) {
        super(cls, typeBindings, javaType, javaTypeArr, r5, obj, obj2, z);
    }
    ...
    protected String buildCanonicalName() {
        ...
        if (size > 0) {
            ...
            for (int r2 = 0; r2 < size; r2++) {
                JavaType containedType = containedType(r2);
                if (r2 > 0) {
                    sb.append(',');
                }
    ...
    public StringBuilder getGenericSignature(StringBuilder sb) {
        ...
        if (size > 0) {
            ...
            for (int r1 = 0; r1 < size; r1++) {
                sb = containedType(r1).getGenericSignature(sb);
            }
            sb.append(Typography.greater);
        }
        sb.append(';');
