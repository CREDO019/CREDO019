...
public class ObjectReader extends ObjectCodec implements Versioned, Serializable {
    ...
    /* renamed from: at */
    public ObjectReader m1244at(String str) {
        return new ObjectReader(this, new JsonPointerBasedFilter(str));
    }

    /* renamed from: at */
    public ObjectReader m1245at(JsonPointer jsonPointer) {
    ...
    public <T> T readValue(byte[] bArr, int r3, int r4) throws IOException, JsonProcessingException {
        if (this._dataFormatReaders != null) {
            return (T) _detectBindAndClose(bArr, r3, r4);
        }
        return (T) _bindAndClose(_considerFilter(this._parserFactory.createParser(bArr, r3, r4), false));
    }
    ...
    public <T> MappingIterator<T> readValues(byte[] bArr, int r3, int r4) throws IOException, JsonProcessingException {
        DataFormatReaders dataFormatReaders = this._dataFormatReaders;
        if (dataFormatReaders != null) {
            return _detectBindAndReadValues(dataFormatReaders.findFormat(bArr, r3, r4), false);
        }
        return _bindAndReadValues(_considerFilter(this._parserFactory.createParser(bArr, r3, r4), true));
    }
    ...
    protected Object _detectBindAndClose(byte[] bArr, int r3, int r4) throws IOException {
        DataFormatReaders.Match findFormat = this._dataFormatReaders.findFormat(bArr, r3, r4);
