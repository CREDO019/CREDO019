...
public abstract class JavaType extends ResolvedType implements Serializable, Type {
    ...
    public abstract JavaType containedType(int r1);
    ...
    public JavaType(Class<?> cls, int r2, Object obj, Object obj2, boolean z) {
        this._class = cls;
        this._hash = cls.getName().hashCode() + r2;
    ...
    public JavaType containedTypeOrUnknown(int r1) {
        JavaType containedType = containedType(r1);
