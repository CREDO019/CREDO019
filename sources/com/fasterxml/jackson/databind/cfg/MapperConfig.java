...
public abstract class MapperConfig<T extends MapperConfig<T>> implements ClassIntrospector.MixInResolver, Serializable {
    ...
    public MapperConfig(BaseSettings baseSettings, int r2) {
        this._base = baseSettings;
        this._mapperFeatures = r2;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public MapperConfig(MapperConfig<T> mapperConfig, int r2) {
    ...
    public final boolean hasMapperFeatures(int r2) {
        return (this._mapperFeatures & r2) == r2;
    }
