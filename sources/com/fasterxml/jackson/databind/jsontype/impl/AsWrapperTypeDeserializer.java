...
public class AsWrapperTypeDeserializer extends TypeDeserializerBase implements Serializable {
    ...
    public JsonTypeInfo.EnumC1748As getTypeInclusion() {
        return JsonTypeInfo.EnumC1748As.WRAPPER_OBJECT;
    }
    ...
    protected Object _deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (currentToken == JsonToken.START_OBJECT) {
            ...
            deserializationContext.reportWrongTokenException(jsonParser, jsonToken2, "need JSON Object to contain As.WRAPPER_OBJECT type information for class " + baseTypeName(), new Object[0]);
        }
