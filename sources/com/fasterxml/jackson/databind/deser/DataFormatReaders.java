...
public class DataFormatReaders {
    ...
    private DataFormatReaders(ObjectReader[] objectReaderArr, MatchStrength matchStrength, MatchStrength matchStrength2, int r4) {
        this._readers = objectReaderArr;
        this._optimalMatch = matchStrength;
        this._minimalMatch = matchStrength2;
        this._maxInputLookahead = r4;
    }
    ...
    public DataFormatReaders withMaxInputLookahead(int r5) {
        return r5 == this._maxInputLookahead ? this : new DataFormatReaders(this._readers, this._optimalMatch, this._minimalMatch, r5);
    }
    ...
    public DataFormatReaders with(DeserializationConfig deserializationConfig) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            objectReaderArr[r2] = this._readers[r2].with(deserializationConfig);
        }
        return new DataFormatReaders(objectReaderArr, this._optimalMatch, this._minimalMatch, this._maxInputLookahead);
    }
    ...
    public DataFormatReaders withType(JavaType javaType) {
        ...
        ObjectReader[] objectReaderArr = new ObjectReader[length];
        for (int r2 = 0; r2 < length; r2++) {
            objectReaderArr[r2] = this._readers[r2].forType(javaType);
        }
        return new DataFormatReaders(objectReaderArr, this._optimalMatch, this._minimalMatch, this._maxInputLookahead);
    }
    ...
    public Match findFormat(byte[] bArr, int r3, int r4) throws IOException {
        return _findFormat(new AccessorForReader(bArr, r3, r4));
    }
    ...
    public String toString() {
        ...
        if (length > 0) {
            ...
            for (int r1 = 1; r1 < length; r1++) {
                sb.append(", ");
                sb.append(this._readers[r1].getFactory().getFormatName());
            }
        }
        sb.append(']');
        return sb.toString();
    ...
    private Match _findFormat(AccessorForReader accessorForReader) throws IOException {
        ...
        while (true) {
            ...
            ObjectReader objectReader2 = objectReaderArr[r4];
    ...
    public class AccessorForReader extends InputAccessor.Std {
        ...
        public AccessorForReader(byte[] bArr, int r3, int r4) {
            super(bArr, r3, r4);
        }
    ...
    public static class Match {
        ...
        protected Match(InputStream inputStream, byte[] bArr, int r3, int r4, ObjectReader objectReader, MatchStrength matchStrength) {
