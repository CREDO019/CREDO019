...
public class ObjectArrayDeserializer extends ContainerDeserializerBase<Object[]> implements ContextualDeserializer {
    ...
    public Object[] deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        while (true) {
            try {
                ...
                int r6 = r4 + 1;
                try {
                    resetAndStart[r4] = deserializeWithType;
                    r4 = r6;
                } catch (Exception e) {
                    e = e;
                    r4 = r6;
                    throw JsonMappingException.wrapWithPath(e, resetAndStart, leaseObjectBuffer.bufferedSize() + r4);
                }
            } catch (Exception e2) {
                e = e2;
            }
        ...
        if (this._untyped) {
            completeAndClearBuffer = leaseObjectBuffer.completeAndClearBuffer(resetAndStart, r4);
        } else {
            completeAndClearBuffer = leaseObjectBuffer.completeAndClearBuffer(resetAndStart, r4, this._elementClass);
        }
    ...
    protected Byte[] deserializeFromBase64(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        for (int r1 = 0; r1 < length; r1++) {
            bArr[r1] = Byte.valueOf(binaryValue[r1]);
        }
        return bArr;
    }
