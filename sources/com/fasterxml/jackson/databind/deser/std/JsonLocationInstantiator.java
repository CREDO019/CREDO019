...
public class JsonLocationInstantiator extends ValueInstantiator.Base {
    ...
    private static CreatorProperty creatorProp(String str, JavaType javaType, int r13) {
        return new CreatorProperty(PropertyName.construct(str), javaType, null, null, null, null, r13, null, PropertyMetadata.STD_REQUIRED);
    }
