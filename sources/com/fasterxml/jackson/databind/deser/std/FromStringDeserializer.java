...
public abstract class FromStringDeserializer<T> extends StdScalarDeserializer<T> {
    ...
    public static class Std extends FromStringDeserializer<Object> {
        ...
        protected Std(Class<?> cls, int r2) {
            super(cls);
            this._kind = r2;
        }
        ...
        protected Object _deserialize(String str, DeserializationContext deserializationContext) throws IOException {
            switch (this._kind) {
                ...
                case 12:
                    ...
                    if (indexOf2 >= 0) {
                        int r0 = indexOf2 + 1;
                        if (str.indexOf(58, r0) < 0) {
                            return new InetSocketAddress(str.substring(0, indexOf2), Integer.parseInt(str.substring(r0)));
                        }
                    }
