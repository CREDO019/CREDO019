...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    protected StdKeyDeserializer(int r2, Class<?> cls) {
        this(r2, cls, null);
    }

    protected StdKeyDeserializer(int r1, Class<?> cls, FromStringDeserializer<?> fromStringDeserializer) {
        this._kind = r1;
        this._keyClass = cls;
    ...
    public static StdKeyDeserializer forType(Class<?> cls) {
        ...
        return new StdKeyDeserializer(r0, cls);
    }
