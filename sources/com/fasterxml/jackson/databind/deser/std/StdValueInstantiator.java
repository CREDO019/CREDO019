...
public class StdValueInstantiator extends ValueInstantiator implements Serializable {
    ...
    */
    ...
    @Override // com.fasterxml.jackson.databind.deser.ValueInstantiator
    public Object createFromInt(DeserializationContext deserializationContext, int r4) throws IOException {
        if (this._fromIntCreator != null) {
            ...
            return super.createFromInt(deserializationContext, r4);
        }
    }
        ...
        try {
            ...
            for (int r2 = 0; r2 < length; r2++) {
                ...
                if (settableBeanProperty == null) {
                    ...
                    objArr[r2] = deserializationContext.findInjectableValue(settableBeanProperty.getInjectableValueId(), settableBeanProperty, null);
                }
            }
            return annotatedWithParams.call(objArr);
        } catch (Throwable th) {
