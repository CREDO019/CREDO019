...
public abstract class ValueInstantiator {
    ...
    public Object createFromInt(DeserializationContext deserializationContext, int r6) throws IOException {
        return deserializationContext.handleMissingInstantiator(getValueClass(), deserializationContext.getParser(), "no int/Int-argument constructor/factory method to deserialize from Number value (%s)", Integer.valueOf(r6));
    }
