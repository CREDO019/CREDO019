...
public class CreatorCollector {
        ...
        if (verifyNonDup(annotatedWithParams, 7, z)) {
            if (settableBeanPropertyArr.length > 1) {
                ...
                for (int r2 = 0; r2 < length; r2++) {
                    String name = settableBeanPropertyArr[r2].getName();
                    if ((name.length() != 0 || settableBeanPropertyArr[r2].getInjectableValueId() == null) && (num = (Integer) hashMap.put(name, Integer.valueOf(r2))) != null) {
                        throw new IllegalArgumentException(String.format("Duplicate creator property \"%s\" (index %s vs %d)", name, num, Integer.valueOf(r2)));
                    }
                }
            }
    ...
    private JavaType _computeDelegateType(AnnotatedWithParams annotatedWithParams, SettableBeanProperty[] settableBeanPropertyArr) {
        ...
        if (settableBeanPropertyArr != null) {
            ...
            while (true) {
                if (r2 >= length) {
                    break;
                } else if (settableBeanPropertyArr[r2] == null) {
                    r0 = r2;
                    break;
                } else {
                    r2++;
        ...
        return annotatedWithParams.getParameterType(r0);
    }
    ...
    protected boolean verifyNonDup(AnnotatedWithParams annotatedWithParams, int r8, boolean z) {
        boolean z2;
        int r1 = 1 << r8;
        this._hasNonDefaultCreator = true;
        AnnotatedWithParams annotatedWithParams2 = this._creators[r8];
        if (annotatedWithParams2 != null) {
            if ((this._explicitCreators & r1) == 0) {
                z2 = !z;
            } else if (!z) {
                return false;
            } else {
        ...
        if (z) {
            this._explicitCreators |= r1;
        }
        this._creators[r8] = (AnnotatedWithParams) _fixAccess(annotatedWithParams);
        return true;
    }
    ...
    protected static final class StdTypeConstructor extends AnnotatedWithParams implements Serializable {
        ...
        public StdTypeConstructor(AnnotatedWithParams annotatedWithParams, int r3) {
        ...
        public Class<?> getRawParameterType(int r2) {
            return this._base.getRawParameterType(r2);
        }

        @Override // com.fasterxml.jackson.databind.introspect.AnnotatedWithParams
        public JavaType getParameterType(int r2) {
            return this._base.getParameterType(r2);
        }

        @Override // com.fasterxml.jackson.databind.introspect.AnnotatedWithParams
        @Deprecated
        public Type getGenericParameterType(int r2) {
            return this._base.getGenericParameterType(r2);
        }
