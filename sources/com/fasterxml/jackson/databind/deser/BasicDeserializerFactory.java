...
public abstract class BasicDeserializerFactory extends DeserializerFactory implements Serializable {
    ...
    protected void _addDeserializerConstructors(DeserializationContext deserializationContext, BeanDescription beanDescription, VisibilityChecker<?> visibilityChecker, AnnotationIntrospector annotationIntrospector, CreatorCollector creatorCollector, Map<AnnotatedWithParams, BeanPropertyDefinition[]> map) throws JsonMappingException {
        ...
        while (it3.hasNext()) {
            ...
            if (parameterCount == 1) {
                ...
                int r17 = 0;
                int r19 = 0;
                while (r4 < parameterCount) {
                    AnnotatedParameter parameter2 = next.getParameter(r4);
                    BeanPropertyDefinition beanPropertyDefinition3 = beanPropertyDefinitionArr == null ? null : beanPropertyDefinitionArr[r4];
                    ...
                    if (beanPropertyDefinition3 == null || !beanPropertyDefinition3.isExplicitlyNamed()) {
                        ...
                        if (findInjectableValueId != null) {
                            r19++;
                            settableBeanPropertyArr[r24] = constructCreatorProperty(deserializationContext, beanDescription, fullName2, r24, parameter2, findInjectableValueId);
                        } else if (annotationIntrospector.findUnwrappingNameTransformer(parameter2) != null) {
                            settableBeanPropertyArr[r24] = constructCreatorProperty(deserializationContext, beanDescription, UNWRAPPED_CREATOR_PARAM_NAME, r24, parameter2, null);
                            r18++;
                        ...
                        settableBeanPropertyArr = settableBeanPropertyArr3;
                        r15 = parameterCount;
                        settableBeanPropertyArr[r24] = constructCreatorProperty(deserializationContext, beanDescription, fullName2, r4, parameter2, findInjectableValueId);
                    }
    ...
    protected void _checkImplicitlyNamedConstructors(DeserializationContext deserializationContext, BeanDescription beanDescription, VisibilityChecker<?> visibilityChecker, AnnotationIntrospector annotationIntrospector, CreatorCollector creatorCollector, List<AnnotatedConstructor> list) throws JsonMappingException {
        ...
        while (true) {
            ...
            if (visibilityChecker.isCreatorVisible(next)) {
                ...
                int r9 = 0;
                while (true) {
                    if (r9 < parameterCount) {
                        AnnotatedParameter parameter = next.getParameter(r9);
                        PropertyName _findParamName = _findParamName(parameter, annotationIntrospector);
                        if (_findParamName != null && !_findParamName.isEmpty()) {
                            settableBeanPropertyArr2[r9] = constructCreatorProperty(deserializationContext, beanDescription, _findParamName, parameter.getIndex(), parameter, null);
                            r9++;
                        }
    ...
    */
    ...
    protected SettableBeanProperty constructCreatorProperty(DeserializationContext deserializationContext, BeanDescription beanDescription, PropertyName propertyName, int r19, AnnotatedParameter annotatedParameter, Object obj) throws JsonMappingException {
        ...
        CreatorProperty creatorProperty = new CreatorProperty(propertyName, resolveMemberAndTypeAnnotations, std.getWrapperName(), typeDeserializer, beanDescription.getClassAnnotations(), annotatedParameter, r19, obj, propertyMetadata);
