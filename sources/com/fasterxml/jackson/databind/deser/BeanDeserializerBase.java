...
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, Serializable {
        ...
        while (it2.hasNext()) {
            ...
            if (_resolveUnwrappedProperty != null) {
                ...
                if (_resolveInnerClassValuedProperty.hasValueTypeDeserializer()) {
                    ...
                    if (valueTypeDeserializer.getTypeInclusion() == JsonTypeInfo.EnumC1748As.EXTERNAL_PROPERTY) {
                        if (builder == null) {
    ...
    protected void _replaceProperty(BeanPropertyMap beanPropertyMap, SettableBeanProperty[] settableBeanPropertyArr, SettableBeanProperty settableBeanProperty, SettableBeanProperty settableBeanProperty2) {
        ...
        if (settableBeanPropertyArr != null) {
            ...
            for (int r3 = 0; r3 < length; r3++) {
                if (settableBeanPropertyArr[r3] == settableBeanProperty) {
                    settableBeanPropertyArr[r3] = settableBeanProperty2;
                    return;
                }
            }
        }
    ...
    public SettableBeanProperty findProperty(int r3) {
        PropertyBasedCreator propertyBasedCreator;
        BeanPropertyMap beanPropertyMap = this._beanProperties;
        SettableBeanProperty find = beanPropertyMap == null ? null : beanPropertyMap.find(r3);
        return (find != null || (propertyBasedCreator = this._propertyBasedCreator) == null) ? find : propertyBasedCreator.findCreatorProperty(r3);
    }
    ...
    public Object deserializeFromNumber(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        JsonDeserializer<Object> _delegateDeserializer = _delegateDeserializer();
        int r1 = C17551.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
        if (r1 == 1) {
    ...
    @Deprecated
    public void wrapAndThrow(Throwable th, Object obj, int r3, DeserializationContext deserializationContext) throws IOException {
        throw JsonMappingException.wrapWithPath(throwOrReturnThrowable(th, deserializationContext), obj, r3);
    }
