...
public abstract class ContainerNode<T extends ContainerNode<T>> extends BaseJsonNode implements JsonNodeCreator {
    ...
    @Override // com.fasterxml.jackson.databind.node.JsonNodeCreator
    public final ArrayNode arrayNode(int r2) {
        return this._nodeFactory.arrayNode(r2);
    }
    ...
    @Override // com.fasterxml.jackson.databind.node.JsonNodeCreator
    public final NumericNode numberNode(int r2) {
        return this._nodeFactory.numberNode(r2);
    }
    ...
    @Override // com.fasterxml.jackson.databind.node.JsonNodeCreator
    public final BinaryNode binaryNode(byte[] bArr, int r3, int r4) {
        return this._nodeFactory.binaryNode(bArr, r3, r4);
    }
