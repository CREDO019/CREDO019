...
class GradientFillParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1371of("nm", "g", NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST, "t", "s", "e", "r", "hd");
                ...
                case 1:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (selectName == 0) {
                            ...
                            animatableGradientColorValue = AnimatableValueParser.parseGradientColor(jsonReader, lottieComposition, r0);
                        } else {
                            jsonReader.skipName();
