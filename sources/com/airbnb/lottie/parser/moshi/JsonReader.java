...
public abstract class JsonReader implements Closeable {
    ...
    /* renamed from: of */
    public static JsonReader m1372of(BufferedSource bufferedSource) {
    ...
    public static final class Options {
        ...
        /* renamed from: of */
        public static Options m1371of(String... strArr) {
            try {
                ByteString[] byteStringArr = new ByteString[strArr.length];
                Buffer buffer = new Buffer();
                for (int r2 = 0; r2 < strArr.length; r2++) {
                    JsonReader.string(buffer, strArr[r2]);
                    buffer.readByte();
                    byteStringArr[r2] = buffer.readByteString();
                }
                return new Options((String[]) strArr.clone(), okio.Options.m145of(byteStringArr));
            } catch (IOException e) {
