...
class GradientStrokeParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1371of("nm", "g", NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST, "t", "s", "e", "w", "lc", "lj", "ml", "hd", "d");
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.m1371of("p", "k");
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.m1371of(NotificationBundleProcessor.PUSH_MINIFIED_BUTTON_TEXT, "v");
                ...
                case 1:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (selectName != 0) {
                            ...
                            if (selectName == 1) {
                                animatableGradientColorValue2 = AnimatableValueParser.parseGradientColor(jsonReader, lottieComposition, r2);
                            } else {
                                jsonReader.skipName();
