...
public class AnimatableTextPropertiesParser {
    private static final JsonReader.Options PROPERTIES_NAMES = JsonReader.Options.m1371of(NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY);
    private static final JsonReader.Options ANIMATABLE_PROPERTIES_NAMES = JsonReader.Options.m1371of("fc", "sc", "sw", "t");
