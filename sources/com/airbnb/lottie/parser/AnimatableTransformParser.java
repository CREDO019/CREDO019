...
public class AnimatableTransformParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1371of(NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY, "p", "s", "rz", "r", NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST, "so", "eo", "sk", "sa");
    private static final JsonReader.Options ANIMATABLE_NAMES = JsonReader.Options.m1371of("k");
