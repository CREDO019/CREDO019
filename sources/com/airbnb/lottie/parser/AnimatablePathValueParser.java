...
public class AnimatablePathValueParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1371of("k", "x", "y");
    ...
    public static AnimatablePathValue parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        if (jsonReader.peek() == JsonReader.Token.BEGIN_ARRAY) {
            ...
            arrayList.add(new Keyframe(JsonUtils.jsonToPoint(jsonReader, C1028Utils.dpScale())));
        }
