...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.m1371of("t", "s", "e", NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST, "i", "h", "to", "ti");
    static JsonReader.Options INTERPOLATOR_NAMES = JsonReader.Options.m1371of("x", "y");
    ...
    private static WeakReference<Interpolator> getInterpolator(int r2) {
        WeakReference<Interpolator> weakReference;
        synchronized (KeyframeParser.class) {
            weakReference = pathInterpolatorCache().get(r2);
        }
        return weakReference;
    }

    private static void putInterpolator(int r2, WeakReference<Interpolator> weakReference) {
        synchronized (KeyframeParser.class) {
            pathInterpolatorCache.put(r2, weakReference);
        }
    }
    ...
    private static Interpolator interpolatorFor(PointF pointF, PointF pointF2) {
        ...
        int hashFor = C1028Utils.hashFor(pointF.x, pointF.y, pointF2.x, pointF2.y);
