...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public void draw(Canvas canvas, Matrix matrix, int r8) {
        ...
        C0991L.beginSection("GradientFillContent#draw");
        this.path.reset();
        for (int r2 = 0; r2 < this.paths.size(); r2++) {
            this.path.addPath(this.paths.get(r2).getPath(), matrix);
        }
        ...
        this.paint.setAlpha(MiscUtils.clamp((int) ((((r8 / 255.0f) * this.opacityAnimation.getValue().intValue()) / 100.0f) * 255.0f), 0, 255));
        canvas.drawPath(this.path, this.paint);
        C0991L.endSection("GradientFillContent#draw");
    }
    ...
    private int getGradientHash() {
        ...
        int r3 = round != 0 ? 527 * round : 17;
        if (round2 != 0) {
            r3 = r3 * 31 * round2;
        }
        return round3 != 0 ? r3 * 31 * round3 : r3;
    }
