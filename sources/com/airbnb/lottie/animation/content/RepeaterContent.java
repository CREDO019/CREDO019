...
public class RepeaterContent implements DrawingContent, PathContent, GreedyContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public Path getPath() {
        ...
        for (int r1 = ((int) floatValue) - 1; r1 >= 0; r1--) {
            this.matrix.set(this.transform.getMatrixForRepeater(r1 + floatValue2));
    ...
    public void draw(Canvas canvas, Matrix matrix, int r12) {
        float floatValue = this.copies.getValue().floatValue();
        float floatValue2 = this.offset.getValue().floatValue();
        ...
        for (int r3 = ((int) floatValue) - 1; r3 >= 0; r3--) {
            this.matrix.set(matrix);
            float f = r3;
            this.matrix.preConcat(this.transform.getMatrixForRepeater(f + floatValue2));
            this.contentGroup.draw(canvas, this.matrix, (int) (r12 * MiscUtils.lerp(floatValue3, floatValue4, f / floatValue)));
        }
    }
