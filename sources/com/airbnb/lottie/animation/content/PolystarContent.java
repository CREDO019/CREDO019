...
public class PolystarContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public Path getPath() {
        ...
        int r0 = C10131.$SwitchMap$com$airbnb$lottie$model$content$PolystarShape$Type[this.type.ordinal()];
        if (r0 == 1) {
            createStarPath();
        } else if (r0 == 2) {
            createPolygonPath();
    ...
    private void createStarPath() {
        ...
        int r10 = (f12 > 0.0f ? 1 : (f12 == 0.0f ? 0 : -1));
        if (r10 != 0) {
        ...
        while (true) {
            ...
            if (d7 < ceil) {
                ...
                int r25 = (f3 > 0.0f ? 1 : (f3 == 0.0f ? 0 : -1));
                if (r25 == 0 || d7 != ceil - 2.0d) {
                    f4 = f10;
                    f5 = f11;
                } else {
                    f4 = f10;
