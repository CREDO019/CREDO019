...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    public void setContents(List<Content> list, List<Content> list2) {
        for (int r0 = 0; r0 < this.pathContents.size(); r0++) {
            this.pathContents.get(r0).setContents(list, list2);
        }
    }
    ...
    public Path getPath() {
        ...
        int r0 = C10121.f77x7df623d1[this.mergePaths.getMode().ordinal()];
        if (r0 == 1) {
            addPaths();
        } else if (r0 == 2) {
    ...
    static /* synthetic */ class C10121 {
        ...
        static final /* synthetic */ int[] f77x7df623d1;
        ...
        static {
            ...
            try {
                f77x7df623d1[MergePaths.MergePathsMode.ADD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f77x7df623d1[MergePaths.MergePathsMode.SUBTRACT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f77x7df623d1[MergePaths.MergePathsMode.INTERSECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f77x7df623d1[MergePaths.MergePathsMode.EXCLUDE_INTERSECTIONS.ordinal()] = 5;
    ...
    private void addPaths() {
        for (int r0 = 0; r0 < this.pathContents.size(); r0++) {
            this.path.addPath(this.pathContents.get(r0).getPath());
        }
    }
    ...
    private void opFirstPathWithRest(Path.Op op) {
        ...
        if (pathContent2 instanceof ContentGroup) {
            ...
            for (int r1 = 0; r1 < pathList2.size(); r1++) {
                Path path2 = pathList2.get(r1).getPath();
