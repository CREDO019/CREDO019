...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    public void notifyListeners() {
        for (int r0 = 0; r0 < this.listeners.size(); r0++) {
            this.listeners.get(r0).onValueChanged();
        }
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public Keyframe<K> getCurrentKeyframe() {
        C0991L.beginSection("BaseKeyframeAnimation#getCurrentKeyframe");
        Keyframe<K> currentKeyframe = this.keyframesWrapper.getCurrentKeyframe();
        C0991L.endSection("BaseKeyframeAnimation#getCurrentKeyframe");
