...
public class PerformanceTracker {
    ...
    public void logRenderTimes() {
        if (this.enabled) {
            ...
            Log.d(C0991L.TAG, "Render times:");
            for (int r3 = 0; r3 < sortedRenderTimes.size(); r3++) {
                Pair<String, Float> pair = sortedRenderTimes.get(r3);
                Log.d(C0991L.TAG, String.format("\t\t%30s:%.2f", pair.first, pair.second));
            }
        }
    }
