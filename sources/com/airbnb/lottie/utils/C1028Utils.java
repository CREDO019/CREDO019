...
public final class C1028Utils {
    ...
    public static int hashFor(float f, float f2, float f3, float f4) {
        ...
        return f4 != 0.0f ? (int) (r2 * 31 * f4) : r2;
    }

    public static boolean isAtLeastVersion(int r2, int r3, int r4, int r5, int r6, int r7) {
        if (r2 < r5) {
            return false;
        }
        if (r2 > r5) {
    ...
    public static void applyTrimPathIfNeeded(Path path, float f, float f2, float f3) {
        C0991L.beginSection("applyTrimPathIfNeeded");
        ...
        if (f == 1.0f && f2 == 0.0f) {
            C0991L.endSection("applyTrimPathIfNeeded");
    ...
    public static void saveLayerCompat(Canvas canvas, RectF rectF, Paint paint, int r6) {
        C0991L.beginSection("Utils#saveLayer");
        if (Build.VERSION.SDK_INT < 23) {
            canvas.saveLayer(rectF, paint, r6);
        } else {
            canvas.saveLayer(rectF, paint);
        }
        C0991L.endSection("Utils#saveLayer");
    }
