...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public void draw(Canvas canvas) {
        C0991L.beginSection("Drawable#draw");
        if (this.safeMode) {
            try {
        ...
        this.isDirty = false;
        C0991L.endSection("Drawable#draw");
    }
        ...
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda0
                ...
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m1466lambda$playAnimation$0$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m1466lambda$playAnimation$0$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        playAnimation();
    }
    ...
    public void resumeAnimation() {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda6
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m1467lambda$resumeAnimation$1$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m1467lambda$resumeAnimation$1$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        resumeAnimation();
    }
    ...
    public void setMinFrame(final int r3) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda13
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m1476lambda$setMinFrame$2$comairbnblottieLottieDrawable(r3, lottieComposition);
                }
            });
        } else {
            this.animator.setMinFrame(r3);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMinFrame$2$com-airbnb-lottie-LottieDrawable  reason: not valid java name */
    public /* synthetic */ void m1476lambda$setMinFrame$2$comairbnblottieLottieDrawable(int r1, LottieComposition lottieComposition) {
        setMinFrame(r1);
    }
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda8
                ...
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m1478lambda$setMinProgress$3$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    public /* synthetic */ void m1478lambda$setMinProgress$3$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMinProgress(f);
    }
    ...
    public void setMaxFrame(final int r3) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda12
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m1469lambda$setMaxFrame$4$comairbnblottieLottieDrawable(r3, lottieComposition);
                }
            });
        } else {
            this.animator.setMaxFrame(r3 + 0.99f);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMaxFrame$4$com-airbnb-lottie-LottieDrawable  reason: not valid java name */
    public /* synthetic */ void m1469lambda$setMaxFrame$4$comairbnblottieLottieDrawable(int r1, LottieComposition lottieComposition) {
        setMaxFrame(r1);
    }
    ...
    public void setMaxProgress(final float f) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda7
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m1471lambda$setMaxProgress$5$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    public /* synthetic */ void m1471lambda$setMaxProgress$5$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMaxProgress(f);
    }
    ...
    public void setMinFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda4
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m1477lambda$setMinFrame$6$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m1477lambda$setMinFrame$6$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMinFrame(str);
    }
    ...
    public void setMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda2
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m1470lambda$setMaxFrame$7$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m1470lambda$setMaxFrame$7$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMaxFrame(str);
    }
    ...
    public void setMinAndMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda3
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m1473lambda$setMinAndMaxFrame$8$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m1473lambda$setMinAndMaxFrame$8$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final String str, final String str2, final boolean z) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda5
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m1474lambda$setMinAndMaxFrame$9$comairbnblottieLottieDrawable(str, str2, z, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m1474lambda$setMinAndMaxFrame$9$comairbnblottieLottieDrawable(String str, String str2, boolean z, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final int r3, final int r4) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda14
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m1472lambda$setMinAndMaxFrame$10$comairbnblottieLottieDrawable(r3, r4, lottieComposition);
                }
            });
        } else {
    ...
    public /* synthetic */ void m1472lambda$setMinAndMaxFrame$10$comairbnblottieLottieDrawable(int r1, int r2, LottieComposition lottieComposition) {
        setMinAndMaxFrame(r1, r2);
    }
    ...
    public void setMinAndMaxProgress(final float f, final float f2) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda10
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m1475lambda$setMinAndMaxProgress$11$comairbnblottieLottieDrawable(f, f2, lottieComposition2);
                }
            });
        } else {
    ...
    public /* synthetic */ void m1475lambda$setMinAndMaxProgress$11$comairbnblottieLottieDrawable(float f, float f2, LottieComposition lottieComposition) {
    ...
    public void setFrame(final int r3) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda11
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m1468lambda$setFrame$12$comairbnblottieLottieDrawable(r3, lottieComposition);
                }
            });
        } else {
    ...
    public /* synthetic */ void m1468lambda$setFrame$12$comairbnblottieLottieDrawable(int r1, LottieComposition lottieComposition) {
        setFrame(r1);
    }
    ...
    public void setProgress(final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda9
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m1479lambda$setProgress$13$comairbnblottieLottieDrawable(f, lottieComposition);
                }
            });
            return;
        }
        C0991L.beginSection("Drawable#setProgress");
        this.animator.setFrame(this.composition.getFrameForProgress(f));
        C0991L.endSection("Drawable#setProgress");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setProgress$13$com-airbnb-lottie-LottieDrawable  reason: not valid java name */
    public /* synthetic */ void m1479lambda$setProgress$13$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setProgress(f);
    }
    ...
    public void setRepeatMode(int r2) {
        this.animator.setRepeatMode(r2);
    }
    ...
    public void setRepeatCount(int r2) {
        this.animator.setRepeatCount(r2);
    }
    ...
    public <T> void addValueCallback(final KeyPath keyPath, final T t, final LottieValueCallback<T> lottieValueCallback) {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda1
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m1465lambda$addValueCallback$14$comairbnblottieLottieDrawable(keyPath, t, lottieValueCallback, lottieComposition);
                }
            });
            return;
        }
        ...
        if (keyPath == KeyPath.COMPOSITION) {
            ...
            for (int r0 = 0; r0 < resolveKeyPath.size(); r0++) {
                resolveKeyPath.get(r0).getResolvedElement().addValueCallback(t, lottieValueCallback);
            }
    ...
    public /* synthetic */ void m1465lambda$addValueCallback$14$comairbnblottieLottieDrawable(KeyPath keyPath, Object obj, LottieValueCallback lottieValueCallback, LottieComposition lottieComposition) {
    ...
    private void ensureSoftwareRenderingBitmap(int r4, int r5) {
        Bitmap bitmap = this.softwareRenderingBitmap;
        if (bitmap == null || bitmap.getWidth() < r4 || this.softwareRenderingBitmap.getHeight() < r5) {
            Bitmap createBitmap = Bitmap.createBitmap(r4, r5, Bitmap.Config.ARGB_8888);
            this.softwareRenderingBitmap = createBitmap;
            this.softwareRenderingCanvas.setBitmap(createBitmap);
            this.isDirty = true;
        } else if (this.softwareRenderingBitmap.getWidth() > r4 || this.softwareRenderingBitmap.getHeight() > r5) {
            Bitmap createBitmap2 = Bitmap.createBitmap(this.softwareRenderingBitmap, 0, 0, r4, r5);
