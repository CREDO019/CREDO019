...
public class LottieComposition {
    ...
    public void incrementMatteOrMaskCount(int r2) {
        this.maskAndMatteCount += r2;
    }
    ...
    public Marker getMarker(String str) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            Marker marker = this.markers.get(r1);
    ...
    public static class Factory {
        ...
        @Deprecated
        public static Cancellable fromRawFile(Context context, int r3, OnCompositionLoadedListener onCompositionLoadedListener) {
            ListenerAdapter listenerAdapter = new ListenerAdapter(onCompositionLoadedListener);
            LottieCompositionFactory.fromRawRes(context, r3).addListener(listenerAdapter);
            return listenerAdapter;
        }
