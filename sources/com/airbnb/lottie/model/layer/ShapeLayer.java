...
public class ShapeLayer extends BaseLayer {
    ...
    void drawLayer(Canvas canvas, Matrix matrix, int r4) {
    ...
    @Override // com.airbnb.lottie.model.layer.BaseLayer
    protected void resolveChildKeyPath(KeyPath keyPath, int r3, List<KeyPath> list, KeyPath keyPath2) {
        this.contentGroup.resolveKeyPath(keyPath, r3, list, keyPath2);
    }
}
