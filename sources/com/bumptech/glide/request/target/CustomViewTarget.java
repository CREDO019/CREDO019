...
import com.bumptech.glide.C1089R;
...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
    ...
    private static final int VIEW_TAG_ID = C1089R.C1092id.glide_custom_view_target_tag;
    ...
    public final CustomViewTarget<T, Z> useTagId(int r2) {
    ...
    static final class SizeDeterminer {
        ...
        private boolean isDimensionValid(int r2) {
            return r2 > 0 || r2 == Integer.MIN_VALUE;
        }
        ...
        private void notifyCbs(int r3, int r4) {
            ...
            while (it.hasNext()) {
                ((SizeReadyCallback) it.next()).onSizeReady(r3, r4);
            }
        }
