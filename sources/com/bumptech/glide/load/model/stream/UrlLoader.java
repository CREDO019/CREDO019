...
public class UrlLoader implements ModelLoader<URL, InputStream> {
    ...
    @Override // com.bumptech.glide.load.model.ModelLoader
    public ModelLoader.LoadData<InputStream> buildLoadData(URL url, int r4, int r5, Options options) {
        return this.glideUrlLoader.buildLoadData(new GlideUrl(url), r4, r5, options);
    }
