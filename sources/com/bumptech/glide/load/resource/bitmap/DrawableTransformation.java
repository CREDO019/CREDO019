...
public class DrawableTransformation implements Transformation<Drawable> {
    ...
    public Resource<Drawable> transform(Context context, Resource<Drawable> resource, int r5, int r6) {
        ...
        Resource<Bitmap> convert = DrawableToBitmapConverter.convert(bitmapPool, drawable, r5, r6);
        if (convert == null) {
            if (this.isRequired) {
        ...
        Resource<Bitmap> transform = this.wrapped.transform(context, convert, r5, r6);
