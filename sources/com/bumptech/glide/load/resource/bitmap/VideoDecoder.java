...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    public Resource<Bitmap> decode(T t, int r10, int r11, Options options) throws IOException {
        ...
        try {
            try {
                ...
                Bitmap decodeFrame = decodeFrame(build, longValue, num.intValue(), r10, r11, downsampleStrategy2);
                build.release();
    ...
    private static Bitmap decodeFrame(MediaMetadataRetriever mediaMetadataRetriever, long j, int r5, int r6, int r7, DownsampleStrategy downsampleStrategy) {
        Bitmap decodeScaledFrame = (Build.VERSION.SDK_INT < 27 || r6 == Integer.MIN_VALUE || r7 == Integer.MIN_VALUE || downsampleStrategy == DownsampleStrategy.NONE) ? null : decodeScaledFrame(mediaMetadataRetriever, j, r5, r6, r7, downsampleStrategy);
        return decodeScaledFrame == null ? decodeOriginalFrame(mediaMetadataRetriever, j, r5) : decodeScaledFrame;
    }
    ...
    private static Bitmap decodeScaledFrame(MediaMetadataRetriever mediaMetadataRetriever, long j, int r12, int r13, int r14, DownsampleStrategy downsampleStrategy) {
        try {
            ...
            float scaleFactor = downsampleStrategy.getScaleFactor(parseInt, parseInt2, r13, r14);
            return mediaMetadataRetriever.getScaledFrameAtTime(j, r12, Math.round(parseInt * scaleFactor), Math.round(scaleFactor * parseInt2));
        } catch (Throwable th) {
