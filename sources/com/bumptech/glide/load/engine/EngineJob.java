...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
        ...
        synchronized (this) {
            ...
            if (this.isCancelled) {
                ...
                while (it.hasNext()) {
                    ...
                    next.executor.execute(new CallResourceReady(next.f105cb));
                }
    ...
    synchronized void incrementPendingCallbacks(int r3) {
        ...
        if (this.pendingCallbacks.getAndAdd(r3) == 0 && (engineResource = this.engineResource) != null) {
    ...
    void notifyCallbacksOfException() {
        synchronized (this) {
            ...
            if (this.isCancelled) {
                ...
                while (it.hasNext()) {
                    ResourceCallbackAndExecutor next = it.next();
                    next.executor.execute(new CallLoadFailed(next.f105cb));
                }
                decrementPendingCallbacks();
            }
        }
    ...
    public class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f103cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f103cb = resourceCallback;
        }

        @Override // java.lang.Runnable
        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f103cb)) {
                    EngineJob.this.callCallbackOnLoadFailed(this.f103cb);
                }
    ...
    public class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f104cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f104cb = resourceCallback;
        }

        @Override // java.lang.Runnable
        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f104cb)) {
                    EngineJob.this.engineResource.acquire();
                    EngineJob.this.callCallbackOnResourceReady(this.f104cb);
                    EngineJob.this.removeCallback(this.f104cb);
                }
                EngineJob.this.decrementPendingCallbacks();
            }
        }
    ...
    public static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f105cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor) {
            this.f105cb = resourceCallback;
            this.executor = executor;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f105cb.equals(((ResourceCallbackAndExecutor) obj).f105cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f105cb.hashCode();
        }
    }
