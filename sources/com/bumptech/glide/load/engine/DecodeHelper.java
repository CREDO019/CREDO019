...
public final class DecodeHelper<Transcode> {
    ...
    public <R> void init(GlideContext glideContext, Object obj, Key key, int r4, int r5, DiskCacheStrategy diskCacheStrategy, Class<?> cls, Class<R> cls2, Priority priority, Options options, Map<Class<?>, Transformation<?>> map, boolean z, boolean z2, DecodeJob.DiskCacheProvider diskCacheProvider) {
    ...
    public boolean isSourceKey(Key key) {
        ...
        for (int r3 = 0; r3 < size; r3++) {
            if (loadData.get(r3).sourceKey.equals(key)) {
                return true;
            }
        }
        return false;
    ...
    public List<ModelLoader.LoadData<?>> getLoadData() {
        if (!this.isLoadDataSet) {
            ...
            for (int r1 = 0; r1 < size; r1++) {
                ModelLoader.LoadData<?> buildLoadData = ((ModelLoader) modelLoaders.get(r1)).buildLoadData(this.model, this.width, this.height, this.options);
