...
public class LruBitmapPool implements BitmapPool {
    ...
    public Bitmap get(int r2, int r3, Bitmap.Config config) {
        Bitmap dirtyOrNull = getDirtyOrNull(r2, r3, config);
        if (dirtyOrNull != null) {
            dirtyOrNull.eraseColor(0);
            return dirtyOrNull;
        }
        return createBitmap(r2, r3, config);
    }

    @Override // com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool
    public Bitmap getDirty(int r2, int r3, Bitmap.Config config) {
        Bitmap dirtyOrNull = getDirtyOrNull(r2, r3, config);
        return dirtyOrNull == null ? createBitmap(r2, r3, config) : dirtyOrNull;
    }
