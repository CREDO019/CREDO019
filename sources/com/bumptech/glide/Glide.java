...
public class Glide implements ComponentCallbacks2 {
    ...
    public Glide(Context context, Engine engine, MemoryCache memoryCache, BitmapPool bitmapPool, ArrayPool arrayPool, RequestManagerRetriever requestManagerRetriever, ConnectivityMonitorFactory connectivityMonitorFactory, int r29, RequestOptions requestOptions, Map<Class<?>, TransitionOptions<?, ?>> map, List<RequestListener<Object>> list, boolean z) {
        this.engine = engine;
        ...
        this.glideContext = new GlideContext(context, arrayPool, registry, new ImageViewTargetFactory(), requestOptions, map, list, engine, z, r29);
    }
    ...
    public void trimMemory(int r2) {
        Util.assertMainThread();
        this.memoryCache.trimMemory(r2);
        this.bitmapPool.trimMemory(r2);
        this.arrayPool.trimMemory(r2);
    }
