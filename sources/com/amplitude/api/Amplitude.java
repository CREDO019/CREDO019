...
public class Amplitude {
    ...
    @Deprecated
    public static void logRevenue(String str, int r2, double d) {
        getInstance().logRevenue(str, r2, d);
    }

    @Deprecated
    public static void logRevenue(String str, int r8, double d, String str2, String str3) {
        getInstance().logRevenue(str, r8, d, str2, str3);
    }
