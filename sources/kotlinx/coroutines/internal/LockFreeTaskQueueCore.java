...
public final class LockFreeTaskQueueCore<E> {
    ...
    private final LockFreeTaskQueueCore<E> fillPlaceholder(int r3, E e) {
        Object obj = this.array.get(this.mask & r3);
        if ((obj instanceof Placeholder) && ((Placeholder) obj).index == r3) {
            this.array.set(r3 & this.mask, e);
            return this;
        }
        return null;
    }
    ...
    private final LockFreeTaskQueueCore<E> allocateNextCopy(long j) {
        ...
        int r2 = (int) ((HEAD_MASK & j) >> 0);
        int r1 = (int) ((TAIL_MASK & j) >> 30);
        while (true) {
            int r3 = this.mask;
            if ((r2 & r3) != (r1 & r3)) {
                Object obj = this.array.get(r3 & r2);
                if (obj == null) {
                    obj = new Placeholder(r2);
                }
                lockFreeTaskQueueCore.array.set(lockFreeTaskQueueCore.mask & r2, obj);
                r2++;
            } else {
                lockFreeTaskQueueCore._state = Companion.m157wo(j, 1152921504606846976L);
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> function1) {
        ...
        long j = this._state;
        int r4 = (int) ((HEAD_MASK & j) >> 0);
        int r2 = (int) ((j & TAIL_MASK) >> 30);
        while (true) {
            int r1 = this.mask;
            if ((r4 & r1) != (r2 & r1)) {
                Object obj = (Object) this.array.get(r1 & r4);
    ...
    /* compiled from: LockFreeTaskQueue.kt */
    @Metadata(m184d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0010\u0010\u0002\u001a\u00020\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m183d2 = {"Lkotlinx/coroutines/internal/LockFreeTaskQueueCore$Placeholder;", "", "index", "", "(I)V", "kotlinx-coroutines-core"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes5.dex */
    ...
    /* compiled from: LockFreeTaskQueue.kt */
    @Metadata(m184d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\t\n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\n\u0010\u0016\u001a\u00020\u0004*\u00020\tJ\u0012\u0010\u0017\u001a\u00020\t*\u00020\t2\u0006\u0010\u0018\u001a\u00020\u0004J\u0012\u0010\u0019\u001a\u00020\t*\u00020\t2\u0006\u0010\u001a\u001a\u00020\u0004JP\u0010\u001b\u001a\u0002H\u001c\"\u0004\b\u0001\u0010\u001c*\u00020\t26\u0010\u001d\u001a2\u0012\u0013\u0012\u00110\u0004¢\u0006\f\b\u001f\u0012\b\b \u0012\u0004\b\b(!\u0012\u0013\u0012\u00110\u0004¢\u0006\f\b\u001f\u0012\b\b \u0012\u0004\b\b(\"\u0012\u0004\u0012\u0002H\u001c0\u001eH\u0086\b¢\u0006\u0002\u0010#J\u0015\u0010$\u001a\u00020\t*\u00020\t2\u0006\u0010%\u001a\u00020\tH\u0086\u0004R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\tX\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\tX\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0010\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u0010\u0010\u0012\u001a\u00020\u00138\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0014\u001a\u00020\tX\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006&"}, m183d2 = {"Lkotlinx/coroutines/internal/LockFreeTaskQueueCore$Companion;", "", "()V", "ADD_CLOSED", "", "ADD_FROZEN", "ADD_SUCCESS", "CAPACITY_BITS", "CLOSED_MASK", "", "CLOSED_SHIFT", "FROZEN_MASK", "FROZEN_SHIFT", "HEAD_MASK", "HEAD_SHIFT", "INITIAL_CAPACITY", "MAX_CAPACITY_MASK", "MIN_ADD_SPIN_CAPACITY", "REMOVE_FROZEN", "Lkotlinx/coroutines/internal/Symbol;", "TAIL_MASK", "TAIL_SHIFT", "addFailReason", "updateHead", "newHead", "updateTail", "newTail", "withState", "T", "block", "Lkotlin/Function2;", "Lkotlin/ParameterName;", "name", TtmlNode.TAG_HEAD, "tail", "(JLkotlin/jvm/functions/Function2;)Ljava/lang/Object;", "wo", "other", "kotlinx-coroutines-core"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes5.dex */
    public static final class Companion {
        ...
        /* renamed from: wo */
        public final long m157wo(long j, long j2) {
            return j & (~j2);
        }
        ...
        public final long updateHead(long j, int r5) {
            return m157wo(j, LockFreeTaskQueueCore.HEAD_MASK) | (r5 << 0);
        }

        public final long updateTail(long j, int r5) {
            return m157wo(j, LockFreeTaskQueueCore.TAIL_MASK) | (r5 << 30);
        }
    ...
    */
    ...
    public final Object removeFirstOrNull() {
        while (true) {
            ...
            int r6 = (int) ((HEAD_MASK & j) >> 0);
            int r1 = (int) ((TAIL_MASK & j) >> 30);
            int r4 = this.mask;
            if ((r1 & r4) == (r6 & r4)) {
                return null;
            }
            Object obj = this.array.get(r4 & r6);
            if (obj == null) {
                ...
                int r9 = (r6 + 1) & MAX_CAPACITY_MASK;
                if (_state$FU.compareAndSet(this, j, companion.updateHead(j, r9))) {
                    this.array.set(this.mask & r6, null);
                    return obj;
                } else if (this.singleConsumer) {
                    LockFreeTaskQueueCore<E> lockFreeTaskQueueCore = this;
                    do {
                        lockFreeTaskQueueCore = lockFreeTaskQueueCore.removeSlowPath(r6, r9);
    ...
    private final LockFreeTaskQueueCore<E> removeSlowPath(int r10, int r11) {
        long j;
        Companion companion;
        int r6;
        do {
        ...
        } while (!_state$FU.compareAndSet(this, j, companion.updateHead(j, r11)));
        this.array.set(this.mask & r6, null);
        return null;
    }
    ...
    private final LockFreeTaskQueueCore<E> allocateOrGetNextCopy(long j) {
        while (true) {
            ...
            C0255xc40028dd.m1422m(_next$FU, this, null, allocateNextCopy(j));
        }
    }
}
