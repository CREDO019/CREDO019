        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (Debug.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    ...
                    continuation.resumeWith(Result.m1749constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m1749constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m1749constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m1749constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            try {
                ...
                m1749constructorimpl2 = Result.m1749constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m1749constructorimpl2 = Result.m1749constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m1752exceptionOrNullimpl(m1749constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m1749constructorimpl = Result.m1749constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m1752exceptionOrNullimpl(m1749constructorimpl));
        }
    }
