...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        if (newInstance != null) {
            m1749constructorimpl = Result.m1749constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
            if (Result.m1755isFailureimpl(m1749constructorimpl)) {
                m1749constructorimpl = null;
            }
            return (Function1) m1749constructorimpl;
        }
    ...
    public final void install() {
        ...
        for (int r4 = 0; r4 < readHoldCount; r4++) {
            readLock.unlock();
        }
    ...
    private final <R> List<R> dumpCoroutinesInfoImpl(final Function2<? super CoroutineOwner<?>, ? super CoroutineContext, ? extends R> function2) {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new C4920x8808a3e8()), new Function1<CoroutineOwner<?>, R>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$1$3
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            m1749constructorimpl = Result.m1749constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m1749constructorimpl = Result.m1749constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) m1749constructorimpl;
        ...
        while (true) {
            ...
            StackTraceElement stackTraceElement = stackTraceElementArr[r1];
        ...
        Tuples<Integer, Integer> findContinuationStartIndex = findContinuationStartIndex(r1, stackTraceElementArr, list);
        int intValue = findContinuationStartIndex.component1().intValue();
        int intValue2 = findContinuationStartIndex.component2().intValue();
        if (intValue == -1) {
            return list;
        }
        ArrayList arrayList = new ArrayList((((list.size() + r1) - intValue) - 1) - intValue2);
        int r12 = r1 - intValue2;
        for (int r0 = 0; r0 < r12; r0++) {
            arrayList.add(stackTraceElementArr[r0]);
        }
        int size = list.size();
        for (int r4 = intValue + 1; r4 < size; r4++) {
            arrayList.add(list.get(r4));
        }
        return arrayList;
    }

    private final Tuples<Integer, Integer> findContinuationStartIndex(int r6, StackTraceElement[] stackTraceElementArr, List<StackTraceElement> list) {
        for (int r1 = 0; r1 < 3; r1++) {
            int findIndexOfFrame = INSTANCE.findIndexOfFrame((r6 - 1) - r1, stackTraceElementArr, list);
            if (findIndexOfFrame != -1) {
                return TuplesKt.m176to(Integer.valueOf(findIndexOfFrame), Integer.valueOf(r1));
            }
        }
        return TuplesKt.m176to(-1, 0);
    }

    private final int findIndexOfFrame(int r6, StackTraceElement[] stackTraceElementArr, List<StackTraceElement> list) {
        StackTraceElement stackTraceElement = (StackTraceElement) ArraysKt.getOrNull(stackTraceElementArr, r6);
    ...
    private final <T extends Throwable> List<StackTraceElement> sanitizeStackTrace(T t) {
        ...
        if (!sanitizeStackTraces) {
            ...
            int r4 = 0;
            while (r4 < r0) {
                arrayList.add(r4 == 0 ? StackTraceRecovery.artificialFrame(ARTIFICIAL_FRAME_MESSAGE) : stackTrace[r4 + r2]);
                r4++;
            }
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList((length - r2) + 1);
        ArrayList arrayList3 = arrayList2;
        arrayList3.add(StackTraceRecovery.artificialFrame(ARTIFICIAL_FRAME_MESSAGE));
        while (true) {
            r2++;
            while (r2 < length) {
                if (isInternalMethod(stackTrace[r2])) {
                    arrayList3.add(stackTrace[r2]);
                    int r32 = r2 + 1;
                    while (r32 < length && isInternalMethod(stackTrace[r32])) {
                        r32++;
                    }
                    int r5 = r32 - 1;
                    int r6 = r5;
                    while (r6 > r2 && stackTrace[r6].getFileName() == null) {
                        r6--;
                    }
                    if (r6 > r2 && r6 < r5) {
                        arrayList3.add(stackTrace[r6]);
                    }
                    arrayList3.add(stackTrace[r5]);
                    r2 = r32;
                }
            }
            return arrayList2;
    ...
    public final List<DebuggerInfo> dumpDebuggerInfo() {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new C4920x8808a3e8()), new Function1<CoroutineOwner<?>, DebuggerInfo>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpDebuggerInfo$$inlined$dumpCoroutinesInfoImpl$1
                @Override // kotlin.jvm.functions.Function1
