...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public CancellableContinuationImpl(Continuation<? super T> continuation, int r4) {
        super(r4);
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (C0255xc40028dd.m1422m(_state$FU, this, obj, makeCancelHandler)) {
                    return;
                }
                ...
                if (z) {
                    ...
                    if (completedContinuation.getCancelled()) {
                        ...
                        if (C0255xc40028dd.m1422m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, makeCancelHandler, null, null, null, 29, null))) {
                            return;
                        }
                    }
                    ...
                    if (C0255xc40028dd.m1422m(_state$FU, this, obj, new CompletedContinuation(obj, makeCancelHandler, null, null, null, 28, null))) {
                        return;
                    }
                }
            }
    ...
    private final void dispatchResume(int r2) {
        ...
        DispatchedTaskKt.dispatch(this, r2);
    }

    private final Object resumedState(NotCompleted notCompleted, Object obj, int r11, Function1<? super Throwable, Unit> function1, Object obj2) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return obj;
        } else if (DispatchedTaskKt.isCancellableMode(r11) || obj2 != null) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    static /* synthetic */ void resumeImpl$default(CancellableContinuationImpl cancellableContinuationImpl, Object obj, int r2, Function1 function1, int r4, Object obj2) {
        if (obj2 != null) {
        ...
        cancellableContinuationImpl.resumeImpl(obj, r2, function1);
    }
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object obj, Throwable th) {
        while (true) {
            ...
            if (obj2 instanceof CompletedContinuation) {
                ...
                if (C0255xc40028dd.m1422m(_state$FU, this, obj2, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, th, 15, null))) {
                    completedContinuation.invokeHandlers(this, th);
                    return;
                }
            } else if (C0255xc40028dd.m1422m(_state$FU, this, obj2, new CompletedContinuation(obj2, null, null, null, th, 14, null))) {
                return;
            }
        }
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!C0255xc40028dd.m1422m(_state$FU, this, obj, new CompletionState(this, th, z)));
    ...
    private final void resumeImpl(Object obj, int r10, Function1<? super Throwable, Unit> function1) {
        Object obj2;
        do {
            obj2 = this._state;
            if (obj2 instanceof NotCompleted) {
        ...
        } while (!C0255xc40028dd.m1422m(_state$FU, this, obj2, resumedState((NotCompleted) obj2, obj, r10, function1, null)));
        detachChildIfNonResuable();
        dispatchResume(r10);
    }
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function1<? super Throwable, Unit> function1) {
        ...
        } while (!C0255xc40028dd.m1422m(_state$FU, this, obj3, resumedState((NotCompleted) obj3, obj, this.resumeMode, function1, obj2)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
}
