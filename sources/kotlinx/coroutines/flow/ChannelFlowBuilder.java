...
public class ChannelFlowBuilder<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelFlowBuilder(Function2 function2, EmptyCoroutineContext emptyCoroutineContext, int r3, BufferOverflow bufferOverflow, int r5, DefaultConstructorMarker defaultConstructorMarker) {
        this(function2, (r5 & 2) != 0 ? EmptyCoroutineContext.INSTANCE : emptyCoroutineContext, (r5 & 4) != 0 ? -2 : r3, (r5 & 8) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
    ...
    protected ChannelFlow<T> create(CoroutineContext coroutineContext, int r4, BufferOverflow bufferOverflow) {
        return new ChannelFlowBuilder(this.block, coroutineContext, r4, bufferOverflow);
    }
