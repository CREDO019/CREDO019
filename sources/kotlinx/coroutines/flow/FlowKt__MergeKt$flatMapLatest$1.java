...
@Metadata(m184d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\u0006\u0010\u0005\u001a\u0002H\u0002H\u008a@"}, m183d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it"}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 176)
@DebugMetadata(m175c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapLatest$1", m174f = "Merge.kt", m173i = {}, m172l = {190, 190}, m171m = "invokeSuspend", m170n = {}, m169s = {})
...
public final class FlowKt__MergeKt$flatMapLatest$1<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 == 0) {
            ...
            this.label = 1;
            obj = this.$transform.invoke(obj3, this);
            if (obj == obj2) {
                return obj2;
            }
        } else if (r1 != 1) {
