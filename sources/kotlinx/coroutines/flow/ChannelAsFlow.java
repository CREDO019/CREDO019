...
public final class ChannelAsFlow<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelAsFlow(ReceiveChannel receiveChannel, boolean z, EmptyCoroutineContext emptyCoroutineContext, int r10, BufferOverflow bufferOverflow, int r12, DefaultConstructorMarker defaultConstructorMarker) {
        this(receiveChannel, z, (r12 & 4) != 0 ? EmptyCoroutineContext.INSTANCE : emptyCoroutineContext, (r12 & 8) != 0 ? -3 : r10, (r12 & 16) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public ChannelAsFlow(ReceiveChannel<? extends T> receiveChannel, boolean z, CoroutineContext coroutineContext, int r4, BufferOverflow bufferOverflow) {
    ...
    protected ChannelFlow<T> create(CoroutineContext coroutineContext, int r9, BufferOverflow bufferOverflow) {
        return new ChannelAsFlow(this.channel, this.consume, coroutineContext, r9, bufferOverflow);
    }
