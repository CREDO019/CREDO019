...
@Metadata(m184d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u00022\u0006\u0010\u0004\u001a\u00020\u0005H\u008a@"}, m183d2 = {"<anonymous>", "", "Lkotlinx/coroutines/flow/FlowCollector;", "Lkotlinx/coroutines/flow/SharingCommand;", NewHtcHomeBadger.COUNT, ""}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
@DebugMetadata(m175c = "kotlinx.coroutines.flow.StartedWhileSubscribed$command$1", m174f = "SharingStarted.kt", m173i = {1, 2, 3}, m172l = {178, RotationOptions.ROTATE_180, 182, 183, 185}, m171m = "invokeSuspend", m170n = {"$this$transformLatest", "$this$transformLatest", "$this$transformLatest"}, m169s = {"L$0", "L$0", "L$0"})
...
final class StartedWhileSubscribed$command$1 extends SuspendLambda implements Function3<FlowCollector<? super SharingCommand>, Integer, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(FlowCollector<? super SharingCommand> flowCollector, int r4, Continuation<? super Unit> continuation) {
        ...
        startedWhileSubscribed$command$1.I$0 = r4;
