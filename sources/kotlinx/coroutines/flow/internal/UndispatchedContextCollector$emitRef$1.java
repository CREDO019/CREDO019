...
@Metadata(m184d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m183d2 = {"<anonymous>", "", "T", "it"}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
@DebugMetadata(m175c = "kotlinx.coroutines.flow.internal.UndispatchedContextCollector$emitRef$1", m174f = "ChannelFlow.kt", m173i = {}, m172l = {212}, m171m = "invokeSuspend", m170n = {}, m169s = {})
...
final class UndispatchedContextCollector$emitRef$1<T> extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 == 0) {
            ...
            this.label = 1;
            if (this.$downstream.emit(obj3, this) == obj2) {
                return obj2;
            }
        } else if (r1 != 1) {
