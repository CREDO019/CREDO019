...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    protected abstract ChannelFlow<T> create(CoroutineContext coroutineContext, int r2, BufferOverflow bufferOverflow);
    ...
    public Flow<T> fuse(CoroutineContext coroutineContext, int r5, BufferOverflow bufferOverflow) {
        if (Debug.getASSERTIONS_ENABLED()) {
            if (!(r5 != -1)) {
                throw new AssertionError();
            }
        ...
        if (Intrinsics.areEqual(plus, this.context) && r5 == this.capacity && bufferOverflow == this.onBufferOverflow) {
            return this;
        }
        return create(plus, r5, bufferOverflow);
    }
