...
@Metadata(m184d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m183d2 = {"<anonymous>", "", "T", "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
...
public final class ChannelFlowMerge$collectTo$2<T> implements FlowCollector {
    ...
    */
    ...
    @DebugMetadata(m175c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m174f = "Merge.kt", m173i = {}, m172l = {69}, m171m = "invokeSuspend", m170n = {}, m169s = {})
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1 */
    /* loaded from: classes5.dex */
    public static final class C49981 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ SendingCollector<T> $collector;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C49981(Flow<? extends T> flow, SendingCollector<T> sendingCollector, Semaphore semaphore, Continuation<? super C49981> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C49981(this.$inner, this.$collector, this.$semaphore, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C49981) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (r1 == 0) {
                    ...
                    this.label = 1;
                    if (this.$inner.collect(this.$collector, this) == obj2) {
                        return obj2;
                    }
                } else if (r1 != 1) {
