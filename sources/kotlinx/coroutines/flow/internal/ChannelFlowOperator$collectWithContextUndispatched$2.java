...
@Metadata(m184d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0005H\u008a@"}, m183d2 = {"<anonymous>", "", ExifInterface.LATITUDE_SOUTH, "T", "it", "Lkotlinx/coroutines/flow/FlowCollector;"}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
@DebugMetadata(m175c = "kotlinx.coroutines.flow.internal.ChannelFlowOperator$collectWithContextUndispatched$2", m174f = "ChannelFlow.kt", m173i = {}, m172l = {152}, m171m = "invokeSuspend", m170n = {}, m169s = {})
...
public final class ChannelFlowOperator$collectWithContextUndispatched$2<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 == 0) {
            ...
            this.label = 1;
            if (channelFlowOperator.flowCollect((FlowCollector) this.L$0, this) == obj2) {
                return obj2;
            }
        } else if (r1 != 1) {
