...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    public ChannelFlowOperator(Flow<? extends S> flow, CoroutineContext coroutineContext, int r3, BufferOverflow bufferOverflow) {
