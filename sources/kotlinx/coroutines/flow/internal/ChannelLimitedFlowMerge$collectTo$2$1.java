...
@DebugMetadata(m175c = "kotlinx.coroutines.flow.internal.ChannelLimitedFlowMerge$collectTo$2$1", m174f = "Merge.kt", m173i = {}, m172l = {96}, m171m = "invokeSuspend", m170n = {}, m169s = {})
...
final class ChannelLimitedFlowMerge$collectTo$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 == 0) {
            ...
            this.label = 1;
            if (this.$flow.collect(this.$collector, this) == obj2) {
                return obj2;
            }
        } else if (r1 != 1) {
