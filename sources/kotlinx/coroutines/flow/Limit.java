...
public final /* synthetic */ class Limit {
    ...
    */
    ...
    public static final <T> Flow<T> drop(final Flow<? extends T> flow, final int r2) {
        if (!(r2 >= 0)) {
            throw new IllegalArgumentException(("Drop count should be non-negative, but had " + r2).toString());
        }
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__LimitKt$drop$$inlined$unsafeFlow$1
            @Override // kotlinx.coroutines.flow.Flow
            public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
                Object collect = Flow.this.collect(new FlowKt__LimitKt$drop$2$1(new Ref.IntRef(), r2, flowCollector), continuation);
    ...
    public static final <T> Flow<T> take(Flow<? extends T> flow, int r2) {
        if (!(r2 > 0)) {
            throw new IllegalArgumentException(("Requested element count " + r2 + " should be positive").toString());
        }
        return new FlowKt__LimitKt$take$$inlined$unsafeFlow$1(flow, r2);
    }
