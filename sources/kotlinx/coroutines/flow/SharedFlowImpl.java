    ...
    */
    ...
    public boolean tryEmit(T t) {
        ...
        for (Continuation<Unit> continuation : continuationArr) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m1749constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    public final boolean tryEmitLocked(T t) {
        ...
        if (this.bufferSize >= this.bufferCapacity && this.minCollectorIndex <= this.replayIndex) {
            int r0 = WhenMappings.$EnumSwitchMapping$0[this.onBufferOverflow.ordinal()];
            if (r0 == 1) {
                return false;
            }
            if (r0 == 2) {
        ...
        enqueueLocked(t);
        int r15 = this.bufferSize + 1;
        this.bufferSize = r15;
        if (r15 > this.bufferCapacity) {
            dropOldestLocked();
        }
    ...
    private final Object[] growBuffer(Object[] objArr, int r8, int r9) {
        if (!(r9 > 0)) {
    ...
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long j) {
        ...
        if (getNCollectors() > 0) {
            r4 = Math.min(this.queueSize, this.bufferCapacity - ((int) (bufferEndIndex - j4)));
        } else {
            r4 = this.queueSize;
        }
        Continuation<Unit>[] continuationArr = AbstractSharedFlowKt.EMPTY_RESUMES;
        ...
        if (r4 > 0) {
            continuationArr = new Continuation[r4];
            Object[] objArr = this.buffer;
            Intrinsics.checkNotNull(objArr);
            ...
            while (true) {
                ...
                if (access$getBufferAt != SharedFlowKt.NO_VALUE) {
                    ...
                    int r6 = r18 + 1;
                    j2 = j4;
                    continuationArr[r18] = emitter.cont;
        ...
        int r1 = (int) (bufferEndIndex - head);
        long j7 = getNCollectors() == 0 ? bufferEndIndex : j2;
        long max = Math.max(this.replayIndex, bufferEndIndex - Math.min(this.replay, r1));
    ...
    public final Continuation<Unit>[] findSlotsToResumeLocked(Continuation<Unit>[] continuationArr) {
        ...
        if (AbstractSharedFlow.access$getNCollectors(sharedFlowImpl) != 0 && (access$getSlots = AbstractSharedFlow.access$getSlots(sharedFlowImpl)) != null) {
            ...
            while (r2 < length2) {
                AbstractSharedFlowSlot abstractSharedFlowSlot = access$getSlots[r2];
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // kotlinx.coroutines.flow.internal.AbstractSharedFlow
    public SharedFlowSlot[] createSlotArray(int r1) {
        return new SharedFlowSlot[r1];
    }

    @Override // kotlinx.coroutines.flow.internal.FusibleFlow
    public Flow<T> fuse(CoroutineContext coroutineContext, int r3, BufferOverflow bufferOverflow) {
        return SharedFlowKt.fuseSharedFlow(this, coroutineContext, r3, bufferOverflow);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: SharedFlow.kt */
    @Metadata(m184d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0002\u0018\u00002\u00020\u0001B1\u0012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t¢\u0006\u0002\u0010\u000bJ\b\u0010\f\u001a\u00020\nH\u0016R\u0016\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, m183d2 = {"Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;", "Lkotlinx/coroutines/DisposableHandle;", "flow", "Lkotlinx/coroutines/flow/SharedFlowImpl;", "index", "", "value", "", "cont", "Lkotlin/coroutines/Continuation;", "", "(Lkotlinx/coroutines/flow/SharedFlowImpl;JLjava/lang/Object;Lkotlin/coroutines/Continuation;)V", "dispose", "kotlinx-coroutines-core"}, m182k = 1, m181mv = {1, 6, 0}, m179xi = 48)
    /* loaded from: classes5.dex */
    ...
    public List<T> getReplayCache() {
        synchronized (this) {
            ...
            Object[] objArr = this.buffer;
            Intrinsics.checkNotNull(objArr);
            for (int r3 = 0; r3 < replaySize; r3++) {
                arrayList.add(SharedFlowKt.access$getBufferAt(objArr, this.replayIndex + r3));
            }
            return arrayList;
        }
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation<Unit> continuation2 : continuationArr) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m1749constructorimpl(Unit.INSTANCE));
            }
        }
