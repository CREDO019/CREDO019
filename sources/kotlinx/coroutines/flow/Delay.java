...
public final /* synthetic */ class Delay {
    ...
    public static final <T> Flow<T> debounce(Flow<? extends T> flow, final long j) {
        ...
        if (r2 >= 0) {
            return r2 == 0 ? flow : debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$2
    ...
    public static final <T> Flow<T> m3235debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m3192toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m3192toDelayMillisLRDsOJo(function1.invoke(t).m3109unboximpl()));
            }
        });
    }
    ...
    public static /* synthetic */ ReceiveChannel fixedPeriodTicker$default(CoroutineScope coroutineScope, long j, long j2, int r5, Object obj) {
        if ((r5 & 2) != 0) {
            j2 = j;
        }
    ...
    public static final <T> Flow<T> m3236sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m3192toDelayMillisLRDsOJo(j));
    }
}
