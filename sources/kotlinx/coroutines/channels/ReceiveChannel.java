...
public interface ReceiveChannel<E> {
    ...
    Object mo3207receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo3208tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void cancel$default(ReceiveChannel receiveChannel, CancellationException cancellationException, int r2, Object obj) {
            if (obj != null) {
        ...
        public static /* synthetic */ boolean cancel$default(ReceiveChannel receiveChannel, Throwable th, int r2, Object obj) {
            if (obj == null) {
                if ((r2 & 1) != 0) {
                    th = null;
                }
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo3208tryReceivePtdJZtk = receiveChannel.mo3208tryReceivePtdJZtk();
            if (ChannelResult.m3224isSuccessimpl(mo3208tryReceivePtdJZtk)) {
                return (E) ChannelResult.m3220getOrThrowimpl(mo3208tryReceivePtdJZtk);
            }
            Throwable m3218exceptionOrNullimpl = ChannelResult.m3218exceptionOrNullimpl(mo3208tryReceivePtdJZtk);
            if (m3218exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecovery.recoverStackTrace(m3218exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L19:
                ...
                java.lang.Object r4 = r5.m3226unboximpl()
                goto L44
            L30:
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo3207receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m3219getOrNullimpl(r4)
                return r4
            */
