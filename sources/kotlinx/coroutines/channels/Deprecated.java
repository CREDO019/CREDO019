...
public final /* synthetic */ class Deprecated {
    ...
    */
    ...
    public static /* synthetic */ ReceiveChannel drop$default(ReceiveChannel receiveChannel, int r1, CoroutineContext coroutineContext, int r3, Object obj) {
        ReceiveChannel drop;
        if ((r3 & 2) != 0) {
            coroutineContext = Dispatchers.getUnconfined();
        }
        drop = drop(receiveChannel, r1, coroutineContext);
        return drop;
    }

    @kotlin.Deprecated(level = DeprecationLevel.HIDDEN, message = "Binary compatibility")
    public static final /* synthetic */ ReceiveChannel drop(ReceiveChannel receiveChannel, int r10, CoroutineContext coroutineContext) {
        return Produce.produce$default(GlobalScope.INSTANCE, coroutineContext, 0, null, ChannelsKt.consumes(receiveChannel), new ChannelsKt__DeprecatedKt$drop$1(r10, receiveChannel, null), 6, null);
    }

    public static /* synthetic */ ReceiveChannel dropWhile$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function2 function2, int r3, Object obj) {
    ...
    public static /* synthetic */ ReceiveChannel filter$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function2 function2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            coroutineContext = Dispatchers.getUnconfined();
        }
    ...
    public static /* synthetic */ ReceiveChannel filterIndexed$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function3 function3, int r3, Object obj) {
    ...
    public static /* synthetic */ ReceiveChannel filterNot$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function2 function2, int r3, Object obj) {
    ...
    */
    ...
    public static /* synthetic */ ReceiveChannel take$default(ReceiveChannel receiveChannel, int r1, CoroutineContext coroutineContext, int r3, Object obj) {
        ReceiveChannel take;
        if ((r3 & 2) != 0) {
            coroutineContext = Dispatchers.getUnconfined();
        }
        take = take(receiveChannel, r1, coroutineContext);
        return take;
    }

    @kotlin.Deprecated(level = DeprecationLevel.HIDDEN, message = "Binary compatibility")
    public static final /* synthetic */ ReceiveChannel take(ReceiveChannel receiveChannel, int r10, CoroutineContext coroutineContext) {
        return Produce.produce$default(GlobalScope.INSTANCE, coroutineContext, 0, null, ChannelsKt.consumes(receiveChannel), new ChannelsKt__DeprecatedKt$take$1(r10, receiveChannel, null), 6, null);
    }

    public static /* synthetic */ ReceiveChannel takeWhile$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function2 function2, int r3, Object obj) {
    ...
    */
    ...
    public static /* synthetic */ ReceiveChannel flatMap$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function2 function2, int r3, Object obj) {
    ...
    public static /* synthetic */ ReceiveChannel map$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function2 function2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            coroutineContext = Dispatchers.getUnconfined();
        }
    ...
    public static /* synthetic */ ReceiveChannel mapIndexed$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function3 function3, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            coroutineContext = Dispatchers.getUnconfined();
        }
    ...
    public static /* synthetic */ ReceiveChannel mapIndexedNotNull$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function3 function3, int r3, Object obj) {
    ...
    public static /* synthetic */ ReceiveChannel mapNotNull$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function2 function2, int r3, Object obj) {
    ...
    public static /* synthetic */ ReceiveChannel withIndex$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, int r2, Object obj) {
    ...
    public static /* synthetic */ ReceiveChannel distinctBy$default(ReceiveChannel receiveChannel, CoroutineContext coroutineContext, Function2 function2, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            coroutineContext = Dispatchers.getUnconfined();
        }
    ...
    */
    ...
    public static /* synthetic */ ReceiveChannel zip$default(ReceiveChannel receiveChannel, ReceiveChannel receiveChannel2, CoroutineContext coroutineContext, Function2 function2, int r4, Object obj) {
        if ((r4 & 2) != 0) {
            coroutineContext = Dispatchers.getUnconfined();
        }
