...
@Metadata(m184d1 = {"\u0000\b\n\u0002\b\u0004\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001\"\u0006\b\u0001\u0010\u0002 \u00012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@"}, m183d2 = {"<anonymous>", "R", ExifInterface.LONGITUDE_EAST, "it", "Lkotlinx/coroutines/channels/ChannelResult;"}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
@DebugMetadata(m175c = "kotlinx.coroutines.channels.ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1", m174f = "Channel.kt", m173i = {}, m172l = {375}, m171m = "invokeSuspend", m170n = {}, m169s = {})
...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m3230invokeWpGqRn0(((ChannelResult) obj).m3226unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m3230invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m3214boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 == 0) {
            ...
            Object m3226unboximpl = ((ChannelResult) this.L$0).m3226unboximpl();
            ...
            Object m3219getOrNullimpl = ChannelResult.m3219getOrNullimpl(m3226unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m3219getOrNullimpl, this);
            if (obj == obj2) {
                return obj2;
            }
        } else if (r1 != 1) {
