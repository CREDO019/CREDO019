...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m3227closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m3229successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m3227closedJP2dKIU(closed.closeCause);
    }
}
