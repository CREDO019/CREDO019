...
public interface SendChannel<E> {
    ...
    Object mo3209trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ boolean close$default(SendChannel sendChannel, Throwable th, int r2, Object obj) {
            if (obj == null) {
                if ((r2 & 1) != 0) {
                    th = null;
                }
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m3224isSuccessimpl(mo3209trySendJP2dKIU)) {
                return true;
            }
            Throwable m3218exceptionOrNullimpl = ChannelResult.m3218exceptionOrNullimpl(mo3209trySendJP2dKIU);
