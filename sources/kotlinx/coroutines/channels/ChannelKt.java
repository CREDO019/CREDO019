...
public final class ChannelKt {
    ...
    public static final <T> Object m3212onFailureWpGqRn0(Object obj, Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m3218exceptionOrNullimpl(obj));
        }
        return obj;
    }

    /* renamed from: onClosed-WpGqRn0 */
    public static final <T> Object m3211onClosedWpGqRn0(Object obj, Function1<? super Throwable, Unit> function1) {
    ...
    public static /* synthetic */ Channel Channel$default(int r0, BufferOverflow bufferOverflow, Function1 function1, int r3, Object obj) {
        if ((r3 & 1) != 0) {
            r0 = 0;
        }
        if ((r3 & 2) != 0) {
        ...
        return Channel(r0, bufferOverflow, function1);
    }

    public static final <E> Channel<E> Channel(int r2, BufferOverflow bufferOverflow, Function1<? super E, Unit> function1) {
        ...
        if (r2 == -2) {
            ...
            if (r2 == 1 && bufferOverflow == BufferOverflow.DROP_OLDEST) {
                arrayChannel2 = new ConflatedChannel(function1);
            } else {
                arrayChannel2 = new ArrayChannel(r2, bufferOverflow, function1);
            }
            return arrayChannel2;
        }
    }

    public static /* synthetic */ Channel Channel$default(int r0, int r1, Object obj) {
        if ((r1 & 1) != 0) {
            r0 = 0;
        }
        return Channel$default(r0, null, null, 6, null);
    }
}
