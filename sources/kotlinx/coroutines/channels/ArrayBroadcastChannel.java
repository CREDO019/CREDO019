...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    public ArrayBroadcastChannel(int r4) {
        super(null);
        this.capacity = r4;
        if (!(r4 >= 1)) {
            throw new IllegalArgumentException(("ArrayBroadcastChannel capacity must be at least 1, but " + r4 + " was specified").toString());
        }
        this.bufferLock = new ReentrantLock();
        this.buffer = new Object[r4];
        this._head = 0L;
        this._tail = 0L;
        this._size = 0;
    ...
    static /* synthetic */ void updateHead$default(ArrayBroadcastChannel arrayBroadcastChannel, Subscriber subscriber, Subscriber subscriber2, int r4, Object obj) {
        if ((r4 & 1) != 0) {
            subscriber = null;
        }
        if ((r4 & 2) != 0) {
    ...
    */
    private final void updateHead(kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r14, kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r15) {
        ...
        L7a:
            ...
            goto L58
        L81:
            boolean r12 = r8 instanceof kotlinx.coroutines.channels.Closed     // Catch: java.lang.Throwable -> L22
            if (r12 != 0) goto L58
        ...
        La2:
            ...
            java.lang.Object r4 = r8.getPollResult()     // Catch: java.lang.Throwable -> L22
