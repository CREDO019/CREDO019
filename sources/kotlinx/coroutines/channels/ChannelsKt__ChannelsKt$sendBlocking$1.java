...
@Metadata(m184d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m183d2 = {"<anonymous>", "", ExifInterface.LONGITUDE_EAST, "Lkotlinx/coroutines/CoroutineScope;"}, m182k = 3, m181mv = {1, 6, 0}, m179xi = 48)
@DebugMetadata(m175c = "kotlinx.coroutines.channels.ChannelsKt__ChannelsKt$sendBlocking$1", m174f = "Channels.kt", m173i = {}, m172l = {58}, m171m = "invokeSuspend", m170n = {}, m169s = {})
...
final class ChannelsKt__ChannelsKt$sendBlocking$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 == 0) {
            ...
            this.label = 1;
            if (this.$this_sendBlocking.send(this.$element, this) == obj2) {
                return obj2;
            }
        } else if (r1 != 1) {
