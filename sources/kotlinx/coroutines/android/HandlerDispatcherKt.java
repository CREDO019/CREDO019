...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ HandlerDispatcher from$default(Handler handler, String str, int r2, Object obj) {
        if ((r2 & 1) != 0) {
            str = null;
        }
    ...
    static {
        ...
        try {
            ...
            m1749constructorimpl = Result.m1749constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m1749constructorimpl = Result.m1749constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m1755isFailureimpl(m1749constructorimpl) ? null : m1749constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo3255dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m3205postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }

    /* renamed from: postFrameCallback$lambda-6 */
    public static final void m3205postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
