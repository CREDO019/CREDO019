...
public class SchedulerCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public /* synthetic */ SchedulerCoroutineDispatcher(int r4, int r5, long j, String str, int r9, DefaultConstructorMarker defaultConstructorMarker) {
        this((r9 & 1) != 0 ? TasksKt.CORE_POOL_SIZE : r4, (r9 & 2) != 0 ? TasksKt.MAX_POOL_SIZE : r5, (r9 & 4) != 0 ? TasksKt.IDLE_WORKER_KEEP_ALIVE_NS : j, (r9 & 8) != 0 ? "CoroutineScheduler" : str);
    }

    public SchedulerCoroutineDispatcher(int r1, int r2, long j, String str) {
