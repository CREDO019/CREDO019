...
public class EmojiCompat {
    ...
    public interface GlyphChecker {
        boolean hasGlyph(CharSequence charSequence, int r2, int r3, int r4);
    }
    ...
    public static boolean handleOnKeyDown(Editable editable, int r3, KeyEvent keyEvent) {
        if (Build.VERSION.SDK_INT >= 19) {
            return EmojiProcessor.handleOnKeyDown(editable, r3, keyEvent);
        }
        return false;
    }

    public static boolean handleDeleteSurroundingText(InputConnection inputConnection, Editable editable, int r4, int r5, boolean z) {
        if (Build.VERSION.SDK_INT >= 19) {
            return EmojiProcessor.handleDeleteSurroundingText(inputConnection, editable, r4, r5, z);
        }
        return false;
    }
    ...
    public boolean hasEmojiGlyph(CharSequence charSequence, int r4) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(charSequence, "sequence cannot be null");
        return this.mHelper.hasEmojiGlyph(charSequence, r4);
    }
    ...
    public CharSequence process(CharSequence charSequence, int r3, int r4) {
        return process(charSequence, r3, r4, Integer.MAX_VALUE);
    }

    public CharSequence process(CharSequence charSequence, int r8, int r9, int r10) {
        return process(charSequence, r8, r9, r10, 0);
    }

    public CharSequence process(CharSequence charSequence, int r9, int r10, int r11, int r12) {
        boolean z;
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkArgumentNonnegative(r9, "start cannot be negative");
        ...
        Preconditions.checkArgument(r9 <= r10, "start should be <= than end");
        if (charSequence == null) {
            return null;
        }
        Preconditions.checkArgument(r9 <= charSequence.length(), "start should be < than charSequence length");
        Preconditions.checkArgument(r10 <= charSequence.length(), "end should be < than charSequence length");
        if (charSequence.length() == 0 || r9 == r10) {
            return charSequence;
        }
        if (r12 != 1) {
            z = r12 != 2 ? this.mReplaceAll : false;
        } else {
            z = true;
        }
        return this.mHelper.process(charSequence, r9, r10, r11, z);
    }
    ...
    public static abstract class Config {
        ...
        public Config setUseEmojiAsDefaultStyle(boolean z, List<Integer> list) {
            ...
            if (z && list != null) {
                ...
                for (Integer num : list) {
                    this.mEmojiAsDefaultStyleExceptions[r4] = num.intValue();
                    r4++;
                }
        ...
        public Config setEmojiSpanIndicatorColor(int r1) {
            this.mEmojiSpanIndicatorColor = r1;
            return this;
        }

        public Config setMetadataLoadStrategy(int r1) {
            this.mMetadataLoadStrategy = r1;
            return this;
        }
    ...
    public static class ListenerDispatcher implements Runnable {
        ...
        ListenerDispatcher(InitCallback initCallback, int r4) {
            this(Arrays.asList((InitCallback) Preconditions.checkNotNull(initCallback, "initCallback cannot be null")), r4, null);
        }

        ListenerDispatcher(Collection<InitCallback> collection, int r3) {
            this(collection, r3, null);
        }

        ListenerDispatcher(Collection<InitCallback> collection, int r3, Throwable th) {
        ...
        public void run() {
            ...
            if (this.mLoadState != 1) {
                while (r2 < size) {
                    this.mInitCallbacks.get(r2).onFailed(this.mThrowable);
                    r2++;
                }
                return;
            }
            while (r2 < size) {
                this.mInitCallbacks.get(r2).onInitialized();
                r2++;
            }
        }
    }
    ...
    public static class CompatInternal {
        ...
        boolean hasEmojiGlyph(CharSequence charSequence, int r2) {
            return false;
        }

        CharSequence process(CharSequence charSequence, int r2, int r3, int r4, boolean z) {
            return charSequence;
        }
    ...
    private static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        boolean hasEmojiGlyph(CharSequence charSequence, int r3) {
            EmojiMetadata emojiMetadata = this.mProcessor.getEmojiMetadata(charSequence);
            return emojiMetadata != null && emojiMetadata.getCompatAdded() <= r3;
        }

        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        CharSequence process(CharSequence charSequence, int r8, int r9, int r10, boolean z) {
            return this.mProcessor.process(charSequence, r8, r9, r10, z);
        }
