...
public class MetadataListReader {
    ...
    public interface OpenTypeReader {
        ...
        void skip(int r1) throws IOException;
    }
    ...
    public static class InputStreamOpenTypeReader implements OpenTypeReader {
        ...
        @Override // androidx.emoji2.text.MetadataListReader.OpenTypeReader
        public void skip(int r5) throws IOException {
            while (r5 > 0) {
                int skip = (int) this.mInputStream.skip(r5);
                if (skip < 1) {
        ...
        private void read(int r5) throws IOException {
            if (this.mInputStream.read(this.mByteArray, 0, r5) != r5) {
    ...
    public static class ByteBufferReader implements OpenTypeReader {
        ...
        @Override // androidx.emoji2.text.MetadataListReader.OpenTypeReader
        public void skip(int r3) throws IOException {
