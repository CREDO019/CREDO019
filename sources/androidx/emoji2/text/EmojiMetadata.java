...
public class EmojiMetadata {
    ...
    public EmojiMetadata(MetadataRepo metadataRepo, int r3) {
    ...
    public int getId() {
        return getMetadataItem().m1395id();
    }
    ...
    public int getCodepointAt(int r2) {
        return getMetadataItem().codepoints(r2);
    }
    ...
    public String toString() {
        ...
        for (int r2 = 0; r2 < codepointsLength; r2++) {
            sb.append(Integer.toHexString(getCodepointAt(r2)));
            sb.append(" ");
        }
        return sb.toString();
    }
