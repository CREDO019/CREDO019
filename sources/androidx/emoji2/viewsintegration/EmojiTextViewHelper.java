    ...
    private static class HelperInternal19 extends HelperInternal {
        ...
        private InputFilter[] removeEmojiInputFilterIfPresent(InputFilter[] inputFilterArr) {
            ...
            for (int r3 = 0; r3 < length; r3++) {
                if (emojiInputFilterPositionArray.indexOfKey(r3) < 0) {
                    inputFilterArr2[r4] = inputFilterArr[r3];
                    r4++;
                }
            }
            return inputFilterArr2;
        ...
        private SparseArray<InputFilter> getEmojiInputFilterPositionArray(InputFilter[] inputFilterArr) {
            ...
            for (int r1 = 0; r1 < inputFilterArr.length; r1++) {
                if (inputFilterArr[r1] instanceof EmojiInputFilter) {
                    sparseArray.put(r1, inputFilterArr[r1]);
                }
            }
            return sparseArray;
        }
