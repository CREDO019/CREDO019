...
public enum WebViewFeatureInternal implements ConditionallySupportedFeature {
    ...
    WebViewFeatureInternal(String str, String str2, int r5) {
    ...
    public static boolean isSupported(String str, Collection<ConditionallySupportedFeature> collection) {
        ...
        for (ConditionallySupportedFeature conditionallySupportedFeature2 : hashSet) {
            if (conditionallySupportedFeature2.isSupported()) {
                return true;
            }
        }
        return false;
