...
public class WebMessagePortImpl extends WebMessagePortCompat {
    ...
    public static WebMessagePortCompat[] portsToCompat(WebMessagePort[] webMessagePortArr) {
        ...
        for (int r1 = 0; r1 < webMessagePortArr.length; r1++) {
            webMessagePortCompatArr[r1] = new WebMessagePortImpl(webMessagePortArr[r1]);
        }
    ...
    public static WebMessagePort[] compatToPorts(WebMessagePortCompat[] webMessagePortCompatArr) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            webMessagePortArr[r2] = webMessagePortCompatArr[r2].getFrameworkPort();
        }
