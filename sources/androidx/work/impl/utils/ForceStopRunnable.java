...
public class ForceStopRunnable implements Runnable {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        if (r1 >= 3) {
                            ...
                            Logger.get().debug(TAG, String.format("Retrying after %s", Long.valueOf(r1 * BACKOFF_DURATION_MS)), e);
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    for (int r3 = 0; r3 < historicalProcessExitReasons.size(); r3++) {
                        if (historicalProcessExitReasons.get(r3).getReason() == 10) {
                            return true;
                        }
                    }
                }
        ...
        try {
            ...
            if (z) {
                for (WorkSpec workSpec : runningWork) {
                    workSpecDao.setState(WorkInfo.State.ENQUEUED, workSpec.f59id);
                    workSpecDao.markWorkSpecScheduled(workSpec.f59id, -1L);
                }
            }
    ...
    static void setAlarm(Context context) {
        ...
        PendingIntent pendingIntent = getPendingIntent(context, BuildCompat.isAtLeastS() ? 167772160 : C1856C.BUFFER_FLAG_FIRST_SAMPLE);
