...
public class WorkManagerImpl extends WorkManager {
    ...
    */
    ...
    public WorkManagerImpl(Context context, Configuration configuration, TaskExecutor workTaskExecutor) {
        this(context, configuration, workTaskExecutor, context.getResources().getBoolean(C0787R.bool.workmanager_test_configuration));
    }
    ...
    public PendingIntent createCancelPendingIntent(UUID id) {
        return PendingIntent.getService(this.mContext, 0, SystemForegroundDispatcher.createCancelWorkIntent(this.mContext, id.toString()), BuildCompat.isAtLeastS() ? 167772160 : C1856C.BUFFER_FLAG_FIRST_SAMPLE);
    }
