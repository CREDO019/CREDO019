...
class SystemJobInfoConverter {
    ...
    public JobInfo convert(WorkSpec workSpec, int jobId) {
        ...
        persistableBundle.putString(EXTRA_WORK_SPEC_ID, workSpec.f59id);
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C08071 {
    ...
    static int convertNetworkType(NetworkType networkType) {
        int r0 = C08071.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (r0 != 1) {
            if (r0 != 2) {
                if (r0 != 3) {
                    if (r0 == 4) {
                    ...
                    } else if (r0 == 5 && Build.VERSION.SDK_INT >= 26) {
                        return 4;
                    }
