...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int r4) {
        if (r4 == 0) {
            this.mPlayTogether = true;
        } else if (r4 == 1) {
    ...
    public void runAnimators() {
        ...
        if (!this.mPlayTogether) {
            for (int r0 = 1; r0 < this.mTransitions.size(); r0++) {
                final Transition transition = this.mTransitions.get(r0);
    ...
    public Transition mo1462clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo1462clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int r2 = 0; r2 < size; r2++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(r2).mo1462clone());
        }
