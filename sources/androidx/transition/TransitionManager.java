...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo1462clone = transition.mo1462clone();
        mo1462clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo1462clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo1462clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo1462clone);
    }
    ...
    /* renamed from: go */
    public static void m1383go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m1382go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo1462clone = transition.mo1462clone();
        sceneChangeSetup(viewGroup, mo1462clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo1462clone);
    }
