...
public class SidePropagation extends VisibilityPropagation {
    ...
    public long getStartDelay(ViewGroup viewGroup, Transition transition, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        int round = r52[0] + Math.round(viewGroup.getTranslationX());
        int round2 = r52[1] + Math.round(viewGroup.getTranslationY());
        ...
        float distance = distance(viewGroup, viewX, viewY, r5, r15, round, round2, width, height) / getMaxDistance(viewGroup);
        long duration = transition.getDuration();
        if (duration < 0) {
            duration = 300;
        }
        return Math.round((((float) (duration * r13)) / this.mPropagationSpeed) * distance);
    }
    ...
    */
    ...
    private int getMaxDistance(ViewGroup viewGroup) {
        int r0 = this.mSide;
        if (r0 == 3 || r0 == 5 || r0 == 8388611 || r0 == 8388613) {
