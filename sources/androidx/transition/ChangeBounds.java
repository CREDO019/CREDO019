...
public class ChangeBounds extends Transition {
    ...
    public Animator createAnimator(final ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (r1 > 0) {
                if (!this.mResizeClip) {
                    ...
                    if (r1 == 2) {
                        if (r5 == r10 && r2 == r4) {
                            mergeAnimators = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(r6, r11, r7, r12));
                        } else {
                            ViewBounds viewBounds = new ViewBounds(view);
                            ObjectAnimator ofPointF = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath(r6, r11, r7, r12));
                            ObjectAnimator ofPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath(r13, r32, r14, r15));
                        ...
                        mergeAnimators = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath(r6, r11, r7, r12));
                    } else {
                        mergeAnimators = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath(r13, r32, r14, r15));
                    }
                } else {
                    view = view2;
                    ViewUtils.setLeftTopRightBottom(view, r6, r11, Math.max(r5, r10) + r6, Math.max(r2, r4) + r11);
                    ObjectAnimator ofPointF3 = (r6 == r7 && r11 == r12) ? null : ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(r6, r11, r7, r12));
                    if (rect4 == null) {
                        r3 = 0;
        ...
        ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(bitmapDrawable, PropertyValuesHolderUtils.ofPointF(DRAWABLE_ORIGIN_PROPERTY, pathMotion.getPath(intValue - r102[0], intValue2 - r102[1], intValue3 - r102[0], intValue4 - r102[1])));
