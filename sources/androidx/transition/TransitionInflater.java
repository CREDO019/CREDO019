...
public class TransitionInflater {
    ...
    public Transition inflateTransition(int r5) {
        XmlResourceParser xml = this.mContext.getResources().getXml(r5);
        try {
            try {
    ...
    public TransitionManager inflateTransitionManager(int r4, ViewGroup viewGroup) {
