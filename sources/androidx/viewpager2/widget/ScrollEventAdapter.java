...
public final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int r7) {
        ...
        if ((this.mAdapterState != 1 || this.mScrollState != 1) && r7 == 1) {
            startDrag(false);
        } else if (isInAnyDraggingState() && r7 == 2) {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void notifyProgrammaticScroll(int r3, boolean z) {
    ...
    private void dispatchSelected(int r2) {
        ViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
        if (onPageChangeCallback != null) {
            onPageChangeCallback.onPageSelected(r2);
        }
    }

    private void dispatchScrolled(int r2, float f, int r4) {
        ViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
        if (onPageChangeCallback != null) {
            onPageChangeCallback.onPageScrolled(r2, f, r4);
        }
    }
