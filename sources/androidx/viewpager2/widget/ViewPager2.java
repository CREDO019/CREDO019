...
import androidx.viewpager2.C0750R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0750R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0750R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(obtainStyledAttributes.getInt(C0750R.styleable.ViewPager2_android_orientation, 0));
        } finally {
    ...
    void setCurrentItemInternal(int r9, boolean z) {
        ...
        if (adapter == null) {
            ...
            int min = Math.min(Math.max(r9, 0), adapter.getItemCount() - 1);
            if (min == this.mCurrentItem && this.mScrollEventAdapter.isIdle()) {
                return;
            }
            int r0 = this.mCurrentItem;
            if (min == r0 && z) {
                return;
            }
            double d = r0;
    ...
    public void addItemDecoration(RecyclerView.ItemDecoration itemDecoration, int r3) {
        this.mRecyclerView.addItemDecoration(itemDecoration, r3);
    }

    public RecyclerView.ItemDecoration getItemDecorationAt(int r2) {
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        void setCurrentItemFromAccessibilityCommand(int r3) {
            if (ViewPager2.this.isUserInputEnabled()) {
                ViewPager2.this.setCurrentItemInternal(r3, true);
            }
        }
        ...
        void updatePageAccessibilityActions() {
            ...
            if (ViewPager2.this.getOrientation() == 0) {
                ...
                int r4 = isRtl ? 16908360 : 16908361;
                int r1 = isRtl ? 16908361 : 16908360;
        ...
        private void addCollectionInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (ViewPager2.this.getAdapter() == null) {
                ...
                r0 = ViewPager2.this.getAdapter().getItemCount();
            } else {
                r2 = ViewPager2.this.getAdapter().getItemCount();
                r0 = 0;
                AccessibilityNodeInfoCompat.wrap(accessibilityNodeInfo).setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(r0, r2, false, 0));
            }
            r2 = 0;
            AccessibilityNodeInfoCompat.wrap(accessibilityNodeInfo).setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(r0, r2, false, 0));
        }
