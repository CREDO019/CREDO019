...
public abstract class MediaBrowserServiceCompat extends Service {
            ...
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplBase.3
                ...
                public void run() {
                    for (int r0 = 0; r0 < MediaBrowserServiceCompat.this.mConnections.size(); r0++) {
                        ConnectionRecord valueAt = MediaBrowserServiceCompat.this.mConnections.valueAt(r0);
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public BrowserRoot onGetRoot(String clientPackageName, int clientUid, Bundle rootHints) {
            ...
            if (rootHints == null || rootHints.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) == 0) {
                ...
                int r0 = rootHints.getInt(MediaBrowserProtocol.EXTRA_CALLING_PID, -1);
                rootHints.remove(MediaBrowserProtocol.EXTRA_CALLING_PID);
                r7 = r0;
            }
            ConnectionRecord connectionRecord = new ConnectionRecord(clientPackageName, r7, clientUid, rootHints, null);
    ...
    List<MediaBrowserCompat.MediaItem> applyOptions(List<MediaBrowserCompat.MediaItem> list, final Bundle options) {
        ...
        int r0 = options.getInt(MediaBrowserCompat.EXTRA_PAGE, -1);
        int r5 = options.getInt(MediaBrowserCompat.EXTRA_PAGE_SIZE, -1);
        if (r0 == -1 && r5 == -1) {
            return list;
        }
        int r1 = r5 * r0;
        int r2 = r1 + r5;
        if (r0 < 0 || r5 < 1 || r1 >= list.size()) {
            return Collections.emptyList();
        }
        if (r2 > list.size()) {
            r2 = list.size();
        }
        return list.subList(r1, r2);
    }
