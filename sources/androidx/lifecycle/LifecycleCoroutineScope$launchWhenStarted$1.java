...
@DebugMetadata(m175c = "androidx.lifecycle.LifecycleCoroutineScope$launchWhenStarted$1", m174f = "Lifecycle.kt", m173i = {}, m172l = {87}, m171m = "invokeSuspend", m170n = {}, m169s = {})
...
final class LifecycleCoroutineScope$launchWhenStarted$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 == 0) {
            ...
            this.label = 1;
            if (PausingDispatcherKt.whenStarted(lifecycle$lifecycle_runtime_ktx_release, function2, this) == obj2) {
                return obj2;
            }
        } else if (r1 != 1) {
