...
class ExifInterfaceUtils {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void copy(InputStream inputStream, OutputStream outputStream, int r7) throws IOException {
        byte[] bArr = new byte[8192];
        while (r7 > 0) {
    ...
    public static String byteArrayToHexString(byte[] bArr) {
        ...
        for (int r2 = 0; r2 < bArr.length; r2++) {
            sb.append(String.format("%02x", Byte.valueOf(bArr[r2])));
        }
        return sb.toString();
    }
    ...
    static class Api21Impl {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static long lseek(FileDescriptor fileDescriptor, long j, int r3) throws ErrnoException {
            return Os.lseek(fileDescriptor, j, r3);
        }
