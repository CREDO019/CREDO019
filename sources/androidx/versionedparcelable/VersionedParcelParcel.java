...
class VersionedParcelParcel extends VersionedParcel {
    ...
    public void closeField() {
        ...
        if (r0 >= 0) {
            ...
            this.mParcel.writeInt(dataPosition - r02);
    ...
    protected VersionedParcel createSubParcel() {
        ...
        int r3 = r0;
        return new VersionedParcelParcel(parcel, dataPosition, r3, this.mPrefix + "  ", this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
