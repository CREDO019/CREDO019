...
class VersionedParcelStream extends VersionedParcel {
    ...
    public boolean readField(int r5) {
        while (true) {
            try {
                int r1 = this.mFieldId;
                if (r1 == r5) {
                    return true;
                }
                if (String.valueOf(r1).compareTo(String.valueOf(r5)) > 0) {
                    return false;
                }
                int r12 = this.mCount;
                int r2 = this.mFieldSize;
                if (r12 < r2) {
                    this.mMasterInput.skip(r2 - r12);
                }
                this.mFieldSize = -1;
                int readInt = this.mMasterInput.readInt();
                this.mCount = 0;
                int r3 = readInt & 65535;
                if (r3 == 65535) {
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public void writeByteArray(byte[] bArr, int r3, int r4) {
        try {
            if (bArr != null) {
    ...
    public void writeInt(int r2) {
        try {
            this.mCurrentOutput.writeInt(r2);
        } catch (IOException e) {
            throw new VersionedParcel.ParcelException(e);
        }
    }
    ...
    private void readObject(int r3, String str, Bundle bundle) {
        switch (r3) {
            case 0:
