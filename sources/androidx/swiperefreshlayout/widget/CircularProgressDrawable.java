...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f, int r8, int r9) {
        int r0 = (r8 >> 24) & 255;
        int r1 = (r8 >> 16) & 255;
        int r2 = (r8 >> 8) & 255;
        int r82 = r8 & 255;
        return ((r0 + ((int) ((((r9 >> 24) & 255) - r0) * f))) << 24) | ((r1 + ((int) ((((r9 >> 16) & 255) - r1) * f))) << 16) | ((r2 + ((int) ((((r9 >> 8) & 255) - r2) * f))) << 8) | (r82 + ((int) (f * ((r9 & 255) - r82))));
    }
