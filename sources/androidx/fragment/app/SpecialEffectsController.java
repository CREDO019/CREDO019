...
public abstract class SpecialEffectsController {
    ...
    public static SpecialEffectsController getOrCreateController(ViewGroup viewGroup, SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        Object tag = viewGroup.getTag(C0377R.C0379id.special_effects_controller_view_tag);
        if (tag instanceof SpecialEffectsController) {
            return (SpecialEffectsController) tag;
        }
        SpecialEffectsController createController = specialEffectsControllerFactory.createController(viewGroup);
        viewGroup.setTag(C0377R.C0379id.special_effects_controller_view_tag, createController);
    ...
    public static class Operation {
        ...
        public enum State {
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            public static State from(int r3) {
                if (r3 != 0) {
                    if (r3 != 4) {
                        if (r3 == 8) {
                            return GONE;
            ...
            public void applyState(View view) {
                int r0 = C04363.f46xe493b431[ordinal()];
                if (r0 == 1) {
        ...
        final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int r7 = C04363.f45xb9e640f0[lifecycleImpact.ordinal()];
            if (r7 == 1) {
            ...
            } else if (r7 == 3 && this.mFinalState != State.REMOVED) {
                if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public static /* synthetic */ class C04363 {
        ...
        static {
            ...
            try {
                f45xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f45xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f46xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f46xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f46xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
