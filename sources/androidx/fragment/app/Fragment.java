...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void setTargetFragment(Fragment fragment, int r5) {
        if (fragment != null) {
            FragmentStrictMode.onSetTargetFragmentUsage(this, fragment, r5);
        }
        FragmentManager fragmentManager = this.mFragmentManager;
    ...
    public void startActivityForResult(Intent intent, int r3, Bundle bundle) {
        ...
        getParentFragmentManager().launchStartActivityForResult(this, intent, r3, bundle);
    }

    @Deprecated
    public void startIntentSenderForResult(IntentSender intentSender, int r12, Intent intent, int r14, int r15, int r16, Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost == null) {
            throw new IllegalStateException("Fragment " + this + " not attached to Activity");
        }
    ...
    public void onActivityResult(int r3, int r4, Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + r3 + " resultCode: " + r4 + " data: " + intent);
        }
    }
    ...
    public final void requestPermissions(String[] strArr, int r3) {
        ...
        getParentFragmentManager().launchRequestPermissions(this, strArr, r3);
    }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        printWriter.print(str);
        printWriter.println("Child " + this.mChildFragmentManager + ParameterizedMessage.ERROR_MSG_SEPARATOR);
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(final ActivityResultContract<I, O> activityResultContract, final Function<Void, ActivityResultRegistry> function, final ActivityResultCallback<O> activityResultCallback) {
        ...
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.9
            ...
            public void launch(I r2, ActivityOptionsCompat activityOptionsCompat) {
                ActivityResultLauncher activityResultLauncher = (ActivityResultLauncher) atomicReference.get();
                if (activityResultLauncher == null) {
                    throw new IllegalStateException("Operation cannot be started before fragment is in created state");
                }
                activityResultLauncher.launch(r2, activityOptionsCompat);
            }
