...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public void setStyle(int r4, int r5) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.d(FragmentManager.TAG, "Setting style and theme for DialogFragment " + this + " to " + r4 + ", " + r5);
        }
        this.mStyle = r4;
        if (r4 == 2 || r4 == 3) {
        ...
        return new FragmentContainer() { // from class: androidx.fragment.app.DialogFragment.5
            ...
            public View onFindViewById(int r2) {
                if (createFragmentContainer.onHasView()) {
                    return createFragmentContainer.onFindViewById(r2);
                }
                return DialogFragment.this.onFindViewById(r2);
            }
