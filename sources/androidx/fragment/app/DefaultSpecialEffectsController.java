...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    void executeOperations(List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation operation3 : list) {
            ...
            int r4 = C038310.f44xe493b431[operation3.getFinalState().ordinal()];
            if (r4 == 1 || r4 == 2 || r4 == 3) {
                if (from == SpecialEffectsController.Operation.State.VISIBLE && operation == null) {
                    operation = operation3;
                }
            } else if (r4 == 4 && from != SpecialEffectsController.Operation.State.VISIBLE) {
    ...
    static /* synthetic */ class C038310 {
        ...
        static {
            ...
            try {
                f44xe493b431[SpecialEffectsController.Operation.State.INVISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f44xe493b431[SpecialEffectsController.Operation.State.REMOVED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f44xe493b431[SpecialEffectsController.Operation.State.VISIBLE.ordinal()] = 4;
    ...
    private void startAnimations(List<AnimationInfo> list, List<SpecialEffectsController.Operation> list2, boolean z, Map<SpecialEffectsController.Operation, Boolean> map) {
        ...
        while (it2.hasNext()) {
            ...
            if (z) {
                if (FragmentManager.isLoggingEnabled(r15)) {
    ...
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(List<TransitionInfo> list, List<SpecialEffectsController.Operation> list2, final boolean z, final SpecialEffectsController.Operation operation, final SpecialEffectsController.Operation operation2) {
        ...
        while (true) {
            ...
            if (!next3.hasSharedElementTransition() || operation5 == null || operation6 == null) {
                ...
                int r2 = 0;
                while (r2 < sharedElementTargetNames.size()) {
                    int indexOf = sharedElementSourceNames.indexOf(sharedElementTargetNames.get(r2));
                    ArrayList<String> arrayList9 = sharedElementTargetNames;
                    if (indexOf != -1) {
                        sharedElementSourceNames.set(indexOf, sharedElementSourceNames2.get(r2));
                    }
                    r2++;
                ...
                int r13 = 0;
                while (r13 < size) {
                    arrayMap2.put(sharedElementSourceNames.get(r13), sharedElementTargetNames2.get(r13));
                    r13++;
                    size = size;
                    rect3 = rect3;
                }
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    if (sharedElementTargetNames2.isEmpty() || (view5 = arrayMap4.get(sharedElementTargetNames2.get(r1))) == null) {
                        rect2 = rect4;
                        view4 = view9;
                    } else {
                        rect2 = rect4;
