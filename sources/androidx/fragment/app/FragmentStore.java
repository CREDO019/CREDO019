...
public class FragmentStore {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchStateChange(int r3) {
        for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
            if (fragmentStateManager != null) {
                fragmentStateManager.setFragmentManagerState(r3);
            }
        }
    }
    ...
    public int findFragmentIndexInContainer(Fragment fragment) {
        ...
        for (int r2 = indexOf - 1; r2 >= 0; r2--) {
            Fragment fragment2 = this.mAdded.get(r2);
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (size > 0) {
            ...
            for (int r7 = 0; r7 < size; r7++) {
                ...
                printWriter.print(": ");
                printWriter.println(this.mAdded.get(r7).toString());
            }
        }
    }
}
