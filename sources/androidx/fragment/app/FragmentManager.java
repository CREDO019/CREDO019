...
import androidx.fragment.C0377R;
...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public void popBackStack(int r2, int r3) {
        popBackStack(r2, r3, false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void popBackStack(int r3, int r4, boolean z) {
        if (r3 < 0) {
            throw new IllegalArgumentException("Bad id: " + r3);
        }
        enqueueAction(new PopBackStackState(null, r3, r4), z);
    }
    ...
    private boolean popBackStackImmediate(String str, int r10, int r11) {
        ...
        if (fragment == null || r10 >= 0 || str != null || !fragment.getChildFragmentManager().popBackStackImmediate()) {
            boolean popBackStackState = popBackStackState(this.mTmpRecords, this.mTmpIsPop, str, r10, r11);
    ...
    public BackStackEntry getBackStackEntryAt(int r2) {
    ...
    public static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0377R.C0379id.fragment_container_view_tag);
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (arrayList != null && (size2 = arrayList.size()) > 0) {
            ...
            for (int r1 = 0; r1 < size2; r1++) {
                ...
                printWriter.print(": ");
                printWriter.println(this.mCreatedMenus.get(r1).toString());
            }
        }
        ...
        synchronized (this.mPendingActions) {
            ...
            if (size3 > 0) {
                ...
                for (int r8 = 0; r8 < size3; r8++) {
                    ...
                    printWriter.print(": ");
                    printWriter.println(this.mPendingActions.get(r8));
                }
            }
        }
        printWriter.print(str);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean isStateAtLeast(int r2) {
        return this.mCurState >= r2;
    }
    ...
    public Fragment findFragmentById(int r2) {
        return this.mFragmentStore.findFragmentById(r2);
    }
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int r11, int r12) {
        boolean z = arrayList.get(r11).mReorderingAllowed;
        ...
        boolean z2 = false;
        for (int r3 = r11; r3 < r12; r3++) {
            BackStackRecord backStackRecord = arrayList.get(r3);
            if (!arrayList2.get(r3).booleanValue()) {
        ...
        if (!z && this.mCurState >= 1) {
            for (int r0 = r11; r0 < r12; r0++) {
                Iterator<FragmentTransaction.C0425Op> it = arrayList.get(r0).mOps.iterator();
                while (it.hasNext()) {
        ...
        boolean booleanValue = arrayList2.get(r12 - 1).booleanValue();
        for (int r1 = r11; r1 < r12; r1++) {
            BackStackRecord backStackRecord2 = arrayList.get(r1);
            if (booleanValue) {
                ...
                Iterator<FragmentTransaction.C0425Op> it2 = backStackRecord2.mOps.iterator();
                while (it2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int r5, int r6) {
        ViewGroup viewGroup;
        HashSet hashSet = new HashSet();
        while (r5 < r6) {
            Iterator<FragmentTransaction.C0425Op> it = arrayList.get(r5).mOps.iterator();
            while (it.hasNext()) {
                Fragment fragment = it.next().mFragment;
    ...
    private static void executeOps(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int r4, int r5) {
        while (r4 < r5) {
            BackStackRecord backStackRecord = arrayList.get(r4);
            if (arrayList2.get(r4).booleanValue()) {
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer.getTag(C0377R.C0379id.visible_removing_fragment_view_tag) == null) {
            fragmentContainer.setTag(C0377R.C0379id.visible_removing_fragment_view_tag, fragment);
        }
        ((Fragment) fragmentContainer.getTag(C0377R.C0379id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
    }
    ...
    private boolean generateOpsForPendingActions(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2) {
        synchronized (this.mPendingActions) {
            ...
            for (int r2 = 0; r2 < size; r2++) {
                z |= this.mPendingActions.get(r2).generateOps(arrayList, arrayList2);
            }
    ...
    boolean restoreBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        while (it.hasNext()) {
            ...
            if (next.mBeingSaved) {
                Iterator<FragmentTransaction.C0425Op> it2 = next.mOps.iterator();
                while (it2.hasNext()) {
                    FragmentTransaction.C0425Op next2 = it2.next();
    ...
    boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int r4 = findBackStackIndex; r4 < this.mBackStack.size(); r4++) {
            BackStackRecord backStackRecord = this.mBackStack.get(r4);
        ...
        HashSet hashSet = new HashSet();
        for (int r5 = findBackStackIndex; r5 < this.mBackStack.size(); r5++) {
            BackStackRecord backStackRecord2 = this.mBackStack.get(r5);
            HashSet hashSet2 = new HashSet();
            HashSet hashSet3 = new HashSet();
            Iterator<FragmentTransaction.C0425Op> it = backStackRecord2.mOps.iterator();
            while (it.hasNext()) {
                FragmentTransaction.C0425Op next = it.next();
        ...
        for (int r6 = findBackStackIndex; r6 < this.mBackStack.size(); r6++) {
            arrayList4.add(null);
        }
    ...
    boolean popBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str, int r6, int r7) {
        int findBackStackIndex = findBackStackIndex(str, r6, (r7 & 1) != 0);
        if (findBackStackIndex < 0) {
            return false;
        }
        for (int size = this.mBackStack.size() - 1; size >= findBackStackIndex; size--) {
    ...
    private int findBackStackIndex(String str, int r6, boolean z) {
        ArrayList<BackStackRecord> arrayList = this.mBackStack;
    ...
    public Parcelable saveAllStateInternal() {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int r7 = 0; r7 < size; r7++) {
                backStackRecordStateArr[r7] = new BackStackRecordState(this.mBackStack.get(r7));
                if (isLoggingEnabled(2)) {
                    Log.v(TAG, "saveAllState: adding back stack #" + r7 + ": " + this.mBackStack.get(r7));
                }
            }
        }
    ...
    public void restoreSaveStateInternal(Parcelable parcelable) {
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            for (int r0 = 0; r0 < fragmentManagerState.mBackStack.length; r0++) {
                BackStackRecord instantiate = fragmentManagerState.mBackStack[r0].instantiate(this);
                if (isLoggingEnabled(2)) {
                    Log.v(TAG, "restoreAllState: back stack #" + r0 + " (index " + instantiate.mIndex + "): " + instantiate);
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
        ...
        if (arrayList != null) {
            for (int r2 = 0; r2 < arrayList.size(); r2++) {
                this.mBackStackStates.put(arrayList.get(r2), fragmentManagerState.mBackStackStates.get(r2));
            }
        }
        ArrayList<String> arrayList2 = fragmentManagerState.mResultKeys;
        if (arrayList2 != null) {
            for (int r1 = 0; r1 < arrayList2.size(); r1++) {
                Bundle bundle = fragmentManagerState.mResults.get(r1);
                bundle.setClassLoader(this.mHost.getContext().getClassLoader());
                this.mResults.put(arrayList2.get(r1), bundle);
            }
        }
    ...
    public void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer fragmentContainer, final Fragment fragment) {
        ...
        if ((fragmentHostCallback2 instanceof SavedStateRegistryOwner) && fragment == null) {
            ...
            savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
                ...
                public final Bundle saveState() {
                    return FragmentManager.this.m1446lambda$attachController$0$androidxfragmentappFragmentManager();
                }
            });
        ...
        if (fragmentHostCallback3 instanceof ActivityResultRegistryOwner) {
            ...
            if (fragment != null) {
                str = fragment.mWho + ParameterizedMessage.ERROR_MSG_SEPARATOR;
            } else {
                str = "";
            }
            ...
            this.mStartActivityForResult = activityResultRegistry.register(str2 + "StartActivityForResult", new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() { // from class: androidx.fragment.app.FragmentManager.7
                ...
                public void onActivityResult(ActivityResult activityResult) {
                    ...
                    findFragmentByWho.onActivityResult(r0, activityResult.getResultCode(), activityResult.getData());
                }
            });
            ...
            this.mRequestPermissions = activityResultRegistry.register(str2 + "RequestPermissions", new ActivityResultContracts.RequestMultiplePermissions(), new ActivityResultCallback<Map<String, Boolean>>() { // from class: androidx.fragment.app.FragmentManager.9
                ...
                public void onActivityResult(Map<String, Boolean> map) {
                    ...
                    for (int r3 = 0; r3 < arrayList.size(); r3++) {
                        r6[r3] = ((Boolean) arrayList.get(r3)).booleanValue() ? 0 : -1;
                    }
                    LaunchedFragmentInfo pollFirst = FragmentManager.this.mLaunchedFragments.pollFirst();
                    if (pollFirst == null) {
    ...
    public /* synthetic */ Bundle m1446lambda$attachController$0$androidxfragmentappFragmentManager() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void launchStartActivityForResult(Fragment fragment, Intent intent, int r4, Bundle bundle) {
        if (this.mStartActivityForResult != null) {
            this.mLaunchedFragments.addLast(new LaunchedFragmentInfo(fragment.mWho, r4));
        ...
        this.mHost.onStartActivityFromFragment(fragment, intent, r4, bundle);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void launchStartIntentSenderForResult(Fragment fragment, IntentSender intentSender, int r14, Intent intent, int r16, int r17, int r18, Bundle bundle) throws IntentSender.SendIntentException {
        Intent intent2;
        if (this.mStartIntentSenderForResult != null) {
            ...
            IntentSenderRequest build = new IntentSenderRequest.Builder(intentSender).setFillInIntent(intent2).setFlags(r17, r16).build();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void launchRequestPermissions(Fragment fragment, String[] strArr, int r4) {
        if (this.mRequestPermissions != null) {
            this.mLaunchedFragments.addLast(new LaunchedFragmentInfo(fragment.mWho, r4));
            this.mRequestPermissions.launch(strArr);
            return;
        }
        this.mHost.onRequestPermissionsFromFragment(fragment, strArr, r4);
    }
    ...
    public static class LaunchedFragmentInfo implements Parcelable {
        public static final Parcelable.Creator<LaunchedFragmentInfo> CREATOR = new Parcelable.Creator<LaunchedFragmentInfo>() { // from class: androidx.fragment.app.FragmentManager.LaunchedFragmentInfo.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public LaunchedFragmentInfo[] newArray(int r1) {
        ...
        LaunchedFragmentInfo(String str, int r2) {
            this.mWho = str;
    ...
    public static class FragmentIntentSenderContract extends ActivityResultContract<IntentSenderRequest, ActivityResult> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // androidx.activity.result.contract.ActivityResultContract
        public ActivityResult parseResult(int r2, Intent intent) {
            return new ActivityResult(r2, intent);
        }
    }
}
