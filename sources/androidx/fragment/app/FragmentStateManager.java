...
public class FragmentStateManager {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setFragmentManagerState(int r1) {
    ...
    int computeExpectedState() {
        ...
        int r1 = C04232.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (r1 != 1) {
            if (r1 == 2) {
                r0 = Math.min(r0, 5);
            } else if (r1 == 3) {
        ...
        if (this.mFragment.mFromLayout) {
            if (this.mFragment.mInLayout) {
                r0 = Math.max(this.mFragmentManagerState, 2);
                if (this.mFragment.mView != null && this.mFragment.mView.getParent() == null) {
                    r0 = Math.min(r0, 2);
                }
            } else {
                r0 = this.mFragmentManagerState < 4 ? Math.min(r0, this.mFragment.mState) : Math.min(r0, 1);
            }
        }
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "computeExpectedState() of " + r0 + " for " + this.mFragment);
        }
        return r0;
    }
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0377R.C0379id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
