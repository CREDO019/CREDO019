...
public class TrustedWebActivityIntentBuilder {
    ...
    public TrustedWebActivityIntentBuilder setToolbarColor(int r2) {
        this.mIntentBuilder.setToolbarColor(r2);
        return this;
    }

    public TrustedWebActivityIntentBuilder setNavigationBarColor(int r2) {
        this.mIntentBuilder.setNavigationBarColor(r2);
        return this;
    }

    public TrustedWebActivityIntentBuilder setNavigationBarDividerColor(int r2) {
        this.mIntentBuilder.setNavigationBarDividerColor(r2);
        return this;
    }

    public TrustedWebActivityIntentBuilder setColorScheme(int r2) {
        this.mIntentBuilder.setColorScheme(r2);
        return this;
    }

    public TrustedWebActivityIntentBuilder setColorSchemeParams(int r2, CustomTabColorSchemeParams customTabColorSchemeParams) {
        this.mIntentBuilder.setColorSchemeParams(r2, customTabColorSchemeParams);
        return this;
    }
    ...
    public TrustedWebActivityIntentBuilder setScreenOrientation(int r1) {
        this.mScreenOrientation = r1;
        return this;
    }
