...
public abstract class TrustedWebActivityService extends Service {
            ...
            if (TrustedWebActivityService.this.mVerifiedUid == -1) {
                ...
                if (load != null) {
                    ...
                    while (true) {
                        if (r1 >= length) {
                            break;
                        } else if (load.matches(packagesForUid[r1], packageManager)) {
    ...
    public boolean onNotifyNotificationWithChannel(String str, int r5, Notification notification, String str2) {
        ensureOnCreateCalled();
        if (NotificationManagerCompat.from(this).areNotificationsEnabled()) {
            if (Build.VERSION.SDK_INT >= 26) {
            ...
            this.mNotificationManager.notify(str, r5, notification);
            return true;
        }
        return false;
    }

    public void onCancelNotification(String str, int r3) {
        ensureOnCreateCalled();
        this.mNotificationManager.cancel(str, r3);
    }
