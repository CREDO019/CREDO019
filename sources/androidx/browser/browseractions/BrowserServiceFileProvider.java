...
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    public static ResolvableFuture<Uri> saveBitmap(Context context, Bitmap bitmap, String str, int r10) {
        String str2 = str + "_" + Integer.toString(r10);
    ...
    public static void grantReadPermission(Intent intent, List<Uri> list, Context context) {
        ...
        for (int r0 = 1; r0 < list.size(); r0++) {
            newUri.addItem(new ClipData.Item(list.get(r0)));
        }
