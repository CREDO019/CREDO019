...
public class BrowserActionsIntent {
    ...
    public static final class Builder {
        ...
        public Builder setUrlType(int r1) {
            this.mType = r1;
            return this;
        }
        ...
        public Builder setCustomItems(ArrayList<BrowserActionItem> arrayList) {
            ...
            for (int r0 = 0; r0 < arrayList.size(); r0++) {
                if (TextUtils.isEmpty(arrayList.get(r0).getTitle()) || arrayList.get(r0).getAction() == null) {
                    throw new IllegalArgumentException("Custom item should contain a non-empty title and non-null intent.");
                }
                this.mMenuItems.add(getBundleFromItem(arrayList.get(r0)));
                if (arrayList.get(r0).getIconUri() != null) {
                    this.mImageUris.add(arrayList.get(r0).getIconUri());
                }
            }
            return this;
        }
    ...
    public static void openBrowserAction(Context context, Uri uri, int r3, ArrayList<BrowserActionItem> arrayList, PendingIntent pendingIntent) {
        launchIntent(context, new Builder(context, uri).setUrlType(r3).setCustomItems(arrayList).setOnItemSelectedAction(pendingIntent).build().getIntent());
    }
        ...
        if (list.size() == 1) {
            ...
            if (resolveActivity != null) {
                ...
                while (true) {
                    if (r1 >= list.size()) {
                        break;
                    } else if (str.equals(list.get(r1).activityInfo.packageName)) {
    ...
    public static List<BrowserActionItem> parseBrowserActionItems(ArrayList<Bundle> arrayList) {
        ...
        for (int r1 = 0; r1 < arrayList.size(); r1++) {
            ...
            int r5 = bundle.getInt(KEY_ICON_ID);
            Uri uri = (Uri) bundle.getParcelable(KEY_ICON_URI);
            if (!TextUtils.isEmpty(string) && pendingIntent != null) {
                if (r5 != 0) {
                    browserActionItem = new BrowserActionItem(string, pendingIntent, r5);
                } else {
