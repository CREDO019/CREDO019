...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public Object getItem(int r2) {
        return this.mMenuItems.get(r2);
    }

    @Override // android.widget.Adapter
    public View getView(int r4, View view, ViewGroup viewGroup) {
        final ViewHolderItem viewHolderItem;
        BrowserActionItem browserActionItem = this.mMenuItems.get(r4);
        if (view == null) {
            view = LayoutInflater.from(this.mContext).inflate(C0220R.layout.browser_actions_context_menu_row, (ViewGroup) null);
            ImageView imageView = (ImageView) view.findViewById(C0220R.C0222id.browser_actions_menu_item_icon);
            TextView textView = (TextView) view.findViewById(C0220R.C0222id.browser_actions_menu_item_text);
