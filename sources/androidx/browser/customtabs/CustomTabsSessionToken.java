...
public class CustomTabsSessionToken {
    ...
    static class MockCallback extends ICustomTabsCallback.Stub {
        ...
        @Override // android.support.customtabs.ICustomTabsCallback
        public void onNavigationEvent(int r1, Bundle bundle) {
        }
        ...
        @Override // android.support.customtabs.ICustomTabsCallback
        public void onRelationshipValidationResult(int r1, Uri uri, boolean z, Bundle bundle) {
        }
    }
    ...
    public CustomTabsSessionToken(ICustomTabsCallback iCustomTabsCallback, PendingIntent pendingIntent) {
        ...
        this.mCallback = iCustomTabsCallback == null ? null : new CustomTabsCallback() { // from class: androidx.browser.customtabs.CustomTabsSessionToken.1
            ...
            public void onNavigationEvent(int r2, Bundle bundle) {
                try {
                    CustomTabsSessionToken.this.mCallbackBinder.onNavigationEvent(r2, bundle);
            ...
            @Override // androidx.browser.customtabs.CustomTabsCallback
            public void onRelationshipValidationResult(int r2, Uri uri, boolean z, Bundle bundle) {
                try {
                    CustomTabsSessionToken.this.mCallbackBinder.onRelationshipValidationResult(r2, uri, z, bundle);
                } catch (RemoteException unused) {
                    Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                }
            }
