...
public class CustomTabsClient {
    ...
    private static PendingIntent createSessionId(Context context, int r3) {
        return PendingIntent.getActivity(context, r3, new Intent(), 67108864);
    }
    ...
    public CustomTabsSession newSession(CustomTabsCallback customTabsCallback, int r3) {
        return newSessionInternal(customTabsCallback, createSessionId(this.mApplicationContext, r3));
    }

    public static CustomTabsSession.PendingSession newPendingSession(Context context, CustomTabsCallback customTabsCallback, int r2) {
        return new CustomTabsSession.PendingSession(customTabsCallback, createSessionId(context, r2));
    }
    ...
    private ICustomTabsCallback.Stub createCallbackWrapper(final CustomTabsCallback customTabsCallback) {
        return new ICustomTabsCallback.Stub() { // from class: androidx.browser.customtabs.CustomTabsClient.2
            ...
            public void onNavigationEvent(final int r3, final Bundle bundle) {
                ...
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.1
                    ...
                    public void run() {
                        customTabsCallback.onNavigationEvent(r3, bundle);
                    }
                });
            }
            ...
            @Override // android.support.customtabs.ICustomTabsCallback
            public void onRelationshipValidationResult(final int r9, final Uri uri, final boolean z, final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.5
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onRelationshipValidationResult(r9, uri, z, bundle);
                    }
                });
            }
        };
