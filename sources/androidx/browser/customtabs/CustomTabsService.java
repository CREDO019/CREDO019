...
public abstract class CustomTabsService extends Service {
    ...
    private ICustomTabsService.Stub mBinder = new BinderC02381();
    ...
    protected abstract boolean receiveFile(CustomTabsSessionToken customTabsSessionToken, Uri uri, int r3, Bundle bundle);
    ...
    protected abstract boolean validateRelationship(CustomTabsSessionToken customTabsSessionToken, int r2, Uri uri, Bundle bundle);
    ...
    /* loaded from: classes.dex */
    public class BinderC02381 extends ICustomTabsService.Stub {
        BinderC02381() {
        }
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs.CustomTabsService$1$$ExternalSyntheticLambda0
                    ...
                    public final void binderDied() {
                        CustomTabsService.BinderC02381.this.m1427x67c68af6(customTabsSessionToken);
                    }
                };
        ...
        public /* synthetic */ void m1427x67c68af6(CustomTabsSessionToken customTabsSessionToken) {
        ...
        @Override // android.support.customtabs.ICustomTabsService
        public boolean validateRelationship(ICustomTabsCallback iCustomTabsCallback, int r5, Uri uri, Bundle bundle) {
            return CustomTabsService.this.validateRelationship(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), r5, uri, bundle);
        }

        @Override // android.support.customtabs.ICustomTabsService
        public boolean receiveFile(ICustomTabsCallback iCustomTabsCallback, Uri uri, int r6, Bundle bundle) {
            return CustomTabsService.this.receiveFile(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), uri, r6, bundle);
        }
