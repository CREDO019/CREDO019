...
public final class CustomTabColorSchemeParams {
    ...
    public static final class Builder {
        ...
        public Builder setToolbarColor(int r2) {
            this.mToolbarColor = Integer.valueOf(r2 | ViewCompat.MEASURED_STATE_MASK);
            return this;
        }

        public Builder setSecondaryToolbarColor(int r1) {
            this.mSecondaryToolbarColor = Integer.valueOf(r1);
            return this;
        }

        public Builder setNavigationBarColor(int r2) {
            this.mNavigationBarColor = Integer.valueOf(r2 | ViewCompat.MEASURED_STATE_MASK);
            return this;
        }

        public Builder setNavigationBarDividerColor(int r1) {
            this.mNavigationBarDividerColor = Integer.valueOf(r1);
            return this;
        }
