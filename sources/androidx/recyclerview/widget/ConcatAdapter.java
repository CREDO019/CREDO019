...
public final class ConcatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public boolean addAdapter(int r2, RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter) {
        return this.mController.addAdapter(r2, adapter);
    }
    ...
    public long getItemId(int r3) {
        return this.mController.getItemId(r3);
    }
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int findRelativeAdapterPositionIn(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder viewHolder, int r4) {
        return this.mController.getLocalAdapterPosition(adapter, viewHolder, r4);
    }
