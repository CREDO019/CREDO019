...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
    ...
    private boolean snapFromFling(RecyclerView.LayoutManager layoutManager, int r4, int r5) {
        ...
        if (!(layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider) || (createScroller = createScroller(layoutManager)) == null || (findTargetSnapPosition = findTargetSnapPosition(layoutManager, r4, r5)) == -1) {
            return false;
        }
