...
class OpReorderer {
    ...
    void swapMoveRemove(List<AdapterHelper.UpdateOp> list, int r10, AdapterHelper.UpdateOp updateOp, int r12, AdapterHelper.UpdateOp updateOp2) {
        ...
        if (updateOp3 != null) {
            list.add(r10, updateOp3);
        }
    }

    private void swapMoveAdd(List<AdapterHelper.UpdateOp> list, int r5, AdapterHelper.UpdateOp updateOp, int r7, AdapterHelper.UpdateOp updateOp2) {
        int r0 = updateOp.itemCount < updateOp2.positionStart ? -1 : 0;
        if (updateOp.positionStart < updateOp2.positionStart) {
            r0++;
        }
        ...
        updateOp2.positionStart += r0;
        list.set(r5, updateOp2);
        list.set(r7, updateOp);
    }
