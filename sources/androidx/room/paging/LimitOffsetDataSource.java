...
public abstract class LimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    public void loadInitial(PositionalDataSource.LoadInitialParams loadInitialParams, PositionalDataSource.LoadInitialCallback<T> loadInitialCallback) {
        ...
        try {
            ...
            loadInitialCallback.onResult(emptyList, r7, countItems);
        } catch (Throwable th2) {
            th = th2;
    ...
    public List<T> loadRange(int r3, int r4) {
        RoomSQLiteQuery sQLiteQuery = getSQLiteQuery(r3, r4);
    ...
    private RoomSQLiteQuery getSQLiteQuery(int r5, int r6) {
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire(this.mLimitOffsetQuery, this.mSourceQuery.getArgCount() + 2);
        acquire.copyArgumentsFrom(this.mSourceQuery);
        acquire.bindLong(acquire.getArgCount() - 1, r6);
        acquire.bindLong(acquire.getArgCount(), r5);
        return acquire;
    }
}
