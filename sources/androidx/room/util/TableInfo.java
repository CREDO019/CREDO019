...
public final class TableInfo {
    ...
    private static Set<ForeignKey> readForeignKeys(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            for (int r9 = 0; r9 < count; r9++) {
                query.moveToPosition(r9);
                if (query.getInt(columnIndex2) == 0) {
                    int r10 = query.getInt(columnIndex);
    ...
    private static Index readIndex(SupportSQLiteDatabase supportSQLiteDatabase, String str, boolean z) {
        ...
        try {
            ...
            if (columnIndex != -1 && columnIndex2 != -1 && columnIndex3 != -1 && columnIndex4 != -1) {
                ...
                while (query.moveToNext()) {
                    if (query.getInt(columnIndex2) >= 0) {
                        int r6 = query.getInt(columnIndex);
                        String string = query.getString(columnIndex3);
                        String str2 = query.getInt(columnIndex4) > 0 ? "DESC" : "ASC";
                        treeMap.put(Integer.valueOf(r6), string);
                        treeMap2.put(Integer.valueOf(r6), str2);
                    }
                }
    ...
    public static final class Column {
        ...
        @Deprecated
        public Column(String str, String str2, boolean z, int r11) {
            this(str, str2, z, r11, null, 0);
        }
                ...
                if (this.name.equals(column.name) && this.notNull == column.notNull) {
                    if (this.mCreatedFrom != 1 || column.mCreatedFrom != 2 || (str3 = this.defaultValue) == null || defaultValueEquals(str3, column.defaultValue)) {
                        if (this.mCreatedFrom != 2 || column.mCreatedFrom != 1 || (str2 = column.defaultValue) == null || defaultValueEquals(str2, this.defaultValue)) {
                            int r1 = this.mCreatedFrom;
                            return (r1 == 0 || r1 != column.mCreatedFrom || ((str = this.defaultValue) == null ? column.defaultValue == null : defaultValueEquals(str, column.defaultValue))) && this.affinity == column.affinity;
                        }
                        return false;
                    }
                    return false;
        ...
        private static boolean containsSurroundingParenthesis(String str) {
            ...
            for (int r0 = 0; r0 < str.length(); r0++) {
                ...
                if (charAt == '(') {
                    r2++;
                } else if (charAt == ')' && r2 - 1 == 0 && r0 != str.length() - 1) {
                    return false;
                }
            }
            return r2 == 0;
    ...
    public static class ForeignKeyWithSequence implements Comparable<ForeignKeyWithSequence> {
        ...
        ForeignKeyWithSequence(int r1, int r2, String str, String str2) {
            this.mId = r1;
            this.mSequence = r2;
            this.mFrom = str;
            this.mTo = str2;
        ...
        public int compareTo(ForeignKeyWithSequence foreignKeyWithSequence) {
            int r0 = this.mId - foreignKeyWithSequence.mId;
            return r0 == 0 ? this.mSequence - foreignKeyWithSequence.mSequence : r0;
        }
    }
