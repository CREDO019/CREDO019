...
public abstract class RoomDatabase {
    ...
    public void init(DatabaseConfiguration databaseConfiguration) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                this.mAutoMigrationSpecs.put(next, databaseConfiguration.autoMigrationSpecs.get(r3));
            } else {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.RoomDatabase$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    return RoomDatabase.this.m1460lambda$beginTransaction$0$androidxroomRoomDatabase((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    public /* synthetic */ Object m1460lambda$beginTransaction$0$androidxroomRoomDatabase(SupportSQLiteDatabase supportSQLiteDatabase) {
        internalBeginTransaction();
        return null;
    }
    ...
    public void endTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.RoomDatabase$$ExternalSyntheticLambda1
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return RoomDatabase.this.m1461lambda$endTransaction$1$androidxroomRoomDatabase((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    public /* synthetic */ Object m1461lambda$endTransaction$1$androidxroomRoomDatabase(SupportSQLiteDatabase supportSQLiteDatabase) {
        internalEndTransaction();
        return null;
    }
    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        public Builder<T> fallbackToDestructiveMigrationFrom(int... r5) {
            if (this.mMigrationsNotRequiredFrom == null) {
                this.mMigrationsNotRequiredFrom = new HashSet(r5.length);
            }
            for (int r2 : r5) {
                this.mMigrationsNotRequiredFrom.add(Integer.valueOf(r2));
            }
            return this;
        }
    ...
    public static class MigrationContainer {
        ...
        private void addMigration(Migration migration) {
            int r0 = migration.startVersion;
            int r1 = migration.endVersion;
            TreeMap<Integer, Migration> treeMap = this.mMigrations.get(Integer.valueOf(r0));
            if (treeMap == null) {
                treeMap = new TreeMap<>();
                this.mMigrations.put(Integer.valueOf(r0), treeMap);
            }
            Migration migration2 = treeMap.get(Integer.valueOf(r1));
            if (migration2 != null) {
                Log.w("ROOM", "Overriding migration " + migration2 + " with " + migration);
            }
            treeMap.put(Integer.valueOf(r1), migration);
        }
        ...
        public List<Migration> findMigrationPath(int r3, int r4) {
            if (r3 == r4) {
                return Collections.emptyList();
            }
            return findUpMigrationPath(new ArrayList(), r4 > r3, r3, r4);
        }
