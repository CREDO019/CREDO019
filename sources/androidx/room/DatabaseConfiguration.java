...
public class DatabaseConfiguration {
    ...
    public boolean isMigrationRequiredFrom(int r2) {
        return isMigrationRequired(r2, r2 + 1);
    }

    public boolean isMigrationRequired(int r3, int r4) {
        Set<Integer> set;
        return !((r3 > r4) && this.allowDestructiveMigrationOnDowngrade) && this.requireMigration && ((set = this.mMigrationNotRequiredFrom) == null || !set.contains(Integer.valueOf(r3)));
    }
}
