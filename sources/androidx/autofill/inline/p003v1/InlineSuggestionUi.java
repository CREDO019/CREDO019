package androidx.autofill.inline.p003v1;
...
import androidx.autofill.C0190R;
...
/* renamed from: androidx.autofill.inline.v1.InlineSuggestionUi */
...
public final class InlineSuggestionUi {
    ...
    public static View render(Context context, Content content, Style style) {
        ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(getDefaultContextThemeWrapper(context)).inflate(C0190R.layout.autofill_inline_suggestion, (ViewGroup) null);
        ImageView imageView = (ImageView) viewGroup.findViewById(C0190R.C0193id.autofill_inline_suggestion_start_icon);
        TextView textView = (TextView) viewGroup.findViewById(C0190R.C0193id.autofill_inline_suggestion_title);
        TextView textView2 = (TextView) viewGroup.findViewById(C0190R.C0193id.autofill_inline_suggestion_subtitle);
        ImageView imageView2 = (ImageView) viewGroup.findViewById(C0190R.C0193id.autofill_inline_suggestion_end_icon);
    ...
    private static Context getDefaultContextThemeWrapper(Context context) {
        ...
        newTheme.applyStyle(C0190R.C0194style.Theme_AutofillInlineSuggestion, true);
    ...
    /* renamed from: androidx.autofill.inline.v1.InlineSuggestionUi$Style */
    /* loaded from: classes.dex */
    public static final class Style extends BundledStyle implements UiVersions.Style {
        ...
        public int getLayoutDirection() {
            int r0 = this.mBundle.getInt(KEY_LAYOUT_DIRECTION, 0);
            if (r0 == 0 || r0 == 1) {
                return r0;
            }
            return 0;
        ...
        /* renamed from: androidx.autofill.inline.v1.InlineSuggestionUi$Style$Builder */
        /* loaded from: classes.dex */
        public static final class Builder extends BundledStyle.Builder<Style> {
            ...
            public Builder setLayoutDirection(int r3) {
                this.mBundle.putInt(Style.KEY_LAYOUT_DIRECTION, r3);
                return this;
            }
    ...
    /* renamed from: androidx.autofill.inline.v1.InlineSuggestionUi$Content */
    /* loaded from: classes.dex */
    public static final class Content extends SlicedContent {
        ...
        /* renamed from: androidx.autofill.inline.v1.InlineSuggestionUi$Content$Builder */
        /* loaded from: classes.dex */
