...
public class ViewStyle extends BundledStyle {
    ...
    public static abstract class BaseBuilder<T extends ViewStyle, B extends BaseBuilder<T, B>> extends BundledStyle.Builder<T> {
        ...
        public B setBackgroundColor(int r3) {
            this.mBundle.putInt(ViewStyle.KEY_BACKGROUND_COLOR, r3);
            return getThis();
        }

        public B setPadding(int r4, int r5, int r6, int r7) {
            this.mBundle.putIntArray("padding", new int[]{r4, r5, r6, r7});
            return getThis();
        }

        public B setLayoutMargin(int r4, int r5, int r6, int r7) {
            this.mBundle.putIntArray(ViewStyle.KEY_LAYOUT_MARGIN, new int[]{r4, r5, r6, r7});
            return getThis();
        }
    }
