...
public final class TextViewStyle extends ViewStyle {
    ...
    public static final class Builder extends ViewStyle.BaseBuilder<TextViewStyle, Builder> {
        ...
        public Builder setTextSize(int r3, float f) {
            this.mBundle.putInt(TextViewStyle.KEY_TEXT_SIZE_UNIT, r3);
            this.mBundle.putFloat(TextViewStyle.KEY_TEXT_SIZE, f);
            return this;
        }

        public Builder setTextColor(int r3) {
            this.mBundle.putInt(TextViewStyle.KEY_TEXT_COLOR, r3);
            return this;
        }

        public Builder setTypeface(String str, int r4) {
            ...
            this.mBundle.putInt(TextViewStyle.KEY_TEXT_FONT_STYLE, r4);
            return this;
        }
