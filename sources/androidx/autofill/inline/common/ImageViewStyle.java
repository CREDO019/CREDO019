...
public final class ImageViewStyle extends ViewStyle {
    ...
    public static final class Builder extends ViewStyle.BaseBuilder<ImageViewStyle, Builder> {
        ...
        public Builder setMaxWidth(int r3) {
            this.mBundle.putInt(ImageViewStyle.KEY_IMAGE_MAX_WIDTH, r3);
            return this;
        }

        public Builder setMaxHeight(int r3) {
            this.mBundle.putInt(ImageViewStyle.KEY_IMAGE_MAX_HEIGHT, r3);
            return this;
        }
