...
public final class HintConstants {
    ...
    public static String generateSmsOtpHintForCharacterPosition(int r3) {
        Preconditions.checkArgumentInRange(r3, 1, 8, "characterPosition");
        return (AUTOFILL_HINT_SMS_OTP + r3).intern();
    }
}
