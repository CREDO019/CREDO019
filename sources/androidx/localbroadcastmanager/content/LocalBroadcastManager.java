    ...
    public boolean sendBroadcast(Intent intent) {
        ...
        synchronized (this.mReceivers) {
            ...
            if (arrayList3 != null) {
                ...
                while (r6 < arrayList3.size()) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        if (match >= 0) {
                            ...
                            Log.v(TAG, "  Filter did not match: " + (match != -4 ? match != -3 ? match != -2 ? match != -1 ? "unknown reason" : SessionDescription.ATTR_TYPE : "data" : "action" : "category"));
                        }
                    }
                ...
                if (arrayList5 != null) {
                    for (int r3 = 0; r3 < arrayList5.size(); r3++) {
                        ((ReceiverRecord) arrayList5.get(r3)).broadcasting = false;
                    }
