...
public class LruCache<K, V> {
    ...
    */
    ...
    public final synchronized String toString() {
        ...
        int r1;
        r0 = this.hitCount;
        r1 = this.missCount + r0;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(r1 != 0 ? (r0 * 100) / r1 : 0));
    }
}
