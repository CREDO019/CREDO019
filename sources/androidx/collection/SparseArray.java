...
public final class SparseArray {
    ...
    public static final <T> boolean contains(SparseArrayCompat<T> receiver$0, int r2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.containsKey(r2);
    }

    public static final <T> void set(SparseArrayCompat<T> receiver$0, int r2, T t) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        receiver$0.put(r2, t);
    }
    ...
    public static final <T> T getOrDefault(SparseArrayCompat<T> receiver$0, int r2, T t) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.get(r2, t);
    }

    public static final <T> T getOrElse(SparseArrayCompat<T> receiver$0, int r2, Functions<? extends T> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(defaultValue, "defaultValue");
        T t = receiver$0.get(r2);
    ...
    public static final <T> boolean remove(SparseArrayCompat<T> receiver$0, int r2, T t) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.remove(r2, t);
    }
    ...
    public static final <T> void forEach(SparseArrayCompat<T> receiver$0, Function2<? super Integer, ? super T, Unit> action) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            action.invoke(Integer.valueOf(receiver$0.keyAt(r1)), receiver$0.valueAt(r1));
        }
    }
    ...
    public static final <T> IntIterator keyIterator(final SparseArrayCompat<T> receiver$0) {
        ...
        return new IntIterator() { // from class: androidx.collection.SparseArrayKt$keyIterator$1
            ...
            public int nextInt() {
                ...
                int r1 = this.index;
                this.index = r1 + 1;
                return sparseArrayCompat.keyAt(r1);
            }
        };
    }
