...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public void setAlpha(int r7) {
        if (this.mHasAlpha && this.mAlpha == r7) {
            return;
        }
        this.mHasAlpha = true;
        this.mAlpha = r7;
    ...
    public boolean selectDrawable(int r10) {
        ...
        if (r10 >= 0 && r10 < this.mDrawableContainerState.mNumChildren) {
            Drawable child = this.mDrawableContainerState.getChild(r10);
    ...
    */
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public final Drawable getChild(int r5) {
            ...
            this.mDrawables[r5] = prepareDrawable;
        ...
        final boolean setLayoutDirection(int r8, int r9) {
            ...
            for (int r3 = 0; r3 < r0; r3++) {
                if (drawableArr[r3] != null) {
                    boolean layoutDirection = Build.VERSION.SDK_INT >= 23 ? DrawableCompat.setLayoutDirection(drawableArr[r3], r8) : false;
                    if (r3 == r9) {
                        z = layoutDirection;
                    }
                }
        ...
        final void applyTheme(Resources.Theme theme) {
            if (theme != null) {
                ...
                for (int r2 = 0; r2 < r0; r2++) {
                    if (drawableArr[r2] != null && DrawableCompat.canApplyTheme(drawableArr[r2])) {
                        DrawableCompat.applyTheme(drawableArr[r2], theme);
        ...
        public final Rect getConstantPadding() {
            ...
            for (int r5 = 0; r5 < r2; r5++) {
                if (drawableArr[r5].getPadding(rect3)) {
                    if (rect == null) {
        ...
        public final boolean isStateful() {
            ...
            while (true) {
                if (r3 >= r0) {
                    break;
                } else if (drawableArr[r3].isStateful()) {
                    z = true;
                    break;
                } else {
                    r3++;
        ...
        public void growArray(int r3, int r4) {
            ...
            if (drawableArr2 != null) {
                System.arraycopy(drawableArr2, 0, drawableArr, 0, r3);
            }
