...
public final class Compatibility {
    ...
    public static class Api15Impl {
        ...
        public static void getValueForDensity(Resources resources, int r1, int r2, TypedValue typedValue, boolean z) {
            resources.getValueForDensity(r1, r2, typedValue, z);
        }
    }
}
