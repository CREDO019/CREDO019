...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int r13) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0079R.styleable.ActivityChooserView, r13, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0079R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, r13, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0079R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0079R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0079R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(C0079R.C0082id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0079R.C0082id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C0079R.C0082id.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0079R.C0082id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0079R.C0082id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0079R.dimen.abc_config_prefDialogWidth));
    }
    ...
    void showPopupUnchecked(int r6) {
        ...
        listPopupWindow.getListView().setContentDescription(getContext().getString(C0079R.string.abc_activitychooserview_choose_application));
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int r3, long j) {
            ...
            Intent chooseActivity = ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(r3);
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getItemViewType(int r3) {
            return (this.mShowFooterView && r3 == getCount() - 1) ? 1 : 0;
        }
        ...
        public View getView(int r6, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    if (view == null || view.getId() != 1) {
                        View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0079R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                        inflate.setId(1);
                        ((TextView) inflate.findViewById(C0079R.C0082id.title)).setText(ActivityChooserView.this.getContext().getString(C0079R.string.abc_activity_chooser_view_see_all));
                        return inflate;
                    }
                    return view;
                }
            ...
            if (view == null || view.getId() != C0079R.C0082id.list_item) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0079R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ResolveInfo resolveInfo = (ResolveInfo) getItem(r6);
            ((ImageView) view.findViewById(C0079R.C0082id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(C0079R.C0082id.title)).setText(resolveInfo.loadLabel(packageManager));
