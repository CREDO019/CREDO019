...
public class AppCompatCheckedTextView extends CheckedTextView implements TintableCheckedTextView, TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatCheckedTextView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mCheckMarkTintId = propertyMapper.mapObject("checkMarkTint", C0079R.attr.checkMarkTint);
            this.mCheckMarkTintModeId = propertyMapper.mapObject("checkMarkTintMode", C0079R.attr.checkMarkTintMode);
    ...
    public AppCompatCheckedTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0079R.attr.checkedTextViewStyle);
    }

    public AppCompatCheckedTextView(Context context, AttributeSet attributeSet, int r3) {
        ...
        appCompatCheckedTextViewHelper.loadFromAttributes(attributeSet, r3);
