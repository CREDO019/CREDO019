...
public class DropDownListView extends ListView {
    ...
    public DropDownListView(Context context, boolean z) {
        super(context, null, C0079R.attr.dropDownListViewStyle);
    ...
    public int lookForSelectablePosition(int r5, boolean z) {
        int min;
    ...
    public int measureHeightOfChildrenCompat(int r11, int r12, int r13, int r14, int r15) {
        ...
        int r122 = listPaddingTop + listPaddingBottom;
        ...
        while (r4 < count) {
            ...
            view.measure(r11, makeMeasureSpec);
            view.forceLayout();
            if (r4 > 0) {
                r122 += dividerHeight;
            }
            r122 += view.getMeasuredHeight();
            if (r122 >= r14) {
                return (r15 < 0 || r4 <= r15 || r7 <= 0 || r122 == r14) ? r14 : r7;
            }
            if (r15 >= 0 && r4 >= r15) {
                r7 = r122;
            }
    ...
    */
    ...
    private void positionSelectorLikeTouchCompat(int r2, View view, float f, float f2) {
        positionSelectorLikeFocusCompat(r2, view);
        Drawable selector = getSelector();
    ...
    private void positionSelectorLikeFocusCompat(int r5, View view) {
        Drawable selector = getSelector();
    ...
    private void positionSelectorCompat(int r6, View view) {
        Rect rect = this.mSelectorRect;
    ...
    private void setPressedItem(View view, int r8, float f, float f2) {
        View childAt;
