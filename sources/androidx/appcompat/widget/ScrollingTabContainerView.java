...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void onMeasure(int r7, int r8) {
        ...
        super.onMeasure(r7, makeMeasureSpec);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0079R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0079R.attr.actionDropDownStyle);
    ...
    public void animateToVisibility(int r5) {
        ...
        if (r5 == 0) {
            ...
            alpha.setListener(this.mVisAnimListener.withFinalVisibility(alpha, r5));
            alpha.start();
            return;
        }
        ...
        alpha2.setListener(this.mVisAnimListener.withFinalVisibility(alpha2, r5));
        alpha2.start();
    }
    ...
    public void addTab(ActionBar.Tab tab, int r7, boolean z) {
        TabView createTabView = createTabView(tab, false);
        this.mTabLayout.addView(createTabView, r7, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            super(context, null, C0079R.attr.actionBarTabStyle);
            int[] r4 = {16842964};
            this.BG_ATTRS = r4;
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, r4, C0079R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0079R.attr.actionBarTabTextStyle);
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public Object getItem(int r2) {
            return ((TabView) ScrollingTabContainerView.this.mTabLayout.getChildAt(r2)).getTab();
        }
