...
public class AppCompatEditText extends EditText implements TintableBackgroundView, OnReceiveContentViewBehavior, EmojiCompatConfigurationView {
    ...
    public AppCompatEditText(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0079R.attr.editTextStyle);
    }
    ...
    public AppCompatEditText(Context context, AttributeSet attributeSet, int r3) {
        ...
        appCompatEmojiEditTextHelper.loadFromAttributes(attributeSet, r3);
    ...
    public boolean onTextContextMenuItem(int r2) {
        if (AppCompatReceiveContentHelper.maybeHandleMenuActionViaPerformReceiveContent(this, r2)) {
            return true;
        }
        return super.onTextContextMenuItem(r2);
    }
