...
public class ThemeUtils {
    ...
    public static int getThemeAttrColor(Context context, int r3) {
        int[] r0 = TEMP_ARRAY;
        r0[0] = r3;
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, (AttributeSet) null, r0);
        try {
    ...
    static int getThemeAttrColor(Context context, int r1, float f) {
        int themeAttrColor = getThemeAttrColor(context, r1);
        return ColorUtils.setAlphaComponent(themeAttrColor, Math.round(Color.alpha(themeAttrColor) * f));
    }

    public static void checkAppCompatTheme(View view, Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(C0079R.styleable.AppCompatTheme);
        try {
