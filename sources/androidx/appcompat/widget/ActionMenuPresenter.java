...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0079R.layout.abc_action_menu_layout, C0079R.layout.abc_action_menu_item_layout);
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z || r12 + r112 > r5)) {
            r5--;
        }
        int r52 = r5 - r112;
        ...
        int r14 = 0;
        while (r122 < r4) {
            MenuItemImpl menuItemImpl2 = arrayList.get(r122);
            if (menuItemImpl2.requiresActionButton()) {
                View itemView = actionMenuPresenter.getItemView(menuItemImpl2, view, viewGroup);
                if (actionMenuPresenter.mStrictWidthLimit) {
                    r11 -= ActionMenuView.measureChildForCells(itemView, r10, r11, makeMeasureSpec, r3);
                } else {
                ...
                boolean z3 = (r52 > 0 || z2) && r6 > 0 && (!actionMenuPresenter.mStrictWidthLimit || r11 > 0);
                boolean z4 = z3;
                r17 = r4;
                if (z3) {
                    View itemView2 = actionMenuPresenter.getItemView(menuItemImpl2, null, viewGroup);
                    if (actionMenuPresenter.mStrictWidthLimit) {
                        int measureChildForCells = ActionMenuView.measureChildForCells(itemView2, r10, r11, makeMeasureSpec, 0);
                        r11 -= measureChildForCells;
                    ...
                    z3 = z5 & (!actionMenuPresenter.mStrictWidthLimit ? r6 + r14 <= 0 : r6 < 0);
                }
                if (z3 && groupId2 != 0) {
                    sparseBooleanArray.put(groupId2, true);
                } else if (z2) {
                    sparseBooleanArray.put(groupId2, false);
                    for (int r42 = 0; r42 < r122; r42++) {
                        MenuItemImpl menuItemImpl3 = arrayList.get(r42);
    ...
    public class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0079R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    public class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0079R.attr.actionOverflowMenuStyle);
    ...
    public class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, C0079R.attr.actionOverflowMenuStyle);
