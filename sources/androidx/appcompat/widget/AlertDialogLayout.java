    ...
    private boolean tryOnMeasure(int r17, int r18) {
        ...
        for (int r8 = 0; r8 < childCount; r8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0079R.C0082id.topPanel) {
                    view = childAt;
                } else if (id == C0079R.C0082id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0079R.C0082id.contentPanel && id != C0079R.C0082id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            ...
            r14 = view2.getMeasuredHeight() - r13;
            paddingTop += r13;
        ...
        if (view3 != null && r10 > 0) {
            view3.measure(r17, View.MeasureSpec.makeMeasureSpec(r15 + r10, mode));
            paddingTop = (paddingTop - r15) + view3.getMeasuredHeight();
            r4 = View.combineMeasuredStates(r4, view3.getMeasuredState());
        }
        int r7 = 0;
        ...
        for (int r1 = 0; r1 < r11; r1++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.width == -1) {
                    ...
                    measureChildWithMargins(childAt, makeMeasureSpec, 0, r12, 0);
