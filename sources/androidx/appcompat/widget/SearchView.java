...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mIconifiedByDefaultId = propertyMapper.mapBoolean("iconifiedByDefault", C0079R.attr.iconifiedByDefault);
            this.mQueryHintId = propertyMapper.mapObject("queryHint", C0079R.attr.queryHint);
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0079R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attributeSet, int r19) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0079R.styleable.SearchView, r19, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0079R.styleable.SearchView, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), r19, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0079R.styleable.SearchView_layout, C0079R.layout.abc_search_view), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0079R.C0082id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0079R.C0082id.search_edit_frame);
        View findViewById = findViewById(C0079R.C0082id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0079R.C0082id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C0079R.C0082id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0079R.C0082id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0079R.C0082id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0079R.C0082id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0079R.C0082id.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        ViewCompat.setBackground(findViewById, obtainStyledAttributes.getDrawable(C0079R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, obtainStyledAttributes.getDrawable(C0079R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(obtainStyledAttributes.getDrawable(C0079R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(obtainStyledAttributes.getDrawable(C0079R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(obtainStyledAttributes.getDrawable(C0079R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(obtainStyledAttributes.getDrawable(C0079R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(C0079R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0079R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0079R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0079R.styleable.SearchView_suggestionRowLayout, C0079R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0079R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0079R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0079R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0079R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0079R.styleable.SearchView_queryHint);
        int r1 = obtainStyledAttributes.getInt(C0079R.styleable.SearchView_android_imeOptions, -1);
        if (r1 != -1) {
            setImeOptions(r1);
        }
        int r12 = obtainStyledAttributes.getInt(C0079R.styleable.SearchView_android_inputType, -1);
        if (r12 != -1) {
            setInputType(r12);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0079R.styleable.SearchView_android_focusable, true));
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0079R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0079R.dimen.abc_search_view_preferred_height);
    }
    ...
    boolean onSuggestionsKey(View view, int r3, KeyEvent keyEvent) {
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0079R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0079R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int r10, String str) {
        ...
        try {
            ...
            try {
                r9 = cursor.getPosition();
            } catch (RuntimeException unused) {
                r9 = -1;
            }
            Log.w(LOG_TAG, "Search suggestions cursor at row " + r9 + " returned exception.", e);
            return null;
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0079R.attr.autoCompleteTextViewStyle);
        }
