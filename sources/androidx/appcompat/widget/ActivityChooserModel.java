...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public ResolveInfo getActivity(int r3) {
        ...
        synchronized (this.mInstanceLock) {
            ensureConsistentState();
            resolveInfo = this.mActivities.get(r3).resolveInfo;
        }
        return resolveInfo;
    }
    ...
    public int getActivityIndex(ResolveInfo resolveInfo) {
        synchronized (this.mInstanceLock) {
            ...
            for (int r3 = 0; r3 < size; r3++) {
                if (list.get(r3).resolveInfo == resolveInfo) {
                    return r3;
                }
            }
            return -1;
    ...
    private boolean loadActivitiesIfNeeded() {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            this.mActivities.add(new ActivityResolveInfo(queryIntentActivities.get(r1)));
        }
        return true;
    }
    ...
    private static final class DefaultSorter implements ActivitySorter {
        ...
        public void sort(Intent intent, List<ActivityResolveInfo> list, List<HistoricalRecord> list2) {
            ...
            int size = list.size();
            for (int r1 = 0; r1 < size; r1++) {
                ActivityResolveInfo activityResolveInfo = list.get(r1);
        ...
        try {
            ...
            try {
                try {
                    ...
                    for (int r3 = 0; r3 != 1 && r3 != 2; r3 = newPullParser.next()) {
                    }
                } catch (IOException e) {
                    String str = LOG_TAG;
