...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SwitchCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mShowTextId = propertyMapper.mapBoolean("showText", C0079R.attr.showText);
            this.mSplitTrackId = propertyMapper.mapBoolean("splitTrack", C0079R.attr.splitTrack);
            this.mSwitchMinWidthId = propertyMapper.mapInt("switchMinWidth", C0079R.attr.switchMinWidth);
            this.mSwitchPaddingId = propertyMapper.mapInt("switchPadding", C0079R.attr.switchPadding);
            this.mThumbTextPaddingId = propertyMapper.mapInt("thumbTextPadding", C0079R.attr.thumbTextPadding);
            this.mThumbTintId = propertyMapper.mapObject("thumbTint", C0079R.attr.thumbTint);
            this.mThumbTintModeId = propertyMapper.mapObject("thumbTintMode", C0079R.attr.thumbTintMode);
            this.mTrackId = propertyMapper.mapObject("track", C0079R.attr.track);
            this.mTrackTintId = propertyMapper.mapObject("trackTint", C0079R.attr.trackTint);
            this.mTrackTintModeId = propertyMapper.mapObject("trackTintMode", C0079R.attr.trackTintMode);
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0079R.attr.switchStyle);
    }

    public SwitchCompat(Context context, AttributeSet attributeSet, int r14) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0079R.styleable.SwitchCompat, r14, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0079R.styleable.SwitchCompat, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), r14, 0);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0079R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = obtainStyledAttributes.getDrawable(C0079R.styleable.SwitchCompat_track);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        setTextOnInternal(obtainStyledAttributes.getText(C0079R.styleable.SwitchCompat_android_textOn));
        setTextOffInternal(obtainStyledAttributes.getText(C0079R.styleable.SwitchCompat_android_textOff));
        this.mShowText = obtainStyledAttributes.getBoolean(C0079R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C0079R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0079R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C0079R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C0079R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0079R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0079R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList colorStateList2 = obtainStyledAttributes.getColorStateList(C0079R.styleable.SwitchCompat_trackTint);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode parseTintMode2 = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0079R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(C0079R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
            setSwitchTextAppearance(context, resourceId);
        }
        AppCompatTextHelper appCompatTextHelper = new AppCompatTextHelper(this);
        this.mTextHelper = appCompatTextHelper;
        appCompatTextHelper.loadFromAttributes(attributeSet, r14);
        obtainStyledAttributes.recycle();
        ViewConfiguration viewConfiguration = ViewConfiguration.get(context);
        this.mTouchSlop = viewConfiguration.getScaledTouchSlop();
        this.mMinFlingVelocity = viewConfiguration.getScaledMinimumFlingVelocity();
        getEmojiTextViewHelper().loadFromAttributes(attributeSet, r14);
    ...
    public void setSwitchTextAppearance(Context context, int r5) {
        ...
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0079R.styleable.TextAppearance_android_textColor);
        if (colorStateList != null) {
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C0079R.styleable.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(C0079R.styleable.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(C0079R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    public void setSwitchTypeface(Typeface typeface, int r5) {
        ...
        if (r5 > 0) {
            if (typeface == null) {
                create = Typeface.defaultFromStyle(r5);
            } else {
                create = Typeface.create(typeface, r5);
            }
            setSwitchTypeface(create);
            int r4 = (~(create != null ? create.getStyle() : 0)) & r5;
    ...
    public void onMeasure(int r7, int r8) {
        ...
        if (drawable != null) {
            ...
            r1 = (this.mThumbDrawable.getIntrinsicWidth() - rect.left) - rect.right;
            r3 = this.mThumbDrawable.getIntrinsicHeight();
        } else {
            r1 = 0;
            r3 = 0;
        }
        this.mThumbWidth = Math.max(this.mShowText ? Math.max(this.mOnLayout.getWidth(), this.mOffLayout.getWidth()) + (this.mThumbTextPadding * 2) : 0, r1);
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
        ...
        int max = Math.max(this.mSwitchMinWidth, (this.mThumbWidth * 2) + r12 + r0);
        int max2 = Math.max(r2, r3);
    ...
    */
    ...
    protected void onLayout(boolean z, int r2, int r3, int r4, int r5) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            r1 = getPaddingLeft() + r42;
            width = ((this.mSwitchWidth + r1) - r42) - r22;
        } else {
            width = (getWidth() - getPaddingRight()) - r22;
            r1 = (width - this.mSwitchWidth) + r42 + r22;
        }
        int gravity = getGravity() & 112;
        if (gravity == 16) {
            r43 = this.mSwitchHeight;
            paddingTop = (((getPaddingTop() + getHeight()) - getPaddingBottom()) / 2) - (r43 / 2);
        } else if (gravity != 80) {
            paddingTop = getPaddingTop();
            r43 = this.mSwitchHeight;
        } else {
            r44 = getHeight() - getPaddingBottom();
            paddingTop = r44 - this.mSwitchHeight;
            this.mSwitchLeft = r1;
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (rect != null) {
                if (rect.left > rect2.left) {
                    r1 += rect.left - rect2.left;
                }
                r7 = rect.top > rect2.top ? (rect.top - rect2.top) + r2 : r2;
                if (rect.right > rect2.right) {
                    r3 -= rect.right - rect2.right;
                }
                if (rect.bottom > rect2.bottom) {
                    r6 = r4 - (rect.bottom - rect2.bottom);
        ...
        if (drawable3 != null) {
            ...
            int r12 = thumbOffset - rect2.left;
            int r5 = thumbOffset + this.mThumbWidth + rect2.right;
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C0079R.string.abc_capital_on);
            }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C0079R.string.abc_capital_off);
            }
            ViewCompat.setStateDescription(this, charSequence);
        }
    }
