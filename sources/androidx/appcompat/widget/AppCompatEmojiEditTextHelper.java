...
class AppCompatEmojiEditTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int r5) {
        TypedArray obtainStyledAttributes = this.mView.getContext().obtainStyledAttributes(attributeSet, C0079R.styleable.AppCompatTextView, r5, 0);
        try {
            boolean z = obtainStyledAttributes.hasValue(C0079R.styleable.AppCompatTextView_emojiCompatEnabled) ? obtainStyledAttributes.getBoolean(C0079R.styleable.AppCompatTextView_emojiCompatEnabled, true) : true;
