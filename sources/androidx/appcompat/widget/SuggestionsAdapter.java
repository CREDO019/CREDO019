...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0079R.C0082id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0079R.C0082id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0079R.attr.textColorSearchUrl, typedValue, true);
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int r12) {
        ...
        if (r12 > 0) {
            fragment.appendQueryParameter("limit", String.valueOf(r12));
        }
