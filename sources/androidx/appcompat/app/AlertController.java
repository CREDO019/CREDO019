...
public class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0079R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0079R.styleable.AlertDialog, C0079R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0079R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0079R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0079R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0079R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0079R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0079R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0079R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0079R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    public int getIconAttributeResId(int r4) {
        TypedValue typedValue = new TypedValue();
        this.mContext.getTheme().resolveAttribute(r4, typedValue, true);
    ...
    private void setupView() {
        ...
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0079R.C0082id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0079R.C0082id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0079R.C0082id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0079R.C0082id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0079R.C0082id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0079R.C0082id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0079R.C0082id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0079R.C0082id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(C0079R.C0082id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            if (this.mMessage != null || this.mListView != null) {
                view = resolvePanel.findViewById(C0079R.C0082id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null && (findViewById = resolvePanel2.findViewById(C0079R.C0082id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int r7, int r8) {
        final View findViewById = this.mWindow.findViewById(C0079R.C0082id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0079R.C0082id.scrollIndicatorDown);
        ...
        if (findViewById != null && (r7 & 1) == 0) {
            viewGroup.removeView(findViewById);
            findViewById = null;
        }
        if (findViewById2 != null && (r7 & 2) == 0) {
            viewGroup.removeView(findViewById2);
            findViewById2 = null;
        }
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0079R.C0082id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0079R.C0082id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if ((!TextUtils.isEmpty(this.mTitle)) && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0079R.C0082id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0079R.C0082id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0079R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0079R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0079R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    listAdapter = new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
                        ...
                        public View getView(int r2, View view, ViewGroup viewGroup) {
                            ...
                            if (AlertParams.this.mCheckedItems != null && AlertParams.this.mCheckedItems[r2]) {
                                recycleListView.setItemChecked(r2, true);
                            }
                            return view2;
                        }
                    };
                ...
                int r4 = r1;
                if (this.mCursor != null) {
                    listAdapter = new SimpleCursorAdapter(this.mContext, r4, this.mCursor, new String[]{this.mLabelColumn}, new int[]{16908308});
                } else {
                    listAdapter = this.mAdapter;
                    if (listAdapter == null) {
                        listAdapter = new CheckedItemAdapter(this.mContext, r4, 16908308, this.mItems);
                    }
                }
            }
