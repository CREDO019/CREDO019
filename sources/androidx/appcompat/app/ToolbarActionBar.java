...
class ToolbarActionBar extends ActionBar {
    ...
    public void setTitle(int r3) {
        ...
        decorToolbar.setTitle(r3 != 0 ? decorToolbar.getContext().getText(r3) : null);
    }
    ...
    public void setSubtitle(int r3) {
        DecorToolbar decorToolbar = this.mDecorToolbar;
        decorToolbar.setSubtitle(r3 != 0 ? decorToolbar.getContext().getText(r3) : null);
    }
    ...
    public void setDisplayOptions(int r3, int r4) {
        this.mDecorToolbar.setDisplayOptions((r3 & r4) | ((~r4) & this.mDecorToolbar.getDisplayOptions()));
    }
    ...
    private class ToolbarMenuCallback implements AppCompatDelegateImpl.ActionBarMenuCallback {
        ...
        public boolean onPreparePanel(int r2) {
            if (r2 != 0 || ToolbarActionBar.this.mToolbarMenuPrepared) {
                return false;
            }
