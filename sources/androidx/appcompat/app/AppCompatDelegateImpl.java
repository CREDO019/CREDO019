...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C0079R.C0084style.Theme_AppCompat_Empty);
    ...
    */
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        Context context;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0079R.styleable.AppCompatTheme);
        if (!obtainStyledAttributes.hasValue(C0079R.styleable.AppCompatTheme_windowActionBar)) {
            obtainStyledAttributes.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (obtainStyledAttributes.getBoolean(C0079R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (obtainStyledAttributes.getBoolean(C0079R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (obtainStyledAttributes.getBoolean(C0079R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (obtainStyledAttributes.getBoolean(C0079R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = obtainStyledAttributes.getBoolean(C0079R.styleable.AppCompatTheme_android_windowIsFloating, false);
        obtainStyledAttributes.recycle();
        ensureWindow();
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(C0079R.layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0079R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    context = new androidx.appcompat.view.ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    context = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0079R.layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0079R.C0082id.decor_content_parent);
            ...
            viewGroup = this.mOverlayActionMode ? (ViewGroup) from.inflate(C0079R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(C0079R.layout.abc_screen_simple, (ViewGroup) null);
        }
        if (viewGroup == null) {
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) viewGroup.findViewById(C0079R.C0082id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0079R.C0082id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0079R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0079R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0079R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0079R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0079R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0079R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0079R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0079R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0079R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0079R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0079R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    public boolean requestWindowFeature(int r5) {
        int sanitizeWindowFeatureId = sanitizeWindowFeatureId(r5);
    ...
    */
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String string = this.mContext.obtainStyledAttributes(C0079R.styleable.AppCompatTheme).getString(C0079R.styleable.AppCompatTheme_viewInflaterClass);
            if (string == null) {
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams3 = new WindowManager.LayoutParams(r6, -2, panelFeatureState.f9x, panelFeatureState.f10y, 1002, 8519680, -3);
            ...
            r6 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(r6, -2, panelFeatureState.f9x, panelFeatureState.f10y, 1002, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0079R.attr.actionBarTheme, typedValue, true);
            Resources.Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0079R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0079R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
    ...
    private boolean onKeyUpPanel(int r4, KeyEvent keyEvent) {
        boolean z;
        DecorContentParent decorContentParent;
        if (this.mActionMode != null) {
            return false;
        ...
        boolean z2 = true;
        PanelFeatureState panelState = getPanelState(r4, true);
        if (r4 == 0 && (decorContentParent = this.mDecorContentParent) != null && decorContentParent.canShowOverflowMenu() && !ViewConfiguration.get(this.mContext).hasPermanentMenuKey()) {
    ...
    PanelFeatureState findMenuPanel(Menu menu) {
        ...
        for (int r1 = 0; r1 < length; r1++) {
            PanelFeatureState panelFeatureState = panelFeatureStateArr[r1];
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int r4, KeyEvent keyEvent, int r6) {
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && panelFeatureState.menu != null) {
            z = panelFeatureState.menu.performShortcut(r4, keyEvent, r6);
        }
        if (z && (r6 & 1) == 0 && this.mDecorContentParent == null) {
            closePanel(panelFeatureState, true);
        }
        return z;
    }
    ...
    final int updateStatusGuard(WindowInsetsCompat windowInsetsCompat, Rect rect) {
        ...
        if (windowInsetsCompat != null) {
            r1 = windowInsetsCompat.getSystemWindowInsetTop();
        } else {
            r1 = rect != null ? rect.top : 0;
        }
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            color = ContextCompat.getColor(this.mContext, C0079R.C0080color.abc_decor_view_status_guard_light);
        } else {
            color = ContextCompat.getColor(this.mContext, C0079R.C0080color.abc_decor_view_status_guard);
        }
    ...
    int mapNightMode(Context context, int r4) {
        if (r4 != -100) {
            if (r4 != -1) {
                if (r4 == 0) {
    ...
    private int calculateNightMode() {
        ...
        return r0 != -100 ? r0 : getDefaultNightMode();
    }

    private Configuration createOverrideConfigurationForDayNight(Context context, int r3, Configuration configuration) {
        int r2;
        if (r3 != 1) {
            r2 = r3 != 2 ? context.getApplicationContext().getResources().getConfiguration().uiMode & 48 : 32;
        } else {
            r2 = 16;
        }
        Configuration configuration2 = new Configuration();
    ...
    */
    ...
    private void updateResourcesConfigurationForNightMode(int r4, boolean z, Configuration configuration) {
        ...
        if (!this.mActivityHandlesUiModeChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= 29) {
                    ...
                    r3 = Build.VERSION.SDK_INT >= 24 ? 786432 : 0;
                }
                ActivityInfo activityInfo = packageManager.getActivityInfo(new ComponentName(this.mContext, this.mHost.getClass()), r3);
    ...
    public static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0079R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0079R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0079R.C0084style.Theme_AppCompat_CompactMenu, true);
            }
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0079R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0079R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0079R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            obtainStyledAttributes.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0079R.layout.abc_list_menu_item_layout);
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public View onCreatePanelView(int r2) {
            ...
            return (actionBarMenuCallback == null || (onCreatePanelView = actionBarMenuCallback.onCreatePanelView(r2)) == null) ? super.onCreatePanelView(r2) : onCreatePanelView;
        }

        @Override // androidx.appcompat.view.WindowCallbackWrapper, android.view.Window.Callback
        public boolean onPreparePanel(int r5, View view, Menu menu) {
            MenuBuilder menuBuilder = menu instanceof MenuBuilder ? (MenuBuilder) menu : null;
            if (r5 == 0 && menuBuilder == null) {
                return false;
            }
            boolean z = true;
            if (menuBuilder != null) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            z = (actionBarMenuCallback == null || !actionBarMenuCallback.onPreparePanel(r5)) ? false : false;
            if (!z) {
                z = super.onPreparePanel(r5, view, menu);
            }
            if (menuBuilder != null) {
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0079R.attr.homeAsUpIndicator});
        ...
        public void setActionBarUpIndicator(Drawable drawable, int r3) {
            ...
            if (supportActionBar != null) {
                ...
                supportActionBar.setHomeActionContentDescription(r3);
            }
        }
