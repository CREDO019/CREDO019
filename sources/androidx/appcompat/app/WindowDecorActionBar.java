...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0079R.C0082id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0079R.C0082id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0079R.C0082id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0079R.C0082id.action_bar_container);
        ...
        if (obtainStyledAttributes.getBoolean(C0079R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0079R.styleable.ActionBar_elevation, 0);
    ...
    public void removeTabAt(int r5) {
        ...
        TabImpl remove = this.mTabs.remove(r5);
        if (remove != null) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0079R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    @Override // androidx.appcompat.app.ActionBar
    public boolean onKeyShortcut(int r5, KeyEvent keyEvent) {
        Menu menu;
        ActionModeImpl actionModeImpl = this.mActionMode;
