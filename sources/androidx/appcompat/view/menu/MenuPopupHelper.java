...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0079R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, C0079R.attr.popupMenuStyle, 0);
    }
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0079R.dimen.abc_cascading_menus_min_smallest_width)) {
    ...
    private void showPopup(int r4, int r5, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            popup.setEpicenterBounds(new Rect(r4 - r6, r5 - r6, r4 + r6, r5 + r6));
        }
        popup.show();
    }
