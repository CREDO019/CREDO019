...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int r6) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0079R.styleable.ActionMenuItemView, r6, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0079R.styleable.ActionMenuItemView_android_minWidth, 0);
    ...
    public void onMeasure(int r6, int r7) {
        ...
        if (mode == Integer.MIN_VALUE) {
            r62 = Math.min(size, this.mMinWidth);
        } else {
            r62 = this.mMinWidth;
        }
