...
public abstract class BaseMenuWrapper {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void internalRemoveGroup(int r3) {
        if (this.mMenuItems == null) {
            return;
        }
        int r0 = 0;
        while (r0 < this.mMenuItems.size()) {
            if (this.mMenuItems.keyAt(r0).getGroupId() == r3) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void internalRemoveItem(int r3) {
        if (this.mMenuItems == null) {
            return;
        }
        for (int r0 = 0; r0 < this.mMenuItems.size(); r0++) {
            if (this.mMenuItems.keyAt(r0).getItemId() == r3) {
                this.mMenuItems.removeAt(r0);
                return;
            }
        }
