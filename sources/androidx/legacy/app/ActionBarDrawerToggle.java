...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private void setActionBarUpIndicator(Drawable drawable, int r8) {
        Delegate delegate = this.mActivityImpl;
        if (delegate != null) {
    ...
    private void setActionBarDescription(int r5) {
        Delegate delegate = this.mActivityImpl;
        if (delegate != null) {
            delegate.setActionBarDescription(r5);
        } else if (Build.VERSION.SDK_INT >= 18) {
            ActionBar actionBar = this.mActivity.getActionBar();
            if (actionBar != null) {
            ...
            if (this.mSetIndicatorInfo.mSetHomeAsUpIndicator != null) {
                try {
                    ActionBar actionBar2 = this.mActivity.getActionBar();
                    this.mSetIndicatorInfo.mSetHomeActionContentDescription.invoke(actionBar2, Integer.valueOf(r5));
    ...
    public class SlideDrawable extends InsetDrawable implements Drawable.Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.translate((-this.mOffset) * width * this.mPosition * r1, 0.0f);
