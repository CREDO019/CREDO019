...
public class BiometricManager {
    ...
    public int canAuthenticate(int r3) {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            return Api30Impl.canAuthenticate(biometricManager, r3);
        }
        return canAuthenticateCompat(r3);
    }

    private int canAuthenticateCompat(int r4) {
        if (AuthenticatorUtils.isSupportedCombination(r4)) {
            if (r4 != 0 && this.mInjector.isDeviceSecurable()) {
                if (AuthenticatorUtils.isDeviceCredentialAllowed(r4)) {
                    return this.mInjector.isDeviceSecuredWithCredential() ? 0 : 11;
                } else if (Build.VERSION.SDK_INT == 29) {
                    if (AuthenticatorUtils.isWeakBiometricAllowed(r4)) {
    ...
    public static class Api30Impl {
        ...
        static int canAuthenticate(android.hardware.biometrics.BiometricManager biometricManager, int r1) {
            return biometricManager.canAuthenticate(r1);
        }
    }
