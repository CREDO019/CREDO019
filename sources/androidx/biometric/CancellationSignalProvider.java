...
class CancellationSignalProvider {
    ...
    private androidx.core.p005os.CancellationSignal mFingerprintCancellationSignal;
    ...
    interface Injector {
        ...
        androidx.core.p005os.CancellationSignal getFingerprintCancellationSignal();
    }
    ...
    public CancellationSignalProvider() {
        this.mInjector = new Injector() { // from class: androidx.biometric.CancellationSignalProvider.1
            ...
            @Override // androidx.biometric.CancellationSignalProvider.Injector
            public androidx.core.p005os.CancellationSignal getFingerprintCancellationSignal() {
                return new androidx.core.p005os.CancellationSignal();
            }
        };
    }
    ...
    public void cancel() {
        ...
        androidx.core.p005os.CancellationSignal cancellationSignal2 = this.mFingerprintCancellationSignal;
