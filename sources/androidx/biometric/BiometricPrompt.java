...
public class BiometricPrompt {
    ...
    public static class AuthenticationResult {
        ...
        public AuthenticationResult(CryptoObject cryptoObject, int r2) {
            this.mCryptoObject = cryptoObject;
            this.mAuthenticationType = r2;
        }
    ...
    public static class PromptInfo {
        ...
        public static class Builder {
            ...
            public Builder setAllowedAuthenticators(int r1) {
                this.mAllowedAuthenticators = r1;
                return this;
            }
            ...
            public PromptInfo build() {
                ...
                int r0 = this.mAllowedAuthenticators;
                if (r0 != 0) {
                    z = AuthenticatorUtils.isDeviceCredentialAllowed(r0);
                } else {
        ...
        PromptInfo(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, CharSequence charSequence4, boolean z, boolean z2, int r7) {
            this.mTitle = charSequence;
            ...
            this.mAllowedAuthenticators = r7;
        }
