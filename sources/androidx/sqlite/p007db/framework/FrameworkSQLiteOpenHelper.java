...
class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    public static class OpenHelper extends SQLiteOpenHelper {
        ...
        @Override // android.database.sqlite.SQLiteOpenHelper
        public void onUpgrade(SQLiteDatabase sQLiteDatabase, int r3, int r4) {
            this.mMigrated = true;
            this.mCallback.onUpgrade(getWrappedDb(sQLiteDatabase), r3, r4);
        }
        ...
        @Override // android.database.sqlite.SQLiteOpenHelper
        public void onDowngrade(SQLiteDatabase sQLiteDatabase, int r3, int r4) {
            this.mMigrated = true;
            this.mCallback.onDowngrade(getWrappedDb(sQLiteDatabase), r3, r4);
        }
