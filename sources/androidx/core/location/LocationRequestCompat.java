...
public final class LocationRequestCompat {
    ...
    LocationRequestCompat(long j, int r3, long j2, int r6, long j3, float f, long j4) {
    ...
    public static final class Builder {
        ...
        public Builder setQuality(int r5) {
            Preconditions.checkArgument(r5 == 104 || r5 == 102 || r5 == 100, "quality must be a defined QUALITY constant, not %d", Integer.valueOf(r5));
            this.mQuality = r5;
            return this;
        }
        ...
        public Builder setMaxUpdates(int r4) {
            this.mMaxUpdates = Preconditions.checkArgumentInRange(r4, 1, Integer.MAX_VALUE, "maxUpdates");
            return this;
        }
