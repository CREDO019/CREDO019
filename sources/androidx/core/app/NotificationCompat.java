...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0264R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0264R.dimen.compat_notification_large_icon_max_height);
        ...
        private void setFlag(int r2, boolean z) {
            if (z) {
                Notification notification = this.mNotification;
            ...
            notification2.flags = (~r2) & notification2.flags;
        }
        ...
        public Builder addInvisibleAction(int r3, CharSequence charSequence, PendingIntent pendingIntent) {
            this.mInvisibleActions.add(new Action(r3, charSequence, pendingIntent));
            return this;
        }
        ...
        public Builder setForegroundServiceBehavior(int r1) {
            this.mFgsDeferBehavior = r1;
            return this;
        }
    ...
    public static abstract class Style {
        ...
        */
        ...
        Bitmap createColoredBitmap(IconCompat iconCompat, int r3) {
            return createColoredBitmap(iconCompat, r3, 0);
        }

        private Bitmap createColoredBitmap(int r2, int r3, int r4) {
            return createColoredBitmap(IconCompat.createWithResource(this.mBuilder.mContext, r2), r3, r4);
        }

        private Bitmap createColoredBitmap(IconCompat iconCompat, int r5, int r6) {
            Drawable loadDrawable = iconCompat.loadDrawable(this.mBuilder.mContext);
            int intrinsicWidth = r6 == 0 ? loadDrawable.getIntrinsicWidth() : r6;
            if (r6 == 0) {
                r6 = loadDrawable.getIntrinsicHeight();
            }
            Bitmap createBitmap = Bitmap.createBitmap(intrinsicWidth, r6, Bitmap.Config.ARGB_8888);
            loadDrawable.setBounds(0, 0, intrinsicWidth, r6);
            if (r5 != 0) {
                loadDrawable.mutate().setColorFilter(new PorterDuffColorFilter(r5, PorterDuff.Mode.SRC_IN));
            }
        ...
        private Bitmap createIconWithBackground(int r3, int r4, int r5, int r6) {
            int r0 = C0264R.C0266drawable.notification_icon_background;
            if (r6 == 0) {
                r6 = 0;
            }
            Bitmap createColoredBitmap = createColoredBitmap(r0, r6, r4);
            Canvas canvas = new Canvas(createColoredBitmap);
            Drawable mutate = this.mBuilder.mContext.getResources().getDrawable(r3).mutate();
            mutate.setFilterBitmap(true);
            int r42 = (r4 - r5) / 2;
            int r52 = r5 + r42;
            mutate.setBounds(r42, r42, r52, r52);
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0264R.C0267id.notification_main_column);
            remoteViews.addView(C0264R.C0267id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0264R.C0267id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0264R.C0267id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0264R.C0267id.title, 8);
            remoteViews.setViewVisibility(C0264R.C0267id.text2, 8);
            remoteViews.setViewVisibility(C0264R.C0267id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0264R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0264R.dimen.notification_top_pad_large_text);
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            int r3 = z ? ViewCompat.MEASURED_STATE_MASK : -1;
            ...
            spannableStringBuilder.setSpan(makeFontColorSpan(r3), spannableStringBuilder.length() - unicodeWrap.length(), spannableStringBuilder.length(), 33);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            boolean z2 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0264R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0264R.C0267id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int r4 = 0; r4 < min; r4++) {
                    applyStandardTemplate.addView(C0264R.C0267id.actions, generateActionButton(nonContextualActions.get(r4)));
                }
            }
            int r2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0264R.C0267id.actions, r2);
            applyStandardTemplate.setViewVisibility(C0264R.C0267id.action_divider, r2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                r3 = C0264R.layout.notification_action_tombstone;
            } else {
                r3 = C0264R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, r3);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0264R.C0267id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0264R.C0265color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0264R.C0267id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0264R.C0267id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0264R.C0267id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    public static class Action {
        ...
        public Action(int r3, CharSequence charSequence, PendingIntent pendingIntent) {
            this(r3 != 0 ? IconCompat.createWithResource(null, "", r3) : null, charSequence, pendingIntent);
        }
        ...
        public Action(int r14, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z, int r21, boolean z2, boolean z3) {
            this(r14 != 0 ? IconCompat.createWithResource(null, "", r14) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z, r21, z2, z3);
        }

        Action(IconCompat iconCompat, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z, int r10, boolean z2, boolean z3) {
        ...
        public IconCompat getIconCompat() {
            int r0;
            if (this.mIcon == null && (r0 = this.icon) != 0) {
                this.mIcon = IconCompat.createWithResource(null, "", r0);
            }
            return this.mIcon;
        }
        ...
        public static final class Builder {
            ...
            public Builder(int r12, CharSequence charSequence, PendingIntent pendingIntent) {
                this(r12 != 0 ? IconCompat.createWithResource(null, "", r12) : null, charSequence, pendingIntent, new Bundle(), null, true, 0, true, false);
            }
            ...
            private Builder(IconCompat iconCompat, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, boolean z, int r8, boolean z2, boolean z3) {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m1435clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m1436clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static final class CarExtender implements Extender {
            ...
            if (parcelableArray != null) {
                ...
                for (int r7 = 0; r7 < length; r7++) {
                    if (parcelableArray[r7] instanceof Bundle) {
                        strArr2[r7] = ((Bundle) parcelableArray[r7]).getString("text");
                        if (strArr2[r7] != null) {
                        }
                    }
                    z = false;
        ...
        private static Bundle getBundleForUnreadConversation(UnreadConversation unreadConversation) {
            ...
            for (int r2 = 0; r2 < length; r2++) {
                ...
                bundle2.putString("text", unreadConversation.getMessages()[r2]);
    ...
    public static final class BubbleMetadata {
        ...
        private BubbleMetadata(PendingIntent pendingIntent, PendingIntent pendingIntent2, IconCompat iconCompat, int r4, int r5, int r6, String str) {
            this.mPendingIntent = pendingIntent;
            this.mIcon = iconCompat;
            this.mDesiredHeight = r4;
            this.mDesiredHeightResId = r5;
        ...
        public static final class Builder {
            ...
            public Builder setDesiredHeight(int r2) {
                this.mDesiredHeight = Math.max(r2, 0);
                this.mDesiredHeightResId = 0;
                return this;
            }

            public Builder setDesiredHeightResId(int r1) {
                this.mDesiredHeightResId = r1;
            ...
            private Builder setFlag(int r1, boolean z) {
                if (z) {
                    this.mFlags = r1 | this.mFlags;
                } else {
                    this.mFlags = (~r1) & this.mFlags;
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            r1 = action.getSemanticAction();
        } else {
            r1 = action.getExtras().getInt("android.support.action.semanticAction", 0);
        }
        int r15 = r1;
        boolean isContextual = Build.VERSION.SDK_INT >= 29 ? action.isContextual() : false;
        if (Build.VERSION.SDK_INT >= 23) {
            if (action.getIcon() == null && action.icon != 0) {
                return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, r15, z3, isContextual);
            }
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, r15, z3, isContextual);
        }
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, r15, z3, isContextual);
    }
    ...
    public static List<Action> getInvisibleActions(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 19 && (bundle = notification.extras.getBundle("android.car.EXTENSIONS")) != null && (bundle2 = bundle.getBundle("invisible_actions")) != null) {
            for (int r1 = 0; r1 < bundle2.size(); r1++) {
                arrayList.add(NotificationCompatJellybean.getActionFromBundle(bundle2.getBundle(Integer.toString(r1))));
            }
        }
        return arrayList;
    }
