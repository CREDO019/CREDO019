...
public final class AppOpsManagerCompat {
    ...
    public static int checkOrNoteProxyOp(Context context, int r3, String str, String str2) {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            return checkOpNoThrow != 0 ? checkOpNoThrow : Api29Impl.checkOpNoThrow(systemService, str, r3, Api29Impl.getOpPackageName(context));
        }
    ...
    static class Api29Impl {
        ...
        static int checkOpNoThrow(AppOpsManager appOpsManager, String str, int r2, String str2) {
