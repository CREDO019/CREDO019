...
public class NotificationChannelCompat {
    ...
    public static class Builder {
        ...
        public Builder(String str, int r3) {
            this.mChannel = new NotificationChannelCompat(str, r3);
        }
        ...
        public Builder setImportance(int r2) {
            this.mChannel.mImportance = r2;
            return this;
        }
        ...
        public Builder setLightColor(int r2) {
            this.mChannel.mLightColor = r2;
            return this;
        }
    ...
    NotificationChannelCompat(String str, int r3) {
