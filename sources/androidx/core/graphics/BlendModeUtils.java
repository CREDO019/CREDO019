...
class BlendModeUtils {
    ...
    static /* synthetic */ class C02831 {
        ...
        static {
            int[] r0 = new int[BlendModeCompat.values().length];
            $SwitchMap$androidx$core$graphics$BlendModeCompat = r0;
            try {
                r0[BlendModeCompat.CLEAR.ordinal()] = 1;
    ...
    public static BlendMode obtainBlendModeFromCompat(BlendModeCompat blendModeCompat) {
        switch (C02831.$SwitchMap$androidx$core$graphics$BlendModeCompat[blendModeCompat.ordinal()]) {
            case 1:
