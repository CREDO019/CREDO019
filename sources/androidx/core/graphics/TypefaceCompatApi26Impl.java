...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    private boolean addFontFromAssetManager(Context context, Object obj, String str, int r7, int r8, int r9, FontVariationAxis[] fontVariationAxisArr) {
        try {
            return ((Boolean) this.mAddFontFromAssetManager.invoke(obj, context.getAssets(), str, 0, false, Integer.valueOf(r7), Integer.valueOf(r8), Integer.valueOf(r9), fontVariationAxisArr)).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }

    private boolean addFontFromBuffer(Object obj, ByteBuffer byteBuffer, int r6, int r7, int r8) {
        try {
            return ((Boolean) this.mAddFontFromBuffer.invoke(obj, byteBuffer, Integer.valueOf(r6), null, Integer.valueOf(r7), Integer.valueOf(r8))).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int r14) {
    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fontInfoArr, int r14) {
        ...
        if (!isFontFamilyPrivateAPIAvailable()) {
            FontsContractCompat.FontInfo findBestInfo = findBestInfo(fontInfoArr, r14);
            try {
        ...
        if (!z) {
            ...
            return Typeface.create(createFromFamiliesWithDefault, r14);
        } else {
            return null;
        }
    }
    ...
    public Typeface createFromResourcesFontFile(Context context, Resources resources, int r11, String str, int r13) {
        if (!isFontFamilyPrivateAPIAvailable()) {
