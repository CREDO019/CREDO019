...
public final class LongSparseArray {
    ...
    public static final <T> void forEach(android.util.LongSparseArray<T> longSparseArray, Function2<? super Long, ? super T, Unit> action) {
        ...
        while (true) {
            int r2 = r1 + 1;
            action.invoke(Long.valueOf(longSparseArray.keyAt(r1)), longSparseArray.valueAt(r1));
            if (r2 >= size) {
                return;
            }
            r1 = r2;
    ...
    public static final <T> LongIterator keyIterator(final android.util.LongSparseArray<T> longSparseArray) {
        ...
        return new LongIterator() { // from class: androidx.core.util.LongSparseArrayKt$keyIterator$1
            ...
            public long nextLong() {
                ...
                int r1 = this.index;
                this.index = r1 + 1;
                return longSparseArray2.keyAt(r1);
            }
        };
    }
    ...
    public static final <T> void putAll(android.util.LongSparseArray<T> longSparseArray, android.util.LongSparseArray<T> other) {
        ...
        while (true) {
            int r2 = r1 + 1;
            longSparseArray.put(other.keyAt(r1), other.valueAt(r1));
            if (r2 >= size) {
                return;
            }
            r1 = r2;
