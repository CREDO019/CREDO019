...
public final class SparseArrayKt {
    ...
    public static final <T> boolean contains(SparseArray<T> sparseArray, int r2) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        return sparseArray.indexOfKey(r2) >= 0;
    }

    public static final <T> void set(SparseArray<T> sparseArray, int r2, T t) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        sparseArray.put(r2, t);
    }
    ...
    public static final <T> boolean containsKey(SparseArray<T> sparseArray, int r2) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        return sparseArray.indexOfKey(r2) >= 0;
    }
    ...
    public static final <T> T getOrDefault(SparseArray<T> sparseArray, int r2, T t) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        T t2 = sparseArray.get(r2);
        return t2 == null ? t : t2;
    }

    public static final <T> T getOrElse(SparseArray<T> sparseArray, int r2, Functions<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        T t = sparseArray.get(r2);
    ...
    public static final <T> boolean remove(SparseArray<T> sparseArray, int r2, T t) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        int indexOfKey = sparseArray.indexOfKey(r2);
    ...
    public static final <T> void forEach(SparseArray<T> sparseArray, Function2<? super Integer, ? super T, Unit> action) {
        ...
        while (true) {
            int r2 = r1 + 1;
            action.invoke(Integer.valueOf(sparseArray.keyAt(r1)), sparseArray.valueAt(r1));
            if (r2 >= size) {
                return;
            }
            r1 = r2;
    ...
    public static final <T> void putAll(SparseArray<T> sparseArray, SparseArray<T> other) {
        ...
        while (true) {
            int r2 = r1 + 1;
            sparseArray.put(other.keyAt(r1), other.valueAt(r1));
            if (r2 >= size) {
                return;
            }
            r1 = r2;
