...
public class FingerprintManagerCompat {
    ...
    public void authenticate(CryptoObject cryptoObject, int r9, CancellationSignal cancellationSignal, AuthenticationCallback authenticationCallback, Handler handler) {
        FingerprintManager fingerprintManagerOrNull;
        if (Build.VERSION.SDK_INT < 23 || (fingerprintManagerOrNull = getFingerprintManagerOrNull(this.mContext)) == null) {
            return;
        }
        fingerprintManagerOrNull.authenticate(wrapCryptoObject(cryptoObject), cancellationSignal != null ? (android.os.CancellationSignal) cancellationSignal.getCancellationSignalObject() : null, r9, wrapCallback(authenticationCallback), handler);
    }
    ...
    private static FingerprintManager.AuthenticationCallback wrapCallback(final AuthenticationCallback authenticationCallback) {
        return new FingerprintManager.AuthenticationCallback() { // from class: androidx.core.hardware.fingerprint.FingerprintManagerCompat.1
            ...
            public void onAuthenticationError(int r2, CharSequence charSequence) {
                AuthenticationCallback.this.onAuthenticationError(r2, charSequence);
            }

            @Override // android.hardware.fingerprint.FingerprintManager.AuthenticationCallback
            public void onAuthenticationHelp(int r2, CharSequence charSequence) {
                AuthenticationCallback.this.onAuthenticationHelp(r2, charSequence);
            }
