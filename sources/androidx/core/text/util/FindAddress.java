...
class FindAddress {
    ...
    /* renamed from: NL */
    private static final String f32NL = "\n\u000b\f\r\u0085\u2028\u2029";

    /* renamed from: SP */
    private static final String f33SP = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000";
    private static final String WORD_DELIM = ",*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    private static final String WORD_END = "(?=[,*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029]|$)";

    /* renamed from: WS */
    private static final String f34WS = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    ...
    public static MatchResult matchHouseNumber(String str, int r4) {
        if (r4 <= 0 || HOUSE_PRE_DELIM.indexOf(str.charAt(r4 - 1)) != -1) {
            Matcher region = sHouseNumberRe.matcher(str).region(r4, str.length());
            if (region.lookingAt()) {
    ...
    public static MatchResult matchState(String str, int r4) {
        if (r4 <= 0 || WORD_DELIM.indexOf(str.charAt(r4 - 1)) != -1) {
            Matcher region = sStateRe.matcher(str).region(r4, str.length());
            if (region.lookingAt()) {
