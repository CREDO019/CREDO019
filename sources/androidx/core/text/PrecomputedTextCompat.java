...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int r5, int r6) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = new PrecomputedText.Params.Builder(textPaint).setBreakStrategy(r5).setHyphenationFrequency(r6).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
    ...
    public void setSpan(Object obj, int r4, int r5, int r6) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            this.mWrapped.setSpan(obj, r4, r5, r6);
        } else {
            this.mText.setSpan(obj, r4, r5, r6);
        }
    }
    ...
    public <T> T[] getSpans(int r3, int r4, Class<T> cls) {
        if (Build.VERSION.SDK_INT >= 29) {
            return (T[]) this.mWrapped.getSpans(r3, r4, cls);
        }
        return (T[]) this.mText.getSpans(r3, r4, cls);
    }
    ...
    public int nextSpanTransition(int r2, int r3, Class cls) {
        return this.mText.nextSpanTransition(r2, r3, cls);
    }
