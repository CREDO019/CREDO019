...
final class CamUtils {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static float lStarFromInt(int r0) {
        return lStarFromY(yFromInt(r0));
    }
    ...
    static float yFromInt(int r6) {
        float linearized = linearized(Color.red(r6));
        float linearized2 = linearized(Color.green(r6));
        float linearized3 = linearized(Color.blue(r6));
        float[][] fArr = SRGB_TO_XYZ;
        return (linearized * fArr[1][0]) + (linearized2 * fArr[1][1]) + (linearized3 * fArr[1][2]);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static float[] xyzFromInt(int r9) {
        float linearized = linearized(Color.red(r9));
        float linearized2 = linearized(Color.green(r9));
        float linearized3 = linearized(Color.blue(r9));
        float[][] fArr = SRGB_TO_XYZ;
