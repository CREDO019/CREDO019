...
public class CamColor {
    ...
    /* renamed from: mJ */
    private final float f23mJ;
    private final float mJstar;

    /* renamed from: mM */
    private final float f24mM;

    /* renamed from: mQ */
    private final float f25mQ;

    /* renamed from: mS */
    private final float f26mS;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static CamColor fromColor(int r1) {
        return fromColorInViewingConditions(r1, ViewingConditions.DEFAULT);
    }

    static CamColor fromColorInViewingConditions(int r23, ViewingConditions viewingConditions) {
        float pow;
        float[] xyzFromInt = CamUtils.xyzFromInt(r23);
