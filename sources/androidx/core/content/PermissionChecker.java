...
public final class PermissionChecker {
    ...
    public static int checkPermission(Context context, String str, int r4, int r5, String str2) {
        int noteProxyOpNoThrow;
        if (context.checkPermission(str, r4, r5) == -1) {
            return -1;
        }
        ...
        if (str2 == null) {
            String[] packagesForUid = context.getPackageManager().getPackagesForUid(r5);
            if (packagesForUid == null || packagesForUid.length <= 0) {
                return -1;
            }
            str2 = packagesForUid[0];
        }
        if (Process.myUid() == r5 && ObjectsCompat.equals(context.getPackageName(), str2)) {
            noteProxyOpNoThrow = AppOpsManagerCompat.checkOrNoteProxyOp(context, r5, permissionToOp, str2);
        } else {
