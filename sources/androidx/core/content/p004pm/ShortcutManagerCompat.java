...
public class ShortcutManagerCompat {
    ...
    */
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int r4) {
        if (Build.VERSION.SDK_INT >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, ((ShortcutManager) context.getSystemService(ShortcutManager.class)).getShortcuts(r4));
        }
    ...
    static boolean convertUriIconToBitmapIcon(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        int r0 = shortcutInfoCompat.mIcon.mType;
        if (r0 == 6 || r0 == 4) {
    ...
    private static String getShortcutInfoCompatWithLowestRank(List<ShortcutInfoCompat> list) {
        ...
        String str = null;
        for (ShortcutInfoCompat shortcutInfoCompat : list) {
            if (shortcutInfoCompat.getRank() > r0) {
                str = shortcutInfoCompat.getId();
                r0 = shortcutInfoCompat.getRank();
            }
        }
        return str;
    }
    ...
    private static class Api25Impl {
        ...
        static String getShortcutInfoWithLowestRank(List<ShortcutInfo> list) {
            ...
            for (ShortcutInfo shortcutInfo : list) {
                if (shortcutInfo.getRank() > r0) {
                    str = shortcutInfo.getId();
                    r0 = shortcutInfo.getRank();
                }
            }
            return str;
        }
