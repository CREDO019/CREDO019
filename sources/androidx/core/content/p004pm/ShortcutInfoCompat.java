...
public class ShortcutInfoCompat {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (personArr != null && personArr.length > 0) {
                ...
                for (int r3 = 0; r3 < length; r3++) {
                    personArr2[r3] = this.mPersons[r3].toAndroidPerson();
                }
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            int r0 = 0;
            while (r0 < this.mPersons.length) {
                PersistableBundle persistableBundle = this.mExtras;
                StringBuilder sb = new StringBuilder();
                sb.append(EXTRA_PERSON_);
                int r3 = r0 + 1;
                sb.append(r3);
                persistableBundle.putPersistableBundle(sb.toString(), this.mPersons[r0].toPersistableBundle());
                r0 = r3;
            }
        }
        LocusIdCompat locusIdCompat = this.mLocusId;
