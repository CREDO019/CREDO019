...
public class ContextCompat {
    ...
    public static Drawable getDrawable(Context context, int r5) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            return Api21Impl.getDrawable(context, r5);
        }
        if (Build.VERSION.SDK_INT >= 16) {
    ...
    public static ColorStateList getColorStateList(Context context, int r2) {
        return ResourcesCompat.getColorStateList(context.getResources(), r2, context.getTheme());
    }

    public static int getColor(Context context, int r3) {
        if (Build.VERSION.SDK_INT >= 23) {
            return Api23Impl.getColor(context, r3);
        }
    ...
    static class Api21Impl {
        ...
        static Drawable getDrawable(Context context, int r1) {
    ...
    public static class Api23Impl {
        ...
        static int getColor(Context context, int r1) {
