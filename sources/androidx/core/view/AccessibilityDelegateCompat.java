...
public class AccessibilityDelegateCompat {
    ...
    public static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            for (int r4 = 0; r4 < actionList.size(); r4++) {
                wrap.addAction(actionList.get(r4));
            }
        }
    ...
    public boolean performAccessibilityAction(View view, int r7, Bundle bundle) {
        ...
        if (!z && Build.VERSION.SDK_INT >= 16) {
            z = this.mOriginalDelegate.performAccessibilityAction(view, r7, bundle);
        }
        return (z || r7 != C0264R.C0267id.accessibility_action_clickable_span) ? z : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }

    private boolean performClickableSpanAction(int r2, View view) {
        WeakReference weakReference;
        SparseArray sparseArray = (SparseArray) view.getTag(C0264R.C0267id.tag_accessibility_clickable_spans);
    ...
    private boolean isSpanStillValid(ClickableSpan clickableSpan, View view) {
        if (clickableSpan != null) {
            ...
            for (int r1 = 0; clickableSpans != null && r1 < clickableSpans.length; r1++) {
                if (clickableSpan.equals(clickableSpans[r1])) {
                    return true;
                }
            }
        }
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> list = (List) view.getTag(C0264R.C0267id.tag_accessibility_actions);
