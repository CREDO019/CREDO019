...
public final class InputConnectionCompat {
    ...
    static boolean handlePerformPrivateCommand(String str, Bundle bundle, OnCommitContentListener onCommitContentListener) {
        ...
        try {
            ...
            if (uri != null && clipDescription != null) {
                r0 = onCommitContentListener.onCommitContent(new InputContentInfoCompat(uri, clipDescription, uri2), r6, bundle2);
            }
            if (resultReceiver != 0) {
    ...
    public static boolean commitContent(InputConnection inputConnection, EditorInfo editorInfo, InputContentInfoCompat inputContentInfoCompat, int r10, Bundle bundle) {
        ...
        while (true) {
            if (r4 >= length) {
                z = false;
                break;
            } else if (description.hasMimeType(contentMimeTypes[r4])) {
                z = true;
                break;
            } else {
                r4++;
    ...
    private static OnCommitContentListener createOnCommitContentListenerUsingPerformReceiveContent(final View view) {
        ...
        return new OnCommitContentListener() { // from class: androidx.core.view.inputmethod.InputConnectionCompat.3
            ...
            public boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int r7, Bundle bundle) {
                if (Build.VERSION.SDK_INT >= 25 && (r7 & 1) != 0) {
                    try {
