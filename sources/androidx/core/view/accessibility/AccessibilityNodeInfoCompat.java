...
public class AccessibilityNodeInfoCompat {
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public Region getRegionAt(int r3) {
            if (Build.VERSION.SDK_INT >= 29) {
                return this.mInfo.getRegionAt(r3);
            }
            return null;
        }
    ...
    public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String str) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            arrayList.add(wrap(findAccessibilityNodeInfosByText.get(r2)));
        }
        return arrayList;
    }
    ...
    public CharSequence getText() {
        if (hasSpans()) {
            ...
            for (int r7 = 0; r7 < extrasIntList.size(); r7++) {
                spannableString.setSpan(new AccessibilityClickableSpanCompat(extrasIntList4.get(r7).intValue(), this, getExtras().getInt(SPANS_ACTION_ID_KEY)), extrasIntList.get(r7).intValue(), extrasIntList2.get(r7).intValue(), extrasIntList3.get(r7).intValue());
            }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        ...
        getExtras().putInt(SPANS_ACTION_ID_KEY, C0264R.C0267id.accessibility_action_clickable_span);
        SparseArray<WeakReference<ClickableSpan>> orCreateSpansFromViewTags = getOrCreateSpansFromViewTags(view);
        for (int r1 = 0; clickableSpans != null && r1 < clickableSpans.length; r1++) {
            int idForClickableSpan = idForClickableSpan(clickableSpans[r1], orCreateSpansFromViewTags);
            orCreateSpansFromViewTags.put(idForClickableSpan, new WeakReference<>(clickableSpans[r1]));
            addSpanLocationToExtras(clickableSpans[r1], (Spanned) charSequence, idForClickableSpan);
        }
    }
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        if (spansFromViewTags == null) {
            ...
            view.setTag(C0264R.C0267id.tag_accessibility_clickable_spans, sparseArray);
            return sparseArray;
        }
    ...
    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C0264R.C0267id.tag_accessibility_clickable_spans);
    }
    ...
    private int idForClickableSpan(ClickableSpan clickableSpan, SparseArray<WeakReference<ClickableSpan>> sparseArray) {
        ...
        int r3 = sClickableSpanId;
        sClickableSpanId = r3 + 1;
        return r3;
    }
    ...
    private void removeCollectedSpans(View view) {
        ...
        if (spansFromViewTags != null) {
            ArrayList arrayList = new ArrayList();
            for (int r2 = 0; r2 < spansFromViewTags.size(); r2++) {
                if (spansFromViewTags.valueAt(r2).get() == null) {
                    arrayList.add(Integer.valueOf(r2));
                }
            }
            for (int r1 = 0; r1 < arrayList.size(); r1++) {
                spansFromViewTags.remove(((Integer) arrayList.get(r1)).intValue());
            }
        }
    }
    ...
    public List<AccessibilityActionCompat> getActionList() {
        ...
        if (actionList != null) {
            ...
            for (int r3 = 0; r3 < size; r3++) {
                arrayList.add(new AccessibilityActionCompat(actionList.get(r3)));
            }
            return arrayList;
        }
    ...
    public String toString() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            for (int r4 = 0; r4 < actionList.size(); r4++) {
                AccessibilityActionCompat accessibilityActionCompat = actionList.get(r4);
                String actionSymbolicName = getActionSymbolicName(accessibilityActionCompat.getId());
                if (actionSymbolicName.equals("ACTION_UNKNOWN") && accessibilityActionCompat.getLabel() != null) {
                    actionSymbolicName = accessibilityActionCompat.getLabel().toString();
                }
                sb.append(actionSymbolicName);
                if (r4 != actionList.size() - 1) {
                    sb.append(", ");
                }
            }
        } else {
    ...
    private void setBooleanProperty(int r6, boolean z) {
        Bundle extras = getExtras();
        if (extras != null) {
            int r3 = extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~r6);
            if (!z) {
                r6 = 0;
            }
            extras.putInt(BOOLEAN_PROPERTY_KEY, r6 | r3);
        }
    }

    private boolean getBooleanProperty(int r4) {
        Bundle extras = getExtras();
        return extras != null && (extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & r4) == r4;
    }
}
