...
public final class ContentInfoCompat {
    ...
    static String sourceToString(int r1) {
        return r1 != 0 ? r1 != 1 ? r1 != 2 ? r1 != 3 ? r1 != 4 ? r1 != 5 ? String.valueOf(r1) : "SOURCE_PROCESS_TEXT" : "SOURCE_AUTOFILL" : "SOURCE_DRAG_AND_DROP" : "SOURCE_INPUT_METHOD" : "SOURCE_CLIPBOARD" : "SOURCE_APP";
    }

    static String flagsToString(int r1) {
        return (r1 & 1) != 0 ? "FLAG_CONVERT_TO_PLAIN_TEXT" : String.valueOf(r1);
    }
    ...
    static Pair<ClipData, ClipData> partition(ClipData clipData, Predicate<ClipData.Item> predicate) {
        ...
        for (int r1 = 0; r1 < clipData.getItemCount(); r1++) {
    ...
    public static final class Builder {
        ...
        public Builder(ClipData clipData, int r4) {
            if (Build.VERSION.SDK_INT >= 31) {
                this.mBuilderCompat = new BuilderCompat31Impl(clipData, r4);
            } else {
                this.mBuilderCompat = new BuilderCompatImpl(clipData, r4);
            }
        }
        ...
        public Builder setSource(int r2) {
            this.mBuilderCompat.setSource(r2);
            return this;
        }

        public Builder setFlags(int r2) {
            this.mBuilderCompat.setFlags(r2);
            return this;
        }
    ...
    private static final class BuilderCompatImpl implements BuilderCompat {
        ...
        BuilderCompatImpl(ClipData clipData, int r2) {
            this.mClip = clipData;
            this.mSource = r2;
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ClipData clipData, int r3) {
            this.mPlatformBuilder = new ContentInfo.Builder(clipData, r3);
        }
        ...
        public void setSource(int r2) {
            this.mPlatformBuilder.setSource(r2);
        }
