...
public class FontsContractCompat {
    ...
    public static Typeface requestFont(Context context, FontRequest fontRequest, int r3, boolean z, int r5, Handler handler, FontRequestCallback fontRequestCallback) {
        CallbackWithHandler callbackWithHandler = new CallbackWithHandler(fontRequestCallback, handler);
        if (z) {
            return FontRequestWorker.requestFontSync(context, fontRequest, callbackWithHandler, r3, r5);
        }
        return FontRequestWorker.requestFontAsync(context, fontRequest, r3, null, callbackWithHandler);
    }
    ...
    public static class FontInfo {
        ...
        public static FontInfo create(Uri uri, int r8, int r9, boolean z, int r11) {
            return new FontInfo(uri, r8, r9, z, r11);
        }
    ...
    public static class FontFamilyResult {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static FontFamilyResult create(int r1, FontInfo[] fontInfoArr) {
            return new FontFamilyResult(r1, fontInfoArr);
        }
    }

    @Deprecated
    public static Typeface getFontSync(Context context, FontRequest fontRequest, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z, int r12, int r13) {
        return requestFont(context, fontRequest, r13, z, r12, ResourcesCompat.FontCallback.getHandler(handler), new TypefaceCompat.ResourcesCallbackAdapter(fontCallback));
    }
