...
public final class TraceCompat {
    ...
    public static void beginAsyncSection(String str, int r7) {
        if (Build.VERSION.SDK_INT >= 29) {
            Trace.beginAsyncSection(str, r7);
        } else if (Build.VERSION.SDK_INT >= 18) {
            try {
                sAsyncTraceBeginMethod.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(r7));
            } catch (Exception unused) {
    ...
    public static void endAsyncSection(String str, int r7) {
        if (Build.VERSION.SDK_INT >= 29) {
            Trace.endAsyncSection(str, r7);
        } else if (Build.VERSION.SDK_INT >= 18) {
            try {
                sAsyncTraceEndMethod.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(r7));
            } catch (Exception unused) {
    ...
    public static void setCounter(String str, int r7) {
        if (Build.VERSION.SDK_INT >= 29) {
            Trace.setCounter(str, r7);
        } else if (Build.VERSION.SDK_INT >= 18) {
            try {
                sTraceCounterMethod.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(r7));
            } catch (Exception unused) {
