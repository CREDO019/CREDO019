    ...
    public static LocaleListCompat forLanguageTags(String str) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            if (Build.VERSION.SDK_INT >= 21) {
                forLanguageTagCompat = Locale.forLanguageTag(split[r2]);
            } else {
                forLanguageTagCompat = forLanguageTagCompat(split[r2]);
            }
            localeArr[r2] = forLanguageTagCompat;
        }
