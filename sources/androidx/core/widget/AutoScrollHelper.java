...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    */
    ...
    private float computeTargetVelocity(int r4, float f, float f2, float f3) {
        float edgeValue = getEdgeValue(this.mRelativeEdges[r4], f2, this.mMaximumEdges[r4], f);
        int r0 = (edgeValue > 0.0f ? 1 : (edgeValue == 0.0f ? 0 : -1));
        if (r0 == 0) {
            return 0.0f;
        }
        float f4 = this.mRelativeVelocity[r4];
        float f5 = this.mMinimumVelocity[r4];
        float f6 = this.mMaximumVelocity[r4];
        float f7 = f4 * f3;
        if (r0 > 0) {
