...
public class ReactNativeEventEmitter {
    ...
    public void attachReactContext(final ReactContext reactContext) {
        this.handler.post(new Runnable() { // from class: io.invertase.googlemobileads.common.ReactNativeEventEmitter$$ExternalSyntheticLambda1
            ...
            public final void run() {
                ReactNativeEventEmitter.this.m199x5484ff51(reactContext);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$attachReactContext$0$io-invertase-googlemobileads-common-ReactNativeEventEmitter */
    public /* synthetic */ void m199x5484ff51(ReactContext reactContext) {
    ...
    public void notifyJsReady(final Boolean bool) {
        this.handler.post(new Runnable() { // from class: io.invertase.googlemobileads.common.ReactNativeEventEmitter$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ReactNativeEventEmitter.this.m198x7c6a1a74(bool);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$notifyJsReady$1$io-invertase-googlemobileads-common-ReactNativeEventEmitter */
    public /* synthetic */ void m198x7c6a1a74(Boolean bool) {
        this.jsReady = bool;
        sendQueuedEvents();
    }
    ...
    public void sendEvent(final NativeEvent nativeEvent) {
        this.handler.post(new Runnable() { // from class: io.invertase.googlemobileads.common.ReactNativeEventEmitter$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ReactNativeEventEmitter.this.m197x8b676a56(nativeEvent);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$sendEvent$2$io-invertase-googlemobileads-common-ReactNativeEventEmitter */
    public /* synthetic */ void m197x8b676a56(NativeEvent nativeEvent) {
    ...
    */
    public void removeListener(java.lang.String r6, java.lang.Boolean r7) {
        ...
        L41:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: io.invertase.googlemobileads.common.ReactNativeEventEmitter.removeListener(java.lang.String, java.lang.Boolean):void");
    }
