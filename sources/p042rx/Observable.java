...
import p042rx.BackpressureOverflow;
...
import p042rx.internal.operators.CachedObservable;
import p042rx.internal.operators.EmptyObservableHolder;
import p042rx.internal.operators.NeverObservableHolder;
import p042rx.internal.operators.OnSubscribeAmb;
import p042rx.internal.operators.OnSubscribeCollect;
import p042rx.internal.operators.OnSubscribeCombineLatest;
import p042rx.internal.operators.OnSubscribeConcatMap;
import p042rx.internal.operators.OnSubscribeCreate;
import p042rx.internal.operators.OnSubscribeDefer;
import p042rx.internal.operators.OnSubscribeDelaySubscription;
import p042rx.internal.operators.OnSubscribeDelaySubscriptionOther;
import p042rx.internal.operators.OnSubscribeDelaySubscriptionWithSelector;
import p042rx.internal.operators.OnSubscribeDetach;
import p042rx.internal.operators.OnSubscribeDoOnEach;
import p042rx.internal.operators.OnSubscribeFilter;
import p042rx.internal.operators.OnSubscribeFlatMapCompletable;
import p042rx.internal.operators.OnSubscribeFlatMapSingle;
import p042rx.internal.operators.OnSubscribeFlattenIterable;
import p042rx.internal.operators.OnSubscribeFromArray;
import p042rx.internal.operators.OnSubscribeFromCallable;
import p042rx.internal.operators.OnSubscribeFromIterable;
import p042rx.internal.operators.OnSubscribeGroupJoin;
import p042rx.internal.operators.OnSubscribeJoin;
import p042rx.internal.operators.OnSubscribeLift;
import p042rx.internal.operators.OnSubscribeMap;
import p042rx.internal.operators.OnSubscribeRange;
import p042rx.internal.operators.OnSubscribeRedo;
import p042rx.internal.operators.OnSubscribeReduce;
import p042rx.internal.operators.OnSubscribeReduceSeed;
import p042rx.internal.operators.OnSubscribeSingle;
import p042rx.internal.operators.OnSubscribeSkipTimed;
import p042rx.internal.operators.OnSubscribeSwitchIfEmpty;
import p042rx.internal.operators.OnSubscribeTakeLastOne;
import p042rx.internal.operators.OnSubscribeThrow;
import p042rx.internal.operators.OnSubscribeTimeoutSelectorWithFallback;
import p042rx.internal.operators.OnSubscribeTimeoutTimedWithFallback;
import p042rx.internal.operators.OnSubscribeTimerOnce;
import p042rx.internal.operators.OnSubscribeTimerPeriodically;
import p042rx.internal.operators.OnSubscribeToMap;
import p042rx.internal.operators.OnSubscribeToMultimap;
import p042rx.internal.operators.OnSubscribeToObservableFuture;
import p042rx.internal.operators.OnSubscribeUsing;
import p042rx.internal.operators.OperatorAll;
import p042rx.internal.operators.OperatorAny;
import p042rx.internal.operators.OperatorAsObservable;
import p042rx.internal.operators.OperatorBufferWithSingleObservable;
import p042rx.internal.operators.OperatorBufferWithSize;
import p042rx.internal.operators.OperatorBufferWithStartEndObservable;
import p042rx.internal.operators.OperatorBufferWithTime;
import p042rx.internal.operators.OperatorCast;
import p042rx.internal.operators.OperatorDebounceWithSelector;
import p042rx.internal.operators.OperatorDebounceWithTime;
import p042rx.internal.operators.OperatorDelay;
import p042rx.internal.operators.OperatorDelayWithSelector;
import p042rx.internal.operators.OperatorDematerialize;
import p042rx.internal.operators.OperatorDistinct;
import p042rx.internal.operators.OperatorDistinctUntilChanged;
import p042rx.internal.operators.OperatorDoAfterTerminate;
import p042rx.internal.operators.OperatorDoOnRequest;
import p042rx.internal.operators.OperatorDoOnSubscribe;
import p042rx.internal.operators.OperatorDoOnUnsubscribe;
import p042rx.internal.operators.OperatorEagerConcatMap;
import p042rx.internal.operators.OperatorElementAt;
import p042rx.internal.operators.OperatorGroupBy;
import p042rx.internal.operators.OperatorGroupByEvicting;
import p042rx.internal.operators.OperatorIgnoreElements;
import p042rx.internal.operators.OperatorMapNotification;
import p042rx.internal.operators.OperatorMapPair;
import p042rx.internal.operators.OperatorMaterialize;
import p042rx.internal.operators.OperatorMerge;
import p042rx.internal.operators.OperatorObserveOn;
import p042rx.internal.operators.OperatorOnBackpressureBuffer;
import p042rx.internal.operators.OperatorOnBackpressureDrop;
import p042rx.internal.operators.OperatorOnBackpressureLatest;
import p042rx.internal.operators.OperatorOnErrorResumeNextViaFunction;
import p042rx.internal.operators.OperatorPublish;
import p042rx.internal.operators.OperatorReplay;
import p042rx.internal.operators.OperatorRetryWithPredicate;
import p042rx.internal.operators.OperatorSampleWithObservable;
import p042rx.internal.operators.OperatorSampleWithTime;
import p042rx.internal.operators.OperatorScan;
import p042rx.internal.operators.OperatorSequenceEqual;
import p042rx.internal.operators.OperatorSerialize;
import p042rx.internal.operators.OperatorSingle;
import p042rx.internal.operators.OperatorSkip;
import p042rx.internal.operators.OperatorSkipLast;
import p042rx.internal.operators.OperatorSkipLastTimed;
import p042rx.internal.operators.OperatorSkipUntil;
import p042rx.internal.operators.OperatorSkipWhile;
import p042rx.internal.operators.OperatorSubscribeOn;
import p042rx.internal.operators.OperatorSwitch;
import p042rx.internal.operators.OperatorTake;
import p042rx.internal.operators.OperatorTakeLast;
import p042rx.internal.operators.OperatorTakeLastTimed;
import p042rx.internal.operators.OperatorTakeTimed;
import p042rx.internal.operators.OperatorTakeUntil;
import p042rx.internal.operators.OperatorTakeUntilPredicate;
import p042rx.internal.operators.OperatorTakeWhile;
import p042rx.internal.operators.OperatorThrottleFirst;
import p042rx.internal.operators.OperatorTimeInterval;
import p042rx.internal.operators.OperatorTimestamp;
import p042rx.internal.operators.OperatorToObservableList;
import p042rx.internal.operators.OperatorToObservableSortedList;
import p042rx.internal.operators.OperatorUnsubscribeOn;
import p042rx.internal.operators.OperatorWindowWithObservable;
import p042rx.internal.operators.OperatorWindowWithObservableFactory;
import p042rx.internal.operators.OperatorWindowWithSize;
import p042rx.internal.operators.OperatorWindowWithStartEndObservable;
import p042rx.internal.operators.OperatorWindowWithTime;
import p042rx.internal.operators.OperatorWithLatestFrom;
import p042rx.internal.operators.OperatorWithLatestFromMany;
import p042rx.internal.operators.OperatorZip;
import p042rx.internal.operators.OperatorZipIterable;
import p042rx.internal.util.ActionNotificationObserver;
import p042rx.internal.util.ActionObserver;
import p042rx.internal.util.ActionSubscriber;
import p042rx.internal.util.InternalObservableUtils;
import p042rx.internal.util.ObserverSubscriber;
...
import p042rx.observables.AsyncOnSubscribe;
import p042rx.observables.BlockingObservable;
...
public class Observable<T> {
    ...
    /* renamed from: to */
    public final <R> R m2to(Func1<? super Observable<T>, R> func1) {
    ...
    public static <T> Observable<T> merge(Iterable<? extends Observable<? extends T>> iterable, int r1) {
        return merge(from(iterable), r1);
    }
    ...
    public static <T> Observable<T> merge(Observable<? extends Observable<? extends T>> observable, int r3) {
        if (observable.getClass() == ScalarSynchronousObservable.class) {
            return ((ScalarSynchronousObservable) observable).scalarFlatMap(UtilityFunctions.identity());
        }
        return (Observable<T>) observable.lift(OperatorMerge.instance(false, r3));
    }
    ...
    public static <T> Observable<T> merge(Observable<? extends T>[] observableArr, int r1) {
        return merge(from(observableArr), r1);
    }
    ...
    public static <T> Observable<T> mergeDelayError(Observable<? extends Observable<? extends T>> observable, int r2) {
        return (Observable<T>) observable.lift(OperatorMerge.instance(true, r2));
    }
    ...
    public static <T> Observable<T> mergeDelayError(Iterable<? extends Observable<? extends T>> iterable, int r1) {
        return mergeDelayError(from(iterable), r1);
    }
    ...
    public static Observable<Integer> range(int r2, int r3) {
        if (r3 >= 0) {
            if (r3 == 0) {
                return empty();
            }
            if (r2 <= (Integer.MAX_VALUE - r3) + 1) {
                if (r3 == 1) {
                    return just(Integer.valueOf(r2));
                }
                return unsafeCreate(new OnSubscribeRange(r2, (r3 - 1) + r2));
            }
    ...
    public static Observable<Integer> range(int r0, int r1, Scheduler scheduler) {
        return range(r0, r1).subscribeOn(scheduler);
    }
    ...
    public final Observable<List<T>> buffer(int r1) {
        return buffer(r1, r1);
    }

    public final Observable<List<T>> buffer(int r2, int r3) {
        return (Observable<List<T>>) lift(new OperatorBufferWithSize(r2, r3));
    }
    ...
    public final Observable<List<T>> buffer(long j, TimeUnit timeUnit, int r13) {
        return (Observable<List<T>>) lift(new OperatorBufferWithTime(j, j, timeUnit, r13, Schedulers.computation()));
    }

    public final Observable<List<T>> buffer(long j, TimeUnit timeUnit, int r13, Scheduler scheduler) {
        return (Observable<List<T>>) lift(new OperatorBufferWithTime(j, j, timeUnit, r13, scheduler));
    }
    ...
    public final <B> Observable<List<T>> buffer(Observable<B> observable, int r3) {
        return (Observable<List<T>>) lift(new OperatorBufferWithSingleObservable(observable, r3));
    }
    ...
    @Deprecated
    public final Observable<T> cache(int r1) {
        return cacheWithInitialCapacity(r1);
    }

    public final Observable<T> cacheWithInitialCapacity(int r1) {
        return CachedObservable.from(this, r1);
    }
    ...
    public static <T> Observable<T> concatEager(Iterable<? extends Observable<? extends T>> iterable, int r2) {
        return from(iterable).concatMapEager(UtilityFunctions.identity(), r2);
    }
    ...
    public static <T> Observable<T> concatEager(Observable<? extends Observable<? extends T>> observable, int r2) {
        return (Observable<T>) observable.concatMapEager(UtilityFunctions.identity(), r2);
    }
    ...
    public final <R> Observable<R> concatMapEager(Func1<? super T, ? extends Observable<? extends R>> func1, int r4) {
        if (r4 < 1) {
            throw new IllegalArgumentException("capacityHint > 0 required but it was " + r4);
        }
        return lift(new OperatorEagerConcatMap(func1, r4, Integer.MAX_VALUE));
    }

    public final <R> Observable<R> concatMapEager(Func1<? super T, ? extends Observable<? extends R>> func1, int r3, int r4) {
        if (r3 < 1) {
            throw new IllegalArgumentException("capacityHint > 0 required but it was " + r3);
        } else if (r4 < 1) {
            throw new IllegalArgumentException("maxConcurrent > 0 required but it was " + r3);
        } else {
            return lift(new OperatorEagerConcatMap(func1, r3, r4));
        }
    }

    public final Observable<T> elementAt(int r2) {
        return (Observable<T>) lift(new OperatorElementAt(r2));
    }

    public final Observable<T> elementAtOrDefault(int r2, T t) {
        return (Observable<T>) lift(new OperatorElementAt(r2, t));
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <R> Observable<R> flatMap(Func1<? super T, ? extends Observable<? extends R>> func1, int r4) {
        if (getClass() == ScalarSynchronousObservable.class) {
            return ((ScalarSynchronousObservable) this).scalarFlatMap(func1);
        }
        return merge(map(func1), r4);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <R> Observable<R> flatMap(Func1<? super T, ? extends Observable<? extends R>> func1, Func1<? super Throwable, ? extends Observable<? extends R>> func12, Func0<? extends Observable<? extends R>> func0, int r4) {
        return merge(mapNotification(func1, func12, func0), r4);
    }
    ...
    public final <U, R> Observable<R> flatMap(Func1<? super T, ? extends Observable<? extends U>> func1, Func2<? super T, ? super U, ? extends R> func2, int r4) {
        return merge(lift(new OperatorMapPair(func1, func2)), r4);
    }
    ...
    public final Observable<T> flatMapCompletable(Func1<? super T, ? extends Completable> func1, boolean z, int r4) {
        return unsafeCreate(new OnSubscribeFlatMapCompletable(this, func1, z, r4));
    }
    ...
    public final <R> Observable<R> flatMapIterable(Func1<? super T, ? extends Iterable<? extends R>> func1, int r2) {
        return OnSubscribeFlattenIterable.createFrom(this, func1, r2);
    }
    ...
    public final <U, R> Observable<R> flatMapIterable(Func1<? super T, ? extends Iterable<? extends U>> func1, Func2<? super T, ? super U, ? extends R> func2, int r3) {
        return flatMap(OperatorMapPair.convertSelector(func1), func2, r3);
    }
    ...
    public final <R> Observable<R> flatMapSingle(Func1<? super T, ? extends Single<? extends R>> func1, boolean z, int r4) {
        return unsafeCreate(new OnSubscribeFlatMapSingle(this, func1, z, r4));
    }
    ...
    public final <K, R> Observable<GroupedObservable<K, R>> groupBy(Func1<? super T, ? extends K> func1, Func1<? super T, ? extends R> func12, int r10, boolean z, Func1<Action1<Object>, Map<K, Object>> func13) {
        Objects.requireNonNull(func13, "evictingMapFactory cannot be null");
        return (Observable<R>) lift(new OperatorGroupByEvicting(func1, func12, r10, z, func13));
    }
    ...
    public final Observable<T> limit(int r1) {
        return take(r1);
    }
    ...
    public final Observable<T> observeOn(Scheduler scheduler, int r3) {
        return observeOn(scheduler, false, r3);
    }
    ...
    public final Observable<T> observeOn(Scheduler scheduler, boolean z, int r4) {
        if (this instanceof ScalarSynchronousObservable) {
            return ((ScalarSynchronousObservable) this).scalarScheduleOn(scheduler);
        }
        return (Observable<T>) lift(new OperatorObserveOn(scheduler, z, r4));
    }
    ...
    public final Observable<T> rebatchRequests(int r4) {
        if (r4 <= 0) {
            throw new IllegalArgumentException("n > 0 required but it was " + r4);
        }
        return (Observable<T>) lift(OperatorObserveOn.rebatch(r4));
    }
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, int r2) {
        return OperatorReplay.multicastSelector(InternalObservableUtils.createReplaySupplier(this, r2), func1);
    }

    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, int r9, long j, TimeUnit timeUnit) {
        return replay(func1, r9, j, timeUnit, Schedulers.computation());
    }

    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, int r8, long j, TimeUnit timeUnit, Scheduler scheduler) {
        if (r8 < 0) {
            throw new IllegalArgumentException("bufferSize < 0");
        }
        return OperatorReplay.multicastSelector(InternalObservableUtils.createReplaySupplier(this, r8, j, timeUnit, scheduler), func1);
    }

    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, int r2, Scheduler scheduler) {
        return OperatorReplay.multicastSelector(InternalObservableUtils.createReplaySupplier(this, r2), InternalObservableUtils.createReplaySelectorAndObserveOn(func1, scheduler));
    }
    ...
    public final ConnectableObservable<T> replay(int r1) {
        return OperatorReplay.create(this, r1);
    }

    public final ConnectableObservable<T> replay(int r7, long j, TimeUnit timeUnit) {
        return replay(r7, j, timeUnit, Schedulers.computation());
    }

    public final ConnectableObservable<T> replay(int r7, long j, TimeUnit timeUnit, Scheduler scheduler) {
        if (r7 < 0) {
            throw new IllegalArgumentException("bufferSize < 0");
        }
        return OperatorReplay.create(this, j, timeUnit, scheduler, r7);
    }

    public final ConnectableObservable<T> replay(int r1, Scheduler scheduler) {
        return OperatorReplay.observeOn(replay(r1), scheduler);
    }
    ...
    public final Observable<T> skip(int r2) {
        return (Observable<T>) lift(new OperatorSkip(r2));
    }
    ...
    public final Observable<T> skipLast(int r2) {
        return (Observable<T>) lift(new OperatorSkipLast(r2));
    }
    ...
    public final Observable<T> take(int r2) {
        return (Observable<T>) lift(new OperatorTake(r2));
    }
    ...
    public final Observable<T> takeLast(int r2) {
        if (r2 == 0) {
        ...
        return (Observable<T>) lift(new OperatorTakeLast(r2));
    }

    public final Observable<T> takeLast(int r7, long j, TimeUnit timeUnit) {
        return takeLast(r7, j, timeUnit, Schedulers.computation());
    }

    public final Observable<T> takeLast(int r8, long j, TimeUnit timeUnit, Scheduler scheduler) {
        return (Observable<T>) lift(new OperatorTakeLastTimed(r8, j, timeUnit, scheduler));
    }
    ...
    public final Observable<List<T>> takeLastBuffer(int r1) {
        return takeLast(r1).toList();
    }

    public final Observable<List<T>> takeLastBuffer(int r1, long j, TimeUnit timeUnit) {
        return takeLast(r1, j, timeUnit).toList();
    }

    public final Observable<List<T>> takeLastBuffer(int r1, long j, TimeUnit timeUnit, Scheduler scheduler) {
        return takeLast(r1, j, timeUnit, scheduler).toList();
    }
    ...
    public final Observable<List<T>> toSortedList(int r2) {
        return (Observable<List<T>>) lift(new OperatorToObservableSortedList(r2));
    }

    public final Observable<List<T>> toSortedList(Func2<? super T, ? super T, Integer> func2, int r3) {
        return (Observable<List<T>>) lift(new OperatorToObservableSortedList(func2, r3));
    }
    ...
    public final Observable<Observable<T>> window(int r1) {
        return window(r1, r1);
    }

    public final Observable<Observable<T>> window(int r3, int r4) {
        if (r3 <= 0) {
            throw new IllegalArgumentException("count > 0 required but it was " + r3);
        } else if (r4 <= 0) {
            throw new IllegalArgumentException("skip > 0 required but it was " + r4);
        } else {
            return (Observable<Observable<T>>) lift(new OperatorWindowWithSize(r3, r4));
        }
    }
    ...
    public final Observable<Observable<T>> window(long j, long j2, TimeUnit timeUnit, int r15, Scheduler scheduler) {
        return (Observable<Observable<T>>) lift(new OperatorWindowWithTime(j, j2, timeUnit, r15, scheduler));
    }
    ...
    public final Observable<Observable<T>> window(long j, TimeUnit timeUnit, int r10) {
        return window(j, timeUnit, r10, Schedulers.computation());
    }

    public final Observable<Observable<T>> window(long j, TimeUnit timeUnit, int r12, Scheduler scheduler) {
        return window(j, j, timeUnit, r12, scheduler);
    }
