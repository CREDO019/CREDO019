...
import p042rx.internal.operators.CompletableFromEmitter;
import p042rx.internal.operators.CompletableOnSubscribeConcat;
import p042rx.internal.operators.CompletableOnSubscribeConcatArray;
import p042rx.internal.operators.CompletableOnSubscribeConcatIterable;
import p042rx.internal.operators.CompletableOnSubscribeMerge;
import p042rx.internal.operators.CompletableOnSubscribeMergeArray;
import p042rx.internal.operators.CompletableOnSubscribeMergeDelayErrorArray;
import p042rx.internal.operators.CompletableOnSubscribeMergeDelayErrorIterable;
import p042rx.internal.operators.CompletableOnSubscribeMergeIterable;
import p042rx.internal.operators.CompletableOnSubscribeTimeout;
...
import p042rx.observers.SafeCompletableSubscriber;
...
public class Completable {
    ...
    public static Completable concat(Observable<? extends Completable> observable, int r3) {
        requireNonNull(observable);
        if (r3 < 1) {
            throw new IllegalArgumentException("prefetch > 0 required but it was " + r3);
        }
        return create(new CompletableOnSubscribeConcat(observable, r3));
    }
    ...
    public static Completable merge(Observable<? extends Completable> observable, int r2) {
        return merge0(observable, r2, false);
    }

    protected static Completable merge0(Observable<? extends Completable> observable, int r2, boolean z) {
        requireNonNull(observable);
        if (r2 < 1) {
            throw new IllegalArgumentException("maxConcurrency > 0 required but it was " + r2);
        }
        return create(new CompletableOnSubscribeMerge(observable, r2, z));
    }
    ...
    public static Completable mergeDelayError(Observable<? extends Completable> observable, int r2) {
        return merge0(observable, r2, true);
    }
    ...
    public static <R> Completable using(final Func0<R> func0, final Func1<? super R, ? extends Completable> func1, final Action1<? super R> action1, final boolean z) {
        ...
        return create(new OnSubscribe() { // from class: rx.Completable.13
            ...
            public void call(CompletableSubscriber completableSubscriber) {
                try {
                    ...
                    try {
                        ...
                        completable.unsafeSubscribe(new C54541(new AtomicBoolean(), call, completableSubscriber));
                    } catch (Throwable th2) {
                        try {
                            action1.call(call);
            ...
            /* loaded from: classes4.dex */
            public class C54541 implements CompletableSubscriber {
                ...
                C54541(AtomicBoolean atomicBoolean, Object obj, CompletableSubscriber completableSubscriber) {
    ...
    public final Completable compose(Transformer transformer) {
        return (Completable) m3to(transformer);
    }
    ...
    protected final Completable doOnLifecycle(Action1<? super Subscription> action1, Action1<? super Throwable> action12, Action0 action0, Action0 action02, Action0 action03) {
        ...
        return create(new C546419(action0, action02, action12, action1, action03));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: rx.Completable$19 */
    /* loaded from: classes4.dex */
    public class C546419 implements OnSubscribe {
        ...
        C546419(Action0 action0, Action0 action02, Action1 action1, Action1 action12, Action0 action03) {
        ...
        public void call(final CompletableSubscriber completableSubscriber) {
            Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.19.1
                ...
                public void onCompleted() {
                    try {
                        C546419.this.val$onComplete.call();
                        completableSubscriber.onCompleted();
                        try {
                            C546419.this.val$onAfterTerminate.call();
                        } catch (Throwable th) {
                            RxJavaHooks.onError(th);
                        }
                    } catch (Throwable th2) {
                ...
                public void onError(Throwable th) {
                    try {
                        C546419.this.val$onError.call(th);
                    } catch (Throwable th2) {
                        th = new CompositeException(Arrays.asList(th, th2));
                    }
                    completableSubscriber.onError(th);
    ...
    /* renamed from: to */
    public final <R> R m3to(Func1<? super Completable, R> func1) {
    ...
    /* loaded from: classes4.dex */
    class C549335 implements OnSubscribe {
        final /* synthetic */ Scheduler val$scheduler;

        C549335(Scheduler scheduler) {
            ...
            Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.35.1
                ...
                public void onSubscribe(final Subscription subscription) {
                    completableSubscriber.onSubscribe(Subscriptions.create(new Action0() { // from class: rx.Completable.35.1.1
                        @Override // p042rx.functions.Action0
                        public void call() {
                            final Scheduler.Worker createWorker = C549335.this.val$scheduler.createWorker();
    ...
    public final Completable unsubscribeOn(Scheduler scheduler) {
        requireNonNull(scheduler);
        return create(new C549335(scheduler));
    }
