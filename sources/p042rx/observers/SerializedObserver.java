...
public class SerializedObserver<T> implements Observer<T> {
    ...
    static final class FastList {
        ...
        public void add(Object obj) {
            ...
            if (objArr == null) {
                ...
                Object[] objArr2 = new Object[(r0 >> 2) + r0];
    ...
    */
    public void onNext(T r7) {
        ...
        L1b:
            java.lang.Object r7 = p042rx.internal.operators.NotificationLite.next(r7)     // Catch: java.lang.Throwable -> L6f
        ...
        L45:
            ...
            boolean r4 = p042rx.internal.operators.NotificationLite.accept(r5, r4)     // Catch: java.lang.Throwable -> L53
            if (r4 == 0) goto L50
        ...
        L53:
            ...
            java.lang.Throwable r7 = p042rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r7)
            r0.onError(r7)
            return
        L63:
            r7 = move-exception
        ...
        L66:
            ...
            r6.terminated = r0
            rx.Observer<? super T> r0 = r6.actual
            p042rx.exceptions.Exceptions.throwOrReport(r1, r0, r7)
            return
        L6f:
            r7 = move-exception
            monitor-exit(r6)     // Catch: java.lang.Throwable -> L6f
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: p042rx.observers.SerializedObserver.onNext(java.lang.Object):void");
    }
