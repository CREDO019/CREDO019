...
public final class SpscAtomicArrayQueue<E> extends AtomicReferenceArrayQueue<E> {
    ...
    @Override // p042rx.internal.util.atomic.AtomicReferenceArrayQueue, java.util.AbstractQueue, java.util.AbstractCollection, java.util.Collection
    public /* bridge */ /* synthetic */ void clear() {
        super.clear();
    }

    @Override // p042rx.internal.util.atomic.AtomicReferenceArrayQueue, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable
    public /* bridge */ /* synthetic */ Iterator iterator() {
        return super.iterator();
    }

    public SpscAtomicArrayQueue(int r2) {
        super(r2);
    ...
    public boolean offer(E e) {
        ...
        int calcElementOffset = calcElementOffset(j, r1);
        if (j >= this.producerLookAhead) {
            long j2 = this.lookAheadStep + j;
            if (lvElement(atomicReferenceArray, calcElementOffset(j2, r1)) == null) {
