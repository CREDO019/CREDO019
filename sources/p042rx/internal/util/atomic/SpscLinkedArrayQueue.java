...
public final class SpscLinkedArrayQueue<T> implements Queue<T> {
    ...
    public SpscLinkedArrayQueue(int r4) {
        int roundToPowerOfTwo = Pow2.roundToPowerOfTwo(r4);
    ...
    private boolean writeToQueue(AtomicReferenceArray<Object> atomicReferenceArray, T t, long j, int r5) {
        soElement(atomicReferenceArray, r5, t);
        soProducerIndex(j + 1);
        return true;
    }
    ...
    private T newBufferPoll(AtomicReferenceArray<Object> atomicReferenceArray, long j, int r7) {
        this.consumerBuffer = atomicReferenceArray;
        int calcWrappedOffset = calcWrappedOffset(j, r7);
        T t = (T) lvElement(atomicReferenceArray, calcWrappedOffset);
        if (t == null) {
            return null;
        }
    ...
    public boolean offer(T t, T t2) {
        AtomicReferenceArray<Object> atomicReferenceArray = this.producerBuffer;
        long lvProducerIndex = lvProducerIndex();
        int r3 = this.producerMask;
        long j = 2 + lvProducerIndex;
        if (lvElement(atomicReferenceArray, calcWrappedOffset(j, r3)) == null) {
            int calcWrappedOffset = calcWrappedOffset(lvProducerIndex, r3);
        ...
        AtomicReferenceArray<Object> atomicReferenceArray2 = new AtomicReferenceArray<>(atomicReferenceArray.length());
        this.producerBuffer = atomicReferenceArray2;
        int calcWrappedOffset2 = calcWrappedOffset(lvProducerIndex, r3);
