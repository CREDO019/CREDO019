...
import p042rx.internal.util.BackpressureDrainManager;
...
public class OperatorOnBackpressureBuffer<T> implements Observable.Operator<T, T> {
    ...
    public static final class BufferSubscriber<T> extends Subscriber<T> implements BackpressureDrainManager.BackpressureQueueCallback {
        ...
        @Override // p042rx.internal.util.BackpressureDrainManager.BackpressureQueueCallback
        ...
        */
        private boolean assertCapacity() {
            ...
            L6:
                ...
                if (r0 > 0) goto L4a
                r0 = 0
                rx.BackpressureOverflow$Strategy r4 = r6.overflowStrategy     // Catch: p042rx.exceptions.MissingBackpressureException -> L23
                boolean r4 = r4.mayAttemptDrop()     // Catch: p042rx.exceptions.MissingBackpressureException -> L23
                if (r4 == 0) goto L34
                java.lang.Object r4 = r6.poll()     // Catch: p042rx.exceptions.MissingBackpressureException -> L23
                if (r4 == 0) goto L34
                r4 = 1
                goto L35
            L23:
            ...
            L4a:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p042rx.internal.operators.OperatorOnBackpressureBuffer.BufferSubscriber.assertCapacity():boolean");
        }
