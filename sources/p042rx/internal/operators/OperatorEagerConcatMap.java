...
public final class OperatorEagerConcatMap<T, R> implements Observable.Operator<R, T> {
    ...
    public OperatorEagerConcatMap(Func1<? super T, ? extends Observable<? extends R>> func1, int r2, int r3) {
        this.mapper = func1;
        this.bufferSize = r2;
    ...
    public static final class EagerOuterSubscriber<T, R> extends Subscriber<T> {
        ...
        public EagerOuterSubscriber(Func1<? super T, ? extends Observable<? extends R>> func1, int r2, int r3, Subscriber<? super R> subscriber) {
            this.mapper = func1;
            this.bufferSize = r2;
            this.actual = subscriber;
            request(r3 == Integer.MAX_VALUE ? Long.MAX_VALUE : r3);
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:55:0x0092, code lost:
            p042rx.internal.operators.BackpressureUtils.produced(r0, r12);
         */
        ...
        */
        void drain() {
            ...
            L18:
                ...
                rx.internal.operators.OperatorEagerConcatMap$EagerInnerSubscriber r7 = (p042rx.internal.operators.OperatorEagerConcatMap.EagerInnerSubscriber) r7     // Catch: java.lang.Throwable -> Lc1
            ...
            La0:
                r5.poll()
                java.lang.Object r14 = p042rx.internal.operators.NotificationLite.getValue(r15)     // Catch: java.lang.Throwable -> Lae
            ...
            Lae:
                r0 = move-exception
                p042rx.exceptions.Exceptions.throwOrReport(r0, r2, r15)
                return
            Lb3:
                r17 = r4
            Lb5:
            ...
            Lc1:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p042rx.internal.operators.OperatorEagerConcatMap.EagerOuterSubscriber.drain():void");
        }
    }
    ...
    public static final class EagerInnerSubscriber<T> extends Subscriber<T> {
        ...
        public EagerInnerSubscriber(EagerOuterSubscriber<?, T> eagerOuterSubscriber, int r2) {
            Queue<Object> spscAtomicArrayQueue;
            this.parent = eagerOuterSubscriber;
            if (UnsafeAccess.isUnsafeAvailable()) {
                spscAtomicArrayQueue = new SpscArrayQueue<>(r2);
            } else {
                spscAtomicArrayQueue = new SpscAtomicArrayQueue<>(r2);
            }
