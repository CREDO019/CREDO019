...
import p042rx.internal.util.OpenHashSet;
...
public final class OperatorReplay<T> extends ConnectableObservable<T> implements Subscription {
    ...
    public static <T> ConnectableObservable<T> observeOn(final ConnectableObservable<T> connectableObservable, Scheduler scheduler) {
        ...
        return new ConnectableObservable<T>(new Observable.OnSubscribe<T>() { // from class: rx.internal.operators.OperatorReplay.3
            ...
            @Override // p042rx.observables.ConnectableObservable
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> observable, final int r2) {
        ...
        return create(observable, new Func0<ReplayBuffer<T>>() { // from class: rx.internal.operators.OperatorReplay.5
            ...
            public ReplayBuffer<T> call() {
                return new SizeBoundReplayBuffer(r2);
            }
        });
    }
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> observable, long j, TimeUnit timeUnit, final Scheduler scheduler, final int r5) {
        final long millis = timeUnit.toMillis(j);
        return create(observable, new Func0<ReplayBuffer<T>>() { // from class: rx.internal.operators.OperatorReplay.6
            @Override // p042rx.functions.Func0, java.util.concurrent.Callable
            public ReplayBuffer<T> call() {
                return new SizeAndTimeBoundReplayBuffer(r5, millis, scheduler);
            }
        });
    }
    ...
    static final class UnboundedReplayBuffer<T> extends ArrayList<Object> implements ReplayBuffer<T> {
        ...
        public UnboundedReplayBuffer(int r1) {
            super(r1);
        }

        @Override // p042rx.internal.operators.OperatorReplay.ReplayBuffer
    ...
    public static final class SizeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        @Override // p042rx.internal.operators.OperatorReplay.BoundedReplayBuffer
        void truncate() {
    ...
    public static final class SizeAndTimeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        public SizeAndTimeBoundReplayBuffer(int r1, long j, Scheduler scheduler) {
        ...
        */
        void truncateFinal() {
            /*
                ...
                rx.internal.operators.OperatorReplay$Node r2 = (p042rx.internal.operators.OperatorReplay.Node) r2
                java.lang.Object r3 = r2.get()
                rx.internal.operators.OperatorReplay$Node r3 = (p042rx.internal.operators.OperatorReplay.Node) r3
                r4 = 0
            L16:
                r9 = r3
                r3 = r2
                ...
                rx.schedulers.Timestamped r5 = (p042rx.schedulers.Timestamped) r5
            ...
            L3f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p042rx.internal.operators.OperatorReplay.SizeAndTimeBoundReplayBuffer.truncateFinal():void");
        }
    }
}
