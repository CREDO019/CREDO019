...
import p042rx.internal.util.LinkedArrayList;
...
public final class CachedObservable<T> extends Observable<T> {
    ...
    public static <T> CachedObservable<T> from(Observable<? extends T> observable, int r2) {
        if (r2 < 1) {
            throw new IllegalArgumentException("capacityHint > 0 required");
        }
        CacheState cacheState = new CacheState(observable, r2);
    ...
    public static final class CacheState<T> extends LinkedArrayList implements Observer<T> {
        ...
        public CacheState(Observable<? extends T> observable, int r2) {
            super(r2);
        ...
        public void removeProducer(ReplayProducer<T> replayProducer) {
            synchronized (this.connection) {
                ...
                while (true) {
                    if (r5 >= length) {
                        break;
                    } else if (replayProducerArr[r5].equals(replayProducer)) {
                        r3 = r5;
                        break;
                    } else {
                        r5++;
                ...
                ReplayProducer<?>[] replayProducerArr2 = new ReplayProducer[length - 1];
                System.arraycopy(replayProducerArr, 0, replayProducerArr2, 0, r3);
                System.arraycopy(replayProducerArr, r3 + 1, replayProducerArr2, r3, (length - r3) - 1);
                this.producers = replayProducerArr2;
            }
        }
    ...
    public static final class ReplayProducer<T> extends AtomicLong implements Producer, Subscription {
        ...
        */
        public void replay() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: p042rx.internal.operators.CachedObservable.ReplayProducer.replay():void");
        }
    }
}
