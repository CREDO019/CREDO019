...
public final class OperatorWindowWithTime<T> implements Observable.Operator<Observable<T>, T> {
    ...
    public OperatorWindowWithTime(long j, long j2, TimeUnit timeUnit, int r6, Scheduler scheduler) {
        this.timespan = j;
        this.timeshift = j2;
        this.unit = timeUnit;
        this.size = r6;
    ...
    public static final class State<T> {
        ...
        public State(Observer<T> observer, Observable<T> observable, int r3) {
        ...
        */
        boolean drain(java.util.List<java.lang.Object> r5) {
            ...
            L8:
                ...
                java.lang.Object r2 = p042rx.internal.operators.OperatorWindowWithTime.NEXT_SUBJECT
                r3 = 0
                if (r1 != r2) goto L1e
                ...
                return r3
            L1e:
                boolean r2 = p042rx.internal.operators.NotificationLite.isError(r1)
                if (r2 == 0) goto L2c
                java.lang.Throwable r5 = p042rx.internal.operators.NotificationLite.getError(r1)
                r4.error(r5)
                goto L3d
            L2c:
                boolean r2 = p042rx.internal.operators.NotificationLite.isCompleted(r1)
                if (r2 == 0) goto L36
                r4.complete()
                goto L3d
            L36:
            ...
            L3d:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p042rx.internal.operators.OperatorWindowWithTime.ExactSubscriber.drain(java.util.List):boolean");
        }
        ...
        public void onNext(T t) {
            synchronized (this.guard) {
                ...
                while (it.hasNext()) {
                    ...
                    int r4 = next.count + 1;
                    next.count = r4;
                    if (r4 == OperatorWindowWithTime.this.size) {
                        it.remove();
                    }
                }
