        ...
        void remove(InnerProducer<T> innerProducer) {
            ...
            do {
                ...
                while (true) {
                    if (r4 >= length) {
                        break;
                    } else if (innerProducerArr[r4].equals(innerProducer)) {
                        r1 = r4;
                        break;
                    } else {
                        r4++;
                ...
                if (length == 1) {
                    ...
                    System.arraycopy(innerProducerArr, 0, innerProducerArr3, 0, r1);
                    System.arraycopy(innerProducerArr, r1 + 1, innerProducerArr3, r1, (length - r1) - 1);
