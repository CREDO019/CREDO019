...
import p042rx.internal.operators.BlockingOperatorLatest;
import p042rx.internal.operators.BlockingOperatorMostRecent;
import p042rx.internal.operators.BlockingOperatorNext;
import p042rx.internal.operators.BlockingOperatorToFuture;
import p042rx.internal.operators.BlockingOperatorToIterator;
...
public final class BlockingObservable<T> {
    ...
    /* renamed from: o */
    private final Observable<? extends T> f2586o;

    private BlockingObservable(Observable<? extends T> observable) {
        this.f2586o = observable;
    }
    ...
    public void forEach(final Action1<? super T> action1) {
        ...
        BlockingUtils.awaitForComplete(countDownLatch, this.f2586o.subscribe((Subscriber<? super Object>) new Subscriber<T>() { // from class: rx.observables.BlockingObservable.1
    ...
    public Iterator<T> getIterator() {
        return BlockingOperatorToIterator.toIterator(this.f2586o);
    }

    public T first() {
        return blockForSingle(this.f2586o.first());
    }

    public T first(Func1<? super T, Boolean> func1) {
        return blockForSingle(this.f2586o.first(func1));
    }

    public T firstOrDefault(T t) {
        return blockForSingle(this.f2586o.map(UtilityFunctions.identity()).firstOrDefault(t));
    }

    public T firstOrDefault(T t, Func1<? super T, Boolean> func1) {
        return blockForSingle(this.f2586o.filter(func1).map(UtilityFunctions.identity()).firstOrDefault(t));
    }

    public T last() {
        return blockForSingle(this.f2586o.last());
    }

    public T last(Func1<? super T, Boolean> func1) {
        return blockForSingle(this.f2586o.last(func1));
    }

    public T lastOrDefault(T t) {
        return blockForSingle(this.f2586o.map(UtilityFunctions.identity()).lastOrDefault(t));
    }

    public T lastOrDefault(T t, Func1<? super T, Boolean> func1) {
        return blockForSingle(this.f2586o.filter(func1).map(UtilityFunctions.identity()).lastOrDefault(t));
    }

    public Iterable<T> mostRecent(T t) {
        return BlockingOperatorMostRecent.mostRecent(this.f2586o, t);
    }

    public Iterable<T> next() {
        return BlockingOperatorNext.next(this.f2586o);
    }

    public Iterable<T> latest() {
        return BlockingOperatorLatest.latest(this.f2586o);
    }

    public T single() {
        return blockForSingle(this.f2586o.single());
    }

    public T single(Func1<? super T, Boolean> func1) {
        return blockForSingle(this.f2586o.single(func1));
    }

    public T singleOrDefault(T t) {
        return blockForSingle(this.f2586o.map(UtilityFunctions.identity()).singleOrDefault(t));
    }

    public T singleOrDefault(T t, Func1<? super T, Boolean> func1) {
        return blockForSingle(this.f2586o.filter(func1).map(UtilityFunctions.identity()).singleOrDefault(t));
    }

    public Future<T> toFuture() {
        return BlockingOperatorToFuture.toFuture(this.f2586o);
    }
    ...
    public void subscribe() {
        ...
        BlockingUtils.awaitForComplete(countDownLatch, this.f2586o.subscribe((Subscriber<? super Object>) new Subscriber<T>() { // from class: rx.observables.BlockingObservable.4
            @Override // p042rx.Observer
            public void onNext(T t) {
            }
    ...
    public void subscribe(Observer<? super T> observer) {
        ...
        Subscription subscribe = this.f2586o.subscribe((Subscriber<? super Object>) new Subscriber<T>() { // from class: rx.observables.BlockingObservable.5
            @Override // p042rx.Observer
            public void onNext(T t) {
    ...
    public void subscribe(Subscriber<? super T> subscriber) {
        ...
        this.f2586o.subscribe((Subscriber<? super Object>) subscriber2);
